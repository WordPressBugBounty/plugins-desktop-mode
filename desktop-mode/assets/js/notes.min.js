(function(){"use strict";const tt="desktop-mode";function be(){return window.wp?.i18n}function u(o,e=tt){return be()?.__(o,e)??o}function J(o,...e){const t=be()?.sprintf;if(t)return t(o,...e);let s=0;return o.replace(/%(?:(\d+)\$)?[sd]/g,(n,i)=>{const r=i?Number.parseInt(i,10)-1:s++;return String(e[r]??"")})}function b(o,...e){return{__wpdHtml:!0,strings:o,values:e}}function ot(o){return!!o&&o.__wpdHtml===!0}const st="$$wpd$$",y=/\$\$wpd\$\$(\d+)\$\$/g,nt="$$wpd-node$$",it=/^\$\$wpd-node\$\$(\d+)\$\$$/,rt=new Set(["style","script","textarea","title"]);function at(o){let e="",t=!1,s=null,n=!1,i=null,r="",l=!1;for(let a=0;a<o.length;a++){const c=o[a];e+=c;for(let d=0;d<c.length;d++){const h=c[d];if(n){c.startsWith("-->",d)&&(n=!1,d+=2);continue}if(i!==null){h==="<"&&c[d+1]==="/"&&c.slice(d+2,d+2+i.length).toLowerCase()===i&&(d+=1+i.length,i=null,t=!0,l=!1,r="");continue}if(s!==null){h===s&&(s=null);continue}if(t){h==='"'||h==="'"?(s=h,l=!1):h===">"?(t=!1,l=!1,rt.has(r)&&(i=r),r=""):l&&(/[a-zA-Z0-9-]/.test(h)?r+=h.toLowerCase():l=!1);continue}if(c.startsWith("<!--",d)){n=!0,d+=3;continue}const m=c[d+1]??"";h==="<"&&/[a-zA-Z/!]/.test(m)&&(t=!0,r="",l=/[a-zA-Z]/.test(m))}a<o.length-1&&(e+=t||n||i!==null?`${st}${a}$$`:`<!--${nt}${a}$$-->`)}return e}const ye=new WeakMap;function we(o){const e=ye.get(o);if(e)return e;const t=document.createElement("template");t.innerHTML=at(o);const s=[],n=(l,a)=>{if(l.nodeType===Node.ELEMENT_NODE){const h=l;for(const m of Array.from(h.attributes)){const f=m.name,p=m.value,_=f[0];if(y.test(p))if(y.lastIndex=0,_==="@"){const g=y.exec(p);y.lastIndex=0,s.push({path:a,kind:"event",name:f.slice(1),valueIndex:g?Number(g[1]):0}),h.removeAttribute(f)}else if(_==="."){const g=y.exec(p);y.lastIndex=0,s.push({path:a,kind:"prop",name:f.slice(1),valueIndex:g?Number(g[1]):0}),h.removeAttribute(f)}else if(_==="?"){const g=y.exec(p);y.lastIndex=0,s.push({path:a,kind:"bool",name:f.slice(1),valueIndex:g?Number(g[1]):0}),h.removeAttribute(f)}else{const g=[],E=[];let x=0,M;for(y.lastIndex=0;(M=y.exec(p))!==null;)g.push(p.slice(x,M.index)),E.push(Number(M[1])),x=M.index+M[0].length;g.push(p.slice(x)),s.push({path:a,kind:"attr",name:f,template:g,valueIndices:E}),h.setAttribute(f,"")}}}const c=Array.from(l.childNodes);let d=0;for(let h=0;h<c.length;h++){const m=c[h],f=h+d;if(m.nodeType===Node.COMMENT_NODE){const p=it.exec(m.data);if(p){const _=document.createTextNode("");m.parentNode.replaceChild(_,m),s.push({path:[...a,f],kind:"node",valueIndex:Number(p[1])})}continue}if(m.nodeType===Node.TEXT_NODE){const p=m.textContent||"";if(!y.test(p)){y.lastIndex=0;continue}y.lastIndex=0;const _=m.parentNode;let g=0,E;const x=[],M=[];for(y.lastIndex=0;(E=y.exec(p))!==null;){E.index>g&&x.push(document.createTextNode(p.slice(g,E.index)));const ve=document.createTextNode("");x.push(ve),M.push({path:[...a,f+x.length-1],kind:"node",valueIndex:Number(E[1])}),g=E.index+E[0].length}g<p.length&&x.push(document.createTextNode(p.slice(g)));for(const ve of x)_.insertBefore(ve,m);_.removeChild(m),d+=x.length-1,s.push(...M)}else n(m,[...a,f])}};n(t.content,[]);const r={template:t,buildParts:l=>{const a=[];for(const c of s){let d=l;for(const h of c.path)d=d.childNodes[h];c.kind==="node"?a.push({kind:"node",valueIndex:c.valueIndex,child:{anchor:d,state:null}}):c.kind==="attr"?a.push({kind:"attr",element:d,name:c.name,template:c.template,valueIndices:c.valueIndices}):c.kind==="event"?a.push({kind:"event",valueIndex:c.valueIndex,element:d,name:c.name}):c.kind==="prop"?a.push({kind:"prop",valueIndex:c.valueIndex,element:d,name:c.name}):c.kind==="bool"&&a.push({kind:"bool",valueIndex:c.valueIndex,element:d,name:c.name})}return a}};return ye.set(o,r),r}const _e=new WeakMap;function lt(o,e){for(const t of o.nodes)if(t.parentNode!==e)return!1;return!0}function ct(o,e){const t=_e.get(e);if(t&&t.strings===o.strings&&lt(t,e)){U(t.parts,o.values);return}const s=we(o.strings),n=s.template.content.cloneNode(!0),i=s.buildParts(n),r=Array.from(n.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(n),U(i,o.values),_e.set(e,{strings:o.strings,parts:i,nodes:r})}function U(o,e){for(const t of o)if(t.kind==="node")X(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let s=t.template[0];for(let n=0;n<t.valueIndices.length;n++)s+=xe(e[t.valueIndices[n]]),s+=t.template[n+1];s!==t.last&&(t.last=s,s===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,s))}else if(t.kind==="event"){const s=e[t.valueIndex];s!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),s&&t.element.addEventListener(t.name,s),t.current=s)}else if(t.kind==="prop"){const s=e[t.valueIndex];s!==t.last&&(t.last=s,t.element[t.name]=s)}else if(t.kind==="bool"){const s=!!e[t.valueIndex];s!==t.last&&(t.last=s,s?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function X(o,e){if(e==null||e===!1){o.state&&(C(o.state),o.state=null);return}if(Array.isArray(e)){pt(o,e);return}if(ot(e)){ut(o,e);return}if(e instanceof Node){dt(o,e);return}ht(o,xe(e))}function dt(o,e){const t=o.state;t?.shape==="node"&&t.node===e||(t&&C(t),z(o,[e]),o.state={shape:"node",node:e})}function ht(o,e){const t=o.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&C(t);const s=document.createTextNode(e);z(o,[s]),o.state={shape:"text",node:s,text:e}}function ut(o,e){const t=o.state;if(t?.shape==="template"&&t.strings===e.strings){U(t.parts,e.values);return}t&&C(t);const s=we(e.strings),n=s.template.content.cloneNode(!0),i=s.buildParts(n),r=Array.from(n.childNodes);z(o,[n]),U(i,e.values),o.state={shape:"template",strings:e.strings,parts:i,nodes:r}}function pt(o,e){const t=o.state;if(t?.shape==="array"){const n=Math.min(t.entries.length,e.length);for(let i=0;i<n;i++)X(t.entries[i],e[i]);if(e.length<t.entries.length){for(let i=e.length;i<t.entries.length;i++){const r=t.entries[i];r.state&&C(r.state),r.anchor.remove()}t.entries.length=e.length}else for(let i=t.entries.length;i<e.length;i++){const r=document.createTextNode("");z(o,[r]);const l={anchor:r,state:null};X(l,e[i]),t.entries.push(l)}return}t&&C(t);const s=[];for(const n of e){const i=document.createTextNode("");z(o,[i]);const r={anchor:i,state:null};X(r,n),s.push(r)}o.state={shape:"array",entries:s}}function z(o,e){const t=o.anchor.parentNode;if(t)for(const s of e)t.insertBefore(s,o.anchor)}function C(o){if(o.shape==="text"){o.node.remove();return}if(o.shape==="template"){for(const e of o.parts)e.kind==="node"&&e.child.state&&(C(e.child.state),e.child.state=null);for(const e of o.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(o.shape==="node"){o.node.parentNode&&o.node.parentNode.removeChild(o.node);return}for(const e of o.entries)e.state&&C(e.state),e.anchor.remove()}function xe(o){return o==null||o===!1?"":String(o)}const T=class T extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(ke)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,s){if(t===s)return;const n=ft(e);this._propValues[n]=s,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const s=(Array.isArray(e)?e:String(e).split(/\s+/)).map(n=>String(n).trim()).filter(n=>n!=="");this.className=s.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const s=ke(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(s),set:n=>{let i;n==null||n===!1?i=null:n===!0?i="":i=String(n),this._propValues[t]=i,i===null?this.removeAttribute(s):this.setAttribute(s,i),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&ct(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(s=>s.sheet).filter(s=>s!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const s of e.styles)if(!s.sheet){const n=document.createElement("style");n.textContent=s.cssText,this.shadowRoot.appendChild(n)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!T._lightStylesAdopted.has(e)){T._lightStylesAdopted.add(e);for(const t of e.styles){const s=document.createElement("style");s.dataset.osUi=this.tagName.toLowerCase(),s.textContent=t.cssText,document.head.appendChild(s)}}}};T.props=[],T.styles=[],T.shadow=!0,T._lightStylesAdopted=new WeakSet;let S=T;function j(o,e){customElements.get(o)||customElements.define(o,e)}function ke(o){return o.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function ft(o){return o.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const mt=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function v(o,...e){let t=o[0];for(let s=1;s<o.length;s++){const n=e[s-1];if(typeof n=="string"||typeof n=="number")t+=String(n);else if(n&&n.__wpdCss)t+=n.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof n);t+=o[s]}if(mt){const s=new CSSStyleSheet;return s.replaceSync(t),{__wpdCss:!0,sheet:s,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function gt(o){const e=[],t=[];let s=null,n=o.parentElement;for(;n&&!(n===document.body||n===document.documentElement);){const r=n.id||"";if(r.startsWith("wp-window-")){s=r.slice(10);break}if(n.tagName.toLowerCase()==="os-tabpanel"){const l=n.getAttribute("for");l&&t.unshift(l)}n=n.parentElement}s&&e.push(ee(s));for(const r of t)e.push("tab-"+ee(r));const i=o.getAttribute("label");return i&&e.push(ee(i)),e.length===0?"os-unnamed":"os-"+e.filter(r=>r!=="").join("-")}function ee(o){return o.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function vt(o){if(o.id)return o.id;const e=gt(o);return o.id=e,e}function bt(o){if(!o)return 214;let e=5381;for(let t=0;t<o.length;t++)e=Math.imul(e,33)+o.charCodeAt(t);return(e%360+360)%360}const yt=v`:host{display:inline-flex;position:relative;width:var( --os-ui-avatar-size,32px );height:var( --os-ui-avatar-size,32px );flex:0 0 auto;vertical-align:middle;line-height:0;perspective:calc( var( --os-ui-avatar-size,32px ) * 8 );--os-ui-avatar-tilt-x:0deg;--os-ui-avatar-tilt-y:0deg;--os-ui-avatar-hover:0;--os-ui-avatar-glare-x:50%;--os-ui-avatar-glare-y:50%}:host( [ hidden ] ){display:none}.os-avatar__tile{position:relative;width:100%;height:100%;border-radius:50%;overflow:hidden;background:var( --os-window-bg,#f0f0f1 );color:var( --os-ui-fg-on-accent,#fff );display:flex;align-items:center;justify-content:center;font-weight:700;font-size:calc( var( --os-ui-avatar-size,32px ) * 0.48 );line-height:1;letter-spacing:0;font-feature-settings:'tnum' 1;user-select:none;transform-style:preserve-3d;transform:rotateX( var( --os-ui-avatar-tilt-x ) ) rotateY( var( --os-ui-avatar-tilt-y ) ) scale( calc( 1 + var( --os-ui-avatar-hover ) * 0.07 ) );transition:transform 220ms cubic-bezier( 0.2,0.8,0.2,1 ),box-shadow 220ms cubic-bezier( 0.2,0.8,0.2,1 );box-shadow:inset 0 0 0 1px rgba( 255,255,255,calc( 0.18 + 0.22 * var( --os-ui-avatar-hover ) ) ),inset 0 0 0 calc( 1px + var( --os-ui-avatar-hover ) * 1px ) rgba( 0,0,0,calc( 0.08 + 0.04 * var( --os-ui-avatar-hover ) ) ),0 calc( 1px + var( --os-ui-avatar-hover ) * 8px ) calc( 6px + var( --os-ui-avatar-hover ) * 18px ) rgba( 0,0,0,calc( 0.08 + 0.18 * var( --os-ui-avatar-hover ) ) )}.os-avatar__tile::after{content:'';position:absolute;inset:0;border-radius:50%;background:radial-gradient( circle at var( --os-ui-avatar-glare-x ) var( --os-ui-avatar-glare-y ),var( --os-ui-scrim,rgba( 255,255,255,0.55 ) ) 0%,var( --os-ui-hover,rgba( 255,255,255,0 ) ) 55% );opacity:var( --os-ui-avatar-hover );mix-blend-mode:overlay;pointer-events:none;transition:opacity 220ms cubic-bezier( 0.2,0.8,0.2,1 )}.os-avatar__tile::before{content:'';position:absolute;inset:calc( var( --os-ui-avatar-hover ) * -3px );border-radius:50%;background:radial-gradient( circle at var( --os-ui-avatar-glare-x ) var( --os-ui-avatar-glare-y ),color-mix( in srgb,var( --os-ui-avatar-halo,rgb( 99,102,241 ) ) calc( 35% * var( --os-ui-avatar-hover ) ),transparent ) 0%,transparent 70% );filter:blur( 4px );pointer-events:none;z-index:-1;transition:inset 220ms cubic-bezier( 0.2,0.8,0.2,1 ),background 220ms}.os-avatar__tile img{width:calc( 100% + 2px );height:calc( 100% + 2px );margin:-1px;object-fit:cover;display:block;transform:translateZ( 1px )}.os-avatar__dot{position:absolute;bottom:0;inset-inline-end:0;width:calc( var( --os-ui-avatar-size,32px ) * 0.32 );height:calc( var( --os-ui-avatar-size,32px ) * 0.32 );min-width:8px;min-height:8px;border-radius:50%;box-sizing:border-box;border:2px solid var( --os-ui-avatar-dot-ring,var( --os-window-bg,#fff ) );background:var( --os-ui-avatar-dot-color,transparent );z-index:2}.os-avatar__dot--online{background:var( --os-ui-success-fg,#00a32a )}.os-avatar__dot--online::after{content:'';position:absolute;inset:-2px;border-radius:50%;border:1px solid var( --os-ui-success-fg,#00a32a );animation:os-avatar-presence 6s var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) ) infinite;pointer-events:none}@keyframes os-avatar-presence{0%{opacity:0.6;transform:scale( 1 )}20%{opacity:0;transform:scale( 2.2 )}100%{opacity:0;transform:scale( 2.2 )}}.os-avatar__dot--inactive{background:var( --os-ui-warning-fg,#dba617 )}.os-avatar__dot--offline{background:var( --os-ui-fg-muted,#8c8f94 )}@media ( prefers-reduced-motion:reduce ){.os-avatar__dot--online::after{animation:none;opacity:0.6}.os-avatar__tile{transform:none;transition:box-shadow 200ms}.os-avatar__tile::after,.os-avatar__tile::before{display:none}}`,Ee={xs:20,sm:24,md:40,lg:64,xl:96},Ce=new Set(["online","inactive","offline"]),V=class V extends S{constructor(){super(...arguments),this._presenceHandler=null,this._imgFailed=!1,this._onPointerMove=null,this._onPointerEnter=null,this._onPointerLeave=null,this._tiltRaf=0,this._pendingTiltX="0deg",this._pendingTiltY="0deg",this._pendingGlareX="50%",this._pendingGlareY="50%"}connectedCallback(){super.connectedCallback(),this._maybeAttachPresenceListener(),this._attachHoverEffect()}disconnectedCallback(){this._presenceHandler&&(document.removeEventListener("os-presence-changed",this._presenceHandler),this._presenceHandler=null),this._detachHoverEffect()}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),e==="src"&&(this._imgFailed=!1),(e==="user-id"||e==="presence")&&this._maybeAttachPresenceListener()}render(){const e=this._attr("src"),t=this._attr("name")||"",s=this._attr("alt"),n=s!==null?s:t,i=this._attr("size"),r=this._resolveSize(i),l=this._presenceForRender(),a=this._attr("clickable")!==null;this.style.setProperty("--os-ui-avatar-size",`${r}px`);const c=e&&!this._imgFailed?"":this._initialsBg(t),d=e&&!this._imgFailed?b`<img
					src=${e}
					alt=${n}
					@error=${()=>this._onImgError()}
					loading="lazy"
				/>`:this._initials(t),h=l?b`<span
		...
		`}_attr(e){return this.getAttribute(e)}_resolveSize(e){if(!e)return 32;if(e in Ee)return Ee[e];const t=Number(e);return Number.isFinite(t)&&t>0?t:32}_initials(e){const t=e.trim();return t?Array.from(t)[0]?.toUpperCase()??"?":"?"}_initialsBg(e){const t=bt(e);return`linear-gradient(135deg, hsl(${t} 62% 55%), hsl(${(t+24)%360} 58% 42%))`}_presenceForRender(){const e=this._attr("presence");return e&&Ce.has(e)?e:null}_presenceLabel(e){switch(e){case"online":return"Online";case"inactive":return"Inactive";case"offline":return"Offline"}}_onImgError(){this._imgFailed=!0,this.requestUpdate()}_onClick(e){const t=this._attr("user-id"),s={userId:t!==null&&Number(t)||null,originalEvent:e};this.emit("os-avatar-click",s)}_attachHoverEffect(){typeof window<"u"&&window.matchMedia?.("(prefers-reduced-motion: reduce)").matches||(this._onPointerEnter=()=>{this.style.setProperty("--os-ui-avatar-hover","1")},this._onPointerLeave=()=>{this.style.setProperty("--os-ui-avatar-hover","0"),this._pendingTiltX="0deg",this._pendingTiltY="0deg",this._pendingGlareX="50%",this._pendingGlareY="50%",this._flushTilt()},this._onPointerMove=t=>{const s=this.getBoundingClientRect();if(s.width===0||s.height===0)return;const n=(t.clientX-s.left)/s.width-.5,i=(t.clientY-s.top)/s.height-.5,r=14;this._pendingTiltY=`${(n*r).toFixed(2)}deg`,this._pendingTiltX=`${(-i*r).toFixed(2)}deg`;const l=Math.max(0,Math.min(100,(n+.5)*100)),a=Math.max(0,Math.min(100,(i+.5)*100));this._pendingGlareX=`${l.toFixed(1)}%`,this._pendingGlareY=`${a.toFixed(1)}%`,this._tiltRaf||(this._tiltRaf=requestAnimationFrame(()=>this._flushTilt()))},this.addEventListener("pointerenter",this._onPointerEnter),this.addEventListener("pointerleave",this._onPointerLeave),this.addEventListener("pointermove",this._onPointerMove))}_flushTilt(){this._tiltRaf=0,this.style.setProperty("--os-ui-avatar-tilt-x",this._pendingTiltX),this.style.setProperty("--os-ui-avatar-tilt-y",this._pendingTiltY),this.style.setProperty("--os-ui-avatar-glare-x",this._pendingGlareX),this.style.setProperty("--os-ui-avatar-glare-y",this._pendingGlareY)}_detachHoverEffect(){this._onPointerMove&&(this.removeEventListener("pointermove",this._onPointerMove),this._onPointerMove=null),this._onPointerEnter&&(this.removeEventListener("pointerenter",this._onPointerEnter),this._onPointerEnter=null),this._onPointerLeave&&(this.removeEventListener("pointerleave",this._onPointerLeave),this._onPointerLeave=null),this._tiltRaf&&(cancelAnimationFrame(this._tiltRaf),this._tiltRaf=0)}_maybeAttachPresenceListener(){const e=this._attr("user-id"),t=this._attr("presence"),s=!!e&&!t;s&&!this._presenceHandler?(this._presenceHandler=n=>{const i=n.detail;i&&String(i.userId)===String(e)&&i.newStatus&&Ce.has(i.newStatus)&&this.setAttribute("presence",i.newStatus)},document.addEventListener("os-presence-changed",this._presenceHandler)):!s&&this._presenceHandler&&(document.removeEventListener("os-presence-changed",this._presenceHandler),this._presenceHandler=null)}};V.props=["src","alt","name","size","presence","userId","clickable"],V.styles=[yt],V.help=void 0;let te=V;j("os-avatar",te);const wt=v`:host{display:inline-flex;align-items:center;gap:6px;font-size:var( --os-ui-save-status-font-size,11px );line-height:1;color:var( --os-ui-save-status-fg,currentColor );vertical-align:middle;min-width:0;opacity:1;pointer-events:auto}.os-save-status__indicator{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-save-status-size,12px );height:var( --os-ui-save-status-size,12px );border-radius:50%;flex-shrink:0;box-sizing:border-box;background:var( --os-ui-save-status-bg,transparent );border:2px solid var( --os-ui-save-status-idle-color,color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 55%,transparent ) );color:var( --wp-admin-theme-color,#2271b1 );transition:background-color 0.2s ease,border-color 0.2s ease,box-shadow 0.2s ease}:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-pulse 1.2s ease-in-out infinite}:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-modem-stutter 1.8s ease-in-out infinite,os-save-status-modem-glow 2.4s ease-in-out infinite}@keyframes os-save-status-modem-stutter{0%,4%{opacity:1}5%,30%{opacity:0.22}31%,36%{opacity:1}37%,39%{opacity:0.22}40%,44%{opacity:1}45%,67%{opacity:0.22}68%,76%{opacity:1}77%,100%{opacity:0.22}}@keyframes os-save-status-modem-glow{0%,12%{box-shadow:0 0 0 0 transparent}13%,22%{box-shadow:0 0 4px 0 currentColor}23%,50%{box-shadow:0 0 0 0 transparent}51%,58%{box-shadow:0 0 4px 0 currentColor}59%,84%{box-shadow:0 0 0 0 transparent}85%,94%{box-shadow:0 0 5px 0 currentColor}95%,100%{box-shadow:0 0 0 0 transparent}}@media ( prefers-reduced-motion:reduce ){:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{animation:none;opacity:0.85}}:host( [ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) );border-color:transparent;color:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ phase='failed' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );border-color:transparent;color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-pulse 0.8s ease-in-out 2}:host( [ variant='ring' ] ) .os-save-status__indicator{background:transparent}:host( [ variant='ring' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ variant='ring' ][ phase='saving' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-ring-color,var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) ) );animation:os-save-status-ring-pulse 1.6s var( --os-ui-ease-loop,ease-in-out ) infinite}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-ring-alert 0.62s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) )}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;animation:os-save-status-ring-land 0.42s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__glyph,:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{animation:os-save-status-glyph-in 0.24s var( --os-ui-ease-out,ease-out ) 0.08s 1 backwards}@keyframes os-save-status-ring-pulse{0%,100%{opacity:0.45;scale:0.9}50%{opacity:1;scale:1}}@keyframes os-save-status-ring-land{0%{scale:0.82}55%{scale:1.06}100%{scale:1}}@keyframes os-save-status-ring-alert{0%{scale:0.9}25%{scale:1.08}50%{scale:0.98}75%{scale:1.04}100%{scale:1}}@keyframes os-save-status-glyph-in{0%{opacity:0;scale:0.4}100%{opacity:1;scale:1}}@media ( prefers-reduced-motion:reduce ){:host( [ variant='ring' ] ) .os-save-status__indicator,:host( [ variant='ring' ] ) .os-save-status__glyph{animation:none;opacity:1;scale:1}}@keyframes os-save-status-pulse{0%,100%{opacity:0.55;transform:scale( 0.9 )}50%{opacity:1;transform:scale( 1 )}}:host( [ mode='pill' ] ) .os-save-status{display:inline-flex;align-items:center;gap:6px;padding:2px 10px;border-radius:999px;background:var( --os-ui-save-status-pill-bg,transparent );font-weight:500;white-space:nowrap}:host( [ mode='pill' ][ phase='saving' ] ) .os-save-status,:host( [ mode='pill' ][ phase='pending' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-fg-muted,#50575e ) )}:host( [ mode='pill' ][ phase='saved' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 30,132,73,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ mode='pill' ][ phase='failed' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 214,54,56,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-danger-hover,#a02622 ) )}.os-save-status__label{min-width:0;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}:host( [ phase='saved' ] ) .os-save-status__glyph,:host( [ phase='failed' ] ) .os-save-status__glyph{display:inline-block;color:var( --os-ui-fg-on-accent,#fff );width:calc( var( --os-ui-save-status-size,12px ) * 0.66 );height:calc( var( --os-ui-save-status-size,12px ) * 0.66 )}.os-save-status__glyph{display:none}.os-save-status__glyph svg{display:block;width:100%;height:100%}`,Ae="os-settings-save-lifecycle",_t=2200,xt=6e3,F=class F extends S{constructor(){super(...arguments),this._autoTimer=null,this._docListener=null}connectedCallback(){super.connectedCallback(),this.auto!==null&&this._installAutoListener()}disconnectedCallback(){this._removeAutoListener(),this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null)}attributeChangedCallback(e,t,s){if(super.attributeChangedCallback(e,t,s),(e==="auto"||e==="event")&&(this._removeAutoListener(),this.auto!==null&&this._installAutoListener()),e==="phase"){this._scheduleAutoClear();const n={phase:this.phase??"idle",error:this.error??void 0};this.emit("os-save-status-change",n)}}render(){const e=this.phase??"idle",t=this.mode??"dot",n=(this.error??"")||this._labelForPhase(e);return n?this.setAttribute("title",n):this.removeAttribute("title"),this.setAttribute("aria-live",e==="failed"?"assertive":"polite"),this.setAttribute("role",e==="failed"?"alert":"status"),b`
			<span class="os-save-status">
				...
				${t==="pill"?b`<span class="os-save-status__label"
							>${this._labelForPhase(e)}</span
					  >`:b``}
			</span>
		`}_renderGlyph(e){return e==="saved"?kt():e==="failed"?Et():""}_labelForPhase(e){switch(e){case"pending":case"saving":return this["saving-label"]??"Saving…";case"saved":return this["saved-label"]??"Saved";case"failed":return(this.error??"")||"Couldn’t save";default:return this["idle-label"]??""}}_installAutoListener(){const e=this.event||Ae;this._docListener=t=>{const s=t.detail;!s||typeof s.phase!="string"||(this.phase=s.phase,s.error?this.error=s.error:s.phase!=="failed"&&this.error&&this.removeAttribute("error"))},document.addEventListener(e,this._docListener)}_removeAutoListener(){if(!this._docListener)return;const e=this.event||Ae;document.removeEventListener(e,this._docListener),this._docListener=null}_scheduleAutoClear(){this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null);const e=this.phase??"idle",t=this._autoClearMsFor(e);t<=0||(this._autoTimer=window.setTimeout(()=>{this._autoTimer=null,this.phase="idle"},t))}_autoClearMsFor(e){if(e==="saved"){const t=this["auto-clear-saved-ms"];return parseInt(t||"",10)||_t}if(e==="failed"){const t=this["auto-clear-failed-ms"];return parseInt(t||"",10)||xt}return 0}};F.props=["phase","mode","variant","animation","auto","event","error","saving-label","saved-label","idle-label","auto-clear-saved-ms","auto-clear-failed-ms"],F.styles=[wt],F.help=void 0;let oe=F;j("os-save-status",oe);function kt(){return b`
		<svg
			viewBox="0 0 12 12"
			aria-hidden="true"
			focusable="false"
	...
	`}const Te=v`:host{--_holo-fill:var( --os-ui-holo-fill,${"linear-gradient( 124deg, #afa2e8 0%, #f5a8ea 46%, #8ee9f7 100% )"} );--_holo-ink:var( --os-ui-holo-ink,#0c0b0f );--_holo-sheen:var( --os-ui-holo-sheen,linear-gradient( 124deg,rgba( 159,214,255,0.1 ) 0%,rgba( 236,155,255,0.12 ) 34%,rgba( 242,82,252,0.1 ) 58%,rgba( 147,240,198,0.09 ) 100% ) );--_holo-edge:var( --os-ui-holo-edge,linear-gradient( 124deg,rgba( 154,242,255,0.7 ) 0%,rgba( 236,155,255,0.85 ) 38%,rgba( 242,82,252,0.7 ) 62%,rgba( 159,152,255,0.6 ) 100% ) );--_holo-edge-quiet:var( --os-ui-holo-edge-quiet,linear-gradient( 124deg,rgba( 154,242,255,0.22 ) 0%,rgba( 236,155,255,0.28 ) 38%,rgba( 242,82,252,0.22 ) 62%,rgba( 159,152,255,0.2 ) 100% ) );--_holo-glow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) );--_holo-glow-strong:var( --os-ui-holo-glow-strong,0 0 0 1px rgba( 242,82,252,0.42 ),0 4px 18px rgba( 242,82,252,0.38 ),0 1px 3px rgba( 12,11,15,0.6 ) );--_holo-track:var( --os-ui-holo-track,rgba( 255,251,255,0.16 ) );--_holo-track-edge:var( --os-ui-holo-track-edge,#8c8f94 );--_holo-ring-color:var( --os-ui-accent-dim,#2271b1 );--_holo-focus:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #f252fc,0 0 12px 2px rgba( 242,82,252,0.45 ) );--_holo-focus-field:var( --os-ui-focus-ring-field,0 0 0 1px #f252fc,0 0 0 4px rgba( 242,82,252,0.18 ) );--_holo-t:var( --os-ui-holo-transition,220ms );--_holo-t-fast:var( --os-ui-motion-fast,140ms );--_holo-t-slow:var( --os-ui-motion-slow,340ms );--_holo-t-ambient:var( --os-ui-motion-ambient,12s );--_holo-spring:var( --os-ui-ease-spring,cubic-bezier( 0.32,1.5,0.55,1 ) );--_holo-ease:var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) );--_holo-loop:var( --os-ui-ease-loop,cubic-bezier( 0.45,0,0.55,1 ) )}`,Ct=v` .os-holo-fill{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --_holo-ink );transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease}.os-holo-fill:hover{background-position:74% 66%}.os-holo-fill:active{background-position:88% 82%;filter:brightness( 0.94 )}@media ( prefers-reduced-motion:reduce ){.os-holo-fill{transition-duration:1ms}.os-holo-fill:hover,.os-holo-fill:active{background-position:22% 28%}}`,At=v` .os-holo-sheen{position:relative;isolation:isolate}.os-holo-sheen::before{content:'';position:absolute;inset:0;z-index:-1;border-radius:inherit;background-image:var( --_holo-sheen );background-size:200% 200%;background-position:20% 30%;opacity:0;pointer-events:none;transition:opacity var( --_holo-t ) ease,background-position var( --_holo-t ) ease}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{opacity:1;background-position:76% 68%}@media ( prefers-reduced-motion:reduce ){.os-holo-sheen::before{transition-duration:1ms}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{background-position:20% 30%}}`,Tt=v` .os-holo-edge{position:relative}.os-holo-edge::after{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;background-image:var( --_holo-edge-quiet );opacity:0;pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude;transition:opacity var( --_holo-t ) ease}.os-holo-edge:hover::after,.os-holo-edge:focus-visible::after{background-image:var( --_holo-edge );opacity:1}.os-holo-edge.is-lit::after{background-image:var( --_holo-edge );opacity:1}@media ( prefers-reduced-motion:reduce ){.os-holo-edge::after{transition-duration:1ms}}`,Mt=v` .os-holo-glint{position:absolute;inset:0;border-radius:inherit;overflow:hidden;pointer-events:none}.os-holo-glint::before{content:'';position:absolute;top:-60%;bottom:-60%;width:45%;inset-inline-start:-60%;background:linear-gradient( 90deg,transparent 0%,rgba( 255,251,255,0.14 ) 45%,rgba( 255,251,255,0.22 ) 50%,rgba( 255,251,255,0.14 ) 55%,transparent 100% );transform:rotate( 18deg ) translateX( 0 );opacity:0}:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:os-holo-glint var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-glint{0%{opacity:0;transform:rotate( 18deg ) translateX( 0 )}15%{opacity:1}85%{opacity:1}100%{opacity:0;transform:rotate( 18deg ) translateX( 240vw )}}@media ( prefers-reduced-motion:reduce ){:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:none}}`,Nt=v` .os-holo-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:0 0 0 0 var( --_holo-ring-color );opacity:0;pointer-events:none}:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:os-holo-ring var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-ring{0%{opacity:0.45;box-shadow:0 0 0 0 var( --_holo-ring-color )}100%{opacity:0;box-shadow:0 0 0 10px transparent}}@media ( prefers-reduced-motion:reduce ){:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:none}}`,St=v` .os-holo-shimmer{background-image:var( --_holo-fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}@keyframes os-holo-shimmer{0%{background-position:0% 50%}100%{background-position:100% 50%}}@media ( prefers-reduced-motion:reduce ){.os-holo-shimmer{animation:none;background-position:30% 50%}}`,Pt=v` .os-holo-enter{animation:os-holo-enter var( --_holo-t ) var( --_holo-spring )}@keyframes os-holo-enter{from{opacity:0;transform:scale( 0.96 )}}@media ( prefers-reduced-motion:reduce ){.os-holo-enter{animation:none}}`,Me=v` input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):hover:not(:disabled ),select:hover:not(:disabled ),textarea:hover:not(:disabled ){border-color:var( --os-ui-border-strong,#8c8f94 )}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus,input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus-visible,select:focus,select:focus-visible,textarea:focus,textarea:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}input::placeholder,textarea::placeholder{color:var( --os-ui-fg-faint,#8c8f94 );opacity:1}input::selection,textarea::selection{background:var( --os-ui-selection-bg,rgba( 159,152,255,0.6 ) );color:var( --os-ui-selection-fg,#fffbff )}@media ( prefers-reduced-motion:reduce ){input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition-duration:1ms}}`,Lt=v` input[ type='checkbox' ],input[ type='radio' ]{appearance:none;-webkit-appearance:none;position:relative;flex:0 0 auto;box-sizing:border-box;width:16px;height:16px;margin:0;padding:0;border:1px solid var( --_holo-track-edge );border-radius:4px;background-color:var( --_holo-track );background-image:none;background-repeat:no-repeat;cursor:inherit;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='radio' ]{border-radius:50%}input[ type='checkbox' ]:hover:not(:disabled ),input[ type='radio' ]:hover:not(:disabled ){border-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:focus-visible,input[ type='radio' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked,input[ type='checkbox' ]:indeterminate,input[ type='radio' ]:checked{border-color:transparent;background-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:checked:focus-visible,input[ type='radio' ]:checked:focus-visible{box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:46%;width:3.5px;height:7.5px;border:solid var( --os-ui-fg-on-accent,#fff );border-width:0 2px 2px 0;transform:translate( -50%,-50% ) rotate( 45deg );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:indeterminate::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:8px;height:2px;border:0;border-radius:1px;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% )}input[ type='radio' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:6px;height:6px;border-radius:50%;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:disabled,input[ type='radio' ]:disabled{cursor:not-allowed}@keyframes os-holo-tick{from{opacity:0;transform:translate( -50%,-50% ) rotate( 45deg ) scale( 0.4 )}}@media ( prefers-reduced-motion:reduce ){input[ type='checkbox' ]:checked::after,input[ type='radio' ]:checked::after{animation:none}}`,$t=v` @keyframes os-holo-drift{0%{background-position:16% 26%}50%{background-position:84% 74%}100%{background-position:16% 26%}}.os-holo-alive{animation:os-holo-drift var( --_holo-t-ambient ) var( --_holo-loop ) infinite}@media ( prefers-reduced-motion:reduce ){.os-holo-alive{animation:none}}`;v` ${Te} ${Ct} ${At} ${Tt} ${Mt} ${Nt} ${St} ${Pt} ${Me} ${Lt} ${$t} `;const Rt=v` ${Te} ${Me}:host{--_field-size:var( --os-ui-field-font-size,13px );--_field-radius:var( --os-ui-field-radius,6px );display:flex;flex-direction:column;gap:4px;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-textarea__label{font-size:12px;color:var( --os-ui-fg-muted,#646970 )}textarea{appearance:none;-webkit-appearance:none;display:block;width:100%;min-width:0;box-sizing:border-box;padding:8px 10px;background:var( --os-window-bg,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:var( --_field-radius );font:inherit;font-size:var( --_field-size );line-height:1.45;color:var( --os-ui-fg,#1d2327 );resize:vertical}textarea:disabled{opacity:0.55;cursor:not-allowed;background:var( --os-ui-hover,rgba( 0,0,0,0.03 ) )}textarea[ aria-invalid='true' ],textarea[ aria-invalid='true' ]:hover:not(:disabled ){border-color:var( --os-ui-danger,#d63638 )}textarea[ aria-invalid='true' ]:focus,textarea[ aria-invalid='true' ]:focus-visible{border-color:var( --os-ui-danger,#d63638 );box-shadow:0 0 0 1px var( --os-ui-danger,#d63638 ),0 0 0 4px rgba( 214,54,56,0.18 )}:host( [ auto-grow ] ) textarea{resize:none;overflow:hidden}`,B=class B extends S{constructor(){super(...arguments),this._textareaEl=null}connectedCallback(){super.connectedCallback(),vt(this)}render(){const e=this._attr("label")||"",t=this._attr("value")??"",s=this._attr("placeholder")||"",n=this._boolAttr("disabled"),i=this._boolAttr("readonly"),r=this._attr("aria-label")||e,l=this._attr("name")||"",a=Number(this._attr("rows"))||3,c=this._attr("maxlength"),d=this._attr("minlength"),h=this._boolAttr("invalid"),f=`${this.id||"os-unnamed"}__field`;return b`
		...
		`}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._paintSvg()),queueMicrotask(()=>this._wireActivateEvent())}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),queueMicrotask(()=>this._paintSvg())}_paintSvg(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector("svg"),s=e.querySelector("[data-svg-buffer]");if(t&&s){const n=s.textContent||"";t.innerHTML!==n&&(t.innerHTML=n)}}_wireActivateEvent(){if(this._activateWired)return;const e=this.shadowRoot;if(!e)return;const t=e.querySelector("button");t&&(this._activateWired=!0,t.addEventListener("click",()=>{this.hasAttribute("disabled")||this.dispatchEvent(new CustomEvent("os-button-activate",{bubbles:!0,composed:!0,cancelable:!0}))}))}};W.props=["icon","icon-src","active","danger","disabled"],W.styles=[zt],W.help=void 0;let ne=W;j("os-window-button",ne);let ie=null;function re(){return!!window.openStationShellOverlays}function Ot(o){return new Promise((e,t)=>{const s=document.querySelector('script[data-os-shell-overlays="1"]'),n=()=>{if(re()){e();return}t(new Error("[openstation] shell-overlays bundle loaded but did not set `window.openStationShellOverlays`."))};if(s){re()?n():(s.addEventListener("load",n),s.addEventListener("error",()=>t(new Error("failed to load shell-overlays bundle"))));return}const i=document.createElement("script");i.src=o,i.async=!0,i.dataset.osShellOverlays="1",i.addEventListener("load",n),i.addEventListener("error",()=>t(new Error("failed to load shell-overlays bundle"))),document.head.appendChild(i)})}function Dt(o){return re()||!o?Promise.resolve():(ie||(ie=Ot(o)),ie)}function Vt(){return window.openStationConfig?.shellOverlaysBundleUrl??""}async function Ft(o){return await Dt(Vt()),new Promise(e=>{const t=document.createElement("os-confirm-dialog");t.setAttribute("open",""),o.title&&t.setAttribute("title",o.title),t.setAttribute("message",o.message),o.confirmLabel&&t.setAttribute("confirm-label",o.confirmLabel),o.cancelLabel&&t.setAttribute("cancel-label",o.cancelLabel),o.danger&&t.setAttribute("danger",""),o.hideCancel&&t.setAttribute("hide-cancel",""),o.dismissable&&t.setAttribute("dismissable",""),o.rememberLabel&&t.setAttribute("remember-label",o.rememberLabel);const s=n=>{t.remove(),e(n)};t.addEventListener("os-confirm",n=>{o.onRemember?.(n.detail?.remember===!0),s(!0)}),t.addEventListener("os-cancel",()=>s(!1)),document.body.appendChild(t)})}const Ne={close:{a:'fill="currentColor"',b:'<path d="m13.06 12 6.47-6.47-1.06-1.06L12 10.94 5.53 4.47 4.47 5.53 10.94 12l-6.47 6.47 1.06 1.06L12 13.06l6.47 6.47 1.06-1.06L13.06 12Z" />'},check:{a:'fill="currentColor"',b:'<path d="M16.5 7.5 10 13.9l-2.5-2.4-1 1 3.5 3.6 7.5-7.6z" />'},"chevron-right":{a:'fill="currentColor"',b:'<path d="M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z" />'},"arrow-up-right":{a:'fill="currentColor"',b:'<path d="M10 6H18V14H16.5V8.5L7 18L6 17L15.5 7.5H10V6Z" />'},plus:{a:'fill="currentColor"',b:'<path d="M11 12.5V17.5H12.5V12.5H17.5V11H12.5V6H11V11H6V12.5H11Z" />'},search:{a:'fill="currentColor"',b:'<path d="M13 5c-3.3 0-6 2.7-6 6 0 1.4.5 2.7 1.3 3.7l-3.8 3.8 1.1 1.1 3.8-3.8c1 .8 2.3 1.3 3.7 1.3 3.3 0 6-2.7 6-6S16.3 5 13 5zm0 10.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z" />'},pin:{a:'fill="currentColor"',b:'<path d="m21.5 9.1-6.6-6.6-4.2 5.6c-1.2-.1-2.4.1-3.6.7-.1 0-.1.1-.2.1-.5.3-.9.6-1.2.9l3.7 3.7-5.7 5.7v1.1h1.1l5.7-5.7 3.7 3.7c.4-.4.7-.8.9-1.2.1-.1.1-.2.2-.3.6-1.1.8-2.4.6-3.6l5.6-4.1zm-7.3 3.5.1.9c.1.9 0 1.8-.4 2.6l-6-6c.8-.4 1.7-.5 2.6-.4l.9.1L15 4.9 19.1 9l-4.9 3.6z" />'},trash:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.5A2.25 2.25 0 0 0 9.878 7h4.244A2.251 2.251 0 0 0 12 5.5ZM12 4a3.751 3.751 0 0 0-3.675 3H5v1.5h1.27l.818 8.997a2.75 2.75 0 0 0 2.739 2.501h4.347a2.75 2.75 0 0 0 2.738-2.5L17.73 8.5H19V7h-3.325A3.751 3.751 0 0 0 12 4Zm4.224 4.5H7.776l.806 8.861a1.25 1.25 0 0 0 1.245 1.137h4.347a1.25 1.25 0 0 0 1.245-1.137l.805-8.861Z" />'},download:{a:'fill="currentColor"',b:'<path d="M18 11.3l-1-1.1-4 4V3h-1.5v11.3L7 10.2l-1 1.1 6.2 5.8 5.8-5.8zm.5 3.7v3.5h-13V15H4v5h16v-5h-1.5z" />'},settings:{a:'fill="currentColor"',b:'<path d="m19 7.5h-7.628c-.3089-.87389-1.1423-1.5-2.122-1.5-.97966 0-1.81309.62611-2.12197 1.5h-2.12803v1.5h2.12803c.30888.87389 1.14231 1.5 2.12197 1.5.9797 0 1.8131-.62611 2.122-1.5h7.628z" /><path d="m19 15h-2.128c-.3089-.8739-1.1423-1.5-2.122-1.5s-1.8131.6261-2.122 1.5h-7.628v1.5h7.628c.3089.8739 1.1423 1.5 2.122 1.5s1.8131-.6261 2.122-1.5h2.128z" />'},info:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm.75 4v1.5h-1.5V8h1.5Zm0 8v-5h-1.5v5h1.5Z" />'},bell:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M17 11.5c0 1.353.17 2.368.976 3 .266.209.602.376 1.024.5v1H5v-1c.422-.124.757-.291 1.024-.5.806-.632.976-1.647.976-3V9c0-2.8 2.2-5 5-5s5 2.2 5 5v2.5ZM15.5 9v2.5c0 .93.066 1.98.515 2.897l.053.103H7.932a4.018 4.018 0 0 0 .053-.103c.449-.917.515-1.967.515-2.897V9c0-1.972 1.528-3.5 3.5-3.5s3.5 1.528 3.5 3.5Zm-5.492 9.008c0-.176.023-.346.065-.508h3.854A1.996 1.996 0 0 1 12 20c-1.1 0-1.992-.892-1.992-1.992Z" />'},more:{a:'fill="currentColor"',b:'<path d="M11 13h2v-2h-2v2zm-6 0h2v-2H5v2zm12-2v2h2v-2h-2z" />'},maximize:{a:'fill="currentColor"',b:'<path d="M6 4a2 2 0 0 0-2 2v3h1.5V6a.5.5 0 0 1 .5-.5h3V4H6Zm3 14.5H6a.5.5 0 0 1-.5-.5v-3H4v3a2 2 0 0 0 2 2h3v-1.5Zm6 1.5v-1.5h3a.5.5 0 0 0 .5-.5v-3H20v3a2 2 0 0 1-2 2h-3Zm3-16a2 2 0 0 1 2 2v3h-1.5V6a.5.5 0 0 0-.5-.5h-3V4h3Z" />'},edit:{a:'fill="currentColor"',b:'<path d="m19 7-3-3-8.5 8.5-1 4 4-1L19 7Zm-7 11.5H5V20h7v-1.5Z" />'},color:{a:'fill="currentColor"',b:'<path d="M17.2 10.9c-.5-1-1.2-2.1-2.1-3.2-.6-.9-1.3-1.7-2.1-2.6L12 4l-1 1.1c-.6.9-1.3 1.7-2 2.6-.8 1.2-1.5 2.3-2 3.2-.6 1.2-1 2.2-1 3 0 3.4 2.7 6.1 6.1 6.1s6.1-2.7 6.1-6.1c0-.8-.3-1.8-1-3zm-5.1 7.6c-2.5 0-4.6-2.1-4.6-4.6 0-.3.1-1 .8-2.3.5-.9 1.1-1.9 2-3.1.7-.9 1.3-1.7 1.8-2.3.7.8 1.3 1.6 1.8 2.3.8 1.1 1.5 2.2 2 3.1.7 1.3.8 2 .8 2.3 0 2.5-2.1 4.6-4.6 4.6z" />'},wallpaper:{a:'fill="currentColor"',b:'<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM5 4.5h14c.3 0 .5.2.5.5v8.4l-3-2.9c-.3-.3-.8-.3-1 0L11.9 14 9 12c-.3-.2-.6-.2-.8 0l-3.6 2.6V5c-.1-.3.1-.5.4-.5zm14 15H5c-.3 0-.5-.2-.5-.5v-2.4l4.1-3 3 1.9c.3.2.7.2.9-.1L16 12l3.5 3.4V19c0 .3-.2.5-.5.5z" />'},warning:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-.75 12v-1.5h1.5V16h-1.5Zm0-8v5h1.5V8h-1.5Z" />'},minimize:{a:'fill="currentColor"',b:'<path d="M5 11.25h14v1.5H5z" />'},window:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="5.4375" width="15.75" height="13.125" rx="1.75"/><path d="M4.125 9.8125h15.75"/><circle cx="7.275" cy="7.625" r="0.7438" fill="currentColor" stroke="none"/>'},windows:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="8.5" width="11.375" height="10.0625" rx="1.75"/><path d="M3.6875 12h11.375"/><path d="M8.5 8.5V7.1875a1.75 1.75 0 0 1 1.75-1.75h7.875A1.75 1.75 0 0 1 19.875 7.1875v7a1.75 1.75 0 0 1-1.75 1.75h-3.0625"/>'},dock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.25" y="8.5" width="17.5" height="7" rx="3.5"/><circle cx="7.625" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="16.375" cy="12" r="1.0062" fill="currentColor" stroke="none"/>'},spaces:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><rect x="12.875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><circle cx="9.375" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="12" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="14.625" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/>'},copilot:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M10 2.5Q10.9 8.5 17.5 10Q10.9 11.5 10 17.5Q9.1 11.5 2.5 10Q9.1 8.5 10 2.5Z" fill="currentColor" stroke="none"/><path d="M17.9 14Q18.35 17.1 21.5 17.6Q18.35 18.1 17.9 21.2Q17.45 18.1 14.3 17.6Q17.45 17.1 17.9 14Z" fill="currentColor" stroke="none"/>'},snap:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="16.625" height="13.125" rx="1.75"/><path d="M12 5.4375v13.125"/><path d="M12 12h8.3125"/>'},command:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M14.625 6.75v10.5a2.625 2.625 0 1 0 2.625-2.625H6.75a2.625 2.625 0 1 0 2.625 2.625V6.75a2.625 2.625 0 1 0-2.625 2.625h10.5a2.625 2.625 0 1 0-2.625-2.625"/>'},apps:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="4.125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/>'},widgets:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="3.6875" width="9.625" height="9.625" rx="1.75"/><rect x="15.0625" y="3.6875" width="5.25" height="5.25" rx="1.75"/><rect x="15.0625" y="10.6875" width="5.25" height="9.625" rx="1.75"/><rect x="3.6875" y="15.0625" width="9.625" height="5.25" rx="1.75"/>'},user:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<circle cx="12" cy="8.9375" r="3.5"/><path d="M5.4375 19.4375a6.5625 6.5625 0 0 1 13.125 0"/>'},lock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="5.4375" y="10.6875" width="13.125" height="8.75" rx="1.75"/><path d="M8.5 10.6875V8.0625a3.5 3.5 0 0 1 7 0v2.625"/>'}};function Se(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Bt(o){return Object.prototype.hasOwnProperty.call(Ne,o)?Ne[o]:null}function Wt(o,e={}){const t=Bt(o);if(!t)return"";const{size:s=24,className:n,title:i,rotate:r}=e,l=['xmlns="http://www.w3.org/2000/svg"','viewBox="0 0 24 24"'];s!=null&&l.push(`width="${s}"`,`height="${s}"`),l.push(t.a),n&&l.push(`class="${Se(n)}"`),i?l.push('role="img"',`aria-label="${Se(i)}"`):l.push('aria-hidden="true"','focusable="false"');const a=r?`<g transform="rotate(${r} 12 12)">${t.b}</g>`:t.b;return`<svg ${l.join(" ")}>${a}</svg>`}const A={START:"os.drag.start",MOVE:"os.drag.move",ENTER:"os.drag.enter",LEAVE:"os.drag.leave"},N=["butter","blush","sky","mint","lilac","peach"];function Ut(o){return N.includes(o)?o:N[0]}function ae(o){return o.toLowerCase().replace(/[^a-z0-9_-]/g,"")||N[0]}function Pe(o){const e=N.indexOf(Ut(o));return N[(e+1)%N.length]}const Le="cubic-bezier(0.2, 0.7, 0.2, 1)",$e="cubic-bezier(0.5, 0, 0.9, 0.4)",Xt="cubic-bezier(0.2, 0.7, 0.3, 1.15)";function P(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function w(o,e,t){return typeof o.animate!="function"?Promise.resolve():o.animate(e,t).finished.then(()=>{}).catch(()=>{})}async function jt(o){const e=o.restRotation??0;if(P()){Re(o.rippleHost,400);return}const t=o.tempo??1,s=o.fallDistance??30;await w(o.pin,[{opacity:0,transform:`translate(8px, ${-s}px) rotate(${e-16}deg) scale(1.9)`},{opacity:1,offset:.35},{opacity:1,transform:`translate(0, 0) rotate(${e}deg) scale(0.92)`}],{duration:170*t,easing:$e,fill:"forwards"}),Re(o.rippleHost,420*t);const n=w(o.paper,[{transform:"scale(1) translateY(0) skewX(0)"},{transform:"scale(0.982) translateY(2px) skewX(0)",offset:.08},{transform:"scale(1.01) translateY(0) skewX(0.6deg)",offset:.32},{transform:"scale(0.996) translateY(0) skewX(-0.4deg)",offset:.55},{transform:"scale(1) translateY(0) skewX(0)"}],{duration:370*t,easing:"linear"}),i=w(o.pin,[{transform:`rotate(${e}deg) scale(0.92)`},{transform:`rotate(${e+1.5}deg) scale(1.07)`,offset:.25},{transform:`rotate(${e-1}deg) scale(0.98)`,offset:.5},{transform:`rotate(${e}deg) scale(1)`}],{duration:370*t,easing:Le,fill:"forwards"});await Promise.all([n,i])}function Re(o,e){const t=document.createElement("span");t.className="os-pinned-note__ripple",t.setAttribute("aria-hidden","true"),o.appendChild(t),w(t,[{boxShadow:"0 0 0 0 rgba(0, 0, 0, 0.28)",opacity:.35},{boxShadow:"0 0 0 26px rgba(0, 0, 0, 0)",opacity:0}],{duration:e,easing:"ease-out"}).then(()=>t.remove()),window.setTimeout(()=>t.remove(),e+100)}function Yt(o){if(P())return{onPointerMove:()=>{},setBias:()=>{},stop:()=>{}};const e=14;let t=0,s=0,n=0,i=0,r=null,l=0,a=0,c=0,d=0,h=!0;const m=f=>{if(!h)return;const p=Math.min(.05,d?(f-d)/1e3:.016);d=f,f-l>80&&(a*=.85),n=Math.max(-14,Math.min(14,-a*.055))+i,s+=(-120*(t-n)-e*s)*p,t+=s*p,o.style.transform=`rotate(${t.toFixed(2)}deg)`,c=window.requestAnimationFrame(m)};return c=window.requestAnimationFrame(m),{onPointerMove(f){const p=performance.now();if(r!==null&&p>l){const _=(f-r)/(p-l)*16.7;a=a*.7+_*.3}r=f,l=p},setBias(f){i=f},stop(){h=!1,window.cancelAnimationFrame(c),o.style.transform=""}}}async function qt(o){if(P()){await w(o.flyback,[{opacity:1},{opacity:0}],{duration:120,easing:"linear",fill:"forwards"});return}const e=o.swing?w(o.swing,[{transform:"rotate(0deg)"},{transform:"rotate(9deg)",offset:.35},{transform:"rotate(-4deg)",offset:.7},{transform:"rotate(0deg)"}],{duration:330,easing:"linear",fill:"forwards"}):Promise.resolve(),t=w(o.flyback,[{left:`${o.flyback.offsetLeft}px`,top:`${o.flyback.offsetTop}px`},{left:`${o.homeX}px`,top:`${o.homeY}px`}],{duration:330,easing:Xt,fill:"forwards"});await Promise.all([t,e])}async function Zt(o){if(P()){await w(o.clone,[{opacity:1},{opacity:0}],{duration:150,easing:"linear",fill:"forwards"});return}o.pin&&w(o.pin,[{transform:"translate(0, 0) rotate(0deg)",opacity:1},{transform:"translate(2px, -16px) rotate(-30deg)",opacity:0}],{duration:200,easing:Le,fill:"forwards"});const e=o.clone.getBoundingClientRect(),t=o.binX-(e.left+e.width/2),s=o.binY-(e.top+e.height/2),n="polygon(4% 8%, 38% 2%, 68% 7%, 96% 3%, 98% 42%, 92% 71%, 97% 94%, 60% 98%, 30% 93%, 3% 97%, 6% 62%, 2% 34%)",i="polygon(10% 14%, 42% 6%, 64% 12%, 90% 8%, 94% 38%, 86% 66%, 92% 88%, 58% 94%, 34% 86%, 10% 92%, 14% 58%, 8% 36%)";await w(o.paper,[{transform:"translate(0, 0) scale(0.88) rotate(0deg)",borderRadius:"2px",opacity:1},{transform:`translate(${t*.3}px, ${s*.3}px) scale(0.6) rotate(12deg)`,clipPath:n,offset:.3},{transform:`translate(${t*.6}px, ${s*.6}px) scale(0.34) rotate(24deg)`,clipPath:i,offset:.6,opacity:1},{transform:`translate(${t}px, ${s}px) scale(0.12) rotate(38deg)`,borderRadius:"50%",clipPath:i,opacity:0}],{duration:400,easing:$e,delay:60,fill:"forwards"})}function Kt(o){let e=2166136261;for(let s=0;s<o.length;s++)e^=o.charCodeAt(s),e=Math.imul(e,16777619)>>>0;return e>>>1||1}function ze(o){let e=2166136261;const t=`os-note-${o}`;for(let i=0;i<t.length;i++)e^=t.charCodeAt(i),e=Math.imul(e,16777619)>>>0;const s=e>>>3,n=e>>>5;return{rotation:(e%45-22)/10,pinOffsetX:s%21-10,pinRotation:n%17-8}}const Gt=.57,Qt=.525,Jt=56,eo=52;function to(o){return`${o.replace(/\/$/,"")}/assets/images/pushpin.svg`}function oo(o){const e=document.createElement("img");return e.src=to(o),e.alt="",e.width=Jt,e.height=eo,e.draggable=!1,e.className="os-pinned-note__pin-img",e}const Ie="X-WP-Nonce";function so(o,e){const t=no();if(!t)return e;const s=io(o);if(!s||!ro(s))return e;const n=e?.headers??(typeof Request<"u"&&o instanceof Request?o.headers:void 0),i=new Headers(n??{});return i.has(Ie)?e:(i.set(Ie,t),{...e??{},headers:i})}function no(){if(typeof window>"u")return;const e=window.openStationConfig?.restNonce;return typeof e=="string"&&e.length>0?e:void 0}function io(o){try{const e=typeof window<"u"&&window.location?window.location.href:void 0;return typeof o=="string"?new URL(o,e):o instanceof URL?o:typeof Request<"u"&&o instanceof Request?new URL(o.url,e):null}catch{return null}}function ro(o){return typeof window>"u"||!window.location||o.origin!==window.location.origin?!1:!!(o.pathname.includes("/wp-json/")||o.searchParams.has("rest_route"))}function ao(o,e,t={}){const s=window.wp?.os?.fetch;if(typeof s=="function")return s(o,e,t);const n=so(o,e);return fetch(o,n)}const lo="http://localhost/";function co(o,e){const t=typeof window<"u"&&window.location?window.location.href:lo,s=new URL(o,t),n=e.replace(/^\/+/,""),i=n.indexOf("?"),r=i===-1?n:n.slice(0,i),l=i===-1?"":n.slice(i+1);if(s.searchParams.has("rest_route")){const a=s.searchParams.get("rest_route")??"/",c=a.endsWith("/")?a:a+"/";s.searchParams.set("rest_route",c+r)}else{const a=s.pathname.endsWith("/")?s.pathname:s.pathname+"/";s.pathname=a+r}return l&&new URLSearchParams(l).forEach((c,d)=>{s.searchParams.append(d,c)}),s.toString()}let le=null;function ho(o){le=o}function uo(){if(!le)throw new Error("[openstation] notes REST client called before installNotesRestDeps().");return le}function po(o){const e=window.openStationConfig;return typeof e?.restNonce=="string"&&e.restNonce?e.restNonce:o}class He extends Error{constructor(e){super("Note was changed by another session."),this.status=409,this.name="NotesConflictError",this.current=e}}function fo(o){return o instanceof He}async function L(o,e){const{baseUrl:t,nonce:s}=uo(),n=o?co(t,o):t,i=new Headers(e.headers??{});i.set("X-WP-Nonce",po(s)),e.body&&!i.has("Content-Type")&&i.set("Content-Type","application/json");const r=await ao(n,{...e,headers:i,credentials:"same-origin"},{source:"desktop-mode/notes"}),l=await r.text();let a=null;if(l)try{a=JSON.parse(l)}catch{a=null}if(!r.ok){if(r.status===409){const d=a?.data?.current;throw new He(d??null)}const c=a;throw new Error(`[openstation] notes REST ${r.status}: ${c?.code??""} ${c?.message??""}`.trim())}if(a===null)throw new Error(`[openstation] notes REST ${r.status}: empty or unparseable body.`);return a}function Oe(){return L("",{method:"GET"})}function mo(o){return L("",{method:"POST",body:JSON.stringify(o)})}function go(o,e){return L(`/${o}`,{method:"PATCH",body:JSON.stringify(e)})}function vo(o){return L(`/${o}`,{method:"DELETE"})}function De(o){return L(`/${o}/restore`,{method:"POST"})}function bo(o){return L(`/${o}/convert`,{method:"POST"})}const Ve="__openStationSharedStores";function yo(){const o=window;let e=o[Ve];return e||(e=new Map,o[Ve]=e),e}function $(o,e){const t=yo();let s=t.get(o);s||(s={state:e(),listeners:new Set,rebuild:e},t.set(o,s));const n={get state(){return s.state},set state(i){s.state=i},getState(){return s.state},notify(){for(const i of Array.from(s.listeners))try{i(s.state)}catch(r){console.error(`[desktop-mode/shared-store:${o}] subscriber threw:`,r)}},subscribe(i){return s.listeners.add(i),()=>{s.listeners.delete(i)}},setState(i){const r=s.state;if(typeof r!="object"||r===null){console.warn(`[desktop-mode/shared-store:${o}] setState called on a primitive store; use the state setter instead.`);return}Object.assign(r,i),n.notify()},reset(){const i=s.rebuild(),r=s.state;if(typeof r=="object"&&r!==null&&typeof i=="object"&&i!==null){const l=r;for(const a of Object.keys(l))delete l[a];Object.assign(l,i)}else s.state=i;s.listeners.clear()}};return n}const I=$("desktop-mode/heartbeat-bus",()=>({suppliers:new Map,subscribers:new Map,booted:!1})),Fe={contribute(o,e){return I.state.suppliers.set(o,e),()=>{I.state.suppliers.get(o)===e&&I.state.suppliers.delete(o)}},subscribe(o,e){let t=I.state.subscribers.get(o);return t||(t=new Set,I.state.subscribers.set(o,t)),t.add(e),()=>{t.delete(e)}}},ce="wpd_note",wo="note-draft",R="note",_o="os-note-created",xo="openstation_notes",ko="openstation_notes_subscribe",Eo=xo;let Be=!1,de=null;function Co(o){de=o,!Be&&(Be=!0,Fe.contribute(ko,()=>de?.getHeartbeatSubscription()),Fe.subscribe(Eo,e=>{de?.applyHeartbeatPayload(e)}))}const k=$("openstation/trash-optimistic",()=>({changes:new Map,reconcile:new Set})),Ao=o=>`${o.type}:${o.id}`;function We(o){return{subtitle:"",mime:"",preview:"",icon:"",deleted_at:new Date().toISOString(),deleted_by:"",deleted_by_id:0,can_restore:!1,can_purge:!1,edit_link:"",...o}}function Ue(o,e="in"){const t=Ao(o);if(k.state.changes.get(t)?.pending)return null;const s={item:o,direction:e,pending:!0};return k.state.changes.set(t,s),k.notify(),{async finish(n){k.state.changes.get(t)!==s||!s.pending||(s.pending=!1,n&&(k.notify(),await Promise.allSettled(Array.from(k.state.reconcile,async i=>i()))),k.state.changes.get(t)===s&&(k.state.changes.delete(t),k.notify()))}}}function H(){const o=window.wp?.hooks;if(!o)throw new Error("[openstation] `window.wp.hooks` is not available. The plugin declares `wp-hooks` as a script dependency; if you are seeing this error, verify the enqueue order.");return o}function To(o,e,t,s){H().addFilter(o,e,t,s)}function Y(o,e,t,s){H().addAction(o,e,t,s)}function Mo(o,e){return H().removeAction(o,e)}function he(o,e,...t){return H().applyFilters(o,e,...t)}function Xe(o,...e){H().doAction(o,...e)}const q={BROADCAST:"os.broadcast",WINDOW_OPENED:"os.window.opened",WINDOW_CLOSED:"os.window.closed",DOCK_AFTER_RENDER:"os.dock.after-render"},No="os.activity.";function ue(o){return No+String(o).replace(/[^a-zA-Z0-9_.-]/g,".")}let So=0;const Po={publish(o,e){Xe(ue(o),e)},subscribe(o,e){const t=`os/activity-sub/${++So}`,s=ue(o);Y(s,t,i=>e(i));let n=!1;return()=>{n||(n=!0,Mo(s,t))}},filter(o,e,...t){return he(ue(o),e,...t)}},Lo="os-broadcast";function $o(o,e){const t=String(he("os.broadcast.topic",o,{payload:e})??o),s=he("os.broadcast.payload",e,{topic:t}),n={topic:t,payload:s};document.dispatchEvent(new CustomEvent(Lo,{detail:n})),Xe(q.BROADCAST,n),Po.publish(t,s)}function Ro(o,e,t,s=""){const n=(Array.isArray(t)?t:[t]).map(r=>Math.floor(Number(r))).filter(r=>Number.isFinite(r)&&r>0),i=String(o).trim();i===""||n.length===0||$o(`os.${i}.changed`,{source:s,action:e,ids:n})}function Z(o,e){Ro(ce,o,e,"desktop-mode/notes")}function je(){const o=window.wp?.os;return o&&typeof o.showToast=="function"?o:null}async function zo(o,e){const t=Ue(We({id:o.id,type:ce,title:o.text}));if(t){e.onEvict(o.id);try{await vo(o.id),Z("trashed",[o.id]),t.finish(!0),je()?.showToast?.({message:u("Note moved to Trash","desktop-mode"),duration:6e3,action:{label:u("Undo","desktop-mode"),onClick:()=>{const s=Ue(We({id:o.id,type:ce,title:o.text}),"out");De(o.id).then(n=>{Z("untrashed",[o.id]),e.onRestore(n),s?.finish(!0)}).catch(n=>{s?.finish(!1),console.error("[openstation] notes: restore failed:",n)})}}})}catch(s){console.error("[openstation] notes: trash failed:",s),t.finish(!1),e.onRestore(o),je()?.showToast?.({message:u("Could not move the note to the Trash.","desktop-mode"),duration:5e3})}}}function K(){return window.wp?.os??null}function Io(o){const e=K();if(!e?.windowManager?.open||!e.deriveWindowId)return window.location.href=o,null;const t=e.deriveWindowId(o);return e.windowManager.open({id:t,baseId:t,url:o,title:u("Edit draft","desktop-mode"),icon:"dashicons-admin-post"}),t}async function Ho(o,e){e.onEvict(o.id);try{const t=await bo(o.id);Z("trashed",[o.id]);const s=Io(t.editUrl);K()?.showToast?.({message:u("Note converted to a draft post","desktop-mode"),duration:6e3,action:{label:u("Undo","desktop-mode"),onClick:()=>{s&&K()?.windowManager?.getById?.(s)?.close?.(),De(o.id).then(n=>{Z("untrashed",[o.id]),e.onRestore(n)}).catch(n=>{console.error("[openstation] notes: convert undo failed:",n)})}}})}catch(t){console.error("[openstation] notes: convert failed:",t),e.onRestore(o),K()?.showToast?.({message:u("Could not convert the note to a post.","desktop-mode"),duration:5e3})}}const Oo=Object.freeze({top:0,right:0,bottom:0,left:0});function Do(o,e,t){return{x:t.left,y:t.top,width:Math.max(0,o-t.left-t.right),height:Math.max(0,e-t.top-t.bottom)}}const Vo="os/work-area";function Fo(){return{insets:{...Oo},rect:{x:0,y:0,width:0,height:0},viewport:{x:0,y:0,width:0,height:0},area:{width:0,height:0}}}const pe=$(Vo,()=>({snapshot:Fo(),installed:!1,areaEl:null}));function Bo(o){const e=o??pe.state.areaEl;if(!e)return{...pe.state.snapshot.rect};const t=e.clientWidth||e.getBoundingClientRect().width,s=e.clientHeight||e.getBoundingClientRect().height;return Do(t,s,pe.state.snapshot.insets)}const Wo=208,Uo=1e3,Xo=800,jo=10,Yo=1;function qo(){return window.wp?.os?.dragManager??null}function G(o){return o.seed||Math.abs(o.id)||1}const Zo='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor" aria-hidden="true" focusable="false"><path d="m7.3 9.7 1.4 1.4c.2-.2.3-.3.4-.5 0 0 0-.1.1-.1.3-.5.4-1.1.3-1.6L12 7 9 4 7.2 6.5c-.6-.1-1.1 0-1.6.3 0 0-.1 0-.1.1-.3.1-.4.2-.6.4l1.4 1.4L4 11v1h1l2.3-2.3zM4 20h9v-1.5H4V20zm0-5.5V16h16v-1.5H4z" /></svg>',Ko=Wt("trash",{size:20});class Go{constructor(e){this.root=null,this.liveRegion=null,this.controllers=new Map,this.zCounter=1,this.highWaterMs=0,this.tempIdCounter=0,this.host=e.host,this.pluginUrl=e.pluginUrl,this.canCreatePosts=e.canCreatePosts??!1,this.onError=e.onError}async boot(){try{const{notes:e}=await Oe();e.forEach(t=>{this.bumpHighWater(t.updatedAtMs),this.upsertNote(t,{animate:"none"})}),Co(this)}catch(e){e instanceof Error&&console.debug("[openstation] Pinned notes unavailable:",e.message)}}upsertNote(e,t={animate:"none"}){this.ensureRoot(),this.zCounter=Math.max(this.zCounter,e.z);const s=this.controllers.get(e.id);if(s)return s.replace(e),s;const n=new Qo({layer:this,note:e});return this.controllers.set(e.id,n),this.root?.appendChild(n.element),t.animate!=="none"&&n.playInsertion(t.animate==="thunk"?1:.7),n}removeNote(e){const t=this.controllers.get(e);t&&(this.controllers.delete(e),t.dispose(),t.element.remove())}rekeyNote(e,t){this.controllers.delete(e),this.controllers.set(t.note.id,t)}has(e){return this.controllers.has(e)}get(e){return this.controllers.get(e)}nextTempId(){return this.tempIdCounter-=1,this.tempIdCounter}bringToFront(e){this.zCounter+=1,e.setZ(this.zCounter)}bumpHighWater(e){Number.isFinite(e)&&e>this.highWaterMs&&(this.highWaterMs=e)}hostSize(){return{width:Math.max(1,this.host.clientWidth),height:Math.max(1,this.host.clientHeight)}}clampPosition(e,t){const{width:s,height:n}=this.hostSize(),i=Bo(this.host),r=i.x/s,l=i.y/n,a=Math.max(r,(i.x+i.width-Wo)/s),c=Math.max(l,(i.y+i.height-120)/n);return{x:Math.min(a,Math.max(r,e)),y:Math.min(c,Math.max(l,t))}}normalizedFromClient(e,t){const s=this.host.getBoundingClientRect(),{width:n,height:i}=this.hostSize();return this.clampPosition((e-s.left)/n,(t-s.top)/i)}createNoteAt(e){const t=e.text??"",s=ae(e.color??N[0]),n=e.isPublic===!0,{x:i,y:r}=this.clampPosition(e.x,e.y),l=Kt(t||`${i},${r}`),a=this.nextTempId(),c=this.upsertNote({id:a,text:t,color:s,x:i,y:r,z:1,public:n,seed:l,ownerId:0,ownerName:"",ownerAvatar:"",canEdit:!0,updatedAtMs:0},{animate:"thunk"});return this.bringToFront(c),e.focus&&c.focusEditor(),mo({text:t,color:s,x:i,y:r,public:n,seed:l}).then(d=>{this.bumpHighWater(d.updatedAtMs),c.replace(d),this.rekeyNote(a,c),c.flushPendingEdits()}).catch(d=>{this.removeNote(a),this.notifyError(u("Could not pin the note. Please try again.","desktop-mode")),console.error("[openstation] notes: create failed:",d)}),c}announce(e){this.ensureRoot(),this.liveRegion&&(this.liveRegion.textContent=e)}notifyError(e){this.onError?.(e)}trashNote(e){zo(e,{onEvict:t=>this.removeNote(t),onRestore:t=>{this.bumpHighWater(t.updatedAtMs),this.upsertNote(t,{animate:"move"})}})}convertNote(e){!this.canCreatePosts||!e.canEdit||Ho(e,{onEvict:t=>this.removeNote(t),onRestore:t=>{this.bumpHighWater(t.updatedAtMs),this.upsertNote(t,{animate:"move"})}})}getHeartbeatSubscription(){return{knownIds:Array.from(this.controllers.keys()).filter(e=>e>0),sinceMs:this.highWaterMs}}applyHeartbeatPayload(e){for(const t of e.notes??[]){this.bumpHighWater(t.updatedAtMs);const s=this.controllers.get(t.id);s?s.shouldReplaceFromRemote(t)&&s.replace(t):this.upsertNote(t,{animate:"move"})}for(const t of e.removed??[])this.removeNote(t);typeof e.serverTimeMs=="number"&&Number.isFinite(e.serverTimeMs)&&this.bumpHighWater(e.serverTimeMs),e.truncated&&this.reloadFromServer()}async reloadFromServer(){try{const{notes:e}=await Oe(),t=new Set;for(const s of e){t.add(s.id),this.bumpHighWater(s.updatedAtMs);const n=this.controllers.get(s.id);n?n.shouldReplaceFromRemote(s)&&n.replace(s):this.upsertNote(s,{animate:"move"})}for(const s of Array.from(this.controllers.keys()))s>0&&!t.has(s)&&this.removeNote(s)}catch{}}ensureRoot(){if(this.root)return this.root;const e=document.createElement("section");e.className="os-notes",e.setAttribute("aria-label",u("Pinned notes","desktop-mode"));const t=document.createElement("div");return t.className="os-notes__live screen-reader-text",t.setAttribute("aria-live","polite"),e.appendChild(t),this.host.appendChild(e),this.root=e,this.liveRegion=t,e}}class Qo{constructor(e){this.editor=null,this.statusEl=null,this.colorDot=null,this.visibilityBtn=null,this.saveTimer=null,this.zTimer=null,this.patchChain=Promise.resolve(),this.pendingText=null,this.disposed=!1,this.moveMode=!1,this.moveOrigin=null,this.dragCleanup=null,this.lastPointer=null,this.layer=e.layer,this.note=e.note,this.jitter=ze(G(e.note)),this.element=document.createElement("article"),this.paperEl=document.createElement("div"),this.pinEl=document.createElement(this.note.canEdit?"button":"span"),this.paint(),this.applyPosition(),this.setZ(this.note.z),this.element.addEventListener("pointerdown",()=>this.layer.bringToFront(this),{capture:!0})}paint(){const e=this.note;this.element.className="os-pinned-note",this.element.dataset.noteId=String(e.id),this.element.dataset.noteColor=ae(e.color),this.element.dataset.owner=e.canEdit?"me":"other",this.element.setAttribute("role",e.canEdit?"group":"note"),this.element.setAttribute("aria-label",e.canEdit?u("Pinned note","desktop-mode"):J(u("Note by %s","desktop-mode"),e.ownerName)),this.element.style.setProperty("--dm-note-rot",`${this.jitter.rotation}deg`),this.element.style.setProperty("--dm-pin-dx",`${this.jitter.pinOffsetX}px`),this.element.style.setProperty("--dm-pin-rot",`${this.jitter.pinRotation}deg`),this.pinEl.className="os-pinned-note__pin",this.pinEl.appendChild(oo(this.layer.pluginUrl)),e.canEdit?(this.pinEl.setAttribute("type","button"),this.pinEl.setAttribute("aria-pressed","false"),this.pinEl.setAttribute("aria-label",u("Move note. Drag the pin, or press Enter then use the arrow keys.","desktop-mode")),this.pinEl.addEventListener("pointerdown",t=>this.startDrag(t)),this.pinEl.addEventListener("click",t=>{t.detail===0&&!this.moveMode&&this.toggleMoveMode()}),this.pinEl.addEventListener("keydown",t=>this.onPinKeydown(t)),this.pinEl.addEventListener("blur",()=>this.exitMoveMode(!1))):this.pinEl.setAttribute("aria-hidden","true"),this.paperEl.className="os-pinned-note__paper",e.canEdit?this.paintOwnerPaper():this.paintViewerPaper(),this.element.append(this.pinEl,this.paperEl)}paintOwnerPaper(){const e=document.createElement("div");e.className="os-pinned-note__meta";const t=document.createElement("os-save-status");t.setAttribute("mode","icon"),t.setAttribute("phase","idle"),t.className="os-pinned-note__status",this.statusEl=t;const s=document.createElement("button");s.type="button",s.className="os-pinned-note__color-dot",this.colorDot=s,this.refreshColorDot(),s.addEventListener("click",()=>this.cycleColor()),e.append(t,s);const n=document.createElement("div");n.className="os-pinned-note__actions";const i=document.createElement("os-window-button");if(i.className="os-pinned-note__visibility",this.visibilityBtn=i,this.refreshVisibility(),i.addEventListener("os-button-activate",()=>this.togglePublic()),n.appendChild(i),this.layer.canCreatePosts){const d=document.createElement("os-window-button");d.className="os-pinned-note__convert",d.innerHTML=Zo;const h=u("Convert to a draft post","desktop-mode");d.setAttribute("title",h),d.setAttribute("aria-label",h),d.addEventListener("os-button-activate",()=>this.layer.convertNote(this.note)),n.appendChild(d)}const r=document.createElement("os-window-button");r.className="os-pinned-note__trash",r.innerHTML=Ko;const l=u("Move to Trash","desktop-mode");r.setAttribute("title",l),r.setAttribute("aria-label",l),r.addEventListener("os-button-activate",()=>this.confirmTrash()),n.appendChild(r);const a=document.createElement("os-textarea");a.className="os-pinned-note__editor",a.setAttribute("aria-label",u("Note text","desktop-mode")),a.setAttribute("rows","5"),a.setAttribute("auto-grow",""),a.setAttribute("max-rows","10"),a.setAttribute("value",this.note.text),["keydown","keypress","keyup"].forEach(d=>{a.addEventListener(d,h=>h.stopPropagation())}),a.addEventListener("os-input-change",d=>{const h=d.detail;this.pendingText=h.value,this.setPhase("pending"),this.scheduleSave()}),a.addEventListener("os-input-commit",()=>this.flushSave()),this.editor=a;const c=document.createElement("div");c.className="os-pinned-note__footer",c.appendChild(n),this.paperEl.append(e,a,c)}paintViewerPaper(){const e=document.createElement("div");e.className="os-pinned-note__body",e.textContent=this.note.text;const t=document.createElement("div");t.className="os-pinned-note__attribution",t.title=J(u("Pinned by %s","desktop-mode"),this.note.ownerName);const s=document.createElement("os-avatar");s.setAttribute("size","20"),s.setAttribute("name",this.note.ownerName),this.note.ownerAvatar&&s.setAttribute("src",this.note.ownerAvatar);const n=document.createElement("span");n.className="os-pinned-note__attribution-name",n.textContent=this.note.ownerName,t.append(s,n),this.paperEl.append(e,t)}refreshColorDot(){if(!this.colorDot)return;const e=Pe(this.note.color);this.colorDot.style.setProperty("--dm-note-next-paper",`var(--dm-note-${e})`),this.colorDot.setAttribute("aria-label",J(u("Change paper color (next: %s)","desktop-mode"),e))}refreshVisibility(){if(!this.visibilityBtn)return;const e=this.note.public;this.visibilityBtn.innerHTML="";const t=document.createElement("span");t.className=`dashicons ${e?"dashicons-admin-site-alt3":"dashicons-lock"}`,t.setAttribute("aria-hidden","true"),this.visibilityBtn.appendChild(t),this.visibilityBtn.setAttribute("title",u(e?"Public note — everyone can see it. Click to make private.":"Private note. Click to share with every desktop user.","desktop-mode")),this.visibilityBtn.classList.toggle("is-public",e)}replace(e){const t=e.id!==this.note.id,s=G(e)!==G(this.note),n=e.color!==this.note.color,i=e.x!==this.note.x||e.y!==this.note.y,r=e.z!==this.note.z;if(this.note=e,r&&(this.element.style.zIndex=String(e.z)),t&&(this.element.dataset.noteId=String(e.id)),s&&(this.jitter=ze(G(e)),this.element.style.setProperty("--dm-note-rot",`${this.jitter.rotation}deg`),this.element.style.setProperty("--dm-pin-dx",`${this.jitter.pinOffsetX}px`),this.element.style.setProperty("--dm-pin-rot",`${this.jitter.pinRotation}deg`)),n&&(this.element.dataset.noteColor=ae(e.color),this.refreshColorDot()),i&&this.applyPosition(),this.note.canEdit)this.pendingText===null&&this.editor?.setAttribute("value",e.text),this.refreshVisibility();else{const l=this.paperEl.querySelector(".os-pinned-note__body");l&&(l.textContent=e.text)}}shouldReplaceFromRemote(e){return this.pendingText!==null||this.saveTimer!==null?!1:e.updatedAtMs>=this.note.updatedAtMs}setZ(e){this.element.style.zIndex=String(e),!(e===this.note.z||!this.note.canEdit)&&(this.note={...this.note,z:e},!(this.note.id<=0)&&(this.zTimer!==null&&window.clearTimeout(this.zTimer),this.zTimer=window.setTimeout(()=>{this.zTimer=null,this.queuePatch({z:this.note.z})},Xo)))}applyPosition(){this.element.style.left=`${(this.note.x*100).toFixed(3)}%`,this.element.style.top=`${(this.note.y*100).toFixed(3)}%`}moveTo(e,t){const s=this.layer.clampPosition(e,t);this.note={...this.note,x:s.x,y:s.y},this.applyPosition(),this.note.id>0&&this.queuePatch({x:s.x,y:s.y})}playInsertion(e=1){return jt({pin:this.pinEl,paper:this.paperEl,rippleHost:this.element,restRotation:this.jitter.pinRotation,fallDistance:e>=1?30:12,tempo:e})}focusEditor(){window.setTimeout(()=>this.editor?.focusInput?.(),0)}dispose(){this.disposed=!0,this.saveTimer!==null&&(window.clearTimeout(this.saveTimer),this.saveTimer=null),this.zTimer!==null&&(window.clearTimeout(this.zTimer),this.zTimer=null),this.dragCleanup?.(),this.dragCleanup=null}setPhase(e){this.statusEl?.setAttribute("phase",e)}scheduleSave(){this.saveTimer!==null&&window.clearTimeout(this.saveTimer),this.saveTimer=window.setTimeout(()=>{this.saveTimer=null,this.flushSave()},Uo)}flushPendingEdits(){this.flushSave()}flushSave(){if(this.saveTimer!==null&&(window.clearTimeout(this.saveTimer),this.saveTimer=null),this.pendingText===null||this.note.id<=0)return;const e=this.pendingText;this.pendingText=null,this.note={...this.note,text:e},this.setPhase("saving"),this.queuePatch({text:e})}cycleColor(){const e=Pe(this.note.color);this.note={...this.note,color:e},this.element.dataset.noteColor=e,this.refreshColorDot(),this.note.id>0&&this.queuePatch({color:e})}togglePublic(){const e=!this.note.public;this.note={...this.note,public:e},this.refreshVisibility(),e&&!P()&&this.visibilityBtn&&this.visibilityBtn.animate?.([{transform:"scale(1)"},{transform:"scale(1.25)"},{transform:"scale(1)"}],{duration:300,easing:"ease-out"}),this.layer.announce(u(e?"Note is now public.":"Note is now private.","desktop-mode")),this.note.id>0&&this.queuePatch({public:e})}confirmTrash(){Ft({title:u("Move note to the Trash?","desktop-mode"),message:u("You can restore it from the Trash later.","desktop-mode"),confirmLabel:u("Move to Trash","desktop-mode"),danger:!0}).then(e=>{e&&this.layer.trashNote(this.note)})}queuePatch(e){this.patchChain=this.patchChain.then(async()=>{if(!(this.disposed||this.note.id<=0))try{const t=await go(this.note.id,{...e,updatedAtMs:this.note.updatedAtMs});if(this.disposed)return;const s=t.public!==this.note.public;this.note={...this.note,updatedAtMs:t.updatedAtMs,public:t.public},s&&this.refreshVisibility(),this.setPhase("saved")}catch(t){if(this.disposed)return;if(fo(t)&&t.current){this.pendingText=null,this.replace(t.current),this.setPhase("idle"),this.layer.notifyError(u("This note was changed in another session — showing the latest version.","desktop-mode"));return}this.setPhase("failed"),console.error("[openstation] notes: save failed:",t)}})}startDrag(e){if(!this.note.canEdit||this.note.id<=0)return;const t=qo();if(!t)return;e.preventDefault(),this.element.ownerDocument.defaultView?.getSelection()?.removeAllRanges();const s=this.buildGhost(),n=this.element.getBoundingClientRect(),i={noteId:this.note.id,canEdit:this.note.canEdit,updatedAtMs:this.note.updatedAtMs};t.start({payload:{type:R,source:this.element,data:i,ghost:{element:s.root,offsetX:s.tipX,offsetY:s.tipY,hint:{neutral:u("Drop on the desktop to pin","desktop-mode"),accept:u("Pin here","desktop-mode"),reject:u("Can’t pin here","desktop-mode")}}},origin:e,onClickOnly:()=>{this.teardownDragListeners(),this.toggleMoveMode()},onCancel:()=>{this.teardownDragListeners(),this.snapBack(n)},onCommit:()=>{this.teardownDragListeners(),this.layer.has(this.note.id)&&this.playInsertion(.7)}})&&this.installDragListeners(s)}buildGhost(){const e=this.element.getBoundingClientRect(),s=(this.pinEl.querySelector("img")??this.pinEl).getBoundingClientRect(),n=s.left-e.left+s.width*Gt,i=s.top-e.top+s.height*Qt,r=document.createElement("div");r.className="os-pinned-note-ghost",r.style.width=`${e.width}px`,r.style.height=`${e.height}px`;const l=document.createElement("div");l.className="os-pinned-note-ghost__swing",l.style.transformOrigin=`${n}px ${i}px`;const a=this.pinEl.cloneNode(!0);a.removeAttribute("aria-pressed"),a.setAttribute("aria-hidden","true");const c=this.paperEl.cloneNode(!0);return c.classList.add("os-pinned-note-ghost__paper"),l.dataset.noteColor=this.element.dataset.noteColor??"",l.append(a,c),r.appendChild(l),{root:r,swing:l,pin:a,paper:c,tipX:n,tipY:i}}installDragListeners(e){this.teardownDragListeners();let t=null;const s=l=>{l.detail?.payload?.data?.noteId===this.note.id&&(t=Yt(e.swing))},n=l=>{const a=l.detail;this.lastPointer={x:a.clientX,y:a.clientY},t?.onPointerMove(a.clientX)},i=l=>{l.detail?.targetId?.startsWith("recycle-bin")&&(e.root.classList.add("os-pinned-note-ghost--doom"),t?.setBias(6))},r=l=>{l.detail?.targetId?.startsWith("recycle-bin")&&(e.root.classList.remove("os-pinned-note-ghost--doom"),t?.setBias(0))};document.addEventListener(A.START,s),document.addEventListener(A.MOVE,n),document.addEventListener(A.ENTER,i),document.addEventListener(A.LEAVE,r),this.dragCleanup=()=>{t?.stop(),t=null,document.removeEventListener(A.START,s),document.removeEventListener(A.MOVE,n),document.removeEventListener(A.ENTER,i),document.removeEventListener(A.LEAVE,r)}}teardownDragListeners(){this.dragCleanup?.(),this.dragCleanup=null}async snapBack(e){if(!this.lastPointer||P()){this.playInsertion(.63);return}const t=this.buildGhost();t.root.classList.add("os-pinned-note-ghost--flyback"),t.root.style.position="fixed",t.root.style.left=`${this.lastPointer.x-t.tipX}px`,t.root.style.top=`${this.lastPointer.y-t.tipY}px`,t.root.style.zIndex="2147483647",t.root.style.pointerEvents="none",document.body.appendChild(t.root);try{await qt({flyback:t.root,swing:t.swing,homeX:e.left,homeY:e.top})}finally{t.root.remove()}this.playInsertion(.63)}async playCrumpleAt(e,t){const s=this.buildGhost();s.root.classList.add("os-pinned-note-ghost--flyback"),s.root.style.position="fixed",s.root.style.left=`${e-s.tipX}px`,s.root.style.top=`${t-s.tipY}px`,s.root.style.zIndex="2147483647",s.root.style.pointerEvents="none",document.body.appendChild(s.root);try{await Zt({clone:s.root,pin:s.pin,paper:s.paper,binX:e,binY:t+24})}finally{s.root.remove()}}toggleMoveMode(){this.moveMode?this.exitMoveMode(!0):this.enterMoveMode()}enterMoveMode(){this.note.canEdit&&(this.moveMode=!0,this.moveOrigin={x:this.note.x,y:this.note.y},this.element.classList.add("os-pinned-note--move-mode"),this.pinEl.setAttribute("aria-pressed","true"),this.layer.announce(u("Moving note. Arrow keys to move, Enter to place, Escape to cancel, Delete to move to the Trash.","desktop-mode")))}exitMoveMode(e){this.moveMode&&(this.moveMode=!1,this.element.classList.remove("os-pinned-note--move-mode"),this.pinEl.setAttribute("aria-pressed","false"),e?(this.moveTo(this.note.x,this.note.y),this.layer.announce(u("Note placed.","desktop-mode")),this.playInsertion(.7)):this.moveOrigin&&(this.note={...this.note,...this.moveOrigin},this.applyPosition()),this.moveOrigin=null)}onPinKeydown(e){if(!this.moveMode)return;const{width:t,height:s}=this.layer.hostSize(),n=e.shiftKey?Yo:jo,i=n/t,r=n/s;switch(e.key){case"ArrowLeft":this.nudge(-i,0);break;case"ArrowRight":this.nudge(i,0);break;case"ArrowUp":this.nudge(0,-r);break;case"ArrowDown":this.nudge(0,r);break;case"Enter":case" ":this.exitMoveMode(!0);break;case"Escape":this.exitMoveMode(!1),this.layer.announce(u("Move cancelled.","desktop-mode"));break;case"Delete":case"Backspace":this.exitMoveMode(!1),this.confirmTrash();break;default:return}e.preventDefault(),e.stopPropagation()}nudge(e,t){const s=this.layer.clampPosition(this.note.x+e,this.note.y+t);this.note={...this.note,...s},this.applyPosition()}}const Jo=$("desktop-mode/canvas-payload-handlers",()=>({handlers:new Map}));function fe(){return Jo.state.handlers}function Ye(o,e){return fe().set(o,e),()=>{fe().get(o)===e&&fe().delete(o)}}const es=$("desktop-mode/recycle-bin-payload-handlers",()=>({handlers:new Map}));function me(){return es.state.handlers}function ts(o,e){return me().set(o,e),()=>{me().get(o)===e&&me().delete(o)}}function qe(o,e,t){const s=o.host.getBoundingClientRect(),n=e.payload.ghost?.offsetX??0,i=e.payload.ghost?.offsetY??0,{width:r,height:l}=o.hostSize();return o.clampPosition((t.clientX-n-s.left)/r,(t.clientY-i-s.top)/l)}function os(o,e,t){const s=e.payload.data,n=String(s.text??"");if(!n.trim())return;const{x:i,y:r}=qe(o,e,t);o.createNoteAt({x:i,y:r,text:n,color:String(s.color??""),isPublic:s.isPublic===!0})}function ss(o,e,t){const s=e.payload.data,n=o.get(s.noteId);if(!n)return;const{x:i,y:r}=qe(o,e,t);n.moveTo(i,r)}function ns(o){const e=[],t=s=>s.folderId===0;return e.push(Ye(wo,{accept:(s,n)=>t(n)&&!!String(s.text??"").trim(),onDrop:(s,n)=>os(o,s,n)})),e.push(Ye(R,{accept:(s,n)=>t(n)&&s.canEdit===!0,onDrop:(s,n)=>ss(o,s,n)})),e.push(ts(R,{accept:s=>s.canEdit===!0,onDrop:(s,n)=>{const i=s.payload.data,r=o.get(i.noteId);if(!r)return;const l=r.note;r.playCrumpleAt(n.clientX,n.clientY),o.trashNote(l)}})),()=>{e.forEach(s=>s())}}const is=$("desktop-mode/tile-payload-handlers",()=>({handlers:new Map}));function Q(){return is.state.handlers}function rs(o,e){const t=Q().get(o);return t?t.push(e):Q().set(o,[e]),()=>{const s=Q().get(o);if(!s)return;const n=s.indexOf(e);n!==-1&&s.splice(n,1),s.length===0&&Q().delete(o)}}const ge="data-os-posts-drop-active",Ze="desktop-mode-posts",as='.os-dock__item[data-menu-slug="menu-posts"],.os-dock__item[data-menu-slug="editphp"]',ls="[data-os-posts-root]";function cs(){return window.wp?.os?.dragManager??null}function ds(o){return o.type!==R?!1:o.data.canEdit===!0}function hs(o){if(!o)return!1;let e=o,t="";try{const i=new URL(o,window.location.origin);e=i.pathname,t=i.search}catch{}if(!(/(?:^|\/)(?:edit\.php|post-new\.php)$/.test(e)||!e.includes("/")&&(e==="edit.php"||e==="post-new.php")))return!1;const n=new URLSearchParams(t).get("post_type");return!n||n==="post"}function us(o){const e=o.placement.file;if(!e||e.type!=="shortcut")return!1;const t=typeof e.shortcutUrl=="string"?e.shortcutUrl:"";return hs(t)}function Ke(o,e){if(e.payload.type!==R)return;const t=e.payload.data;if(typeof t.noteId!="number")return;const s=o.get(t.noteId);s&&o.convertNote(s.note)}let Ge=!1,O=null,D=null,Qe=null;function Je(o,e,t,s){return o.registerDropTarget({id:t,element:s,acceptLabel:u("Convert to post","desktop-mode"),accept:n=>ds(n),onEnter:()=>{s.setAttribute(ge,"")},onLeave:()=>{s.removeAttribute(ge)},onDrop:n=>{s.removeAttribute(ge),Ke(e,n)}})}function ps(o,e){const t=o.debug().listTargets().find(s=>s.id===e);return t?t.element:null}function fs(o){if(Ge||!o.canCreatePosts)return;const e=cs();if(!e)return;Ge=!0,rs(R,{appliesTo:s=>us(s),acceptLabel:u("Convert to post","desktop-mode"),accept:s=>s.canEdit===!0,onDrop:s=>Ke(o,s)});const t=()=>{const s=document.querySelector(as);if(!(s instanceof HTMLElement)){O?.(),O=null;return}O&&ps(e,"notes-convert-dock")===s||(O?.(),O=Je(e,o,"notes-convert-dock",s))};t(),Y(q.DOCK_AFTER_RENDER,"desktop-mode/notes/convert-dock-target",t),typeof MutationObserver<"u"&&(Qe=new MutationObserver(()=>{t()}),Qe.observe(document.body,{childList:!0,subtree:!0})),Y(q.WINDOW_OPENED,"desktop-mode/notes/convert-window-target",s=>{if(s.windowId!==Ze)return;D?.(),D=null;const n=document.querySelector(ls);n instanceof HTMLElement&&(D=Je(e,o,"notes-convert-window",n))}),Y(q.WINDOW_CLOSED,"desktop-mode/notes/convert-window-cleanup",s=>{s.windowId===Ze&&(D?.(),D=null)})}const et="new-note";function ms(o){To("os.wallpaper-context-menu","desktop-mode/notes",(e,t)=>{if(!Array.isArray(e)||e.some(i=>i.id===et))return e;const{x:s,y:n}=t??{x:0,y:0};return[...e,{id:et,label:u("New note","desktop-mode"),icon:"dashicons-edit-page",sort:14,onClick:()=>{const i=o.normalizedFromClient(s,n);o.createNoteAt({...i,focus:!0})}}]})}function gs(o){const e=o.config.notesUrl;if(typeof e!="string"||!e)return null;ho({baseUrl:e,nonce:o.config.restNonce??""});const t=new Go({host:o.host,pluginUrl:o.config.pluginUrl??"",canCreatePosts:o.config.canCreatePosts??!1,onError:o.onError});return ns(t),fs(t),ms(t),document.addEventListener(_o,s=>{const n=s.detail?.note;if(n&&typeof n.id=="number"){t.bumpHighWater(n.updatedAtMs);const i=t.upsertNote(n,{animate:"thunk"});t.bringToFront(i),i.focusEditor()}}),t.boot(),t}window.openStationNotes={boot:gs}})();
