var openStationApp_osSettings=function(xs){"use strict";const na="desktop-mode";function Ei(){return window.wp?.i18n}function d(o,e=na){return Ei()?.__(o,e)??o}function U(o,...e){const t=Ei()?.sprintf;if(t)return t(o,...e);let s=0;return o.replace(/%(?:(\d+)\$)?[sd]/g,(i,n)=>{const r=n?Number.parseInt(n,10)-1:s++;return String(e[r]??"")})}function l(o,...e){return{__wpdHtml:!0,strings:o,values:e}}function ra(o){return!!o&&o.__wpdHtml===!0}const aa="$$wpd$$",z=/\$\$wpd\$\$(\d+)\$\$/g,la="$$wpd-node$$",ca=/^\$\$wpd-node\$\$(\d+)\$\$$/,da=new Set(["style","script","textarea","title"]);function ua(o){let e="",t=!1,s=null,i=!1,n=null,r="",a=!1;for(let c=0;c<o.length;c++){const u=o[c];e+=u;for(let h=0;h<u.length;h++){const p=u[h];if(i){u.startsWith("-->",h)&&(i=!1,h+=2);continue}if(n!==null){p==="<"&&u[h+1]==="/"&&u.slice(h+2,h+2+n.length).toLowerCase()===n&&(h+=1+n.length,n=null,t=!0,a=!1,r="");continue}if(s!==null){p===s&&(s=null);continue}if(t){p==='"'||p==="'"?(s=p,a=!1):p===">"?(t=!1,a=!1,da.has(r)&&(n=r),r=""):a&&(/[a-zA-Z0-9-]/.test(p)?r+=p.toLowerCase():a=!1);continue}if(u.startsWith("<!--",h)){i=!0,h+=3;continue}const g=u[h+1]??"";p==="<"&&/[a-zA-Z/!]/.test(g)&&(t=!0,r="",a=/[a-zA-Z]/.test(g))}c<o.length-1&&(e+=t||i||n!==null?`${aa}${c}$$`:`<!--${la}${c}$$-->`)}return e}const Ai=new WeakMap;function Ci(o){const e=Ai.get(o);if(e)return e;const t=document.createElement("template");t.innerHTML=ua(o);const s=[],i=(a,c)=>{if(a.nodeType===Node.ELEMENT_NODE){const p=a;for(const g of Array.from(p.attributes)){const m=g.name,b=g.value,x=m[0];if(z.test(b))if(z.lastIndex=0,x==="@"){const w=z.exec(b);z.lastIndex=0,s.push({path:c,kind:"event",name:m.slice(1),valueIndex:w?Number(w[1]):0}),p.removeAttribute(m)}else if(x==="."){const w=z.exec(b);z.lastIndex=0,s.push({path:c,kind:"prop",name:m.slice(1),valueIndex:w?Number(w[1]):0}),p.removeAttribute(m)}else if(x==="?"){const w=z.exec(b);z.lastIndex=0,s.push({path:c,kind:"bool",name:m.slice(1),valueIndex:w?Number(w[1]):0}),p.removeAttribute(m)}else{const w=[],k=[];let f=0,A;for(z.lastIndex=0;(A=z.exec(b))!==null;)w.push(b.slice(f,A.index)),k.push(Number(A[1])),f=A.index+A[0].length;w.push(b.slice(f)),s.push({path:c,kind:"attr",name:m,template:w,valueIndices:k}),p.setAttribute(m,"")}}}const u=Array.from(a.childNodes);let h=0;for(let p=0;p<u.length;p++){const g=u[p],m=p+h;if(g.nodeType===Node.COMMENT_NODE){const b=ca.exec(g.data);if(b){const x=document.createTextNode("");g.parentNode.replaceChild(x,g),s.push({path:[...c,m],kind:"node",valueIndex:Number(b[1])})}continue}if(g.nodeType===Node.TEXT_NODE){const b=g.textContent||"";if(!z.test(b)){z.lastIndex=0;continue}z.lastIndex=0;const x=g.parentNode;let w=0,k;const f=[],A=[];for(z.lastIndex=0;(k=z.exec(b))!==null;){k.index>w&&f.push(document.createTextNode(b.slice(w,k.index)));const $=document.createTextNode("");f.push($),A.push({path:[...c,m+f.length-1],kind:"node",valueIndex:Number(k[1])}),w=k.index+k[0].length}w<b.length&&f.push(document.createTextNode(b.slice(w)));for(const $ of f)x.insertBefore($,g);x.removeChild(g),h+=f.length-1,s.push(...A)}else i(g,[...c,m])}};i(t.content,[]);const r={template:t,buildParts:a=>{const c=[];for(const u of s){let h=a;for(const p of u.path)h=h.childNodes[p];u.kind==="node"?c.push({kind:"node",valueIndex:u.valueIndex,child:{anchor:h,state:null}}):u.kind==="attr"?c.push({kind:"attr",element:h,name:u.name,template:u.template,valueIndices:u.valueIndices}):u.kind==="event"?c.push({kind:"event",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="prop"?c.push({kind:"prop",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="bool"&&c.push({kind:"bool",valueIndex:u.valueIndex,element:h,name:u.name})}return c}};return Ai.set(o,r),r}const Si=new WeakMap;function ha(o,e){for(const t of o.nodes)if(t.parentNode!==e)return!1;return!0}function fe(o,e){const t=Si.get(e);if(t&&t.strings===o.strings&&ha(t,e)){Zt(t.parts,o.values);return}const s=Ci(o.strings),i=s.template.content.cloneNode(!0),n=s.buildParts(i),r=Array.from(i.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(i),Zt(n,o.values),Si.set(e,{strings:o.strings,parts:n,nodes:r})}function Zt(o,e){for(const t of o)if(t.kind==="node")Yt(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let s=t.template[0];for(let i=0;i<t.valueIndices.length;i++)s+=Li(e[t.valueIndices[i]]),s+=t.template[i+1];s!==t.last&&(t.last=s,s===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,s))}else if(t.kind==="event"){const s=e[t.valueIndex];s!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),s&&t.element.addEventListener(t.name,s),t.current=s)}else if(t.kind==="prop"){const s=e[t.valueIndex];s!==t.last&&(t.last=s,t.element[t.name]=s)}else if(t.kind==="bool"){const s=!!e[t.valueIndex];s!==t.last&&(t.last=s,s?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function Yt(o,e){if(e==null||e===!1){o.state&&(se(o.state),o.state=null);return}if(Array.isArray(e)){ba(o,e);return}if(ra(e)){fa(o,e);return}if(e instanceof Node){pa(o,e);return}ga(o,Li(e))}function pa(o,e){const t=o.state;t?.shape==="node"&&t.node===e||(t&&se(t),Ee(o,[e]),o.state={shape:"node",node:e})}function ga(o,e){const t=o.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&se(t);const s=document.createTextNode(e);Ee(o,[s]),o.state={shape:"text",node:s,text:e}}function fa(o,e){const t=o.state;if(t?.shape==="template"&&t.strings===e.strings){Zt(t.parts,e.values);return}t&&se(t);const s=Ci(e.strings),i=s.template.content.cloneNode(!0),n=s.buildParts(i),r=Array.from(i.childNodes);Ee(o,[i]),Zt(n,e.values),o.state={shape:"template",strings:e.strings,parts:n,nodes:r}}function ba(o,e){const t=o.state;if(t?.shape==="array"){const i=Math.min(t.entries.length,e.length);for(let n=0;n<i;n++)Yt(t.entries[n],e[n]);if(e.length<t.entries.length){for(let n=e.length;n<t.entries.length;n++){const r=t.entries[n];r.state&&se(r.state),r.anchor.remove()}t.entries.length=e.length}else for(let n=t.entries.length;n<e.length;n++){const r=document.createTextNode("");Ee(o,[r]);const a={anchor:r,state:null};Yt(a,e[n]),t.entries.push(a)}return}t&&se(t);const s=[];for(const i of e){const n=document.createTextNode("");Ee(o,[n]);const r={anchor:n,state:null};Yt(r,i),s.push(r)}o.state={shape:"array",entries:s}}function Ee(o,e){const t=o.anchor.parentNode;if(t)for(const s of e)t.insertBefore(s,o.anchor)}function se(o){if(o.shape==="text"){o.node.remove();return}if(o.shape==="template"){for(const e of o.parts)e.kind==="node"&&e.child.state&&(se(e.child.state),e.child.state=null);for(const e of o.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(o.shape==="node"){o.node.parentNode&&o.node.parentNode.removeChild(o.node);return}for(const e of o.entries)e.state&&se(e.state),e.anchor.remove()}function Li(o){return o==null||o===!1?"":String(o)}function ma(o,e){const t=e.local??{},s={id:o,hasLocal:r=>Object.prototype.hasOwnProperty.call(t,r),runLocal:(r,a,c,u)=>{const h=t[r];if(!h)return a;const p={...a},g=h(p,c,u);return g===void 0?p:g},render:r=>{fe(e.view(r),r.root),e.updated?.(r)},mounted:r=>e.mounted?.(r)},{placeholder:i}=e;i&&(s.placeholder=r=>i(r));const n=window;return(n.openStationApps??(n.openStationApps={}))[o]=s,s}function Ri(){const o=window.wp?.hooks;if(!o)throw new Error("[openstation] `window.wp.hooks` is not available. The plugin declares `wp-hooks` as a script dependency; if you are seeing this error, verify the enqueue order.");return o}function ce(o,e,...t){return Ri().applyFilters(o,e,...t)}function de(o,...e){Ri().doAction(o,...e)}const O={INIT:"os.init",WALLPAPERS:"os.wallpapers",GAMES:"os.games",UNFOCUS_EFFECTS:"os.unfocus-effects",WINDOW_REVEALS:"os.window-reveals",WALLPAPER_MOUNTING:"os.wallpaper.mounting",WALLPAPER_MOUNTED:"os.wallpaper.mounted",WALLPAPER_UNMOUNTING:"os.wallpaper.unmounting",WALLPAPER_MOUNT_FAILED:"os.wallpaper.mount-failed",WALLPAPER_VISIBILITY:"os.wallpaper.visibility",WALLPAPER_SUSPEND:"os.wallpaper.suspend",WALLPAPER_PREVIEW_PARAMS:"os.wallpaper.preview-params",WALLPAPER_SETTINGS_CHANGED:"os.wallpaper.settings-changed",IFRAME_READY:"os.iframe.ready",IFRAME_ERROR:"os.iframe.error",IFRAME_NETWORK_COMPLETED:"os.iframe.network-completed",SHELL_ERROR:"os.shell.error",BROADCAST:"os.broadcast",MONITOR_ENTRY:"os.monitor.entry",WALLPAPER_SURFACES:"os.wallpaper.surfaces",DESKTOP_THEME_CHANGED:"os.os-theme.changed",DESKTOP_THEME_ICON:"os.os-theme.icon",DESKTOP_THEME_ICON_COLOR:"os.os-theme.icon-color",WALLPAPERS_SERVER_CHANGED:"os.wallpapers.server-changed",EXTENDED_OPTIONS_CHANGED:"os.extended-options.changed",WINDOW_GEOMETRY:"os.window.geometry",WINDOW_OPENED:"os.window.opened",WINDOW_CONTENT_LOADING:"os.window.content-loading",WINDOW_CONTENT_LOADED:"os.window.content-loaded",WINDOW_LOADING_OVERLAY:"os.window.loading-overlay",WINDOW_REOPENED:"os.window.reopened",WINDOW_MENU_OPENED:"os.window.menu-opened",WINDOW_CLOSING:"os.window.closing",WINDOW_CLOSED:"os.window.closed",WINDOW_FOCUSED:"os.window.focused",WINDOW_BLURRED:"os.window.blurred",WINDOW_MINIMIZED:"os.window.minimized",WINDOW_RESTORED:"os.window.restored",WINDOW_CHILD_BLOCKED:"os.window.child-blocked",WINDOW_MAXIMIZED:"os.window.maximized",WINDOW_UNMAXIMIZED:"os.window.unmaximized",WINDOW_FULLSCREEN_ENTERED:"os.window.fullscreen-entered",WINDOW_FULLSCREEN_EXITED:"os.window.fullscreen-exited",WINDOW_AUTO_EXIT_FULLSCREEN:"os.window.auto-exit-fullscreen",WINDOW_FOCUS_ON_DRAG_HOVER:"os.window.focus-on-drag-hover",WINDOW_BOUNDS_CHANGED:"os.window.bounds-changed",WINDOW_MOVED:"os.window.moved",WINDOW_RESIZED:"os.window.resized",WINDOW_DRAG_START:"os.window.drag-start",WINDOW_DRAG_END:"os.window.drag-end",WINDOW_RESIZE_START:"os.window.resize-start",WINDOW_RESIZE_END:"os.window.resize-end",WINDOW_DETACHED:"os.window.detached",WINDOW_RELOADED:"os.window.reloaded",WINDOW_TITLE_CHANGED:"os.window.title-changed",WINDOW_HIGHLIGHT_CHANGED:"os.window.highlight-changed",WINDOW_BODY_RESIZED:"os.window.body-resized",NATIVE_WINDOW_BEFORE_RENDER:"os.native-window.before-render",NATIVE_WINDOW_AFTER_RENDER:"os.native-window.after-render",NATIVE_WINDOW_BEFORE_CLOSE:"os.native-window.before-close",WINDOW_CHROME_THEME:"os.window.chrome.theme",WINDOW_CHROME_CONTROLS:"os.window.chrome.controls",WINDOW_CHROME_SLOT:"os.window.chrome.slot",WINDOW_CHROME_RENDER:"os.window.chrome.render",WINDOW_CHROME_APPLIED:"os.window.chrome.applied",WINDOW_CHROME_THEME_CHANGED:"os.window.chrome.theme-changed",DESKTOP_ICON_CLICKED:"os.os-icon.clicked",DESKTOP_ICONS_RENDERED:"os.os-icons.rendered",ICON_BADGE_CHANGED:"os.icon.badge-changed",COMPONENTS_REGISTERED:"os.components.registered",DOCK_ITEM_APPENDED:"os.dock.item-appended",DOCK_ITEM_REMOVED:"os.dock.item-removed",DOCK_BEFORE_RENDER:"os.dock.before-render",DOCK_AFTER_RENDER:"os.dock.after-render",DOCK_REFRESH_ACTIVE:"os.dock.refresh-active",DOCK_TILE_CLASS:"os.dock.tile-class",DOCK_TILE_ELEMENT:"os.dock.tile-element",DOCK_TILE_RENDERED:"os.dock.tile-rendered",DOCK_TILE_TOOLTIP:"os.dock.tile-tooltip",DOCK_PEEK_CARD_CONTENT:"os.dock.peek-card-content",DOCK_PEEK_CARD_ELEMENT:"os.dock.peek-card-element",CONSTELLATION_PANEL:"os.constellation.panel",CONSTELLATION_OPENED:"os.constellation.opened",CONSTELLATION_CLOSED:"os.constellation.closed",OVERVIEW_ENTERING:"os.overview.entering",OVERVIEW_ENTERED:"os.overview.entered",OVERVIEW_EXITING:"os.overview.exiting",OVERVIEW_EXITED:"os.overview.exited",OVERVIEW_WINDOW_HOVER:"os.overview.window-hover",OVERVIEW_WINDOW_UNHOVER:"os.overview.window-unhover",OVERVIEW_WINDOW_CLICK:"os.overview.window-click",WORK_AREA_CHANGED:"os.work-area.changed",ARRANGE_CASCADE_STARTING:"os.arrange.cascade.starting",ARRANGE_CASCADE_APPLIED:"os.arrange.cascade.applied",ARRANGE_TILE_STARTING:"os.arrange.tile.starting",ARRANGE_TILE_APPLIED:"os.arrange.tile.applied",ARRANGE_TILE_DIMENSIONS:"os.arrange.tile.dimensions",ARRANGE_COLUMNS_STARTING:"os.arrange.columns.starting",ARRANGE_COLUMNS_APPLIED:"os.arrange.columns.applied",ARRANGE_FOCUS_SPLIT:"os.arrange.focus.split",ARRANGE_FOCUS_STARTING:"os.arrange.focus.starting",ARRANGE_FOCUS_APPLIED:"os.arrange.focus.applied",ARRANGE_SNAP_CHANGED:"os.arrange.snap.changed",ARRANGE_SNAP_CELL_SIZE:"os.arrange.snap.cell-size",ARRANGE_CUSTOM_ACTION:"os.arrange.custom-action",POINTER_SHAKE:"os.pointer.shake",GRID_SNAP_DIMENSIONS:"os.grid-snap.dimensions",GRID_SNAP_ARMED:"os.grid-snap.armed",GRID_SNAP_CHANGED:"os.grid-snap.changed",GRID_SNAP_ANCHOR_RESET:"os.grid-snap.anchor-reset",GRID_SNAP_CANCELED:"os.grid-snap.canceled",GRID_SNAP_COMMITTED:"os.grid-snap.committed",GRID_SNAP_REFLOWED:"os.grid-snap.reflowed",SNAP_ZONE_PENDING:"os.snap.zone-pending",SNAP_ZONE_CANCELED:"os.snap.zone-canceled",SNAP_ZONE_COMMITTED:"os.snap.zone-committed",SNAP_SPLIT_FILLED:"os.snap.split-filled",WIDGETS:"os.widgets",WIDGET_MOUNTING:"os.widget.mounting",WIDGET_MOUNTED:"os.widget.mounted",WIDGET_UNMOUNTING:"os.widget.unmounting",WIDGET_MOUNT_FAILED:"os.widget.mount-failed",WIDGET_ADDED:"os.widget.added",WIDGET_REMOVED:"os.widget.removed",DESKTOP_CREATED:"os.os.created",DESKTOP_CLOSED:"os.os.closed",DESKTOP_SWITCHED:"os.os.switched",DESKTOP_RENAMED:"os.os.renamed",WINDOW_DESKTOP_CHANGED:"os.os.window-moved",PRIMARY_DESKTOP_ID:"os.primary-desktop-id",WORKSPACE_PRESETS:"os.workspaces.presets",WORKSPACE_PROFILE:"os.workspaces.profile",WORKSPACE_UPDATED:"os.workspaces.updated",WORKSPACE_PROVISIONED:"os.workspaces.provisioned",WINDOWS_BEFORE_CLOSE_ALL:"os.windows.before-close-all",WINDOWS_CLOSE_ALL:"os.windows.close-all",WINDOWS_AFTER_CLOSE_ALL:"os.windows.after-close-all",COMMAND_BEFORE_RUN:"os.command.before-run",COMMAND_AFTER_RUN:"os.command.after-run",COMMAND_ERROR:"os.command.error",SHELL_RESIZED:"os.shell.resized",SHELL_VISIBILITY:"os.shell.visibility",CONNECTION_OPENED:"os.connection.opened",CONNECTION_CLOSED:"os.connection.closed",CONNECTION_MESSAGE:"os.connection.message",IFRAME_CONNECTION_REQUEST:"os.iframe.connection-request",WINDOW_CONTENT_CHANGED:"os.window-links.content-changed",WINDOW_LINK_GROUPS_CHANGED:"os.window-links.groups-changed",WINDOW_LINKS_CONTENT:"os.window-links.content",WINDOW_LINK_GROUPS:"os.window-links.groups",WINDOW_LINK_EDGES:"os.window-links.edges",RELATED_ENTITIES_ITEMS:"os.related-entities.items",WINDOW_LINK_RENDERERS:"os.window-links.renderers",WINDOW_LINK_RENDERER:"os.window-links.renderer",EDITOR_PREVIEW_WINDOW_CONFIG:"os.editor-preview.window-config",EDITOR_PREVIEW_LIVE:"os.editor-preview.live",EDITOR_PREVIEW_OPENED:"os.editor-preview.opened",EDITOR_PREVIEW_CLOSED:"os.editor-preview.closed",REVISIONS_WINDOW_CONFIG:"os.revisions.window-config",REVISIONS_OPENED:"os.revisions.opened",FILE_DROP_FILES_DETECTED:"os.drop.files-detected",FILE_DROP_FILES_REJECTED:"os.drop.files-rejected",FILE_DROP_DIALOG_FIELDS:"os.drop.dialog-fields",FILE_DROP_BEFORE_UPLOAD:"os.drop.before-upload",FILE_DROP_UPLOAD_STARTED:"os.drop.upload-started",FILE_DROP_UPLOAD_PROGRESS:"os.drop.upload-progress",FILE_DROP_AFTER_UPLOAD:"os.drop.after-upload",FILE_DROP_UPLOAD_FAILED:"os.drop.upload-failed",AUTH_LOST:"os.auth.lost",AUTH_RESTORED:"os.auth.restored",MODE_CHANGED:"os.mode.changed",SESSION_SNAPSHOT:"os.session.snapshot"};function Ii(o,e){if(!o||typeof o!="object")return["def (not an object)"];const t=o,s=[];for(const i of e)i.valid(t)||s.push(`${i.field} (${i.message})`);return s}class va extends Error{constructor(e,t,s){super(`[openstation] ${e} registration rejected — fields: `+t.join(", ")+"."),this.name="RegistrationError",this.kind=e,this.errors=t,this.def=s}}function ks(o,e,t){if(e.length!==0)throw new va(o,e,t)}const Di="__openStationSharedStores";function _a(){const o=window;let e=o[Di];return e||(e=new Map,o[Di]=e),e}function j(o,e){const t=_a();let s=t.get(o);s||(s={state:e(),listeners:new Set,rebuild:e},t.set(o,s));const i={get state(){return s.state},set state(n){s.state=n},getState(){return s.state},notify(){for(const n of Array.from(s.listeners))try{n(s.state)}catch(r){console.error(`[desktop-mode/shared-store:${o}] subscriber threw:`,r)}},subscribe(n){return s.listeners.add(n),()=>{s.listeners.delete(n)}},setState(n){const r=s.state;if(typeof r!="object"||r===null){console.warn(`[desktop-mode/shared-store:${o}] setState called on a primitive store; use the state setter instead.`);return}Object.assign(r,n),i.notify()},reset(){const n=s.rebuild(),r=s.state;if(typeof r=="object"&&r!==null&&typeof n=="object"&&n!==null){const a=r;for(const c of Object.keys(a))delete a[c];Object.assign(a,n)}else s.state=n;s.listeners.clear()}};return i}const Ti=j("desktop-mode/wallpaper-registry",()=>({seed:[],listeners:new Set})),Qt=Ti.state.seed,$s=Ti.state.listeners;function Ni(o){ks("Wallpaper",Ii(o,zi),o);const e=Qt.findIndex(t=>t.id===o.id);e>=0?Qt[e]=o:Qt.push(o),wa()}function ya(o){return $s.add(o),()=>{$s.delete(o)}}function wa(){const o=Array.from($s);for(const e of o)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] wallpaper registry listener threw:",t)}}function Pi(){const o=Qt.slice(),e=ce(O.WALLPAPERS,o);return Array.isArray(e)?e.filter(xa):(typeof console<"u"&&console.warn("[openstation] `os.wallpapers` filter returned a non-array; falling back to seed list."),o)}function Ae(o){return Pi().find(e=>e.id===o)}const zi=[{field:"id",message:"missing or not a non-empty string",valid:o=>typeof o.id=="string"&&o.id!==""},{field:"label",message:"missing or not a non-empty string",valid:o=>typeof o.label=="string"&&o.label!==""},{field:"preview",message:"missing or not a non-empty string",valid:o=>typeof o.preview=="string"&&o.preview!==""},{field:"type",message:'must be "css" or "canvas"',valid:o=>o.type==="css"||o.type==="canvas"},{field:"value/resolveValue/mount",message:"css types need `value` or `resolveValue`; canvas types need `mount`",valid:o=>o.type==="css"?typeof o.value=="string"||typeof o.resolveValue=="function":o.type==="canvas"?typeof o.mount=="function":!0}];function xa(o){return Ii(o,zi).length===0}function Mi(o){let e,t;try{const i=new URL(o,document.baseURI);e=i.origin,t=i.pathname}catch{return null}if(!t)return null;const s=document.querySelectorAll("script[src]");for(const i of Array.from(s))try{const n=new URL(i.src,document.baseURI);if(n.origin===e&&n.pathname===t)return i}catch{}return null}const Oi=new Map;function ka(o){const e=Oi.get(o);if(e)return e;let t=[];try{const s=new URL(o,document.baseURI);if(s.pathname.endsWith("/load-scripts.php")){const i=[];s.searchParams.forEach((n,r)=>{if(r!=="load"&&!r.startsWith("load["))return;const a=/(\d+)/.exec(r);i.push({order:a?Number(a[1]):i.length,value:n})}),i.sort((n,r)=>n.order-r.order),t=i.map(n=>n.value).join("").split(",").map(n=>n.trim()).filter(Boolean)}}catch{}return Oi.set(o,t),t}function $a(){const o=new Set,e=document.querySelectorAll('script[src*="load-scripts.php"]');for(const t of Array.from(e))for(const s of ka(t.src))o.add(s);return o}function Wi(o){return o.url&&Mi(o.url)?!0:!!o.handle&&$a().has(o.handle)}const Jt=new Map;function Es(o,e){const t=Jt.get(o);if(t)return t;const s=e?.deps;if(s&&s.length>0){const n=a=>!a.url||Wi(a)?Promise.resolve():Es(a.url,{...a,deps:void 0}),r=s.reduce((a,c)=>a.then(()=>n(c)),Promise.resolve(void 0)).then(()=>Hi(o,e));return Jt.set(o,r),r}const i=Hi(o,e);return Jt.set(o,i),i}function Hi(o,e){return new Promise((t,s)=>{const i=`script[data-os-vendor="${Ea(o)}"]`,n=document.querySelector(i);if(n){if(n.dataset.loaded==="1"){t();return}n.addEventListener("load",()=>t(),{once:!0}),n.addEventListener("error",()=>s(new Error(`Failed to load ${o}`)),{once:!0});return}const r=Mi(o);if(r){r.dataset.osVendor=o,r.dataset.loaded="1",t();return}if(Wi({handle:e?.handle})){t();return}e?.translations&&es(e.translations);for(const c of e?.l10n??[])es(c);for(const c of e?.before??[])es(c);const a=document.createElement("script");a.src=o,a.async=!0,a.dataset.osVendor=o,a.addEventListener("load",()=>{a.dataset.loaded="1";for(const c of e?.after??[])es(c);t()},{once:!0}),a.addEventListener("error",()=>{Jt.delete(o),a.remove(),s(new Error(`Failed to load ${o}`))},{once:!0}),document.head.appendChild(a)})}function es(o){if(!o)return;const e=document.createElement("script");e.textContent=o,e.dataset.osVendorInline="1",document.head.appendChild(e)}function Ea(o){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(o):o.replace(/["\\]/g,"\\$&")}const be=j("desktop-mode/wallpaper-lazy",()=>({pending:new Map,inflight:new Map}));function Aa(o){be.state.pending.delete(o)}function Ca(o){return(window.openStationWallpapers||{})[o]??null}function Sa(o){const e=be.state.inflight.get(o);if(e)return e;const t=be.state.pending.get(o);if(!t)return Promise.resolve(null);const s=(async()=>{try{await Es(t.scriptUrl,{translations:t.scriptTranslations,l10n:t.scriptL10n,before:t.scriptBefore,after:t.scriptAfter})}catch(n){return de(O.SHELL_ERROR,{scope:"wallpaper-script-load",id:t.id,error:n}),null}let i=Ca(t.id);if(i&&!i.description&&t.description&&(i={...i,description:t.description}),!i)return de(O.SHELL_ERROR,{scope:"wallpaper-missing-def",id:t.id,error:new Error(`[openstation] No wallpaper def on window.openStationWallpapers["${t.id}"]. Script loaded but didn't publish a def — check the plugin's enqueue + global assignment.`)}),null;try{Ni(i)}catch(n){return de(O.SHELL_ERROR,{scope:"wallpaper-register",id:t.id,error:n}),null}return Aa(t.id),i})().finally(()=>{be.state.inflight.delete(o)});return be.state.inflight.set(o,s),s}async function La(){const o=Array.from(be.state.pending.keys());o.length!==0&&await Promise.all(o.map(e=>Sa(e)))}const Ui=j("desktop-mode/dock-rail-registry",()=>({registry:new Map,listeners:new Set,activeId:"default"})),qi=Ui.state.registry,Fi=Ui.state.listeners;function Ra(o){return qi.get(o)}function Ia(){return Array.from(qi.values())}function Da(o){return Fi.add(o),()=>{Fi.delete(o)}}function Ta(o){o.style.setProperty("--os-file-tile-enter-delay",`${(Math.random()*.25).toFixed(3)}s`),o.style.setProperty("--os-file-tile-enter-duration",`${(.3+Math.random()*.25).toFixed(3)}s`)}function Vi(o){if(!o)return 214;let e=5381;for(let t=0;t<o.length;t++)e=Math.imul(e,33)+o.charCodeAt(t);return(e%360+360)%360}const Ki="X-WP-Nonce";function Na(o,e){const t=Pa();if(!t)return e;const s=za(o);if(!s||!Ma(s))return e;const i=e?.headers??(typeof Request<"u"&&o instanceof Request?o.headers:void 0),n=new Headers(i??{});return n.has(Ki)?e:(n.set(Ki,t),{...e??{},headers:n})}function Pa(){if(typeof window>"u")return;const e=window.openStationConfig?.restNonce;return typeof e=="string"&&e.length>0?e:void 0}function za(o){try{const e=typeof window<"u"&&window.location?window.location.href:void 0;return typeof o=="string"?new URL(o,e):o instanceof URL?o:typeof Request<"u"&&o instanceof Request?new URL(o.url,e):null}catch{return null}}function Ma(o){return typeof window>"u"||!window.location||o.origin!==window.location.origin?!1:!!(o.pathname.includes("/wp-json/")||o.searchParams.has("rest_route"))}function Oa(o,e,t={}){const s=window.wp?.os?.fetch;if(typeof s=="function")return s(o,e,t);const i=Na(o,e);return fetch(o,i)}const oe=[[0,0],[100,0],[100,100],[0,100]],Wa=48,Ha=80,As=6,Cs=8,ji=4,Bi=3,Gi=64,Ss=105,ie=2;function Xi(o){return`${Math.round(o*1e3)/1e3}%`}function ne(o){return o.slice().reverse()}function Ce(o,e,t,s){return[[o,e],[t,e],[t,s],[o,s]]}function Ua(o,e,t,s){const i=[];for(let n=0;n<s;n++){const r=n/s*Math.PI*2;i.push([o+Math.cos(r)*t,e+Math.sin(r)*t])}return i}function B(o,e=[]){const t=[],s=i=>{t.push(`${Xi(i[0])} ${Xi(i[1])}`)};for(const i of o)s(i);if(e.length>0){s(o[0]);for(const i of e){for(const n of i)s(n);s(i[0]),s(o[0])}}return`polygon( ${t.join(", ")} )`}function Zi(o){return B(oe,[ne(Ua(50,50,o,Wa))])}function Yi(o){return B(oe,[ne(Ce(50-o,-ie,50+o,100+ie))])}function Qi(o){const e=100/As,t=[];for(let s=0;s<As;s++){const i=s*e;t.push(ne(Ce(-ie,i,100+ie,i+o)))}return B(oe,t)}function Ji(o){return B(oe,[ne(Ce(-ie,50-o,100+ie,50+o))])}function en(o){const e=100/Cs,t=[];for(let s=0;s<Cs;s++){const i=s*e;t.push(ne(Ce(i,-ie,i+o,100+ie)))}return B(oe,t)}function tn(o){return B(oe,[ne([[50,50-o],[50+o,50],[50,50+o],[50-o,50]])])}function sn(o){const e=100/ji,t=100/Bi,s=[];for(let i=0;i<Bi;i++)for(let n=0;n<ji;n++){const r=n*e+e/2,a=i*t+t/2,c=e/2*o,u=t/2*o;s.push(ne(Ce(r-c,a-u,r+c,a+u)))}return B(oe,s)}function on(o){const e=-Math.PI/2,t=o/180*Math.PI,s=[[50,50]];for(let i=0;i<Gi;i++){const n=e+i/(Gi-1)*t;s.push([50+Math.cos(n)*Ss,50+Math.sin(n)*Ss])}return B(oe,[ne(s)])}function qa(){return{from:Zi(0),to:Zi(Ha)}}function Fa(){return{from:Yi(0),to:Yi(52)}}function Va(){return{from:Qi(0),to:Qi(100/As+.5)}}function Ka(){return{from:Ji(0),to:Ji(52)}}function ja(){return{from:en(0),to:en(100/Cs+.5)}}function Ba(){return{from:tn(0),to:tn(Ss)}}function Ga(){return{from:sn(0),to:sn(1.04)}}function Xa(){return{from:on(0),to:on(360)}}function Za(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 100% 0% )"}}function Ya(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 0% 100% )"}}function Qa(){return{from:B([[-60,0],[100,0],[100,100],[0,100]]),to:B([[100,0],[260,0],[260,100],[160,100]])}}const Ls=6,Rs=100,me=Rs/2,ts=200,nn=90,rn=["#5c5c6d","#525261","#484855","#3e3e49","#34343d","#2a2a31"],Ja="#101014",el=1.25,ve="http://www.w3.org/2000/svg";let tl=0;function ss(o){return Math.round(o*1e3)/1e3}function Is(o){return o/Ls*Math.PI*2-Math.PI/2}function sl(o){const t=Is(o)+Math.PI/Ls+Math.PI/2;return{x:Math.cos(t),y:Math.sin(t)}}function ol(o){const e=Is(o),t=Is(o+1);return[[me,me],[me+Math.cos(e)*ts,me+Math.sin(e)*ts],[me+Math.cos(t)*ts,me+Math.sin(t)*ts]]}function an(o,e){const t=ol(o),s=document.createElementNS(ve,"path");return s.setAttribute("d",`M ${t.map(([i,n])=>`${ss(i)} ${ss(n)}`).join(" L ")} Z`),e?s.setAttribute("fill","#fff"):(s.setAttribute("fill",rn[o%rn.length]),s.setAttribute("stroke",Ja),s.setAttribute("stroke-width",String(el)),s.setAttribute("vector-effect","non-scaling-stroke"),s.setAttribute("stroke-linejoin","round")),s}function il(){const o=`os-iris-${++tl}`,e=document.createElementNS(ve,"svg");e.setAttribute("viewBox",`0 0 ${Rs} ${Rs}`),e.setAttribute("preserveAspectRatio","none"),e.setAttribute("aria-hidden","true"),e.style.width="100%",e.style.height="100%",e.style.display="block";const t=document.createElementNS(ve,"defs"),s=document.createElementNS(ve,"mask");s.setAttribute("id",o);const i=document.createElementNS(ve,"g"),n=document.createElementNS(ve,"g");n.setAttribute("mask",`url(#${o})`);const r=[];for(let c=0;c<Ls;c++){const u=an(c,!0),h=an(c,!1);i.appendChild(u),n.appendChild(h),r.push({el:u,index:c},{el:h,index:c})}s.appendChild(i),t.appendChild(s),e.appendChild(t),e.appendChild(n);const a=document.createElement("div");return a.appendChild(e),{element:a,play:c=>r.map(({el:u,index:h})=>{const p=sl(h),g=ss(p.x*nn),m=ss(p.y*nn);return u.animate([{transform:"translate( 0px, 0px )"},{transform:`translate( ${g}px, ${m}px )`}],{duration:c.duration,easing:c.easing,delay:c.delay,fill:"both"})})}}const os="none",ln=j("desktop-mode/window-reveal-registry",()=>({registry:new Map,listeners:new Set})),Ds=ln.state.registry,Ts=ln.state.listeners,cn=/^[a-z0-9_/-]+$/;function dn(o){const e=/^\s*([a-zA-Z-]+)\s*\(/.exec(o);return e?e[1].toLowerCase():""}const nl=0;function un(o,e){const t=[],s=typeof o.from=="string"&&o.from.trim()!=="",i=typeof o.to=="string"&&o.to.trim()!=="";if(s||t.push(`${e}.from (missing — the clip-path covering the window)`),i||t.push(`${e}.to (missing — the clip-path uncovering the window)`),s&&i){const n=dn(o.from),r=dn(o.to);n===""||r===""?t.push(`${e}.from|to (must be shape functions, e.g. \`inset( … )\` or \`polygon( … )\` — bare keywords like \`none\` cannot be animated)`):n!==r&&t.push(`${e}.from|to (must use the same shape function to interpolate — got \`${n}()\` and \`${r}()\`)`)}return t}function rl(o){if(typeof KeyframeEffect!="function")return!0;try{return new KeyframeEffect(null,null,{easing:o}),!0}catch{return!1}}function q(o){const e=[];if(!o||typeof o!="object")e.push("def (not an object)");else{typeof o.id!="string"||o.id.trim()===""?e.push("id (missing)"):cn.test(o.id.trim().toLowerCase())?o.id.trim().toLowerCase()===os&&e.push('id ("none" is reserved)'):e.push(`id (must match ${cn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof o.label!="string"||o.label.trim()==="")&&e.push("label (missing)");const s=o.render!==void 0,i=Array.isArray(o.layers),n=o.from!==void 0||o.to!==void 0;s&&typeof o.render!="function"?e.push("render (not a function)"):s&&(i||n)?e.push("render|layers|from|to (supply exactly one of: a from/to pair, a layers array, or a render function)"):s||(i&&n?e.push("layers|from|to (supply EITHER a single from/to pair OR a layers array, not both)"):i?(o.layers.length===0&&e.push("layers (empty — supply at least one matched pair)"),o.layers.forEach((r,a)=>{if(!r||typeof r!="object"){e.push(`layers[ ${a} ] (not an object)`);return}e.push(...un(r,`layers[ ${a} ]`))})):e.push(...un(o,"").map(r=>r.replace(/^\./,"")))),o.easing!==void 0&&(typeof o.easing!="string"||o.easing.trim()===""?e.push("easing (not a non-empty string)"):rl(o.easing)||e.push("easing (not an easing the browser can parse — `Element.animate()` would throw at play time, with the covering surface already over the window)"))}ks("WindowReveal",e,o);const t=o.id.trim().toLowerCase();Ds.set(t,{...o,id:t}),dl()}function al(){const o=Array.from(Ds.values()),e=ce(O.WINDOW_REVEALS,o);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-reveals` filter returned a non-array; falling back to registry list."),o)}function ll(o){return Ds.has(o)}function cl(o){return Ts.add(o),()=>{Ts.delete(o)}}function dl(){const o=Array.from(Ts);for(const e of o)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] window-reveal registry listener threw:",t)}}q({id:"sweep",label:d("Sweep"),description:d("A straight edge travels across the window, uncovering the page behind it."),...Ya(),duration:420}),q({id:"iris",label:d("Iris"),description:d("The page opens out from the centre of the window, like a camera shutter."),...qa(),duration:520}),q({id:"curtain",label:d("Curtain"),description:d("Two panels part from the middle of the window and slide off the sides."),...Fa(),duration:480}),q({id:"blinds",label:d("Blinds"),description:d("Six horizontal slats retract at once, letting the page through between them."),...Va(),duration:560}),q({id:"diagonal",label:d("Diagonal"),description:d("A slanted edge sweeps off the trailing corner of the window."),...Qa(),duration:460}),q({id:"rise",label:d("Rise"),description:d("The page rises into the window from the bottom edge upward."),...Za(),duration:440}),q({id:"shutter",label:d("Shutter"),description:d("Two panels part from the middle of the window and slide off the top and bottom."),...Ka(),duration:480}),q({id:"slats",label:d("Slats"),description:d("Eight vertical slats retract at once, letting the page through between them."),...ja(),duration:560}),q({id:"diamond",label:d("Diamond"),description:d("The page opens out from the centre of the window through a growing rhombus."),...Ba(),duration:520}),q({id:"mosaic",label:d("Mosaic"),description:d("The page arrives as a grid of tiles, each opening out from its own centre."),...Ga(),duration:600}),q({id:"obturator",label:d("Camera shutter"),description:d("Six wedges slide aside in unison, opening a hexagonal aperture from the centre like the iris of a camera lens."),render:il,duration:720,edgeLag:0}),q({id:"radar",label:d("Radar"),description:d("A spoke sweeps a full turn around the centre of the window, uncovering the page behind it."),...Xa(),duration:760});const ul="desktop-mode-os-settings",Ns=1920,Ps=1080,hl=40,pl=300,is="custom-gradient",re="custom-image",gl="galaxy",Se="custom",hn=[{id:"pulse",label:"Pulse",value:"#f252fc"},{id:"nebula",label:"Nebula",value:"#ec9bff"},{id:"sirius",label:"Sirius",value:"#9af2ff"},{id:"lagoon",label:"Lagoon",value:"#9f98ff"},{id:"wp-blue",label:"WordPress Blue",value:"#2271b1"},{id:"indigo",label:"Indigo",value:"#3858e9"},{id:"teal",label:"Teal",value:"#04a4cc"},{id:"emerald",label:"Emerald",value:"#059669"},{id:"amber",label:"Amber",value:"#d97706"},{id:"rose",label:"Rose",value:"#e11d48"}];function zs(){const e=window.wp?.os?.config?.accentColors;if(!Array.isArray(e)||e.length===0)return hn;const t=[];for(const s of e)s&&typeof s=="object"&&typeof s.id=="string"&&typeof s.label=="string"&&typeof s.value=="string"&&s.id!==""&&s.label!==""&&/^#[0-9a-f]{3,8}$/i.test(s.value)&&t.push({id:s.id,label:s.label,value:s.value});return t.length>0?t:hn}function fl(){const e=window.wp?.os?.config?.defaultWallpaper;return typeof e=="string"&&e!==""?e:gl}const pn=[{id:"compact",label:"Compact",width:48,icon:18},{id:"default",label:"Default",width:56,icon:20},{id:"large",label:"Large",width:72,icon:26}],gn=[{id:"sharp",label:"Sharp",value:0},{id:"default",label:"Default",value:8},{id:"round",label:"Round",value:16}],fn=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"},{id:"hidden",label:"Hidden"}],Ms=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"}],bn=[{id:"bottom",label:"Bottom"},{id:"left",label:"Left"},{id:"right",label:"Right"}],bl=[{id:"unified",label:"Unified"},{id:"classic",label:"Split"}],mn={dockSize:["compact","default","large"],desktopLayout:["classic","unified"],dockPlacement:["bottom","left","right"],windowRadius:["sharp","default","round"],adminBarMode:["static","dynamic","hidden"]},vn=["dockRailRenderer","windowReveal","accent"],_n={windowRevealDuration:{min:80,max:4e3}},ml=/^[a-z0-9_-]+$/;[...Object.keys(mn),...vn,...Object.keys(_n)];function yn(o){if(!o||typeof o!="object"||Array.isArray(o))return{};const e=o,t={},s={};for(const[i,n]of Object.entries(mn)){const r=e[i];typeof r=="string"&&n.includes(r)&&(t[i]=r)}for(const i of vn){const n=e[i];typeof n=="string"&&ml.test(n)&&(t[i]=n)}for(const[i,n]of Object.entries(_n)){const r=e[i];typeof r=="number"&&Number.isFinite(r)&&(s[i]=Math.min(n.max,Math.max(n.min,Math.round(r))))}return{...t,...s}}function wn(o){const e=yn(o);return typeof e.dockRailRenderer=="string"&&Ra(e.dockRailRenderer)===void 0&&delete e.dockRailRenderer,typeof e.windowReveal=="string"&&e.windowReveal!==os&&!ll(e.windowReveal)&&delete e.windowReveal,typeof e.accent=="string"&&!zs().some(t=>t.id===e.accent)&&delete e.accent,e}const vl=/^[a-z0-9_-]+$/,xn=128;function _l(o){return typeof o!="string"||o===""||o.length>2048?!1:o.startsWith("dashicons-")||o.startsWith("https://")||o.startsWith("http://")||o.startsWith("data:image/")}function kn(o){if(!o||typeof o!="object")return null;const e=o,t=typeof e.slug=="string"?e.slug:"";if(!vl.test(t))return null;const s={};if(e.icons&&typeof e.icons=="object"){let c=0;for(const[u,h]of Object.entries(e.icons)){if(c>=xn)break;u===""||!_l(h)||(s[u]=h,c+=1)}}const i={};if(e.tokens&&typeof e.tokens=="object")for(const[c,u]of Object.entries(e.tokens))typeof u=="string"&&(i[c]=u);const n=[];if(Array.isArray(e.fonts))for(const c of e.fonts)typeof c=="string"&&c!==""&&n.push(c);const r={};if(e.iconColors&&typeof e.iconColors=="object"){let c=0;for(const[u,h]of Object.entries(e.iconColors)){if(c>=xn)break;u===""||typeof h!="string"||h===""||(r[u]=h,c+=1)}}const a=c=>typeof e[c]=="string"?e[c]:"";return{id:a("id")||t,slug:t,name:a("name")||t,version:a("version"),author:a("author"),description:a("description"),previewUrl:a("previewUrl"),cssUrl:a("cssUrl"),cssText:a("cssText"),tokens:i,fonts:n,icons:s,iconColors:r,recommendedOsSettings:yn(e.recommendedOsSettings),installedAt:typeof e.installedAt=="number"?e.installedAt:0,source:e.source==="code"?"code":"upload",cssDeferred:e.cssDeferred===!0}}function yl(){const e=window.openStationConfig?.serverDesktopThemes,t=[];if(Array.isArray(e))for(const s of e){const i=kn(s);i&&t.push(i)}return{themes:t,activeId:null,activeIcons:null,activeIconColors:null}}const J=j("desktop-mode/desktop-themes",yl);function $n(){return J}function wl(){return J.getState().themes.slice()}function xl(o){if(typeof o!="string"||o==="")return null;const e=o.replace(/\//g,"-");return J.getState().themes.find(t=>t.slug===e||t.id===o)??null}function kl(o){const e=kn(o);if(!e)return null;const t=J.state.themes.slice(),s=t.findIndex(i=>i.slug===e.slug);return s>=0?t[s]=e:t.push(e),t.sort((i,n)=>i.name.localeCompare(n.name)),J.setState({themes:t}),e}function $l(o){const e=J.state.themes.filter(t=>t.slug!==o);e.length!==J.state.themes.length&&J.setState({themes:e})}function El(o){return J.subscribe(o)}function Al(o){const e=$n().state;if(e.activeIcons===null||!o)return null;const t=e.activeIcons[o];if(typeof t!="string"||t==="")return null;const s=ce(O.DESKTOP_THEME_ICON,t,{slot:o,themeId:e.activeId??""});return typeof s=="string"&&s!==""?s:null}function Cl(o){const e=$n().state;if(e.activeIconColors===null||!o)return null;const t=e.activeIconColors[o];if(typeof t!="string"||t==="")return null;const s=ce(O.DESKTOP_THEME_ICON_COLOR,t,{slot:o,themeId:e.activeId??""});return typeof s=="string"&&s!==""?Sl(s):null}function Sl(o){const e=o.trim();if(e===""||e.length>64||/[;{}<>"'\\]/.test(e))return null;let t=0;for(const s of e)if(s==="(")t+=1;else if(s===")"&&(t-=1,t<0))return null;return t===0?e:null}function Ll(o){return typeof o!="string"||o===""||o.length>4096||!/^(https?:\/\/|data:image\/)/i.test(o)?!1:!/['"()\\<>\s]/.test(o)}function En(o,e,t){if(!Ll(e))return!1;const s=`url("${e}") center / contain no-repeat`;return o.style.backgroundImage="none",o.style.backgroundColor=t,o.style.setProperty("-webkit-mask",s),o.style.setProperty("mask",s),!0}const Le={OS_SETTINGS:"OS_SETTINGS",RECYCLE_BIN:"RECYCLE_BIN",BUG_REPORT:"BUG_REPORT",EXIT_OPENSTATION:"EXIT_OPENSTATION",PWA_INSTALL:"PWA_INSTALL"},Rl={"desktop-mode-os-settings":Le.OS_SETTINGS,"desktop-mode-recycle-bin":Le.RECYCLE_BIN,"desktop-mode-bug-report":Le.BUG_REPORT,"os-exit":Le.EXIT_OPENSTATION,"os-pwa-install":Le.PWA_INSTALL};function Il(o){if(typeof o!="string"||o==="")return"";const e=Rl[o];if(e)return e;const t=o.toLowerCase().replace(/[^a-z0-9_-]/g,"");return t===""?"":`APP:${t}`}j("desktop-mode/native-url-remap",()=>({remaps:[],deps:null}));const Dl={core:"rail",plugin:"rail",app:"desktop",control:"rail"};function Tl(o,e){return o==="core"&&e==="classic"?"sidebar":"dock"}function Nl(o,e){return o.locked?"rail":e[o.id]??o.defaultPlacement??Dl[o.kind]}function Pl(o){return o.map((e,t)=>({item:e,index:t})).sort((e,t)=>(e.item.order??0)-(t.item.order??0)||e.index-t.index).map(e=>e.item)}function zl(){return window.wp?.os??null}function Ml(){return zl()?.getNavItems?.()??[]}const Os="none",An=j("desktop-mode/unfocus-effect-registry",()=>({registry:new Map,listeners:new Set})),Cn=An.state.registry,Ws=An.state.listeners,Sn=/^[a-z0-9_/-]+$/;function Hs(o){const e=[];!o||typeof o!="object"?e.push("def (not an object)"):(typeof o.id!="string"||o.id.trim()===""?e.push("id (missing)"):Sn.test(o.id.trim().toLowerCase())?o.id.trim().toLowerCase()===Os&&e.push('id ("none" is reserved)'):e.push(`id (must match ${Sn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof o.label!="string"||o.label.trim()==="")&&e.push("label (missing)"),typeof o.className!="string"&&typeof o.apply!="function"&&e.push("className|apply (at least one must be provided — a CSS class to toggle or an apply callback)")),ks("UnfocusEffect",e,o);const t=o.id.trim().toLowerCase();Cn.set(t,{...o,id:t}),Hl()}function Ol(){const o=Array.from(Cn.values()),e=ce(O.UNFOCUS_EFFECTS,o);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.unfocus-effects` filter returned a non-array; falling back to registry list."),o)}function Wl(o){return Ws.add(o),()=>{Ws.delete(o)}}function Hl(){const o=Array.from(Ws);for(const e of o)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] unfocus-effect registry listener threw:",t)}}Hs({id:"darken",label:d("Darken"),description:d("Dim unfocused windows so the focused one stands out."),className:"os-window--fx-darken"}),Hs({id:"frost",label:d("Frost"),description:d("Throw unfocused windows out of focus — a soft, frosted-glass blur, as if you were looking at them through an iced-over pane."),className:"os-window--fx-frost"}),Hs({id:"grayscale",label:d("Grayscale"),description:d("Drain the colour from unfocused windows so the focused one is the only thing still in colour — your eye snaps right to it."),className:"os-window--fx-grayscale"});const Ln="none",Rn=j("desktop-mode/window-link-renderer-registry",()=>({registry:new Map,listeners:new Set})),Ul=Rn.state.registry,In=Rn.state.listeners;function ql(){const o=Array.from(Ul.values()),e=ce(O.WINDOW_LINK_RENDERERS,o);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-links.renderers` filter returned a non-array; falling back to registry list."),o)}function Fl(o){return In.add(o),()=>{In.delete(o)}}let ue=null;function Vl(){if(ue)return ue;if(window.openStationWindowLinkVisuals)return ue=Promise.resolve(!0),ue;const e=window.openStationConfig?.windowLinkVisualsBundleUrl;return e?(ue=Es(e).then(()=>!0).catch(t=>{throw ue=null,t}),ue):Promise.resolve(!1)}const Dn=j("desktop-mode/settings-tab-registry",()=>({registry:new Map,listeners:new Set})),Kl=Dn.state.registry,Tn=Dn.state.listeners;function jl(){return Array.from(Kl.values()).sort((o,e)=>(o.order??100)-(e.order??100))}function Bl(o){return Tn.add(o),()=>{Tn.delete(o)}}function Us(o){const{from:e,to:t,angle:s}=o.customGradient;return`linear-gradient(${s}deg, ${e}, ${t})`}function Gl(o,e){Ni({id:is,label:d("Custom gradient"),type:"css",preview:Us(o()),description:d("Mix your own two-colour gradient and set the angle — your desk, your palette."),resolveValue:()=>Us(o()),...e?{renderEditor:e}:{}})}const Nn={close:{a:'fill="currentColor"',b:'<path d="m13.06 12 6.47-6.47-1.06-1.06L12 10.94 5.53 4.47 4.47 5.53 10.94 12l-6.47 6.47 1.06 1.06L12 13.06l6.47 6.47 1.06-1.06L13.06 12Z" />'},check:{a:'fill="currentColor"',b:'<path d="M16.5 7.5 10 13.9l-2.5-2.4-1 1 3.5 3.6 7.5-7.6z" />'},"chevron-right":{a:'fill="currentColor"',b:'<path d="M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z" />'},"arrow-up-right":{a:'fill="currentColor"',b:'<path d="M10 6H18V14H16.5V8.5L7 18L6 17L15.5 7.5H10V6Z" />'},plus:{a:'fill="currentColor"',b:'<path d="M11 12.5V17.5H12.5V12.5H17.5V11H12.5V6H11V11H6V12.5H11Z" />'},search:{a:'fill="currentColor"',b:'<path d="M13 5c-3.3 0-6 2.7-6 6 0 1.4.5 2.7 1.3 3.7l-3.8 3.8 1.1 1.1 3.8-3.8c1 .8 2.3 1.3 3.7 1.3 3.3 0 6-2.7 6-6S16.3 5 13 5zm0 10.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z" />'},pin:{a:'fill="currentColor"',b:'<path d="m21.5 9.1-6.6-6.6-4.2 5.6c-1.2-.1-2.4.1-3.6.7-.1 0-.1.1-.2.1-.5.3-.9.6-1.2.9l3.7 3.7-5.7 5.7v1.1h1.1l5.7-5.7 3.7 3.7c.4-.4.7-.8.9-1.2.1-.1.1-.2.2-.3.6-1.1.8-2.4.6-3.6l5.6-4.1zm-7.3 3.5.1.9c.1.9 0 1.8-.4 2.6l-6-6c.8-.4 1.7-.5 2.6-.4l.9.1L15 4.9 19.1 9l-4.9 3.6z" />'},trash:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.5A2.25 2.25 0 0 0 9.878 7h4.244A2.251 2.251 0 0 0 12 5.5ZM12 4a3.751 3.751 0 0 0-3.675 3H5v1.5h1.27l.818 8.997a2.75 2.75 0 0 0 2.739 2.501h4.347a2.75 2.75 0 0 0 2.738-2.5L17.73 8.5H19V7h-3.325A3.751 3.751 0 0 0 12 4Zm4.224 4.5H7.776l.806 8.861a1.25 1.25 0 0 0 1.245 1.137h4.347a1.25 1.25 0 0 0 1.245-1.137l.805-8.861Z" />'},download:{a:'fill="currentColor"',b:'<path d="M18 11.3l-1-1.1-4 4V3h-1.5v11.3L7 10.2l-1 1.1 6.2 5.8 5.8-5.8zm.5 3.7v3.5h-13V15H4v5h16v-5h-1.5z" />'},settings:{a:'fill="currentColor"',b:'<path d="m19 7.5h-7.628c-.3089-.87389-1.1423-1.5-2.122-1.5-.97966 0-1.81309.62611-2.12197 1.5h-2.12803v1.5h2.12803c.30888.87389 1.14231 1.5 2.12197 1.5.9797 0 1.8131-.62611 2.122-1.5h7.628z" /><path d="m19 15h-2.128c-.3089-.8739-1.1423-1.5-2.122-1.5s-1.8131.6261-2.122 1.5h-7.628v1.5h7.628c.3089.8739 1.1423 1.5 2.122 1.5s1.8131-.6261 2.122-1.5h2.128z" />'},info:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm.75 4v1.5h-1.5V8h1.5Zm0 8v-5h-1.5v5h1.5Z" />'},bell:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M17 11.5c0 1.353.17 2.368.976 3 .266.209.602.376 1.024.5v1H5v-1c.422-.124.757-.291 1.024-.5.806-.632.976-1.647.976-3V9c0-2.8 2.2-5 5-5s5 2.2 5 5v2.5ZM15.5 9v2.5c0 .93.066 1.98.515 2.897l.053.103H7.932a4.018 4.018 0 0 0 .053-.103c.449-.917.515-1.967.515-2.897V9c0-1.972 1.528-3.5 3.5-3.5s3.5 1.528 3.5 3.5Zm-5.492 9.008c0-.176.023-.346.065-.508h3.854A1.996 1.996 0 0 1 12 20c-1.1 0-1.992-.892-1.992-1.992Z" />'},more:{a:'fill="currentColor"',b:'<path d="M11 13h2v-2h-2v2zm-6 0h2v-2H5v2zm12-2v2h2v-2h-2z" />'},maximize:{a:'fill="currentColor"',b:'<path d="M6 4a2 2 0 0 0-2 2v3h1.5V6a.5.5 0 0 1 .5-.5h3V4H6Zm3 14.5H6a.5.5 0 0 1-.5-.5v-3H4v3a2 2 0 0 0 2 2h3v-1.5Zm6 1.5v-1.5h3a.5.5 0 0 0 .5-.5v-3H20v3a2 2 0 0 1-2 2h-3Zm3-16a2 2 0 0 1 2 2v3h-1.5V6a.5.5 0 0 0-.5-.5h-3V4h3Z" />'},edit:{a:'fill="currentColor"',b:'<path d="m19 7-3-3-8.5 8.5-1 4 4-1L19 7Zm-7 11.5H5V20h7v-1.5Z" />'},color:{a:'fill="currentColor"',b:'<path d="M17.2 10.9c-.5-1-1.2-2.1-2.1-3.2-.6-.9-1.3-1.7-2.1-2.6L12 4l-1 1.1c-.6.9-1.3 1.7-2 2.6-.8 1.2-1.5 2.3-2 3.2-.6 1.2-1 2.2-1 3 0 3.4 2.7 6.1 6.1 6.1s6.1-2.7 6.1-6.1c0-.8-.3-1.8-1-3zm-5.1 7.6c-2.5 0-4.6-2.1-4.6-4.6 0-.3.1-1 .8-2.3.5-.9 1.1-1.9 2-3.1.7-.9 1.3-1.7 1.8-2.3.7.8 1.3 1.6 1.8 2.3.8 1.1 1.5 2.2 2 3.1.7 1.3.8 2 .8 2.3 0 2.5-2.1 4.6-4.6 4.6z" />'},wallpaper:{a:'fill="currentColor"',b:'<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM5 4.5h14c.3 0 .5.2.5.5v8.4l-3-2.9c-.3-.3-.8-.3-1 0L11.9 14 9 12c-.3-.2-.6-.2-.8 0l-3.6 2.6V5c-.1-.3.1-.5.4-.5zm14 15H5c-.3 0-.5-.2-.5-.5v-2.4l4.1-3 3 1.9c.3.2.7.2.9-.1L16 12l3.5 3.4V19c0 .3-.2.5-.5.5z" />'},warning:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-.75 12v-1.5h1.5V16h-1.5Zm0-8v5h1.5V8h-1.5Z" />'},minimize:{a:'fill="currentColor"',b:'<path d="M5 11.25h14v1.5H5z" />'},window:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="5.4375" width="15.75" height="13.125" rx="1.75"/><path d="M4.125 9.8125h15.75"/><circle cx="7.275" cy="7.625" r="0.7438" fill="currentColor" stroke="none"/>'},windows:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="8.5" width="11.375" height="10.0625" rx="1.75"/><path d="M3.6875 12h11.375"/><path d="M8.5 8.5V7.1875a1.75 1.75 0 0 1 1.75-1.75h7.875A1.75 1.75 0 0 1 19.875 7.1875v7a1.75 1.75 0 0 1-1.75 1.75h-3.0625"/>'},dock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.25" y="8.5" width="17.5" height="7" rx="3.5"/><circle cx="7.625" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="16.375" cy="12" r="1.0062" fill="currentColor" stroke="none"/>'},spaces:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><rect x="12.875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><circle cx="9.375" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="12" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="14.625" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/>'},copilot:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M10 2.5Q10.9 8.5 17.5 10Q10.9 11.5 10 17.5Q9.1 11.5 2.5 10Q9.1 8.5 10 2.5Z" fill="currentColor" stroke="none"/><path d="M17.9 14Q18.35 17.1 21.5 17.6Q18.35 18.1 17.9 21.2Q17.45 18.1 14.3 17.6Q17.45 17.1 17.9 14Z" fill="currentColor" stroke="none"/>'},snap:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="16.625" height="13.125" rx="1.75"/><path d="M12 5.4375v13.125"/><path d="M12 12h8.3125"/>'},command:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M14.625 6.75v10.5a2.625 2.625 0 1 0 2.625-2.625H6.75a2.625 2.625 0 1 0 2.625 2.625V6.75a2.625 2.625 0 1 0-2.625 2.625h10.5a2.625 2.625 0 1 0-2.625-2.625"/>'},apps:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="4.125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/>'},widgets:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="3.6875" width="9.625" height="9.625" rx="1.75"/><rect x="15.0625" y="3.6875" width="5.25" height="5.25" rx="1.75"/><rect x="15.0625" y="10.6875" width="5.25" height="9.625" rx="1.75"/><rect x="3.6875" y="15.0625" width="9.625" height="5.25" rx="1.75"/>'},user:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<circle cx="12" cy="8.9375" r="3.5"/><path d="M5.4375 19.4375a6.5625 6.5625 0 0 1 13.125 0"/>'},lock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="5.4375" y="10.6875" width="13.125" height="8.75" rx="1.75"/><path d="M8.5 10.6875V8.0625a3.5 3.5 0 0 1 7 0v2.625"/>'}};function Pn(o){return o.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Xl(o){return Object.prototype.hasOwnProperty.call(Nn,o)?Nn[o]:null}function Zl(o,e={}){const t=Xl(o);if(!t)return"";const{size:s=24,className:i,title:n,rotate:r}=e,a=['xmlns="http://www.w3.org/2000/svg"','viewBox="0 0 24 24"'];s!=null&&a.push(`width="${s}"`,`height="${s}"`),a.push(t.a),i&&a.push(`class="${Pn(i)}"`),n?a.push('role="img"',`aria-label="${Pn(n)}"`):a.push('aria-hidden="true"','focusable="false"');const c=r?`<g transform="rotate(${r} 12 12)">${t.b}</g>`:t.b;return`<svg ${a.join(" ")}>${c}</svg>`}function I(o,e={}){const t=Zl(o,e),s=document.createElement("div");s.innerHTML=t;const i=s.firstElementChild;return i instanceof SVGSVGElement?i:document.createElementNS("http://www.w3.org/2000/svg","svg")}const zn=j("desktop-mode/wallpaper-settings",()=>({values:{}}));function Mn(o){return{...zn.state.values[o]??{}}}function Yl(o,e){zn.state.values[o]={...e},de(O.WALLPAPER_SETTINGS_CHANGED,{id:o,settings:{...e}})}function qs(o){return!!o&&typeof o=="object"&&typeof o.then=="function"}const Ql=4,On=24,Wn=4,Jl=250,ec="os-settings__wallpaper-live-preview";function tc(o){const e=o.type==="canvas"?o.needs:void 0;if(!e||e.length===0)return Promise.resolve();const t=window.wp?.os;return t?.loadModules?t.loadModules(e):Promise.reject(new Error(`[openstation] Wallpaper "${o.id}" declares needs but wp.os.loadModules is unavailable.`))}function sc(){return window.openStationConfig?.pluginUrl??""}function oc(){return typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches}function ic(o){const e={...o.previewParams??{}},t=ce(O.WALLPAPER_PREVIEW_PARAMS,e,o.id);return!t||typeof t!="object"?e:t}function nc(o){const e=new Map;let t=!1;const s=()=>{let f=0;return e.forEach(A=>{(A.teardown||A.mounting)&&f++}),f},i=f=>{f.remountTimer!==null&&(clearTimeout(f.remountTimer),f.remountTimer=null)},n=f=>{if(f.generation++,f.mounting=!1,i(f),f.teardown){const A=f.teardown;f.teardown=null;try{A()}catch($){typeof console<"u"&&console.error(`[openstation] Wallpaper "${f.defId}" preview teardown threw:`,$)}}f.overlay.innerHTML=""},r=f=>{t||!f.visible||f.teardown||f.mounting||m&&(f.tile.clientWidth<On||f.tile.clientHeight<On)||a(f)},a=f=>{const A=Ae(f.defId);if(!A?.renderPreview||s()>=Ql)return;const $=++f.generation;f.mounting=!0,f.mountWidth=f.tile.clientWidth,f.mountHeight=f.tile.clientHeight;const L={id:A.id,pluginUrl:sc(),prefersReducedMotion:oc(),visible:!document.hidden,settings:Mn(A.id),params:ic(A),width:f.mountWidth,height:f.mountHeight},Z=P=>{if($!==f.generation||t){try{P()}catch{}return}f.mounting=!1,f.teardown=P,c(f)&&u(f)},K=P=>{$===f.generation&&(f.mounting=!1,f.overlay.innerHTML="",typeof console<"u"&&console.error(`[openstation] Wallpaper "${A.id}" renderPreview failed:`,P))};tc(A).then(()=>{if($!==f.generation||t)return;let P;try{P=A.renderPreview(f.overlay,L)}catch(F){K(F);return}if(qs(P)){P.then(Z,K);return}Z(P)},K)},c=f=>Math.abs(f.tile.clientWidth-f.mountWidth)>Wn||Math.abs(f.tile.clientHeight-f.mountHeight)>Wn,u=f=>{i(f),f.remountTimer=setTimeout(()=>{f.remountTimer=null,!(t||!f.teardown||!c(f))&&(n(f),r(f))},Jl)},h=f=>{for(const A of f){const $=e.get(A.target);$&&($.visible=A.isIntersecting,A.isIntersecting?r($):n($))}},p=typeof IntersectionObserver=="function"?new IntersectionObserver(h,{threshold:.1}):null,g=f=>{for(const A of f){const $=e.get(A.target);!$||t||(!$.teardown&&!$.mounting?r($):$.teardown&&c($)&&u($))}},m=typeof ResizeObserver=="function"?new ResizeObserver(g):null,b=f=>{n(f),p?.unobserve(f.tile),m?.unobserve(f.tile),f.overlay.remove(),e.delete(f.tile)},x=()=>{if(t)return;const f=o.querySelectorAll("os-swatch[data-wallpaper-id]"),A=new Set;f.forEach($=>{A.add($);const L=$.dataset.wallpaperId??"",K=!!Ae(L)?.renderPreview&&!!p,P=e.get($);if(P&&(P.defId!==L||!K)&&b(P),!K||e.has($))return;const F=document.createElement("div");F.className=ec,F.setAttribute("aria-hidden","true"),$.appendChild(F),e.set($,{tile:$,overlay:F,defId:L,generation:0,teardown:null,mounting:!1,visible:!1,mountWidth:0,mountHeight:0,remountTimer:null}),p.observe($),m?.observe($)}),e.forEach(($,L)=>{A.has(L)||b($)})},w=()=>{t||(t=!0,e.forEach(f=>n(f)),e.clear(),p?.disconnect(),m?.disconnect(),document.removeEventListener("os-window-closed",k))},k=()=>{o.isConnected||w()};return document.addEventListener("os-window-closed",k),{sync:x,dispose:w}}const le=class le extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(Hn)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,s){if(t===s)return;const i=rc(e);this._propValues[i]=s,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const s=(Array.isArray(e)?e:String(e).split(/\s+/)).map(i=>String(i).trim()).filter(i=>i!=="");this.className=s.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const s=Hn(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(s),set:i=>{let n;i==null||i===!1?n=null:i===!0?n="":n=String(i),this._propValues[t]=n,n===null?this.removeAttribute(s):this.setAttribute(s,n),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&fe(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(s=>s.sheet).filter(s=>s!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const s of e.styles)if(!s.sheet){const i=document.createElement("style");i.textContent=s.cssText,this.shadowRoot.appendChild(i)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!le._lightStylesAdopted.has(e)){le._lightStylesAdopted.add(e);for(const t of e.styles){const s=document.createElement("style");s.dataset.osUi=this.tagName.toLowerCase(),s.textContent=t.cssText,document.head.appendChild(s)}}}};le.props=[],le.styles=[],le.shadow=!0,le._lightStylesAdopted=new WeakSet;let _=le;function y(o,e){customElements.get(o)||customElements.define(o,e)}function Hn(o){return o.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function rc(o){return o.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const ac=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function v(o,...e){let t=o[0];for(let s=1;s<o.length;s++){const i=e[s-1];if(typeof i=="string"||typeof i=="number")t+=String(i);else if(i&&i.__wpdCss)t+=i.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof i);t+=o[s]}if(ac){const s=new CSSStyleSheet;return s.replaceSync(t),{__wpdCss:!0,sheet:s,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function lc(o){const e=[],t=[];let s=null,i=o.parentElement;for(;i&&!(i===document.body||i===document.documentElement);){const r=i.id||"";if(r.startsWith("wp-window-")){s=r.slice(10);break}if(i.tagName.toLowerCase()==="os-tabpanel"){const a=i.getAttribute("for");a&&t.unshift(a)}i=i.parentElement}s&&e.push(Fs(s));for(const r of t)e.push("tab-"+Fs(r));const n=o.getAttribute("label");return n&&e.push(Fs(n)),e.length===0?"os-unnamed":"os-"+e.filter(r=>r!=="").join("-")}function Fs(o){return o.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function Re(o){if(o.id)return o.id;const e=lc(o);return o.id=e,e}const S=v`:host{--_holo-fill:var( --os-ui-holo-fill,${"linear-gradient( 124deg, #afa2e8 0%, #f5a8ea 46%, #8ee9f7 100% )"} );--_holo-ink:var( --os-ui-holo-ink,#0c0b0f );--_holo-sheen:var( --os-ui-holo-sheen,linear-gradient( 124deg,rgba( 159,214,255,0.1 ) 0%,rgba( 236,155,255,0.12 ) 34%,rgba( 242,82,252,0.1 ) 58%,rgba( 147,240,198,0.09 ) 100% ) );--_holo-edge:var( --os-ui-holo-edge,linear-gradient( 124deg,rgba( 154,242,255,0.7 ) 0%,rgba( 236,155,255,0.85 ) 38%,rgba( 242,82,252,0.7 ) 62%,rgba( 159,152,255,0.6 ) 100% ) );--_holo-edge-quiet:var( --os-ui-holo-edge-quiet,linear-gradient( 124deg,rgba( 154,242,255,0.22 ) 0%,rgba( 236,155,255,0.28 ) 38%,rgba( 242,82,252,0.22 ) 62%,rgba( 159,152,255,0.2 ) 100% ) );--_holo-glow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) );--_holo-glow-strong:var( --os-ui-holo-glow-strong,0 0 0 1px rgba( 242,82,252,0.42 ),0 4px 18px rgba( 242,82,252,0.38 ),0 1px 3px rgba( 12,11,15,0.6 ) );--_holo-track:var( --os-ui-holo-track,rgba( 255,251,255,0.16 ) );--_holo-track-edge:var( --os-ui-holo-track-edge,#8c8f94 );--_holo-ring-color:var( --os-ui-accent-dim,#2271b1 );--_holo-focus:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #f252fc,0 0 12px 2px rgba( 242,82,252,0.45 ) );--_holo-focus-field:var( --os-ui-focus-ring-field,0 0 0 1px #f252fc,0 0 0 4px rgba( 242,82,252,0.18 ) );--_holo-t:var( --os-ui-holo-transition,220ms );--_holo-t-fast:var( --os-ui-motion-fast,140ms );--_holo-t-slow:var( --os-ui-motion-slow,340ms );--_holo-t-ambient:var( --os-ui-motion-ambient,12s );--_holo-spring:var( --os-ui-ease-spring,cubic-bezier( 0.32,1.5,0.55,1 ) );--_holo-ease:var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) );--_holo-loop:var( --os-ui-ease-loop,cubic-bezier( 0.45,0,0.55,1 ) )}`,cc=v` .os-holo-fill{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --_holo-ink );transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease}.os-holo-fill:hover{background-position:74% 66%}.os-holo-fill:active{background-position:88% 82%;filter:brightness( 0.94 )}@media ( prefers-reduced-motion:reduce ){.os-holo-fill{transition-duration:1ms}.os-holo-fill:hover,.os-holo-fill:active{background-position:22% 28%}}`,ns=v` .os-holo-sheen{position:relative;isolation:isolate}.os-holo-sheen::before{content:'';position:absolute;inset:0;z-index:-1;border-radius:inherit;background-image:var( --_holo-sheen );background-size:200% 200%;background-position:20% 30%;opacity:0;pointer-events:none;transition:opacity var( --_holo-t ) ease,background-position var( --_holo-t ) ease}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{opacity:1;background-position:76% 68%}@media ( prefers-reduced-motion:reduce ){.os-holo-sheen::before{transition-duration:1ms}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{background-position:20% 30%}}`,Un=v` .os-holo-edge{position:relative}.os-holo-edge::after{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;background-image:var( --_holo-edge-quiet );opacity:0;pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude;transition:opacity var( --_holo-t ) ease}.os-holo-edge:hover::after,.os-holo-edge:focus-visible::after{background-image:var( --_holo-edge );opacity:1}.os-holo-edge.is-lit::after{background-image:var( --_holo-edge );opacity:1}@media ( prefers-reduced-motion:reduce ){.os-holo-edge::after{transition-duration:1ms}}`,rs=v` .os-holo-glint{position:absolute;inset:0;border-radius:inherit;overflow:hidden;pointer-events:none}.os-holo-glint::before{content:'';position:absolute;top:-60%;bottom:-60%;width:45%;inset-inline-start:-60%;background:linear-gradient( 90deg,transparent 0%,rgba( 255,251,255,0.14 ) 45%,rgba( 255,251,255,0.22 ) 50%,rgba( 255,251,255,0.14 ) 55%,transparent 100% );transform:rotate( 18deg ) translateX( 0 );opacity:0}:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:os-holo-glint var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-glint{0%{opacity:0;transform:rotate( 18deg ) translateX( 0 )}15%{opacity:1}85%{opacity:1}100%{opacity:0;transform:rotate( 18deg ) translateX( 240vw )}}@media ( prefers-reduced-motion:reduce ){:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:none}}`,Vs=v` .os-holo-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:0 0 0 0 var( --_holo-ring-color );opacity:0;pointer-events:none}:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:os-holo-ring var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-ring{0%{opacity:0.45;box-shadow:0 0 0 0 var( --_holo-ring-color )}100%{opacity:0;box-shadow:0 0 0 10px transparent}}@media ( prefers-reduced-motion:reduce ){:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:none}}`,qn=v` .os-holo-shimmer{background-image:var( --_holo-fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}@keyframes os-holo-shimmer{0%{background-position:0% 50%}100%{background-position:100% 50%}}@media ( prefers-reduced-motion:reduce ){.os-holo-shimmer{animation:none;background-position:30% 50%}}`,Ks=v` .os-holo-enter{animation:os-holo-enter var( --_holo-t ) var( --_holo-spring )}@keyframes os-holo-enter{from{opacity:0;transform:scale( 0.96 )}}@media ( prefers-reduced-motion:reduce ){.os-holo-enter{animation:none}}`,js=v` input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):hover:not(:disabled ),select:hover:not(:disabled ),textarea:hover:not(:disabled ){border-color:var( --os-ui-border-strong,#8c8f94 )}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus,input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus-visible,select:focus,select:focus-visible,textarea:focus,textarea:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}input::placeholder,textarea::placeholder{color:var( --os-ui-fg-faint,#8c8f94 );opacity:1}input::selection,textarea::selection{background:var( --os-ui-selection-bg,rgba( 159,152,255,0.6 ) );color:var( --os-ui-selection-fg,#fffbff )}@media ( prefers-reduced-motion:reduce ){input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition-duration:1ms}}`,as=v` input[ type='checkbox' ],input[ type='radio' ]{appearance:none;-webkit-appearance:none;position:relative;flex:0 0 auto;box-sizing:border-box;width:16px;height:16px;margin:0;padding:0;border:1px solid var( --_holo-track-edge );border-radius:4px;background-color:var( --_holo-track );background-image:none;background-repeat:no-repeat;cursor:inherit;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='radio' ]{border-radius:50%}input[ type='checkbox' ]:hover:not(:disabled ),input[ type='radio' ]:hover:not(:disabled ){border-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:focus-visible,input[ type='radio' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked,input[ type='checkbox' ]:indeterminate,input[ type='radio' ]:checked{border-color:transparent;background-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:checked:focus-visible,input[ type='radio' ]:checked:focus-visible{box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:46%;width:3.5px;height:7.5px;border:solid var( --os-ui-fg-on-accent,#fff );border-width:0 2px 2px 0;transform:translate( -50%,-50% ) rotate( 45deg );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:indeterminate::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:8px;height:2px;border:0;border-radius:1px;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% )}input[ type='radio' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:6px;height:6px;border-radius:50%;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:disabled,input[ type='radio' ]:disabled{cursor:not-allowed}@keyframes os-holo-tick{from{opacity:0;transform:translate( -50%,-50% ) rotate( 45deg ) scale( 0.4 )}}@media ( prefers-reduced-motion:reduce ){input[ type='checkbox' ]:checked::after,input[ type='radio' ]:checked::after{animation:none}}`,Fn=v` @keyframes os-holo-drift{0%{background-position:16% 26%}50%{background-position:84% 74%}100%{background-position:16% 26%}}.os-holo-alive{animation:os-holo-drift var( --_holo-t-ambient ) var( --_holo-loop ) infinite}@media ( prefers-reduced-motion:reduce ){.os-holo-alive{animation:none}}`;v` ${S} ${cc} ${ns} ${Un} ${rs} ${Vs} ${qn} ${Ks} ${js} ${as} ${Fn} `;const dc=v` ${S}:host{display:none;position:fixed;inset:0;align-items:center;justify-content:center;background:var( --os-ui-scrim,rgba( 0,0,0,0.45 ) );background-image:var( --os-ui-scrim-image,none );background-repeat:var( --os-ui-scrim-image-repeat,repeat );background-size:var( --os-ui-scrim-image-size,auto );background-position:var( --os-ui-scrim-image-position,center );backdrop-filter:blur( 2px );z-index:10000;--os-ui-fg:var( --os-ui-modal-text,#f0f0f1 );--os-ui-fg-muted:var( --os-ui-modal-text-muted,#a7aaad );--os-ui-border:var( --os-ui-modal-border,rgba( 255,255,255,0.25 ) );--os-window-bg:var( --os-ui-modal-field-bg,#2c3338 );--os-ui-button-bg-hover:var( --os-ui-modal-button-bg-hover,rgba( 255,255,255,0.08 ) );--os-ui-surface:var( --os-ui-modal-surface,#2c3338 );--os-ui-surface-elevated:var( --os-ui-modal-surface-elevated,#3c434a );--os-ui-border-strong:var( --os-ui-modal-border-strong,rgba( 255,255,255,0.35 ) );--os-ui-hover:var( --os-ui-modal-hover,rgba( 255,255,255,0.08 ) );--os-ui-notice-color:var( --os-ui-modal-text,#f0f0f1 );--os-ui-card-bg:var( --os-ui-modal-surface,#2c3338 );--os-ui-card-fg:var( --os-ui-modal-text,#f0f0f1 );--os-ui-card-border:var( --os-ui-modal-border,rgba( 255,255,255,0.25 ) );--os-ui-card-border-hover:var( --os-ui-modal-border-strong,rgba( 255,255,255,0.35 ) )}:host( [ open ] ){display:flex;animation:os-modal-scrim var( --_holo-t ) var( --_holo-ease )}:host( [ open ] ) .dialog{animation:os-modal-dialog var( --_holo-t ) var( --_holo-spring )}@keyframes os-modal-scrim{from{opacity:0}}@keyframes os-modal-dialog{from{opacity:0;transform:scale( 0.96 ) translateY( 8px )}}@media ( prefers-reduced-motion:reduce ){:host( [ open ] ),:host( [ open ] ) .dialog{animation:none}}.dialog{max-width:92vw;max-height:90vh;background-color:var( --os-ui-modal-bg,#1d2327 );background-image:var( --os-ui-dialog-bg-image,none );background-repeat:var( --os-ui-dialog-bg-image-repeat,repeat );background-size:var( --os-ui-dialog-bg-image-size,auto );background-position:var( --os-ui-dialog-bg-image-position,center );color:var( --os-ui-modal-fg,var( --os-fg,#fff ) );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.08 ) );border-radius:10px;box-shadow:0 20px 50px rgba( 0,0,0,0.6 );display:flex;flex-direction:column;overflow:hidden}:host( [ size='sm' ] ) .dialog{width:min( 360px,92vw )}:host(:not( [ size ] ) ) .dialog,:host( [ size='md' ] ) .dialog{width:min( 540px,92vw )}:host( [ size='lg' ] ) .dialog{width:min( 760px,94vw )}.header{display:flex;align-items:center;gap:10px;padding:16px 20px 12px;border-bottom:1px solid var( --os-ui-border,rgba( 255,255,255,0.06 ) )}.title{margin:0;flex:1;font-size:15px;font-weight:600}.header-actions{display:flex;gap:6px}.header-actions::slotted( * ){margin-inline-start:6px}.close{background:transparent;border:0;color:inherit;font-size:18px;line-height:1;padding:4px 8px;border-radius:4px;cursor:pointer;opacity:0.7}.close:hover{opacity:1;background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) )}.body{padding:16px 20px;overflow:auto;flex:1 1 auto;font-size:13px;line-height:1.5}.footer{padding:12px 20px 16px;border-top:1px solid var( --os-ui-border,rgba( 255,255,255,0.06 ) )}.footer slot{display:flex;justify-content:flex-end;gap:10px;flex-wrap:wrap}:host( [ mandatory ] ) .close{display:none}`,Vn='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',Pe=class Pe extends _{constructor(){super(...arguments),this._prevFocus=null,this._onKey=e=>{if(e.key==="Escape"&&!this.hasAttribute("mandatory")){e.preventDefault(),this._cancel();return}if(e.key==="Tab"){const t=this._focusables();if(t.length===0)return;const s=t[0],i=t[t.length-1],n=this.ownerDocument,r=n?n.activeElement:null,a=e.composedPath()[0]||r;e.shiftKey&&a===s?(e.preventDefault(),i.focus()):!e.shiftKey&&a===i&&(e.preventDefault(),s.focus())}},this._onBackdrop=e=>{if(this.hasAttribute("mandatory"))return;const t=e.composedPath();(t.length>0?t[0]:e.target)===this&&this._cancel()}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","dialog"),this.setAttribute("aria-modal","true"),this.addEventListener("keydown",this._onKey),this.addEventListener("click",this._onBackdrop)}disconnectedCallback(){this.removeEventListener("keydown",this._onKey),this.removeEventListener("click",this._onBackdrop)}attributeChangedCallback(e,t,s){if(super.attributeChangedCallback?.(e,t,s),e==="open"){if(s!==null){const i=this.ownerDocument;this._prevFocus=i?i.activeElement:null,queueMicrotask(()=>this._focusFirst())}else if(this._prevFocus){try{this._prevFocus.focus()}catch{}this._prevFocus=null}}}showModal(){this.setAttribute("open","")}hideModal(){this.removeAttribute("open")}_focusables(){const e=this.shadowRoot;if(!e)return[];const t=Array.from(this.querySelectorAll(Vn)),s=Array.from(e.querySelectorAll(Vn));return[...t,...s].filter(i=>i.offsetParent!==null||i.tagName==="BUTTON")}_focusFirst(){const e=this._focusables();e.length>0?e[0].focus():this.shadowRoot?.querySelector(".dialog")?.focus?.()}_cancel(){const e=new CustomEvent("os-modal-cancel",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(e)&&this.hideModal()}render(){const e=this.getAttribute("title")??"",t=this.hasAttribute("mandatory");return l`
		...
		`}};ze.props=["variant","disabled","type","busy","fill-cell"],ze.styles=[uc],ze.help=void 0;let Gs=ze;y("os-button",Gs);const Xs=ul;function he(){return window.wp?.os}function ee(){return he().getOsSettings()}function E(o){he()?.updateOsSettings(o,{windowId:Xs})}function hc(){he()?.resetOsSettings({windowId:Xs})}function Kn(o){return he()?.subscribeOsSettings(o)??(()=>{})}function pc(o){const e=he()?.desktopThemes?.applyRecommendedOsSettings(o)??{};return Object.keys(e).length>0}function gc(){try{he()?.refreshMenu?.()}catch{}}function fc(o,e,t="dashicons-admin-settings"){const s=he();if(s?.windowManager?.open){s.windowManager.open({id:s.deriveWindowId?s.deriveWindowId(o):o,url:o,title:e,icon:t});return}window.open(o,"_blank","noopener")}function jn(){return window.openStationConfig??{}}const bc=()=>({editor:{id:"",teardown:null},previews:null,imagePickerOpen:!1,imageSource:"",library:{query:"",page:0,totalPages:0,loaded:[],loading:!1,error:"",searchTimer:null,uploadError:"",uploading:!1,dragover:!1},themes:{error:"",busy:!1},features:{purging:!1,resetting:!1,extendedSaving:!1,extendedError:"",commentsAiSaving:!1},components:{entries:null,activeTag:"",query:"",paintedTag:""},about:null,search:{query:"",index:null},mountedTabs:new WeakMap,glyphs:new Map}),_e=o=>o.extra,C=o=>o.ui(bc),Bn=o=>o.detail??{},N=o=>String(Bn(o).value??""),M=o=>Bn(o).checked===!0;function mc(o){return o.replace(/[^a-zA-Z0-9._-]+/g,"-").replace(/^-+|-+$/g,"")||"wallpaper"}function vc(o){if(!o||typeof o.id!="number"||!o.source_url)return!1;const e=o.media_details;return!!e&&typeof e.width=="number"&&typeof e.height=="number"&&e.width>0&&e.height>0}function _c(o){if(!o)return"";const e=document.createElement("div");return e.innerHTML=o,e.textContent?.trim()||""}async function Gn(o,e){try{const t=await o.json();if(t&&typeof t.message=="string")return t.message}catch{}return e}async function yc(o,e,t,s){const i=new URL(_e(o).mediaUrl);i.searchParams.set("media_type","image"),i.searchParams.set("per_page",String(hl)),i.searchParams.set("page",String(e)),i.searchParams.set("orderby","date"),i.searchParams.set("order","desc"),i.searchParams.set("_fields","id,source_url,alt_text,title,media_details"),t&&i.searchParams.set("search",t),s&&(i.searchParams.set("openstation_min_width",String(Ns)),i.searchParams.set("openstation_min_height",String(Ps)));const n=await o.fetch(i.toString());if(!n.ok)throw new Error(await Gn(n,`HTTP ${n.status}`));const r=n.headers.get("X-WP-TotalPages"),a=r?parseInt(r,10):1;return{items:(await n.json()).filter(vc),totalPages:a||1}}async function wc(o,e){const t=await o.fetch(_e(o).mediaUrl,{method:"POST",headers:{"Content-Type":e.type,"Content-Disposition":`attachment; filename="${mc(e.name)}"`},body:e});if(!t.ok)throw new Error(await Gn(t,`Upload failed (HTTP ${t.status}).`));const s=await t.json();return{id:s.id,url:s.source_url}}function Xn(o){E({customImage:o,wallpaper:re})}async function Zn(o,e){const t=C(o).library,s=i=>{t.uploadError=i,o.repaint(),window.setTimeout(()=>{t.uploadError="",o.repaint()},4e3)};if(!e.type.startsWith("image/")){s(d("That file isn’t an image."));return}t.uploading=!0,o.repaint();try{Xn(await wc(o,e))}catch(i){s(i instanceof Error?i.message:d("Upload failed."))}finally{t.uploading=!1,o.repaint()}}function xc(o,e,t){return o?l`<span class="os-settings__upload-status">${d("Uploading…")}</span>`:e?l`<os-button
			variant="danger"
			class="os-settings__upload-remove"
			aria-label=${d("Remove custom image")}
			@click=${t}
		>${d("Remove")}</os-button>`:l`<div class="os-settings__upload-inner">
	...
	</div>`}const kc=(o,e)=>{const t=C(e).library,s=!!o.customImage,i=["os-settings__upload-tile"];s&&i.push("os-settings__upload-tile--filled"),t.dragover&&i.push("os-settings__upload-tile--dragover"),t.uploading&&i.push("os-settings__upload-tile--busy");const n=()=>e.root.querySelector("[data-os-upload-input]"),r=h=>{h.stopPropagation(),E({customImage:null,...o.wallpaper===re?{wallpaper:fl()}:{}})},a=()=>{if(!t.uploading){if(o.customImage){E({wallpaper:re});return}n()?.click()}},c=h=>{const p=h.currentTarget,g=p.files?.[0];g&&Zn(e,g),p.value=""},u=h=>{t.dragover!==h&&(t.dragover=h,e.repaint())};return l`
		<input
			type="file"
			accept="image/*"
		...
		<div
			class=${i.join(" ")}
			data-wallpaper-id=${re}
			aria-pressed=${o.wallpaper===re?"true":"false"}
			aria-label=${d(s?"Custom image wallpaper":"Upload a wallpaper image")}
			style=${s?`background-image: url("${encodeURI(o.customImage.url)}")`:""}
			@click=${a}
			@dragover=${h=>{h.preventDefault(),u(!0)}}
			@dragleave=${()=>u(!1)}
			@drop=${h=>{h.preventDefault(),u(!1);const p=h.dataTransfer?.files?.[0];p&&Zn(e,p)}}
		>
			${xc(t.uploading,s,r)}
			${t.uploadError?l`<span class="os-settings__upload-error" role="status">${t.uploadError}</span>`:""}
		</div>
	`};function $c(o,e){return o.libraryHdOnly?e.filter(t=>t.media_details.width>=Ns&&t.media_details.height>=Ps):e}async function Zs(o){const e=C(o).library;if(!(e.loading||e.totalPages>0&&e.page>=e.totalPages)){e.loading=!0,e.error="",o.repaint();try{const t=await yc(o,e.page+1,e.query,ee().libraryHdOnly);e.page+=1,e.totalPages=t.totalPages,e.loaded=e.loaded.concat(t.items)}catch(t){e.error=t instanceof Error?U(d("Couldn’t load your media: %s"),t.message):d("Couldn’t load your media.")}finally{e.loading=!1,o.repaint()}}}function Yn(o){const e=C(o).library;e.page=0,e.totalPages=0,e.loaded=[],Zs(o)}const Ec=(o,e)=>{const t=o.wallpaper===re&&o.customImage?.id===e.id,s=e.media_details.sizes||{},i=s.medium?.source_url||s.thumbnail?.source_url||s.large?.source_url||e.source_url,n=e.alt_text||_c(e.title?.rendered||"")||`Image #${e.id}`;return l`<button
		type="button"
		...
		@click=${()=>Xn({id:e.id,url:e.source_url})}
	>
		<span class="os-settings__library-tile-dims">${e.media_details.width}×${e.media_details.height}</span>
	</button>`},Ac=(o,e)=>{const t=C(e).library,s=$c(o,t.loaded),i=t.loaded.length-s.length,n=[U(d("Showing %d"),s.length)];o.libraryHdOnly&&i>0&&n.push(U(d("%d hidden by HD filter"),i));const r=u=>{const h=u.target.value;t.searchTimer!==null&&window.clearTimeout(t.searchTimer),t.searchTimer=window.setTimeout(()=>{t.searchTimer=null,t.query=h.trim(),Yn(e)},pl)},a=u=>{E({libraryHdOnly:M(u)}),Yn(e)},c=()=>t.error?l`<p class="os-settings__library-error">${t.error}</p>`:t.loading&&t.page===0?Array.from({length:8},()=>l`<div class="os-settings__library-tile os-settings__library-tile--skeleton"></div>`):s.length===0&&!t.loading?l`<p class="os-settings__library-empty">
				${o.libraryHdOnly?d("No HD images found. Try unchecking the filter, or upload a larger image."):d("No images in your Media Library yet.")}
			</p>`:s.map(u=>Ec(o,u));return l`
		<div class="os-settings__library">
			<div class="os-settings__library-toolbar">
				...
				/>
				<os-checkbox-label
					label=${U(d("Only HD (≥%1$d×%2$d)"),Ns,Ps)}
					?checked=${o.libraryHdOnly}
					@os-checkbox-change=${a}
				></os-checkbox-label>
			</div>
			<div class="os-settings__library-grid">${c()}</div>
	...
	`};function Qn(o){const e=C(o);return e.imageSource?e.imageSource:o.data.canUpload?"upload":"library"}function Cc(o){const e=C(o);if(!e.imagePickerOpen||Qn(o)!=="library")return;const t=e.library;t.page===0&&!t.loading&&!t.error&&Zs(o)}const Sc=(o,e)=>{const t=e.data.canUpload,s=Qn(e),i=n=>{const r=N(n);(r==="upload"||r==="library")&&(C(e).imageSource=r,e.repaint())};return l`
		<div class="os-settings__uploader">
			${t?l`<os-tabs value=${s} label=${d("Image source")} @os-tab-change=${i}>
					<os-tab value="upload">${d("Upload new")}</os-tab>
					<os-tab value="library">${d("Media Library")}</os-tab>
				</os-tabs>`:""}
			<div class="os-settings__tab-pane">
				${s==="upload"?kc(o,e):Ac(o,e)}
			</div>
		</div>
	`},Lc="[data-os-editor-slot]";function Jn(o){return{id:o,pluginUrl:"",prefersReducedMotion:typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches,visible:!document.hidden,settings:Mn(o)}}function Rc(o){const e=o.root.querySelector(Lc);if(!e)return;const t=C(o),s=ee().wallpaper;if(t.editor.id===s&&e.firstElementChild)return;er(o),t.editor.id=s;const i=document.createElement("div");i.className="os-settings__editor-slot-inner",e.textContent="",e.appendChild(i);const n=Ae(s);if(n?.renderEditor)try{const r=n.renderEditor(i,Jn(n.id));qs(r)?r.then(a=>{t.editor.teardown=a}):t.editor.teardown=r}catch(r){console.error(`[openstation] Wallpaper "${n.id}" renderEditor threw:`,r)}}function er(o){const e=C(o);if(e.editor.teardown)try{e.editor.teardown()}catch(t){console.error("[openstation] Wallpaper editor teardown threw:",t)}e.editor={id:"",teardown:null}}function Ic(o){o.classList.add("os-settings__gradient-editor-inner");const e=s=>{E({customGradient:{...ee().customGradient,...s}}),t()},t=()=>{const{from:s,to:i,angle:n}=ee().customGradient;fe(l`
				<div class="os-settings__gradient-row">
					<os-color-field
						variant="block"
						label=${d("From")}
						value=${s}
						@os-color-change=${r=>e({from:N(r)})}
					></os-color-field>
					<os-color-field
						variant="block"
						label=${d("To")}
						value=${i}
						@os-color-change=${r=>e({to:N(r)})}
					></os-color-field>
				</div>
				<os-range-field
					label=${d("Angle")}
					...
					suffix="°"
					value=${String(n)}
					@os-range-change=${r=>e({angle:Number(N(r))})}
				></os-range-field>
			`,o)};return t(),()=>{}}function Dc(o){if(typeof o.renderConfig!="function")return;const e=document.createElement("os-modal");e.setAttribute("size","sm"),e.setAttribute("title",U(d("%s settings"),o.label));const t=document.createElement("div");t.className="os-settings__wallpaper-config-form",e.appendChild(t);const s=document.createElement("os-button");s.setAttribute("slot","footer"),s.setAttribute("variant","primary"),s.textContent=d("Done"),e.appendChild(s);let i=null,n=!1;const r=()=>{if(!n){n=!0;try{i?.()}catch(c){console.error(`[openstation] Wallpaper "${o.id}" config teardown threw:`,c)}i=null,e.remove()}};s.addEventListener("click",r),e.addEventListener("os-modal-cancel",r);const a={...Jn(o.id),setSettings:c=>{const u=ee(),h={...u.wallpaperSettings[o.id]??{},...c};E({wallpaperSettings:{...u.wallpaperSettings,[o.id]:h}}),Yl(o.id,h)}};document.body.appendChild(e),e.setAttribute("open","");try{const c=o.renderConfig(t,a);qs(c)?c.then(u=>{if(n){try{u()}catch{}return}i=u}):i=c}catch(c){console.error(`[openstation] Wallpaper "${o.id}" renderConfig threw:`,c),r()}}const Tc=(o,e)=>{const t=C(e),s=Ae(o.wallpaper),i=typeof s?.renderConfig=="function",n=typeof s?.renderEditor=="function",r=c=>{const u=Ae(N(c));u&&u.id!==re&&E({wallpaper:u.id})},a=Pi().filter(c=>c.id!==re).sort((c,u)=>+(c.id===is)-+(u.id===is));return l`
		<os-section
			heading=${d("Wallpaper")}
		...
		>
			<div class="os-settings__grid os-settings__grid--wallpapers" @os-pick=${r}>
				${a.map(c=>l`<os-swatch
						value=${c.id}
						label=${c.label}
						preview=${c.id===is?Us(o):c.preview}
						variant="wallpaper"
						data-wallpaper-id=${c.id}
						?selected=${o.wallpaper===c.id}
					>
						<span class="os-settings__swatch-label">${c.label}</span>
					</os-swatch>`)}
				<button
					type="button"
			...
			>
				<div class="os-settings__wallpaper-config-slot-inner">
					${i?l`<div class="os-settings__wallpaper-config">
							<os-button variant="secondary" @click=${()=>Dc(s)}>
			...
			<div class="os-settings__image-picker-slot" data-expanded=${t.imagePickerOpen?"true":"false"}>
				<div class="os-settings__image-picker-slot-inner">${Sc(o,e)}</div>
			</div>
		</os-section>
	`},Nc=typeof navigator<"u"&&/Mac|iPhone|iPad|iPod/i.test(navigator.platform||navigator.userAgent||"")?"⌘K":"Ctrl+K";let Ys=!1;document.addEventListener("os-settings-save-lifecycle",o=>{if(!Ys)return;const e=o.detail?.phase;e!=="saved"&&e!=="failed"||(Ys=!1,e==="saved"&&gc())});const G=(o,e,t,s,i=!1,n="")=>l`
...
`,tr=o=>l`
	<os-notice tone="warning" not-dismissible>
		...
		<a
			href=${o}
			@click=${e=>{e.preventDefault(),o&&fc(o,d("Connectors"))}}
		>${d("Settings → Connectors")}</a>.
	</os-notice>
`;async function Pc(o,e){const t=C(o).features;t.commentsAiSaving||(t.commentsAiSaving=!0,o.repaint(),await o.dispatch("comments-ai",{enabled:e}),t.commentsAiSaving=!1,sr(o),o.repaint())}async function zc(o){const e=C(o).features;e.resetting||(e.resetting=!0,o.repaint(),await o.dispatch("reset-intros")&&document.dispatchEvent(new CustomEvent("os-intros-reset")),e.resetting=!1,o.repaint())}function sr(o){const e=jn(),t=o.data.aiAssistant;if(t&&e.aiAssistant){const s=e.aiAssistant.available!==t.available||e.aiAssistant.assistantProviderConfigured!==t.assistantProviderConfigured;Object.assign(e.aiAssistant,t),s&&document.dispatchEvent(new CustomEvent("os-ai-status-changed"))}o.data.commentsAi&&e.commentsAi&&Object.assign(e.commentsAi,o.data.commentsAi)}const Mc=(o,e)=>{const{aiAssistant:t,commentsAi:s,isAdmin:i}=e.data,n=C(e).features,r=a=>{const c=Number(N(a));if([15,30,45,60].includes(c)){E({heartbeatRate:c});try{window.wp?.heartbeat?.interval?.(c>=60?"slow":"standard")}catch{}}};return l`
		<os-section
			heading=""
			description=${d("Watch the dot in the OpenStation Preferences title bar to see when a change has been saved.")}
		>
			${t?.available?G(d("AI assistant"),o.ai.enabled,a=>E({ai:{...o.ai,enabled:M(a)}}),U(d("Adds an AI mode to the %s command palette: find content and ask about your site."),Nc),!t.assistantProviderConfigured,t.assistantProviderConfigured?"":tr(t.connectorsUrl)):""}
			${s?G(d("Score new comments with AI"),s.enabled,a=>void Pc(e,M(a)),d("Rates incoming comments so you can triage the queue faster."),n.commentsAiSaving||!s.providerConfigured,s.providerConfigured?"":tr(t?.connectorsUrl??"")):""}
			<div class="os-features__item">
				<os-checkbox-label
					label=${d("Window links")}
					?checked=${o.windowLinksEnabled}
					@os-checkbox-change=${a=>E({windowLinksEnabled:M(a)})}
				></os-checkbox-label>
				...
				${G(d("Bring related windows to front"),o.windowLinkRaiseOnFocus,a=>E({windowLinkRaiseOnFocus:M(a)}),d("Clicking a window also surfaces its parent and children."),!o.windowLinksEnabled)}
				${G(d("Highlight related windows"),o.windowLinkHighlight,a=>E({windowLinkHighlight:M(a)}),d("Related windows get an accent outline while one of them is focused."),!o.windowLinksEnabled)}
			</div>
			${G(d("Show desktop when clicking the wallpaper"),o.showDesktopOnWallpaperClick,a=>E({showDesktopOnWallpaperClick:M(a)}),d("A click on the empty desktop minimizes every window; a second click restores them."))}
			${G(d("Show post/page status ribbon"),o.showPostStatusRibbons,a=>E({showPostStatusRibbons:M(a)}),d("Marks unpublished posts and pages with a corner ribbon on their tiles."))}
			${G(d("Enable developer mode"),o.developerModeEnabled,a=>{E({developerModeEnabled:M(a)}),Ys=!0},d("Unlocks developer surfaces meant for plugin authors."))}
			${G(d("Folder sharing"),o.foldersSharingEnabled,a=>E({foldersSharingEnabled:M(a)}),d("Share desktop folders with other users or roles, with read or write access."),!1,i?l`<div class="os-features__danger-row">
			...
			<div class="os-features__item">
				<label class="os-features__select-label">
					...
					<os-select value=${String(o.heartbeatRate)} @os-pick=${r}>
			...
			<div class="os-features__row">
				...
				<os-button variant="secondary" ?disabled=${n.resetting} @click=${()=>void zc(e)}>
					${n.resetting?d("Resetting…"):d("Reset what’s-new dialogs")}
				</os-button>
			</div>
		</os-section>
	`},Oc=o=>{const e=(t,s,i)=>G(s,o[t]===!0,n=>E({[t]:M(n)}),i);return l`
		<os-section
	...
	`};let Qs=0;async function Wc(o,e){const t=C(o).features;t.extendedSaving=!0,t.extendedError="",o.data.extendedOptions&&Object.assign(o.data.extendedOptions,e),o.repaint(),Qs++;try{const s=await o.dispatch("extended",{options:e});if(s&&o.data.extendedOptions)try{de(O.EXTENDED_OPTIONS_CHANGED,{options:o.data.extendedOptions})}catch{}else s||(t.extendedError=d("The options could not be saved."))}finally{Qs--,t.extendedSaving=Qs>0,o.repaint()}}const Hc=(o,e)=>{const t=e.data.extendedOptions;if(!t)return l``;const s=C(e).features,i=(n,r,a)=>G(r,t[n],c=>void Wc(e,{...t,[n]:M(c)}),a);return l`
		<os-section
		...
		>
			...
			${s.extendedError?l`<p class="os-ext__error">${s.extendedError}</p>`:""}
			${s.extendedSaving?l`<p class="os-ext__saving">${d("Saving…")}</p>`:""}
		</os-section>
	`},Uc=(o,e)=>l`
	${Mc(o,e)}
	${Oc(o)}
	${e.data.isAdmin?Hc(o,e):""}
`,qc=v`:host{display:block;margin-block-end:36px}:host( [ hidden ] ){display:none}.os-section__heading{margin:0 0 5px;font-size:20px;font-weight:500;letter-spacing:-0.01em;color:var( --os-ui-fg,#1d2327 )}.os-section__description{margin:0 0 14px;max-width:78ch;font-size:14px;color:var( --os-ui-fg-muted,#646970 );line-height:1.55}.os-section__description:empty{display:none}:host( [ stack ] ) .os-section__body{display:flex;flex-direction:column;gap:var( --os-ui-section-gap,12px )}`,Me=class Me extends _{render(){const e=this.heading||"",t=this.description||"";return l`
		...
		`}_onPick(){this.emit("os-pick",{value:this.value})}};Oe.props=["value","label","selected","preview","size","variant"],Oe.styles=[Fc],Oe.help=void 0;let eo=Oe;y("os-swatch",eo);const Vc=v`:host{display:grid;grid-template-columns:repeat( var( --os-ui-swatch-grid-cols,4 ),1fr );gap:12px}:host( [ mode='row' ] ){display:flex;flex-wrap:wrap;align-items:center;gap:10px}`,We=class We extends _{render(){const e=this.label||"",t=this.columns||"";return t&&this.style.setProperty("--os-ui-swatch-grid-cols",t),this.setAttribute("role","radiogroup"),e&&this.setAttribute("aria-label",e),l`<slot></slot>`}};We.props=["label","columns","mode"],We.styles=[Vc],We.help=void 0;let to=We;y("os-swatch-grid",to);const Kc=v` ${S}:host{display:inline-flex;position:relative;padding:3px;background:var( --os-ui-segmented-bg,var( --os-ui-hover,rgba( 0,0,0,0.05 ) ) );border-radius:8px;gap:2px}.os-segmented__thumb{position:absolute;top:3px;bottom:3px;left:0;width:var( --_thumb-w,0px );border-radius:6px;background-color:var( --os-ui-segmented-selected-bg,var( --os-ui-accent,#2271b1 ) );background-image:var( --os-ui-segmented-selected-image,none );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;transform:translateX( var( --_thumb-x,0px ) );pointer-events:none;opacity:0}:host( [ data-thumb ] ) .os-segmented__thumb{opacity:1}:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition:transform var( --_holo-t-slow ) var( --_holo-spring ),width var( --_holo-t-slow ) var( --_holo-ease ),opacity var( --_holo-t-fast ) linear}@media ( prefers-reduced-motion:reduce ){:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition-duration:1ms}}`,jc=v` ${S} ${ns}:host{flex:1 1 auto;min-width:0}button{appearance:none;display:block;width:100%;padding:6px 13px;background:transparent;border:0;font:inherit;font-size:13px;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:6px;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,background-position var( --_holo-t ) ease;white-space:nowrap}button:hover{color:var( --os-ui-fg,#1d2327 )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}:host( [ aria-checked='true' ] ) button{color:var( --os-ui-segmented-selected-fg,var( --os-ui-fg-on-accent,#fff ) );transition-duration:var( --_holo-t-fast )}:host( [ aria-checked='true' ] ) button::before{display:none}`,He=class He extends _{render(){return this.setAttribute("role","radio"),l`
			<button
				type="button"
				class="os-holo-sheen"
				@click=${()=>this._onPick()}
		...
		`};let oo=Ue;y("os-segmented",oo);const Bc=v` ${S}:host{display:flex;flex-direction:column;gap:8px;font-size:13px;color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-select__label{font-size:13px;line-height:1.5;color:var( --os-ui-fg-muted,#646970 )}.os-select__trigger{appearance:none;display:flex;align-items:center;gap:8px;width:100%;min-width:0;padding:8px 12px;background:var( --os-ui-hover,rgba( 0,0,0,0.05 ) );border:1px solid transparent;border-radius:8px;font:inherit;font-size:13px;line-height:1.5;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}.os-select__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.08 ) );border-color:var( --os-ui-border-strong,#8c8f94 )}.os-select__trigger:focus,.os-select__trigger:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}.os-select__trigger:disabled{opacity:0.5;cursor:not-allowed}:host( [ plain ] ){display:inline-flex;flex-direction:row;align-items:center}:host( [ plain ] ) .os-select__label{display:none}:host( [ plain ] ) .os-select__trigger{width:auto;padding:4px 6px;background:transparent;border-color:transparent;border-radius:6px}:host( [ plain ] ) .os-select__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.05 ) );border-color:transparent}:host( [ plain ] ) .os-select__trigger:focus,:host( [ plain ] ) .os-select__trigger:focus-visible{border-color:var( --os-ui-accent,#2271b1 )}:host( [ plain ] ) .os-select__value{flex:0 1 auto}.os-select__value{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-select__value--placeholder{color:var( --os-ui-fg-muted,#646970 )}.os-select__chevron{flex:0 0 auto;pointer-events:none;color:var( --os-ui-fg-muted,#646970 )}.os-select__trigger:hover .os-select__chevron{color:var( --os-ui-fg,#1d2327 )}.os-select__trigger:focus .os-select__chevron,.os-select__trigger:focus-visible .os-select__chevron{color:var( --os-ui-accent,#2271b1 )}.os-select__popup{position:fixed;inset:auto;margin:0;max-height:min( 320px,60vh );overflow-y:auto;padding:4px;background:var( --os-ui-surface,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:8px;box-shadow:0 12px 32px rgba( 0,0,0,0.45 );color:var( --os-ui-fg,#1d2327 )}.os-select__popup:not( [ data-open ] ){display:none}.os-select__popup:popover-open{display:block}.os-select__popup[ data-open ]{position:absolute;top:calc( 100% + 4px );left:0;min-width:100%;z-index:1000}:host{position:relative}.os-select__option{display:flex;align-items:center;gap:8px;padding:7px 10px;border-radius:6px;font-size:13px;line-height:1.5;cursor:pointer;white-space:nowrap}.os-select__check{flex:0 0 auto;visibility:hidden}.os-select__option[ aria-selected='true' ] .os-select__check{visibility:visible}.os-select__option[ data-active ],.os-select__option:hover{background:var( --os-ui-accent,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-select__option[ aria-disabled='true' ]{opacity:0.5;cursor:not-allowed}.os-select__option[ aria-disabled='true' ]:hover{background:transparent;color:inherit}@media ( prefers-reduced-motion:reduce ){.os-select__trigger{transition-duration:1ms}}`,Gc=v`:host{display:none}`,qe=class qe extends _{render(){return l``}};qe.props=["value","disabled"],qe.styles=[Gc],qe.help=void 0;let io=qe;y("os-option",io);const Fe=class Fe extends _{constructor(){super(...arguments),this._optionObserver=null,this._open=!1,this._activeIndex=-1,this._typed="",this._dismissedAt=0,this._typedTimer=null,this._onWindowScroll=e=>{const t=e.target,s=this._popup();s&&t instanceof Node&&(t===s||s.contains(t))||this._hide()},this._onWindowResize=()=>this._hide()}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const n of Array.from(t))n.remove();for(const n of e){const r=document.createElement("os-option");r.setAttribute("value",n.value),r.textContent=n.label,this.appendChild(r)}const s=this.value;!(s!==null&&e.some(n=>n.value===s))&&e.length>0&&(this.value=e[0].value),this.requestUpdate()}connectedCallback(){super.connectedCallback(),Re(this),this._optionObserver=new MutationObserver(()=>this.requestUpdate()),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._teardownDismiss(),this._open=!1,this._typedTimer&&(clearTimeout(this._typedTimer),this._typedTimer=null)}render(){const e=this.label||"",t=this.value,s=this.placeholder||"",i=this.disabled!==null;e&&this.setAttribute("aria-label",e);const n=this.getAttribute("aria-label")||"",r=e||n||s,a=this._readOptions(),c=a.find(b=>b.value===t),u=c?c.label:s,h=this.id||"os-unnamed",p=`${h}__listbox`,g=`${h}__trigger`,m=this._open&&this._activeIndex>=0?`${h}__opt-${this._activeIndex}`:"";return l`
			...
			>
				<span
					...
					>${u}</span
				>
				${I("chevron-right",{size:16,rotate:90,className:"os-select__chevron"})}
			</button>
			<div
			...
			>
				${a.map((b,x)=>l`
						<div
							...
							?data-active=${this._open&&x===this._activeIndex}
							@click=${()=>this._onOptionClick(b)}
							@pointermove=${()=>this._setActive(x)}
						>
							${I("check",{size:16,className:"os-select__check"})}
		...
		`};let no=Fe;y("os-select",no);const Xc=v`
	:host {
		display: flex;
...
`;function Zc(){const o="os-multiselect-popover-styles";if(document.getElementById(o))return;const e=document.createElement("style");e.id=o,e.textContent=`
...
`,document.head.appendChild(e)}typeof document<"u"&&Zc();const Ve=class Ve extends _{constructor(){super(...arguments),this._optionObserver=null,this._popover=null,this._teardownOpen=null,this._hasMore=!1,this._loadingMore=!1}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const n of Array.from(t))n.remove();for(const n of e){const r=document.createElement("os-option");r.setAttribute("value",n.value),r.textContent=n.label,this.appendChild(r)}this._loadingMore=!1;const s=new Set(e.map(n=>n.value)),i=this._readValues().filter(n=>s.has(n));this._writeValueAttribute(i),this.requestUpdate(),this._refreshPopover()}get values(){return this._readValues()}set values(e){const t=Array.isArray(e)?e.map(s=>String(s)).filter(s=>s!==""):[];this._writeValueAttribute(t),this.requestUpdate(),this._refreshPopover()}get hasMore(){return this._hasMore}set hasMore(e){this._hasMore=!!e,this._refreshPopover()}get loadingMore(){return this._loadingMore}set loadingMore(e){this._loadingMore=!!e,this._refreshPopover()}appendItems(e){if(this._loadingMore=!1,!e||e.length===0){this._refreshPopover();return}const t=new Set(Array.from(this.querySelectorAll(":scope > os-option")).map(s=>s.getAttribute("value")));for(const s of e){if(t.has(s.value))continue;const i=document.createElement("os-option");i.setAttribute("value",s.value),i.textContent=s.label,this.appendChild(i)}this.requestUpdate(),this._refreshPopover()}connectedCallback(){super.connectedCallback(),Re(this),this._optionObserver=new MutationObserver(()=>{this.requestUpdate(),this._refreshPopover()}),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._closePopover()}render(){const e=this.label||"",t=this.placeholder||"All",s=this.disabled!==null;e?this.setAttribute("aria-label",e):this.removeAttribute("aria-label");const i=e||t,n=this._summarize(t),r=this._readValues().length>0,c=`${this.id||"os-unnamed"}__trigger`;return l`
		...
		`}connectedCallback(){super.connectedCallback(),getComputedStyle(this).direction==="rtl"&&this.style.setProperty("--_range-angle","270deg")}_onInput(e){const t=e.target,s=parseFloat(t.value);Number.isFinite(s)&&(this.value=String(s),this.emit("os-range-change",{value:s}))}};je.props=["label","value","min","max","step","suffix","decimals"],je.styles=[Qc],je.help=void 0;let lo=je;y("os-range-field",lo);const or=v` ${S} ${js}:host{--_field-size:var( --os-ui-field-font-size,13px );--_field-radius:var( --os-ui-field-radius,6px );display:flex;flex-direction:column;gap:4px;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-text-field__label{font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__label--hidden{position:absolute;width:1px;height:1px;margin:-1px;padding:0;border:0;overflow:hidden;white-space:nowrap;clip-path:inset( 50% )}.os-text-field__row{position:relative;display:flex;align-items:center;width:100%}input{appearance:none;-webkit-appearance:none;display:block;width:100%;min-width:0;box-sizing:border-box;padding:7px 10px;background:var( --os-window-bg,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:var( --_field-radius );font:inherit;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 )}.os-text-field__suffix{position:absolute;inset-inline-end:10px;top:50%;transform:translateY( -50% );pointer-events:none;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row--has-reveal input{padding-inline-end:36px}.os-text-field__row--has-clear input{padding-inline-end:36px}.os-text-field__row--has-reveal.os-text-field__row--has-clear input{padding-inline-end:68px}.os-text-field__clear{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0}.os-text-field__row--has-reveal .os-text-field__clear{inset-inline-end:34px;border-radius:0}.os-text-field__clear:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__clear:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 )}.os-text-field__clear:disabled{opacity:0.45;cursor:default}.os-text-field__reveal{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0;transition:color 0.12s ease}.os-text-field__reveal:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__reveal:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 );border-radius:0 6px 6px 0}.os-text-field__reveal:disabled{opacity:0.45;cursor:not-allowed}.os-text-field__input--masked{-webkit-text-security:disc;text-security:disc}@supports not ( ( -webkit-text-security:disc ) or ( text-security:disc ) ){.os-text-field__input--masked{font-family:text-security-disc,"password",monospace;letter-spacing:0.2em}}input:disabled{opacity:0.55;cursor:not-allowed;background:var( --os-ui-hover,rgba( 0,0,0,0.03 ) )}input[ aria-invalid='true' ],input[ aria-invalid='true' ]:hover:not(:disabled ){border-color:var( --os-ui-danger,#d63638 )}input[ aria-invalid='true' ]:focus,input[ aria-invalid='true' ]:focus-visible{border-color:var( --os-ui-danger,#d63638 );box-shadow:0 0 0 1px var( --os-ui-danger,#d63638 ),0 0 0 4px rgba( 214,54,56,0.18 )}input[ type='number' ]::-webkit-inner-spin-button,input[ type='number' ]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[ type='number' ]{-moz-appearance:textfield}`,Be=class Be extends _{constructor(){super(...arguments),this._revealed=!1}connectedCallback(){super.connectedCallback(),Re(this)}render(){const e=this.label||"",t=this.hideLabel!==null,s=this.value??"",i=this.placeholder||"",n=this.disabled!==null,r=this.readonly!==null,a=this.autocomplete,c=this.type||"text",u=c==="password";let h=a||"off";u&&(!a||h==="off")&&(h="new-password");const p=this.maxlength,g=this.minlength,m=this.pattern||"",b=this.name||"",x=this.suffix||"",w=this.invalid!==null,k=this.reveal!==null,f=this.clearable!==null,A=c==="password",$=A&&!(k&&this._revealed);let L;A||k&&this._revealed?L="text":L=c;const Z=["os-text-field__row",k?"os-text-field__row--has-reveal":"",f?"os-text-field__row--has-clear":""].filter(Boolean).join(" "),K=$?"os-text-field__input os-text-field__input--masked":"os-text-field__input",F=`${this.id||"os-unnamed"}__input`;return l`
			...
			<span class=${Z}>
				<input
					...
					aria-label=${e||""}
					@input=${ge=>this._onInput(ge)}
					@change=${ge=>this._onChange(ge)}
					@keydown=${ge=>this._onKeyDown(ge)}
				/>
				${x?l`<span class="os-text-field__suffix">${x}</span>`:l``}
				${f&&s!==""?this._renderClearButton(n):l``}
				${k?this._renderRevealButton(n):l``}
			</span>
		`}_renderClearButton(e){return l`
			<button
				type="button"
		...
		`}_onClear(){this.value="",this.emit("os-input-change",{value:""}),this.emit("os-input-commit",{value:""}),this.shadowRoot?.querySelector("input")?.focus()}_renderRevealButton(e){const t=this._revealed?"Hide":"Show";return l`
			<button
				type="button"
			...
			>
				${this._revealed?id():od()}
			</button>
		`}_onToggleReveal(){this._revealed=!this._revealed,this.requestUpdate()}_onInput(e){const t=e.target;this.value=t.value,this.emit("os-input-change",{value:t.value})}_onChange(e){const t=e.target;this.emit("os-input-commit",{value:t.value})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target;this.emit("os-submit",{value:t.value})}}};Be.props=["label","hideLabel","value","placeholder","disabled","readonly","autocomplete","type","maxlength","minlength","pattern","name","suffix","invalid","reveal","clearable"],Be.styles=[or],Be.help=void 0;let co=Be;y("os-text-field",co);function sd(){return l`
		<svg
			viewBox="0 0 16 16"
			width="14"
			height="14"
	...
	`}const Ge=class Ge extends _{connectedCallback(){super.connectedCallback(),Re(this)}render(){const e=this.label||"",t=this.value??"",s=this.placeholder||"",i=this.disabled!==null,n=this.readonly!==null,r=this.name||"",a=this.suffix||"",c=this.min,u=this.max,h=this.step||"any",p=this.invalid!==null,m=`${this.id||"os-unnamed"}__input`;return l`
			${e?l`<label
		...
		`}_readRange(){const e=this.min,t=this.max,s=e!==null?parseFloat(e):-1/0,i=t!==null?parseFloat(t):1/0;return{min:Number.isFinite(s)?s:-1/0,max:Number.isFinite(i)?i:1/0}}_clamp(e){const{min:t,max:s}=this._readRange();return e<t?t:e>s?s:e}_onInput(e){const t=e.target,s=parseFloat(t.value);Number.isFinite(s)&&(this.value=String(s),this.emit("os-input-change",{value:s}))}_onCommit(e){const t=e.target,s=parseFloat(t.value);if(!Number.isFinite(s))return;const i=this._clamp(s);i!==s&&(t.value=String(i),this.value=String(i)),this.emit("os-input-commit",{value:i})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target,s=parseFloat(t.value);if(!Number.isFinite(s))return;const i=this._clamp(s);i!==s&&(t.value=String(i),this.value=String(i)),this.emit("os-submit",{value:i})}}};Ge.props=["label","value","placeholder","disabled","readonly","name","suffix","min","max","step","invalid"],Ge.styles=[or],Ge.help=void 0;let uo=Ge;y("os-number-field",uo);const nd=v` ${S} ${as}:host{display:inline-flex;align-items:center;gap:6px;font-size:13px;color:var( --os-ui-fg,#1d2327 );cursor:pointer}:host( [ disabled ] ){cursor:not-allowed;opacity:0.55}:host( [ block ] ){display:flex;cursor:default}:host( [ block ] ) label{cursor:pointer}:host( [ block ][ disabled ] ) label{cursor:not-allowed}label{display:inline-flex;align-items:center;gap:6px;cursor:inherit}.os-checkbox__label{line-height:1.3}.os-checkbox__label:empty{display:none}`,Xe=class Xe extends _{render(){const e=this.checked!==null,t=this.disabled!==null,s=this.label||"",i=this.value;return l`
			<label>
				<input
					type="checkbox"
					.checked=${e}
				...
				/>
				<span class="os-checkbox__label">${s}</span>
			</label>
		`}_onChange(e){const s=e.target.checked;s?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("os-checkbox-change",{checked:s,value:this.value})}};Xe.props=["checked","value","label","disabled"],Xe.styles=[nd],Xe.help=void 0;let ho=Xe;y("os-checkbox",ho);const rd=v` ${S} ${as}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg,#1d2327 );cursor:pointer;-webkit-user-select:none;user-select:none}label{display:inline-flex;align-items:center;gap:8px;cursor:pointer}:host( [ disabled ] ){opacity:0.5;cursor:not-allowed}:host( [ disabled ] ) label,:host( [ disabled ] ) input[ type='checkbox' ]{cursor:not-allowed}`,Ze=class Ze extends _{render(){const e=this.label||"",t=this.checked!==null,s=this.disabled!==null;return l`
			<label>
				<input
					type="checkbox"
					?checked=${t}
		...
		`};let vo=et;y("os-tabs",vo);const tt=class tt extends _{connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0");const e=fd(this);e&&ir(e,e.getAttribute("value"))}render(){return l`<slot></slot>`}};tt.props=["for"],tt.styles=[hd],tt.help={title:"Tab panel",summary:'Auto-managed panel paired with a sibling <os-tabs>. Declares which tab it belongs to via `for="<tab-value>"`; the parent strip toggles `hidden` whenever the active tab changes. role="tabpanel" and tabindex="0" are set automatically.',status:"stable",props:[{name:"for",type:"string",description:"Matches the `value` of the owning <os-tab>. Panel is shown when its parent tabs strip is on that value."}],slots:[{name:"(default)",description:"Panel body content."}],example:l`
		...
		`};let xo=it;y("os-context-menu-option",xo);function wd(o,e){o.style.visibility="hidden";const t=()=>{o.isConnected&&(e(o.getBoundingClientRect()),o.style.visibility="")};typeof requestAnimationFrame=="function"?requestAnimationFrame(t):t()}const xd=v`:host{display:inline-block}:host([hidden]){display:none}.panel{position:fixed;inset:auto;margin:0;padding:0;border:0;background:transparent;overflow:visible;max-inline-size:calc(100vw - 16px)}.panel[hidden]{display:none}os-context-menu{position:relative;inset:auto;max-inline-size:calc(100vw - 16px)}os-button::part(button){min-block-size:30px}.chevron{display:inline-block;inline-size:5px;block-size:5px;border-inline-end:1.5px solid currentColor;border-block-end:1.5px solid currentColor;transform:translateY(-2px) rotate(45deg);margin-inline-start:5px;vertical-align:middle}:host(:dir(rtl)) .chevron{transform:translateY(-2px) rotate(-45deg)}`,nt=class nt extends _{constructor(){super(...arguments),this.opened=!1,this.listeners=null,this.onKey=e=>{if(e.key==="Escape"||e.key==="Tab"){e.key==="Escape"&&(e.preventDefault(),e.stopPropagation()),this.close();return}if(!["ArrowDown","ArrowUp","Home","End"].includes(e.key))return;e.preventDefault(),e.stopPropagation();const t=this.options();let i=t.indexOf(this.ownerDocument.activeElement)+(e.key==="ArrowUp"?-1:1);e.key==="Home"&&(i=0),e.key==="End"&&(i=t.length-1),t[(i+t.length)%t.length]?.focus()}}get panel(){return this.shadowRoot?.querySelector(".panel")??null}get trigger(){return this.shadowRoot?.querySelector("os-button")?.shadowRoot?.querySelector("button")??null}options(){return Array.from(this.querySelectorAll("os-context-menu-option:not([heading]):not([disabled])"))}render(){return l`<os-button variant="ghost" @click=${()=>this.opened?this.close():this.show()} @keydown=${e=>{(e.key==="ArrowDown"||e.key==="ArrowUp")&&(e.preventDefault(),this.show(e.key==="ArrowUp"))}}>${this.getAttribute("text")||"Actions"} <span class="chevron" aria-hidden="true"></span></os-button>
		<div class="panel" popover="manual" hidden><os-context-menu open aria-label=${this.getAttribute("label")||"Actions"}><slot></slot></os-context-menu></div>`}requestUpdate(){this.opened&&this.close(!1),super.requestUpdate(),queueMicrotask(()=>queueMicrotask(()=>this.syncTrigger()))}syncTrigger(){this.trigger?.setAttribute("aria-label",this.getAttribute("label")||"Actions"),this.trigger?.setAttribute("aria-haspopup","menu"),this.trigger?.setAttribute("aria-expanded",String(this.opened))}show(e=!1){if(this.opened||!this.panel)return;this.opened=!0,this.panel.hidden=!1,this.panel.showPopover?.(),this.syncTrigger();const t=this.panel;wd(t,i=>{if(!this.opened)return;const n=this.getBoundingClientRect(),r=getComputedStyle(this).direction==="rtl";t.style.left=`${Math.max(8,Math.min(r?n.left:n.right-i.width,window.innerWidth-i.width-8))}px`,t.style.top=`${Math.max(8,Math.min(n.bottom+5+i.height<=window.innerHeight-8?n.bottom+5:n.top-i.height-5,window.innerHeight-i.height-8))}px`;const a=this.options();a[e?a.length-1:0]?.focus({preventScroll:!0})}),this.listeners=new AbortController;const{signal:s}=this.listeners;document.addEventListener("pointerdown",i=>{i.composedPath().includes(this)||this.close(!1)},{capture:!0,signal:s}),document.addEventListener("focusin",i=>{i.composedPath().includes(this)||this.close(!1)},{signal:s}),document.addEventListener("scroll",i=>{i.composedPath().includes(t)||this.close(!1)},{capture:!0,signal:s}),window.addEventListener("resize",()=>this.close(!1),{signal:s}),this.addEventListener("keydown",this.onKey,{signal:s}),this.addEventListener("os-context-menu-pick",()=>this.close(),{capture:!0,signal:s})}close(e=!0){this.opened&&(this.opened=!1,this.listeners?.abort(),this.listeners=null,this.panel?.isConnected&&this.panel.hidePopover?.(),this.panel&&(this.panel.hidden=!0),this.syncTrigger(),e&&this.isConnected&&this.trigger?.focus({preventScroll:!0}))}disconnectedCallback(){this.close(!1)}};nt.props=["label","text"],nt.styles=[xd],nt.help=void 0;let ko=nt;y("os-action-menu",ko);const kd=v` ${S} ${Ks}:host{display:block;animation:os-holo-enter var( --_holo-t ) var( --_holo-spring );transform-origin:top left;min-width:220px;padding:4px;background:var( --os-window-bg,#fff );background-image:var( --os-ui-menu-bg-image,none );background-repeat:var( --os-ui-menu-bg-image-repeat,repeat );background-size:var( --os-ui-menu-bg-image-size,auto );background-position:var( --os-ui-menu-bg-image-position,center );color:var( --os-ui-fg,#1d2327 );border:1px solid var( --os-window-border,#c3c4c7 );border-radius:8px;box-shadow:0 8px 24px rgba( 0,0,0,0.18 ),0 2px 6px rgba( 0,0,0,0.08 )}:host(:dir( rtl ) ){transform-origin:top right}@media ( prefers-reduced-motion:reduce ){:host{animation:none}}:host( [ hidden ] ){display:none}`,$d=v`:host{display:block}button{display:flex;align-items:center;gap:10px;width:100%;min-height:32px;padding:6px 10px;border:none;border-radius:6px;background:transparent;color:inherit;font:inherit;font-size:13px;line-height:1.3;text-align:start;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease}button:hover,button:focus-visible{background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) );color:var( --os-ui-fg,#000 );outline:none}button:focus-visible{outline:none;box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 )}.os-menu-item__icon{flex-shrink:0;width:18px;height:18px;font-size:18px;line-height:1;color:var( --wp-admin-theme-color,#2271b1 )}.os-menu-item__icon[ hidden ]{display:none}.os-menu-item__label{flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.os-menu-item__check{flex-shrink:0;width:16px;height:16px;border-radius:3px;border:1.5px solid var( --os-ui-border,rgba( 0,0,0,0.25 ) );position:relative;background:transparent;transition:background-color 0.12s ease,border-color 0.12s ease}.os-menu-item__check[ hidden ]{display:none}:host( [ checked ] ) .os-menu-item__check{background-color:transparent;background-image:var( --os-ui-holo-fill,linear-gradient( 124deg,#afa2e8 0%,#f5a8ea 46%,#8ee9f7 100% ) );background-size:200% 200%;background-position:25% 30%;border-color:transparent;box-shadow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) )}:host( [ checked ] ) .os-menu-item__check::after{content:'';position:absolute;top:1px;left:4px;width:4px;height:8px;border:solid var( --os-ui-holo-ink,#0c0b0f );border-width:0 2px 2px 0;transform:rotate( 45deg )}`,_s=class _s extends _{connectedCallback(){super.connectedCallback(),this.setAttribute("role","menu")}render(){return l`<slot></slot>`}};_s.styles=[kd],_s.help=void 0;let $o=_s;y("os-menu",$o);const rt=class rt extends _{connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","menuitem")}render(){const e=this.icon||"",t=this.getAttribute("role")==="menuitemcheckbox",s=this.checked!==null;return t&&this.setAttribute("aria-checked",s?"true":"false"),l`
		...
		`};let Eo=rt;y("os-menu-item",Eo);const Ed=v` ${S}:host{display:none;position:fixed;inset:0;align-items:center;justify-content:center;background:var( --os-ui-scrim,rgba( 0,0,0,0.45 ) );background-image:var( --os-ui-scrim-image,none );background-repeat:var( --os-ui-scrim-image-repeat,repeat );background-size:var( --os-ui-scrim-image-size,auto );background-position:var( --os-ui-scrim-image-position,center );backdrop-filter:blur( 2px );z-index:10000}:host( [ open ] ){display:flex;animation:os-confirm-scrim var( --_holo-t ) var( --_holo-ease )}:host( [ open ] ) .dialog{animation:os-confirm-dialog var( --_holo-t ) var( --_holo-spring )}@keyframes os-confirm-scrim{from{opacity:0}}@keyframes os-confirm-dialog{from{opacity:0;transform:scale( 0.96 ) translateY( 8px )}}@media ( prefers-reduced-motion:reduce ){:host( [ open ] ),:host( [ open ] ) .dialog{animation:none}}.dialog{width:min( 420px,92vw );background-color:var( --os-ui-confirm-dialog-bg,#1d2327 );background-image:var( --os-ui-dialog-bg-image,none );background-repeat:var( --os-ui-dialog-bg-image-repeat,repeat );background-size:var( --os-ui-dialog-bg-image-size,auto );background-position:var( --os-ui-dialog-bg-image-position,center );color:var( --os-ui-confirm-dialog-fg,var( --os-fg,#fff ) );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.08 ) );border-radius:10px;box-shadow:0 20px 50px rgba( 0,0,0,0.6 );padding:20px 22px 18px;display:flex;flex-direction:column;gap:10px;position:relative}.close{position:absolute;top:8px;right:10px;width:28px;height:28px;display:inline-flex;align-items:center;justify-content:center;background:transparent;border:0;border-radius:6px;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );cursor:pointer;font-size:22px;line-height:1;padding:0}.close:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) );color:inherit}.btn:focus,.close:focus{outline:none;box-shadow:var( --_holo-focus )}.dialog:focus,.dialog:focus-visible{outline:none}.title{margin:0 0 4px;font-size:16px;font-weight:600}.message{margin:0;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );line-height:1.45;white-space:pre-line}.remember{display:flex;align-items:center;gap:8px;margin-top:4px;font-size:12px;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );cursor:pointer;user-select:none}.remember__box{margin:0;accent-color:var( --os-ui-accent,#2271b1 );cursor:pointer}.remember__box:focus,.remember__box:focus-visible{outline:none;box-shadow:var( --_holo-focus )}.actions{display:flex;justify-content:flex-end;gap:8px;margin-top:6px}.btn{border:0;border-radius:6px;padding:8px 14px;font-size:13px;cursor:pointer;font-weight:500}.btn--secondary{background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) );color:inherit}.btn--secondary:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.14 ) )}.btn--primary{background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.btn--primary:hover{filter:brightness( 1.08 )}.btn--danger{background:var( --os-ui-danger,#d63638 );color:var( --os-ui-fg-on-accent,#fff )}.btn--danger:hover{filter:brightness( 1.08 )}`,nr='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function Ad(o){let e=o?.activeElement??null;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e&&e!==o?.body?e:null}function rr(o){const e=o.composedPath(),t=e.length>0?e[0]:o.target;return t instanceof HTMLElement?t:null}function ar(o){return o!==null&&o.matches(nr)}const at=class at extends _{constructor(){super(...arguments),this._prevFocus=null,this._focusTries=0,this._onKey=e=>{if(e.key==="Escape"){e.preventDefault(),this._cancel();return}if(e.key==="Tab"){this._trapTab(e);return}if(e.key==="Enter"&&!e.isComposing){if(ar(rr(e))||this.hasAttribute("danger"))return;e.preventDefault(),this._confirm()}},this._focusInitial=()=>{if(!this.hasAttribute("open"))return;const e=this.isConnected?this._initialFocusTarget():null;if(e){e.focus();return}if(this._focusTries++<5){queueMicrotask(this._focusInitial);return}this.isConnected&&this.focus()},this._onBackdrop=e=>{const t=e.composedPath();(t.length>0?t[0]:e.target)===this&&this._cancel()},this._confirm=()=>{this.emit("os-confirm",{confirmed:!0,remember:this._remembered()}),this.removeAttribute("open")},this._cancel=()=>{this.emit("os-cancel",{confirmed:!1}),this.removeAttribute("open")}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","dialog"),this.setAttribute("aria-modal","true"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","-1"),this.addEventListener("keydown",this._onKey),this.addEventListener("click",this._onBackdrop)}disconnectedCallback(){this.removeEventListener("keydown",this._onKey),this.removeEventListener("click",this._onBackdrop),this._restoreFocus()}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),e==="open"&&(s!==null?(this._prevFocus=Ad(this.ownerDocument),this._focusTries=0,queueMicrotask(this._focusInitial)):this._restoreFocus())}_focusables(){const e=this.shadowRoot;return e?Array.from(e.querySelectorAll(nr)):[]}_trapTab(e){const t=this._focusables();if(t.length===0)return;const s=t[0],i=t[t.length-1],n=rr(e),r=!ar(n);e.shiftKey&&(r||n===s)?(e.preventDefault(),i.focus()):!e.shiftKey&&(r||n===i)&&(e.preventDefault(),s.focus())}_initialFocusTarget(){const e=this.shadowRoot;if(!e)return null;const t=e.querySelector(".btn--secondary"),s=e.querySelector(".dialog");return this.hasAttribute("danger")?t??e.querySelector(".close")??s:e.querySelector(".btn--primary, .btn--danger")??t??s}_restoreFocus(){const e=this._prevFocus;this._prevFocus=null,!(!e||!e.isConnected)&&e.focus()}_remembered(){return this.shadowRoot?.querySelector(".remember__box")?.checked===!0}render(){const e=this.title??"",t=this.message??"",s=this["confirm-label"]||"Confirm",i=this["cancel-label"]||"Cancel",n=this.hasAttribute("danger"),r=this.hasAttribute("hide-cancel"),a=this.hasAttribute("dismissable"),c=this["remember-label"]??"";return l`
			<div class="dialog" tabindex="-1">
				...
				${c?l`<label class="remember">
						<input type="checkbox" class="remember__box" />
						<span class="remember__label">${c}</span>
					</label>`:l``}
				<div class="actions">
					${r?l``:l`<button
							type="button"
		...
		`}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._paintSvg())}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),queueMicrotask(()=>this._paintSvg())}_paintSvg(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector("svg"),s=e.querySelector("[data-svg-buffer]");if(t&&s){const i=s.textContent||"";t.innerHTML!==i&&(t.innerHTML=i)}}};ut.props=["variant"],ut.styles=[Id],ut.help=void 0;let Ro=ut;y("os-tab-chip",Ro);const Td=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-stack-gap,12px );align-items:var( --os-ui-stack-align,stretch );padding:var( --os-ui-stack-padding,0 )}:host( [ hidden ] ){display:none}`,ht=class ht extends _{render(){const e=this.gap,t=this.align,s=this.padding,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-stack-gap",i),t&&this.style.setProperty("--os-ui-stack-align",t),s!==null&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-stack-padding",`${s}px`),l`<slot></slot>`}};ht.props=["gap","align","padding"],ht.styles=[Td],ht.help=void 0;let Io=ht;y("os-stack",Io);const Nd=v`:host{display:flex;flex-direction:row;flex-wrap:wrap;gap:var( --os-ui-cluster-gap,8px );justify-content:var( --os-ui-cluster-justify,flex-start );align-items:var( --os-ui-cluster-align,center )}:host( [ hidden ] ){display:none}`,pt=class pt extends _{render(){const e=this.gap,t=this.justify,s=this.align,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-cluster-gap",i),t&&this.style.setProperty("--os-ui-cluster-justify",t),s&&this.style.setProperty("--os-ui-cluster-align",s),l`<slot></slot>`}};pt.props=["gap","justify","align"],pt.styles=[Nd],pt.help=void 0;let Do=pt;y("os-cluster",Do);const Pd=v`:host{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );color:inherit;line-height:1}:host( [ hidden ] ){display:none}.os-icon__glyph{font-size:var( --os-ui-icon-size,16px );width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );line-height:1;color:inherit;display:inline-flex;align-items:center;justify-content:center}.os-icon__glyph--char{font-family:dashicons;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;speak:none}.os-icon__glyph.dashicons{font-family:dashicons}`;let ls=null;function zd(o){let e=o.trim();if(e==="")return null;(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))&&(e=e.slice(1,-1));const t=e.match(/^\\([0-9a-f]{1,6})\s?$/i);return t?String.fromCodePoint(parseInt(t[1],16)):e||null}function cr(){const o=new Map;if(typeof document>"u")return o;const e=Array.from(document.styleSheets??[]);for(const t of e){let s=null;try{s=t.cssRules}catch{continue}if(s)for(const i of Array.from(s)){const n=i;if(!n||!n.selectorText)continue;const r=n.selectorText.match(/\.dashicons-([a-z0-9-]+)::?before/i);if(!r)continue;const a=n.style?.content;if(!a)continue;const c=zd(a);c&&o.set(r[1],c)}}return o}function Md(o){ls||(ls=cr());const e=o.startsWith("dashicons-")?o.slice(10):o;return ls.get(e)??null}function Od(){ls=cr()}let dr=!1;function Wd(){if(dr||typeof window>"u")return;dr=!0;const o=()=>{Od()};document.readyState==="loading"&&document.addEventListener("DOMContentLoaded",o,{once:!0}),window.addEventListener("load",o,{once:!0})}Wd();const gt=class gt extends _{render(){const e=this.name||"",t=e.startsWith("dashicons-")?e.slice(10):e,s=this.size;s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-icon-size",`${s}px`);const i=Md(t);return i?l`<span
				class="os-icon__glyph os-icon__glyph--char dashicons dashicons-${t}"
				aria-hidden="true"
			>${i}</span>`:l`<span
			class="os-icon__glyph dashicons dashicons-${t}"
			aria-hidden="true"
		></span>`}};gt.props=["name","size"],gt.styles=[Pd],gt.help=void 0;let To=gt;y("os-icon",To);const Hd=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-body-gap,12px );padding:var( --os-ui-body-padding,16px );box-sizing:border-box;width:100%;height:100%;min-width:0;min-height:0}:host( [ scroll ] ){overflow:auto}:host( [ hidden ] ){display:none}::slotted( * ){min-width:0}`,ft=class ft extends _{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-body-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-body-padding",`${t}px`),l`<slot></slot>`}};ft.props=["gap","padding","scroll"],ft.styles=[Hd],ft.help=void 0;let No=ft;y("os-body",No);const Ud=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-panel-gap,12px );padding:var( --os-ui-panel-padding,16px );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );box-sizing:border-box}:host( [ hidden ] ){display:none}`,bt=class bt extends _{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-panel-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-panel-padding",`${t}px`),l`<slot></slot>`}};bt.props=["gap","padding"],bt.styles=[Ud],bt.help=void 0;let Po=bt;y("os-panel",Po);const qd=v`:host{display:grid;grid-template-columns:repeat( 12,minmax( 0,1fr ) );gap:var( --os-ui-row-gap,12px );row-gap:var( --os-ui-row-row-gap,var( --os-ui-row-gap,12px ) );column-gap:var( --os-ui-row-column-gap,var( --os-ui-row-gap,12px ) );width:100%;min-width:0}:host( [ hidden ] ){display:none}::slotted( [ col='1' ] ){grid-column:span 1}::slotted( [ col='2' ] ){grid-column:span 2}::slotted( [ col='3' ] ){grid-column:span 3}::slotted( [ col='4' ] ){grid-column:span 4}::slotted( [ col='5' ] ){grid-column:span 5}::slotted( [ col='6' ] ){grid-column:span 6}::slotted( [ col='7' ] ){grid-column:span 7}::slotted( [ col='8' ] ){grid-column:span 8}::slotted( [ col='9' ] ){grid-column:span 9}::slotted( [ col='10' ] ){grid-column:span 10}::slotted( [ col='11' ] ){grid-column:span 11}::slotted( [ col='12' ] ){grid-column:span 12}::slotted(:not( [ col ] ) ){grid-column:1 / -1}::slotted( * ){min-width:0}`,mt=class mt extends _{render(){const e=this.gap,t=this["column-gap"],s=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-row-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-row-column-gap",`${t}px`),s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-row-row-gap",`${s}px`),l`<slot></slot>`}};mt.props=["gap","column-gap","row-gap"],mt.styles=[qd],mt.help=void 0;let zo=mt;y("os-row",zo);const Fd=v`:host{display:grid;grid-template-columns:var( --os-ui-grid-columns,1fr );grid-template-rows:var( --os-ui-grid-rows,auto );gap:var( --os-ui-grid-gap,8px );column-gap:var( --os-ui-grid-column-gap,var( --os-ui-grid-gap,8px ) );row-gap:var( --os-ui-grid-row-gap,var( --os-ui-grid-gap,8px ) )}:host( [ hidden ] ){display:none}`,vt=class vt extends _{render(){const e=this.columns,t=this.rows,s=this.gap,i=this["column-gap"],n=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-grid-columns",`repeat(${e}, minmax(0, 1fr))`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-grid-rows",`repeat(${t}, minmax(0, 1fr))`),s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-grid-gap",`${s}px`),i&&/^\d+$/.test(i)&&this.style.setProperty("--os-ui-grid-column-gap",`${i}px`),n&&/^\d+$/.test(n)&&this.style.setProperty("--os-ui-grid-row-gap",`${n}px`),l`<slot></slot>`}};vt.props=["columns","rows","gap","column-gap","row-gap"],vt.styles=[Fd],vt.help=void 0;let Mo=vt;y("os-grid",Mo);const Vd=v`:host{display:flex;align-items:center;justify-content:var( --os-ui-display-align,flex-end );width:100%;min-height:calc( var( --os-ui-display-size,28px ) * 1.4 );padding:8px 14px;box-sizing:border-box;font-size:var( --os-ui-display-size,28px );font-variant-numeric:tabular-nums;font-weight:500;letter-spacing:0.01em;color:var( --os-ui-display-fg,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-display-bg,transparent );border-radius:var( --os-ui-display-border-radius,0 );line-height:1.1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}:host( [ hidden ] ){display:none}.os-display__output{display:block;font:inherit;color:inherit;text-align:var( --os-ui-display-align,end );overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0}`,ur={sm:"16px",md:"20px",lg:"28px",xl:"40px"},_t=class _t extends _{connectedCallback(){super.connectedCallback?.(),this.hasAttribute("aria-live")||this.setAttribute("aria-live","polite"),this.hasAttribute("role")||this.setAttribute("role","status")}render(){const e=this.value,t=this.size||"lg",s=this.align||"end";return this.style.setProperty("--os-ui-display-size",ur[t]||ur.lg),this.style.setProperty("--os-ui-display-align",s),l`
			<output part="output" class="os-display__output">
				${e??l`<slot></slot>`}
			</output>
		`}};_t.props=["value","size","align"],_t.styles=[Vd],_t.help=void 0;let Oo=_t;y("os-display",Oo);const Kd=v`:host{display:block}:host( [ hidden ] ){display:none}.os-disclosure__summary{display:flex;align-items:center;gap:8px;width:100%;padding:0;background:none;border:0;font:inherit;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer}.os-disclosure__summary:focus-visible{outline:2px solid var( --os-ui-accent,#f252fc );outline-offset:2px;border-radius:4px}.os-disclosure__heading{flex:1 1 auto;min-width:0;margin:0;font-size:20px;font-weight:500;letter-spacing:-0.01em}.os-disclosure__hint{flex:0 0 auto;font-size:13px;font-weight:400;color:var( --os-ui-fg-muted,#646970 )}.os-disclosure__marker{flex:0 0 auto;width:8px;height:8px;margin-inline-end:2px;border-inline-end:2px solid currentColor;border-block-end:2px solid currentColor;transform:rotate( -45deg );transition:transform 160ms ease;opacity:0.7}:host( [ open ] ) .os-disclosure__marker{transform:rotate( 45deg )}@media ( prefers-reduced-motion:reduce ){.os-disclosure__marker{transition:none}}.os-disclosure__body{margin-block-start:14px}.os-disclosure__body[ hidden ]{display:none}`;let jd=0;const yt=class yt extends _{constructor(){super(...arguments),this.bodyId=`os-disclosure-body-${++jd}`,this.onToggle=()=>{const e=!this.isOpen();e?this.setAttribute("open",""):this.removeAttribute("open"),this.emit("os-disclosure-toggle",{open:e})}}isOpen(){return this.hasAttribute("open")}render(){const e=this.heading||"",t=this.hint||"",s=this.isOpen();return l`
			<button
				type="button"
		...
		`}};yt.props=["heading","hint","open"],yt.styles=[Kd],yt.help=void 0;let Wo=yt;y("os-disclosure",Wo);const Bd=v`:host{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;padding:32px 24px;text-align:center;color:var( --os-ui-empty-state-fg,var( --os-ui-fg-muted,#646970 ) )}:host( [ hidden ] ){display:none}.os-empty-state__icon{margin-bottom:4px;color:var( --os-ui-empty-state-icon-color,currentColor );opacity:0.75}.os-empty-state__heading{margin:0;font-size:14px;font-weight:600;color:var( --os-ui-fg,#1d2327 )}.os-empty-state__description{margin:0;font-size:12px;line-height:1.4;max-width:48ch}.os-empty-state__description:empty{display:none}.os-empty-state__cta{margin-top:8px}.os-empty-state__cta:empty{display:none}`,wt=class wt extends _{render(){const e=this.icon||"",t=this.heading||"",s=this.description||"";return l`
			${e?l`<os-icon
			...
			<slot></slot>
		`}};wt.props=["icon","heading","description"],wt.styles=[Bd],wt.help=void 0;let Ho=wt;y("os-empty-state",Ho);const Gd=v` ${S} ${ns} ${rs} ${Vs}:host{display:inline-flex;user-select:none}:host( [ fill-cell ] ),:host{display:flex;width:100%}:host( [ hidden ] ){display:none}button{width:100%;min-height:var( --os-ui-key-min-height,48px );appearance:none;display:inline-flex;align-items:center;justify-content:center;padding:var( --os-ui-key-padding,8px 12px );font:inherit;font-size:var( --os-ui-key-font-size,16px );font-weight:500;cursor:pointer;border-radius:var( --os-ui-key-border-radius,8px );background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-key-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-key-border,1px solid transparent );transition:transform 0.08s ease,background-color 0.12s ease,box-shadow 0.12s ease}button:hover:not(:disabled ){background:var( --os-ui-key-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before{opacity:0 !important}:host( [ variant='primary' ] ) button{background:var( --os-ui-key-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-key-fg,var( --os-ui-fg-on-accent,#fff ) )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 )}:host( [ variant='secondary' ] ) button{background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}:host( [ variant='ghost' ] ) button{background:transparent;border:var( --os-ui-key-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ variant='danger' ] ) button{background:transparent;color:var( --os-ui-danger,#d63638 );border:1px solid currentColor}:host( .os-key--pressed ) button,button:active:not(:disabled ){transform:scale( 0.96 );box-shadow:inset 0 1px 2px rgba( 0,0,0,0.22 );background:var( --os-ui-key-bg-pressed,var( --os-ui-hover,rgba( 0,0,0,0.14 ) ) )}button:disabled{opacity:0.5;cursor:not-allowed}`,cs="os-key--pressed",xt=class xt extends _{constructor(){super(...arguments),this._onKeyDown=null,this._onKeyUp=null,this._keyHeldByKeyboard=!1}connectedCallback(){super.connectedCallback?.(),this._onKeyDown=e=>this.handleKeyboardDown(e),this._onKeyUp=e=>this.handleKeyboardUp(e),document.addEventListener("keydown",this._onKeyDown),document.addEventListener("keyup",this._onKeyUp)}disconnectedCallback(){this._onKeyDown&&document.removeEventListener("keydown",this._onKeyDown),this._onKeyUp&&document.removeEventListener("keyup",this._onKeyUp)}render(){const e=this.label,t=this.disabled!==null;return l`
			<button
				part="button"
				class="os-holo-sheen"
				type="button"
			...
			<div class="head" part="head">
				...
				${e.map((n,r)=>l`
						<button
							...
							aria-pressed=${s.has(n.key)?"false":"true"}
		...
		`}_onDismiss(e){if(e.stopPropagation(),this.disabled!==null)return;const s=this.label??"";this.emit("os-chip-dismiss",{label:s})}};zt.props=["label","tone","size","dismissible","disabled","pending","selected"],zt.styles=[Nu],zt.help=void 0;let ni=zt;y("os-chip",ni);const Pu=v`:host{display:inline-flex;max-width:100%}.os-tag-input{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-tag-input-gap,4px );padding:var( --os-ui-tag-input-padding,2px );min-height:24px;max-width:100%}.os-tag-input__chips{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-tag-input-gap,4px );min-width:0}.os-tag-input__add{appearance:none;display:inline-flex;align-items:center;gap:3px;padding:1px 8px;min-height:22px;font:inherit;font-size:11px;font-weight:500;line-height:1;color:var( --os-ui-tag-input-add-fg,var( --os-ui-fg-muted,#50575e ) );background:transparent;border:1px dashed var( --os-ui-tag-input-add-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease,border-color 0.12s ease}.os-tag-input__add:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) );color:var( --os-ui-tag-input-add-fg-hover,var( --os-ui-fg,#1d2327 ) );border-color:var( --os-ui-tag-input-add-border-hover,var( --os-ui-border-strong,#8c8f94 ) )}.os-tag-input__add:focus-visible{outline:none;border-style:solid;box-shadow:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #2271b1 )}.os-tag-input__add:disabled{opacity:0.5;cursor:not-allowed}.os-tag-input__add svg{display:block}.os-tag-input__editor{position:relative;display:inline-flex;align-items:center;flex:0 1 auto;min-width:120px}.os-tag-input__input{appearance:none;font:inherit;font-size:var( --os-ui-field-font-size-compact,12px );line-height:1.4;padding:2px 8px;border:1px solid var( --os-ui-tag-input-input-border,var( --os-ui-border,#2271b1 ) );border-radius:999px;background:var( --os-ui-tag-input-input-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-tag-input-input-fg,var( --os-ui-fg,#1d2327 ) );min-width:80px;max-width:240px}.os-tag-input__input:focus{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --os-ui-focus-ring-field,0 0 0 1px #2271b1,0 0 0 4px rgba( 34,113,177,0.18 ) )}.os-tag-input__suggestions{position:absolute;top:calc( 100% + 4px );left:0;min-width:220px;max-width:320px;max-height:240px;overflow-y:auto;padding:4px 0;background:var( --os-ui-tag-input-pop-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-tag-input-pop-fg,var( --os-ui-fg,#1d2327 ) );border:1px solid var( --os-ui-tag-input-pop-border,var( --os-ui-border,#c3c4c7 ) );border-radius:8px;box-shadow:0 6px 16px rgba( 0,0,0,0.08 ),0 1px 2px rgba( 0,0,0,0.06 );z-index:50}.os-tag-input__suggestion-item{display:flex;align-items:center;gap:6px;padding:6px 12px;font-size:13px;cursor:pointer;user-select:none}.os-tag-input__suggestion-item[ aria-selected='true' ]{background:color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 10%,transparent );color:var( --wp-admin-theme-color,#2271b1 )}.os-tag-input__suggestion-create{font-style:italic;color:var( --os-ui-tag-input-create-fg,var( --os-ui-fg-muted,#50575e ) );border-top:1px solid var( --os-ui-tag-input-pop-divider,var( --os-ui-border,#f0f0f1 ) )}.os-tag-input__suggestion-create[ aria-selected='true' ]{color:var( --wp-admin-theme-color,#2271b1 )}.os-tag-input__suggestion-empty,.os-tag-input__suggestion-loading{display:flex;align-items:center;gap:8px;padding:8px 12px;font-size:12px;color:var( --os-ui-tag-input-pop-muted,var( --os-ui-fg-muted,#646970 ) )}.os-tag-input__suggestion-spinner{display:inline-block;width:10px;height:10px;border-radius:50%;border:2px solid currentColor;border-top-color:transparent;animation:os-tag-input-spin 0.8s linear infinite}@keyframes os-tag-input-spin{to{transform:rotate( 360deg )}}:host( [ disabled ] ) .os-tag-input{opacity:0.6;pointer-events:none}`,Mt=class Mt extends _{constructor(){super(...arguments),this._value=[],this._suggestions=[],this._suggestionsLoading=!1,this._query="",this._highlight=-1,this._focusedChip=-1,this._onDocumentPointerDown=e=>{!this.isOpen||e.composedPath().includes(this)||this.closeInput()}}get _input(){const e=this.shadowRoot;return e?e.querySelector(".os-tag-input__input"):null}get value(){return this._value}set value(e){this._value=Array.isArray(e)?e.slice():[],this._focusedChip>=this._value.length&&(this._focusedChip=-1),this.requestUpdate()}get suggestions(){return this._suggestions}set suggestions(e){this._suggestions=Array.isArray(e)?e.slice():[],this._highlight=this._suggestions.length>0?0:-1,this._suggestionsLoading=!1,this.requestUpdate()}get suggestionsLoading(){return this._suggestionsLoading}set suggestionsLoading(e){this._suggestionsLoading=!!e,this.requestUpdate()}get query(){return this._query}get isOpen(){return this.open!==null}openInput(){this.isOpen||(this.open="",this._query="",this._highlight=-1,this.emit("os-tag-open",{}),queueMicrotask(()=>{this._input?.focus(),this._emitSuggest("")}))}closeInput(){this.isOpen&&(this.open=null,this._query="",this._suggestions=[],this._highlight=-1,this._suggestionsLoading=!1,this.emit("os-tag-close",{}),this.requestUpdate())}connectedCallback(){super.connectedCallback(),document.addEventListener("pointerdown",this._onDocumentPointerDown,!0)}disconnectedCallback(){document.removeEventListener("pointerdown",this._onDocumentPointerDown,!0)}render(){const e=this.isOpen,t=this.disabled!==null,s=this.readonly!==null,i=this.removable!==null||this.removable===null&&!s,n=this.creatable!==null,r=this["add-label"]||"Add",a=this.placeholder||"Add a tag…";return l`
			...
			>
				...
				${this._renderTrailing({isOpen:e,readonly:s,disabled:t,placeholder:a,creatable:n,addLabel:r})}
			</span>
		`}_renderTrailing(e){return e.isOpen?this._renderEditor(e.placeholder,e.creatable):e.readonly||e.disabled?l``:this._renderTrigger(e.addLabel)}_renderChips(e,t){const s=this._value;return s.length===0?l``:l`
			<span class="os-tag-input__chips" role="list">
				${s.map((i,n)=>{const r=i.tone??"neutral";return l`
						<os-chip
							role="listitem"
							size="compact"
							tone=${r}
		...
		`}_renderEditor(e,t){const s=this._suggestions.length>0||this._suggestionsLoading||t&&this._query.trim().length>0;return l`
			<span class="os-tag-input__editor">
				...
				/>
				${s?this._renderSuggestions(t):l``}
			</span>
		`}_renderSuggestions(e){const t=this._query.trim(),s=this._suggestions,i=e&&t.length>0&&!s.some(n=>n.label.toLowerCase()===t.toLowerCase())&&!this._value.some(n=>n.label.toLowerCase()===t.toLowerCase());return l`
			<div
			...
			>
				${this._suggestionsLoading?l`
					  ...
					  `:l``}
				${s.length===0&&!this._suggestionsLoading&&!i?l`
							<div class="os-tag-input__suggestion-empty">
								${t.length>0?"No matches.":"Type to search."}
							</div>
					  `:l``}
				${s.map((n,r)=>{const a=r===this._highlight;return l`
						<div
		...
		`}_onChipDismiss(e,t){e.stopPropagation(),this.emit("os-tag-remove",{tag:t})}_onInput(e){const t=e.target.value;this._query=t,this._emitSuggest(t)}_emitSuggest(e){const t=parseInt(this["min-query"]||"0",10)||0;if(e.length<t){this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate();return}this._suggestionsLoading=!0,this.requestUpdate(),this.emit("os-tag-suggest",{query:e})}_onInputKeyDown(e){const t=this.creatable!==null,s=this._suggestions,i=this._query.trim(),n=t&&i.length>0&&!s.some(a=>a.label.toLowerCase()===i.toLowerCase())&&!this._value.some(a=>a.label.toLowerCase()===i.toLowerCase()),r=s.length+(n?1:0);switch(e.key){case"ArrowDown":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight+1>=r?0:this._highlight+1,this.requestUpdate();return}case"ArrowUp":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight<=0?r-1:this._highlight-1,this.requestUpdate();return}case"Enter":{if(e.preventDefault(),this._highlight>=0&&this._highlight<s.length){this._addSuggestion(s[this._highlight],!1);return}if(this._highlight===s.length&&n){this._addSuggestion({label:i},!0);return}if(n&&i.length>0){this._addSuggestion({label:i},!0);return}return}case"Escape":{e.preventDefault(),this.closeInput();return}case"Backspace":{if(this._query===""&&this._value.length>0){e.preventDefault();const a=this._value.length-1;this._focusedChip===a?(this.emit("os-tag-remove",{tag:this._value[a]}),this._focusedChip=-1):(this._focusedChip=a,this.requestUpdate())}return}default:this._focusedChip!==-1&&(this._focusedChip=-1)}}_onInputBlur(e){queueMicrotask(()=>{this.shadowRoot?.activeElement||this.closeInput()})}_addSuggestion(e,t){if(this._value.some(i=>i.label.toLowerCase()===e.label.toLowerCase())){this._query="",this._highlight=-1,this._suggestions=[],this.requestUpdate(),this._input?.focus();return}this.emit("os-tag-add",{tag:e,isNew:t}),this._query="",this._highlight=-1,this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate(),queueMicrotask(()=>{this._input?.focus()})}};Mt.props=["label","placeholder","add-label","creatable","removable","disabled","readonly","size","min-query","open"],Mt.styles=[Pu],Mt.help=void 0;let ri=Mt;y("os-tag-input",ri);function zu(){return I("plus",{size:14})}const Mu=v`:host{display:block;container-type:inline-size;container-name:os-form;font-size:13px;color:var( --os-ui-fg,#1d2327 )}:host( [ hidden ] ){display:none}.header{margin:0 0 18px}.header:empty{display:none}.fields{display:grid;grid-template-columns:1fr;gap:14px 16px;margin:0 0 18px}@container os-form ( min-width:480px ){.fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}}@container os-form ( min-width:760px ){:host( [ columns="3" ] ) .fields{grid-template-columns:repeat( 3,minmax( 0,1fr ) )}}:host( [ columns="1" ] ) .fields{grid-template-columns:1fr}:host( [ columns="2" ] ) .fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}::slotted( [ full-width ] ){grid-column:1 / -1}::slotted( [ slot ] ){display:contents}.error{margin:0 0 14px;padding:10px 12px;border-radius:6px;background:var( --os-ui-notice-error-bg,rgba( 179,45,46,0.10 ) );color:var( --os-ui-danger-hover,#b32d2e );font-size:13px;line-height:1.4}.error[ hidden ]{display:none}.footer{display:flex;flex-wrap:wrap;gap:8px;align-items:center;justify-content:flex-end;border-top:1px solid var( --os-ui-border,#dcdcde );padding-top:14px}:host( [ align="start" ] ) .footer{justify-content:flex-start}:host( [ align="stretch" ] ) .footer{justify-content:stretch}:host( [ align="stretch" ] ) .footer .footer-actions{flex:1 1 auto}.footer-leading,.footer-trailing{display:contents}.footer-actions{display:inline-flex;gap:8px;align-items:center;margin-inline-start:auto}:host( [ align="start" ] ) .footer-actions{margin-inline-start:0}:host( [ busy ] ){pointer-events:none}:host( [ busy ] ) .fields{opacity:0.6}:host( [ busy ] ) .footer{pointer-events:auto}.busy-spinner{display:inline-flex;width:14px;height:14px;border-radius:50%;border:2px solid currentColor;border-right-color:transparent;animation:os-form-spin 0.7s linear infinite;vertical-align:-2px;margin-inline-end:6px}@keyframes os-form-spin{to{transform:rotate( 360deg )}}@media ( prefers-reduced-motion:reduce ){.busy-spinner{animation-duration:2s}}`,Ot=class Ot extends _{constructor(){super(...arguments),this._initial=new Map,this._captured=!1,this._fieldChangeListener=null,this._enterSubmitListener=null}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._captureInitialValues()),this._fieldChangeListener=e=>this._onAnyFieldInput(e),this.addEventListener("os-input-change",this._fieldChangeListener),this.addEventListener("os-input-commit",this._fieldChangeListener),this.addEventListener("os-checkbox-change",this._fieldChangeListener),this.addEventListener("os-select-change",this._fieldChangeListener),this.addEventListener("change",this._fieldChangeListener),this._enterSubmitListener=()=>this.submit(),this.addEventListener("os-submit",this._enterSubmitListener)}disconnectedCallback(){this._fieldChangeListener&&(this.removeEventListener("os-input-change",this._fieldChangeListener),this.removeEventListener("os-input-commit",this._fieldChangeListener),this.removeEventListener("os-checkbox-change",this._fieldChangeListener),this.removeEventListener("os-select-change",this._fieldChangeListener),this.removeEventListener("change",this._fieldChangeListener),this._fieldChangeListener=null),this._enterSubmitListener&&(this.removeEventListener("os-submit",this._enterSubmitListener),this._enterSubmitListener=null)}render(){const e=this["submit-label"]||"Submit",t=this["reset-label"]||"Reset",s=this.error||"",i=this.busy!==null,r=this["show-reset"]!=="false";return l`
			...
			<slot name="error">
				${s?l`<p class="error" role="alert" part="error">${s}</p>`:l`<p class="error" role="alert" part="error" hidden></p>`}
			</slot>
		...
		`}_renderGlyph(e){return e==="saved"?Uu():e==="failed"?qu():""}_labelForPhase(e){switch(e){case"pending":case"saving":return this["saving-label"]??"Saving…";case"saved":return this["saved-label"]??"Saved";case"failed":return(this.error??"")||"Couldn’t save";default:return this["idle-label"]??""}}_installAutoListener(){const e=this.event||Cr;this._docListener=t=>{const s=t.detail;!s||typeof s.phase!="string"||(this.phase=s.phase,s.error?this.error=s.error:s.phase!=="failed"&&this.error&&this.removeAttribute("error"))},document.addEventListener(e,this._docListener)}_removeAutoListener(){if(!this._docListener)return;const e=this.event||Cr;document.removeEventListener(e,this._docListener),this._docListener=null}_scheduleAutoClear(){this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null);const e=this.phase??"idle",t=this._autoClearMsFor(e);t<=0||(this._autoTimer=window.setTimeout(()=>{this._autoTimer=null,this.phase="idle"},t))}_autoClearMsFor(e){if(e==="saved"){const t=this["auto-clear-saved-ms"];return parseInt(t||"",10)||Wu}if(e==="failed"){const t=this["auto-clear-failed-ms"];return parseInt(t||"",10)||Hu}return 0}};Wt.props=["phase","mode","variant","animation","auto","event","error","saving-label","saved-label","idle-label","auto-clear-saved-ms","auto-clear-failed-ms"],Wt.styles=[Ou],Wt.help=void 0;let li=Wt;y("os-save-status",li);function Uu(){return l`
		<svg
			viewBox="0 0 12 12"
			aria-hidden="true"
			focusable="false"
	...
	`}const Fu=v`:host{display:flex;width:100%;min-width:0;max-width:100%;align-items:stretch}.os-cat{display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:var( --os-ui-cat-padding,2px );min-height:24px;max-width:100%;width:100%}.os-cat__chips{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-cat-gap,4px );min-width:0}.os-cat__chains{display:flex;flex-wrap:wrap;gap:4px;min-width:0}.os-cat__viz-host{display:flex;align-items:center;gap:4px;min-width:0;flex:1 1 auto;max-width:100%;min-height:28px;cursor:pointer;position:relative}.os-cat__viz-svg{display:block;width:100%;max-width:100%;min-width:0;overflow:visible;flex:1 1 auto}.os-cat__viz-svg .os-cat-edge{fill:none;stroke:var( --os-ui-cat-edge-color,currentColor );stroke-width:1.25;stroke-linecap:round;opacity:0.55;transition:stroke-width 0.18s ease,opacity 0.18s ease}.os-cat__viz-svg .os-cat-edge[ data-active='true' ]{stroke-width:2;opacity:1}.os-cat__viz-svg .os-cat-node{cursor:pointer;transition:r 0.2s cubic-bezier( 0.34,1.56,0.64,1 ),fill 0.18s ease,stroke-width 0.18s ease,filter 0.18s ease}.os-cat__viz-svg .os-cat-node[ data-selected='true' ]{filter:drop-shadow( 0 0 6px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.18 ) ) )}.os-cat__viz-svg .os-cat-node:hover,.os-cat__viz-svg .os-cat-node:focus-visible{filter:drop-shadow( 0 0 8px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.3 ) ) );outline:none}.os-cat__viz-svg .os-cat-label{font-family:var( --os-ui-font,system-ui,sans-serif );font-size:10.5px;fill:var( --os-ui-cat-label-fg,var( --os-ui-fg,#1d2327 ) );font-weight:500;pointer-events:none;user-select:none}.os-cat__viz-svg .os-cat-label[ data-selected='false' ]{fill:var( --os-ui-cat-label-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-weight:400;font-style:italic}.os-cat__trigger{appearance:none;display:inline-flex;align-items:center;gap:4px;padding:1px 8px;min-height:22px;font:inherit;font-size:11px;font-weight:500;line-height:1;color:var( --os-ui-cat-trigger-fg,var( --os-ui-fg-muted,#50575e ) );background:transparent;border:1px dashed var( --os-ui-cat-trigger-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease,border-color 0.12s ease}.os-cat__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) );color:var( --os-ui-cat-trigger-fg-hover,var( --os-ui-fg,#1d2327 ) );border-color:var( --os-ui-cat-trigger-border-hover,var( --os-ui-border-strong,#8c8f94 ) )}.os-cat__trigger:focus-visible{outline:none;border-style:solid;box-shadow:0 0 0 2px var( --wp-admin-theme-color,#2271b1 )}.os-cat__trigger svg{display:block}.os-cat__uncategorized{display:inline-flex;align-items:center;gap:4px;padding:1px 10px;min-height:22px;font-size:11px;font-weight:500;line-height:1.6;color:var( --os-ui-cat-uncat-fg,var( --os-ui-fg-muted,#8c8f94 ) );background:transparent;border:1px dashed var( --os-ui-cat-uncat-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;font-style:italic}.os-cat__popover{position:fixed;top:0;left:0;min-width:280px;max-width:360px;max-height:360px;display:flex;flex-direction:column;background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-cat-pop-fg,var( --os-ui-fg,#1d2327 ) );border:1px solid var( --os-ui-cat-pop-border,var( --os-ui-border,#c3c4c7 ) );border-radius:8px;box-shadow:0 6px 16px rgba( 0,0,0,0.08 ),0 1px 2px rgba( 0,0,0,0.06 );z-index:1000}.os-cat__editor{position:relative;display:inline-flex;align-items:center}.os-cat__search{appearance:none;font:inherit;font-size:13px;padding:8px 12px;border:0;border-bottom:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );background:transparent;color:inherit;outline:none}.os-cat__search:focus{border-bottom-color:var( --wp-admin-theme-color,#2271b1 )}.os-cat__tree{flex:1 1 auto;min-height:0;overflow-y:auto;padding:4px 0}.os-cat__row-block{display:contents}.os-cat__row{display:flex;align-items:center;gap:6px;padding:4px 8px 4px var( --os-ui-cat-row-indent,12px );cursor:pointer;user-select:none;font-size:13px;line-height:1.4;position:relative}.os-cat__row:hover,.os-cat__row[ data-focused='true' ]{background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) )}.os-cat__row[ data-selected='true' ]{color:var( --wp-admin-theme-color,#2271b1 );font-weight:600}.os-cat__row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__expander{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;border:0;background:transparent;color:inherit;cursor:pointer;flex-shrink:0;opacity:0.65}.os-cat__expander:hover{opacity:1}.os-cat__expander svg{display:block;transition:transform 0.12s ease}.os-cat__row[ data-expanded='true' ] .os-cat__expander svg{transform:rotate( 90deg )}.os-cat__expander--placeholder{visibility:hidden}.os-cat__create-row{display:flex;align-items:center;padding:2px 8px 2px var( --os-ui-cat-row-indent,28px );position:relative}.os-cat__create-row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__create-wrap{display:inline-flex;align-items:center;flex:1 1 auto;min-width:0;gap:4px;padding:1px 1px 1px 0;border:1px solid transparent;border-radius:6px;background:transparent;transition:border-color 0.12s ease,background-color 0.12s ease,box-shadow 0.12s ease}.os-cat__create-wrap:hover{border-color:var( --os-ui-border,rgba( 0,0,0,0.12 ) );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) )}.os-cat__create-wrap:focus-within{border-color:var( --wp-admin-theme-color,#2271b1 );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );box-shadow:0 0 0 2px color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 15%,transparent )}.os-cat__create-input{flex:1 1 auto;min-width:0;appearance:none;font:inherit;font-size:var( --os-ui-field-font-size-compact,12px );padding:3px 6px;border:0;background:transparent;color:inherit;outline:none}.os-cat__create-input::placeholder{color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-style:italic;opacity:1}.os-cat__create-submit{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;flex-shrink:0;padding:0;border:0;border-radius:4px;background:transparent;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease}.os-cat__create-wrap:focus-within .os-cat__create-submit:not( [ disabled ] ){background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__create-submit:hover:not( [ disabled ] ){filter:brightness( 1.05 )}.os-cat__create-submit[ disabled ]{cursor:default;opacity:0.5}.os-cat__create-submit svg{display:block}.os-cat__create-spinner{display:inline-block;width:12px;height:12px;margin:0 4px;border-radius:50%;border:2px solid var( --wp-admin-theme-color,#2271b1 );border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;flex-shrink:0}.os-cat__check{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;border:1.5px solid var( --os-ui-cat-check-border,var( --os-ui-border,#8c8f94 ) );border-radius:3px;color:transparent;transition:background-color 0.12s ease,border-color 0.12s ease,color 0.12s ease}.os-cat__row[ data-selected='true' ] .os-cat__check{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__check svg{display:block;width:14px;height:14px}.os-cat__label{min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-cat__delete{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:18px;height:18px;border:0;border-radius:50%;padding:0;background:transparent;color:var( --os-ui-cat-delete-color,var( --os-ui-danger,#d63638 ) );cursor:pointer;opacity:0;transition:opacity 0.12s ease,background-color 0.12s ease}.os-cat__row:hover .os-cat__delete,.os-cat__row[ data-focused='true' ] .os-cat__delete,.os-cat__delete:focus-visible{opacity:1}.os-cat__delete:hover,.os-cat__delete:focus-visible{background:var( --os-ui-badge-danger-bg,rgba( 214,54,56,0.12 ) )}.os-cat__delete svg{display:block;width:14px;height:14px}.os-cat__match{background:var( --os-ui-search-highlight-bg,rgba( 252,211,77,0.45 ) );border-radius:2px;padding:0 1px}.os-cat__empty,.os-cat__loading{padding:12px;font-size:12px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );text-align:center}.os-cat__loading-spinner{display:inline-block;width:12px;height:12px;border-radius:50%;border:2px solid currentColor;border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;margin-inline-end:8px;vertical-align:middle}@keyframes os-cat-spin{to{transform:rotate( 360deg )}}.os-cat__footer{padding:8px 12px;font-size:11px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );border-top:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );border-radius:10px;background:var( --os-ui-cat-pop-footer-bg,var( --os-ui-surface,#fafafb ) );display:flex;align-items:center;gap:6px;line-height:1.4}.os-cat__footer .dashicons{font-size:14px;width:14px;height:14px;flex-shrink:0}:host( [ disabled ] ) .os-cat{opacity:0.6;pointer-events:none}`,X="10px",Vu=v`:host{display:inline-flex;max-width:100%;align-items:center;min-width:0;font-family:var( --os-ui-font,system-ui,sans-serif );font-size:12px;line-height:1;font-weight:500}.os-crumb-chain{display:inline-flex;flex-wrap:nowrap;align-items:stretch;max-width:100%;min-width:0;min-height:22px;border-radius:999px;overflow:hidden;filter:drop-shadow( 0 1px 1px rgba( 0,0,0,0.06 ) )}.os-crumb{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:22px;padding:2px 12px;background:var( --os-ui-crumb-bg,var( --os-ui-surface,#c3c4c7 ) );color:var( --os-ui-crumb-fg,var( --os-ui-fg,#1d2327 ) );text-align:center;min-width:0;max-width:100%;flex-shrink:1;font-size:12px;font-weight:500;letter-spacing:0.01em;white-space:nowrap;cursor:grab;transition:filter 0.15s ease,transform 0.15s ease,background-color 0.12s ease}.os-crumb:active{cursor:grabbing}.os-crumb:hover{filter:brightness( 1.06 )}.os-crumb__remove{cursor:pointer}.os-crumb--first{padding-inline-end:22px;clip-path:polygon( 0 0,calc( 100% - ${X} ) 0,100% 50%,calc( 100% - ${X} ) 100%,0 100% )}.os-crumb--middle{padding-inline:22px;margin-inline-start:calc( -1 * ${X} );clip-path:polygon( ${X} 0,calc( 100% - ${X} ) 0,100% 50%,calc( 100% - ${X} ) 100%,${X} 100%,0 50% )}.os-crumb--last{padding-inline-start:22px;padding-inline-end:14px;margin-inline-start:calc( -1 * ${X} );clip-path:polygon( ${X} 0,100% 0,100% 100%,${X} 100%,0 50% )}.os-crumb--solo{padding:2px 12px;border-radius:999px}.os-crumb__label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;line-height:1.4}.os-crumb__remove{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;padding:0;border:0;border-radius:50%;background:transparent;color:inherit;cursor:pointer;opacity:0.65;transition:opacity 0.12s ease,background-color 0.12s ease,transform 0.12s ease}.os-crumb__remove:hover,.os-crumb__remove:focus-visible{opacity:1;background:var( --os-ui-scrim,rgba( 0,0,0,0.22 ) );outline:none;transform:scale( 1.1 )}.os-crumb__remove svg{display:block;width:100%;height:100%}.os-crumb-chain:hover{filter:drop-shadow( 0 2px 3px rgba( 0,0,0,0.12 ) )}:host( [ disabled ] ) .os-crumb-chain{opacity:0.55;pointer-events:none}`,Ht=class Ht extends _{constructor(){super(...arguments),this._segments=[]}get segments(){return this._segments}set segments(e){this._segments=Array.isArray(e)?e.slice():[],this.requestUpdate()}render(){const e=this.removable!==null,t=this._segments;return t.length===0?l``:l`
		...
		`}_renderTreeBody(e,t){return e?l`
			...
			`:t.map((s,i)=>this._renderRow(s,i,t.length))}_renderRow(e,t,s){const{node:i,hasChildren:n}=e,r=this._value.includes(i.item.id),a=!this._collapsed.has(i.item.id),c=12+i.depth*16,u=i.depth>0?i.depth*16:0,h=t===this._focusedRow;return l`
			<div class="os-cat__row-block">
				...
				>
					${n?l`<button
							...
							>${Tr()}</button>`:l`<span class="os-cat__expander os-cat__expander--placeholder" aria-hidden="true">${Tr()}</span>`}
					<span class="os-cat__check" aria-hidden="true">${Yu()}</span>
					<span class="os-cat__label">${this._highlight(i.item.name,this._query)}</span>
					${ps(i.item)?l``:l`<button
								type="button"
				...
				${a&&!ps(i.item)?this._renderCreateRow(i.item.id,12+(i.depth+1)*16,(i.depth+1)*16,i.item.name):l``}
			</div>
		`}_renderCreateRow(e,t,s,i){const n=this._creatingValues.get(e)??"",r=this._creatingPending.has(e),a=e===0?"Add new category…":`Add child of "${i}"…`;return l`
			<div
				class="os-cat__create-row"
				style=${`--os-ui-cat-row-indent: ${t}px; --os-ui-cat-guide-width: ${s}px;`}
		...
		`}};Ft.props=["rating","total"],Ft.styles=[eh],Ft.help=void 0;let hi=Ft;function Pr(o,e){const t=o.getAttribute(e);if(t===null||t==="")return 0;const s=Number(t);return Number.isFinite(s)?s:0}function th(o){return o<0?0:o>100?100:o}function sh(o,e){return e===0?"No ratings yet":`Average rating ${(o/100*5).toFixed(1)} out of 5, from ${e} ratings`}function oh(o){const e=Math.floor(o),t=o-e>=.5?1:0,s=5-e-t,i=[];for(let n=0;n<e;n++)i.push(zr());for(let n=0;n<t;n++)i.push(ih());for(let n=0;n<s;n++)i.push(nh());return i}function zr(){return l`
		<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
			<path
				d="M8 1.5l2.06 4.17 4.6.67-3.33 3.25.79 4.58L8 12L3.88 14.17l.79-4.58L1.34 6.34l4.6-.67L8 1.5z"
			/>
		</svg>
	`}function ih(){return l`
	...
	`}y("os-rating-summary",hi);const rh=v`:host{display:flex;align-items:flex-start;gap:10px;width:100%;box-sizing:border-box;padding:10px 14px;font:var( --os-ui-notice-font,13px/1.5 var( --os-font,system-ui ) );color:var( --os-ui-notice-color,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-notice-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );border-block-end:1px solid var( --os-ui-notice-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-inline-start:4px solid var( --os-ui-notice-accent,var( --os-ui-border,#646970 ) )}:host( [ hidden ] ){display:none}.os-notice__icon{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;color:var( --os-ui-notice-accent,var( --os-ui-accent,#646970 ) )}.os-notice__icon[ hidden ]{display:none}.os-notice__label{flex:1;min-width:0;word-wrap:break-word}::slotted( a ){color:var( --os-ui-notice-link,var( --wp-admin-theme-color,#2271b1 ) );border-radius:2px}::slotted( a:hover ),::slotted( a:focus-visible ){color:var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) )}::slotted( a:focus-visible ){outline:2px solid var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) );outline-offset:2px}::slotted( p:first-child ){margin-block-start:0}::slotted( p:last-child ){margin-block-end:0}.os-notice__close{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;padding:0;border:none;background:transparent;color:inherit;opacity:0.6;cursor:pointer;border-radius:4px;transition:opacity 0.12s ease,background-color 0.12s ease}.os-notice__close:hover{opacity:1;background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) )}.os-notice__close:focus-visible{opacity:1;outline:2px solid var( --wp-admin-theme-color,#2271b1 );outline-offset:1px}.os-notice__close[ hidden ]{display:none}.os-notice__close svg{width:14px;height:14px}:host( [ tone='info' ] ){--os-ui-notice-accent:var( --os-ui-notice-info,var( --os-ui-info-fg,#0969da ) );--os-ui-notice-bg:var( --os-ui-notice-info-bg,rgba( 9,105,218,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-info-border,rgba( 9,105,218,0.16 ) )}:host( [ tone='success' ] ){--os-ui-notice-accent:var( --os-ui-notice-success,var( --os-ui-success-fg,#1a7f37 ) );--os-ui-notice-bg:var( --os-ui-notice-success-bg,rgba( 26,127,55,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-success-border,rgba( 26,127,55,0.16 ) )}:host( [ tone='warning' ] ){--os-ui-notice-accent:var( --os-ui-notice-warning,var( --os-ui-warning-fg,#9a6700 ) );--os-ui-notice-bg:var( --os-ui-notice-warning-bg,rgba( 154,103,0,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-warning-border,rgba( 154,103,0,0.16 ) )}:host( [ tone='error' ] ),:host( [ tone='danger' ] ){--os-ui-notice-accent:var( --os-ui-notice-error,var( --os-ui-danger,#cf222e ) );--os-ui-notice-bg:var( --os-ui-notice-error-bg,rgba( 207,34,46,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-error-border,rgba( 207,34,46,0.16 ) )}:host( [ tone='neutral' ] ){--os-ui-notice-accent:var( --os-ui-notice-neutral,var( --os-ui-fg-muted,#57606a ) );--os-ui-notice-bg:var( --os-ui-notice-neutral-bg,rgba( 87,96,106,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-neutral-border,rgba( 87,96,106,0.16 ) )}`,ah="desktop-mode-notice-dismissed";function lh(){const e=window.wp?.os?.config?.currentUserId;return typeof e=="number"&&e>0?String(e):"anon"}function Mr(){return`${ah}:${lh()}`}function pi(){try{const o=window.localStorage.getItem(Mr());if(!o)return{};const e=JSON.parse(o);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{}}function Or(o){try{window.localStorage.setItem(Mr(),JSON.stringify(o))}catch{}}function ch(o){return o?pi()[o]===!0:!1}function dh(o){if(!o)return;const e=pi();e[o]=!0,Or(e)}function uh(o){if(!o)return;const e=pi();e[o]&&(delete e[o],Or(e))}const Vt=class Vt extends _{connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","status"),this.hasAttribute("tone")||this.setAttribute("tone","info");const e=this.getAttribute("notice-id");e&&ch(e)&&(this.hidden=!0)}dismiss(){this.hidden=!0;const e=this.getAttribute("notice-id");e&&dh(e),this.emit("os-notice-dismiss",{noticeId:e??void 0})}undismiss(){const e=this.getAttribute("notice-id");e&&uh(e),this.hidden=!1}render(){const e=this.getAttribute("icon"),t=!this.hasAttribute("not-dismissible");return l`
				...
				${e.length===0?l`<div class="os-repeater__empty">
							<slot name="empty">${a}</slot>
								...
								<div class="os-repeater__row" data-key=${g}>
									${s?l`<div class="os-repeater__handles">
													<button
														type="button"
		...
		`}};Bt.props=["add-label","empty-text","disabled","reorderable","min","max","row-label"],Bt.styles=[bh],Bt.help=void 0;let mi=Bt;y("os-repeater",mi);const mh=v`:host{--_bg:var( --os-ui-token-field-bg,var( --os-ui-field-bg,#fff ) );--_border:var( --os-ui-token-field-border,var( --os-ui-field-border,#8c8f94 ) );--_fg:var( --os-ui-token-field-fg,var( --os-ui-field-fg,#2c3338 ) );--_chip-bg:var( --os-ui-token-field-chip-bg,var( --os-ui-surface-raised,rgba( 0,0,0,0.06 ) ) );display:block;position:relative}:host( [ hidden ] ){display:none}.os-token-field{display:flex;flex-direction:column;gap:6px}.os-token-field__label{font-size:13px;font-weight:500;color:var( --os-ui-fg,#1d2327 )}.os-token-field__input{box-sizing:border-box;width:100%;padding:6px 8px;border-radius:4px;background:var( --_bg );border:1px solid var( --_border );color:var( --_fg );font:inherit;resize:vertical}.os-token-field__input:focus-visible{outline:2px solid var( --os-ui-accent,#2271b1 );outline-offset:1px}.os-token-field__input:disabled{opacity:0.6}.os-token-field__toolbar{display:flex;align-items:center;gap:6px}.os-token-field__catalogue{position:absolute;inset-inline-start:0;inset-block-start:100%;z-index:20;max-height:18rem;overflow-y:auto;width:100%;padding:4px;box-sizing:border-box;border:1px solid var( --os-ui-border,#dcdcde );border-radius:6px;background:var( --os-ui-surface-elevated,#fff );box-shadow:0 8px 24px rgba( 0,0,0,0.18 )}.os-token-field__group{margin:6px 6px 2px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em;color:var( --os-ui-fg-faint,#8c8f94 )}.os-token-field__option{display:grid;grid-template-columns:minmax( 0,1fr ) auto;gap:2px 8px;width:100%;padding:6px 8px;border:0;border-radius:4px;background:transparent;color:var( --os-ui-fg,#1d2327 );font:inherit;text-align:start;cursor:pointer}.os-token-field__option:hover,.os-token-field__option:focus-visible{background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) );outline:none}.os-token-field__option-label{font-size:13px;min-width:0}.os-token-field__option-token{grid-column:2;grid-row:1;padding:1px 5px;border-radius:3px;background:var( --_chip-bg );font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample,.os-token-field__option-description{grid-column:1 / -1;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample{font-style:italic}.os-token-field__hint{margin:0;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview{display:flex;gap:6px;margin:0;font-size:12px;line-height:1.4;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview-label{flex:0 0 auto;font-weight:600}.os-token-field__preview-body{min-width:0;overflow-wrap:anywhere;white-space:pre-wrap}`,Gt=class Gt extends _{constructor(){super(...arguments),this._tokens=[],this._value="",this.caret=null,this.onInput=e=>{const t=e.target;this._value=t.value,this.emit("os-token-field-input",{value:this._value}),this.requestUpdate()},this.rememberCaret=()=>{const e=this.field;e&&(this.caret={start:e.selectionStart??e.value.length,end:e.selectionEnd??e.value.length})},this.toggleCatalogue=()=>{if(!(this.hasAttribute("disabled")||this.hasAttribute("readonly"))){if(this.isOpen){this.removeAttribute("open");return}this.rememberCaret(),this.setAttribute("open","")}},this.onKeydown=e=>{e.key==="Escape"&&this.isOpen&&(e.stopPropagation(),this.removeAttribute("open"),this.field?.focus())}}get tokens(){return this._tokens}set tokens(e){this._tokens=Array.isArray(e)?[...e]:[],this.requestUpdate()}get value(){return this._value}set value(e){this._value=typeof e=="string"?e:"";const t=this.field;t&&t.value!==this._value&&(t.value=this._value),this.requestUpdate()}get field(){return this.shadowRoot?.querySelector(".os-token-field__input")??null}get isOpen(){return this.hasAttribute("open")}grouped(){const e=new Map;for(const t of this._tokens){const s=t.group??"",i=e.get(s);i?i.push(t):e.set(s,[t])}return[...e.entries()].sort((t,s)=>t[0]===""?1:s[0]===""?-1:0)}preview(){let e=this._value,t=!1;for(const s of this._tokens)!s.sample||!e.includes(s.token)||(e=e.split(s.token).join(s.sample),t=!0);return t?e:null}insert(e){const t=this.field,s=this.caret??{start:this._value.length,end:this._value.length},i=this._value.slice(0,s.start),n=this._value.slice(s.end);this._value=`${i}${e.token}${n}`,this.removeAttribute("open"),t&&(t.value=this._value),this.emit("os-token-insert",{token:e.token,value:this._value}),this.emit("os-token-field-input",{value:this._value}),this.requestUpdate();const r=i.length+e.token.length;this.caret={start:r,end:r},queueMicrotask(()=>{const a=this.field;a?.focus(),a?.setSelectionRange?.(r,r)})}render(){const e=this.label||"",t=this.hint||"",s=this.placeholder||"",i=this,n=i["insert-label"]||"Insert a value",r=i["preview-label"]||"Reads as",a=this.hasAttribute("multiline"),c=this.hasAttribute("disabled"),u=this.hasAttribute("readonly"),h=Number(this.getAttribute("rows"))||4,p=this.preview(),g=this.grouped(),m=a?l`<textarea
			...
			<div class="os-token-field" @keydown=${this.onKeydown}>
				...
				${this.isOpen?l`<div
					  ...
					  >
							${g.map(([b,x])=>l`
									${b?l`<p class="os-token-field__group">${b}</p>`:null}
									${x.map(w=>l`
											<button
												type="button"
												role="option"
											...
											>
												...
												<code class="os-token-field__option-token"
													>${w.token}</code
												>
												${w.sample?l`<span class="os-token-field__option-sample"
															>${w.sample}</span
													  >`:null}
												${w.description?l`<span
		...
		`}};Gt.props=["label","placeholder","hint","multiline","rows","disabled","readonly","insert-label","preview-label","open"],Gt.styles=[mh],Gt.help=void 0;let vi=Gt;y("os-token-field",vi);const vh=["os-section","os-button","os-swatch","os-swatch-grid","os-segmented","os-segment","os-select","os-option","os-multiselect","os-color-field","os-range-field","os-text-field","os-number-field","os-checkbox","os-checkbox-label","os-switch","os-toast","os-toast-container","os-tabs","os-tab","os-tabpanel","os-window-button","os-menu","os-menu-item","os-action-menu","os-context-menu","os-context-menu-option","os-confirm-dialog","os-modal","os-user-search","os-role-picker","os-flyout","os-tab-chip","os-stack","os-cluster","os-icon","os-body","os-panel","os-row","os-grid","os-display","os-disclosure","os-empty-state","os-key","os-code","os-badge","os-ribbon","os-tile","os-log","os-steps","os-step","os-table","os-spinner","os-relative-time","os-histogram","os-stat","os-avatar","os-textarea","os-chip","os-tag-input","os-form","os-save-status","os-category-picker","os-crumb-chain","os-card","os-rating-summary","os-notice","os-progress-bar","os-field-row","os-repeater","os-token-field"];function _h(o,e,t,s){const i=[o,e,...s];if(t){i.push(t.summary??"",t.status??"");for(const n of[t.props,t.slots,t.events,t.parts,t.cssProps])for(const r of n??[]){const{name:a,description:c}=r;i.push(a??"",c??"")}}return i.join(" ").toLowerCase()}function Wr(o,e){return e.toLowerCase().split(/\s+/).filter(Boolean).every(s=>o.haystack.includes(s))}function yh(o){const e=o.replace(/^os-/,"").replace(/-/g," ");return e.charAt(0).toUpperCase()+e.slice(1)}function wh(){const o=[];for(const e of vh){const t=customElements.get(e);if(!t)continue;const s=t.help??null,i=s?.title??yh(e),n=t.props??[];o.push({tag:e,title:i,help:s,props:n,haystack:_h(e,i,s,n)})}return o.sort((e,t)=>e.title.localeCompare(t.title)),o}const xh=["<!-- 1 — invented name, nothing close in the registry. -->","<os-example-console-fail-due-to-unregistered-component>","</os-example-console-fail-due-to-unregistered-component>","","<!-- 2 — typo within edit distance of a real tag. -->","<os-buton></os-buton>"].join(`
`);let Hr=!1;function kh(){if(Hr)return;Hr=!0,console.log(`%c⚠ wp.os — INTENTIONAL DEMO%c
...
if you want a quieter Components tab.`,"background: #ffb400;color: #1a1a1a;font-weight: 700;font-size: 12px;padding: 4px 8px;border-radius: 3px","color: #b25c00;font-weight: 500")}const $h=o=>{switch(o){case"experimental":return d("Experimental");case"planned":return d("Planned");default:return d("Stable")}},gs=(o,e,t)=>e?.length?l`<section class="os-settings__help-group">
			<h4>${o}</h4>
			<ul class="os-settings__help-list">${e.map(s=>l`<li>${t(s)}</li>`)}</ul>
		</section>`:"",fs=o=>o?l` — ${o}`:"";function Eh(o){const e=o.help?.props??[],t=new Set(e.map(i=>i.name)),s=o.props.filter(i=>!t.has(i));return e.length===0&&s.length===0?"":l`
	...
	`}function Ah(o){const e=o.help,t=e?.status??"stable";return l`
		<header class="os-settings__help-head">
			<h3 class="os-settings__help-title">${o.title}</h3>
			<code class="os-settings__help-code">&lt;${o.tag}&gt;</code>
			<span class="os-settings__help-badge is-${t}">${$h(t)}</span>
		</header>
		${e?.summary?l`<p class="os-settings__help-summary">${e.summary}</p>`:""}
		${e?.example?l`<section class="os-settings__help-group">
				<h4>${d("Example")}</h4>
				<div class="os-settings__help-example">${e.example}</div>
			</section>`:""}
		${Eh(o)}
		${gs(d("Slots"),e?.slots,s=>l`<code>${s.name}</code>${fs(s.description)}`)}
		${gs(d("Events"),e?.events,s=>l`<code>${s.name}</code>${s.detail?l` — <code>${s.detail}</code>`:""}${fs(s.description)}`)}
		${gs(d("Shadow parts"),e?.parts,s=>l`<code>::part(${s.name})</code>${fs(s.description)}`)}
		${gs(d("CSS custom properties"),e?.cssProps,s=>l`<code>${s.name}</code>${s.default?l` (${d("default")} <code>${s.default}</code>)`:""}${fs(s.description)}`)}
		${e?"":l`<p class="os-settings__help-note">
	...
	>
		<div class="os-settings__help-warner">
			...
			<pre class="os-settings__help-warner-code"><code>${xh}</code></pre>
		</div>
	</os-disclosure>
	<!--
...
`;function Ur(o){const e=C(o).components;return e.entries??(e.entries=wh()),e.entries}function qr(o){const e=C(o).components,t=Ur(o).filter(s=>Wr(s,e.query));return t.find(s=>s.tag===e.activeTag)??t[0]}const Sh=(o,e)=>{const t=C(e).components;o.developerModeEnabled&&kh();const s=Ur(e).filter(n=>Wr(n,t.query)),i=qr(e);return l`
		${o.developerModeEnabled?Ch():""}
		<div class="os-settings__help-layout">
			<div class="os-settings__help-sidebar">
				<os-text-field
					...
					autocomplete="off"
					value=${t.query}
					@os-input-change=${n=>{t.query=N(n).trim(),e.repaint()}}
				></os-text-field>
				<nav class="os-settings__help-nav" aria-label=${d("Components")}>
					${s.length?"":l`<p class="os-settings__help-nav-empty">${d("No components match.")}</p>`}
					${s.map(n=>l`<button
							type="button"
			...
			<div class="os-settings__help-detail">
				${i?Ah(i):l`<p>${d("No components registered.")}</p>`}
			</div>
		</div>
	`};function Lh(o){const e=C(o).components,t=o.root.querySelector(".os-settings__help-detail");if(!t)return;const s=qr(o),i=s?.tag??"";i!==e.paintedTag&&(t.scrollTop=0,e.paintedTag=i);const n=s?.help?.exampleInit,r=t.querySelector(".os-settings__help-example");if(!(!n||!r||r.hasAttribute("data-os-example-ready"))){r.setAttribute("data-os-example-ready",""),customElements.upgrade(r);try{n(r)}catch(a){console.error(`[openstation] <${i}> exampleInit threw:`,a)}}}const Fr="https://openstation.blog/",Vr="https://openstation.blog/feed/",Rh="https://github.com/WordPress/openstation/";function _i(o){if(typeof o!="string"||o==="")return"";try{const e=new URL(o,window.location.href);return e.protocol==="http:"||e.protocol==="https:"?e.href:""}catch{return""}}const xe=o=>typeof o=="string"?o.trim():"";function Ih(o){if(!o||typeof o!="object")return null;const e=o,t=(Array.isArray(e.items)?e.items:[]).map(s=>{if(!s||typeof s!="object")return null;const i=s,n=xe(i.title),r=_i(i.url);return n===""||r===""?null:{title:n,url:r,author:xe(i.author),publishedAt:xe(i.publishedAt),excerpt:xe(i.excerpt)}}).filter(s=>s!==null).slice(0,5);return{title:xe(e.title)||d("OpenStation"),description:xe(e.description)||d("A public dev diary — building a desktop OS for wp-admin."),homeUrl:_i(e.homeUrl)||Fr,feedUrl:_i(e.feedUrl)||Vr,items:t,stale:e.stale===!0}}function Dh(o){if(o==="")return"";const e=new Date(o);return Number.isNaN(e.getTime())?"":e.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function Kr(o){const e=Dh(o.publishedAt);return e&&o.author?U("%1$s · %2$s",e,o.author):e||o.author}const Th=o=>l`
...
`,Nh=o=>l`
	<article class="os-settings__about-card" role="listitem">
		<a href=${o.url} target="_blank" rel="noopener noreferrer">
			<span class="os-settings__about-card-meta">${Kr(o)}</span>
			<h3>${o.title}</h3>
			${o.excerpt?l`<p>${o.excerpt}</p>`:""}
...
`,yi=(o,e,t,s="",i=!1)=>l`
	<div class=${`os-settings__about-status${s}`} role=${t} aria-live=${t==="status"?"polite":null}>
		${i?l`<span class="os-settings__about-spinner" aria-hidden="true"></span>`:l`<span class="dashicons dashicons-rss" aria-hidden="true"></span>`}
		<div>
			<strong>${o}</strong>
			<span>${e}</span>
		</div>
	</div>
`;function Ph(o){if(o.kind==="loading")return yi(d("Opening the journal…"),d("The latest posts are arriving over RSS."),"status","",!0);if(o.kind==="error")return yi(d("The journal could not be reached."),d("You can still read every post on openstation.blog."),"alert"," os-settings__about-status--error");if(o.feed.items.length===0)return yi(d("No dispatches yet."),d("The journal is open and waiting for its next post."),"status");const[e,...t]=o.feed.items;return l`
		${o.feed.stale?l`<p class="os-settings__about-stale" role="status">
		...
		<section class="os-settings__about-feed" aria-label=${d("Latest journal posts")}>
			${Th(e)}
			${t.length>0?l`<div class="os-settings__about-grid" role="list">${t.map(Nh)}</div>`:""}
		</section>
	`}function zh(o,e){const t=e.kind==="ready"?e.feed:null,s=`${o.pluginUrl??""}/assets/images/openstation-mark.svg`,i=o.pluginVersion??"";return l`
		<div class="os-settings__about-inner">
			<header class="os-settings__about-overview">
				...
				<div class="os-settings__about-story">
					...
					<div class="os-settings__about-meta">
						...
						<a href=${Rh} target="_blank" rel="noopener noreferrer">
			...
			<div class="os-settings__about-journal-head">
				...
				<a class="os-settings__about-journal-link" href=${t?.homeUrl||Fr} target="_blank" rel="noopener noreferrer">
			...
			<footer class="os-settings__about-footer">
				...
				<a href=${t?.feedUrl||Vr} target="_blank" rel="noopener noreferrer">
					<span class="dashicons dashicons-rss" aria-hidden="true"></span>
					${d("RSS feed")}
				</a>
			</footer>
		</div>
	`}const Mh=(o,e)=>l`<div class="os-settings__about">${zh(_e(e),C(e).about??{kind:"loading"})}</div>`;function Oh(o){const e=C(o);if(o.state.tab!=="about"||e.about!==null)return;e.about={kind:"loading"};const t=_e(o).aboutFeedUrl;if(!t){e.about={kind:"error"},o.repaint();return}(async()=>{try{const s=await o.fetch(t,{credentials:"same-origin"});if(!s.ok)throw new Error(`about feed returned ${s.status}`);const i=await s.json(),n=i.success?Ih(i.data):null;if(!n)throw new Error("about feed returned an invalid payload");e.about={kind:"ready",feed:n}}catch(s){console.error("[openstation/about] journal feed failed:",s),e.about={kind:"error"}}o.repaint()})()}function Wh(o,e){switch(o){case"wp-blue":return d("WordPress Blue");case"indigo":return d("Indigo");case"teal":return d("Teal");case"emerald":return d("Emerald");case"amber":return d("Amber");case"rose":return d("Rose");default:return e}}function Hh(o,e){switch(o){case"compact":return d("Compact");case"default":return d("Default");case"large":return d("Large");default:return e}}function Uh(o,e){switch(o){case"sharp":return d("Sharp");case"default":return d("Default");case"round":return d("Round");default:return e}}function qh(o,e){switch(o){case"static":return d("Static");case"dynamic":return d("Dynamic");case"hidden":return d("Hidden");default:return e}}function Fh(o,e){switch(o){case"static":return d("Static");case"dynamic":return d("Dynamic");default:return e}}function Vh(o,e){switch(o){case"bottom":return d("Bottom");case"left":return d("Left");case"right":return d("Right");default:return e}}function Kh(o,e){switch(o){case"classic":return d("Split");case"unified":return d("Unified");default:return e}}function jh(o){switch(o){case"classic":return d("Core admin menus are placed in a sidebar; plugins, apps, and OpenStation controls in a dock along the bottom edge.");case"unified":return d("Every menu in a single dock.");default:return""}}const Bh="conic-gradient( #f252fc, #9af2ff, #93f0c6, #f8f2b6, #ff5a5a, #f252fc )";function Gh(o){const e=o.querySelector(".os-settings__accent-picker");if(e)try{e.showPicker()}catch{e.click()}}const Xh=o=>{const e=o.accent===Se,t=i=>{const n=N(i);n!==Se&&!zs().some(r=>r.id===n)||(E({accent:n}),n===Se&&Gh(i.currentTarget))},s=i=>{const n=i.target.value;/^#[0-9a-fA-F]{6}$/.test(n)&&E({customAccent:n,accent:Se})};return l`
		<os-section
		...
		>
			<os-swatch-grid label=${d("Accent color")} mode="row" @os-pick=${t}>
				${zs().map(i=>l`<os-swatch
						value=${i.id}
						label=${Wh(i.id,i.label)}
						preview=${i.value}
						size="small"
						variant="accent"
						?selected=${o.accent===i.id}
					></os-swatch>`)}
				<span class="os-settings__accent-custom">
					<os-swatch
						value=${Se}
						label=${d("Custom")}
						preview=${e?o.customAccent:Bh}
						size="small"
						variant="accent"
						?selected=${e}
					></os-swatch>
					<input
						...
						tabindex="-1"
						aria-hidden="true"
						.value=${o.customAccent}
						@input=${s}
					/>
				</span>
			</os-swatch-grid>
		</os-section>
	`},Zh={unified:[{kind:"win",style:"left:12%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:30%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:24%;bottom:10%;width:52%;height:9%"}],classic:[{kind:"bar",rail:"sidebar",style:"left:0;top:0;bottom:0;width:5%"},{kind:"win",style:"left:14%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:32%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:33%;bottom:10%;width:38%;height:9%"}]},Ne=(o,e)=>t=>{const s=N(t);o.some(i=>i.id===s)&&e(s)},jr=()=>Ms.map(o=>l`<os-segment value=${o.id}>${Fh(o.id,o.label)}</os-segment>`),Yh=o=>d(o==="dynamic"?"The dock folds into a thin line at its edge of the screen and comes back when you move the pointer there. Windows can use the whole desktop.":"The dock is always visible, and windows open above it."),Qh=o=>{const e=r=>a=>{a.target.closest(".os-settings__dock-option")||E({desktopLayout:r})},t=r=>{const a=["os-settings__layout-card"];return o.dockBehavior==="dynamic"&&a.push("is-dock-dynamic"),r==="classic"&&o.sideDockBehavior==="dynamic"&&a.push("is-sidebar-dynamic"),a.join(" ")},s=(r,a,c,u="")=>l`<div class="os-settings__dock-option">
			<span class="os-settings__dock-option-label" id=${r}>${a}</span>
			${c}
			${u?l`<span class="os-settings__dock-option-hint">${u}</span>`:""}
		</div>`,i=()=>l`<div class="os-settings__dock-options">
			${s("os-settings-dock-placement-label",d("Placement"),l`<os-segmented
					value=${o.dockPlacement}
					label=${d("Dock position")}
					@os-pick=${Ne(bn,r=>E({dockPlacement:r}))}
				>
					${bn.map(r=>l`<os-segment value=${r.id}>${Vh(r.id,r.label)}</os-segment>`)}
				</os-segmented>`)}
		</div>`,n=()=>l`<div class="os-settings__dock-options">
			${s("os-settings-side-dock-behavior-label",d("Sidebar behavior"),l`<os-segmented
					value=${o.sideDockBehavior}
					label=${d("Sidebar behavior")}
					@os-pick=${Ne(Ms,r=>E({sideDockBehavior:r}))}
				>
					${jr()}
				</os-segmented>`)}
		</div>`;return l`
		<os-section heading=${d("Desktop layout")} description=${d("Where the menus live.")}>
			<div class="os-settings__layout-grid" role="radiogroup" aria-label=${d("Desktop layout")}>
				${bl.map(r=>{const a=o.desktopLayout===r.id;return l`<div class=${t(r.id)} @click=${e(r.id)}>
						<button
							type="button"
						...
						>
							<span class="os-settings__layout-preview" aria-hidden="true">
								${(Zh[r.id]??[]).map(c=>l`<span
										class="os-settings__layout-${c.kind}${c.rail?` is-accent is-${c.rail}`:""}"
										style=${c.style}
									></span>`)}
							</span>
							<span class="os-settings__layout-name">${Kh(r.id,r.label)}</span>
							<span class="os-settings__layout-desc">${jh(r.id)}</span>
						</button>
						${r.id==="classic"?n():i()}
					</div>`})}
			</div>
			<div class="os-settings__dock-options os-settings__dock-options--page">
				${s("os-settings-dock-size-label",d("Dock size"),l`<os-segmented
						value=${o.dockSize}
						label=${d("Dock size")}
						@os-pick=${Ne(pn,r=>E({dockSize:r}))}
					>
						${pn.map(r=>l`<os-segment value=${r.id}>${Hh(r.id,r.label)}</os-segment>`)}
					</os-segmented>`)}
				${s("os-settings-dock-behavior-label",d("Dock behavior"),l`<os-segmented
						value=${o.dockBehavior}
						label=${d("Dock behavior")}
						@os-pick=${Ne(Ms,r=>E({dockBehavior:r}))}
					>
						${jr()}
					</os-segmented>`,Yh(o.dockBehavior))}
			</div>
		</os-section>
	`},Jh=o=>{const e=Ia();return e.length<=1?l``:l`
		<os-section
		...
		>
			<os-segmented
				value=${o.dockRailRenderer}
				label=${d("Dock style")}
				@os-pick=${t=>{const s=N(t);s!==""&&E({dockRailRenderer:s})}}
			>
				${e.map(t=>l`<os-segment value=${t.id}>${t.label}</os-segment>`)}
			</os-segmented>
		</os-section>
	`};function ep(o){switch(o){case"dynamic":return d("The admin bar slides out of the way and comes back when you move the pointer to the top edge of the screen.");case"hidden":return d("The admin bar is never shown. Use the Exit OpenStation tile on the dock to get back to the classic admin.");default:return d("The admin bar is always visible above the desktop.")}}const tp=o=>l`
	<os-section heading=${d("Admin bar")} description=${ep(o.adminBarMode)}>
		<os-segmented
			value=${o.adminBarMode}
			label=${d("Admin bar")}
			@os-pick=${Ne(fn,e=>E({adminBarMode:e}))}
		>
			${fn.map(e=>l`<os-segment value=${e.id}>${qh(e.id,e.label)}</os-segment>`)}
		</os-segmented>
	</os-section>
`;function sp(o,e,t){return l`
		${Xh(o)}
		${e}
		${Qh(o)}
		${Jh(o)}
	...
	<os-section heading=${d("Window corners")} description=${d("How rounded the corners of windows are.")}>
		<os-segmented
			value=${o.windowRadius}
			label=${d("Window corners")}
			@os-pick=${e=>{const t=N(e);gn.some(s=>s.id===t)&&E({windowRadius:t})}}
		>
			${gn.map(e=>l`<os-segment value=${e.id}>${Uh(e.id,e.label)}</os-segment>`)}
		</os-segmented>
	</os-section>
`,Br=[{value:nl,label:()=>d("Default (per reveal)")},{value:200,label:()=>d("Very fast — 200 ms")},{value:320,label:()=>d("Fast — 320 ms")},{value:460,label:()=>d("Normal — 460 ms")},{value:700,label:()=>d("Slow — 700 ms")},{value:1100,label:()=>d("Very slow — 1100 ms")}],ip=[{id:"focus",label:()=>d("When a related window is focused")},{id:"always",label:()=>d("Always")},{id:"off",label:()=>d("Off")}],wi=(o,e,t,s,i)=>l`<os-select
	value=${e}
	label=${o}
	@os-pick=${n=>{const r=N(n);r!==""&&(r===t||s.some(a=>a.id===r))&&i(r)}}
>
	<os-option value=${t}>${d("None")}</os-option>
	${s.map(n=>l`<os-option value=${n.id}>${n.label}</os-option>`)}
</os-select>`,np=o=>{const e=Ol(),t=al(),s=ql(),i=(n,r,a,c)=>{const u=n.find(h=>h.id===r);return r!==a&&u?.description?u.description:c};return l`
		<os-section
			heading=${d("Unfocused windows")}
			description=${i(e,o.unfocusEffect,Os,d("Apply a visual treatment to every window except the one you are working in."))}
		>
			${wi(d("Unfocused window effect"),o.unfocusEffect,Os,e,n=>E({unfocusEffect:n}))}
		</os-section>
		<os-section
			heading=${d("Window reveal")}
			description=${i(t,o.windowReveal,os,d("Uncover a window’s content when it finishes loading, instead of fading it in."))}
		>
			${wi(d("Reveal style"),o.windowReveal,os,t,n=>E({windowReveal:n}))}
			<os-select
				value=${String(o.windowRevealDuration)}
				label=${d("Reveal speed")}
				@os-pick=${n=>{const r=Number(N(n));Br.some(a=>a.value===r)&&E({windowRevealDuration:r})}}
			>
				${Br.map(n=>l`<os-option value=${String(n.value)}>${n.label()}</os-option>`)}
			</os-select>
		</os-section>
		<os-section
			heading=${d("Window links")}
			description=${i(s,o.windowLinkRenderer,Ln,d("Draw a visual tie between windows showing related content — a post and its comments or media."))}
		>
			${wi(d("Link style"),o.windowLinkRenderer,Ln,s,n=>E({windowLinkRenderer:n}))}
			<os-select
				value=${o.windowLinkVisibility}
				label=${d("Show links")}
				@os-pick=${n=>{const r=N(n);(r==="focus"||r==="always"||r==="off")&&E({windowLinkVisibility:r})}}
			>
				${ip.map(n=>l`<os-option value=${n.id}>${n.label()}</os-option>`)}
			</os-select>
		</os-section>
	`},rp=o=>l`
	<os-section
	...
	>
		<os-checkbox-label
			...
			?checked=${o.confirmCloseAllWindows}
			@os-checkbox-change=${e=>E({confirmCloseAllWindows:M(e)})}
		></os-checkbox-label>
	</os-section>
`,ap=(o,e)=>l`
	${op(o)}
	${np(o)}
	${rp(o)}
`,lp="",cp={accent:"pulse",desktopLayout:"unified",dockPlacement:"bottom"};function dp(o){if(o===lp)return Object.keys(wn(cp)).length>0;const e=xl(o);return e?Object.keys(wn(e.recommendedOsSettings)).length>0:!1}const bs="",Gr="OpenStation";function up(o){const e=o.trim().split(/\s+/).filter(Boolean);return e.length===0?"?":e.length>=2?(e[0][0]+e[1][0]).toUpperCase():e[0].slice(0,2).toUpperCase()}async function Xr(o,e){try{const t=await o.json();if(t&&typeof t.message=="string"&&t.message!=="")return t.message}catch{}return`${e} (HTTP ${o.status}).`}function Zr(o){const e=o?.serverWallpapers;Array.isArray(e)&&de(O.WALLPAPERS_SERVER_CHANGED,{wallpapers:e})}async function hp(o,e){const t=new FormData;t.append("file",e,e.name);const s=await o.fetch(_e(o).desktopThemesUrl,{method:"POST",body:t});if(!s.ok)throw new Error(await Xr(s,"Theme upload failed"));const i=await s.json();return Zr(i),i}async function pp(o,e){const t=await o.fetch(`${_e(o).desktopThemesUrl}/${encodeURIComponent(e)}`,{method:"DELETE"});if(!t.ok)throw new Error(await Xr(t,"Theme delete failed"));try{Zr(await t.json())}catch{}}async function Yr(o,e){const t=C(o).themes;if(!t.busy){t.busy=!0,t.error="",o.repaint();try{kl(await hp(o,e))}catch(s){t.error=s instanceof Error?s.message:d("That theme could not be installed.")}finally{t.busy=!1,o.repaint()}}}async function gp(o,e){if(!await o.host.confirm?.({title:d("Delete this theme?"),message:U(d("“%s” will be removed from this site for everyone. This cannot be undone."),e.name),confirmLabel:d("Delete"),danger:!0}))return;const s=C(o).themes;s.error="";try{await pp(o,e.slug),$l(e.slug),ee().desktopTheme===e.slug&&E({desktopTheme:bs})}catch(i){s.error=i instanceof Error?i.message:d("That theme could not be deleted.")}o.repaint()}const fp=(o,e,t,s)=>l`
	<div class="os-settings__theme-card-wrap">
		<button
			...
			@click=${()=>E({desktopTheme:e.slug})}
		>
			<span class="os-settings__theme-preview">
				${e.previewUrl?l`<img src=${e.previewUrl} alt="" aria-hidden="true" draggable="false" />`:l`<span class="os-settings__theme-initials" aria-hidden="true">${up(e.name)}</span>`}
			</span>
			<span class="os-settings__theme-name">${e.name}</span>
			<span class="os-settings__theme-meta">
				${e.version!==""?U(d("Version %s"),e.version):""}
			</span>
		</button>
		${s&&e.source!=="code"?l`<button
				type="button"
				class="os-settings__theme-delete"
				aria-label=${U(d("Delete %s"),e.name)}
				@click=${()=>void gp(o,e)}
			>×</button>`:""}
	</div>
`,bp=o=>l`
	<div class="os-settings__theme-card-wrap">
		<button
			...
			@click=${()=>E({desktopTheme:bs})}
		>
			<span class="os-settings__theme-preview os-settings__theme-preview--system" aria-hidden="true"></span>
			<span class="os-settings__theme-name">${Gr}</span>
			<span class="os-settings__theme-meta">${d("The look OpenStation ships with")}</span>
		</button>
	</div>
`,mp=o=>{const e=C(o).themes,t=s=>s.dataTransfer?.files?.[0]??s.currentTarget.files?.[0];return l`<div
		class=${e.busy?"os-settings__theme-upload os-settings__theme-upload--busy":"os-settings__theme-upload"}
		@dragover=${s=>{s.preventDefault(),s.currentTarget.classList.add("os-settings__theme-upload--dragover")}}
		@dragleave=${s=>{s.currentTarget.classList.remove("os-settings__theme-upload--dragover")}}
		@drop=${s=>{s.preventDefault(),s.currentTarget.classList.remove("os-settings__theme-upload--dragover");const i=t(s);i&&Yr(o,i)}}
	>
		<label class="os-settings__theme-upload-label">
			<input
				...
				class="os-settings__file-input"
				?disabled=${e.busy}
				@change=${s=>{const i=s.currentTarget,n=i.files?.[0];n&&Yr(o,n),i.value=""}}
			/>
	...
	</div>`},vp=(o,e)=>{if(!dp(o))return"";const t=o===bs?Gr:e.find(s=>s.slug===o)?.name;return t===void 0?"":l`<div class="os-settings__theme-recommendation">
		<os-button variant="secondary" @click=${()=>pc(o)}>
			${U(d("Apply %s’s recommended layout and effects"),t)}
		</os-button>
	</div>`},_p=(o,e)=>{const t=wl(),s=e.data.canManageDesktopThemes,i=C(e).themes.error;return l`
		${i!==""?l`<os-notice tone="error">${i}</os-notice>`:""}
		<os-section heading=${d("Installed")}>
			<div class="os-settings__theme-grid" role="group" aria-label=${d("Desktop theme")}>
				${bp(o.desktopTheme===bs)}
				${t.map(n=>fp(e,n,o.desktopTheme===n.slug,s))}
				${s?mp(e):""}
			</div>
			${vp(o.desktopTheme,t)}
		</os-section>
	`},yp=[{kinds:["core"],heading:()=>d("WordPress Core"),description:()=>d("The admin menus WordPress itself registers.")},{kinds:["plugin","app"],heading:()=>d("Plugins & Apps"),description:()=>d("Menus from installed plugins and apps.")},{kinds:["control"],heading:()=>d("OpenStation"),description:()=>d("The OpenStation’s own controls.")}];function wp(){const o=window.wp?.os;return typeof o?.getNavItems=="function"?o.getNavItems():[]}function xp(o){return o.locked||o.transient?!1:o.menu||o.entry?!0:o.tile?.placeable===!0}const kp=o=>d(o==="classic"?"Choose where each menu shows up: on the dock/sidebar, on the desktop wallpaper, both, or hidden entirely. Changes apply instantly.":"Choose where each menu shows up: on the dock, on the desktop wallpaper, both, or hidden entirely. Changes apply instantly."),$p=(o,e)=>[{id:"rail",label:Tl(o,e)==="sidebar"?d("In the sidebar"):d("On the dock")},{id:"desktop",label:d("On the desktop")},{id:"both",label:d("On both")},{id:"hidden",label:d("Hidden")}],Ep=(o,e)=>l`<div class="os-nav-settings__row" data-item-id=${o.id}>
	<div class="os-nav-settings__identity">
		${pr(o.icon,{title:o.title,className:"os-nav-settings__icon",slot:Il(o.id)})}
		<div class="os-nav-settings__title">${o.title}</div>
	</div>
	<os-select
		plain
		label=${o.title}
		value=${Nl(o,e.navPlacement)}
		@os-pick=${t=>{const s=N(t);(s==="both"||s==="rail"||s==="desktop"||s==="hidden")&&E({navPlacement:{...e.navPlacement,[o.id]:s}})}}
	>
		${$p(o.kind,e.desktopLayout).map(t=>l`<os-option value=${t.id}>${t.label}</os-option>`)}
	</os-select>
</div>`,Ap=o=>{const e=wp().filter(xp),t=yp.map(s=>({...s,rows:Pl(e.filter(i=>s.kinds.includes(i.kind)))})).filter(s=>s.rows.length>0);return l`
		<p class="os-settings__page-description os-nav-settings__lead">${kp(o.desktopLayout)}</p>
		${t.length===0?l`<os-empty-state
				heading=${d("Nothing registered yet")}
				description=${d("Plugins and the admin menu will appear here once they’re registered.")}
			></os-empty-state>`:t.map(s=>l`
					<os-section class="os-nav-settings" heading=${s.heading()} description=${s.description()}>
						${s.rows.map(i=>Ep(i,o))}
					</os-section>
				`)}
	`},ms=3,Qr=[{id:"auto",label:()=>d("Automatic")},{id:"desktop",label:()=>d("Always desktop")},{id:"mobile",label:()=>d("Always mobile")}];function Cp(o){return o.filter(e=>!e.locked&&!e.transient&&!!(e.windowId||e.tile||e.menu?.url||e.entry?.url))}const Sp=(o,e)=>{const t=Cp(Ml()),s=new Set(t.map(u=>u.id)),i=(jn().mode?.tabBar??[]).filter(u=>s.has(u)),n=(o.mobileTabs.length>0?o.mobileTabs:i).slice(0,ms),r=n.length>=ms,a=u=>{const h=N(u);Qr.some(p=>p.id===h)&&E({mobileLayout:h})},c=u=>h=>{const p=M(h),g=n.filter(m=>m!==u);p&&g.length<ms&&g.push(u),E({mobileTabs:g})};return l`
		<os-section
			heading=${d("Layout")}
		...
		>
			<os-segmented value=${o.mobileLayout} label=${d("Mobile layout")} @os-pick=${a}>
				${Qr.map(u=>l`<os-segment value=${u.id}>${u.label()}</os-segment>`)}
			</os-segmented>
		</os-section>

		<os-section
			heading=${d("Tab bar")}
			description=${U(d("Home and the app switcher are always there. Pin up to %d apps between them; leave it empty for the default set."),ms)}
		>
			${t.length===0?l`<p class="os-features__hint">${d("Nothing to pin yet.")}</p>`:t.map(u=>{const h=n.includes(u.id);return l`
						<div class="os-features__item">
							<os-checkbox-label
								label=${u.title}
								?checked=${h}
								?disabled=${!h&&r}
								@os-checkbox-change=${c(u.id)}
							></os-checkbox-label>
						</div>
					`})}
		</os-section>
	`},ke={size:null},te={appearance:()=>I("color",ke),themes:()=>{const o=document.createElementNS("http://www.w3.org/2000/svg","svg");return o.setAttribute("viewBox","0 0 24 24"),o.setAttribute("fill","currentColor"),o.setAttribute("aria-hidden","true"),o.innerHTML='<path fill-rule="evenodd" clip-rule="evenodd" d="M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 0 1-6.5 6.5v-13a6.5 6.5 0 0 1 6.5 6.5Z" />',o},windows:()=>I("windows",ke),navigation:()=>{const o=document.createElementNS("http://www.w3.org/2000/svg","svg");return o.setAttribute("viewBox","0 0 24 24"),o.setAttribute("fill","currentColor"),o.setAttribute("aria-hidden","true"),o.innerHTML='<path d="M12 4c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14.5c-3.6 0-6.5-2.9-6.5-6.5S8.4 5.5 12 5.5s6.5 2.9 6.5 6.5-2.9 6.5-6.5 6.5zM9 16l4.5-3L15 8.4l-4.5 3L9 16z" />',o},mobile:()=>I("window",ke),features:()=>I("settings",ke),help:()=>I("widgets",ke),"os-file-associations":()=>{const o=document.createElementNS("http://www.w3.org/2000/svg","svg");return o.setAttribute("viewBox","0 0 24 24"),o.setAttribute("fill","currentColor"),o.setAttribute("aria-hidden","true"),o.innerHTML='<path d="M15.5 7.5h-7V9h7V7.5Zm-7 3.5h7v1.5h-7V11Zm7 3.5h-7V16h7v-1.5Z" /><path d="M17 4H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM7 5.5h10a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5H7a.5.5 0 0 1-.5-.5V6a.5.5 0 0 1 .5-.5Z" />',o},about:()=>I("info",ke)},Jr=o=>`os-settings-tab-host-${o}`;function pe(o,e=""){return l`
		<header class="os-settings__page-header">
			<h2 class="os-settings__page-title">${o}</h2>
			${e?l`<p class="os-settings__page-description">${e}</p>`:""}
		</header>
	`}function Lp(o,e){return o.capability==="manage_options"?e:!0}function ea(o){return o<20?1:o<40?2:3}function ta(o){const e=o.data.isAdmin,t=[{id:"appearance",order:10,label:d("Appearance"),icon:te.appearance,panel:(s,i)=>l`${pe(d("Appearance"),d("Personalize your desktop. Changes apply instantly and are saved to this browser."))}${sp(s,Tc(s,i))}`},{id:"themes",order:12,label:d("Themes"),icon:te.themes,panel:(s,i)=>l`${pe(d("Themes"),d("A desktop theme repaints every token at once. A coarser version of what Appearance does one control at a time."))}${_p(s,i)}`},{id:"windows",order:18,label:d("Windows"),icon:te.windows,panel:(s,i)=>l`${pe(d("Windows"),d("How windows look, how they arrive, and how they behave when they are not the one you are using."))}${ap(s)}`},{id:"navigation",order:22,label:d("Navigation"),icon:te.navigation,panel:(s,i)=>l`${pe(d("Navigation"))}${Ap(s)}`},{id:"mobile",order:24,label:d("Mobile"),icon:te.mobile,panel:(s,i)=>l`${pe(d("Mobile"),d("On a phone the desktop becomes a home screen, one full-screen app at a time, and a tab bar. Choose when that happens and what the bar holds."))}${Sp(s)}`},{id:"features",order:30,label:d("Features"),icon:te.features,panel:(s,i)=>l`${pe(d("Features"),d("The assistant, developer tools, and beta features for your account, plus site-wide Extended options for administrators."))}${Uc(s,i)}`}];e&&t.push({id:"help",order:40,label:d("Components"),icon:te.help,panel:(s,i)=>l`${pe(d("Components"),d("Every <os-*> web component shipped by this plugin, with its props, slots, and a live example."))}${Sh(s,i)}`}),t.push({id:"about",order:Number.MAX_SAFE_INTEGER,label:d("About"),icon:te.about,padding:"0",panel:Mh});for(const s of jl())Lp(s,e)&&t.push({id:`ext-${s.id}`,order:s.order??100,label:s.label,icon:te[s.id],tab:s,panel:()=>l`<div data-host=${Jr(s.id)}></div>`});return t.sort((s,i)=>s.order-i.order),t}function Rp(o,e){const t=C(o);for(const s of e){const i=s.tab;if(!i)continue;const n=o.root.querySelector(`[data-host="${Jr(i.id)}"]`);if(!(!n||t.mountedTabs.get(n)===i)){t.mountedTabs.set(n,i);try{i.render(n,{isAdmin:o.data.isAdmin,getOsSettings:ee,subscribeOsSettings:Kn})}catch(r){console.error("[openstation] settings tab render threw:",i.id,r)}}}}const Ip=["heading","description","label","placeholder"];function Dp(o,e){const t=new Map;for(const s of e){const i=o.querySelector(`os-tabpanel[for="${s.id}"]`),n=[s.label,i?.textContent??""];for(const r of Array.from(i?.querySelectorAll("[heading],[description],[label],[placeholder]")??[]))for(const a of Ip)n.push(r.getAttribute(a)??"");t.set(s.id,n.join(" ").replace(/\s+/g," ").toLowerCase())}return t}const Tp="appearance";function sa(o,e){if(!e.icon)return l`<span class="os-settings__nav-glyph-blank" aria-hidden="true"></span>`;let t=o.glyphs.get(e.id);return t||(t=e.icon(),o.glyphs.set(e.id,t)),t}function Np(o){const e=ee(),t=C(o),s=ta(o),i=s.some(h=>h.id===o.state.tab)?o.state.tab:Tp,{query:n,index:r}=t.search,a=h=>n===""||(r?.get(h.id)??"").includes(n);let c=0;const u=h=>{var p;(p=t.search).index??(p.index=Dp(o.root,s)),t.search.query=h.target.value.trim().toLowerCase(),o.repaint()};return l`
		<div class="os-settings">
			<div class="os-settings__search">
				<label class="os-settings__search-field">
					${sa(t,{id:"__search",order:0,label:"",icon:()=>I("search",{size:null}),panel:()=>l``})}
					<input
						type="search"
			...
			<os-tabs
				...
				os-bind="tab"
			>
				${s.map((h,p)=>{const g=p>0&&ea(h.order)!==ea(s[p-1].order),m=a(h);return m&&c++,l`<os-tab
						value=${h.id}
						data-group-start=${g?"true":null}
						data-search-hidden=${m?null:"true"}
					>${sa(t,h)}${h.label}</os-tab>`})}
			</os-tabs>
			<p class="os-settings__search-empty" ?hidden=${n===""||c>0}>
			...
			<os-select
				...
				os-bind="tab"
			>
				${s.map(h=>l`<os-option value=${h.id}>${h.label}</os-option>`)}
			</os-select>
			<os-panel class="os-settings__footer">
				<os-button variant="ghost" @click=${hc}>${d("Reset to defaults")}</os-button>
			</os-panel>
			${s.map(h=>l`<os-tabpanel for=${h.id}>
					<os-panel padding=${h.padding??null}>${h.panel(e,o)}</os-panel>
				</os-tabpanel>`)}
		</div>
	`}const Pp=ma(Xs,{local:{tab:(o,e)=>{const t=String(e.value??"");t!==""&&(o.tab=t)}},view:Np,mounted:o=>{const e=C(o);Gl(ee,Ic),e.previews=nc(o.root),La(),Vl().catch(()=>{});const t=()=>o.repaint(),s=[Kn(t),ya(t),Da(t),Wl(t),cl(t),Fl(t),El(t),Bl(t)];return()=>{for(const i of s)i();er(o),e.previews?.dispose(),e.previews=null}},updated:o=>{Rc(o),C(o).previews?.sync(),Cc(o),Rp(o,ta(o)),Lh(o),Oh(o),sr(o)}});return xs.default=Pp,Object.defineProperties(xs,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),xs}({});
