var openStationApp_osSettings=function(Cs){"use strict";const Ra="desktop-mode";function Ui(){return window.wp?.i18n}function d(s,e=Ra){return Ui()?.__(s,e)??s}function V(s,...e){const t=Ui()?.sprintf;if(t)return t(s,...e);let o=0;return s.replace(/%(?:(\d+)\$)?[sd]/g,(i,n)=>{const r=n?Number.parseInt(n,10)-1:o++;return String(e[r]??"")})}const La="desktop-mode-os-settings",Is=1920,Rs=1080,Ta=40,Da=300,ss="custom-gradient",ie="custom-image",Pa="galaxy",Ce="custom",qi=[{id:"pulse",label:"Pulse",value:"#f252fc"},{id:"nebula",label:"Nebula",value:"#ec9bff"},{id:"sirius",label:"Sirius",value:"#9af2ff"},{id:"lagoon",label:"Lagoon",value:"#9f98ff"},{id:"wp-blue",label:"WordPress Blue",value:"#2271b1"},{id:"indigo",label:"Indigo",value:"#3858e9"},{id:"teal",label:"Teal",value:"#04a4cc"},{id:"emerald",label:"Emerald",value:"#059669"},{id:"amber",label:"Amber",value:"#d97706"},{id:"rose",label:"Rose",value:"#e11d48"}];function Ie(){const e=window.wp?.os?.config?.accentColors;if(!Array.isArray(e)||e.length===0)return qi;const t=[];for(const o of e)o&&typeof o=="object"&&typeof o.id=="string"&&typeof o.label=="string"&&typeof o.value=="string"&&o.id!==""&&o.label!==""&&/^#[0-9a-f]{3,8}$/i.test(o.value)&&t.push({id:o.id,label:o.label,value:o.value});return t.length>0?t:qi}function Fi(){const e=window.wp?.os?.config?.defaultWallpaper;return typeof e=="string"&&e!==""?e:Pa}const Vi=[{id:"compact",label:"Compact",width:48,icon:18},{id:"default",label:"Default",width:56,icon:20},{id:"large",label:"Large",width:72,icon:26}],ji=[{id:"sharp",label:"Sharp",value:0},{id:"default",label:"Default",value:8},{id:"round",label:"Round",value:16}],Bi=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"},{id:"hidden",label:"Hidden"}],Ls=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"}],Ki=[{id:"bottom",label:"Bottom"},{id:"left",label:"Left"},{id:"right",label:"Right"}],Na=[{id:"unified",label:"Unified"},{id:"classic",label:"Split"}],Ts=La;function he(){return window.wp?.os}function D(){return he().getOsSettings()}function A(s){he()?.updateOsSettings(s,{windowId:Ts})}function Ma(){he()?.resetOsSettings({windowId:Ts})}function Gi(s){return he()?.subscribeOsSettings(s)??(()=>{})}function Xi(s){const e=he()?.desktopThemes?.applyRecommendedOsSettings(s)??{};return Object.keys(e).length>0}function Zi(){try{he()?.refreshMenu?.()}catch{}}function za(s,e,t="dashicons-admin-settings"){const o=he();if(o?.windowManager?.open){o.windowManager.open({id:o.deriveWindowId?o.deriveWindowId(s):s,url:s,title:e,icon:t});return}window.open(s,"_blank","noopener")}function Ds(){return window.openStationConfig??{}}const Yi="__openStationSharedStores";function Oa(){const s=window;let e=s[Yi];return e||(e=new Map,s[Yi]=e),e}function Z(s,e){const t=Oa();let o=t.get(s);o||(o={state:e(),listeners:new Set,rebuild:e},t.set(s,o));const i={get state(){return o.state},set state(n){o.state=n},getState(){return o.state},notify(){for(const n of Array.from(o.listeners))try{n(o.state)}catch(r){console.error(`[desktop-mode/shared-store:${s}] subscriber threw:`,r)}},subscribe(n){return o.listeners.add(n),()=>{o.listeners.delete(n)}},setState(n){const r=o.state;if(typeof r!="object"||r===null){console.warn(`[desktop-mode/shared-store:${s}] setState called on a primitive store; use the state setter instead.`);return}Object.assign(r,n),i.notify()},reset(){const n=o.rebuild(),r=o.state;if(typeof r=="object"&&r!==null&&typeof n=="object"&&n!==null){const a=r;for(const l of Object.keys(a))delete a[l];Object.assign(a,n)}else o.state=n;o.listeners.clear()}};return i}const Ji="X-WP-Nonce";function Wa(s,e){const t=Ha();if(!t)return e;const o=Ua(s);if(!o||!qa(o))return e;const i=e?.headers??(typeof Request<"u"&&s instanceof Request?s.headers:void 0),n=new Headers(i??{});return n.has(Ji)?e:(n.set(Ji,t),{...e??{},headers:n})}function Ha(){if(typeof window>"u")return;const e=window.openStationConfig?.restNonce;return typeof e=="string"&&e.length>0?e:void 0}function Ua(s){try{const e=typeof window<"u"&&window.location?window.location.href:void 0;return typeof s=="string"?new URL(s,e):s instanceof URL?s:typeof Request<"u"&&s instanceof Request?new URL(s.url,e):null}catch{return null}}function qa(s){return typeof window>"u"||!window.location||s.origin!==window.location.origin?!1:!!(s.pathname.includes("/wp-json/")||s.searchParams.has("rest_route"))}function Qi(s,e,t={}){const o=window.wp?.os?.fetch;if(typeof o=="function")return o(s,e,t);const i=Wa(s,e);return fetch(s,i)}const en=Z("desktop-mode/dock-rail-registry",()=>({registry:new Map,listeners:new Set,activeId:"default"})),tn=en.state.registry,sn=en.state.listeners;function Fa(s){return tn.get(s)}function Ps(){return Array.from(tn.values())}function Va(s){return sn.add(s),()=>{sn.delete(s)}}function on(){const s=window.wp?.hooks;if(!s)throw new Error("[openstation] `window.wp.hooks` is not available. The plugin declares `wp-hooks` as a script dependency; if you are seeing this error, verify the enqueue order.");return s}function pe(s,e,...t){return on().applyFilters(s,e,...t)}function ge(s,...e){on().doAction(s,...e)}const U={INIT:"os.init",WALLPAPERS:"os.wallpapers",GAMES:"os.games",UNFOCUS_EFFECTS:"os.unfocus-effects",WINDOW_REVEALS:"os.window-reveals",WALLPAPER_MOUNTING:"os.wallpaper.mounting",WALLPAPER_MOUNTED:"os.wallpaper.mounted",WALLPAPER_UNMOUNTING:"os.wallpaper.unmounting",WALLPAPER_MOUNT_FAILED:"os.wallpaper.mount-failed",WALLPAPER_VISIBILITY:"os.wallpaper.visibility",WALLPAPER_SUSPEND:"os.wallpaper.suspend",WALLPAPER_PREVIEW_PARAMS:"os.wallpaper.preview-params",WALLPAPER_SETTINGS_CHANGED:"os.wallpaper.settings-changed",IFRAME_READY:"os.iframe.ready",IFRAME_ERROR:"os.iframe.error",IFRAME_NETWORK_COMPLETED:"os.iframe.network-completed",SHELL_ERROR:"os.shell.error",BROADCAST:"os.broadcast",MONITOR_ENTRY:"os.monitor.entry",WALLPAPER_SURFACES:"os.wallpaper.surfaces",DESKTOP_THEME_CHANGED:"os.os-theme.changed",DESKTOP_THEME_ICON:"os.os-theme.icon",DESKTOP_THEME_ICON_COLOR:"os.os-theme.icon-color",WALLPAPERS_SERVER_CHANGED:"os.wallpapers.server-changed",EXTENDED_OPTIONS_CHANGED:"os.extended-options.changed",WINDOW_GEOMETRY:"os.window.geometry",WINDOW_OPENED:"os.window.opened",WINDOW_CONTENT_LOADING:"os.window.content-loading",WINDOW_CONTENT_LOADED:"os.window.content-loaded",WINDOW_LOADING_OVERLAY:"os.window.loading-overlay",WINDOW_REOPENED:"os.window.reopened",WINDOW_MENU_OPENED:"os.window.menu-opened",WINDOW_CLOSING:"os.window.closing",WINDOW_CLOSED:"os.window.closed",WINDOW_FOCUSED:"os.window.focused",WINDOW_BLURRED:"os.window.blurred",WINDOW_MINIMIZED:"os.window.minimized",WINDOW_RESTORED:"os.window.restored",WINDOW_CHILD_BLOCKED:"os.window.child-blocked",WINDOW_MAXIMIZED:"os.window.maximized",WINDOW_UNMAXIMIZED:"os.window.unmaximized",WINDOW_FULLSCREEN_ENTERED:"os.window.fullscreen-entered",WINDOW_FULLSCREEN_EXITED:"os.window.fullscreen-exited",WINDOW_AUTO_EXIT_FULLSCREEN:"os.window.auto-exit-fullscreen",WINDOW_FOCUS_ON_DRAG_HOVER:"os.window.focus-on-drag-hover",WINDOW_BOUNDS_CHANGED:"os.window.bounds-changed",WINDOW_MOVED:"os.window.moved",WINDOW_RESIZED:"os.window.resized",WINDOW_DRAG_START:"os.window.drag-start",WINDOW_DRAG_END:"os.window.drag-end",WINDOW_RESIZE_START:"os.window.resize-start",WINDOW_RESIZE_END:"os.window.resize-end",WINDOW_DETACHED:"os.window.detached",WINDOW_RELOADED:"os.window.reloaded",WINDOW_TITLE_CHANGED:"os.window.title-changed",WINDOW_HIGHLIGHT_CHANGED:"os.window.highlight-changed",WINDOW_BODY_RESIZED:"os.window.body-resized",NATIVE_WINDOW_BEFORE_RENDER:"os.native-window.before-render",NATIVE_WINDOW_AFTER_RENDER:"os.native-window.after-render",NATIVE_WINDOW_BEFORE_CLOSE:"os.native-window.before-close",WINDOW_CHROME_THEME:"os.window.chrome.theme",WINDOW_CHROME_CONTROLS:"os.window.chrome.controls",WINDOW_CHROME_SLOT:"os.window.chrome.slot",WINDOW_CHROME_RENDER:"os.window.chrome.render",WINDOW_CHROME_APPLIED:"os.window.chrome.applied",WINDOW_CHROME_THEME_CHANGED:"os.window.chrome.theme-changed",DESKTOP_ICON_CLICKED:"os.os-icon.clicked",DESKTOP_ICONS_RENDERED:"os.os-icons.rendered",ICON_BADGE_CHANGED:"os.icon.badge-changed",COMPONENTS_REGISTERED:"os.components.registered",DOCK_ITEM_APPENDED:"os.dock.item-appended",DOCK_ITEM_REMOVED:"os.dock.item-removed",DOCK_BEFORE_RENDER:"os.dock.before-render",DOCK_AFTER_RENDER:"os.dock.after-render",DOCK_REFRESH_ACTIVE:"os.dock.refresh-active",DOCK_TILE_CLASS:"os.dock.tile-class",DOCK_TILE_ELEMENT:"os.dock.tile-element",DOCK_TILE_RENDERED:"os.dock.tile-rendered",DOCK_TILE_TOOLTIP:"os.dock.tile-tooltip",DOCK_PEEK_CARD_CONTENT:"os.dock.peek-card-content",DOCK_PEEK_CARD_ELEMENT:"os.dock.peek-card-element",CONSTELLATION_PANEL:"os.constellation.panel",CONSTELLATION_OPENED:"os.constellation.opened",CONSTELLATION_CLOSED:"os.constellation.closed",OVERVIEW_ENTERING:"os.overview.entering",OVERVIEW_ENTERED:"os.overview.entered",OVERVIEW_EXITING:"os.overview.exiting",OVERVIEW_EXITED:"os.overview.exited",OVERVIEW_WINDOW_HOVER:"os.overview.window-hover",OVERVIEW_WINDOW_UNHOVER:"os.overview.window-unhover",OVERVIEW_WINDOW_CLICK:"os.overview.window-click",WORK_AREA_CHANGED:"os.work-area.changed",ARRANGE_CASCADE_STARTING:"os.arrange.cascade.starting",ARRANGE_CASCADE_APPLIED:"os.arrange.cascade.applied",ARRANGE_TILE_STARTING:"os.arrange.tile.starting",ARRANGE_TILE_APPLIED:"os.arrange.tile.applied",ARRANGE_TILE_DIMENSIONS:"os.arrange.tile.dimensions",ARRANGE_COLUMNS_STARTING:"os.arrange.columns.starting",ARRANGE_COLUMNS_APPLIED:"os.arrange.columns.applied",ARRANGE_FOCUS_SPLIT:"os.arrange.focus.split",ARRANGE_FOCUS_STARTING:"os.arrange.focus.starting",ARRANGE_FOCUS_APPLIED:"os.arrange.focus.applied",ARRANGE_SNAP_CHANGED:"os.arrange.snap.changed",ARRANGE_SNAP_CELL_SIZE:"os.arrange.snap.cell-size",ARRANGE_CUSTOM_ACTION:"os.arrange.custom-action",POINTER_SHAKE:"os.pointer.shake",GRID_SNAP_DIMENSIONS:"os.grid-snap.dimensions",GRID_SNAP_ARMED:"os.grid-snap.armed",GRID_SNAP_CHANGED:"os.grid-snap.changed",GRID_SNAP_ANCHOR_RESET:"os.grid-snap.anchor-reset",GRID_SNAP_CANCELED:"os.grid-snap.canceled",GRID_SNAP_COMMITTED:"os.grid-snap.committed",GRID_SNAP_REFLOWED:"os.grid-snap.reflowed",SNAP_ZONE_PENDING:"os.snap.zone-pending",SNAP_ZONE_CANCELED:"os.snap.zone-canceled",SNAP_ZONE_COMMITTED:"os.snap.zone-committed",SNAP_SPLIT_FILLED:"os.snap.split-filled",WIDGETS:"os.widgets",WIDGET_MOUNTING:"os.widget.mounting",WIDGET_MOUNTED:"os.widget.mounted",WIDGET_UNMOUNTING:"os.widget.unmounting",WIDGET_MOUNT_FAILED:"os.widget.mount-failed",WIDGET_ADDED:"os.widget.added",WIDGET_REMOVED:"os.widget.removed",DESKTOP_CREATED:"os.os.created",DESKTOP_CLOSED:"os.os.closed",DESKTOP_SWITCHED:"os.os.switched",DESKTOP_RENAMED:"os.os.renamed",WINDOW_DESKTOP_CHANGED:"os.os.window-moved",PRIMARY_DESKTOP_ID:"os.primary-desktop-id",WORKSPACE_PRESETS:"os.workspaces.presets",WORKSPACE_PROFILE:"os.workspaces.profile",WORKSPACE_UPDATED:"os.workspaces.updated",WORKSPACE_PROVISIONED:"os.workspaces.provisioned",WINDOWS_BEFORE_CLOSE_ALL:"os.windows.before-close-all",WINDOWS_CLOSE_ALL:"os.windows.close-all",WINDOWS_AFTER_CLOSE_ALL:"os.windows.after-close-all",COMMAND_BEFORE_RUN:"os.command.before-run",COMMAND_AFTER_RUN:"os.command.after-run",COMMAND_ERROR:"os.command.error",SHELL_RESIZED:"os.shell.resized",SHELL_VISIBILITY:"os.shell.visibility",CONNECTION_OPENED:"os.connection.opened",CONNECTION_CLOSED:"os.connection.closed",CONNECTION_MESSAGE:"os.connection.message",IFRAME_CONNECTION_REQUEST:"os.iframe.connection-request",WINDOW_CONTENT_CHANGED:"os.window-links.content-changed",WINDOW_LINK_GROUPS_CHANGED:"os.window-links.groups-changed",WINDOW_LINKS_CONTENT:"os.window-links.content",WINDOW_LINK_GROUPS:"os.window-links.groups",WINDOW_LINK_EDGES:"os.window-links.edges",RELATED_ENTITIES_ITEMS:"os.related-entities.items",WINDOW_LINK_RENDERERS:"os.window-links.renderers",WINDOW_LINK_RENDERER:"os.window-links.renderer",EDITOR_PREVIEW_WINDOW_CONFIG:"os.editor-preview.window-config",EDITOR_PREVIEW_LIVE:"os.editor-preview.live",EDITOR_PREVIEW_OPENED:"os.editor-preview.opened",EDITOR_PREVIEW_CLOSED:"os.editor-preview.closed",REVISIONS_WINDOW_CONFIG:"os.revisions.window-config",REVISIONS_OPENED:"os.revisions.opened",FILE_DROP_FILES_DETECTED:"os.drop.files-detected",FILE_DROP_FILES_REJECTED:"os.drop.files-rejected",FILE_DROP_DIALOG_FIELDS:"os.drop.dialog-fields",FILE_DROP_BEFORE_UPLOAD:"os.drop.before-upload",FILE_DROP_UPLOAD_STARTED:"os.drop.upload-started",FILE_DROP_UPLOAD_PROGRESS:"os.drop.upload-progress",FILE_DROP_AFTER_UPLOAD:"os.drop.after-upload",FILE_DROP_UPLOAD_FAILED:"os.drop.upload-failed",AUTH_LOST:"os.auth.lost",AUTH_RESTORED:"os.auth.restored",MODE_CHANGED:"os.mode.changed",SESSION_SNAPSHOT:"os.session.snapshot"};function nn(s,e){if(!s||typeof s!="object")return["def (not an object)"];const t=s,o=[];for(const i of e)i.valid(t)||o.push(`${i.field} (${i.message})`);return o}class ja extends Error{constructor(e,t,o){super(`[openstation] ${e} registration rejected — fields: `+t.join(", ")+"."),this.name="RegistrationError",this.kind=e,this.errors=t,this.def=o}}function Ns(s,e,t){if(e.length!==0)throw new ja(s,e,t)}const ne=[[0,0],[100,0],[100,100],[0,100]],Ba=48,Ka=80,Ms=6,zs=8,rn=4,an=3,ln=64,Os=105,re=2;function cn(s){return`${Math.round(s*1e3)/1e3}%`}function ae(s){return s.slice().reverse()}function Re(s,e,t,o){return[[s,e],[t,e],[t,o],[s,o]]}function Ga(s,e,t,o){const i=[];for(let n=0;n<o;n++){const r=n/o*Math.PI*2;i.push([s+Math.cos(r)*t,e+Math.sin(r)*t])}return i}function Y(s,e=[]){const t=[],o=i=>{t.push(`${cn(i[0])} ${cn(i[1])}`)};for(const i of s)o(i);if(e.length>0){o(s[0]);for(const i of e){for(const n of i)o(n);o(i[0]),o(s[0])}}return`polygon( ${t.join(", ")} )`}function dn(s){return Y(ne,[ae(Ga(50,50,s,Ba))])}function un(s){return Y(ne,[ae(Re(50-s,-re,50+s,100+re))])}function hn(s){const e=100/Ms,t=[];for(let o=0;o<Ms;o++){const i=o*e;t.push(ae(Re(-re,i,100+re,i+s)))}return Y(ne,t)}function pn(s){return Y(ne,[ae(Re(-re,50-s,100+re,50+s))])}function gn(s){const e=100/zs,t=[];for(let o=0;o<zs;o++){const i=o*e;t.push(ae(Re(i,-re,i+s,100+re)))}return Y(ne,t)}function fn(s){return Y(ne,[ae([[50,50-s],[50+s,50],[50,50+s],[50-s,50]])])}function bn(s){const e=100/rn,t=100/an,o=[];for(let i=0;i<an;i++)for(let n=0;n<rn;n++){const r=n*e+e/2,a=i*t+t/2,l=e/2*s,u=t/2*s;o.push(ae(Re(r-l,a-u,r+l,a+u)))}return Y(ne,o)}function mn(s){const e=-Math.PI/2,t=s/180*Math.PI,o=[[50,50]];for(let i=0;i<ln;i++){const n=e+i/(ln-1)*t;o.push([50+Math.cos(n)*Os,50+Math.sin(n)*Os])}return Y(ne,[ae(o)])}function Xa(){return{from:dn(0),to:dn(Ka)}}function Za(){return{from:un(0),to:un(52)}}function Ya(){return{from:hn(0),to:hn(100/Ms+.5)}}function Ja(){return{from:pn(0),to:pn(52)}}function Qa(){return{from:gn(0),to:gn(100/zs+.5)}}function el(){return{from:fn(0),to:fn(Os)}}function tl(){return{from:bn(0),to:bn(1.04)}}function sl(){return{from:mn(0),to:mn(360)}}function ol(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 100% 0% )"}}function il(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 0% 100% )"}}function nl(){return{from:Y([[-60,0],[100,0],[100,100],[0,100]]),to:Y([[100,0],[260,0],[260,100],[160,100]])}}const Ws=6,Hs=100,_e=Hs/2,os=200,vn=90,_n=["#5c5c6d","#525261","#484855","#3e3e49","#34343d","#2a2a31"],rl="#101014",al=1.25,we="http://www.w3.org/2000/svg";let ll=0;function is(s){return Math.round(s*1e3)/1e3}function Us(s){return s/Ws*Math.PI*2-Math.PI/2}function cl(s){const t=Us(s)+Math.PI/Ws+Math.PI/2;return{x:Math.cos(t),y:Math.sin(t)}}function dl(s){const e=Us(s),t=Us(s+1);return[[_e,_e],[_e+Math.cos(e)*os,_e+Math.sin(e)*os],[_e+Math.cos(t)*os,_e+Math.sin(t)*os]]}function wn(s,e){const t=dl(s),o=document.createElementNS(we,"path");return o.setAttribute("d",`M ${t.map(([i,n])=>`${is(i)} ${is(n)}`).join(" L ")} Z`),e?o.setAttribute("fill","#fff"):(o.setAttribute("fill",_n[s%_n.length]),o.setAttribute("stroke",rl),o.setAttribute("stroke-width",String(al)),o.setAttribute("vector-effect","non-scaling-stroke"),o.setAttribute("stroke-linejoin","round")),o}function ul(){const s=`os-iris-${++ll}`,e=document.createElementNS(we,"svg");e.setAttribute("viewBox",`0 0 ${Hs} ${Hs}`),e.setAttribute("preserveAspectRatio","none"),e.setAttribute("aria-hidden","true"),e.style.width="100%",e.style.height="100%",e.style.display="block";const t=document.createElementNS(we,"defs"),o=document.createElementNS(we,"mask");o.setAttribute("id",s);const i=document.createElementNS(we,"g"),n=document.createElementNS(we,"g");n.setAttribute("mask",`url(#${s})`);const r=[];for(let l=0;l<Ws;l++){const u=wn(l,!0),h=wn(l,!1);i.appendChild(u),n.appendChild(h),r.push({el:u,index:l},{el:h,index:l})}o.appendChild(i),t.appendChild(o),e.appendChild(t),e.appendChild(n);const a=document.createElement("div");return a.appendChild(e),{element:a,play:l=>r.map(({el:u,index:h})=>{const p=cl(h),g=is(p.x*vn),m=is(p.y*vn);return u.animate([{transform:"translate( 0px, 0px )"},{transform:`translate( ${g}px, ${m}px )`}],{duration:l.duration,easing:l.easing,delay:l.delay,fill:"both"})})}}const ns="none",yn=Z("desktop-mode/window-reveal-registry",()=>({registry:new Map,listeners:new Set})),qs=yn.state.registry,Fs=yn.state.listeners,xn=/^[a-z0-9_/-]+$/;function kn(s){const e=/^\s*([a-zA-Z-]+)\s*\(/.exec(s);return e?e[1].toLowerCase():""}const hl=0;function $n(s,e){const t=[],o=typeof s.from=="string"&&s.from.trim()!=="",i=typeof s.to=="string"&&s.to.trim()!=="";if(o||t.push(`${e}.from (missing — the clip-path covering the window)`),i||t.push(`${e}.to (missing — the clip-path uncovering the window)`),o&&i){const n=kn(s.from),r=kn(s.to);n===""||r===""?t.push(`${e}.from|to (must be shape functions, e.g. \`inset( … )\` or \`polygon( … )\` — bare keywords like \`none\` cannot be animated)`):n!==r&&t.push(`${e}.from|to (must use the same shape function to interpolate — got \`${n}()\` and \`${r}()\`)`)}return t}function pl(s){if(typeof KeyframeEffect!="function")return!0;try{return new KeyframeEffect(null,null,{easing:s}),!0}catch{return!1}}function j(s){const e=[];if(!s||typeof s!="object")e.push("def (not an object)");else{typeof s.id!="string"||s.id.trim()===""?e.push("id (missing)"):xn.test(s.id.trim().toLowerCase())?s.id.trim().toLowerCase()===ns&&e.push('id ("none" is reserved)'):e.push(`id (must match ${xn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof s.label!="string"||s.label.trim()==="")&&e.push("label (missing)");const o=s.render!==void 0,i=Array.isArray(s.layers),n=s.from!==void 0||s.to!==void 0;o&&typeof s.render!="function"?e.push("render (not a function)"):o&&(i||n)?e.push("render|layers|from|to (supply exactly one of: a from/to pair, a layers array, or a render function)"):o||(i&&n?e.push("layers|from|to (supply EITHER a single from/to pair OR a layers array, not both)"):i?(s.layers.length===0&&e.push("layers (empty — supply at least one matched pair)"),s.layers.forEach((r,a)=>{if(!r||typeof r!="object"){e.push(`layers[ ${a} ] (not an object)`);return}e.push(...$n(r,`layers[ ${a} ]`))})):e.push(...$n(s,"").map(r=>r.replace(/^\./,"")))),s.easing!==void 0&&(typeof s.easing!="string"||s.easing.trim()===""?e.push("easing (not a non-empty string)"):pl(s.easing)||e.push("easing (not an easing the browser can parse — `Element.animate()` would throw at play time, with the covering surface already over the window)"))}Ns("WindowReveal",e,s);const t=s.id.trim().toLowerCase();qs.set(t,{...s,id:t}),bl()}function Vs(){const s=Array.from(qs.values()),e=pe(U.WINDOW_REVEALS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-reveals` filter returned a non-array; falling back to registry list."),s)}function gl(s){return qs.has(s)}function fl(s){return Fs.add(s),()=>{Fs.delete(s)}}function bl(){const s=Array.from(Fs);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] window-reveal registry listener threw:",t)}}j({id:"sweep",label:d("Sweep"),description:d("A straight edge travels across the window, uncovering the page behind it."),...il(),duration:420}),j({id:"iris",label:d("Iris"),description:d("The page opens out from the centre of the window, like a camera shutter."),...Xa(),duration:520}),j({id:"curtain",label:d("Curtain"),description:d("Two panels part from the middle of the window and slide off the sides."),...Za(),duration:480}),j({id:"blinds",label:d("Blinds"),description:d("Six horizontal slats retract at once, letting the page through between them."),...Ya(),duration:560}),j({id:"diagonal",label:d("Diagonal"),description:d("A slanted edge sweeps off the trailing corner of the window."),...nl(),duration:460}),j({id:"rise",label:d("Rise"),description:d("The page rises into the window from the bottom edge upward."),...ol(),duration:440}),j({id:"shutter",label:d("Shutter"),description:d("Two panels part from the middle of the window and slide off the top and bottom."),...Ja(),duration:480}),j({id:"slats",label:d("Slats"),description:d("Eight vertical slats retract at once, letting the page through between them."),...Qa(),duration:560}),j({id:"diamond",label:d("Diamond"),description:d("The page opens out from the centre of the window through a growing rhombus."),...el(),duration:520}),j({id:"mosaic",label:d("Mosaic"),description:d("The page arrives as a grid of tiles, each opening out from its own centre."),...tl(),duration:600}),j({id:"obturator",label:d("Camera shutter"),description:d("Six wedges slide aside in unison, opening a hexagonal aperture from the centre like the iris of a camera lens."),render:ul,duration:720,edgeLag:0}),j({id:"radar",label:d("Radar"),description:d("A spoke sweeps a full turn around the centre of the window, uncovering the page behind it."),...sl(),duration:760});const An={dockSize:["compact","default","large"],desktopLayout:["classic","unified"],dockPlacement:["bottom","left","right"],windowRadius:["sharp","default","round"],adminBarMode:["static","dynamic","hidden"]},En=["dockRailRenderer","windowReveal","accent"],Sn={windowRevealDuration:{min:80,max:4e3}},ml=/^[a-z0-9_-]+$/;[...Object.keys(An),...En,...Object.keys(Sn)];function Cn(s){if(!s||typeof s!="object"||Array.isArray(s))return{};const e=s,t={},o={};for(const[i,n]of Object.entries(An)){const r=e[i];typeof r=="string"&&n.includes(r)&&(t[i]=r)}for(const i of En){const n=e[i];typeof n=="string"&&ml.test(n)&&(t[i]=n)}for(const[i,n]of Object.entries(Sn)){const r=e[i];typeof r=="number"&&Number.isFinite(r)&&(o[i]=Math.min(n.max,Math.max(n.min,Math.round(r))))}return{...t,...o}}function In(s){const e=Cn(s);return typeof e.dockRailRenderer=="string"&&Fa(e.dockRailRenderer)===void 0&&delete e.dockRailRenderer,typeof e.windowReveal=="string"&&e.windowReveal!==ns&&!gl(e.windowReveal)&&delete e.windowReveal,typeof e.accent=="string"&&!Ie().some(t=>t.id===e.accent)&&delete e.accent,e}const vl=/^[a-z0-9_-]+$/,Rn=128;function _l(s){return typeof s!="string"||s===""||s.length>2048?!1:s.startsWith("dashicons-")||s.startsWith("https://")||s.startsWith("http://")||s.startsWith("data:image/")}function Ln(s){if(!s||typeof s!="object")return null;const e=s,t=typeof e.slug=="string"?e.slug:"";if(!vl.test(t))return null;const o={};if(e.icons&&typeof e.icons=="object"){let l=0;for(const[u,h]of Object.entries(e.icons)){if(l>=Rn)break;u===""||!_l(h)||(o[u]=h,l+=1)}}const i={};if(e.tokens&&typeof e.tokens=="object")for(const[l,u]of Object.entries(e.tokens))typeof u=="string"&&(i[l]=u);const n=[];if(Array.isArray(e.fonts))for(const l of e.fonts)typeof l=="string"&&l!==""&&n.push(l);const r={};if(e.iconColors&&typeof e.iconColors=="object"){let l=0;for(const[u,h]of Object.entries(e.iconColors)){if(l>=Rn)break;u===""||typeof h!="string"||h===""||(r[u]=h,l+=1)}}const a=l=>typeof e[l]=="string"?e[l]:"";return{id:a("id")||t,slug:t,name:a("name")||t,version:a("version"),author:a("author"),description:a("description"),previewUrl:a("previewUrl"),cssUrl:a("cssUrl"),cssText:a("cssText"),tokens:i,fonts:n,icons:o,iconColors:r,recommendedOsSettings:Cn(e.recommendedOsSettings),installedAt:typeof e.installedAt=="number"?e.installedAt:0,source:e.source==="code"?"code":"upload",cssDeferred:e.cssDeferred===!0}}function wl(){const e=window.openStationConfig?.serverDesktopThemes,t=[];if(Array.isArray(e))for(const o of e){const i=Ln(o);i&&t.push(i)}return{themes:t,activeId:null,activeIcons:null,activeIconColors:null}}const se=Z("desktop-mode/desktop-themes",wl);function Tn(){return se}function js(){return se.getState().themes.slice()}function yl(s){if(typeof s!="string"||s==="")return null;const e=s.replace(/\//g,"-");return se.getState().themes.find(t=>t.slug===e||t.id===s)??null}function Dn(s){const e=Ln(s);if(!e)return null;const t=se.state.themes.slice(),o=t.findIndex(i=>i.slug===e.slug);return o>=0?t[o]=e:t.push(e),t.sort((i,n)=>i.name.localeCompare(n.name)),se.setState({themes:t}),e}let Le=null;function xl(){if(Le)return Le;const s=window.openStationConfig?.desktopThemesUrl;return s?(Le=Qi(s,{method:"GET",credentials:"same-origin"},{source:"desktop-mode/desktop-themes"}).then(e=>{if(!e.ok)throw new Error(`HTTP ${e.status}`);return e.json()}).then(e=>{for(const t of e?.themes??[])Dn(t)}).catch(()=>{Le=null}),Le):Promise.resolve()}function kl(s){const e=se.state.themes.filter(t=>t.slug!==s);e.length!==se.state.themes.length&&se.setState({themes:e})}function $l(s){return se.subscribe(s)}function Al(s){s.style.setProperty("--os-file-tile-enter-delay",`${(Math.random()*.25).toFixed(3)}s`),s.style.setProperty("--os-file-tile-enter-duration",`${(.3+Math.random()*.25).toFixed(3)}s`)}function Pn(s){if(!s)return 214;let e=5381;for(let t=0;t<s.length;t++)e=Math.imul(e,33)+s.charCodeAt(t);return(e%360+360)%360}function El(s){const e=Tn().state;if(e.activeIcons===null||!s)return null;const t=e.activeIcons[s];if(typeof t!="string"||t==="")return null;const o=pe(U.DESKTOP_THEME_ICON,t,{slot:s,themeId:e.activeId??""});return typeof o=="string"&&o!==""?o:null}function Sl(s){const e=Tn().state;if(e.activeIconColors===null||!s)return null;const t=e.activeIconColors[s];if(typeof t!="string"||t==="")return null;const o=pe(U.DESKTOP_THEME_ICON_COLOR,t,{slot:s,themeId:e.activeId??""});return typeof o=="string"&&o!==""?Cl(o):null}function Cl(s){const e=s.trim();if(e===""||e.length>64||/[;{}<>"'\\]/.test(e))return null;let t=0;for(const o of e)if(o==="(")t+=1;else if(o===")"&&(t-=1,t<0))return null;return t===0?e:null}function Il(s){return typeof s!="string"||s===""||s.length>4096||!/^(https?:\/\/|data:image\/)/i.test(s)?!1:!/['"()\\<>\s]/.test(s)}function Nn(s,e,t){if(!Il(e))return!1;const o=`url("${e}") center / contain no-repeat`;return s.style.backgroundImage="none",s.style.backgroundColor=t,s.style.setProperty("-webkit-mask",o),s.style.setProperty("mask",o),!0}const Te={OS_SETTINGS:"OS_SETTINGS",RECYCLE_BIN:"RECYCLE_BIN",BUG_REPORT:"BUG_REPORT",EXIT_OPENSTATION:"EXIT_OPENSTATION",PWA_INSTALL:"PWA_INSTALL"},Rl={"desktop-mode-os-settings":Te.OS_SETTINGS,"desktop-mode-recycle-bin":Te.RECYCLE_BIN,"desktop-mode-bug-report":Te.BUG_REPORT,"os-exit":Te.EXIT_OPENSTATION,"os-pwa-install":Te.PWA_INSTALL};function Ll(s){if(typeof s!="string"||s==="")return"";const e=Rl[s];if(e)return e;const t=s.toLowerCase().replace(/[^a-z0-9_-]/g,"");return t===""?"":`APP:${t}`}function Mn(s){let e,t;try{const i=new URL(s,document.baseURI);e=i.origin,t=i.pathname}catch{return null}if(!t)return null;const o=document.querySelectorAll("script[src]");for(const i of Array.from(o))try{const n=new URL(i.src,document.baseURI);if(n.origin===e&&n.pathname===t)return i}catch{}return null}const zn=new Map;function Tl(s){const e=zn.get(s);if(e)return e;let t=[];try{const o=new URL(s,document.baseURI);if(o.pathname.endsWith("/load-scripts.php")){const i=[];o.searchParams.forEach((n,r)=>{if(r!=="load"&&!r.startsWith("load["))return;const a=/(\d+)/.exec(r);i.push({order:a?Number(a[1]):i.length,value:n})}),i.sort((n,r)=>n.order-r.order),t=i.map(n=>n.value).join("").split(",").map(n=>n.trim()).filter(Boolean)}}catch{}return zn.set(s,t),t}function Dl(){const s=new Set,e=document.querySelectorAll('script[src*="load-scripts.php"]');for(const t of Array.from(e))for(const o of Tl(t.src))s.add(o);return s}function On(s){return s.url&&Mn(s.url)?!0:!!s.handle&&Dl().has(s.handle)}const rs=new Map;function Bs(s,e){const t=rs.get(s);if(t)return t;const o=e?.deps;if(o&&o.length>0){const n=a=>!a.url||On(a)?Promise.resolve():Bs(a.url,{...a,deps:void 0}),r=o.reduce((a,l)=>a.then(()=>n(l)),Promise.resolve(void 0)).then(()=>Wn(s,e));return rs.set(s,r),r}const i=Wn(s,e);return rs.set(s,i),i}function Wn(s,e){return new Promise((t,o)=>{const i=`script[data-os-vendor="${Pl(s)}"]`,n=document.querySelector(i);if(n){if(n.dataset.loaded==="1"){t();return}n.addEventListener("load",()=>t(),{once:!0}),n.addEventListener("error",()=>o(new Error(`Failed to load ${s}`)),{once:!0});return}const r=Mn(s);if(r){r.dataset.osVendor=s,r.dataset.loaded="1",t();return}if(On({handle:e?.handle})){t();return}e?.translations&&as(e.translations);for(const l of e?.l10n??[])as(l);for(const l of e?.before??[])as(l);const a=document.createElement("script");a.src=s,a.async=!0,a.dataset.osVendor=s,a.addEventListener("load",()=>{a.dataset.loaded="1";for(const l of e?.after??[])as(l);t()},{once:!0}),a.addEventListener("error",()=>{rs.delete(s),a.remove(),o(new Error(`Failed to load ${s}`))},{once:!0}),document.head.appendChild(a)})}function as(s){if(!s)return;const e=document.createElement("script");e.textContent=s,e.dataset.osVendorInline="1",document.head.appendChild(e)}function Pl(s){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(s):s.replace(/["\\]/g,"\\$&")}Z("desktop-mode/native-url-remap",()=>({remaps:[],deps:null}));const Nl={core:"rail",plugin:"rail",app:"desktop",control:"rail"};function Ml(s,e){return s==="core"&&e==="classic"?"sidebar":"dock"}function zl(s,e){return s.locked?"rail":e[s.id]??s.defaultPlacement??Nl[s.kind]}function Ol(s){return s.map((e,t)=>({item:e,index:t})).sort((e,t)=>(e.item.order??0)-(t.item.order??0)||e.index-t.index).map(e=>e.item)}function Wl(){return window.wp?.os??null}function Ks(){return Wl()?.getNavItems?.()??[]}const Gs="none",Hn=Z("desktop-mode/unfocus-effect-registry",()=>({registry:new Map,listeners:new Set})),Un=Hn.state.registry,Xs=Hn.state.listeners,qn=/^[a-z0-9_/-]+$/;function Zs(s){const e=[];!s||typeof s!="object"?e.push("def (not an object)"):(typeof s.id!="string"||s.id.trim()===""?e.push("id (missing)"):qn.test(s.id.trim().toLowerCase())?s.id.trim().toLowerCase()===Gs&&e.push('id ("none" is reserved)'):e.push(`id (must match ${qn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof s.label!="string"||s.label.trim()==="")&&e.push("label (missing)"),typeof s.className!="string"&&typeof s.apply!="function"&&e.push("className|apply (at least one must be provided — a CSS class to toggle or an apply callback)")),Ns("UnfocusEffect",e,s);const t=s.id.trim().toLowerCase();Un.set(t,{...s,id:t}),Ul()}function Ys(){const s=Array.from(Un.values()),e=pe(U.UNFOCUS_EFFECTS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.unfocus-effects` filter returned a non-array; falling back to registry list."),s)}function Hl(s){return Xs.add(s),()=>{Xs.delete(s)}}function Ul(){const s=Array.from(Xs);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] unfocus-effect registry listener threw:",t)}}Zs({id:"darken",label:d("Darken"),description:d("Dim unfocused windows so the focused one stands out."),className:"os-window--fx-darken"}),Zs({id:"frost",label:d("Frost"),description:d("Throw unfocused windows out of focus — a soft, frosted-glass blur, as if you were looking at them through an iced-over pane."),className:"os-window--fx-frost"}),Zs({id:"grayscale",label:d("Grayscale"),description:d("Drain the colour from unfocused windows so the focused one is the only thing still in colour — your eye snaps right to it."),className:"os-window--fx-grayscale"});const Fn="none",Vn=Z("desktop-mode/window-link-renderer-registry",()=>({registry:new Map,listeners:new Set})),ql=Vn.state.registry,jn=Vn.state.listeners;function Js(){const s=Array.from(ql.values()),e=pe(U.WINDOW_LINK_RENDERERS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-links.renderers` filter returned a non-array; falling back to registry list."),s)}function Fl(s){return jn.add(s),()=>{jn.delete(s)}}const Bn=Z("desktop-mode/wallpaper-registry",()=>({seed:[],listeners:new Set})),ls=Bn.state.seed,Qs=Bn.state.listeners;function Kn(s){Ns("Wallpaper",nn(s,Gn),s);const e=ls.findIndex(t=>t.id===s.id);e>=0?ls[e]=s:ls.push(s),jl()}function Vl(s){return Qs.add(s),()=>{Qs.delete(s)}}function jl(){const s=Array.from(Qs);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] wallpaper registry listener threw:",t)}}function ye(){const s=ls.slice(),e=pe(U.WALLPAPERS,s);return Array.isArray(e)?e.filter(Bl):(typeof console<"u"&&console.warn("[openstation] `os.wallpapers` filter returned a non-array; falling back to seed list."),s)}function De(s){return ye().find(e=>e.id===s)}const Gn=[{field:"id",message:"missing or not a non-empty string",valid:s=>typeof s.id=="string"&&s.id!==""},{field:"label",message:"missing or not a non-empty string",valid:s=>typeof s.label=="string"&&s.label!==""},{field:"preview",message:"missing or not a non-empty string",valid:s=>typeof s.preview=="string"&&s.preview!==""},{field:"type",message:'must be "css" or "canvas"',valid:s=>s.type==="css"||s.type==="canvas"},{field:"value/resolveValue/mount",message:"css types need `value` or `resolveValue`; canvas types need `mount`",valid:s=>s.type==="css"?typeof s.value=="string"||typeof s.resolveValue=="function":s.type==="canvas"?typeof s.mount=="function":!0}];function Bl(s){return nn(s,Gn).length===0}const Kl={desktopLayout:["unified","classic"],dockPlacement:["bottom","left","right"],dockBehavior:["static","dynamic"],sideDockBehavior:["static","dynamic"],dockSize:["compact","default","large"],windowRadius:["sharp","default","round"],adminBarMode:["static","dynamic","hidden"],windowLinkVisibility:["always","focus","off"],mobileLayout:["auto","desktop","mobile"],heartbeatRate:[15,30,45,60]},Gl=["mioApiEnabled","mioShowOnWallpaper","windowLinksEnabled","windowLinkRaiseOnFocus","windowLinkHighlight","showDesktopOnWallpaperClick","showPostStatusRibbons","developerModeEnabled","foldersSharingEnabled","stationHomeEnabled","nativePostsEnabled","nativePagesEnabled","nativeUsersEnabled","nativePluginsEnabled","nativeCommentsEnabled","confirmCloseAllWindows","libraryHdOnly"];function eo(){return{...Kl,accent:[...Ie().map(s=>s.id),"custom"],desktopTheme:["",...js().map(s=>s.slug)],wallpaper:ye().map(s=>s.id),dockRailRenderer:Ps().map(s=>s.id),unfocusEffect:["none",...Ys().map(s=>s.id)],windowReveal:["none",...Vs().map(s=>s.id)],windowLinkRenderer:["none",...Js().map(s=>s.id)]}}function Xn(){return Ks().filter(s=>!s.locked&&!s.transient&&(s.menu||s.entry||s.tile?.placeable))}function Zn(){return Ks().filter(s=>!s.locked&&!s.transient&&!!(s.windowId||s.tile||s.menu?.url||s.entry?.url))}async function Xl(){return await xl(),{choices:eo(),themes:[{id:"",name:"OpenStation",description:"Built-in dark OpenStation palette.",surface:"#15151e"},...js().map(s=>({id:s.slug,name:s.name,description:s.description,surfaces:Object.fromEntries(Object.entries(s.tokens).filter(([e])=>/(?:surface|bg|backstop)$/.test(e)).slice(0,12)),recommendations:s.recommendedOsSettings}))],accents:Ie(),wallpapers:ye().map(s=>({id:s.id,label:s.label,configurable:!!s.renderConfig})),dockRenderers:Ps().map(s=>({id:s.id,label:s.label})),unfocusEffects:Ys().map(s=>({id:s.id,label:s.label})),reveals:Vs().map(s=>({id:s.id,label:s.label})),linkRenderers:Js().map(s=>({id:s.id,label:s.label})),navigation:Xn().map(s=>({id:s.id,title:s.title})),phonePins:Zn().map(s=>({id:s.id,title:s.title}))}}function Yn(s,e,t){const o=JSON.parse(JSON.stringify(D()));return new Promise((i,n)=>{let r=!1;const a=p=>{if(!r)if(r=!0,clearTimeout(h),document.removeEventListener("os-settings-save-lifecycle",u),e.removeEventListener("abort",l),p)n(p);else{const g=D(),m=Object.keys(g).flatMap(b=>{const y=b;return JSON.stringify(o[y])===JSON.stringify(g[y])?[]:[{setting:y,before:o[y],after:g[y]}]});i({saved:!0,changed:m.length>0,changes:m,settings:t})}},l=()=>a(new DOMException("Cancelled; a submitted save may still finish.","AbortError")),u=p=>{const g=p.detail;if(g.phase==="failed")a(new Error(g.error||"Preferences could not be saved."));else if(g.phase==="saved"){const m=D(),b=!t||Object.entries(t).every(([k,f])=>JSON.stringify(m[k])===JSON.stringify(f)),y=g.savedSettings,x=y&&Object.entries(t??m).every(([k,f])=>JSON.stringify(y[k])===JSON.stringify(f));if(b&&!x)return;a(b?void 0:new Error("The setting changed during this request. Review Preferences."))}},h=setTimeout(()=>a(new Error("Save confirmation timed out. Changes may still be saving; review Preferences.")),2e4);if(document.addEventListener("os-settings-save-lifecycle",u),e.addEventListener("abort",l,{once:!0}),e.aborted){l();return}try{s()}catch(p){a(p instanceof Error?p:new Error(String(p)))}})}const Zl={wind:{min:0,max:80},particleCount:{min:100,max:2e3},flakeSize:{min:6,max:40}},Jn=Z("desktop-mode/wallpaper-settings",()=>({values:{}}));function Qn(s){return{...Jn.state.values[s]??{}}}function er(s,e){Jn.state.values[s]={...e},ge(U.WALLPAPER_SETTINGS_CHANGED,{id:s,settings:{...e}})}function c(s,...e){return{__wpdHtml:!0,strings:s,values:e}}function Yl(s){return!!s&&s.__wpdHtml===!0}const Jl="$$wpd$$",H=/\$\$wpd\$\$(\d+)\$\$/g,Ql="$$wpd-node$$",ec=/^\$\$wpd-node\$\$(\d+)\$\$$/,tc=new Set(["style","script","textarea","title"]);function sc(s){let e="",t=!1,o=null,i=!1,n=null,r="",a=!1;for(let l=0;l<s.length;l++){const u=s[l];e+=u;for(let h=0;h<u.length;h++){const p=u[h];if(i){u.startsWith("-->",h)&&(i=!1,h+=2);continue}if(n!==null){p==="<"&&u[h+1]==="/"&&u.slice(h+2,h+2+n.length).toLowerCase()===n&&(h+=1+n.length,n=null,t=!0,a=!1,r="");continue}if(o!==null){p===o&&(o=null);continue}if(t){p==='"'||p==="'"?(o=p,a=!1):p===">"?(t=!1,a=!1,tc.has(r)&&(n=r),r=""):a&&(/[a-zA-Z0-9-]/.test(p)?r+=p.toLowerCase():a=!1);continue}if(u.startsWith("<!--",h)){i=!0,h+=3;continue}const g=u[h+1]??"";p==="<"&&/[a-zA-Z/!]/.test(g)&&(t=!0,r="",a=/[a-zA-Z]/.test(g))}l<s.length-1&&(e+=t||i||n!==null?`${Jl}${l}$$`:`<!--${Ql}${l}$$-->`)}return e}const tr=new WeakMap;function sr(s){const e=tr.get(s);if(e)return e;const t=document.createElement("template");t.innerHTML=sc(s);const o=[],i=(a,l)=>{if(a.nodeType===Node.ELEMENT_NODE){const p=a;for(const g of Array.from(p.attributes)){const m=g.name,b=g.value,y=m[0];if(H.test(b))if(H.lastIndex=0,y==="@"){const x=H.exec(b);H.lastIndex=0,o.push({path:l,kind:"event",name:m.slice(1),valueIndex:x?Number(x[1]):0}),p.removeAttribute(m)}else if(y==="."){const x=H.exec(b);H.lastIndex=0,o.push({path:l,kind:"prop",name:m.slice(1),valueIndex:x?Number(x[1]):0}),p.removeAttribute(m)}else if(y==="?"){const x=H.exec(b);H.lastIndex=0,o.push({path:l,kind:"bool",name:m.slice(1),valueIndex:x?Number(x[1]):0}),p.removeAttribute(m)}else{const x=[],k=[];let f=0,E;for(H.lastIndex=0;(E=H.exec(b))!==null;)x.push(b.slice(f,E.index)),k.push(Number(E[1])),f=E.index+E[0].length;x.push(b.slice(f)),o.push({path:l,kind:"attr",name:m,template:x,valueIndices:k}),p.setAttribute(m,"")}}}const u=Array.from(a.childNodes);let h=0;for(let p=0;p<u.length;p++){const g=u[p],m=p+h;if(g.nodeType===Node.COMMENT_NODE){const b=ec.exec(g.data);if(b){const y=document.createTextNode("");g.parentNode.replaceChild(y,g),o.push({path:[...l,m],kind:"node",valueIndex:Number(b[1])})}continue}if(g.nodeType===Node.TEXT_NODE){const b=g.textContent||"";if(!H.test(b)){H.lastIndex=0;continue}H.lastIndex=0;const y=g.parentNode;let x=0,k;const f=[],E=[];for(H.lastIndex=0;(k=H.exec(b))!==null;){k.index>x&&f.push(document.createTextNode(b.slice(x,k.index)));const $=document.createTextNode("");f.push($),E.push({path:[...l,m+f.length-1],kind:"node",valueIndex:Number(k[1])}),x=k.index+k[0].length}x<b.length&&f.push(document.createTextNode(b.slice(x)));for(const $ of f)y.insertBefore($,g);y.removeChild(g),h+=f.length-1,o.push(...E)}else i(g,[...l,m])}};i(t.content,[]);const r={template:t,buildParts:a=>{const l=[];for(const u of o){let h=a;for(const p of u.path)h=h.childNodes[p];u.kind==="node"?l.push({kind:"node",valueIndex:u.valueIndex,child:{anchor:h,state:null}}):u.kind==="attr"?l.push({kind:"attr",element:h,name:u.name,template:u.template,valueIndices:u.valueIndices}):u.kind==="event"?l.push({kind:"event",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="prop"?l.push({kind:"prop",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="bool"&&l.push({kind:"bool",valueIndex:u.valueIndex,element:h,name:u.name})}return l}};return tr.set(s,r),r}const or=new WeakMap;function oc(s,e){for(const t of s.nodes)if(t.parentNode!==e)return!1;return!0}function xe(s,e){const t=or.get(e);if(t&&t.strings===s.strings&&oc(t,e)){cs(t.parts,s.values);return}const o=sr(s.strings),i=o.template.content.cloneNode(!0),n=o.buildParts(i),r=Array.from(i.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(i),cs(n,s.values),or.set(e,{strings:s.strings,parts:n,nodes:r})}function cs(s,e){for(const t of s)if(t.kind==="node")ds(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let o=t.template[0];for(let i=0;i<t.valueIndices.length;i++)o+=ir(e[t.valueIndices[i]]),o+=t.template[i+1];o!==t.last&&(t.last=o,o===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,o))}else if(t.kind==="event"){const o=e[t.valueIndex];o!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),o&&t.element.addEventListener(t.name,o),t.current=o)}else if(t.kind==="prop"){const o=e[t.valueIndex];o!==t.last&&(t.last=o,t.element[t.name]=o)}else if(t.kind==="bool"){const o=!!e[t.valueIndex];o!==t.last&&(t.last=o,o?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function ds(s,e){if(e==null||e===!1){s.state&&(le(s.state),s.state=null);return}if(Array.isArray(e)){ac(s,e);return}if(Yl(e)){rc(s,e);return}if(e instanceof Node){ic(s,e);return}nc(s,ir(e))}function ic(s,e){const t=s.state;t?.shape==="node"&&t.node===e||(t&&le(t),Pe(s,[e]),s.state={shape:"node",node:e})}function nc(s,e){const t=s.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&le(t);const o=document.createTextNode(e);Pe(s,[o]),s.state={shape:"text",node:o,text:e}}function rc(s,e){const t=s.state;if(t?.shape==="template"&&t.strings===e.strings){cs(t.parts,e.values);return}t&&le(t);const o=sr(e.strings),i=o.template.content.cloneNode(!0),n=o.buildParts(i),r=Array.from(i.childNodes);Pe(s,[i]),cs(n,e.values),s.state={shape:"template",strings:e.strings,parts:n,nodes:r}}function ac(s,e){const t=s.state;if(t?.shape==="array"){const i=Math.min(t.entries.length,e.length);for(let n=0;n<i;n++)ds(t.entries[n],e[n]);if(e.length<t.entries.length){for(let n=e.length;n<t.entries.length;n++){const r=t.entries[n];r.state&&le(r.state),r.anchor.remove()}t.entries.length=e.length}else for(let n=t.entries.length;n<e.length;n++){const r=document.createTextNode("");Pe(s,[r]);const a={anchor:r,state:null};ds(a,e[n]),t.entries.push(a)}return}t&&le(t);const o=[];for(const i of e){const n=document.createTextNode("");Pe(s,[n]);const r={anchor:n,state:null};ds(r,i),o.push(r)}s.state={shape:"array",entries:o}}function Pe(s,e){const t=s.anchor.parentNode;if(t)for(const o of e)t.insertBefore(o,s.anchor)}function le(s){if(s.shape==="text"){s.node.remove();return}if(s.shape==="template"){for(const e of s.parts)e.kind==="node"&&e.child.state&&(le(e.child.state),e.child.state=null);for(const e of s.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(s.shape==="node"){s.node.parentNode&&s.node.parentNode.removeChild(s.node);return}for(const e of s.entries)e.state&&le(e.state),e.anchor.remove()}function ir(s){return s==null||s===!1?"":String(s)}function lc(s,e){const t=e.local??{},o={id:s,hasLocal:r=>Object.prototype.hasOwnProperty.call(t,r),runLocal:(r,a,l,u)=>{const h=t[r];if(!h)return a;const p={...a},g=h(p,l,u);return g===void 0?p:g},render:r=>{xe(e.view(r),r.root),e.updated?.(r)},mounted:r=>e.mounted?.(r)},{placeholder:i}=e;i&&(o.placeholder=r=>i(r));const n=window;return(n.openStationApps??(n.openStationApps={}))[s]=o,o}const nr=Z("desktop-mode/settings-tab-registry",()=>({registry:new Map,listeners:new Set})),cc=nr.state.registry,rr=nr.state.listeners;function dc(){return Array.from(cc.values()).sort((s,e)=>(s.order??100)-(e.order??100))}function uc(s){return rr.add(s),()=>{rr.delete(s)}}function hc(s,e){switch(s){case"wp-blue":return d("WordPress Blue");case"indigo":return d("Indigo");case"teal":return d("Teal");case"emerald":return d("Emerald");case"amber":return d("Amber");case"rose":return d("Rose");default:return e}}function pc(s,e){switch(s){case"compact":return d("Compact");case"default":return d("Default");case"large":return d("Large");default:return e}}function gc(s,e){switch(s){case"sharp":return d("Sharp");case"default":return d("Default");case"round":return d("Round");default:return e}}function fc(s,e){switch(s){case"static":return d("Static");case"dynamic":return d("Dynamic");case"hidden":return d("Hidden");default:return e}}function bc(s,e){switch(s){case"static":return d("Static");case"dynamic":return d("Dynamic");default:return e}}function mc(s,e){switch(s){case"bottom":return d("Bottom");case"left":return d("Left");case"right":return d("Right");default:return e}}function vc(s,e){switch(s){case"classic":return d("Split");case"unified":return d("Unified");default:return e}}function _c(s){switch(s){case"classic":return d("Core admin menus are placed in a sidebar; plugins, apps, and OpenStation controls in a dock along the bottom edge.");case"unified":return d("Every menu in a single dock.");default:return""}}const wc=()=>({editor:{id:"",teardown:null},previews:null,imagePickerOpen:!1,imageSource:"",library:{query:"",page:0,totalPages:0,loaded:[],loading:!1,error:"",searchTimer:null,uploadError:"",uploading:!1,dragover:!1},themes:{error:"",busy:!1},features:{purging:!1,resetting:!1,extendedSaving:!1,extendedError:"",commentsAiSaving:!1},components:{entries:null,activeTag:"",query:"",paintedTag:""},about:null,search:{query:"",index:null},mountedTabs:new WeakMap,glyphs:new Map}),ce=s=>s.extra,S=s=>s.ui(wc),ar=s=>s.detail??{},z=s=>String(ar(s).value??""),O=s=>ar(s).checked===!0,yc="conic-gradient( #f252fc, #9af2ff, #93f0c6, #f8f2b6, #ff5a5a, #f252fc )";function xc(s){const e=s.querySelector(".os-settings__accent-picker");if(e)try{e.showPicker()}catch{e.click()}}const kc=s=>{const e=s.accent===Ce,t=i=>{const n=z(i);n!==Ce&&!Ie().some(r=>r.id===n)||(A({accent:n}),n===Ce&&xc(i.currentTarget))},o=i=>{const n=i.target.value;/^#[0-9a-fA-F]{6}$/.test(n)&&A({customAccent:n,accent:Ce})};return c`
		<os-section
			heading=${d("Accent color")}
			description=${d("Used in focused window title bars, buttons, and focus rings.")}
		>
			<os-swatch-grid label=${d("Accent color")} mode="row" @os-pick=${t}>
				${Ie().map(i=>c`<os-swatch
						value=${i.id}
						label=${hc(i.id,i.label)}
						preview=${i.value}
						size="small"
						variant="accent"
						?selected=${s.accent===i.id}
					></os-swatch>`)}
				<span class="os-settings__accent-custom">
					<os-swatch
						value=${Ce}
						label=${d("Custom")}
						preview=${e?s.customAccent:yc}
						size="small"
						variant="accent"
						?selected=${e}
					></os-swatch>
	...
	`},$c={unified:[{kind:"win",style:"left:12%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:30%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:24%;bottom:10%;width:52%;height:9%"}],classic:[{kind:"bar",rail:"sidebar",style:"left:0;top:0;bottom:0;width:5%"},{kind:"win",style:"left:14%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:32%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:33%;bottom:10%;width:38%;height:9%"}]},Ne=(s,e)=>t=>{const o=z(t);s.some(i=>i.id===o)&&e(o)},lr=()=>Ls.map(s=>c`<os-segment value=${s.id}>${bc(s.id,s.label)}</os-segment>`),Ac=s=>d(s==="dynamic"?"The dock folds into a thin line at its edge of the screen and comes back when you move the pointer there. Windows can use the whole desktop.":"The dock is always visible, and windows open above it."),Ec=s=>{const e=r=>a=>{a.target.closest(".os-settings__dock-option")||A({desktopLayout:r})},t=r=>{const a=["os-settings__layout-card"];return s.dockBehavior==="dynamic"&&a.push("is-dock-dynamic"),r==="classic"&&s.sideDockBehavior==="dynamic"&&a.push("is-sidebar-dynamic"),a.join(" ")},o=(r,a,l,u="")=>c`<div class="os-settings__dock-option">
			<span class="os-settings__dock-option-label" id=${r}>${a}</span>
			${l}
			${u?c`<span class="os-settings__dock-option-hint">${u}</span>`:""}
		</div>`,i=()=>c`<div class="os-settings__dock-options">
			${o("os-settings-dock-placement-label",d("Placement"),c`<os-segmented
					value=${s.dockPlacement}
					label=${d("Dock position")}
					@os-pick=${Ne(Ki,r=>A({dockPlacement:r}))}
				>
					${Ki.map(r=>c`<os-segment value=${r.id}>${mc(r.id,r.label)}</os-segment>`)}
				</os-segmented>`)}
		</div>`,n=()=>c`<div class="os-settings__dock-options">
			${o("os-settings-side-dock-behavior-label",d("Sidebar behavior"),c`<os-segmented
					value=${s.sideDockBehavior}
					label=${d("Sidebar behavior")}
					@os-pick=${Ne(Ls,r=>A({sideDockBehavior:r}))}
				>
					${lr()}
				</os-segmented>`)}
		</div>`;return c`
		<os-section heading=${d("Desktop layout")} description=${d("Where the menus live.")}>
			<div class="os-settings__layout-grid" role="radiogroup" aria-label=${d("Desktop layout")}>
				${Na.map(r=>{const a=s.desktopLayout===r.id;return c`<div class=${t(r.id)} @click=${e(r.id)}>
						<button
							type="button"
						...
						>
							<span class="os-settings__layout-preview" aria-hidden="true">
								${($c[r.id]??[]).map(l=>c`<span
										class="os-settings__layout-${l.kind}${l.rail?` is-accent is-${l.rail}`:""}"
										style=${l.style}
									></span>`)}
							</span>
							<span class="os-settings__layout-name">${vc(r.id,r.label)}</span>
							<span class="os-settings__layout-desc">${_c(r.id)}</span>
						</button>
						${r.id==="classic"?n():i()}
					</div>`})}
			</div>
			<div class="os-settings__dock-options os-settings__dock-options--page">
				${o("os-settings-dock-size-label",d("Dock size"),c`<os-segmented
						value=${s.dockSize}
						label=${d("Dock size")}
						@os-pick=${Ne(Vi,r=>A({dockSize:r}))}
					>
						${Vi.map(r=>c`<os-segment value=${r.id}>${pc(r.id,r.label)}</os-segment>`)}
					</os-segmented>`)}
				${o("os-settings-dock-behavior-label",d("Dock behavior"),c`<os-segmented
						value=${s.dockBehavior}
						label=${d("Dock behavior")}
						@os-pick=${Ne(Ls,r=>A({dockBehavior:r}))}
					>
						${lr()}
					</os-segmented>`,Ac(s.dockBehavior))}
			</div>
		</os-section>
	`},Sc=s=>{const e=Ps();return e.length<=1?c``:c`
		<os-section
...
`;function Rc(s,e,t){return c`
	...
	`}const ue=class ue extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(cr)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,o){if(t===o)return;const i=Lc(e);this._propValues[i]=o,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const o=(Array.isArray(e)?e:String(e).split(/\s+/)).map(i=>String(i).trim()).filter(i=>i!=="");this.className=o.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const o=cr(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(o),set:i=>{let n;i==null||i===!1?n=null:i===!0?n="":n=String(i),this._propValues[t]=n,n===null?this.removeAttribute(o):this.setAttribute(o,n),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&xe(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(o=>o.sheet).filter(o=>o!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const o of e.styles)if(!o.sheet){const i=document.createElement("style");i.textContent=o.cssText,this.shadowRoot.appendChild(i)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!ue._lightStylesAdopted.has(e)){ue._lightStylesAdopted.add(e);for(const t of e.styles){const o=document.createElement("style");o.dataset.osUi=this.tagName.toLowerCase(),o.textContent=t.cssText,document.head.appendChild(o)}}}};ue.props=[],ue.styles=[],ue.shadow=!0,ue._lightStylesAdopted=new WeakSet;let _=ue;function w(s,e){customElements.get(s)||customElements.define(s,e)}function cr(s){return s.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function Lc(s){return s.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const Tc=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function v(s,...e){let t=s[0];for(let o=1;o<s.length;o++){const i=e[o-1];if(typeof i=="string"||typeof i=="number")t+=String(i);else if(i&&i.__wpdCss)t+=i.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof i);t+=s[o]}if(Tc){const o=new CSSStyleSheet;return o.replaceSync(t),{__wpdCss:!0,sheet:o,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function Dc(s){const e=[],t=[];let o=null,i=s.parentElement;for(;i&&!(i===document.body||i===document.documentElement);){const r=i.id||"";if(r.startsWith("wp-window-")){o=r.slice(10);break}if(i.tagName.toLowerCase()==="os-tabpanel"){const a=i.getAttribute("for");a&&t.unshift(a)}i=i.parentElement}o&&e.push(to(o));for(const r of t)e.push("tab-"+to(r));const n=s.getAttribute("label");return n&&e.push(to(n)),e.length===0?"os-unnamed":"os-"+e.filter(r=>r!=="").join("-")}function to(s){return s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function Me(s){if(s.id)return s.id;const e=Dc(s);return s.id=e,e}const C=v`:host{--_holo-fill:var( --os-ui-holo-fill,${"linear-gradient( 124deg, #afa2e8 0%, #f5a8ea 46%, #8ee9f7 100% )"} );--_holo-ink:var( --os-ui-holo-ink,#0c0b0f );--_holo-sheen:var( --os-ui-holo-sheen,linear-gradient( 124deg,rgba( 159,214,255,0.1 ) 0%,rgba( 236,155,255,0.12 ) 34%,rgba( 242,82,252,0.1 ) 58%,rgba( 147,240,198,0.09 ) 100% ) );--_holo-edge:var( --os-ui-holo-edge,linear-gradient( 124deg,rgba( 154,242,255,0.7 ) 0%,rgba( 236,155,255,0.85 ) 38%,rgba( 242,82,252,0.7 ) 62%,rgba( 159,152,255,0.6 ) 100% ) );--_holo-edge-quiet:var( --os-ui-holo-edge-quiet,linear-gradient( 124deg,rgba( 154,242,255,0.22 ) 0%,rgba( 236,155,255,0.28 ) 38%,rgba( 242,82,252,0.22 ) 62%,rgba( 159,152,255,0.2 ) 100% ) );--_holo-glow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) );--_holo-glow-strong:var( --os-ui-holo-glow-strong,0 0 0 1px rgba( 242,82,252,0.42 ),0 4px 18px rgba( 242,82,252,0.38 ),0 1px 3px rgba( 12,11,15,0.6 ) );--_holo-track:var( --os-ui-holo-track,rgba( 255,251,255,0.16 ) );--_holo-track-edge:var( --os-ui-holo-track-edge,#8c8f94 );--_holo-ring-color:var( --os-ui-accent-dim,#2271b1 );--_holo-focus:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #f252fc,0 0 12px 2px rgba( 242,82,252,0.45 ) );--_holo-focus-field:var( --os-ui-focus-ring-field,0 0 0 1px #f252fc,0 0 0 4px rgba( 242,82,252,0.18 ) );--_holo-t:var( --os-ui-holo-transition,220ms );--_holo-t-fast:var( --os-ui-motion-fast,140ms );--_holo-t-slow:var( --os-ui-motion-slow,340ms );--_holo-t-ambient:var( --os-ui-motion-ambient,12s );--_holo-spring:var( --os-ui-ease-spring,cubic-bezier( 0.32,1.5,0.55,1 ) );--_holo-ease:var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) );--_holo-loop:var( --os-ui-ease-loop,cubic-bezier( 0.45,0,0.55,1 ) )}`,Pc=v` .os-holo-fill{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --_holo-ink );transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease}.os-holo-fill:hover{background-position:74% 66%}.os-holo-fill:active{background-position:88% 82%;filter:brightness( 0.94 )}@media ( prefers-reduced-motion:reduce ){.os-holo-fill{transition-duration:1ms}.os-holo-fill:hover,.os-holo-fill:active{background-position:22% 28%}}`,us=v` .os-holo-sheen{position:relative;isolation:isolate}.os-holo-sheen::before{content:'';position:absolute;inset:0;z-index:-1;border-radius:inherit;background-image:var( --_holo-sheen );background-size:200% 200%;background-position:20% 30%;opacity:0;pointer-events:none;transition:opacity var( --_holo-t ) ease,background-position var( --_holo-t ) ease}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{opacity:1;background-position:76% 68%}@media ( prefers-reduced-motion:reduce ){.os-holo-sheen::before{transition-duration:1ms}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{background-position:20% 30%}}`,dr=v` .os-holo-edge{position:relative}.os-holo-edge::after{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;background-image:var( --_holo-edge-quiet );opacity:0;pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude;transition:opacity var( --_holo-t ) ease}.os-holo-edge:hover::after,.os-holo-edge:focus-visible::after{background-image:var( --_holo-edge );opacity:1}.os-holo-edge.is-lit::after{background-image:var( --_holo-edge );opacity:1}@media ( prefers-reduced-motion:reduce ){.os-holo-edge::after{transition-duration:1ms}}`,hs=v` .os-holo-glint{position:absolute;inset:0;border-radius:inherit;overflow:hidden;pointer-events:none}.os-holo-glint::before{content:'';position:absolute;top:-60%;bottom:-60%;width:45%;inset-inline-start:-60%;background:linear-gradient( 90deg,transparent 0%,rgba( 255,251,255,0.14 ) 45%,rgba( 255,251,255,0.22 ) 50%,rgba( 255,251,255,0.14 ) 55%,transparent 100% );transform:rotate( 18deg ) translateX( 0 );opacity:0}:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:os-holo-glint var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-glint{0%{opacity:0;transform:rotate( 18deg ) translateX( 0 )}15%{opacity:1}85%{opacity:1}100%{opacity:0;transform:rotate( 18deg ) translateX( 240vw )}}@media ( prefers-reduced-motion:reduce ){:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:none}}`,so=v` .os-holo-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:0 0 0 0 var( --_holo-ring-color );opacity:0;pointer-events:none}:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:os-holo-ring var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-ring{0%{opacity:0.45;box-shadow:0 0 0 0 var( --_holo-ring-color )}100%{opacity:0;box-shadow:0 0 0 10px transparent}}@media ( prefers-reduced-motion:reduce ){:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:none}}`,ur=v` .os-holo-shimmer{background-image:var( --_holo-fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}@keyframes os-holo-shimmer{0%{background-position:0% 50%}100%{background-position:100% 50%}}@media ( prefers-reduced-motion:reduce ){.os-holo-shimmer{animation:none;background-position:30% 50%}}`,oo=v` .os-holo-enter{animation:os-holo-enter var( --_holo-t ) var( --_holo-spring )}@keyframes os-holo-enter{from{opacity:0;transform:scale( 0.96 )}}@media ( prefers-reduced-motion:reduce ){.os-holo-enter{animation:none}}`,io=v` input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):hover:not(:disabled ),select:hover:not(:disabled ),textarea:hover:not(:disabled ){border-color:var( --os-ui-border-strong,#8c8f94 )}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus,input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus-visible,select:focus,select:focus-visible,textarea:focus,textarea:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}input::placeholder,textarea::placeholder{color:var( --os-ui-fg-faint,#8c8f94 );opacity:1}input::selection,textarea::selection{background:var( --os-ui-selection-bg,rgba( 159,152,255,0.6 ) );color:var( --os-ui-selection-fg,#fffbff )}@media ( prefers-reduced-motion:reduce ){input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition-duration:1ms}}`,ps=v` input[ type='checkbox' ],input[ type='radio' ]{appearance:none;-webkit-appearance:none;position:relative;flex:0 0 auto;box-sizing:border-box;width:16px;height:16px;margin:0;padding:0;border:1px solid var( --_holo-track-edge );border-radius:4px;background-color:var( --_holo-track );background-image:none;background-repeat:no-repeat;cursor:inherit;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='radio' ]{border-radius:50%}input[ type='checkbox' ]:hover:not(:disabled ),input[ type='radio' ]:hover:not(:disabled ){border-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:focus-visible,input[ type='radio' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked,input[ type='checkbox' ]:indeterminate,input[ type='radio' ]:checked{border-color:transparent;background-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:checked:focus-visible,input[ type='radio' ]:checked:focus-visible{box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:46%;width:3.5px;height:7.5px;border:solid var( --os-ui-fg-on-accent,#fff );border-width:0 2px 2px 0;transform:translate( -50%,-50% ) rotate( 45deg );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:indeterminate::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:8px;height:2px;border:0;border-radius:1px;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% )}input[ type='radio' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:6px;height:6px;border-radius:50%;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:disabled,input[ type='radio' ]:disabled{cursor:not-allowed}@keyframes os-holo-tick{from{opacity:0;transform:translate( -50%,-50% ) rotate( 45deg ) scale( 0.4 )}}@media ( prefers-reduced-motion:reduce ){input[ type='checkbox' ]:checked::after,input[ type='radio' ]:checked::after{animation:none}}`,hr=v` @keyframes os-holo-drift{0%{background-position:16% 26%}50%{background-position:84% 74%}100%{background-position:16% 26%}}.os-holo-alive{animation:os-holo-drift var( --_holo-t-ambient ) var( --_holo-loop ) infinite}@media ( prefers-reduced-motion:reduce ){.os-holo-alive{animation:none}}`;v` ${C} ${Pc} ${us} ${dr} ${hs} ${so} ${ur} ${oo} ${io} ${ps} ${hr} `;const Nc=v` ${C}:host{display:none;position:fixed;inset:0;align-items:center;justify-content:center;background:var( --os-ui-scrim,rgba( 0,0,0,0.45 ) );background-image:var( --os-ui-scrim-image,none );background-repeat:var( --os-ui-scrim-image-repeat,repeat );background-size:var( --os-ui-scrim-image-size,auto );background-position:var( --os-ui-scrim-image-position,center );backdrop-filter:blur( 2px );z-index:10000;--os-ui-fg:var( --os-ui-modal-text,#f0f0f1 );--os-ui-fg-muted:var( --os-ui-modal-text-muted,#a7aaad );--os-ui-border:var( --os-ui-modal-border,rgba( 255,255,255,0.25 ) );--os-window-bg:var( --os-ui-modal-field-bg,#2c3338 );--os-ui-button-bg-hover:var( --os-ui-modal-button-bg-hover,rgba( 255,255,255,0.08 ) );--os-ui-surface:var( --os-ui-modal-surface,#2c3338 );--os-ui-surface-elevated:var( --os-ui-modal-surface-elevated,#3c434a );--os-ui-border-strong:var( --os-ui-modal-border-strong,rgba( 255,255,255,0.35 ) );--os-ui-hover:var( --os-ui-modal-hover,rgba( 255,255,255,0.08 ) );--os-ui-notice-color:var( --os-ui-modal-text,#f0f0f1 );--os-ui-card-bg:var( --os-ui-modal-surface,#2c3338 );--os-ui-card-fg:var( --os-ui-modal-text,#f0f0f1 );--os-ui-card-border:var( --os-ui-modal-border,rgba( 255,255,255,0.25 ) );--os-ui-card-border-hover:var( --os-ui-modal-border-strong,rgba( 255,255,255,0.35 ) )}:host( [ open ] ){display:flex;animation:os-modal-scrim var( --_holo-t ) var( --_holo-ease )}:host( [ open ] ) .dialog{animation:os-modal-dialog var( --_holo-t ) var( --_holo-spring )}@keyframes os-modal-scrim{from{opacity:0}}@keyframes os-modal-dialog{from{opacity:0;transform:scale( 0.96 ) translateY( 8px )}}@media ( prefers-reduced-motion:reduce ){:host( [ open ] ),:host( [ open ] ) .dialog{animation:none}}.dialog{max-width:92vw;max-height:90vh;background-color:var( --os-ui-modal-bg,#1d2327 );background-image:var( --os-ui-dialog-bg-image,none );background-repeat:var( --os-ui-dialog-bg-image-repeat,repeat );background-size:var( --os-ui-dialog-bg-image-size,auto );background-position:var( --os-ui-dialog-bg-image-position,center );color:var( --os-ui-modal-fg,var( --os-fg,#fff ) );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.08 ) );border-radius:10px;box-shadow:0 20px 50px rgba( 0,0,0,0.6 );display:flex;flex-direction:column;overflow:hidden}:host( [ size='sm' ] ) .dialog{width:min( 360px,92vw )}:host(:not( [ size ] ) ) .dialog,:host( [ size='md' ] ) .dialog{width:min( 540px,92vw )}:host( [ size='lg' ] ) .dialog{width:min( 760px,94vw )}.header{display:flex;align-items:center;gap:10px;padding:16px 20px 12px;border-bottom:1px solid var( --os-ui-border,rgba( 255,255,255,0.06 ) )}.title{margin:0;flex:1;font-size:15px;font-weight:600}.header-actions{display:flex;gap:6px}.header-actions::slotted( * ){margin-inline-start:6px}.close{background:transparent;border:0;color:inherit;font-size:18px;line-height:1;padding:4px 8px;border-radius:4px;cursor:pointer;opacity:0.7}.close:hover{opacity:1;background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) )}.body{padding:16px 20px;overflow:auto;flex:1 1 auto;font-size:13px;line-height:1.5}.footer{padding:12px 20px 16px;border-top:1px solid var( --os-ui-border,rgba( 255,255,255,0.06 ) )}.footer slot{display:flex;justify-content:flex-end;gap:10px;flex-wrap:wrap}:host( [ mandatory ] ) .close{display:none}`,pr='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])',Ue=class Ue extends _{constructor(){super(...arguments),this._prevFocus=null,this._onKey=e=>{if(e.key==="Escape"&&!this.hasAttribute("mandatory")){e.preventDefault(),this._cancel();return}if(e.key==="Tab"){const t=this._focusables();if(t.length===0)return;const o=t[0],i=t[t.length-1],n=this.ownerDocument,r=n?n.activeElement:null,a=e.composedPath()[0]||r;e.shiftKey&&a===o?(e.preventDefault(),i.focus()):!e.shiftKey&&a===i&&(e.preventDefault(),o.focus())}},this._onBackdrop=e=>{if(this.hasAttribute("mandatory"))return;const t=e.composedPath();(t.length>0?t[0]:e.target)===this&&this._cancel()}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","dialog"),this.setAttribute("aria-modal","true"),this.addEventListener("keydown",this._onKey),this.addEventListener("click",this._onBackdrop)}disconnectedCallback(){this.removeEventListener("keydown",this._onKey),this.removeEventListener("click",this._onBackdrop)}attributeChangedCallback(e,t,o){if(super.attributeChangedCallback?.(e,t,o),e==="open"){if(o!==null){const i=this.ownerDocument;this._prevFocus=i?i.activeElement:null,queueMicrotask(()=>this._focusFirst())}else if(this._prevFocus){try{this._prevFocus.focus()}catch{}this._prevFocus=null}}}showModal(){this.setAttribute("open","")}hideModal(){this.removeAttribute("open")}_focusables(){const e=this.shadowRoot;if(!e)return[];const t=Array.from(this.querySelectorAll(pr)),o=Array.from(e.querySelectorAll(pr));return[...t,...o].filter(i=>i.offsetParent!==null||i.tagName==="BUTTON")}_focusFirst(){const e=this._focusables();e.length>0?e[0].focus():this.shadowRoot?.querySelector(".dialog")?.focus?.()}_cancel(){const e=new CustomEvent("os-modal-cancel",{bubbles:!0,cancelable:!0,composed:!0});this.dispatchEvent(e)&&this.hideModal()}render(){const e=this.getAttribute("title")??"",t=this.hasAttribute("mandatory");return c`
		...
		`}};Ue.props=["open","title","size","mandatory"],Ue.styles=[Nc],Ue.help=void 0;let no=Ue;w("os-modal",no);const Mc=v` ${C} ${us} ${dr} ${hs} ${so} ${hr}:host{display:inline-flex}:host( [ fill-cell ] ){display:flex;width:100%}button{appearance:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:var( --os-ui-button-padding,6px 12px );border-radius:var( --os-ui-button-border-radius,6px );font:inherit;font-weight:500;cursor:pointer;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,transform 80ms ease;background:var( --os-ui-button-bg,transparent );background-image:var( --os-ui-button-bg-image,none );background-repeat:var( --os-ui-button-bg-image-repeat,repeat );background-size:var( --os-ui-button-bg-image-size,auto );background-position:var( --os-ui-button-bg-image-position,center );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ fill-cell ] ) button{width:100%;min-height:var( --os-ui-button-min-height,44px )}button:disabled{opacity:0.5;cursor:not-allowed}button:active:not(:disabled ){transform:translateY( 1px )}button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before,button:disabled::after,button:disabled .os-holo-glint{opacity:0 !important}:host( [ variant='primary' ] ) button{background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-button-fg,var( --os-ui-fg-on-accent,#fff ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 );background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --_holo-glow )}:host( [ variant='holo' ] ) button{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --os-ui-button-fg,var( --_holo-ink ) );border:var( --os-ui-button-border,1px solid transparent );box-shadow:var( --_holo-glow );font-weight:600;transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease,transform 80ms ease}:host( [ variant='holo' ] ) button:hover:not(:disabled ){background-color:transparent;background-position:74% 66%;box-shadow:var( --_holo-glow-strong )}:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:88% 82%;filter:brightness( 0.94 )}:host( [ variant='holo' ] ) button::before{display:none}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ] ) button:hover:not(:disabled ),:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:22% 28%}}:host( [ variant='secondary' ] ) button{background-color:var( --os-ui-button-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='secondary' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}:host( [ variant='danger' ] ) button{background-color:var( --os-ui-button-bg,transparent );color:var( --os-ui-button-fg,var( --os-ui-danger,#d63638 ) );border:var( --os-ui-button-border,1px solid currentColor )}:host( [ variant='danger' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-danger,#d63638 );color:var( --os-ui-fg-on-accent,#fff )}:host( [ variant='danger' ] ) button::after{display:none}:host( [ variant='link' ] ) button{background-color:transparent;background-image:none;color:var( --os-ui-button-fg,var( --wp-admin-theme-color,#2271b1 ) );border:0;padding:0;text-decoration:underline}:host( [ variant='link' ] ) button::before,:host( [ variant='link' ] ) button::after,:host( [ variant='link' ] ) .os-holo-glint,:host( [ variant='link' ] ) .os-holo-ring{display:none}:host( [ variant='link' ] ) button:active:not(:disabled ){transform:none}:host( [ busy ] ) button{pointer-events:none;opacity:0.75}:host( [ variant='holo' ][ busy ] ) button{animation:os-holo-drift 12s ease-in-out infinite}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ][ busy ] ) button{animation:none}}.os-button__spinner{box-sizing:border-box;display:inline-block;width:12px;height:12px;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:os-button-spin 0.6s linear infinite;flex-shrink:0}@keyframes os-button-spin{to{transform:rotate( 360deg )}}`,qe=class qe extends _{render(){const e=this.disabled!==null,t=this.busy!==null,o=this.type||"button";return c`
			...
			>
				${t?c`<span class="os-button__spinner" aria-hidden="true"></span>`:""}
				<slot></slot>
				<!--
		...
		`}};qe.props=["variant","disabled","type","busy","fill-cell"],qe.styles=[Mc],qe.help=void 0;let ro=qe;w("os-button",ro);function ao(s){return!!s&&typeof s=="object"&&typeof s.then=="function"}function lo(s){const{from:e,to:t,angle:o}=s.customGradient;return`linear-gradient(${o}deg, ${e}, ${t})`}function zc(s,e){Kn({id:ss,label:d("Custom gradient"),type:"css",preview:lo(s()),description:d("Mix your own two-colour gradient and set the angle — your desk, your palette."),resolveValue:()=>lo(s()),...e?{renderEditor:e}:{}})}function Oc(s){return s.replace(/[^a-zA-Z0-9._-]+/g,"-").replace(/^-+|-+$/g,"")||"wallpaper"}function Wc(s){if(!s||typeof s.id!="number"||!s.source_url)return!1;const e=s.media_details;return!!e&&typeof e.width=="number"&&typeof e.height=="number"&&e.width>0&&e.height>0}function Hc(s){if(!s)return"";const e=document.createElement("div");return e.innerHTML=s,e.textContent?.trim()||""}async function gr(s,e){try{const t=await s.json();if(t&&typeof t.message=="string")return t.message}catch{}return e}async function Uc(s,e,t,o){const i=new URL(ce(s).mediaUrl);i.searchParams.set("media_type","image"),i.searchParams.set("per_page",String(Ta)),i.searchParams.set("page",String(e)),i.searchParams.set("orderby","date"),i.searchParams.set("order","desc"),i.searchParams.set("_fields","id,source_url,alt_text,title,media_details"),t&&i.searchParams.set("search",t),o&&(i.searchParams.set("openstation_min_width",String(Is)),i.searchParams.set("openstation_min_height",String(Rs)));const n=await s.fetch(i.toString());if(!n.ok)throw new Error(await gr(n,`HTTP ${n.status}`));const r=n.headers.get("X-WP-TotalPages"),a=r?parseInt(r,10):1;return{items:(await n.json()).filter(Wc),totalPages:a||1}}async function qc(s,e){const t=await s.fetch(ce(s).mediaUrl,{method:"POST",headers:{"Content-Type":e.type,"Content-Disposition":`attachment; filename="${Oc(e.name)}"`},body:e});if(!t.ok)throw new Error(await gr(t,`Upload failed (HTTP ${t.status}).`));const o=await t.json();return{id:o.id,url:o.source_url}}function fr(s){A({customImage:s,wallpaper:ie})}async function br(s,e){const t=S(s).library,o=i=>{t.uploadError=i,s.repaint(),window.setTimeout(()=>{t.uploadError="",s.repaint()},4e3)};if(!e.type.startsWith("image/")){o(d("That file isn’t an image."));return}t.uploading=!0,s.repaint();try{fr(await qc(s,e))}catch(i){o(i instanceof Error?i.message:d("Upload failed."))}finally{t.uploading=!1,s.repaint()}}function Fc(s,e,t){return s?c`<span class="os-settings__upload-status">${d("Uploading…")}</span>`:e?c`<os-button
			variant="danger"
			class="os-settings__upload-remove"
			aria-label=${d("Remove custom image")}
			@click=${t}
		>${d("Remove")}</os-button>`:c`<div class="os-settings__upload-inner">
		<span class="os-settings__upload-plus" aria-hidden="true">+</span>
		<span class="os-settings__upload-prompt">${d("Drop an image here, or click to upload")}</span>
		<span class="os-settings__upload-hint">${d("JPEG, PNG, or WebP · goes straight to your Media Library")}</span>
	</div>`}const Vc=(s,e)=>{const t=S(e).library,o=!!s.customImage,i=["os-settings__upload-tile"];o&&i.push("os-settings__upload-tile--filled"),t.dragover&&i.push("os-settings__upload-tile--dragover"),t.uploading&&i.push("os-settings__upload-tile--busy");const n=()=>e.root.querySelector("[data-os-upload-input]"),r=h=>{h.stopPropagation(),A({customImage:null,...s.wallpaper===ie?{wallpaper:Fi()}:{}})},a=()=>{if(!t.uploading){if(s.customImage){A({wallpaper:ie});return}n()?.click()}},l=h=>{const p=h.currentTarget,g=p.files?.[0];g&&br(e,g),p.value=""},u=h=>{t.dragover!==h&&(t.dragover=h,e.repaint())};return c`
		<input
			type="file"
			accept="image/*"
		...
		<div
			class=${i.join(" ")}
			data-wallpaper-id=${ie}
			aria-pressed=${s.wallpaper===ie?"true":"false"}
			aria-label=${d(o?"Custom image wallpaper":"Upload a wallpaper image")}
			style=${o?`background-image: url("${encodeURI(s.customImage.url)}")`:""}
			@click=${a}
			@dragover=${h=>{h.preventDefault(),u(!0)}}
			@dragleave=${()=>u(!1)}
			@drop=${h=>{h.preventDefault(),u(!1);const p=h.dataTransfer?.files?.[0];p&&br(e,p)}}
		>
			${Fc(t.uploading,o,r)}
			${t.uploadError?c`<span class="os-settings__upload-error" role="status">${t.uploadError}</span>`:""}
		</div>
	`};function jc(s,e){return s.libraryHdOnly?e.filter(t=>t.media_details.width>=Is&&t.media_details.height>=Rs):e}async function co(s){const e=S(s).library;if(!(e.loading||e.totalPages>0&&e.page>=e.totalPages)){e.loading=!0,e.error="",s.repaint();try{const t=await Uc(s,e.page+1,e.query,D().libraryHdOnly);e.page+=1,e.totalPages=t.totalPages,e.loaded=e.loaded.concat(t.items)}catch(t){e.error=t instanceof Error?V(d("Couldn’t load your media: %s"),t.message):d("Couldn’t load your media.")}finally{e.loading=!1,s.repaint()}}}function mr(s){const e=S(s).library;e.page=0,e.totalPages=0,e.loaded=[],co(s)}const Bc=(s,e)=>{const t=s.wallpaper===ie&&s.customImage?.id===e.id,o=e.media_details.sizes||{},i=o.medium?.source_url||o.thumbnail?.source_url||o.large?.source_url||e.source_url,n=e.alt_text||Hc(e.title?.rendered||"")||`Image #${e.id}`;return c`<button
		type="button"
		class=${t?"os-settings__library-tile os-settings__library-tile--selected":"os-settings__library-tile"}
		data-media-id=${String(e.id)}
		aria-pressed=${t?"true":"false"}
		aria-label=${n}
		title=${n}
		style=${`background-image: url("${encodeURI(i)}")`}
		@click=${()=>fr({id:e.id,url:e.source_url})}
	>
		<span class="os-settings__library-tile-dims">${e.media_details.width}×${e.media_details.height}</span>
	</button>`},Kc=(s,e)=>{const t=S(e).library,o=jc(s,t.loaded),i=t.loaded.length-o.length,n=[V(d("Showing %d"),o.length)];s.libraryHdOnly&&i>0&&n.push(V(d("%d hidden by HD filter"),i));const r=u=>{const h=u.target.value;t.searchTimer!==null&&window.clearTimeout(t.searchTimer),t.searchTimer=window.setTimeout(()=>{t.searchTimer=null,t.query=h.trim(),mr(e)},Da)},a=u=>{A({libraryHdOnly:O(u)}),mr(e)},l=()=>t.error?c`<p class="os-settings__library-error">${t.error}</p>`:t.loading&&t.page===0?Array.from({length:8},()=>c`<div class="os-settings__library-tile os-settings__library-tile--skeleton"></div>`):o.length===0&&!t.loading?c`<p class="os-settings__library-empty">
				${s.libraryHdOnly?d("No HD images found. Try unchecking the filter, or upload a larger image."):d("No images in your Media Library yet.")}
			</p>`:o.map(u=>Bc(s,u));return c`
		<div class="os-settings__library">
			<div class="os-settings__library-toolbar">
				<input
					type="search"
					class="os-settings__library-search"
					placeholder=${d("Search your media")}
					aria-label=${d("Search media")}
					@input=${r}
				/>
				<os-checkbox-label
					label=${V(d("Only HD (≥%1$d×%2$d)"),Is,Rs)}
					?checked=${s.libraryHdOnly}
					@os-checkbox-change=${a}
				></os-checkbox-label>
			</div>
			<div class="os-settings__library-grid">${l()}</div>
			<div class="os-settings__library-footer">
				<span class="os-settings__library-meta">${n.join(" · ")}</span>
				<os-button
					variant="ghost"
					?hidden=${t.totalPages>0&&t.page>=t.totalPages}
					?disabled=${t.loading}
					@click=${()=>void co(e)}
				>${d("Load more")}</os-button>
			</div>
		</div>
	`};function vr(s){const e=S(s);return e.imageSource?e.imageSource:s.data.canUpload?"upload":"library"}function Gc(s){const e=S(s);if(!e.imagePickerOpen||vr(s)!=="library")return;const t=e.library;t.page===0&&!t.loading&&!t.error&&co(s)}const Xc=(s,e)=>{const t=e.data.canUpload,o=vr(e),i=n=>{const r=z(n);(r==="upload"||r==="library")&&(S(e).imageSource=r,e.repaint())};return c`
		<div class="os-settings__uploader">
			${t?c`<os-tabs value=${o} label=${d("Image source")} @os-tab-change=${i}>
					<os-tab value="upload">${d("Upload new")}</os-tab>
					<os-tab value="library">${d("Media Library")}</os-tab>
				</os-tabs>`:""}
			<div class="os-settings__tab-pane">
				${o==="upload"?Vc(s,e):Kc(s,e)}
			</div>
		</div>
	`},Zc="[data-os-editor-slot]";function _r(s){return{id:s,pluginUrl:"",prefersReducedMotion:typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches,visible:!document.hidden,settings:Qn(s)}}function Yc(s){const e=s.root.querySelector(Zc);if(!e)return;const t=S(s),o=D().wallpaper;if(t.editor.id===o&&e.firstElementChild)return;wr(s),t.editor.id=o;const i=document.createElement("div");i.className="os-settings__editor-slot-inner",e.textContent="",e.appendChild(i);const n=De(o);if(n?.renderEditor)try{const r=n.renderEditor(i,_r(n.id));ao(r)?r.then(a=>{t.editor.teardown=a}):t.editor.teardown=r}catch(r){console.error(`[openstation] Wallpaper "${n.id}" renderEditor threw:`,r)}}function wr(s){const e=S(s);if(e.editor.teardown)try{e.editor.teardown()}catch(t){console.error("[openstation] Wallpaper editor teardown threw:",t)}e.editor={id:"",teardown:null}}function Jc(s){s.classList.add("os-settings__gradient-editor-inner");const e=o=>{A({customGradient:{...D().customGradient,...o}}),t()},t=()=>{const{from:o,to:i,angle:n}=D().customGradient;xe(c`
				<div class="os-settings__gradient-row">
					<os-color-field
						variant="block"
						label=${d("From")}
						value=${o}
						@os-color-change=${r=>e({from:z(r)})}
					></os-color-field>
					<os-color-field
						variant="block"
						label=${d("To")}
						value=${i}
						@os-color-change=${r=>e({to:z(r)})}
					></os-color-field>
				</div>
				<os-range-field
					label=${d("Angle")}
					...
					suffix="°"
					value=${String(n)}
					@os-range-change=${r=>e({angle:Number(z(r))})}
				></os-range-field>
			`,s)};return t(),()=>{}}function yr(s){if(typeof s.renderConfig!="function")return;const e=document.createElement("os-modal");e.setAttribute("size","sm"),e.setAttribute("title",V(d("%s settings"),s.label));const t=document.createElement("div");t.className="os-settings__wallpaper-config-form",e.appendChild(t);const o=document.createElement("os-button");o.setAttribute("slot","footer"),o.setAttribute("variant","primary"),o.textContent=d("Done"),e.appendChild(o);let i=null,n=!1;const r=()=>{if(!n){n=!0;try{i?.()}catch(l){console.error(`[openstation] Wallpaper "${s.id}" config teardown threw:`,l)}i=null,e.remove()}};o.addEventListener("click",r),e.addEventListener("os-modal-cancel",r);const a={..._r(s.id),setSettings:l=>{const u=D(),h={...u.wallpaperSettings[s.id]??{},...l};A({wallpaperSettings:{...u.wallpaperSettings,[s.id]:h}}),er(s.id,h)}};document.body.appendChild(e),e.setAttribute("open","");try{const l=s.renderConfig(t,a);ao(l)?l.then(u=>{if(n){try{u()}catch{}return}i=u}):i=l}catch(l){console.error(`[openstation] Wallpaper "${s.id}" renderConfig threw:`,l),r()}}const Qc=(s,e)=>{const t=S(e),o=De(s.wallpaper),i=typeof o?.renderConfig=="function",n=typeof o?.renderEditor=="function",r=l=>{const u=De(z(l));u&&u.id!==ie&&A({wallpaper:u.id})},a=ye().filter(l=>l.id!==ie).sort((l,u)=>+(l.id===ss)-+(u.id===ss));return c`
		<os-section
			heading=${d("Wallpaper")}
			description=${d("The backdrop behind your windows. Pick a preset, mix your own gradient, or drop in an image.")}
		>
			<div class="os-settings__grid os-settings__grid--wallpapers" @os-pick=${r}>
				${a.map(l=>c`<os-swatch
						value=${l.id}
						label=${l.label}
						preview=${l.id===ss?lo(s):l.preview}
						variant="wallpaper"
						data-wallpaper-id=${l.id}
						?selected=${s.wallpaper===l.id}
					>
						<span class="os-settings__swatch-label">${l.label}</span>
					</os-swatch>`)}
				<button
					type="button"
					class="os-settings__wallpaper-add"
					aria-expanded=${t.imagePickerOpen?"true":"false"}
					@click=${()=>{t.imagePickerOpen=!t.imagePickerOpen,e.repaint()}}
				>
			...
			<div
				...
				style=${i?"margin-top:12px":""}
			>
				<div class="os-settings__wallpaper-config-slot-inner">
					${i?c`<div class="os-settings__wallpaper-config">
							<os-button variant="secondary" @click=${()=>yr(o)}>
			...
			></div>
			<div class="os-settings__image-picker-slot" data-expanded=${t.imagePickerOpen?"true":"false"}>
				<div class="os-settings__image-picker-slot-inner">${Xc(s,e)}</div>
			</div>
		</os-section>
	`},ed=s=>c`
	<os-section heading=${d("Window corners")} description=${d("How rounded the corners of windows are.")}>
		<os-segmented
			value=${s.windowRadius}
			label=${d("Window corners")}
			@os-pick=${e=>{const t=z(e);ji.some(o=>o.id===t)&&A({windowRadius:t})}}
		>
			${ji.map(e=>c`<os-segment value=${e.id}>${gc(e.id,e.label)}</os-segment>`)}
		</os-segmented>
	</os-section>
`,xr=[{value:hl,label:()=>d("Default (per reveal)")},{value:200,label:()=>d("Very fast — 200 ms")},{value:320,label:()=>d("Fast — 320 ms")},{value:460,label:()=>d("Normal — 460 ms")},{value:700,label:()=>d("Slow — 700 ms")},{value:1100,label:()=>d("Very slow — 1100 ms")}],td=[{id:"focus",label:()=>d("When a related window is focused")},{id:"always",label:()=>d("Always")},{id:"off",label:()=>d("Off")}],uo=(s,e,t,o,i)=>c`<os-select
	value=${e}
	label=${s}
	@os-pick=${n=>{const r=z(n);r!==""&&(r===t||o.some(a=>a.id===r))&&i(r)}}
>
	<os-option value=${t}>${d("None")}</os-option>
	${o.map(n=>c`<os-option value=${n.id}>${n.label}</os-option>`)}
</os-select>`,sd=s=>{const e=Ys(),t=Vs(),o=Js(),i=(n,r,a,l)=>{const u=n.find(h=>h.id===r);return r!==a&&u?.description?u.description:l};return c`
		<os-section
			heading=${d("Unfocused windows")}
			description=${i(e,s.unfocusEffect,Gs,d("Apply a visual treatment to every window except the one you are working in."))}
		>
			${uo(d("Unfocused window effect"),s.unfocusEffect,Gs,e,n=>A({unfocusEffect:n}))}
		</os-section>
		<os-section
			heading=${d("Window reveal")}
			description=${i(t,s.windowReveal,ns,d("Uncover a window’s content when it finishes loading, instead of fading it in."))}
		>
			${uo(d("Reveal style"),s.windowReveal,ns,t,n=>A({windowReveal:n}))}
			<os-select
				value=${String(s.windowRevealDuration)}
				label=${d("Reveal speed")}
				@os-pick=${n=>{const r=Number(z(n));xr.some(a=>a.value===r)&&A({windowRevealDuration:r})}}
			>
				${xr.map(n=>c`<os-option value=${String(n.value)}>${n.label()}</os-option>`)}
			</os-select>
		</os-section>
		<os-section
			heading=${d("Window links")}
			description=${i(o,s.windowLinkRenderer,Fn,d("Draw a visual tie between windows showing related content — a post and its comments or media."))}
		>
			${uo(d("Link style"),s.windowLinkRenderer,Fn,o,n=>A({windowLinkRenderer:n}))}
			<os-select
				value=${s.windowLinkVisibility}
				label=${d("Show links")}
				@os-pick=${n=>{const r=z(n);(r==="focus"||r==="always"||r==="off")&&A({windowLinkVisibility:r})}}
			>
				${td.map(n=>c`<os-option value=${n.id}>${n.label()}</os-option>`)}
			</os-select>
		</os-section>
	`},od=s=>c`
	<os-section
		heading=${d("Closing every window")}
		description=${d("⌥⌘W on macOS, Ctrl+Alt+W elsewhere, closes every open window on the desktop you are looking at. Unticked, it closes them without asking — a page holding unsaved changes still gets to raise its own prompt.")}
	>
		<os-checkbox-label
			label=${d("Ask before closing all windows")}
			?checked=${s.confirmCloseAllWindows}
			@os-checkbox-change=${e=>A({confirmCloseAllWindows:O(e)})}
		></os-checkbox-label>
	</os-section>
`,id=(s,e)=>c`
	${ed(s)}
	${sd(s)}
	${od(s)}
`,nd=typeof navigator<"u"&&/Mac|iPhone|iPad|iPod/i.test(navigator.platform||navigator.userAgent||"")?"⌘K":"Ctrl+K";let ho=!1;document.addEventListener("os-settings-save-lifecycle",s=>{if(!ho)return;const e=s.detail?.phase;e!=="saved"&&e!=="failed"||(ho=!1,e==="saved"&&Zi())});const B=(s,e,t,o,i=!1,n="")=>c`
...
`,kr=s=>c`
	<os-notice tone="warning" not-dismissible>
		...
		<a
			href=${s}
			@click=${e=>{e.preventDefault(),s&&za(s,d("Connectors"))}}
		>${d("Settings → Connectors")}</a>.
	</os-notice>
`;async function rd(s,e){const t=S(s).features;t.commentsAiSaving||(t.commentsAiSaving=!0,s.repaint(),await s.dispatch("comments-ai",{enabled:e}),t.commentsAiSaving=!1,po(s),s.repaint())}async function ad(s){const e=S(s).features;e.resetting||(e.resetting=!0,s.repaint(),await s.dispatch("reset-intros")&&document.dispatchEvent(new CustomEvent("os-intros-reset")),e.resetting=!1,s.repaint())}function po(s){const e=Ds(),t=s.data.aiAssistant;if(t&&e.aiAssistant){const o=e.aiAssistant.available!==t.available||e.aiAssistant.assistantProviderConfigured!==t.assistantProviderConfigured;Object.assign(e.aiAssistant,t),o&&document.dispatchEvent(new CustomEvent("os-ai-status-changed"))}s.data.commentsAi&&e.commentsAi&&Object.assign(e.commentsAi,s.data.commentsAi)}const ld=(s,e)=>{const{aiAssistant:t,commentsAi:o,isAdmin:i}=e.data,n=S(e).features,r=a=>{const l=Number(z(a));if([15,30,45,60].includes(l)){A({heartbeatRate:l});try{window.wp?.heartbeat?.interval?.(l>=60?"slow":"standard")}catch{}}};return c`
		<os-section
			heading=""
			description=${d("Watch the dot in the OpenStation Preferences title bar to see when a change has been saved.")}
		>
			${t?.available?B(d("AI assistant"),s.ai.enabled,a=>A({ai:{...s.ai,enabled:O(a)}}),V(d("Adds an AI mode to the %s command palette: find content and ask about your site."),nd),!t.assistantProviderConfigured,t.assistantProviderConfigured?"":kr(t.connectorsUrl)):""}
			${B(d("MIO API"),s.mioApiEnabled,a=>A({mioApiEnabled:O(a)}),d("Enables MIO and its window integrations. This is the same switch as the MIO dock button. Ask MIO also requires the AI assistant and a configured connector."))}
			${B(d("Show MIO on wallpaper"),s.mioShowOnWallpaper,a=>A({mioShowOnWallpaper:O(a)}),d("Let MIO roam the desktop. Turn this off to keep it hidden until a window opens chat or invites it to show a tip."))}
			${o?B(d("Score new comments with AI"),o.enabled,a=>void rd(e,O(a)),d("Rates incoming comments so you can triage the queue faster."),n.commentsAiSaving||!o.providerConfigured,o.providerConfigured?"":kr(t?.connectorsUrl??"")):""}
			<div class="os-features__item">
				<os-checkbox-label
					label=${d("Window links")}
					?checked=${s.windowLinksEnabled}
					@os-checkbox-change=${a=>A({windowLinksEnabled:O(a)})}
				></os-checkbox-label>
				...
				${B(d("Bring related windows to front"),s.windowLinkRaiseOnFocus,a=>A({windowLinkRaiseOnFocus:O(a)}),d("Clicking a window also surfaces its parent and children."),!s.windowLinksEnabled)}
				${B(d("Highlight related windows"),s.windowLinkHighlight,a=>A({windowLinkHighlight:O(a)}),d("Related windows get an accent outline while one of them is focused."),!s.windowLinksEnabled)}
			</div>
			${B(d("Show desktop when clicking the wallpaper"),s.showDesktopOnWallpaperClick,a=>A({showDesktopOnWallpaperClick:O(a)}),d("A click on the empty desktop minimizes every window; a second click restores them."))}
			${B(d("Show post/page status ribbon"),s.showPostStatusRibbons,a=>A({showPostStatusRibbons:O(a)}),d("Marks unpublished posts and pages with a corner ribbon on their tiles."))}
			${B(d("Enable developer mode"),s.developerModeEnabled,a=>{A({developerModeEnabled:O(a)}),ho=!0},d("Unlocks developer surfaces meant for plugin authors."))}
			${B(d("Folder sharing"),s.foldersSharingEnabled,a=>A({foldersSharingEnabled:O(a)}),d("Share desktop folders with other users or roles, with read or write access."),!1,i?c`<div class="os-features__danger-row">
						<p class="os-features__hint">${d("Removes every share and its access list. Cannot be undone.")}</p>
						<os-button
							variant="danger"
							os-action="purge-shares"
							os-confirm=${d("This drops every shares table on the site (current + legacy). All invites, accept/deny decisions, and share rows are permanently removed. Recipients lose their access until someone shares with them again. The empty tables are recreated on the next admin load so the feature keeps working — but every existing share is gone.")}
							os-confirm-title=${d("Delete folder sharing data?")}
							os-confirm-label=${d("Delete data")}
							os-confirm-danger
						>${d("Delete folder sharing data")}</os-button>
					</div>`:"")}
			<div class="os-features__item">
				<label class="os-features__select-label">
					<span class="os-features__select-title">${d("WordPress Heartbeat rate")}</span>
					<os-select value=${String(s.heartbeatRate)} @os-pick=${r}>
			...
			<div class="os-features__row">
				...
				<os-button variant="secondary" ?disabled=${n.resetting} @click=${()=>void ad(e)}>
					${n.resetting?d("Resetting…"):d("Reset what’s-new dialogs")}
				</os-button>
			</div>
		</os-section>
	`},cd=s=>{const e=(t,o,i)=>B(o,s[t]===!0,n=>A({[t]:O(n)}),i);return c`
		<os-section
		...
		>
			${e("stationHomeEnabled",d("Use Station Home as your Dashboard"),d("Opens Station Home instead of the classic WordPress Dashboard: recent work, site pulse, and quick actions in one native window. Leave off to keep the classic Dashboard, including any customizations plugins have made to it."))}
			${e("nativePostsEnabled",d("Use the native Posts window"),d("Replaces the classic Posts list with a native table window: sticky header, paginated rows, bulk actions, and a row preview."))}
			${e("nativePagesEnabled",d("Use the native Pages window"),d("The Posts table experience for Pages, with a Parent column, hierarchical sort, and edit-lock indicators."))}
			${e("nativeUsersEnabled",d("Use the native Users window"),d("A native Users list with bulk role changes, online indicators, and one-click password resets."))}
			${e("nativePluginsEnabled",d("Use the native Plugins window"),d("A native Plugins window with an Installed list, bulk actions, and a Browse gallery from the WordPress.org directory."))}
			${e("nativeCommentsEnabled",d("Use the native Comments window"),d("A native two-pane Comments window: a list of conversations beside the full reply thread."))}

		</os-section>
	`};let go=0;async function dd(s,e){const t=S(s).features;t.extendedSaving=!0,t.extendedError="",s.data.extendedOptions&&Object.assign(s.data.extendedOptions,e),s.repaint(),go++;try{const o=await s.dispatch("extended",{options:e});if(o&&s.data.extendedOptions)try{ge(U.EXTENDED_OPTIONS_CHANGED,{options:s.data.extendedOptions})}catch{}else o||(t.extendedError=d("The options could not be saved."))}finally{go--,t.extendedSaving=go>0,s.repaint()}}const ud=(s,e)=>{const t=e.data.extendedOptions;if(!t)return c``;const o=S(e).features,i=(n,r,a)=>B(r,t[n],l=>void dd(e,{...t,[n]:O(l)}),a);return c`
		<os-section
		...
		>
			${i("media_library_enhanced",d("Enable drag-and-drop in the Media Library"),d("Makes every item in the WordPress Media Library draggable. Drop a media item into text fields, rich-text editors, Gutenberg blocks, or any target that accepts images or files. No replacement of the library — just a drag-and-drop layer on top of the one you already know."))}
			${i("agents",d("Enable AI agents"),d("Adds an Agents section to WP Explorer: durable AI workers that live on the site as login-blocked users, act through the WordPress Abilities API under their own role, and answer in a chat window. Requires a configured AI connector to run. Off by default — while off, nothing agent-related loads. Agent definitions are kept across a disable and reappear when re-enabled."))}
			${i("network",d("Enable OpenStation Network"),d("Pairs this install with other OpenStation installs into one network: a Network app in the dock, a key and a registry, and a site switcher that moves between installs and logs you in on arrival. Off by default — while off, none of the network module loads, on the server or in the browser, and a multisite keeps its own site switcher. Pairings are kept across a disable and reappear when re-enabled."))}
			${i("games",d("Enable games"),d("Adds a Games app for every user: built-in games, scoreboards, and player-to-player challenges. Off by default — while off, nothing game-related runs anywhere, on the server or in the browser. Saved scores are kept across a disable and reappear when re-enabled."))}
			${i("window_prewarm",d("Preload windows on hover"),d("Starts loading a window while you hover its dock icon, so it appears sooner when you click. Enabled by default for everyone; turn off to avoid the extra memory and background requests. Takes effect after reloading OpenStation."))}
			${i("admin_asset_cache",d("Shared asset cache"),d("Shares cached admin stylesheets and scripts across windows to reduce network requests. Enabled by default for everyone; turn off to bypass the shared cache. Takes effect after reloading OpenStation."))}
			${o.extendedError?c`<p class="os-ext__error">${o.extendedError}</p>`:""}
			${o.extendedSaving?c`<p class="os-ext__saving">${d("Saving…")}</p>`:""}
		</os-section>
	`},hd=(s,e)=>c`
	${ld(s,e)}
	${cd(s)}
	${e.data.isAdmin?ud(s,e):""}
`,pd="",gd={accent:"pulse",desktopLayout:"unified",dockPlacement:"bottom"};function fd(s){if(s===pd)return Object.keys(In(gd)).length>0;const e=yl(s);return e?Object.keys(In(e.recommendedOsSettings)).length>0:!1}const gs="",$r="OpenStation";function bd(s){const e=s.trim().split(/\s+/).filter(Boolean);return e.length===0?"?":e.length>=2?(e[0][0]+e[1][0]).toUpperCase():e[0].slice(0,2).toUpperCase()}async function Ar(s,e){try{const t=await s.json();if(t&&typeof t.message=="string"&&t.message!=="")return t.message}catch{}return`${e} (HTTP ${s.status}).`}function Er(s){const e=s?.serverWallpapers;Array.isArray(e)&&ge(U.WALLPAPERS_SERVER_CHANGED,{wallpapers:e})}async function md(s,e){const t=new FormData;t.append("file",e,e.name);const o=await s.fetch(ce(s).desktopThemesUrl,{method:"POST",body:t});if(!o.ok)throw new Error(await Ar(o,"Theme upload failed"));const i=await o.json();return Er(i),i}async function vd(s,e){const t=await s.fetch(`${ce(s).desktopThemesUrl}/${encodeURIComponent(e)}`,{method:"DELETE"});if(!t.ok)throw new Error(await Ar(t,"Theme delete failed"));try{Er(await t.json())}catch{}}async function Sr(s,e){const t=S(s).themes;if(!t.busy){t.busy=!0,t.error="",s.repaint();try{Dn(await md(s,e))}catch(o){t.error=o instanceof Error?o.message:d("That theme could not be installed.")}finally{t.busy=!1,s.repaint()}}}async function _d(s,e){if(!await s.host.confirm?.({title:d("Delete this theme?"),message:V(d("“%s” will be removed from this site for everyone. This cannot be undone."),e.name),confirmLabel:d("Delete"),danger:!0}))return;const o=S(s).themes;o.error="";try{await vd(s,e.slug),kl(e.slug),D().desktopTheme===e.slug&&A({desktopTheme:gs})}catch(i){o.error=i instanceof Error?i.message:d("That theme could not be deleted.")}s.repaint()}const wd=(s,e,t,o)=>c`
	<div class="os-settings__theme-card-wrap">
		<button
			...
			@click=${()=>A({desktopTheme:e.slug})}
		>
			<span class="os-settings__theme-preview">
				${e.previewUrl?c`<img src=${e.previewUrl} alt="" aria-hidden="true" draggable="false" />`:c`<span class="os-settings__theme-initials" aria-hidden="true">${bd(e.name)}</span>`}
			</span>
			<span class="os-settings__theme-name">${e.name}</span>
			<span class="os-settings__theme-meta">
				${e.version!==""?V(d("Version %s"),e.version):""}
			</span>
		</button>
		${o&&e.source!=="code"?c`<button
				type="button"
				class="os-settings__theme-delete"
				aria-label=${V(d("Delete %s"),e.name)}
				@click=${()=>void _d(s,e)}
			>×</button>`:""}
	</div>
`,yd=s=>c`
	<div class="os-settings__theme-card-wrap">
		<button
			...
			@click=${()=>A({desktopTheme:gs})}
		>
			<span class="os-settings__theme-preview os-settings__theme-preview--system" aria-hidden="true"></span>
			<span class="os-settings__theme-name">${$r}</span>
			<span class="os-settings__theme-meta">${d("The look OpenStation ships with")}</span>
		</button>
	</div>
`,xd=s=>{const e=S(s).themes,t=o=>o.dataTransfer?.files?.[0]??o.currentTarget.files?.[0];return c`<div
		class=${e.busy?"os-settings__theme-upload os-settings__theme-upload--busy":"os-settings__theme-upload"}
		@dragover=${o=>{o.preventDefault(),o.currentTarget.classList.add("os-settings__theme-upload--dragover")}}
		@dragleave=${o=>{o.currentTarget.classList.remove("os-settings__theme-upload--dragover")}}
		@drop=${o=>{o.preventDefault(),o.currentTarget.classList.remove("os-settings__theme-upload--dragover");const i=t(o);i&&Sr(s,i)}}
	>
	...
	`},Od=v`:host{display:block;margin-block-end:36px}:host( [ hidden ] ){display:none}.os-section__heading{margin:0 0 5px;font-size:20px;font-weight:500;letter-spacing:-0.01em;color:var( --os-ui-fg,#1d2327 )}.os-section__description{margin:0 0 14px;max-width:78ch;font-size:14px;color:var( --os-ui-fg-muted,#646970 );line-height:1.55}.os-section__description:empty{display:none}:host( [ stack ] ) .os-section__body{display:flex;flex-direction:column;gap:var( --os-ui-section-gap,12px )}`,Fe=class Fe extends _{render(){const e=this.heading||"",t=this.description||"";return c`
		...
		`}_onPick(){this.emit("os-pick",{value:this.value})}};Ve.props=["value","label","selected","preview","size","variant"],Ve.styles=[Wd],Ve.help=void 0;let bo=Ve;w("os-swatch",bo);const Hd=v`:host{display:grid;grid-template-columns:repeat( var( --os-ui-swatch-grid-cols,4 ),1fr );gap:12px}:host( [ mode='row' ] ){display:flex;flex-wrap:wrap;align-items:center;gap:10px}`,je=class je extends _{render(){const e=this.label||"",t=this.columns||"";return t&&this.style.setProperty("--os-ui-swatch-grid-cols",t),this.setAttribute("role","radiogroup"),e&&this.setAttribute("aria-label",e),c`<slot></slot>`}};je.props=["label","columns","mode"],je.styles=[Hd],je.help=void 0;let mo=je;w("os-swatch-grid",mo);const Ud=v` ${C}:host{display:inline-flex;position:relative;padding:3px;background:var( --os-ui-segmented-bg,var( --os-ui-hover,rgba( 0,0,0,0.05 ) ) );border-radius:8px;gap:2px}.os-segmented__thumb{position:absolute;top:3px;bottom:3px;left:0;width:var( --_thumb-w,0px );border-radius:6px;background-color:var( --os-ui-segmented-selected-bg,var( --os-ui-accent,#2271b1 ) );background-image:var( --os-ui-segmented-selected-image,none );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;transform:translateX( var( --_thumb-x,0px ) );pointer-events:none;opacity:0}:host( [ data-thumb ] ) .os-segmented__thumb{opacity:1}:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition:transform var( --_holo-t-slow ) var( --_holo-spring ),width var( --_holo-t-slow ) var( --_holo-ease ),opacity var( --_holo-t-fast ) linear}@media ( prefers-reduced-motion:reduce ){:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition-duration:1ms}}`,qd=v` ${C} ${us}:host{flex:1 1 auto;min-width:0}button{appearance:none;display:block;width:100%;padding:6px 13px;background:transparent;border:0;font:inherit;font-size:13px;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:6px;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,background-position var( --_holo-t ) ease;white-space:nowrap}button:hover{color:var( --os-ui-fg,#1d2327 )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}:host( [ aria-checked='true' ] ) button{color:var( --os-ui-segmented-selected-fg,var( --os-ui-fg-on-accent,#fff ) );transition-duration:var( --_holo-t-fast )}:host( [ aria-checked='true' ] ) button::before{display:none}`,Be=class Be extends _{render(){return this.setAttribute("role","radio"),c`
			<button
				type="button"
				class="os-holo-sheen"
				@click=${()=>this._onPick()}
		...
		`};let yo=Xe;w("os-select",yo);const jd=v`
	:host {
		display: flex;
...
`;function Bd(){const s="os-multiselect-popover-styles";if(document.getElementById(s))return;const e=document.createElement("style");e.id=s,e.textContent=`
...
`,document.head.appendChild(e)}typeof document<"u"&&Bd();const Ze=class Ze extends _{constructor(){super(...arguments),this._optionObserver=null,this._popover=null,this._teardownOpen=null,this._hasMore=!1,this._loadingMore=!1}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const n of Array.from(t))n.remove();for(const n of e){const r=document.createElement("os-option");r.setAttribute("value",n.value),r.textContent=n.label,this.appendChild(r)}this._loadingMore=!1;const o=new Set(e.map(n=>n.value)),i=this._readValues().filter(n=>o.has(n));this._writeValueAttribute(i),this.requestUpdate(),this._refreshPopover()}get values(){return this._readValues()}set values(e){const t=Array.isArray(e)?e.map(o=>String(o)).filter(o=>o!==""):[];this._writeValueAttribute(t),this.requestUpdate(),this._refreshPopover()}get hasMore(){return this._hasMore}set hasMore(e){this._hasMore=!!e,this._refreshPopover()}get loadingMore(){return this._loadingMore}set loadingMore(e){this._loadingMore=!!e,this._refreshPopover()}appendItems(e){if(this._loadingMore=!1,!e||e.length===0){this._refreshPopover();return}const t=new Set(Array.from(this.querySelectorAll(":scope > os-option")).map(o=>o.getAttribute("value")));for(const o of e){if(t.has(o.value))continue;const i=document.createElement("os-option");i.setAttribute("value",o.value),i.textContent=o.label,this.appendChild(i)}this.requestUpdate(),this._refreshPopover()}connectedCallback(){super.connectedCallback(),Me(this),this._optionObserver=new MutationObserver(()=>{this.requestUpdate(),this._refreshPopover()}),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._closePopover()}render(){const e=this.label||"",t=this.placeholder||"All",o=this.disabled!==null;e?this.setAttribute("aria-label",e):this.removeAttribute("aria-label");const i=e||t,n=this._summarize(t),r=this._readValues().length>0,l=`${this.id||"os-unnamed"}__trigger`;return c`
		...
		`}connectedCallback(){super.connectedCallback(),getComputedStyle(this).direction==="rtl"&&this.style.setProperty("--_range-angle","270deg")}_onInput(e){const t=e.target,o=parseFloat(t.value);Number.isFinite(o)&&(this.value=String(o),this.emit("os-range-change",{value:o}))}};Je.props=["label","value","min","max","step","suffix","decimals"],Je.styles=[Gd],Je.help=void 0;let $o=Je;w("os-range-field",$o);const Nr=v` ${C} ${io}:host{--_field-size:var( --os-ui-field-font-size,13px );--_field-radius:var( --os-ui-field-radius,6px );display:flex;flex-direction:column;gap:4px;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-text-field__label{font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__label--hidden{position:absolute;width:1px;height:1px;margin:-1px;padding:0;border:0;overflow:hidden;white-space:nowrap;clip-path:inset( 50% )}.os-text-field__row{position:relative;display:flex;align-items:center;width:100%}input{appearance:none;-webkit-appearance:none;display:block;width:100%;min-width:0;box-sizing:border-box;padding:7px 10px;background:var( --os-window-bg,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:var( --_field-radius );font:inherit;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 )}.os-text-field__suffix{position:absolute;inset-inline-end:10px;top:50%;transform:translateY( -50% );pointer-events:none;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row--has-reveal input{padding-inline-end:36px}.os-text-field__row--has-clear input{padding-inline-end:36px}.os-text-field__row--has-reveal.os-text-field__row--has-clear input{padding-inline-end:68px}.os-text-field__clear{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0}.os-text-field__row--has-reveal .os-text-field__clear{inset-inline-end:34px;border-radius:0}.os-text-field__clear:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__clear:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 )}.os-text-field__clear:disabled{opacity:0.45;cursor:default}.os-text-field__reveal{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0;transition:color 0.12s ease}.os-text-field__reveal:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__reveal:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 );border-radius:0 6px 6px 0}.os-text-field__reveal:disabled{opacity:0.45;cursor:not-allowed}.os-text-field__input--masked{-webkit-text-security:disc;text-security:disc}@supports not ( ( -webkit-text-security:disc ) or ( text-security:disc ) ){.os-text-field__input--masked{font-family:text-security-disc,"password",monospace;letter-spacing:0.2em}}input:disabled{opacity:0.55;cursor:not-allowed;background:var( --os-ui-hover,rgba( 0,0,0,0.03 ) )}input[ aria-invalid='true' ],input[ aria-invalid='true' ]:hover:not(:disabled ){border-color:var( --os-ui-danger,#d63638 )}input[ aria-invalid='true' ]:focus,input[ aria-invalid='true' ]:focus-visible{border-color:var( --os-ui-danger,#d63638 );box-shadow:0 0 0 1px var( --os-ui-danger,#d63638 ),0 0 0 4px rgba( 214,54,56,0.18 )}input[ type='number' ]::-webkit-inner-spin-button,input[ type='number' ]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[ type='number' ]{-moz-appearance:textfield}`,Qe=class Qe extends _{constructor(){super(...arguments),this._revealed=!1}connectedCallback(){super.connectedCallback(),Me(this)}render(){const e=this.label||"",t=this.hideLabel!==null,o=this.value??"",i=this.placeholder||"",n=this.disabled!==null,r=this.readonly!==null,a=this.autocomplete,l=this.type||"text",u=l==="password";let h=a||"off";u&&(!a||h==="off")&&(h="new-password");const p=this.maxlength,g=this.minlength,m=this.pattern||"",b=this.name||"",y=this.suffix||"",x=this.invalid!==null,k=this.reveal!==null,f=this.clearable!==null,E=l==="password",$=E&&!(k&&this._revealed);let L;E||k&&this._revealed?L="text":L=l;const Q=["os-text-field__row",k?"os-text-field__row--has-reveal":"",f?"os-text-field__row--has-clear":""].filter(Boolean).join(" "),X=$?"os-text-field__input os-text-field__input--masked":"os-text-field__input",K=`${this.id||"os-unnamed"}__input`;return c`
			...
			<span class=${Q}>
				<input
					...
					aria-label=${e||""}
					@input=${ve=>this._onInput(ve)}
					@change=${ve=>this._onChange(ve)}
					@keydown=${ve=>this._onKeyDown(ve)}
				/>
				${y?c`<span class="os-text-field__suffix">${y}</span>`:c``}
				${f&&o!==""?this._renderClearButton(n):c``}
				${k?this._renderRevealButton(n):c``}
			</span>
		`}_renderClearButton(e){return c`
			<button
				type="button"
		...
		`}_onClear(){this.value="",this.emit("os-input-change",{value:""}),this.emit("os-input-commit",{value:""}),this.shadowRoot?.querySelector("input")?.focus()}_renderRevealButton(e){const t=this._revealed?"Hide":"Show";return c`
			<button
				type="button"
			...
			>
				${this._revealed?eu():Qd()}
			</button>
		`}_onToggleReveal(){this._revealed=!this._revealed,this.requestUpdate()}_onInput(e){const t=e.target;this.value=t.value,this.emit("os-input-change",{value:t.value})}_onChange(e){const t=e.target;this.emit("os-input-commit",{value:t.value})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target;this.emit("os-submit",{value:t.value})}}};Qe.props=["label","hideLabel","value","placeholder","disabled","readonly","autocomplete","type","maxlength","minlength","pattern","name","suffix","invalid","reveal","clearable"],Qe.styles=[Nr],Qe.help=void 0;let Ao=Qe;w("os-text-field",Ao);function Jd(){return c`
		<svg
			viewBox="0 0 16 16"
			width="14"
			height="14"
	...
	`}const et=class et extends _{connectedCallback(){super.connectedCallback(),Me(this)}render(){const e=this.label||"",t=this.value??"",o=this.placeholder||"",i=this.disabled!==null,n=this.readonly!==null,r=this.name||"",a=this.suffix||"",l=this.min,u=this.max,h=this.step||"any",p=this.invalid!==null,m=`${this.id||"os-unnamed"}__input`;return c`
			${e?c`<label
			...
			<span class="os-text-field__row">
				...
				/>
				${a?c`<span class="os-text-field__suffix">${a}</span>`:c``}
			</span>
		`}_readRange(){const e=this.min,t=this.max,o=e!==null?parseFloat(e):-1/0,i=t!==null?parseFloat(t):1/0;return{min:Number.isFinite(o)?o:-1/0,max:Number.isFinite(i)?i:1/0}}_clamp(e){const{min:t,max:o}=this._readRange();return e<t?t:e>o?o:e}_onInput(e){const t=e.target,o=parseFloat(t.value);Number.isFinite(o)&&(this.value=String(o),this.emit("os-input-change",{value:o}))}_onCommit(e){const t=e.target,o=parseFloat(t.value);if(!Number.isFinite(o))return;const i=this._clamp(o);i!==o&&(t.value=String(i),this.value=String(i)),this.emit("os-input-commit",{value:i})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target,o=parseFloat(t.value);if(!Number.isFinite(o))return;const i=this._clamp(o);i!==o&&(t.value=String(i),this.value=String(i)),this.emit("os-submit",{value:i})}}};et.props=["label","value","placeholder","disabled","readonly","name","suffix","min","max","step","invalid"],et.styles=[Nr],et.help=void 0;let Eo=et;w("os-number-field",Eo);const tu=v` ${C} ${ps}:host{display:inline-flex;align-items:center;gap:6px;font-size:13px;color:var( --os-ui-fg,#1d2327 );cursor:pointer}:host( [ disabled ] ){cursor:not-allowed;opacity:0.55}:host( [ block ] ){display:flex;cursor:default}:host( [ block ] ) label{cursor:pointer}:host( [ block ][ disabled ] ) label{cursor:not-allowed}label{display:inline-flex;align-items:center;gap:6px;cursor:inherit}.os-checkbox__label{line-height:1.3}.os-checkbox__label:empty{display:none}`,tt=class tt extends _{render(){const e=this.checked!==null,t=this.disabled!==null,o=this.label||"",i=this.value;return c`
			<label>
				<input
					type="checkbox"
					.checked=${e}
		...
		`}_onChange(e){const o=e.target.checked;o?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("os-checkbox-change",{checked:o,value:this.value})}};tt.props=["checked","value","label","disabled"],tt.styles=[tu],tt.help=void 0;let So=tt;w("os-checkbox",So);const su=v` ${C} ${ps}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg,#1d2327 );cursor:pointer;-webkit-user-select:none;user-select:none}label{display:inline-flex;align-items:center;gap:8px;cursor:pointer}:host( [ disabled ] ){opacity:0.5;cursor:not-allowed}:host( [ disabled ] ) label,:host( [ disabled ] ) input[ type='checkbox' ]{cursor:not-allowed}`,st=class st extends _{render(){const e=this.label||"",t=this.checked!==null,o=this.disabled!==null;return c`
			<label>
				<input
					type="checkbox"
					?checked=${t}
		...
		`};let Do=rt;w("os-tabs",Do);const at=class at extends _{connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0");const e=uu(this);e&&Mr(e,e.getAttribute("value"))}render(){return c`<slot></slot>`}};at.props=["for"],at.styles=[lu],at.help={title:"Tab panel",summary:'Auto-managed panel paired with a sibling <os-tabs>. Declares which tab it belongs to via `for="<tab-value>"`; the parent strip toggles `hidden` whenever the active tab changes. role="tabpanel" and tabindex="0" are set automatically.',status:"stable",props:[{name:"for",type:"string",description:"Matches the `value` of the owning <os-tab>. Panel is shown when its parent tabs strip is on that value."}],slots:[{name:"(default)",description:"Panel body content."}],example:c`
		...
		`};let Ho=ht;w("os-menu-item",Ho);const yu=v` ${C}:host{display:none;position:fixed;inset:0;align-items:center;justify-content:center;background:var( --os-ui-scrim,rgba( 0,0,0,0.45 ) );background-image:var( --os-ui-scrim-image,none );background-repeat:var( --os-ui-scrim-image-repeat,repeat );background-size:var( --os-ui-scrim-image-size,auto );background-position:var( --os-ui-scrim-image-position,center );backdrop-filter:blur( 2px );z-index:10000}:host( [ open ] ){display:flex;animation:os-confirm-scrim var( --_holo-t ) var( --_holo-ease )}:host( [ open ] ) .dialog{animation:os-confirm-dialog var( --_holo-t ) var( --_holo-spring )}@keyframes os-confirm-scrim{from{opacity:0}}@keyframes os-confirm-dialog{from{opacity:0;transform:scale( 0.96 ) translateY( 8px )}}@media ( prefers-reduced-motion:reduce ){:host( [ open ] ),:host( [ open ] ) .dialog{animation:none}}.dialog{width:min( 420px,92vw );background-color:var( --os-ui-confirm-dialog-bg,#1d2327 );background-image:var( --os-ui-dialog-bg-image,none );background-repeat:var( --os-ui-dialog-bg-image-repeat,repeat );background-size:var( --os-ui-dialog-bg-image-size,auto );background-position:var( --os-ui-dialog-bg-image-position,center );color:var( --os-ui-confirm-dialog-fg,var( --os-fg,#fff ) );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.08 ) );border-radius:10px;box-shadow:0 20px 50px rgba( 0,0,0,0.6 );padding:20px 22px 18px;display:flex;flex-direction:column;gap:10px;position:relative}.close{position:absolute;top:8px;right:10px;width:28px;height:28px;display:inline-flex;align-items:center;justify-content:center;background:transparent;border:0;border-radius:6px;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );cursor:pointer;font-size:22px;line-height:1;padding:0}.close:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) );color:inherit}.btn:focus,.close:focus{outline:none;box-shadow:var( --_holo-focus )}.dialog:focus,.dialog:focus-visible{outline:none}.title{margin:0 0 4px;font-size:16px;font-weight:600}.message{margin:0;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );line-height:1.45;white-space:pre-line}.remember{display:flex;align-items:center;gap:8px;margin-top:4px;font-size:12px;color:var( --os-ui-confirm-dialog-fg-muted,var( --os-ui-fg-muted,rgba( 255,255,255,0.7 ) ) );cursor:pointer;user-select:none}.remember__box{margin:0;accent-color:var( --os-ui-accent,#2271b1 );cursor:pointer}.remember__box:focus,.remember__box:focus-visible{outline:none;box-shadow:var( --_holo-focus )}.actions{display:flex;justify-content:flex-end;gap:8px;margin-top:6px}.btn{border:0;border-radius:6px;padding:8px 14px;font-size:13px;cursor:pointer;font-weight:500}.btn--secondary{background:var( --os-ui-hover,rgba( 255,255,255,0.08 ) );color:inherit}.btn--secondary:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.14 ) )}.btn--primary{background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.btn--primary:hover{filter:brightness( 1.08 )}.btn--danger{background:var( --os-ui-danger,#d63638 );color:var( --os-ui-fg-on-accent,#fff )}.btn--danger:hover{filter:brightness( 1.08 )}`,zr='a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])';function xu(s){let e=s?.activeElement??null;for(;e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e&&e!==s?.body?e:null}function Or(s){const e=s.composedPath(),t=e.length>0?e[0]:s.target;return t instanceof HTMLElement?t:null}function Wr(s){return s!==null&&s.matches(zr)}const pt=class pt extends _{constructor(){super(...arguments),this._prevFocus=null,this._focusTries=0,this._onKey=e=>{if(e.key==="Escape"){e.preventDefault(),this._cancel();return}if(e.key==="Tab"){this._trapTab(e);return}if(e.key==="Enter"&&!e.isComposing){if(Wr(Or(e))||this.hasAttribute("danger"))return;e.preventDefault(),this._confirm()}},this._focusInitial=()=>{if(!this.hasAttribute("open"))return;const e=this.isConnected?this._initialFocusTarget():null;if(e){e.focus();return}if(this._focusTries++<5){queueMicrotask(this._focusInitial);return}this.isConnected&&this.focus()},this._onBackdrop=e=>{const t=e.composedPath();(t.length>0?t[0]:e.target)===this&&this._cancel()},this._confirm=()=>{this.emit("os-confirm",{confirmed:!0,remember:this._remembered()}),this.removeAttribute("open")},this._cancel=()=>{this.emit("os-cancel",{confirmed:!1}),this.removeAttribute("open")}}connectedCallback(){super.connectedCallback(),this.setAttribute("role","dialog"),this.setAttribute("aria-modal","true"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","-1"),this.addEventListener("keydown",this._onKey),this.addEventListener("click",this._onBackdrop)}disconnectedCallback(){this.removeEventListener("keydown",this._onKey),this.removeEventListener("click",this._onBackdrop),this._restoreFocus()}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),e==="open"&&(o!==null?(this._prevFocus=xu(this.ownerDocument),this._focusTries=0,queueMicrotask(this._focusInitial)):this._restoreFocus())}_focusables(){const e=this.shadowRoot;return e?Array.from(e.querySelectorAll(zr)):[]}_trapTab(e){const t=this._focusables();if(t.length===0)return;const o=t[0],i=t[t.length-1],n=Or(e),r=!Wr(n);e.shiftKey&&(r||n===o)?(e.preventDefault(),i.focus()):!e.shiftKey&&(r||n===i)&&(e.preventDefault(),o.focus())}_initialFocusTarget(){const e=this.shadowRoot;if(!e)return null;const t=e.querySelector(".btn--secondary"),o=e.querySelector(".dialog");return this.hasAttribute("danger")?t??e.querySelector(".close")??o:e.querySelector(".btn--primary, .btn--danger")??t??o}_restoreFocus(){const e=this._prevFocus;this._prevFocus=null,!(!e||!e.isConnected)&&e.focus()}_remembered(){return this.shadowRoot?.querySelector(".remember__box")?.checked===!0}render(){const e=this.title??"",t=this.message??"",o=this["confirm-label"]||"Confirm",i=this["cancel-label"]||"Cancel",n=this.hasAttribute("danger"),r=this.hasAttribute("hide-cancel"),a=this.hasAttribute("dismissable"),l=this["remember-label"]??"";return c`
			<div class="dialog" tabindex="-1">
				${a?c`<button
						...
						@click=${()=>this._cancel()}
					>&times;</button>`:c``}
				${e?c`<h2 class="title">${e}</h2>`:c``}
				${t?c`<p class="message">${t}</p>`:c``}
				${l?c`<label class="remember">
						<input type="checkbox" class="remember__box" />
						<span class="remember__label">${l}</span>
					</label>`:c``}
				<div class="actions">
					${r?c``:c`<button
							type="button"
		...
		`}};pt.props=["open","title","message","confirm-label","cancel-label","danger","hide-cancel","dismissable","remember-label"],pt.styles=[yu],pt.help=void 0;let Uo=pt;w("os-confirm-dialog",Uo);const ku=v`:host{display:block;position:relative;font-size:13px}.input{width:100%;padding:8px 10px;background:var( --os-ui-input-bg,var( --os-ui-hover,rgba( 255,255,255,0.06 ) ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );border-radius:6px;font:inherit;box-sizing:border-box}.input:focus{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --os-ui-focus-ring-field,0 0 0 1px #2271b1,0 0 0 4px rgba( 34,113,177,0.18 ) )}.dropdown{background:var( --os-bg,#1d2327 );color:var( --os-fg,#fff );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.18 ) );border-radius:6px;overflow:auto;z-index:11000;box-shadow:0 12px 32px rgba( 0,0,0,0.5 )}.empty.error{color:var( --os-ui-danger-hover,#ff8080 )}.item{display:flex;align-items:center;gap:10px;padding:8px 10px;cursor:pointer;border:0;background:transparent;color:inherit;width:100%;text-align:start;font:inherit}.item:hover,.item:focus{background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );outline:none}.avatar{width:24px;height:24px;border-radius:50%;flex:0 0 auto;background:var( --os-ui-hover,rgba( 255,255,255,0.1 ) )}.name{font-weight:500}.slug{opacity:0.6;font-size:12px}.empty{padding:12px;color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,gt=class gt extends _{constructor(){super(...arguments),this._timer=null,this._abort=null,this._results=[],this._query="",this._open=!1,this._phase="idle",this._error="",this._dropdownStyle="",this._onScrollOrResize=()=>{},this._onInput=e=>{const t=e.target.value;this._query=t,this._scheduleSearch(t)},this._onFocus=()=>{if(this._results.length===0&&this._phase==="idle"){this._scheduleSearch(this._query);return}this._open=!0,this._positionDropdown(),this.requestUpdate()},this._onBlur=()=>{setTimeout(()=>{this._open=!1,this.requestUpdate()},150)},this._pick=e=>{this.emit("os-user-pick",{user:e}),this._results=[],this._open=!1,this._phase="idle",this._query="";const t=this.shadowRoot?.querySelector(".input");t&&(t.value=""),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this._onScrollOrResize=()=>{this._open&&(this._positionDropdown(),this.requestUpdate())},window.addEventListener("resize",this._onScrollOrResize),window.addEventListener("scroll",this._onScrollOrResize,!0)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),this._abort&&this._abort.abort(),window.removeEventListener("resize",this._onScrollOrResize),window.removeEventListener("scroll",this._onScrollOrResize,!0)}_endpoint(){const e=this.getAttribute("endpoint");return e||window.openStationConfig?.filesUsersSearchUrl||""}_scheduleSearch(e){this._timer&&clearTimeout(this._timer),this._phase="loading",this._open=!0,this._positionDropdown(),this.requestUpdate(),this._timer=setTimeout(()=>this._runSearch(e),200)}async _runSearch(e){const t=this._endpoint();if(!t){this._phase="error",this._error="Search endpoint is not configured.",this._results=[],this._open=!0,this.requestUpdate();return}this._abort&&this._abort.abort();const o=new AbortController;this._abort=o;const i=this.getAttribute("exclude")||"",n=t+"?q="+encodeURIComponent(e)+"&exclude="+encodeURIComponent(i);try{const r={signal:o.signal,credentials:"same-origin"},a=await Qi(n,r,{source:"desktop-mode/files-user-search",silent:!0});if(!a.ok)throw new Error(`HTTP ${a.status}`);const l=await a.json();this._results=l&&Array.isArray(l.users)?l.users:[],this._phase="ready",this._error="",this._open=!0}catch(r){if(r.name==="AbortError")return;this._results=[],this._phase="error",this._error=r.message||"Search failed.",this._open=!0}this._positionDropdown(),this.requestUpdate()}_positionDropdown(){const e=this.shadowRoot?.querySelector(".input");if(!e)return;const t=e.getBoundingClientRect(),o=t.bottom+4,i=t.left,n=t.width,a=window.innerHeight-t.bottom,l=t.top,u=Math.max(120,Math.min(280,Math.max(a,l)-16));a<200&&l>a?this._dropdownStyle=["position:fixed",`left:${i}px`,`top:${t.top-4-u}px`,`width:${n}px`,`max-height:${u}px`].join(";"):this._dropdownStyle=["position:fixed",`left:${i}px`,`top:${o}px`,`width:${n}px`,`max-height:${u}px`].join(";")}_dropdownContent(){if(this._phase==="loading")return c`<div class="empty">Searching…</div>`;if(this._phase==="error")return c`<div class="empty error">${this._error}</div>`;if(this._results.length===0){const e=this._query?"No matches.":"No users available.";return c`<div class="empty">${e}</div>`}return this._results.map(e=>c`
			...
			`)}render(){const e=this.getAttribute("placeholder")||"Search users…";return c`
			<input
				class="input"
				type="search"
				placeholder=${e}
			...
			${this._open?c`
				...
				`:c``}
		`}};gt.props=["placeholder","exclude","endpoint"],gt.styles=[ku],gt.help=void 0;let qo=gt;w("os-user-search",qo);const $u=v`:host{display:flex;flex-wrap:wrap;gap:6px;font-size:13px}.chip{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:999px;background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );cursor:pointer;font:inherit}.chip:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.12 ) )}.chip[ aria-pressed='true' ]{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.empty{color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,ft=class ft extends _{constructor(){super(...arguments),this._onToggle=e=>{const t=!this._selectedSet().has(e);this.emit("os-role-toggle",{slug:e,selected:t})}}_selectedSet(){const e=this.getAttribute("selected")||"";return new Set(e.split(",").map(t=>t.trim()).filter(t=>t!==""))}_roles(){const e=this.getAttribute("roles");if(e)try{const t=JSON.parse(e);if(Array.isArray(t))return t}catch{}return window.openStationConfig?.shareEligibleRoles||[]}render(){const e=this._roles();if(e.length===0)return c`<span class="empty">No eligible roles.</span>`;const t=this._selectedSet();return c`
			${e.map(o=>{const i=t.has(o.slug);return c`
					<button
						type="button"
						class="chip"
		...
		`}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._paintSvg())}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),queueMicrotask(()=>this._paintSvg())}_paintSvg(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector("svg"),o=e.querySelector("[data-svg-buffer]");if(t&&o){const i=o.textContent||"";t.innerHTML!==i&&(t.innerHTML=i)}}};mt.props=["variant"],mt.styles=[Su],mt.help=void 0;let jo=mt;w("os-tab-chip",jo);const Iu=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-stack-gap,12px );align-items:var( --os-ui-stack-align,stretch );padding:var( --os-ui-stack-padding,0 )}:host( [ hidden ] ){display:none}`,vt=class vt extends _{render(){const e=this.gap,t=this.align,o=this.padding,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-stack-gap",i),t&&this.style.setProperty("--os-ui-stack-align",t),o!==null&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-stack-padding",`${o}px`),c`<slot></slot>`}};vt.props=["gap","align","padding"],vt.styles=[Iu],vt.help=void 0;let Bo=vt;w("os-stack",Bo);const Ru=v`:host{display:flex;flex-direction:row;flex-wrap:wrap;gap:var( --os-ui-cluster-gap,8px );justify-content:var( --os-ui-cluster-justify,flex-start );align-items:var( --os-ui-cluster-align,center )}:host( [ hidden ] ){display:none}`,_t=class _t extends _{render(){const e=this.gap,t=this.justify,o=this.align,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-cluster-gap",i),t&&this.style.setProperty("--os-ui-cluster-justify",t),o&&this.style.setProperty("--os-ui-cluster-align",o),c`<slot></slot>`}};_t.props=["gap","justify","align"],_t.styles=[Ru],_t.help=void 0;let Ko=_t;w("os-cluster",Ko);const Lu=v`:host{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );color:inherit;line-height:1}:host( [ hidden ] ){display:none}.os-icon__glyph{font-size:var( --os-ui-icon-size,16px );width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );line-height:1;color:inherit;display:inline-flex;align-items:center;justify-content:center}.os-icon__glyph--char{font-family:dashicons;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;speak:none}.os-icon__glyph.dashicons{font-family:dashicons}`;let ms=null;function Tu(s){let e=s.trim();if(e==="")return null;(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))&&(e=e.slice(1,-1));const t=e.match(/^\\([0-9a-f]{1,6})\s?$/i);return t?String.fromCodePoint(parseInt(t[1],16)):e||null}function Ur(){const s=new Map;if(typeof document>"u")return s;const e=Array.from(document.styleSheets??[]);for(const t of e){let o=null;try{o=t.cssRules}catch{continue}if(o)for(const i of Array.from(o)){const n=i;if(!n||!n.selectorText)continue;const r=n.selectorText.match(/\.dashicons-([a-z0-9-]+)::?before/i);if(!r)continue;const a=n.style?.content;if(!a)continue;const l=Tu(a);l&&s.set(r[1],l)}}return s}function Du(s){ms||(ms=Ur());const e=s.startsWith("dashicons-")?s.slice(10):s;return ms.get(e)??null}function Pu(){ms=Ur()}let qr=!1;function Nu(){if(qr||typeof window>"u")return;qr=!0;const s=()=>{Pu()};document.readyState==="loading"&&document.addEventListener("DOMContentLoaded",s,{once:!0}),window.addEventListener("load",s,{once:!0})}Nu();const wt=class wt extends _{render(){const e=this.name||"",t=e.startsWith("dashicons-")?e.slice(10):e,o=this.size;o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-icon-size",`${o}px`);const i=Du(t);return i?c`<span
				class="os-icon__glyph os-icon__glyph--char dashicons dashicons-${t}"
				aria-hidden="true"
			>${i}</span>`:c`<span
			class="os-icon__glyph dashicons dashicons-${t}"
			aria-hidden="true"
		></span>`}};wt.props=["name","size"],wt.styles=[Lu],wt.help=void 0;let Go=wt;w("os-icon",Go);const Mu=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-body-gap,12px );padding:var( --os-ui-body-padding,16px );box-sizing:border-box;width:100%;height:100%;min-width:0;min-height:0}:host( [ scroll ] ){overflow:auto}:host( [ hidden ] ){display:none}::slotted( * ){min-width:0}`,yt=class yt extends _{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-body-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-body-padding",`${t}px`),c`<slot></slot>`}};yt.props=["gap","padding","scroll"],yt.styles=[Mu],yt.help=void 0;let Xo=yt;w("os-body",Xo);const zu=v`:host{display:flex;flex-direction:column;gap:var( --os-ui-panel-gap,12px );padding:var( --os-ui-panel-padding,16px );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );box-sizing:border-box}:host( [ hidden ] ){display:none}`,xt=class xt extends _{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-panel-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-panel-padding",`${t}px`),c`<slot></slot>`}};xt.props=["gap","padding"],xt.styles=[zu],xt.help=void 0;let Zo=xt;w("os-panel",Zo);const Ou=v`:host{display:grid;grid-template-columns:repeat( 12,minmax( 0,1fr ) );gap:var( --os-ui-row-gap,12px );row-gap:var( --os-ui-row-row-gap,var( --os-ui-row-gap,12px ) );column-gap:var( --os-ui-row-column-gap,var( --os-ui-row-gap,12px ) );width:100%;min-width:0}:host( [ hidden ] ){display:none}::slotted( [ col='1' ] ){grid-column:span 1}::slotted( [ col='2' ] ){grid-column:span 2}::slotted( [ col='3' ] ){grid-column:span 3}::slotted( [ col='4' ] ){grid-column:span 4}::slotted( [ col='5' ] ){grid-column:span 5}::slotted( [ col='6' ] ){grid-column:span 6}::slotted( [ col='7' ] ){grid-column:span 7}::slotted( [ col='8' ] ){grid-column:span 8}::slotted( [ col='9' ] ){grid-column:span 9}::slotted( [ col='10' ] ){grid-column:span 10}::slotted( [ col='11' ] ){grid-column:span 11}::slotted( [ col='12' ] ){grid-column:span 12}::slotted(:not( [ col ] ) ){grid-column:1 / -1}::slotted( * ){min-width:0}`,kt=class kt extends _{render(){const e=this.gap,t=this["column-gap"],o=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-row-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-row-column-gap",`${t}px`),o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-row-row-gap",`${o}px`),c`<slot></slot>`}};kt.props=["gap","column-gap","row-gap"],kt.styles=[Ou],kt.help=void 0;let Yo=kt;w("os-row",Yo);const Wu=v`:host{display:grid;grid-template-columns:var( --os-ui-grid-columns,1fr );grid-template-rows:var( --os-ui-grid-rows,auto );gap:var( --os-ui-grid-gap,8px );column-gap:var( --os-ui-grid-column-gap,var( --os-ui-grid-gap,8px ) );row-gap:var( --os-ui-grid-row-gap,var( --os-ui-grid-gap,8px ) )}:host( [ hidden ] ){display:none}`,$t=class $t extends _{render(){const e=this.columns,t=this.rows,o=this.gap,i=this["column-gap"],n=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-grid-columns",`repeat(${e}, minmax(0, 1fr))`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-grid-rows",`repeat(${t}, minmax(0, 1fr))`),o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-grid-gap",`${o}px`),i&&/^\d+$/.test(i)&&this.style.setProperty("--os-ui-grid-column-gap",`${i}px`),n&&/^\d+$/.test(n)&&this.style.setProperty("--os-ui-grid-row-gap",`${n}px`),c`<slot></slot>`}};$t.props=["columns","rows","gap","column-gap","row-gap"],$t.styles=[Wu],$t.help=void 0;let Jo=$t;w("os-grid",Jo);const Hu=v`:host{display:flex;align-items:center;justify-content:var( --os-ui-display-align,flex-end );width:100%;min-height:calc( var( --os-ui-display-size,28px ) * 1.4 );padding:8px 14px;box-sizing:border-box;font-size:var( --os-ui-display-size,28px );font-variant-numeric:tabular-nums;font-weight:500;letter-spacing:0.01em;color:var( --os-ui-display-fg,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-display-bg,transparent );border-radius:var( --os-ui-display-border-radius,0 );line-height:1.1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}:host( [ hidden ] ){display:none}.os-display__output{display:block;font:inherit;color:inherit;text-align:var( --os-ui-display-align,end );overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0}`,Fr={sm:"16px",md:"20px",lg:"28px",xl:"40px"},At=class At extends _{connectedCallback(){super.connectedCallback?.(),this.hasAttribute("aria-live")||this.setAttribute("aria-live","polite"),this.hasAttribute("role")||this.setAttribute("role","status")}render(){const e=this.value,t=this.size||"lg",o=this.align||"end";return this.style.setProperty("--os-ui-display-size",Fr[t]||Fr.lg),this.style.setProperty("--os-ui-display-align",o),c`
			<output part="output" class="os-display__output">
				${e??c`<slot></slot>`}
			</output>
		`}};At.props=["value","size","align"],At.styles=[Hu],At.help=void 0;let Qo=At;w("os-display",Qo);const Uu=v`:host{display:block}:host( [ hidden ] ){display:none}.os-disclosure__summary{display:flex;align-items:center;gap:8px;width:100%;padding:0;background:none;border:0;font:inherit;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer}.os-disclosure__summary:focus-visible{outline:2px solid var( --os-ui-accent,#f252fc );outline-offset:2px;border-radius:4px}.os-disclosure__heading{flex:1 1 auto;min-width:0;margin:0;font-size:20px;font-weight:500;letter-spacing:-0.01em}.os-disclosure__hint{flex:0 0 auto;font-size:13px;font-weight:400;color:var( --os-ui-fg-muted,#646970 )}.os-disclosure__marker{flex:0 0 auto;width:8px;height:8px;margin-inline-end:2px;border-inline-end:2px solid currentColor;border-block-end:2px solid currentColor;transform:rotate( -45deg );transition:transform 160ms ease;opacity:0.7}:host( [ open ] ) .os-disclosure__marker{transform:rotate( 45deg )}@media ( prefers-reduced-motion:reduce ){.os-disclosure__marker{transition:none}}.os-disclosure__body{margin-block-start:14px}.os-disclosure__body[ hidden ]{display:none}`;let qu=0;const Et=class Et extends _{constructor(){super(...arguments),this.bodyId=`os-disclosure-body-${++qu}`,this.onToggle=()=>{const e=!this.isOpen();e?this.setAttribute("open",""):this.removeAttribute("open"),this.emit("os-disclosure-toggle",{open:e})}}isOpen(){return this.hasAttribute("open")}render(){const e=this.heading||"",t=this.hint||"",o=this.isOpen();return c`
			<button
				type="button"
			...
			>
				...
				<h3 part="heading" class="os-disclosure__heading">${e}</h3>
				${t?c`<span class="os-disclosure__hint">${t}</span>`:""}
			</button>
			<div
				id=${this.bodyId}
		...
		`}};Et.props=["heading","hint","open"],Et.styles=[Uu],Et.help=void 0;let ei=Et;w("os-disclosure",ei);const Fu=v`:host{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;padding:32px 24px;text-align:center;color:var( --os-ui-empty-state-fg,var( --os-ui-fg-muted,#646970 ) )}:host( [ hidden ] ){display:none}.os-empty-state__icon{margin-bottom:4px;color:var( --os-ui-empty-state-icon-color,currentColor );opacity:0.75}.os-empty-state__heading{margin:0;font-size:14px;font-weight:600;color:var( --os-ui-fg,#1d2327 )}.os-empty-state__description{margin:0;font-size:12px;line-height:1.4;max-width:48ch}.os-empty-state__description:empty{display:none}.os-empty-state__cta{margin-top:8px}.os-empty-state__cta:empty{display:none}`,St=class St extends _{render(){const e=this.icon||"",t=this.heading||"",o=this.description||"";return c`
			${e?c`<os-icon
			...
			<slot></slot>
		`}};St.props=["icon","heading","description"],St.styles=[Fu],St.help=void 0;let ti=St;w("os-empty-state",ti);const Vu=v` ${C} ${us} ${hs} ${so}:host{display:inline-flex;user-select:none}:host( [ fill-cell ] ),:host{display:flex;width:100%}:host( [ hidden ] ){display:none}button{width:100%;min-height:var( --os-ui-key-min-height,48px );appearance:none;display:inline-flex;align-items:center;justify-content:center;padding:var( --os-ui-key-padding,8px 12px );font:inherit;font-size:var( --os-ui-key-font-size,16px );font-weight:500;cursor:pointer;border-radius:var( --os-ui-key-border-radius,8px );background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-key-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-key-border,1px solid transparent );transition:transform 0.08s ease,background-color 0.12s ease,box-shadow 0.12s ease}button:hover:not(:disabled ){background:var( --os-ui-key-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before{opacity:0 !important}:host( [ variant='primary' ] ) button{background:var( --os-ui-key-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-key-fg,var( --os-ui-fg-on-accent,#fff ) )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 )}:host( [ variant='secondary' ] ) button{background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}:host( [ variant='ghost' ] ) button{background:transparent;border:var( --os-ui-key-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ variant='danger' ] ) button{background:transparent;color:var( --os-ui-danger,#d63638 );border:1px solid currentColor}:host( .os-key--pressed ) button,button:active:not(:disabled ){transform:scale( 0.96 );box-shadow:inset 0 1px 2px rgba( 0,0,0,0.22 );background:var( --os-ui-key-bg-pressed,var( --os-ui-hover,rgba( 0,0,0,0.14 ) ) )}button:disabled{opacity:0.5;cursor:not-allowed}`,vs="os-key--pressed",Ct=class Ct extends _{constructor(){super(...arguments),this._onKeyDown=null,this._onKeyUp=null,this._keyHeldByKeyboard=!1}connectedCallback(){super.connectedCallback?.(),this._onKeyDown=e=>this.handleKeyboardDown(e),this._onKeyUp=e=>this.handleKeyboardUp(e),document.addEventListener("keydown",this._onKeyDown),document.addEventListener("keyup",this._onKeyUp)}disconnectedCallback(){this._onKeyDown&&document.removeEventListener("keydown",this._onKeyDown),this._onKeyUp&&document.removeEventListener("keyup",this._onKeyUp)}render(){const e=this.label,t=this.disabled!==null;return c`
			<button
				part="button"
				class="os-holo-sheen"
				type="button"
			...
			<div class="head" part="head">
				...
				${e.map((n,r)=>c`
						<button
							...
							aria-pressed=${o.has(n.key)?"false":"true"}
							@click=${()=>this.toggleSeries(n.key)}
						>
							<span class="swatch"></span>
							<span class="label">${n.label}</span>
							<span class="count">${t[r].toLocaleString()}</span>
						</button>
					`)}
				</div>
			</div>
		...
		`}_renderTrailing(e){return e.isOpen?this._renderEditor(e.placeholder,e.creatable):e.readonly||e.disabled?c``:this._renderTrigger(e.addLabel)}_renderChips(e,t){const o=this._value;return o.length===0?c``:c`
			<span class="os-tag-input__chips" role="list">
				${o.map((i,n)=>{const r=i.tone??"neutral";return c`
						<os-chip
							role="listitem"
							size="compact"
							tone=${r}
		...
		`}_renderTrigger(e){const t=this.disabled!==null;return c`
			<button
				type="button"
		...
		`}_renderEditor(e,t){const o=this._suggestions.length>0||this._suggestionsLoading||t&&this._query.trim().length>0;return c`
			<span class="os-tag-input__editor">
				...
				/>
				${o?this._renderSuggestions(t):c``}
			</span>
		`}_renderSuggestions(e){const t=this._query.trim(),o=this._suggestions,i=e&&t.length>0&&!o.some(n=>n.label.toLowerCase()===t.toLowerCase())&&!this._value.some(n=>n.label.toLowerCase()===t.toLowerCase());return c`
			<div
				class="os-tag-input__suggestions"
				role="listbox"
			>
				${this._suggestionsLoading?c`
							<div class="os-tag-input__suggestion-loading">
								<span class="os-tag-input__suggestion-spinner" aria-hidden="true"></span>
								<span>Searching…</span>
							</div>
					  `:c``}
				${o.length===0&&!this._suggestionsLoading&&!i?c`
							<div class="os-tag-input__suggestion-empty">
								${t.length>0?"No matches.":"Type to search."}
							</div>
					  `:c``}
				${o.map((n,r)=>{const a=r===this._highlight;return c`
						<div
							id=${`os-tag-suggestion-${r}`}
							role="option"
							aria-selected=${a?"true":"false"}
							class="os-tag-input__suggestion-item"
							@mousedown=${l=>{l.preventDefault(),this._addSuggestion(n,!1)}}
		...
		`}_onChipDismiss(e,t){e.stopPropagation(),this.emit("os-tag-remove",{tag:t})}_onInput(e){const t=e.target.value;this._query=t,this._emitSuggest(t)}_emitSuggest(e){const t=parseInt(this["min-query"]||"0",10)||0;if(e.length<t){this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate();return}this._suggestionsLoading=!0,this.requestUpdate(),this.emit("os-tag-suggest",{query:e})}_onInputKeyDown(e){const t=this.creatable!==null,o=this._suggestions,i=this._query.trim(),n=t&&i.length>0&&!o.some(a=>a.label.toLowerCase()===i.toLowerCase())&&!this._value.some(a=>a.label.toLowerCase()===i.toLowerCase()),r=o.length+(n?1:0);switch(e.key){case"ArrowDown":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight+1>=r?0:this._highlight+1,this.requestUpdate();return}case"ArrowUp":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight<=0?r-1:this._highlight-1,this.requestUpdate();return}case"Enter":{if(e.preventDefault(),this._highlight>=0&&this._highlight<o.length){this._addSuggestion(o[this._highlight],!1);return}if(this._highlight===o.length&&n){this._addSuggestion({label:i},!0);return}if(n&&i.length>0){this._addSuggestion({label:i},!0);return}return}case"Escape":{e.preventDefault(),this.closeInput();return}case"Backspace":{if(this._query===""&&this._value.length>0){e.preventDefault();const a=this._value.length-1;this._focusedChip===a?(this.emit("os-tag-remove",{tag:this._value[a]}),this._focusedChip=-1):(this._focusedChip=a,this.requestUpdate())}return}default:this._focusedChip!==-1&&(this._focusedChip=-1)}}_onInputBlur(e){queueMicrotask(()=>{this.shadowRoot?.activeElement||this.closeInput()})}_addSuggestion(e,t){if(this._value.some(i=>i.label.toLowerCase()===e.label.toLowerCase())){this._query="",this._highlight=-1,this._suggestions=[],this.requestUpdate(),this._input?.focus();return}this.emit("os-tag-add",{tag:e,isNew:t}),this._query="",this._highlight=-1,this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate(),queueMicrotask(()=>{this._input?.focus()})}};Ft.props=["label","placeholder","add-label","creatable","removable","disabled","readonly","size","min-query","open"],Ft.styles=[Ih],Ft.help=void 0;let yi=Ft;w("os-tag-input",yi);function Rh(){return P("plus",{size:14})}const Lh=v`:host{display:block;container-type:inline-size;container-name:os-form;font-size:13px;color:var( --os-ui-fg,#1d2327 )}:host( [ hidden ] ){display:none}.header{margin:0 0 18px}.header:empty{display:none}.fields{display:grid;grid-template-columns:1fr;gap:14px 16px;margin:0 0 18px}@container os-form ( min-width:480px ){.fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}}@container os-form ( min-width:760px ){:host( [ columns="3" ] ) .fields{grid-template-columns:repeat( 3,minmax( 0,1fr ) )}}:host( [ columns="1" ] ) .fields{grid-template-columns:1fr}:host( [ columns="2" ] ) .fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}::slotted( [ full-width ] ){grid-column:1 / -1}::slotted( [ slot ] ){display:contents}.error{margin:0 0 14px;padding:10px 12px;border-radius:6px;background:var( --os-ui-notice-error-bg,rgba( 179,45,46,0.10 ) );color:var( --os-ui-danger-hover,#b32d2e );font-size:13px;line-height:1.4}.error[ hidden ]{display:none}.footer{display:flex;flex-wrap:wrap;gap:8px;align-items:center;justify-content:flex-end;border-top:1px solid var( --os-ui-border,#dcdcde );padding-top:14px}:host( [ align="start" ] ) .footer{justify-content:flex-start}:host( [ align="stretch" ] ) .footer{justify-content:stretch}:host( [ align="stretch" ] ) .footer .footer-actions{flex:1 1 auto}.footer-leading,.footer-trailing{display:contents}.footer-actions{display:inline-flex;gap:8px;align-items:center;margin-inline-start:auto}:host( [ align="start" ] ) .footer-actions{margin-inline-start:0}:host( [ busy ] ){pointer-events:none}:host( [ busy ] ) .fields{opacity:0.6}:host( [ busy ] ) .footer{pointer-events:auto}.busy-spinner{display:inline-flex;width:14px;height:14px;border-radius:50%;border:2px solid currentColor;border-right-color:transparent;animation:os-form-spin 0.7s linear infinite;vertical-align:-2px;margin-inline-end:6px}@keyframes os-form-spin{to{transform:rotate( 360deg )}}@media ( prefers-reduced-motion:reduce ){.busy-spinner{animation-duration:2s}}`,Vt=class Vt extends _{constructor(){super(...arguments),this._initial=new Map,this._captured=!1,this._fieldChangeListener=null,this._enterSubmitListener=null}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._captureInitialValues()),this._fieldChangeListener=e=>this._onAnyFieldInput(e),this.addEventListener("os-input-change",this._fieldChangeListener),this.addEventListener("os-input-commit",this._fieldChangeListener),this.addEventListener("os-checkbox-change",this._fieldChangeListener),this.addEventListener("os-select-change",this._fieldChangeListener),this.addEventListener("change",this._fieldChangeListener),this._enterSubmitListener=()=>this.submit(),this.addEventListener("os-submit",this._enterSubmitListener)}disconnectedCallback(){this._fieldChangeListener&&(this.removeEventListener("os-input-change",this._fieldChangeListener),this.removeEventListener("os-input-commit",this._fieldChangeListener),this.removeEventListener("os-checkbox-change",this._fieldChangeListener),this.removeEventListener("os-select-change",this._fieldChangeListener),this.removeEventListener("change",this._fieldChangeListener),this._fieldChangeListener=null),this._enterSubmitListener&&(this.removeEventListener("os-submit",this._enterSubmitListener),this._enterSubmitListener=null)}render(){const e=this["submit-label"]||"Submit",t=this["reset-label"]||"Reset",o=this.error||"",i=this.busy!==null,r=this["show-reset"]!=="false";return c`
			...
			<slot name="error">
				${o?c`<p class="error" role="alert" part="error">${o}</p>`:c`<p class="error" role="alert" part="error" hidden></p>`}
			</slot>
			<footer class="footer" part="footer">
				...
				<span class="footer-actions">
					...
					<os-button
						...
						@click=${()=>this.submit()}
					>
						${i?c`<span class="busy-spinner" aria-hidden="true"></span>`:c``}
						${e}
					</os-button>
				</span>
		...
		`}getValues(){const e={};for(const t of this._namedFields()){const o=t.getAttribute("name");o&&(e[o]=this._readField(t))}return e}setValues(e){for(const[t,o]of Object.entries(e)){const i=this._fieldByName(t);i&&this._writeField(i,o)}}setBusy(e){e?this.setAttribute("busy",""):this.removeAttribute("busy")}setError(e){e?this.setAttribute("error",e):this.removeAttribute("error")}setFieldInvalid(e,t=!0,o=null){const i=this._fieldByName(e);i&&(t?(i.setAttribute("invalid",""),o!==null&&i.setAttribute("error",o)):(i.removeAttribute("invalid"),i.removeAttribute("error")))}clearErrors(){this.setError(null);for(const e of this._namedFields())e.removeAttribute("invalid"),e.removeAttribute("error")}reset(){this.clearErrors();for(const[e,t]of this._initial.entries()){const o=this._fieldByName(e);if(o){if(t.checked!==null){o.checked=t.checked,t.checked?o.setAttribute("checked",""):o.removeAttribute("checked");continue}this._writeField(o,t.value)}}this.dispatchEvent(new CustomEvent("os-form-reset",{bubbles:!0,composed:!0,detail:{form:this}}))}submit(){const e=[];for(const i of this._namedFields()){const n=i.getAttribute("name");if(!n||!i.hasAttribute("required"))continue;const a=this._readField(i);if(a==null||a===""||Array.isArray(a)&&a.length===0){i.setAttribute("invalid","");const u=i.getAttribute("label");e.push(u||n)}}if(e.length>0){const i=e.join(", ");this.setError(`Required: ${i}`);return}const t=this.getValues(),o=new CustomEvent("os-form-submit",{bubbles:!0,composed:!0,cancelable:!0,detail:{values:t,form:this}});this.dispatchEvent(o)}_captureInitialValues(){if(this._captured)return;const e=this._namedFields();if(e.length!==0){for(const t of e){const o=t.getAttribute("name");if(!o)continue;const i=t.tagName==="OS-CHECKBOX"||t.tagName==="OS-CHECKBOX-LABEL"||t.tagName==="INPUT"&&t.type==="checkbox";this._initial.set(o,{value:this._readField(t),checked:i?!!t.checked:null})}this._captured=!0}}_namedFields(){return Array.from(this.querySelectorAll("[name]"))}_fieldByName(e){const t=typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/["\\]/g,"\\$&");return this.querySelector(`[name="${t}"]`)}_readField(e){const t=e.tagName.toUpperCase();return t==="OS-CHECKBOX"||t==="OS-CHECKBOX-LABEL"||t==="INPUT"&&e.type==="checkbox"?typeof e.checked=="boolean"?e.checked:e.hasAttribute("checked"):e.value!==void 0&&e.value!==null?e.value:e.getAttribute("value")??""}_writeField(e,t){const o=e.tagName.toUpperCase();if(o==="OS-CHECKBOX"||o==="OS-CHECKBOX-LABEL"||o==="INPUT"&&e.type==="checkbox"){const r=!!t;e.checked=r,r?e.setAttribute("checked",""):e.removeAttribute("checked");return}const n=t==null?"":String(t);e.value=n,e.setAttribute("value",n)}_onAnyFieldInput(e){const t=e.target;if(!t)return;const o=t.getAttribute?.("name");o&&(this.dispatchEvent(new CustomEvent("os-form-input",{bubbles:!0,composed:!0,detail:{name:o,value:this._readField(t),form:this}})),t.hasAttribute("invalid")&&t.removeAttribute("invalid"))}};Vt.props=["submit-label","reset-label","error","busy","columns","min-column","show-reset","align"],Vt.styles=[Lh],Vt.help=void 0;let xi=Vt;w("os-form",xi);const Th=v`:host{display:inline-flex;align-items:center;gap:6px;font-size:var( --os-ui-save-status-font-size,11px );line-height:1;color:var( --os-ui-save-status-fg,currentColor );vertical-align:middle;min-width:0;opacity:1;pointer-events:auto}.os-save-status__indicator{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-save-status-size,12px );height:var( --os-ui-save-status-size,12px );border-radius:50%;flex-shrink:0;box-sizing:border-box;background:var( --os-ui-save-status-bg,transparent );border:2px solid var( --os-ui-save-status-idle-color,color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 55%,transparent ) );color:var( --wp-admin-theme-color,#2271b1 );transition:background-color 0.2s ease,border-color 0.2s ease,box-shadow 0.2s ease}:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-pulse 1.2s ease-in-out infinite}:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-modem-stutter 1.8s ease-in-out infinite,os-save-status-modem-glow 2.4s ease-in-out infinite}@keyframes os-save-status-modem-stutter{0%,4%{opacity:1}5%,30%{opacity:0.22}31%,36%{opacity:1}37%,39%{opacity:0.22}40%,44%{opacity:1}45%,67%{opacity:0.22}68%,76%{opacity:1}77%,100%{opacity:0.22}}@keyframes os-save-status-modem-glow{0%,12%{box-shadow:0 0 0 0 transparent}13%,22%{box-shadow:0 0 4px 0 currentColor}23%,50%{box-shadow:0 0 0 0 transparent}51%,58%{box-shadow:0 0 4px 0 currentColor}59%,84%{box-shadow:0 0 0 0 transparent}85%,94%{box-shadow:0 0 5px 0 currentColor}95%,100%{box-shadow:0 0 0 0 transparent}}@media ( prefers-reduced-motion:reduce ){:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{animation:none;opacity:0.85}}:host( [ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) );border-color:transparent;color:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ phase='failed' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );border-color:transparent;color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-pulse 0.8s ease-in-out 2}:host( [ variant='ring' ] ) .os-save-status__indicator{background:transparent}:host( [ variant='ring' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ variant='ring' ][ phase='saving' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-ring-color,var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) ) );animation:os-save-status-ring-pulse 1.6s var( --os-ui-ease-loop,ease-in-out ) infinite}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-ring-alert 0.62s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) )}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;animation:os-save-status-ring-land 0.42s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__glyph,:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{animation:os-save-status-glyph-in 0.24s var( --os-ui-ease-out,ease-out ) 0.08s 1 backwards}@keyframes os-save-status-ring-pulse{0%,100%{opacity:0.45;scale:0.9}50%{opacity:1;scale:1}}@keyframes os-save-status-ring-land{0%{scale:0.82}55%{scale:1.06}100%{scale:1}}@keyframes os-save-status-ring-alert{0%{scale:0.9}25%{scale:1.08}50%{scale:0.98}75%{scale:1.04}100%{scale:1}}@keyframes os-save-status-glyph-in{0%{opacity:0;scale:0.4}100%{opacity:1;scale:1}}@media ( prefers-reduced-motion:reduce ){:host( [ variant='ring' ] ) .os-save-status__indicator,:host( [ variant='ring' ] ) .os-save-status__glyph{animation:none;opacity:1;scale:1}}@keyframes os-save-status-pulse{0%,100%{opacity:0.55;transform:scale( 0.9 )}50%{opacity:1;transform:scale( 1 )}}:host( [ mode='pill' ] ) .os-save-status{display:inline-flex;align-items:center;gap:6px;padding:2px 10px;border-radius:999px;background:var( --os-ui-save-status-pill-bg,transparent );font-weight:500;white-space:nowrap}:host( [ mode='pill' ][ phase='saving' ] ) .os-save-status,:host( [ mode='pill' ][ phase='pending' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-fg-muted,#50575e ) )}:host( [ mode='pill' ][ phase='saved' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 30,132,73,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ mode='pill' ][ phase='failed' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 214,54,56,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-danger-hover,#a02622 ) )}.os-save-status__label{min-width:0;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}:host( [ phase='saved' ] ) .os-save-status__glyph,:host( [ phase='failed' ] ) .os-save-status__glyph{display:inline-block;color:var( --os-ui-fg-on-accent,#fff );width:calc( var( --os-ui-save-status-size,12px ) * 0.66 );height:calc( var( --os-ui-save-status-size,12px ) * 0.66 )}.os-save-status__glyph{display:none}.os-save-status__glyph svg{display:block;width:100%;height:100%}`,sa="os-settings-save-lifecycle",Dh=2200,Ph=6e3,jt=class jt extends _{constructor(){super(...arguments),this._autoTimer=null,this._docListener=null}connectedCallback(){super.connectedCallback(),this.auto!==null&&this._installAutoListener()}disconnectedCallback(){this._removeAutoListener(),this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null)}attributeChangedCallback(e,t,o){if(super.attributeChangedCallback(e,t,o),(e==="auto"||e==="event")&&(this._removeAutoListener(),this.auto!==null&&this._installAutoListener()),e==="phase"){this._scheduleAutoClear();const i={phase:this.phase??"idle",error:this.error??void 0};this.emit("os-save-status-change",i)}}render(){const e=this.phase??"idle",t=this.mode??"dot",i=(this.error??"")||this._labelForPhase(e);return i?this.setAttribute("title",i):this.removeAttribute("title"),this.setAttribute("aria-live",e==="failed"?"assertive":"polite"),this.setAttribute("role",e==="failed"?"alert":"status"),c`
			<span class="os-save-status">
				...
				${t==="pill"?c`<span class="os-save-status__label"
							>${this._labelForPhase(e)}</span
					  >`:c``}
			</span>
		`}_renderGlyph(e){return e==="saved"?Nh():e==="failed"?Mh():""}_labelForPhase(e){switch(e){case"pending":case"saving":return this["saving-label"]??"Saving…";case"saved":return this["saved-label"]??"Saved";case"failed":return(this.error??"")||"Couldn’t save";default:return this["idle-label"]??""}}_installAutoListener(){const e=this.event||sa;this._docListener=t=>{const o=t.detail;!o||typeof o.phase!="string"||(this.phase=o.phase,o.error?this.error=o.error:o.phase!=="failed"&&this.error&&this.removeAttribute("error"))},document.addEventListener(e,this._docListener)}_removeAutoListener(){if(!this._docListener)return;const e=this.event||sa;document.removeEventListener(e,this._docListener),this._docListener=null}_scheduleAutoClear(){this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null);const e=this.phase??"idle",t=this._autoClearMsFor(e);t<=0||(this._autoTimer=window.setTimeout(()=>{this._autoTimer=null,this.phase="idle"},t))}_autoClearMsFor(e){if(e==="saved"){const t=this["auto-clear-saved-ms"];return parseInt(t||"",10)||Dh}if(e==="failed"){const t=this["auto-clear-failed-ms"];return parseInt(t||"",10)||Ph}return 0}};jt.props=["phase","mode","variant","animation","auto","event","error","saving-label","saved-label","idle-label","auto-clear-saved-ms","auto-clear-failed-ms"],jt.styles=[Th],jt.help=void 0;let ki=jt;w("os-save-status",ki);function Nh(){return c`
		<svg
			viewBox="0 0 12 12"
			aria-hidden="true"
			focusable="false"
	...
	`}const zh=v`:host{display:flex;width:100%;min-width:0;max-width:100%;align-items:stretch}.os-cat{display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:var( --os-ui-cat-padding,2px );min-height:24px;max-width:100%;width:100%}.os-cat__chips{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-cat-gap,4px );min-width:0}.os-cat__chains{display:flex;flex-wrap:wrap;gap:4px;min-width:0}.os-cat__viz-host{display:flex;align-items:center;gap:4px;min-width:0;flex:1 1 auto;max-width:100%;min-height:28px;cursor:pointer;position:relative}.os-cat__viz-svg{display:block;width:100%;max-width:100%;min-width:0;overflow:visible;flex:1 1 auto}.os-cat__viz-svg .os-cat-edge{fill:none;stroke:var( --os-ui-cat-edge-color,currentColor );stroke-width:1.25;stroke-linecap:round;opacity:0.55;transition:stroke-width 0.18s ease,opacity 0.18s ease}.os-cat__viz-svg .os-cat-edge[ data-active='true' ]{stroke-width:2;opacity:1}.os-cat__viz-svg .os-cat-node{cursor:pointer;transition:r 0.2s cubic-bezier( 0.34,1.56,0.64,1 ),fill 0.18s ease,stroke-width 0.18s ease,filter 0.18s ease}.os-cat__viz-svg .os-cat-node[ data-selected='true' ]{filter:drop-shadow( 0 0 6px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.18 ) ) )}.os-cat__viz-svg .os-cat-node:hover,.os-cat__viz-svg .os-cat-node:focus-visible{filter:drop-shadow( 0 0 8px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.3 ) ) );outline:none}.os-cat__viz-svg .os-cat-label{font-family:var( --os-ui-font,system-ui,sans-serif );font-size:10.5px;fill:var( --os-ui-cat-label-fg,var( --os-ui-fg,#1d2327 ) );font-weight:500;pointer-events:none;user-select:none}.os-cat__viz-svg .os-cat-label[ data-selected='false' ]{fill:var( --os-ui-cat-label-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-weight:400;font-style:italic}.os-cat__trigger{appearance:none;display:inline-flex;align-items:center;gap:4px;padding:1px 8px;min-height:22px;font:inherit;font-size:11px;font-weight:500;line-height:1;color:var( --os-ui-cat-trigger-fg,var( --os-ui-fg-muted,#50575e ) );background:transparent;border:1px dashed var( --os-ui-cat-trigger-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease,border-color 0.12s ease}.os-cat__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) );color:var( --os-ui-cat-trigger-fg-hover,var( --os-ui-fg,#1d2327 ) );border-color:var( --os-ui-cat-trigger-border-hover,var( --os-ui-border-strong,#8c8f94 ) )}.os-cat__trigger:focus-visible{outline:none;border-style:solid;box-shadow:0 0 0 2px var( --wp-admin-theme-color,#2271b1 )}.os-cat__trigger svg{display:block}.os-cat__uncategorized{display:inline-flex;align-items:center;gap:4px;padding:1px 10px;min-height:22px;font-size:11px;font-weight:500;line-height:1.6;color:var( --os-ui-cat-uncat-fg,var( --os-ui-fg-muted,#8c8f94 ) );background:transparent;border:1px dashed var( --os-ui-cat-uncat-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;font-style:italic}.os-cat__popover{position:fixed;top:0;left:0;min-width:280px;max-width:360px;max-height:360px;display:flex;flex-direction:column;background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-cat-pop-fg,var( --os-ui-fg,#1d2327 ) );border:1px solid var( --os-ui-cat-pop-border,var( --os-ui-border,#c3c4c7 ) );border-radius:8px;box-shadow:0 6px 16px rgba( 0,0,0,0.08 ),0 1px 2px rgba( 0,0,0,0.06 );z-index:1000}.os-cat__editor{position:relative;display:inline-flex;align-items:center}.os-cat__search{appearance:none;font:inherit;font-size:13px;padding:8px 12px;border:0;border-bottom:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );background:transparent;color:inherit;outline:none}.os-cat__search:focus{border-bottom-color:var( --wp-admin-theme-color,#2271b1 )}.os-cat__tree{flex:1 1 auto;min-height:0;overflow-y:auto;padding:4px 0}.os-cat__row-block{display:contents}.os-cat__row{display:flex;align-items:center;gap:6px;padding:4px 8px 4px var( --os-ui-cat-row-indent,12px );cursor:pointer;user-select:none;font-size:13px;line-height:1.4;position:relative}.os-cat__row:hover,.os-cat__row[ data-focused='true' ]{background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) )}.os-cat__row[ data-selected='true' ]{color:var( --wp-admin-theme-color,#2271b1 );font-weight:600}.os-cat__row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__expander{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;border:0;background:transparent;color:inherit;cursor:pointer;flex-shrink:0;opacity:0.65}.os-cat__expander:hover{opacity:1}.os-cat__expander svg{display:block;transition:transform 0.12s ease}.os-cat__row[ data-expanded='true' ] .os-cat__expander svg{transform:rotate( 90deg )}.os-cat__expander--placeholder{visibility:hidden}.os-cat__create-row{display:flex;align-items:center;padding:2px 8px 2px var( --os-ui-cat-row-indent,28px );position:relative}.os-cat__create-row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__create-wrap{display:inline-flex;align-items:center;flex:1 1 auto;min-width:0;gap:4px;padding:1px 1px 1px 0;border:1px solid transparent;border-radius:6px;background:transparent;transition:border-color 0.12s ease,background-color 0.12s ease,box-shadow 0.12s ease}.os-cat__create-wrap:hover{border-color:var( --os-ui-border,rgba( 0,0,0,0.12 ) );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) )}.os-cat__create-wrap:focus-within{border-color:var( --wp-admin-theme-color,#2271b1 );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );box-shadow:0 0 0 2px color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 15%,transparent )}.os-cat__create-input{flex:1 1 auto;min-width:0;appearance:none;font:inherit;font-size:var( --os-ui-field-font-size-compact,12px );padding:3px 6px;border:0;background:transparent;color:inherit;outline:none}.os-cat__create-input::placeholder{color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-style:italic;opacity:1}.os-cat__create-submit{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;flex-shrink:0;padding:0;border:0;border-radius:4px;background:transparent;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease}.os-cat__create-wrap:focus-within .os-cat__create-submit:not( [ disabled ] ){background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__create-submit:hover:not( [ disabled ] ){filter:brightness( 1.05 )}.os-cat__create-submit[ disabled ]{cursor:default;opacity:0.5}.os-cat__create-submit svg{display:block}.os-cat__create-spinner{display:inline-block;width:12px;height:12px;margin:0 4px;border-radius:50%;border:2px solid var( --wp-admin-theme-color,#2271b1 );border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;flex-shrink:0}.os-cat__check{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;border:1.5px solid var( --os-ui-cat-check-border,var( --os-ui-border,#8c8f94 ) );border-radius:3px;color:transparent;transition:background-color 0.12s ease,border-color 0.12s ease,color 0.12s ease}.os-cat__row[ data-selected='true' ] .os-cat__check{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__check svg{display:block;width:14px;height:14px}.os-cat__label{min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-cat__delete{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:18px;height:18px;border:0;border-radius:50%;padding:0;background:transparent;color:var( --os-ui-cat-delete-color,var( --os-ui-danger,#d63638 ) );cursor:pointer;opacity:0;transition:opacity 0.12s ease,background-color 0.12s ease}.os-cat__row:hover .os-cat__delete,.os-cat__row[ data-focused='true' ] .os-cat__delete,.os-cat__delete:focus-visible{opacity:1}.os-cat__delete:hover,.os-cat__delete:focus-visible{background:var( --os-ui-badge-danger-bg,rgba( 214,54,56,0.12 ) )}.os-cat__delete svg{display:block;width:14px;height:14px}.os-cat__match{background:var( --os-ui-search-highlight-bg,rgba( 252,211,77,0.45 ) );border-radius:2px;padding:0 1px}.os-cat__empty,.os-cat__loading{padding:12px;font-size:12px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );text-align:center}.os-cat__loading-spinner{display:inline-block;width:12px;height:12px;border-radius:50%;border:2px solid currentColor;border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;margin-inline-end:8px;vertical-align:middle}@keyframes os-cat-spin{to{transform:rotate( 360deg )}}.os-cat__footer{padding:8px 12px;font-size:11px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );border-top:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );border-radius:10px;background:var( --os-ui-cat-pop-footer-bg,var( --os-ui-surface,#fafafb ) );display:flex;align-items:center;gap:6px;line-height:1.4}.os-cat__footer .dashicons{font-size:14px;width:14px;height:14px;flex-shrink:0}:host( [ disabled ] ) .os-cat{opacity:0.6;pointer-events:none}`,J="10px",Oh=v`:host{display:inline-flex;max-width:100%;align-items:center;min-width:0;font-family:var( --os-ui-font,system-ui,sans-serif );font-size:12px;line-height:1;font-weight:500}.os-crumb-chain{display:inline-flex;flex-wrap:nowrap;align-items:stretch;max-width:100%;min-width:0;min-height:22px;border-radius:999px;overflow:hidden;filter:drop-shadow( 0 1px 1px rgba( 0,0,0,0.06 ) )}.os-crumb{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:22px;padding:2px 12px;background:var( --os-ui-crumb-bg,var( --os-ui-surface,#c3c4c7 ) );color:var( --os-ui-crumb-fg,var( --os-ui-fg,#1d2327 ) );text-align:center;min-width:0;max-width:100%;flex-shrink:1;font-size:12px;font-weight:500;letter-spacing:0.01em;white-space:nowrap;cursor:grab;transition:filter 0.15s ease,transform 0.15s ease,background-color 0.12s ease}.os-crumb:active{cursor:grabbing}.os-crumb:hover{filter:brightness( 1.06 )}.os-crumb__remove{cursor:pointer}.os-crumb--first{padding-inline-end:22px;clip-path:polygon( 0 0,calc( 100% - ${J} ) 0,100% 50%,calc( 100% - ${J} ) 100%,0 100% )}.os-crumb--middle{padding-inline:22px;margin-inline-start:calc( -1 * ${J} );clip-path:polygon( ${J} 0,calc( 100% - ${J} ) 0,100% 50%,calc( 100% - ${J} ) 100%,${J} 100%,0 50% )}.os-crumb--last{padding-inline-start:22px;padding-inline-end:14px;margin-inline-start:calc( -1 * ${J} );clip-path:polygon( ${J} 0,100% 0,100% 100%,${J} 100%,0 50% )}.os-crumb--solo{padding:2px 12px;border-radius:999px}.os-crumb__label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;line-height:1.4}.os-crumb__remove{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;padding:0;border:0;border-radius:50%;background:transparent;color:inherit;cursor:pointer;opacity:0.65;transition:opacity 0.12s ease,background-color 0.12s ease,transform 0.12s ease}.os-crumb__remove:hover,.os-crumb__remove:focus-visible{opacity:1;background:var( --os-ui-scrim,rgba( 0,0,0,0.22 ) );outline:none;transform:scale( 1.1 )}.os-crumb__remove svg{display:block;width:100%;height:100%}.os-crumb-chain:hover{filter:drop-shadow( 0 2px 3px rgba( 0,0,0,0.12 ) )}:host( [ disabled ] ) .os-crumb-chain{opacity:0.55;pointer-events:none}`,Bt=class Bt extends _{constructor(){super(...arguments),this._segments=[]}get segments(){return this._segments}set segments(e){this._segments=Array.isArray(e)?e.slice():[],this.requestUpdate()}render(){const e=this.removable!==null,t=this._segments;return t.length===0?c``:c`
		...
		`}_renderChipRow(e,t,o,i){const n=this._selectedItemsInOrder();if(n.length===0)return c`
			...
			`;const r=this._buildChains(n);return c`
			<div
		...
		`}_renderTreeBody(e,t){return e?c`
			...
			`:t.map((o,i)=>this._renderRow(o,i,t.length))}_renderRow(e,t,o){const{node:i,hasChildren:n}=e,r=this._value.includes(i.item.id),a=!this._collapsed.has(i.item.id),l=12+i.depth*16,u=i.depth>0?i.depth*16:0,h=t===this._focusedRow;return c`
			<div class="os-cat__row-block">
				...
				>
					${n?c`<button
							...
							>${la()}</button>`:c`<span class="os-cat__expander os-cat__expander--placeholder" aria-hidden="true">${la()}</span>`}
					<span class="os-cat__check" aria-hidden="true">${jh()}</span>
					<span class="os-cat__label">${this._highlight(i.item.name,this._query)}</span>
					${ys(i.item)?c``:c`<button
								type="button"
				...
				${a&&!ys(i.item)?this._renderCreateRow(i.item.id,12+(i.depth+1)*16,(i.depth+1)*16,i.item.name):c``}
			</div>
		`}_renderCreateRow(e,t,o,i){const n=this._creatingValues.get(e)??"",r=this._creatingPending.has(e),a=e===0?"Add new category…":`Add child of "${i}"…`;return c`
			<div
			...
			>
				<div class="os-cat__create-wrap">
					...
					/>
					${r?c`<span class="os-cat__create-spinner" aria-hidden="true"></span>`:c`<button
								type="button"
		...
		>${e.slice(r+o.length)}`}_toggleSelection(e){const t=this._value.includes(e)?this._value.filter(o=>o!==e):[...this._value,e];this.emit("os-categories-change",{value:t})}_onDeleteClick(e,t){e.stopPropagation(),e.preventDefault(),this.emit("os-categories-delete",{id:t.id,name:t.name})}_toggleExpand(e){this._collapsed.has(e)?this._collapsed.delete(e):this._collapsed.add(e),this.requestUpdate()}_onSearchInput(e){this._query=e.target.value,this._focusedRow=0,this.requestUpdate()}_onSearchKeydown(e,t){switch(e.key){case"ArrowDown":{if(t.length===0)return;e.preventDefault(),this._focusedRow=this._focusedRow+1>=t.length?0:this._focusedRow+1,this.requestUpdate(),this._scrollFocusedIntoView();return}case"ArrowUp":{if(t.length===0)return;e.preventDefault(),this._focusedRow=this._focusedRow<=0?t.length-1:this._focusedRow-1,this.requestUpdate(),this._scrollFocusedIntoView();return}case"ArrowRight":{if(this._focusedRow<0||this._focusedRow>=t.length)return;const o=t[this._focusedRow];o.hasChildren&&this._collapsed.has(o.node.item.id)&&(e.preventDefault(),this._toggleExpand(o.node.item.id));return}case"ArrowLeft":{if(this._focusedRow<0||this._focusedRow>=t.length)return;const o=t[this._focusedRow];o.hasChildren&&!this._collapsed.has(o.node.item.id)&&(e.preventDefault(),this._toggleExpand(o.node.item.id));return}case"Enter":case" ":{if(this._focusedRow<0||this._focusedRow>=t.length)return;e.preventDefault();const o=t[this._focusedRow];this._toggleSelection(o.node.item.id);return}case"Escape":e.preventDefault(),this.closePicker()}}_scrollFocusedIntoView(){queueMicrotask(()=>{const e=this.shadowRoot?.querySelector(".os-cat__tree");if(!e)return;const t=e.querySelector('.os-cat__row[data-focused="true"]');if(!t)return;const o=t.getBoundingClientRect(),i=e.getBoundingClientRect();o.top<i.top?t.scrollIntoView({block:"nearest"}):o.bottom>i.bottom&&t.scrollIntoView({block:"nearest"})})}_positionPopover(){const e=this.shadowRoot?.querySelector(".os-cat__popover");if(!e)return;const t=this.getBoundingClientRect(),o=e.getBoundingClientRect(),i=window.innerWidth,n=window.innerHeight,r=8;let a=t.bottom+4;const l=a+o.height+r>n,u=t.top-4-o.height>=r;l&&u?a=t.top-4-o.height:l&&(a=Math.max(r,n-o.height-r));let h=t.left;h+o.width+r>i&&(h=t.right-o.width),h=Math.max(r,Math.min(h,i-o.width-r)),e.style.top=`${a}px`,e.style.left=`${h}px`}};Kt.props=["placeholder","add-label","disabled","readonly","open","loading","max-visible"],Kt.styles=[zh],Kt.help=void 0;let Ai=Kt;w("os-category-picker",Ai);function la(){return P("chevron-right",{size:14})}function Vh(){return P("plus",{size:16})}function jh(){return P("check",{size:null})}function Bh(){return P("close",{size:null})}const Kh=v` ${C} ${hs}:host(:not( [ interactive ] ) ) .os-holo-glint,:host( [ disabled ] ) .os-holo-glint{display:none}:host{display:flex;flex-direction:column;position:relative;gap:var( --os-ui-card-gap,12px );padding:var( --os-ui-card-padding,16px );border:1px solid var( --os-ui-card-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-radius:var( --os-ui-card-radius,12px );background:var( --os-ui-card-bg,var( --os-ui-surface,#fff ) );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );color:var( --os-ui-card-fg,inherit );box-sizing:border-box;min-width:0;transition:transform 180ms ease,box-shadow 180ms ease,border-color 180ms ease}:host( [ hidden ] ){display:none}:host( [ compact ] ){padding:var( --os-ui-card-padding-compact,10px );gap:var( --os-ui-card-gap-compact,6px );border-radius:var( --os-ui-card-radius-compact,8px )}:host( [ interactive ] ){cursor:pointer;outline-offset:2px}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:translateY( -2px );box-shadow:var( --os-ui-card-shadow-hover,0 4px 16px rgba( 0,0,0,0.08 ) );border-color:var( --os-ui-card-border-hover,var( --os-ui-border-strong,rgba( 0,0,0,0.16 ) ) )}:host( [ interactive ]:focus-visible ){outline:none;box-shadow:var( --_holo-focus )}:host( [ selected ] ){border-color:var( --os-ui-card-border-selected,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --os-ui-card-shadow-selected,0 0 0 1px var( --wp-admin-theme-color,#2271b1 ) inset )}:host( [ selected ] )::after{content:'';position:absolute;inset:-1px;border-radius:inherit;padding:1px;background-image:var( --_holo-edge );pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude}:host( [ disabled ] ){opacity:0.55;pointer-events:none;cursor:not-allowed}@media ( prefers-reduced-motion:reduce ){:host{transition:none}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:none}}::slotted( header ){display:flex;align-items:center;gap:12px;min-width:0}::slotted( footer ){display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:auto}`,ca="[data-noclick]",Gt=class Gt extends _{constructor(){super(...arguments),this._onClick=e=>{!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.target?.closest(ca)||this._emitCardClick(e)},this._onKeyDown=e=>{if(!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.key!=="Enter"&&e.key!==" "&&e.key!=="Spacebar")return;const t=e.target;t&&t!==this&&t.closest(ca)||t instanceof HTMLElement&&t!==this&&(t.tagName==="BUTTON"||t.tagName==="A"||t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT")||(e.preventDefault(),this._emitCardClick(e))}}connectedCallback(){super.connectedCallback(),this._syncRoles(),this.addEventListener("click",this._onClick),this.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){this.removeEventListener("click",this._onClick),this.removeEventListener("keydown",this._onKeyDown)}render(){return this._syncRoles(),c`<span class="os-holo-glint" aria-hidden="true"></span
			...
			<div class="summary-card" role="img" aria-label=${Zh(e,i)}>
				...
				<div class="bars">
					${[5,4,3,2,1].map(a=>{const l=this._ratings[String(a)]??0,u=i===0?0:l/i;return c`
							<div
								class="row"
								role="presentation"
								aria-label=${`${a} stars: ${n.format(l)}`}
							>
								...
								<span class="row__count">${n.format(l)}</span>
							</div>
						`})}
				</div>
			</div>
		`}};Xt.props=["rating","total"],Xt.styles=[Gh],Xt.help=void 0;let Si=Xt;function da(s,e){const t=s.getAttribute(e);if(t===null||t==="")return 0;const o=Number(t);return Number.isFinite(o)?o:0}function Xh(s){return s<0?0:s>100?100:s}function Zh(s,e){return e===0?"No ratings yet":`Average rating ${(s/100*5).toFixed(1)} out of 5, from ${e} ratings`}function Yh(s){const e=Math.floor(s),t=s-e>=.5?1:0,o=5-e-t,i=[];for(let n=0;n<e;n++)i.push(ua());for(let n=0;n<t;n++)i.push(Jh());for(let n=0;n<o;n++)i.push(Qh());return i}function ua(){return c`
		<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
			<path
				d="M8 1.5l2.06 4.17 4.6.67-3.33 3.25.79 4.58L8 12L3.88 14.17l.79-4.58L1.34 6.34l4.6-.67L8 1.5z"
			/>
		</svg>
	`}function Jh(){return c`
	...
	`}w("os-rating-summary",Si);const ep=v`:host{display:flex;align-items:flex-start;gap:10px;width:100%;box-sizing:border-box;padding:10px 14px;font:var( --os-ui-notice-font,13px/1.5 var( --os-font,system-ui ) );color:var( --os-ui-notice-color,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-notice-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );border-block-end:1px solid var( --os-ui-notice-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-inline-start:4px solid var( --os-ui-notice-accent,var( --os-ui-border,#646970 ) )}:host( [ hidden ] ){display:none}.os-notice__icon{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;color:var( --os-ui-notice-accent,var( --os-ui-accent,#646970 ) )}.os-notice__icon[ hidden ]{display:none}.os-notice__label{flex:1;min-width:0;word-wrap:break-word}::slotted( a ){color:var( --os-ui-notice-link,var( --wp-admin-theme-color,#2271b1 ) );border-radius:2px}::slotted( a:hover ),::slotted( a:focus-visible ){color:var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) )}::slotted( a:focus-visible ){outline:2px solid var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) );outline-offset:2px}::slotted( p:first-child ){margin-block-start:0}::slotted( p:last-child ){margin-block-end:0}.os-notice__close{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;padding:0;border:none;background:transparent;color:inherit;opacity:0.6;cursor:pointer;border-radius:4px;transition:opacity 0.12s ease,background-color 0.12s ease}.os-notice__close:hover{opacity:1;background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) )}.os-notice__close:focus-visible{opacity:1;outline:2px solid var( --wp-admin-theme-color,#2271b1 );outline-offset:1px}.os-notice__close[ hidden ]{display:none}.os-notice__close svg{width:14px;height:14px}:host( [ tone='info' ] ){--os-ui-notice-accent:var( --os-ui-notice-info,var( --os-ui-info-fg,#0969da ) );--os-ui-notice-bg:var( --os-ui-notice-info-bg,rgba( 9,105,218,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-info-border,rgba( 9,105,218,0.16 ) )}:host( [ tone='success' ] ){--os-ui-notice-accent:var( --os-ui-notice-success,var( --os-ui-success-fg,#1a7f37 ) );--os-ui-notice-bg:var( --os-ui-notice-success-bg,rgba( 26,127,55,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-success-border,rgba( 26,127,55,0.16 ) )}:host( [ tone='warning' ] ){--os-ui-notice-accent:var( --os-ui-notice-warning,var( --os-ui-warning-fg,#9a6700 ) );--os-ui-notice-bg:var( --os-ui-notice-warning-bg,rgba( 154,103,0,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-warning-border,rgba( 154,103,0,0.16 ) )}:host( [ tone='error' ] ),:host( [ tone='danger' ] ){--os-ui-notice-accent:var( --os-ui-notice-error,var( --os-ui-danger,#cf222e ) );--os-ui-notice-bg:var( --os-ui-notice-error-bg,rgba( 207,34,46,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-error-border,rgba( 207,34,46,0.16 ) )}:host( [ tone='neutral' ] ){--os-ui-notice-accent:var( --os-ui-notice-neutral,var( --os-ui-fg-muted,#57606a ) );--os-ui-notice-bg:var( --os-ui-notice-neutral-bg,rgba( 87,96,106,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-neutral-border,rgba( 87,96,106,0.16 ) )}`,tp="desktop-mode-notice-dismissed";function sp(){const e=window.wp?.os?.config?.currentUserId;return typeof e=="number"&&e>0?String(e):"anon"}function ha(){return`${tp}:${sp()}`}function Ci(){try{const s=window.localStorage.getItem(ha());if(!s)return{};const e=JSON.parse(s);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{}}function pa(s){try{window.localStorage.setItem(ha(),JSON.stringify(s))}catch{}}function op(s){return s?Ci()[s]===!0:!1}function ip(s){if(!s)return;const e=Ci();e[s]=!0,pa(e)}function np(s){if(!s)return;const e=Ci();e[s]&&(delete e[s],pa(e))}const Zt=class Zt extends _{connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","status"),this.hasAttribute("tone")||this.setAttribute("tone","info");const e=this.getAttribute("notice-id");e&&op(e)&&(this.hidden=!0)}dismiss(){this.hidden=!0;const e=this.getAttribute("notice-id");e&&ip(e),this.emit("os-notice-dismiss",{noticeId:e??void 0})}undismiss(){const e=this.getAttribute("notice-id");e&&np(e),this.hidden=!1}render(){const e=this.getAttribute("icon"),t=!this.hasAttribute("not-dismissible");return c`
		...
		`}};Qt.props=["add-label","empty-text","disabled","reorderable","min","max","row-label"],Qt.styles=[dp],Qt.help=void 0;let Ti=Qt;w("os-repeater",Ti);const up=v`:host{--_bg:var( --os-ui-token-field-bg,var( --os-ui-field-bg,#fff ) );--_border:var( --os-ui-token-field-border,var( --os-ui-field-border,#8c8f94 ) );--_fg:var( --os-ui-token-field-fg,var( --os-ui-field-fg,#2c3338 ) );--_chip-bg:var( --os-ui-token-field-chip-bg,var( --os-ui-surface-raised,rgba( 0,0,0,0.06 ) ) );display:block;position:relative}:host( [ hidden ] ){display:none}.os-token-field{display:flex;flex-direction:column;gap:6px}.os-token-field__label{font-size:13px;font-weight:500;color:var( --os-ui-fg,#1d2327 )}.os-token-field__input{box-sizing:border-box;width:100%;padding:6px 8px;border-radius:4px;background:var( --_bg );border:1px solid var( --_border );color:var( --_fg );font:inherit;resize:vertical}.os-token-field__input:focus-visible{outline:2px solid var( --os-ui-accent,#2271b1 );outline-offset:1px}.os-token-field__input:disabled{opacity:0.6}.os-token-field__toolbar{display:flex;align-items:center;gap:6px}.os-token-field__catalogue{position:absolute;inset-inline-start:0;inset-block-start:100%;z-index:20;max-height:18rem;overflow-y:auto;width:100%;padding:4px;box-sizing:border-box;border:1px solid var( --os-ui-border,#dcdcde );border-radius:6px;background:var( --os-ui-surface-elevated,#fff );box-shadow:0 8px 24px rgba( 0,0,0,0.18 )}.os-token-field__group{margin:6px 6px 2px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em;color:var( --os-ui-fg-faint,#8c8f94 )}.os-token-field__option{display:grid;grid-template-columns:minmax( 0,1fr ) auto;gap:2px 8px;width:100%;padding:6px 8px;border:0;border-radius:4px;background:transparent;color:var( --os-ui-fg,#1d2327 );font:inherit;text-align:start;cursor:pointer}.os-token-field__option:hover,.os-token-field__option:focus-visible{background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) );outline:none}.os-token-field__option-label{font-size:13px;min-width:0}.os-token-field__option-token{grid-column:2;grid-row:1;padding:1px 5px;border-radius:3px;background:var( --_chip-bg );font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample,.os-token-field__option-description{grid-column:1 / -1;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample{font-style:italic}.os-token-field__hint{margin:0;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview{display:flex;gap:6px;margin:0;font-size:12px;line-height:1.4;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview-label{flex:0 0 auto;font-weight:600}.os-token-field__preview-body{min-width:0;overflow-wrap:anywhere;white-space:pre-wrap}`,es=class es extends _{constructor(){super(...arguments),this._tokens=[],this._value="",this.caret=null,this.onInput=e=>{const t=e.target;this._value=t.value,this.emit("os-token-field-input",{value:this._value}),this.requestUpdate()},this.rememberCaret=()=>{const e=this.field;e&&(this.caret={start:e.selectionStart??e.value.length,end:e.selectionEnd??e.value.length})},this.toggleCatalogue=()=>{if(!(this.hasAttribute("disabled")||this.hasAttribute("readonly"))){if(this.isOpen){this.removeAttribute("open");return}this.rememberCaret(),this.setAttribute("open","")}},this.onKeydown=e=>{e.key==="Escape"&&this.isOpen&&(e.stopPropagation(),this.removeAttribute("open"),this.field?.focus())}}get tokens(){return this._tokens}set tokens(e){this._tokens=Array.isArray(e)?[...e]:[],this.requestUpdate()}get value(){return this._value}set value(e){this._value=typeof e=="string"?e:"";const t=this.field;t&&t.value!==this._value&&(t.value=this._value),this.requestUpdate()}get field(){return this.shadowRoot?.querySelector(".os-token-field__input")??null}get isOpen(){return this.hasAttribute("open")}grouped(){const e=new Map;for(const t of this._tokens){const o=t.group??"",i=e.get(o);i?i.push(t):e.set(o,[t])}return[...e.entries()].sort((t,o)=>t[0]===""?1:o[0]===""?-1:0)}preview(){let e=this._value,t=!1;for(const o of this._tokens)!o.sample||!e.includes(o.token)||(e=e.split(o.token).join(o.sample),t=!0);return t?e:null}insert(e){const t=this.field,o=this.caret??{start:this._value.length,end:this._value.length},i=this._value.slice(0,o.start),n=this._value.slice(o.end);this._value=`${i}${e.token}${n}`,this.removeAttribute("open"),t&&(t.value=this._value),this.emit("os-token-insert",{token:e.token,value:this._value}),this.emit("os-token-field-input",{value:this._value}),this.requestUpdate();const r=i.length+e.token.length;this.caret={start:r,end:r},queueMicrotask(()=>{const a=this.field;a?.focus(),a?.setSelectionRange?.(r,r)})}render(){const e=this.label||"",t=this.hint||"",o=this.placeholder||"",i=this,n=i["insert-label"]||"Insert a value",r=i["preview-label"]||"Reads as",a=this.hasAttribute("multiline"),l=this.hasAttribute("disabled"),u=this.hasAttribute("readonly"),h=Number(this.getAttribute("rows"))||4,p=this.preview(),g=this.grouped(),m=a?c`<textarea
			...
			<div class="os-token-field" @keydown=${this.onKeydown}>
				${e?c`<span class="os-token-field__label">${e}</span>`:null}
				${m}
				<div class="os-token-field__toolbar">
					<os-button
						variant="ghost"
						size="small"
						?disabled=${l||u||g.length===0}
				...
				${this.isOpen?c`<div
					  ...
					  >
							${g.map(([b,y])=>c`
									${b?c`<p class="os-token-field__group">${b}</p>`:null}
									${y.map(x=>c`
											<button
												type="button"
												role="option"
											...
											>
												...
												<code class="os-token-field__option-token"
													>${x.token}</code
												>
												${x.sample?c`<span class="os-token-field__option-sample"
															>${x.sample}</span
													  >`:null}
												${x.description?c`<span
				...
				${t?c`<p class="os-token-field__hint">${t}</p>`:null}
				${p!==null?c`<p class="os-token-field__preview">
		...
		`}};es.props=["label","placeholder","hint","multiline","rows","disabled","readonly","insert-label","preview-label","open"],es.styles=[up],es.help=void 0;let Di=es;w("os-token-field",Di);const hp=["os-section","os-button","os-swatch","os-swatch-grid","os-segmented","os-segment","os-select","os-option","os-multiselect","os-color-field","os-range-field","os-text-field","os-number-field","os-checkbox","os-checkbox-label","os-switch","os-toast","os-toast-container","os-tabs","os-tab","os-tabpanel","os-window-button","os-menu","os-menu-item","os-action-menu","os-context-menu","os-context-menu-option","os-confirm-dialog","os-modal","os-user-search","os-role-picker","os-flyout","os-tab-chip","os-stack","os-cluster","os-icon","os-body","os-panel","os-row","os-grid","os-display","os-disclosure","os-empty-state","os-key","os-code","os-badge","os-ribbon","os-tile","os-log","os-steps","os-step","os-table","os-spinner","os-relative-time","os-histogram","os-stat","os-avatar","os-textarea","os-chip","os-tag-input","os-form","os-save-status","os-category-picker","os-crumb-chain","os-card","os-rating-summary","os-notice","os-progress-bar","os-field-row","os-repeater","os-token-field"];function pp(s,e,t,o){const i=[s,e,...o];if(t){i.push(t.summary??"",t.status??"");for(const n of[t.props,t.slots,t.events,t.parts,t.cssProps])for(const r of n??[]){const{name:a,description:l}=r;i.push(a??"",l??"")}}return i.join(" ").toLowerCase()}function ga(s,e){return e.toLowerCase().split(/\s+/).filter(Boolean).every(o=>s.haystack.includes(o))}function gp(s){const e=s.replace(/^os-/,"").replace(/-/g," ");return e.charAt(0).toUpperCase()+e.slice(1)}function Pi(){const s=[];for(const e of hp){const t=customElements.get(e);if(!t)continue;const o=t.help??null,i=o?.title??gp(e),n=t.props??[];s.push({tag:e,title:i,help:o,props:n,haystack:pp(e,i,o,n)})}return s.sort((e,t)=>e.title.localeCompare(t.title)),s}const fp=["<!-- 1 — invented name, nothing close in the registry. -->","<os-example-console-fail-due-to-unregistered-component>","</os-example-console-fail-due-to-unregistered-component>","","<!-- 2 — typo within edit distance of a real tag. -->","<os-buton></os-buton>"].join(`
`);let fa=!1;function bp(){if(fa)return;fa=!0,console.log(`%c⚠ wp.os — INTENTIONAL DEMO%c
...
if you want a quieter Components tab.`,"background: #ffb400;color: #1a1a1a;font-weight: 700;font-size: 12px;padding: 4px 8px;border-radius: 3px","color: #b25c00;font-weight: 500")}const mp=s=>{switch(s){case"experimental":return d("Experimental");case"planned":return d("Planned");default:return d("Stable")}},xs=(s,e,t)=>e?.length?c`<section class="os-settings__help-group">
			<h4>${s}</h4>
			<ul class="os-settings__help-list">${e.map(o=>c`<li>${t(o)}</li>`)}</ul>
		</section>`:"",ks=s=>s?c` — ${s}`:"";function vp(s){const e=s.help?.props??[],t=new Set(e.map(i=>i.name)),o=s.props.filter(i=>!t.has(i));return e.length===0&&o.length===0?"":c`
			...
			<table class="os-settings__help-table">
				...
				<tbody>
					...
					${o.map(i=>c`<tr>
							...
							<td>—</td>
							<td>—</td>
							<td><em>${d("Undocumented — declared via static props.")}</em></td>
						</tr>`)}
				</tbody>
			</table>
		</section>
	`}function _p(s){const e=s.help,t=e?.status??"stable";return c`
		<header class="os-settings__help-head">
			<h3 class="os-settings__help-title">${s.title}</h3>
			<code class="os-settings__help-code">&lt;${s.tag}&gt;</code>
			<span class="os-settings__help-badge is-${t}">${mp(t)}</span>
		</header>
		${e?.summary?c`<p class="os-settings__help-summary">${e.summary}</p>`:""}
		${e?.example?c`<section class="os-settings__help-group">
				<h4>${d("Example")}</h4>
				<div class="os-settings__help-example">${e.example}</div>
			</section>`:""}
		${vp(s)}
		${xs(d("Slots"),e?.slots,o=>c`<code>${o.name}</code>${ks(o.description)}`)}
		${xs(d("Events"),e?.events,o=>c`<code>${o.name}</code>${o.detail?c` — <code>${o.detail}</code>`:""}${ks(o.description)}`)}
		${xs(d("Shadow parts"),e?.parts,o=>c`<code>::part(${o.name})</code>${ks(o.description)}`)}
		${xs(d("CSS custom properties"),e?.cssProps,o=>c`<code>${o.name}</code>${o.default?c` (${d("default")} <code>${o.default}</code>)`:""}${ks(o.description)}`)}
		${e?"":c`<p class="os-settings__help-note">
	...
	>
		<div class="os-settings__help-warner">
			...
			<pre class="os-settings__help-warner-code"><code>${fp}</code></pre>
		</div>
	</os-disclosure>
	<!--
...
`;function ba(s){const e=S(s).components;return e.entries??(e.entries=Pi()),e.entries}function ma(s){const e=S(s).components,t=ba(s).filter(o=>ga(o,e.query));return t.find(o=>o.tag===e.activeTag)??t[0]}const yp=(s,e)=>{const t=S(e).components;s.developerModeEnabled&&bp();const o=ba(e).filter(n=>ga(n,t.query)),i=ma(e);return c`
		${s.developerModeEnabled?wp():""}
		<div class="os-settings__help-layout">
			<div class="os-settings__help-sidebar">
				<os-text-field
					...
					autocomplete="off"
					value=${t.query}
					@os-input-change=${n=>{t.query=z(n).trim(),e.repaint()}}
				></os-text-field>
				<nav class="os-settings__help-nav" aria-label=${d("Components")}>
					${o.length?"":c`<p class="os-settings__help-nav-empty">${d("No components match.")}</p>`}
					${o.map(n=>c`<button
							type="button"
							class=${n.tag===i?.tag?"os-settings__help-nav-item is-active":"os-settings__help-nav-item"}
							aria-pressed=${n.tag===i?.tag?"true":"false"}
							@click=${()=>{t.activeTag=n.tag,e.repaint()}}
						>
							<span class="os-settings__help-nav-title">${n.title}</span>
							<span class="os-settings__help-nav-tag">&lt;${n.tag}&gt;</span>
						</button>`)}
				</nav>
			</div>
			<div class="os-settings__help-detail">
				${i?_p(i):c`<p>${d("No components registered.")}</p>`}
			</div>
		</div>
	`};function xp(s){const e=S(s).components,t=s.root.querySelector(".os-settings__help-detail");if(!t)return;const o=ma(s),i=o?.tag??"";i!==e.paintedTag&&(t.scrollTop=0,e.paintedTag=i);const n=o?.help?.exampleInit,r=t.querySelector(".os-settings__help-example");if(!(!n||!r||r.hasAttribute("data-os-example-ready"))){r.setAttribute("data-os-example-ready",""),customElements.upgrade(r);try{n(r)}catch(a){console.error(`[openstation] <${i}> exampleInit threw:`,a)}}}const va="https://openstation.blog/",_a="https://openstation.blog/feed/",kp="https://github.com/WordPress/openstation/";function Ni(s){if(typeof s!="string"||s==="")return"";try{const e=new URL(s,window.location.href);return e.protocol==="http:"||e.protocol==="https:"?e.href:""}catch{return""}}const Ae=s=>typeof s=="string"?s.trim():"";function $p(s){if(!s||typeof s!="object")return null;const e=s,t=(Array.isArray(e.items)?e.items:[]).map(o=>{if(!o||typeof o!="object")return null;const i=o,n=Ae(i.title),r=Ni(i.url);return n===""||r===""?null:{title:n,url:r,author:Ae(i.author),publishedAt:Ae(i.publishedAt),excerpt:Ae(i.excerpt)}}).filter(o=>o!==null).slice(0,5);return{title:Ae(e.title)||d("OpenStation"),description:Ae(e.description)||d("A public dev diary — building a desktop OS for wp-admin."),homeUrl:Ni(e.homeUrl)||va,feedUrl:Ni(e.feedUrl)||_a,items:t,stale:e.stale===!0}}function Ap(s){if(s==="")return"";const e=new Date(s);return Number.isNaN(e.getTime())?"":e.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function wa(s){const e=Ap(s.publishedAt);return e&&s.author?V("%1$s · %2$s",e,s.author):e||s.author}const Ep=s=>c`
	<article class="os-settings__about-featured">
		<a href=${s.url} target="_blank" rel="noopener noreferrer">
			<div class="os-settings__about-featured-copy">
				<span class="os-settings__about-kicker">${d("Latest dispatch")}</span>
				<h3>${s.title}</h3>
				${s.excerpt?c`<p>${s.excerpt}</p>`:""}
			</div>
			<footer>
				<span>${wa(s)}</span>
				<strong>${d("Read the dispatch")} <span aria-hidden="true">↗</span></strong>
			</footer>
		</a>
	</article>
`,Sp=s=>c`
	<article class="os-settings__about-card" role="listitem">
		<a href=${s.url} target="_blank" rel="noopener noreferrer">
			<span class="os-settings__about-card-meta">${wa(s)}</span>
			<h3>${s.title}</h3>
			${s.excerpt?c`<p>${s.excerpt}</p>`:""}
			<strong>${d("Read more")} <span aria-hidden="true">↗</span></strong>
		</a>
	</article>
`,Mi=(s,e,t,o="",i=!1)=>c`
	<div class=${`os-settings__about-status${o}`} role=${t} aria-live=${t==="status"?"polite":null}>
		${i?c`<span class="os-settings__about-spinner" aria-hidden="true"></span>`:c`<span class="dashicons dashicons-rss" aria-hidden="true"></span>`}
		<div>
			<strong>${s}</strong>
			<span>${e}</span>
		</div>
	</div>
`;function Cp(s){if(s.kind==="loading")return Mi(d("Opening the journal…"),d("The latest posts are arriving over RSS."),"status","",!0);if(s.kind==="error")return Mi(d("The journal could not be reached."),d("You can still read every post on openstation.blog."),"alert"," os-settings__about-status--error");if(s.feed.items.length===0)return Mi(d("No dispatches yet."),d("The journal is open and waiting for its next post."),"status");const[e,...t]=s.feed.items;return c`
		${s.feed.stale?c`<p class="os-settings__about-stale" role="status">
				${d("Showing the last saved copy while the journal reconnects.")}
			</p>`:""}
		<section class="os-settings__about-feed" aria-label=${d("Latest journal posts")}>
			${Ep(e)}
			${t.length>0?c`<div class="os-settings__about-grid" role="list">${t.map(Sp)}</div>`:""}
		</section>
	`}function Ip(s,e){const t=e.kind==="ready"?e.feed:null,o=`${s.pluginUrl??""}/assets/images/openstation-mark.svg`,i=s.pluginVersion??"";return c`
		<div class="os-settings__about-inner">
			<header class="os-settings__about-overview">
				<div class="os-settings__about-identity">
					<img src=${o} alt="" width="64" height="64" />
					<div>
						<span class="os-settings__about-eyebrow">${d("About OpenStation")}</span>
				...
				<div class="os-settings__about-story">
					...
					<div class="os-settings__about-meta">
						<span>
							<strong>OpenStation${i?` ${i}`:""}</strong>
							<small>${d("An experiment by Automattic")}</small>
						</span>
						<a href=${kp} target="_blank" rel="noopener noreferrer">
							${d("View the project")} <span aria-hidden="true">↗</span>
						</a>
					</div>
				</div>
			</header>
			<div class="os-settings__about-journal-head">
				<div>
					<span class="os-settings__about-eyebrow">${d("OpenStation Journal")}</span>
					<h2>${d("Latest from the station")}</h2>
					<p>${t?.description||d("A public dev diary — building a desktop OS for wp-admin.")}</p>
				</div>
				<a class="os-settings__about-journal-link" href=${t?.homeUrl||va} target="_blank" rel="noopener noreferrer">
					${d("Visit the journal")} <span aria-hidden="true">↗</span>
				</a>
			</div>
			${Cp(e)}
			<footer class="os-settings__about-footer">
				<p>
					...
					<span>${d("News and field notes, delivered over RSS.")}</span>
				</p>
				<a href=${t?.feedUrl||_a} target="_blank" rel="noopener noreferrer">
					<span class="dashicons dashicons-rss" aria-hidden="true"></span>
					${d("RSS feed")}
				</a>
			</footer>
		</div>
	`}const Rp=(s,e)=>c`<div class="os-settings__about">${Ip(ce(e),S(e).about??{kind:"loading"})}</div>`;function Lp(s){const e=S(s);if(s.state.tab!=="about"||e.about!==null)return;e.about={kind:"loading"};const t=ce(s).aboutFeedUrl;if(!t){e.about={kind:"error"},s.repaint();return}(async()=>{try{const o=await s.fetch(t,{credentials:"same-origin"});if(!o.ok)throw new Error(`about feed returned ${o.status}`);const i=await o.json(),n=i.success?$p(i.data):null;if(!n)throw new Error("about feed returned an invalid payload");e.about={kind:"ready",feed:n}}catch(o){console.error("[openstation/about] journal feed failed:",o),e.about={kind:"error"}}s.repaint()})()}const fe={size:null},oe={appearance:()=>P("color",fe),themes:()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path fill-rule="evenodd" clip-rule="evenodd" d="M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 0 1-6.5 6.5v-13a6.5 6.5 0 0 1 6.5 6.5Z" />',s},windows:()=>P("windows",fe),navigation:()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path d="M12 4c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14.5c-3.6 0-6.5-2.9-6.5-6.5S8.4 5.5 12 5.5s6.5 2.9 6.5 6.5-2.9 6.5-6.5 6.5zM9 16l4.5-3L15 8.4l-4.5 3L9 16z" />',s},mobile:()=>P("window",fe),features:()=>P("settings",fe),help:()=>P("widgets",fe),"os-file-associations":()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path d="M15.5 7.5h-7V9h7V7.5Zm-7 3.5h7v1.5h-7V11Zm7 3.5h-7V16h7v-1.5Z" /><path d="M17 4H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM7 5.5h10a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5H7a.5.5 0 0 1-.5-.5V6a.5.5 0 0 1 .5-.5Z" />',s},about:()=>P("info",fe)};function Tp(s,e){return e&&Pd(e)?()=>P(e,fe):oe[s]}const ya=s=>`os-settings-tab-host-${s}`;function be(s,e=""){return c`
		<header class="os-settings__page-header">
			<h2 class="os-settings__page-title">${s}</h2>
			${e?c`<p class="os-settings__page-description">${e}</p>`:""}
		</header>
	`}function Dp(s,e){return s.capability==="manage_options"?e:!0}function xa(s){return s<20?1:s<40?2:3}function He(s){const e=s.data.isAdmin,t=[{id:"appearance",order:10,label:d("Appearance"),icon:oe.appearance,panel:(o,i)=>c`${be(d("Appearance"),d("Personalize your desktop. Changes apply instantly and are saved to this browser."))}${Rc(o,Qc(o,i))}`},{id:"themes",order:12,label:d("Themes"),icon:oe.themes,panel:(o,i)=>c`${be(d("Themes"),d("A desktop theme repaints every token at once. A coarser version of what Appearance does one control at a time."))}${$d(o,i)}`},{id:"windows",order:18,label:d("Windows"),icon:oe.windows,panel:(o,i)=>c`${be(d("Windows"),d("How windows look, how they arrive, and how they behave when they are not the one you are using."))}${id(o)}`},{id:"navigation",order:22,label:d("Navigation"),icon:oe.navigation,panel:(o,i)=>c`${be(d("Navigation"))}${Dd(o)}`},{id:"mobile",order:24,label:d("Mobile"),icon:oe.mobile,panel:(o,i)=>c`${be(d("Mobile"),d("On a phone the desktop becomes a home screen, one full-screen app at a time, and a tab bar. Choose when that happens and what the bar holds."))}${zd(o)}`},{id:"features",order:30,label:d("Features"),icon:oe.features,panel:(o,i)=>c`${be(d("Features"),d("The assistant, developer tools, and beta features for your account, plus site-wide Extended options for administrators."))}${hd(o,i)}`}];e&&t.push({id:"help",order:40,label:d("Components"),icon:oe.help,panel:(o,i)=>c`${be(d("Components"),d("Every <os-*> web component shipped by this plugin, with its props, slots, and a live example."))}${yp(o,i)}`}),t.push({id:"about",order:Number.MAX_SAFE_INTEGER,label:d("About"),icon:oe.about,padding:"0",panel:Rp});for(const o of dc())Dp(o,e)&&t.push({id:`ext-${o.id}`,order:o.order??100,label:o.label,icon:Tp(o.id,o.icon),tab:o,panel:()=>c`<div data-host=${ya(o.id)}></div>`});return t.sort((o,i)=>o.order-i.order),t}function Pp(s,e){const t=S(s);for(const o of e){const i=o.tab;if(!i)continue;const n=s.root.querySelector(`[data-host="${ya(i.id)}"]`);if(!(!n||t.mountedTabs.get(n)===i)){t.mountedTabs.set(n,i);try{i.render(n,{isAdmin:s.data.isAdmin,getOsSettings:D,subscribeOsSettings:Gi})}catch(r){console.error("[openstation] settings tab render threw:",i.id,r)}}}}const Np=["heading","description","label","placeholder"];function ka(s,e){const t=new Map;for(const o of e){const i=s.querySelector(`os-tabpanel[for="${o.id}"]`),n=[o.label,i?.textContent??""];for(const r of Array.from(i?.querySelectorAll("[heading],[description],[label],[placeholder]")??[]))for(const a of Np)n.push(r.getAttribute(a)??"");t.set(o.id,n.join(" ").replace(/\s+/g," ").toLowerCase())}return t}const Mp=["window_prewarm","admin_asset_cache","media_library_enhanced","games","agents","network"];function zp(s,e){const t=I({enabled:{type:"boolean"}}),o=n=>R(n,["enabled"])&&typeof n.enabled=="boolean",i=async(n,r)=>{if(!await s.dispatch(n,r))throw new Error("Preferences did not save this action.");return po(s),{saved:!0,extendedOptions:s.data.extendedOptions,commentsAi:s.data.commentsAi}};return[...Mp.map(n=>({name:`set_extended_${n}`,description:`Set site-wide ${n}. Administrator only. Affects all users; window prewarm and asset cache need shell reload.`,parameters:t,validate:o,allowed:()=>s.data.isAdmin&&!!s.data.extendedOptions,run:r=>i("extended",{options:{...s.data.extendedOptions,[n]:r.enabled}})})),{name:"set_comments_ai",description:"Enable or disable site-wide AI comment scoring. Requires a configured provider and administrator rights.",parameters:t,validate:o,allowed:()=>s.data.isAdmin&&!!s.data.commentsAi?.providerConfigured,run:n=>i("comments-ai",{enabled:n.enabled})},{name:"set_ai_assistant",description:"Enable or disable the assistant for this account. Disabling ends future MIO requests.",parameters:t,validate:o,allowed:()=>!!s.data.aiAssistant?.assistantProviderConfigured,run:(n,r)=>e({ai:{enabled:n.enabled}},r)},{name:"show_introductions_again",description:"Show welcome introductions again on their next open. Does not delete settings or content.",parameters:I({}),validate:n=>R(n,[]),run:()=>i("reset-intros",{})},{name:"open_section",effect:"none",description:"Open a Preferences section. Use appearance, themes, windows, navigation, mobile, features, about, or help (Components; admin only).",parameters:I({id:{type:"string",enum:He(s).map(n=>n.id)}}),validate:n=>R(n,["id"])&&He(s).some(r=>r.id===n.id),run:n=>(s.local("tab",{value:n.id}),{opened:n.id})},{name:"search_settings",effect:"none",description:"Filter the Preferences sidebar by text.",parameters:I({query:{type:"string"}}),validate:n=>R(n,["query"])&&typeof n.query=="string"&&n.query.length<=200,run:n=>{const r=S(s).search;return r.index??(r.index=ka(s.root,He(s))),r.query=n.query.toLowerCase().trim(),s.repaint(),{filtered:n.query}}},{name:"open_image_picker",effect:"none",description:"Show the wallpaper image picker. Upload requires the user to select a local file; library offers existing images.",parameters:I({source:{type:"string",enum:["library","upload"]}}),validate:n=>R(n,["source"])&&(n.source==="library"||n.source==="upload"&&s.data.canUpload),run:n=>{const r=S(s);return r.imagePickerOpen=!0,r.imageSource=n.source,s.local("tab",{value:"appearance"}),s.repaint(),{opened:n.source,needsUserFile:n.source==="upload"}}},{name:"search_wallpaper_images",effect:"read",description:"Search image attachments in the media library. Returns verified ids and dimensions for select_wallpaper_image.",parameters:I({query:{type:"string"},page:{type:"integer",minimum:1,maximum:100}}),validate:n=>R(n,["query","page"])&&typeof n.query=="string"&&n.query.length<=200&&Number.isInteger(n.page)&&n.page>=1&&n.page<=100,run:async(n,r)=>{const a=new URL(ce(s).mediaUrl);a.searchParams.set("media_type","image"),a.searchParams.set("search",n.query),a.searchParams.set("page",String(n.page)),a.searchParams.set("per_page","12"),a.searchParams.set("_fields","id,title,media_details,source_url,mime_type");const l=await s.fetch(a.href,{signal:r});if(!l.ok)throw new Error("Could not search the media library.");return l.json()}},{name:"select_wallpaper_image",description:"Use an existing image attachment as wallpaper. Verifies the attachment on the server; never accepts a model-supplied URL.",parameters:I({id:{type:"integer",minimum:1}}),validate:n=>R(n,["id"])&&Number.isSafeInteger(n.id)&&n.id>0,run:async(n,r)=>{const a=await s.fetch(`${ce(s).mediaUrl}/${n.id}`,{signal:r});if(!a.ok)throw new Error("This image is unavailable.");const l=await a.json();if(typeof l.mime_type!="string"||!l.mime_type.startsWith("image/")||typeof l.source_url!="string"||!/^https?:\/\//.test(l.source_url))throw new Error("The attachment is not a usable image.");return e({customImage:{id:l.id,url:l.source_url},wallpaper:"custom-image"},r)}},{name:"clear_wallpaper_image",description:"Clear the selected wallpaper image without deleting its media attachment. Active image wallpaper returns to the default wallpaper.",parameters:I({}),validate:n=>R(n,[]),run:(n,r)=>e({customImage:null,...D().wallpaper==="custom-image"?{wallpaper:Fi()}:{}},r)},{name:"open_theme_upload",effect:"none",description:"Show the desktop theme upload tile. The user must choose the ZIP from their device.",parameters:I({}),validate:n=>R(n,[]),allowed:()=>s.data.canManageDesktopThemes,run:()=>(s.local("tab",{value:"themes"}),{opened:"themes",needsUserFile:!0})},{name:"open_wallpaper_settings",effect:"none",description:"Open the active wallpaper’s custom settings dialog, when available.",parameters:I({}),validate:n=>R(n,[]),run:()=>{const n=ye().find(r=>r.id===D().wallpaper);if(!n?.renderConfig)throw new Error("This wallpaper has no settings dialog.");return yr(n),{opened:n.id}}},{name:"set_snow_settings",description:"Configure Snow wallpaper: wind 0–80, particleCount 100–2000, flakeSize 6–40, background #rrggbb. Does not switch wallpaper.",parameters:I({wind:{type:"number",minimum:0,maximum:80},particleCount:{type:"integer",minimum:100,maximum:2e3},flakeSize:{type:"number",minimum:6,maximum:40},background:{type:"string"}}),allowed:()=>ye().some(n=>n.id==="wp-snow"),validate:n=>R(n,["wind","particleCount","flakeSize","background"])&&Object.entries(Zl).every(([r,a])=>typeof n[r]=="number"&&Number.isFinite(n[r])&&n[r]>=a.min&&n[r]<=a.max)&&Number.isInteger(n.particleCount)&&typeof n.background=="string"&&/^#[0-9a-f]{6}$/i.test(n.background),run:async(n,r)=>{const a=n,l=await e({wallpaperSettings:{...D().wallpaperSettings,"wp-snow":a}},r);return er("wp-snow",a),l}},{name:"open_component_reference",effect:"none",description:"Inspect a kit component’s documentation and interactive example. Administrator only.",parameters:I({tag:{type:"string"}}),allowed:()=>s.data.isAdmin,validate:n=>R(n,["tag"])&&Pi().some(r=>r.tag===n.tag),run:n=>(S(s).components.activeTag=n.tag,s.local("tab",{value:"help"}),s.repaint(),{opened:n.tag})},{name:"list_components",effect:"read",description:"List available component references.",parameters:I({}),validate:n=>R(n,[]),allowed:()=>s.data.isAdmin,run:()=>Pi().map(n=>({tag:n.tag,title:n.title}))},{name:"show_connectors_location",effect:"read",description:"Explain where to connect the AI provider. Credentials must be entered by the user in WordPress Connectors.",parameters:I({}),validate:n=>R(n,[]),run:()=>({url:Ds().aiAssistant?.connectorsUrl,instructions:"Open WordPress Settings → Connectors to manage provider credentials."})}]}const $a=s=>`set_${s.replace(/[A-Z]/g,e=>`_${e.toLowerCase()}`)}`,I=s=>({type:"object",properties:s,required:Object.keys(s),additionalProperties:!1}),R=(s,e)=>Object.keys(s).length===e.length&&e.every(t=>Object.prototype.hasOwnProperty.call(s,t)),zi=s=>typeof s=="string"&&/^#[0-9a-f]{6}$/i.test(s);function Op(s){const e=async(n,r)=>{const a=await Yn(()=>A(n),r,n);return"developerModeEnabled"in n&&Zi(),a},t=eo(),o=Object.entries(t).map(([n,r])=>({name:$a(n),description:`Set Preferences ${n}. Current: ${JSON.stringify(D()[n])}.${n==="desktopLayout"?" unified combines all docks; classic is Split.":""}${n==="desktopTheme"?" Read list_options first to choose from installed themes; this never changes the WordPress frontend theme.":""}`,parameters:I({value:{type:typeof r[0]=="number"?"number":"string",enum:[...new Set(r)]}}),validate:a=>R(a,["value"])&&(eo()[n]??[]).includes(a.value),run:(a,l)=>e({[n]:a.value},l)}));for(const n of Gl)o.push({name:$a(n),description:`Set Preferences ${n}. Current: ${D()[n]}.`,parameters:I({value:{type:"boolean"}}),validate:r=>R(r,["value"])&&typeof r.value=="boolean",run:(r,a)=>e({[n]:r.value},a)});return[...o,{name:"list_options",effect:"read",description:"List live themes (including surface colours), wallpapers, accents, effects, navigation and phone pin choices. Read before selecting ids.",parameters:I({}),validate:n=>R(n,[]),run:Xl},{name:"read_settings",effect:"read",description:"Read current preferences, active section and capability-gated site options.",parameters:I({}),validate:n=>R(n,[]),run:()=>({settings:D(),section:s.state.tab,extendedOptions:s.data.extendedOptions,commentsAi:s.data.commentsAi})},{name:"set_custom_accent",description:"Set a custom six-digit hex accent and activate it.",parameters:I({value:{type:"string",pattern:"^#[0-9a-fA-F]{6}$"}}),validate:n=>R(n,["value"])&&zi(n.value),run:(n,r)=>e({accent:"custom",customAccent:n.value},r)},{name:"set_custom_gradient",description:"Set both gradient colours and its angle, and activate the custom gradient wallpaper.",parameters:I({from:{type:"string"},to:{type:"string"},angle:{type:"number",minimum:0,maximum:360}}),validate:n=>R(n,["from","to","angle"])&&zi(n.from)&&zi(n.to)&&typeof n.angle=="number"&&Number.isFinite(n.angle)&&n.angle>=0&&n.angle<=360,run:(n,r)=>e({wallpaper:"custom-gradient",customGradient:{from:n.from,to:n.to,angle:n.angle}},r)},{name:"set_window_reveal_duration",description:"Set reveal duration: 0 uses each effect’s default; otherwise 80–4000 milliseconds.",parameters:I({value:{type:"number"}}),validate:n=>R(n,["value"])&&typeof n.value=="number"&&(n.value===0||Number.isFinite(n.value)&&n.value>=80&&n.value<=4e3),run:(n,r)=>e({windowRevealDuration:n.value},r)},{name:"set_navigation_placement",description:"Place one available Navigation item on the rail, desktop, both, or hidden. Preserves every other item.",parameters:I({id:{type:"string"},placement:{type:"string",enum:["rail","desktop","both","hidden"]}}),validate:n=>R(n,["id","placement"])&&Xn().some(r=>r.id===n.id)&&["rail","desktop","both","hidden"].includes(n.placement),run:(n,r)=>e({navPlacement:{...D().navPlacement,[n.id]:n.placement}},r)},{name:"set_mobile_tabs",description:"Choose up to three available phone pins in order. Empty selects the server defaults; Home and Switcher are reserved.",parameters:I({ids:{type:"array",items:{type:"string"},maxItems:3,uniqueItems:!0}}),validate:n=>R(n,["ids"])&&Array.isArray(n.ids)&&n.ids.length<=3&&new Set(n.ids).size===n.ids.length&&n.ids.every(r=>Zn().some(a=>a.id===r)),run:(n,r)=>e({mobileTabs:n.ids},r)},{name:"apply_theme_recommendations",description:"Reapply the active theme’s recommended arrangement. Changes only the settings that theme recommends.",parameters:I({}),validate:n=>R(n,[]),run:async(n,r)=>D().desktopTheme?Yn(()=>{if(!Xi(D().desktopTheme))throw new Error("This theme has no applicable recommendations.")},r):{effect:"none",status:"completed",data:{changed:!1,reason:"System default has no recommended layout."}}},...zp(s,e)].map(n=>({effect:"write",...n}))}const Wp=Object.entries({index:`# OpenStation Preferences help
...
`)[0].replace(/^# /,""),markdown:e}));function Hp(s){const e=window.wp?.os?.mio?.registerWindow(s.windowId,{host:s.root,title:"OpenStation Preferences",prompt:()=>`You are MIO, the warm, concise companion inside OpenStation Preferences. Help the user understand and customize this admin desktop. Your caller is this window; your scope is its non-destructive controls. Do not change the public website theme. Current section: ${s.state.tab}. Current settings: ${JSON.stringify(D())}. Administrator: ${s.data.isAdmin}. Use help for factual explanations, list_options for live choices, and only offered actions for changes. For "unify docks" choose desktopLayout unified. "Rounded corners" is windowRadius round. For "make both docks dynamic" in Split set both dockBehavior and sideDockBehavior. Apply a desktop theme before requested explicit overrides. Ask when an essential choice is unclear. Read results and report partial completion honestly. Current settings are refreshed AFTER each action; they are not the original state. Use the action result changed and changes (before/after) to describe what happened. Only say already selected when the action result explicitly reports changed:false. Never claim that opening an upload picker uploaded a file. Do not reset preferences, delete themes or purge sharing data.`,documents:Wp,abilities:()=>Op(s)});return e?.showCallout({id:"about-blog",target:()=>s.state.tab==="about"?s.root.querySelector(".os-settings__about-journal-head"):null,message:d("Visit our blog!")}),()=>e?.dispose()}const Ee=Z("desktop-mode/wallpaper-lazy",()=>({pending:new Map,inflight:new Map}));function Up(s){Ee.state.pending.delete(s)}function qp(s){return(window.openStationWallpapers||{})[s]??null}function Fp(s){const e=Ee.state.inflight.get(s);if(e)return e;const t=Ee.state.pending.get(s);if(!t)return Promise.resolve(null);const o=(async()=>{try{await Bs(t.scriptUrl,{translations:t.scriptTranslations,l10n:t.scriptL10n,before:t.scriptBefore,after:t.scriptAfter})}catch(n){return ge(U.SHELL_ERROR,{scope:"wallpaper-script-load",id:t.id,error:n}),null}let i=qp(t.id);if(i&&!i.description&&t.description&&(i={...i,description:t.description}),!i)return ge(U.SHELL_ERROR,{scope:"wallpaper-missing-def",id:t.id,error:new Error(`[openstation] No wallpaper def on window.openStationWallpapers["${t.id}"]. Script loaded but didn't publish a def — check the plugin's enqueue + global assignment.`)}),null;try{Kn(i)}catch(n){return ge(U.SHELL_ERROR,{scope:"wallpaper-register",id:t.id,error:n}),null}return Up(t.id),i})().finally(()=>{Ee.state.inflight.delete(s)});return Ee.state.inflight.set(s,o),o}async function Vp(){const s=Array.from(Ee.state.pending.keys());s.length!==0&&await Promise.all(s.map(e=>Fp(e)))}let me=null;function jp(){if(me)return me;if(window.openStationWindowLinkVisuals)return me=Promise.resolve(!0),me;const e=window.openStationConfig?.windowLinkVisualsBundleUrl;return e?(me=Bs(e).then(()=>!0).catch(t=>{throw me=null,t}),me):Promise.resolve(!1)}const Bp=4,Aa=24,Ea=4,Kp=250,Gp="os-settings__wallpaper-live-preview";function Xp(s){const e=s.type==="canvas"?s.needs:void 0;if(!e||e.length===0)return Promise.resolve();const t=window.wp?.os;return t?.loadModules?t.loadModules(e):Promise.reject(new Error(`[openstation] Wallpaper "${s.id}" declares needs but wp.os.loadModules is unavailable.`))}function Zp(){return window.openStationConfig?.pluginUrl??""}function Yp(){return typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches}function Jp(s){const e={...s.previewParams??{}},t=pe(U.WALLPAPER_PREVIEW_PARAMS,e,s.id);return!t||typeof t!="object"?e:t}function Qp(s){const e=new Map;let t=!1;const o=()=>{let f=0;return e.forEach(E=>{(E.teardown||E.mounting)&&f++}),f},i=f=>{f.remountTimer!==null&&(clearTimeout(f.remountTimer),f.remountTimer=null)},n=f=>{if(f.generation++,f.mounting=!1,i(f),f.teardown){const E=f.teardown;f.teardown=null;try{E()}catch($){typeof console<"u"&&console.error(`[openstation] Wallpaper "${f.defId}" preview teardown threw:`,$)}}f.overlay.innerHTML=""},r=f=>{t||!f.visible||f.teardown||f.mounting||m&&(f.tile.clientWidth<Aa||f.tile.clientHeight<Aa)||a(f)},a=f=>{const E=De(f.defId);if(!E?.renderPreview||o()>=Bp)return;const $=++f.generation;f.mounting=!0,f.mountWidth=f.tile.clientWidth,f.mountHeight=f.tile.clientHeight;const L={id:E.id,pluginUrl:Zp(),prefersReducedMotion:Yp(),visible:!document.hidden,settings:Qn(E.id),params:Jp(E),width:f.mountWidth,height:f.mountHeight},Q=W=>{if($!==f.generation||t){try{W()}catch{}return}f.mounting=!1,f.teardown=W,l(f)&&u(f)},X=W=>{$===f.generation&&(f.mounting=!1,f.overlay.innerHTML="",typeof console<"u"&&console.error(`[openstation] Wallpaper "${E.id}" renderPreview failed:`,W))};Xp(E).then(()=>{if($!==f.generation||t)return;let W;try{W=E.renderPreview(f.overlay,L)}catch(K){X(K);return}if(ao(W)){W.then(Q,X);return}Q(W)},X)},l=f=>Math.abs(f.tile.clientWidth-f.mountWidth)>Ea||Math.abs(f.tile.clientHeight-f.mountHeight)>Ea,u=f=>{i(f),f.remountTimer=setTimeout(()=>{f.remountTimer=null,!(t||!f.teardown||!l(f))&&(n(f),r(f))},Kp)},h=f=>{for(const E of f){const $=e.get(E.target);$&&($.visible=E.isIntersecting,E.isIntersecting?r($):n($))}},p=typeof IntersectionObserver=="function"?new IntersectionObserver(h,{threshold:.1}):null,g=f=>{for(const E of f){const $=e.get(E.target);!$||t||(!$.teardown&&!$.mounting?r($):$.teardown&&l($)&&u($))}},m=typeof ResizeObserver=="function"?new ResizeObserver(g):null,b=f=>{n(f),p?.unobserve(f.tile),m?.unobserve(f.tile),f.overlay.remove(),e.delete(f.tile)},y=()=>{if(t)return;const f=s.querySelectorAll("os-swatch[data-wallpaper-id]"),E=new Set;f.forEach($=>{E.add($);const L=$.dataset.wallpaperId??"",X=!!De(L)?.renderPreview&&!!p,W=e.get($);if(W&&(W.defId!==L||!X)&&b(W),!X||e.has($))return;const K=document.createElement("div");K.className=Gp,K.setAttribute("aria-hidden","true"),$.appendChild(K),e.set($,{tile:$,overlay:K,defId:L,generation:0,teardown:null,mounting:!1,visible:!1,mountWidth:0,mountHeight:0,remountTimer:null}),p.observe($),m?.observe($)}),e.forEach(($,L)=>{E.has(L)||b($)})},x=()=>{t||(t=!0,e.forEach(f=>n(f)),e.clear(),p?.disconnect(),m?.disconnect(),document.removeEventListener("os-window-closed",k))},k=()=>{s.isConnected||x()};return document.addEventListener("os-window-closed",k),{sync:y,dispose:x}}const eg="appearance";function Sa(s,e){if(!e.icon)return c`<span class="os-settings__nav-glyph-blank" aria-hidden="true"></span>`;let t=s.glyphs.get(e.id);return t||(t=e.icon(),s.glyphs.set(e.id,t)),t}function tg(s){const e=D(),t=S(s),o=He(s),i=o.some(h=>h.id===s.state.tab)?s.state.tab:eg,{query:n,index:r}=t.search,a=h=>n===""||(r?.get(h.id)??"").includes(n);let l=0;const u=h=>{var p;(p=t.search).index??(p.index=ka(s.root,o)),t.search.query=h.target.value.trim().toLowerCase(),s.repaint()};return c`
		<div class="os-settings">
			...
			<os-tabs
				...
				os-bind="tab"
			>
				${o.map((h,p)=>{const g=p>0&&xa(h.order)!==xa(o[p-1].order),m=a(h);return m&&l++,c`<os-tab
						value=${h.id}
						data-group-start=${g?"true":null}
						data-search-hidden=${m?null:"true"}
					>${Sa(t,h)}${h.label}</os-tab>`})}
			</os-tabs>
			<p class="os-settings__search-empty" ?hidden=${n===""||l>0}>
				${d("No settings match that.")}
			</p>
			${""}
			<os-select
				class="os-settings__page-select"
				label=${d("Settings section")}
				value=${i}
				os-bind="tab"
			>
				${o.map(h=>c`<os-option value=${h.id}>${h.label}</os-option>`)}
			</os-select>
			<os-panel class="os-settings__footer">
				<os-button variant="ghost" @click=${Ma}>${d("Reset to defaults")}</os-button>
			</os-panel>
			${o.map(h=>c`<os-tabpanel for=${h.id}>
					<os-panel padding=${h.padding??null}>${h.panel(e,s)}</os-panel>
				</os-tabpanel>`)}
		</div>
	`}const sg=lc(Ts,{local:{tab:(s,e)=>{const t=String(e.value??"");t!==""&&(s.tab=t)}},view:tg,mounted:s=>{const e=S(s);zc(D,Jc),e.previews=Qp(s.root),Vp(),jp().catch(()=>{});const t=()=>s.repaint(),o=[Hp(s),Gi(t),Vl(t),Va(t),Hl(t),fl(t),Fl(t),$l(t),uc(t)];return()=>{for(const i of o)i();wr(s),e.previews?.dispose(),e.previews=null}},updated:s=>{Yc(s),S(s).previews?.sync(),Gc(s),Pp(s,He(s)),xp(s),Lp(s),po(s)}});return Cs.default=sg,Object.defineProperties(Cs,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),Cs}({});
