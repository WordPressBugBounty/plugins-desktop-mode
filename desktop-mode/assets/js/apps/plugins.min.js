var openStationApp_plugins=function(Te){"use strict";const Co="desktop-mode";function mt(){return window.wp?.i18n}function d(o,e=Co){return mt()?.__(o,e)??o}function y(o,...e){const t=mt()?.sprintf;if(t)return t(o,...e);let s=0;return o.replace(/%(?:(\d+)\$)?[sd]/g,(n,i)=>{const a=i?Number.parseInt(i,10)-1:s++;return String(e[a]??"")})}function f(o,...e){return{__wpdHtml:!0,strings:o,values:e}}function Ao(o){return!!o&&o.__wpdHtml===!0}const Eo="$$wpd$$",z=/\$\$wpd\$\$(\d+)\$\$/g,So="$$wpd-node$$",$o=/^\$\$wpd-node\$\$(\d+)\$\$$/,zo=new Set(["style","script","textarea","title"]);function No(o){let e="",t=!1,s=null,n=!1,i=null,a="",r=!1;for(let l=0;l<o.length;l++){const c=o[l];e+=c;for(let p=0;p<c.length;p++){const u=c[p];if(n){c.startsWith("-->",p)&&(n=!1,p+=2);continue}if(i!==null){u==="<"&&c[p+1]==="/"&&c.slice(p+2,p+2+i.length).toLowerCase()===i&&(p+=1+i.length,i=null,t=!0,r=!1,a="");continue}if(s!==null){u===s&&(s=null);continue}if(t){u==='"'||u==="'"?(s=u,r=!1):u===">"?(t=!1,r=!1,zo.has(a)&&(i=a),a=""):r&&(/[a-zA-Z0-9-]/.test(u)?a+=u.toLowerCase():r=!1);continue}if(c.startsWith("<!--",p)){n=!0,p+=3;continue}const g=c[p+1]??"";u==="<"&&/[a-zA-Z/!]/.test(g)&&(t=!0,a="",r=/[a-zA-Z]/.test(g))}l<o.length-1&&(e+=t||n||i!==null?`${Eo}${l}$$`:`<!--${So}${l}$$-->`)}return e}const vt=new WeakMap;function _t(o){const e=vt.get(o);if(e)return e;const t=document.createElement("template");t.innerHTML=No(o);const s=[],n=(r,l)=>{if(r.nodeType===Node.ELEMENT_NODE){const u=r;for(const g of Array.from(u.attributes)){const b=g.name,h=g.value,_=b[0];if(z.test(h))if(z.lastIndex=0,_==="@"){const m=z.exec(h);z.lastIndex=0,s.push({path:l,kind:"event",name:b.slice(1),valueIndex:m?Number(m[1]):0}),u.removeAttribute(b)}else if(_==="."){const m=z.exec(h);z.lastIndex=0,s.push({path:l,kind:"prop",name:b.slice(1),valueIndex:m?Number(m[1]):0}),u.removeAttribute(b)}else if(_==="?"){const m=z.exec(h);z.lastIndex=0,s.push({path:l,kind:"bool",name:b.slice(1),valueIndex:m?Number(m[1]):0}),u.removeAttribute(b)}else{const m=[],w=[];let x=0,S;for(z.lastIndex=0;(S=z.exec(h))!==null;)m.push(h.slice(x,S.index)),w.push(Number(S[1])),x=S.index+S[0].length;m.push(h.slice(x)),s.push({path:l,kind:"attr",name:b,template:m,valueIndices:w}),u.setAttribute(b,"")}}}const c=Array.from(r.childNodes);let p=0;for(let u=0;u<c.length;u++){const g=c[u],b=u+p;if(g.nodeType===Node.COMMENT_NODE){const h=$o.exec(g.data);if(h){const _=document.createTextNode("");g.parentNode.replaceChild(_,g),s.push({path:[...l,b],kind:"node",valueIndex:Number(h[1])})}continue}if(g.nodeType===Node.TEXT_NODE){const h=g.textContent||"";if(!z.test(h)){z.lastIndex=0;continue}z.lastIndex=0;const _=g.parentNode;let m=0,w;const x=[],S=[];for(z.lastIndex=0;(w=z.exec(h))!==null;){w.index>m&&x.push(document.createTextNode(h.slice(m,w.index)));const D=document.createTextNode("");x.push(D),S.push({path:[...l,b+x.length-1],kind:"node",valueIndex:Number(w[1])}),m=w.index+w[0].length}m<h.length&&x.push(document.createTextNode(h.slice(m)));for(const D of x)_.insertBefore(D,g);_.removeChild(g),p+=x.length-1,s.push(...S)}else n(g,[...l,b])}};n(t.content,[]);const a={template:t,buildParts:r=>{const l=[];for(const c of s){let p=r;for(const u of c.path)p=p.childNodes[u];c.kind==="node"?l.push({kind:"node",valueIndex:c.valueIndex,child:{anchor:p,state:null}}):c.kind==="attr"?l.push({kind:"attr",element:p,name:c.name,template:c.template,valueIndices:c.valueIndices}):c.kind==="event"?l.push({kind:"event",valueIndex:c.valueIndex,element:p,name:c.name}):c.kind==="prop"?l.push({kind:"prop",valueIndex:c.valueIndex,element:p,name:c.name}):c.kind==="bool"&&l.push({kind:"bool",valueIndex:c.valueIndex,element:p,name:c.name})}return l}};return vt.set(o,a),a}const yt=new WeakMap;function Lo(o,e){for(const t of o.nodes)if(t.parentNode!==e)return!1;return!0}function W(o,e){const t=yt.get(e);if(t&&t.strings===o.strings&&Lo(t,e)){ve(t.parts,o.values);return}const s=_t(o.strings),n=s.template.content.cloneNode(!0),i=s.buildParts(n),a=Array.from(n.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(n),ve(i,o.values),yt.set(e,{strings:o.strings,parts:i,nodes:a})}function ve(o,e){for(const t of o)if(t.kind==="node")_e(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let s=t.template[0];for(let n=0;n<t.valueIndices.length;n++)s+=kt(e[t.valueIndices[n]]),s+=t.template[n+1];s!==t.last&&(t.last=s,s===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,s))}else if(t.kind==="event"){const s=e[t.valueIndex];s!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),s&&t.element.addEventListener(t.name,s),t.current=s)}else if(t.kind==="prop"){const s=e[t.valueIndex];s!==t.last&&(t.last=s,t.element[t.name]=s)}else if(t.kind==="bool"){const s=!!e[t.valueIndex];s!==t.last&&(t.last=s,s?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function _e(o,e){if(e==null||e===!1){o.state&&(P(o.state),o.state=null);return}if(Array.isArray(e)){qo(o,e);return}if(Ao(e)){Po(o,e);return}if(e instanceof Node){To(o,e);return}Ro(o,kt(e))}function To(o,e){const t=o.state;t?.shape==="node"&&t.node===e||(t&&P(t),j(o,[e]),o.state={shape:"node",node:e})}function Ro(o,e){const t=o.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&P(t);const s=document.createTextNode(e);j(o,[s]),o.state={shape:"text",node:s,text:e}}function Po(o,e){const t=o.state;if(t?.shape==="template"&&t.strings===e.strings){ve(t.parts,e.values);return}t&&P(t);const s=_t(e.strings),n=s.template.content.cloneNode(!0),i=s.buildParts(n),a=Array.from(n.childNodes);j(o,[n]),ve(i,e.values),o.state={shape:"template",strings:e.strings,parts:i,nodes:a}}function qo(o,e){const t=o.state;if(t?.shape==="array"){const n=Math.min(t.entries.length,e.length);for(let i=0;i<n;i++)_e(t.entries[i],e[i]);if(e.length<t.entries.length){for(let i=e.length;i<t.entries.length;i++){const a=t.entries[i];a.state&&P(a.state),a.anchor.remove()}t.entries.length=e.length}else for(let i=t.entries.length;i<e.length;i++){const a=document.createTextNode("");j(o,[a]);const r={anchor:a,state:null};_e(r,e[i]),t.entries.push(r)}return}t&&P(t);const s=[];for(const n of e){const i=document.createTextNode("");j(o,[i]);const a={anchor:i,state:null};_e(a,n),s.push(a)}o.state={shape:"array",entries:s}}function j(o,e){const t=o.anchor.parentNode;if(t)for(const s of e)t.insertBefore(s,o.anchor)}function P(o){if(o.shape==="text"){o.node.remove();return}if(o.shape==="template"){for(const e of o.parts)e.kind==="node"&&e.child.state&&(P(e.child.state),e.child.state=null);for(const e of o.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(o.shape==="node"){o.node.parentNode&&o.node.parentNode.removeChild(o.node);return}for(const e of o.entries)e.state&&P(e.state),e.anchor.remove()}function kt(o){return o==null||o===!1?"":String(o)}function ye(o){if(!Number.isFinite(o)||o<=0)return"0 B";const e=["B","KB","MB","GB","TB"];let t=o,s=0;for(;t>=1024&&s<e.length-1;)t/=1024,s++;const n=t>=100||s===0?0:1;return`${t.toFixed(n)} ${e[s]}`}function xt(o,e="short"){if(o===""||o===null||o===void 0)return"";const t=typeof o=="string"&&/^\d{4}-\d{2}$/.test(o)?`${o}-01T00:00:00`:o,s=t instanceof Date?t:new Date(t);if(Number.isNaN(s.getTime()))return String(o);try{switch(e){case"long":return s.toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"});case"month":return s.toLocaleDateString(void 0,{year:"numeric",month:"long"});case"datetime":return s.toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit",second:"2-digit"});case"iso":return s.toISOString();default:return s.toLocaleDateString(void 0,{month:"short",day:"numeric"})}}catch{return String(o)}}const Do="data-os-mode";function wt(o=typeof document<"u"?document.documentElement:null){return!!o&&o.getAttribute(Do)==="mobile"}function Mo(o){return o.phone??wt()?f`<os-select
	...
	>${o.segments.map(t=>f`<os-segment value=${t.value}>${t.label}</os-segment>`)}</os-segmented>`}function Io(o,e){const t=e.local??{},s={id:o,hasLocal:a=>Object.prototype.hasOwnProperty.call(t,a),runLocal:(a,r,l,c)=>{const p=t[a];if(!p)return r;const u={...r},g=p(u,l,c);return g===void 0?u:g},render:a=>{W(e.view(a),a.root),e.updated?.(a)},mounted:a=>e.mounted?.(a)},{placeholder:n}=e;n&&(s.placeholder=a=>n(a));const i=window;return(i.openStationApps??(i.openStationApps={}))[o]=s,s}function Re(o){const e=document.createElement("textarea");return e.innerHTML=o,e.value}`${btoa('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="currentColor"><rect x="6" y="6" width="23" height="23" rx="4"/><rect x="35" y="6" width="23" height="23" rx="4"/><rect x="6" y="35" width="23" height="23" rx="4"/><rect x="35" y="35" width="23" height="23" rx="4"/></svg>')}`,`${btoa('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="6" stroke-linecap="round"><path d="M10 22h44M10 42h44"/><circle cx="24" cy="22" r="7" fill="currentColor" stroke="none"/><circle cx="42" cy="42" r="7" fill="currentColor" stroke="none"/></svg>')}`;function Ho(o){try{(window.top??window).location.assign(o)}catch{window.location.assign(o)}}const Uo=800;function Fo(o,e=Uo){window.setTimeout(()=>{if(o){Ho(o);return}try{(window.top??window).location.reload()}catch{window.location.reload()}},e)}const Ct="os.plugin.changed",At="plugins-app";function Pe(o){return o.textdomain||o.plugin}function N(o){return o==="active"||o==="network-active"}function I(o){return o instanceof Error?o.message:String(o)}function qe(o){return o.endsWith(".php")?o:o+".php"}function Vo(o){let e=4294967295;for(let t=0;t<o.length;t++){e^=o.charCodeAt(t)&255;for(let s=0;s<8;s++)e=e&1?e>>>1^3988292384:e>>>1}return Math.max(1,(e^4294967295)>>>0)}function De(o,e){if(!o.rest.isOpenStationSelf(e))return!1;const t=o.installed.find(s=>s.plugin===e);return!t||!N(t.status)}function Me(o,e){o.toast(d(e?"OpenStation deleted. Reloading…":"OpenStation deactivated. Reloading…","desktop-mode"),2e3),Fo(o.extra.adminUrl??"")}async function Et(o,e){if(!e.some(s=>o.rest.isOpenStationSelf(s)))return;const t=o.extra.deactivationFeedback;if(t)try{const s=window.wp?.os;let n=s?.deactivationFeedback??window.openStationDeactivationFeedback;if(!n&&t.script.url&&typeof s?.loadVendorScript=="function"&&(await s.loadVendorScript(t.script.url,{handle:"os-deactivation-feedback",translations:t.script.translations}),n=s.deactivationFeedback??window.openStationDeactivationFeedback),!n)return;await n.ask({plugin:o.extra.selfPluginFile+".php",restUrl:t.restUrl,restNonce:"",context:"app",styleUrl:t.styleUrl})}catch{}}async function Ie(o,e){const t=await o.dispatch("activate",{plugin:e.plugin});return t&&o.broadcastChange({plugin:e.plugin,action:"activate"}),t}async function Wo(o,e){return await Et(o,[e.plugin]),await o.dispatch("deactivate",{plugin:e.plugin})?De(o,e.plugin)?(Me(o,!1),!0):(o.broadcastChange({plugin:e.plugin,action:"deactivate"}),!0):!1}async function jo(o,e){return await o.dispatch("delete",{plugin:e.plugin},{confirm:{title:d("Delete plugin?","desktop-mode"),message:y(d("Permanently delete %s? Its files will be removed from disk. This cannot be undone.","desktop-mode"),e.name||e.plugin),label:d("Delete","desktop-mode"),danger:!0}})?De(o,e.plugin)?(Me(o,!0),!0):(o.broadcastChange({plugin:e.plugin,action:"delete"}),!0):!1}async function St(o,e,t){try{await o.rest.installPluginBySlug(e)}catch(s){return o.toast(y(d("Install failed: %s","desktop-mode"),I(s)),6e3),!1}return await o.refresh(),o.toast(y(d("Installed %s.","desktop-mode"),Re(t))),o.broadcastChange({plugin:e,action:"install"}),o.refreshMenu(),!0}const Oo=6e4,$t=[];let He=!1;function Bo(o,e=Oo){return new Promise((t,s)=>{$t.push({run:o,resolve:t,reject:s,timeoutMs:e}),zt()})}async function zt(){if(He)return;const o=$t.shift();if(!o)return;He=!0;let e=null;try{const t=new Promise((n,i)=>{e=setTimeout(()=>{i(new Error("Update request timed out"))},o.timeoutMs)}),s=await Promise.race([o.run(),t]);o.resolve(s)}catch(t){o.reject(t)}finally{e!==null&&clearTimeout(e),He=!1,Promise.resolve().then(zt)}}const Ko=()=>({updating:new Set,autoUpdating:new Set,optimistic:new Map});function ke(o,e,t="small"){const s=document.createElement("os-button");return s.setAttribute("variant",e),t&&s.setAttribute("size",t),s.textContent=o,s}function O(o,e){if(!o)return()=>{};const t=o.textContent??"";return o.setAttribute("busy",""),o.setAttribute("disabled",""),o.setAttribute("aria-busy","true"),e!==void 0&&(o.textContent=e),()=>{o.removeAttribute("busy"),o.removeAttribute("disabled"),o.removeAttribute("aria-busy"),o.textContent=t}}function xe(o){return o.openstation_can_manage??{activate:o.status==="inactive",deactivate:N(o.status),delete:o.status==="inactive"}}function Nt(o,e,t={}){const s=t.size??"small",n=l=>c=>t.onDone?.(c!==!1,l),i=[],a=xe(e),r=e.openstation_update_available;if(o.extra.caps.update&&r?.available)if(r.package){const l=o.busy.updating.has(e.plugin),c=ke(d(l?"Updating…":"Update","desktop-mode"),"primary",s);l&&(c.setAttribute("disabled",""),c.setAttribute("aria-busy","true")),c.addEventListener("click",p=>{p.stopPropagation(),Zo(o,e).then(n("update"))}),i.push(c)}else{const l=document.createElement("span");l.className="os-plugins__update-hint",l.textContent=d("Auto-update unavailable","desktop-mode"),l.title=d("This plugin does not ship a wp.org download package. Update it manually from its source.","desktop-mode"),i.push(l)}if(o.extra.caps.activate&&a.activate){const l=ke(d("Activate","desktop-mode"),"primary",s);l.addEventListener("click",c=>{c.stopPropagation(),Lt(o,e,"active",()=>Ie(o,e)).then(n("activate"))}),i.push(l)}else if(o.extra.caps.activate&&a.deactivate){const l=ke(d("Deactivate","desktop-mode"),"secondary",s);l.addEventListener("click",c=>{c.stopPropagation(),Lt(o,e,"inactive",()=>Wo(o,e)).then(n("deactivate"))}),i.push(l)}if(o.extra.caps.delete&&a.delete){const l=ke(d("Delete","desktop-mode"),"danger",s);l.addEventListener("click",c=>{c.stopPropagation(),jo(o,e).then(n("delete"))}),i.push(l)}return i}async function Lt(o,e,t,s){o.busy.optimistic.set(e.plugin,t),o.repaint();try{return await s()}finally{o.busy.optimistic.delete(e.plugin),o.repaint()}}async function Tt(o,e){return Bo(async()=>{try{return await o.rest.updateInstalledPlugin(e)}finally{await o.refresh()}})}async function Zo(o,e){if(o.busy.updating.has(e.plugin))return!1;o.busy.updating.add(e.plugin),o.repaint();let t=!1;try{const s=await Tt(o,e);o.toast(y(d("%1$s updated to %2$s.","desktop-mode"),e.name||e.plugin,s.newVersion)),o.broadcastChange({plugin:e.plugin,action:"update"}),t=!0}catch(s){Go(s)?(o.toast(y(d("%s is already up to date.","desktop-mode"),e.name||e.plugin)),o.broadcastChange({plugin:e.plugin,action:"update"}),t=!0):o.toast(y(d("Update of %1$s failed: %2$s","desktop-mode"),e.name||e.plugin,I(s)),6e3)}finally{o.busy.updating.delete(e.plugin),o.repaint(),o.refreshMenu()}return t}function Go(o){if(o?.code==="up_to_date")return!0;const t=o?.message,s=window.wp?.i18n?.__?.("The plugin is at the latest version.");return!!s&&t===s}async function Yo(o,e){const t=e.openstation_auto_update;if(o.busy.autoUpdating.has(e.plugin)||!t||t.forced!==null||!t.supported)return;const s=t.enabled;o.busy.autoUpdating.add(e.plugin),o.repaint();try{await o.rest.toggleAutoUpdate(e,s?"disable":"enable"),o.toast(y(d(s?"Auto-updates disabled for %s.":"Auto-updates enabled for %s.","desktop-mode"),e.name||e.plugin)),o.broadcastChange({plugin:e.plugin,action:"auto-update"}),await o.refresh()}catch(n){o.toast(y(d("Could not toggle auto-updates for %1$s: %2$s","desktop-mode"),e.name||e.plugin,I(n)),6e3)}finally{o.busy.autoUpdating.delete(e.plugin),o.repaint()}}function Xo(o,e,t){const{caps:s}=o.extra,n=o.installed.filter(a=>e.includes(a.plugin)),i=[];if(s.update){const a=n.filter(r=>!!r.openstation_update_available?.available&&!!r.openstation_update_available.package);a.length>0&&i.push({label:y(d("Update %d","desktop-mode"),a.length),variant:"primary",run:()=>void Qo(o,a).then(t)})}if(s.activate){const a=n.filter(l=>l.status==="inactive"&&xe(l).activate);a.length>0&&i.push({label:d("Activate","desktop-mode"),variant:"primary",run:()=>void Ue(o,a,"activate").then(t)});const r=n.filter(l=>N(l.status)&&xe(l).deactivate);r.length>0&&i.push({label:d("Deactivate","desktop-mode"),variant:"secondary",run:()=>void Ue(o,r,"deactivate").then(t)})}if(s.delete){const a=n.filter(r=>r.status==="inactive"&&xe(r).delete);a.length>0&&i.push({label:d("Delete","desktop-mode"),variant:"danger",run:()=>void Ue(o,a,"delete").then(t)})}return i}async function Ue(o,e,t){const s=e.map(i=>i.plugin);if(t==="deactivate"&&await Et(o,s),!!await o.dispatch("bulk",{plugins:s,do:t},t==="delete"?{confirm:{title:d("Delete selected plugins?","desktop-mode"),message:y(d("Permanently delete %d plugin(s)? Their files will be removed from disk. This cannot be undone.","desktop-mode"),e.length),label:d("Delete","desktop-mode"),danger:!0}}:{})){if(t!=="activate"&&s.some(i=>De(o,i))){Me(o,t==="delete");return}o.broadcastChange({action:"bulk"},s)}}async function Qo(o,e){let t=0,s=0;for(const i of e){o.busy.updating.add(i.plugin),o.repaint();try{await Tt(o,i),t++}catch{s++}finally{o.busy.updating.delete(i.plugin),o.repaint()}}t>0&&o.broadcastChange({action:"bulk"},e.map(i=>i.plugin)),o.refreshMenu();const n=d("updated","desktop-mode");o.toast(s===0?y(d("%1$d plugin(s) %2$s.","desktop-mode"),t,n):y(d("%1$d %3$s, %2$d failed.","desktop-mode"),t,s,n),5e3)}const q=class q extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(Rt)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,s){if(t===s)return;const n=Jo(e);this._propValues[n]=s,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const s=(Array.isArray(e)?e:String(e).split(/\s+/)).map(n=>String(n).trim()).filter(n=>n!=="");this.className=s.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const s=Rt(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(s),set:n=>{let i;n==null||n===!1?i=null:n===!0?i="":i=String(n),this._propValues[t]=i,i===null?this.removeAttribute(s):this.setAttribute(s,i),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&W(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(s=>s.sheet).filter(s=>s!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const s of e.styles)if(!s.sheet){const n=document.createElement("style");n.textContent=s.cssText,this.shadowRoot.appendChild(n)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!q._lightStylesAdopted.has(e)){q._lightStylesAdopted.add(e);for(const t of e.styles){const s=document.createElement("style");s.dataset.osUi=this.tagName.toLowerCase(),s.textContent=t.cssText,document.head.appendChild(s)}}}};q.props=[],q.styles=[],q.shadow=!0,q._lightStylesAdopted=new WeakSet;let C=q;function E(o,e){customElements.get(o)||customElements.define(o,e)}function Rt(o){return o.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function Jo(o){return o.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const es=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function k(o,...e){let t=o[0];for(let s=1;s<o.length;s++){const n=e[s-1];if(typeof n=="string"||typeof n=="number")t+=String(n);else if(n&&n.__wpdCss)t+=n.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof n);t+=o[s]}if(es){const s=new CSSStyleSheet;return s.replaceSync(t),{__wpdCss:!0,sheet:s,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}const T=k`:host{--_holo-fill:var( --os-ui-holo-fill,${"linear-gradient( 124deg, #afa2e8 0%, #f5a8ea 46%, #8ee9f7 100% )"} );--_holo-ink:var( --os-ui-holo-ink,#0c0b0f );--_holo-sheen:var( --os-ui-holo-sheen,linear-gradient( 124deg,rgba( 159,214,255,0.1 ) 0%,rgba( 236,155,255,0.12 ) 34%,rgba( 242,82,252,0.1 ) 58%,rgba( 147,240,198,0.09 ) 100% ) );--_holo-edge:var( --os-ui-holo-edge,linear-gradient( 124deg,rgba( 154,242,255,0.7 ) 0%,rgba( 236,155,255,0.85 ) 38%,rgba( 242,82,252,0.7 ) 62%,rgba( 159,152,255,0.6 ) 100% ) );--_holo-edge-quiet:var( --os-ui-holo-edge-quiet,linear-gradient( 124deg,rgba( 154,242,255,0.22 ) 0%,rgba( 236,155,255,0.28 ) 38%,rgba( 242,82,252,0.22 ) 62%,rgba( 159,152,255,0.2 ) 100% ) );--_holo-glow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) );--_holo-glow-strong:var( --os-ui-holo-glow-strong,0 0 0 1px rgba( 242,82,252,0.42 ),0 4px 18px rgba( 242,82,252,0.38 ),0 1px 3px rgba( 12,11,15,0.6 ) );--_holo-track:var( --os-ui-holo-track,rgba( 255,251,255,0.16 ) );--_holo-track-edge:var( --os-ui-holo-track-edge,#8c8f94 );--_holo-ring-color:var( --os-ui-accent-dim,#2271b1 );--_holo-focus:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #f252fc,0 0 12px 2px rgba( 242,82,252,0.45 ) );--_holo-focus-field:var( --os-ui-focus-ring-field,0 0 0 1px #f252fc,0 0 0 4px rgba( 242,82,252,0.18 ) );--_holo-t:var( --os-ui-holo-transition,220ms );--_holo-t-fast:var( --os-ui-motion-fast,140ms );--_holo-t-slow:var( --os-ui-motion-slow,340ms );--_holo-t-ambient:var( --os-ui-motion-ambient,12s );--_holo-spring:var( --os-ui-ease-spring,cubic-bezier( 0.32,1.5,0.55,1 ) );--_holo-ease:var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) );--_holo-loop:var( --os-ui-ease-loop,cubic-bezier( 0.45,0,0.55,1 ) )}`,ts=k` .os-holo-fill{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --_holo-ink );transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease}.os-holo-fill:hover{background-position:74% 66%}.os-holo-fill:active{background-position:88% 82%;filter:brightness( 0.94 )}@media ( prefers-reduced-motion:reduce ){.os-holo-fill{transition-duration:1ms}.os-holo-fill:hover,.os-holo-fill:active{background-position:22% 28%}}`,Pt=k` .os-holo-sheen{position:relative;isolation:isolate}.os-holo-sheen::before{content:'';position:absolute;inset:0;z-index:-1;border-radius:inherit;background-image:var( --_holo-sheen );background-size:200% 200%;background-position:20% 30%;opacity:0;pointer-events:none;transition:opacity var( --_holo-t ) ease,background-position var( --_holo-t ) ease}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{opacity:1;background-position:76% 68%}@media ( prefers-reduced-motion:reduce ){.os-holo-sheen::before{transition-duration:1ms}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{background-position:20% 30%}}`,qt=k` .os-holo-edge{position:relative}.os-holo-edge::after{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;background-image:var( --_holo-edge-quiet );opacity:0;pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude;transition:opacity var( --_holo-t ) ease}.os-holo-edge:hover::after,.os-holo-edge:focus-visible::after{background-image:var( --_holo-edge );opacity:1}.os-holo-edge.is-lit::after{background-image:var( --_holo-edge );opacity:1}@media ( prefers-reduced-motion:reduce ){.os-holo-edge::after{transition-duration:1ms}}`,Fe=k` .os-holo-glint{position:absolute;inset:0;border-radius:inherit;overflow:hidden;pointer-events:none}.os-holo-glint::before{content:'';position:absolute;top:-60%;bottom:-60%;width:45%;inset-inline-start:-60%;background:linear-gradient( 90deg,transparent 0%,rgba( 255,251,255,0.14 ) 45%,rgba( 255,251,255,0.22 ) 50%,rgba( 255,251,255,0.14 ) 55%,transparent 100% );transform:rotate( 18deg ) translateX( 0 );opacity:0}:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:os-holo-glint var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-glint{0%{opacity:0;transform:rotate( 18deg ) translateX( 0 )}15%{opacity:1}85%{opacity:1}100%{opacity:0;transform:rotate( 18deg ) translateX( 240vw )}}@media ( prefers-reduced-motion:reduce ){:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:none}}`,Dt=k` .os-holo-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:0 0 0 0 var( --_holo-ring-color );opacity:0;pointer-events:none}:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:os-holo-ring var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-ring{0%{opacity:0.45;box-shadow:0 0 0 0 var( --_holo-ring-color )}100%{opacity:0;box-shadow:0 0 0 10px transparent}}@media ( prefers-reduced-motion:reduce ){:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:none}}`,os=k` .os-holo-shimmer{background-image:var( --_holo-fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}@keyframes os-holo-shimmer{0%{background-position:0% 50%}100%{background-position:100% 50%}}@media ( prefers-reduced-motion:reduce ){.os-holo-shimmer{animation:none;background-position:30% 50%}}`,Mt=k` .os-holo-enter{animation:os-holo-enter var( --_holo-t ) var( --_holo-spring )}@keyframes os-holo-enter{from{opacity:0;transform:scale( 0.96 )}}@media ( prefers-reduced-motion:reduce ){.os-holo-enter{animation:none}}`,ss=k` input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):hover:not(:disabled ),select:hover:not(:disabled ),textarea:hover:not(:disabled ){border-color:var( --os-ui-border-strong,#8c8f94 )}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus,input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus-visible,select:focus,select:focus-visible,textarea:focus,textarea:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}input::placeholder,textarea::placeholder{color:var( --os-ui-fg-faint,#8c8f94 );opacity:1}input::selection,textarea::selection{background:var( --os-ui-selection-bg,rgba( 159,152,255,0.6 ) );color:var( --os-ui-selection-fg,#fffbff )}@media ( prefers-reduced-motion:reduce ){input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition-duration:1ms}}`,Ve=k` input[ type='checkbox' ],input[ type='radio' ]{appearance:none;-webkit-appearance:none;position:relative;flex:0 0 auto;box-sizing:border-box;width:16px;height:16px;margin:0;padding:0;border:1px solid var( --_holo-track-edge );border-radius:4px;background-color:var( --_holo-track );background-image:none;background-repeat:no-repeat;cursor:inherit;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='radio' ]{border-radius:50%}input[ type='checkbox' ]:hover:not(:disabled ),input[ type='radio' ]:hover:not(:disabled ){border-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:focus-visible,input[ type='radio' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked,input[ type='checkbox' ]:indeterminate,input[ type='radio' ]:checked{border-color:transparent;background-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:checked:focus-visible,input[ type='radio' ]:checked:focus-visible{box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:46%;width:3.5px;height:7.5px;border:solid var( --os-ui-accent-ink,var( --os-ui-fg-on-accent,#fff ) );border-width:0 2px 2px 0;transform:translate( -50%,-50% ) rotate( 45deg );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:indeterminate::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:8px;height:2px;border:0;border-radius:1px;background:var( --os-ui-accent-ink,var( --os-ui-fg-on-accent,#fff ) );transform:translate( -50%,-50% )}input[ type='radio' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:6px;height:6px;border-radius:50%;background:var( --os-ui-accent-ink,var( --os-ui-fg-on-accent,#fff ) );transform:translate( -50%,-50% );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:disabled,input[ type='radio' ]:disabled{cursor:not-allowed}@keyframes os-holo-tick{from{opacity:0;transform:translate( -50%,-50% ) rotate( 45deg ) scale( 0.4 )}}@media ( prefers-reduced-motion:reduce ){input[ type='checkbox' ]:checked::after,input[ type='radio' ]:checked::after{animation:none}}`,It=k` @keyframes os-holo-drift{0%{background-position:16% 26%}50%{background-position:84% 74%}100%{background-position:16% 26%}}.os-holo-alive{animation:os-holo-drift var( --_holo-t-ambient ) var( --_holo-loop ) infinite}@media ( prefers-reduced-motion:reduce ){.os-holo-alive{animation:none}}`;k` ${T} ${ts} ${Pt} ${qt} ${Fe} ${Dt} ${os} ${Mt} ${ss} ${Ve} ${It} `;const ns=k` ${T} ${Fe}:host(:not( [ interactive ] ) ) .os-holo-glint,:host( [ disabled ] ) .os-holo-glint{display:none}:host{display:flex;flex-direction:column;position:relative;gap:var( --os-ui-card-gap,12px );padding:var( --os-ui-card-padding,16px );border:1px solid var( --os-ui-card-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-radius:var( --os-ui-card-radius,12px );background:var( --os-ui-card-bg,var( --os-ui-surface,#fff ) );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );color:var( --os-ui-card-fg,inherit );box-sizing:border-box;min-width:0;transition:transform 180ms ease,box-shadow 180ms ease,border-color 180ms ease}:host( [ hidden ] ){display:none}:host( [ compact ] ){padding:var( --os-ui-card-padding-compact,10px );gap:var( --os-ui-card-gap-compact,6px );border-radius:var( --os-ui-card-radius-compact,8px )}:host( [ interactive ] ){cursor:pointer;outline-offset:2px}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:translateY( -2px );box-shadow:var( --os-ui-card-shadow-hover,0 4px 16px rgba( 0,0,0,0.08 ) );border-color:var( --os-ui-card-border-hover,var( --os-ui-border-strong,rgba( 0,0,0,0.16 ) ) )}:host( [ interactive ]:focus-visible ){outline:none;box-shadow:var( --_holo-focus )}:host( [ selected ] ){border-color:var( --os-ui-card-border-selected,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --os-ui-card-shadow-selected,0 0 0 1px var( --wp-admin-theme-color,#2271b1 ) inset )}:host( [ selected ] )::after{content:'';position:absolute;inset:-1px;border-radius:inherit;padding:1px;background-image:var( --_holo-edge );pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude}:host( [ disabled ] ){opacity:0.55;pointer-events:none;cursor:not-allowed}@media ( prefers-reduced-motion:reduce ){:host{transition:none}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:none}}::slotted( header ){display:flex;align-items:center;gap:12px;min-width:0}::slotted( footer ){display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:auto}`,Ht="[data-noclick]",Q=class Q extends C{constructor(){super(...arguments),this._onClick=e=>{!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.target?.closest(Ht)||this._emitCardClick(e)},this._onKeyDown=e=>{if(!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.key!=="Enter"&&e.key!==" "&&e.key!=="Spacebar")return;const t=e.target;t&&t!==this&&t.closest(Ht)||t instanceof HTMLElement&&t!==this&&(t.tagName==="BUTTON"||t.tagName==="A"||t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT")||(e.preventDefault(),this._emitCardClick(e))}}connectedCallback(){super.connectedCallback(),this._syncRoles(),this.addEventListener("click",this._onClick),this.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){this.removeEventListener("click",this._onClick),this.removeEventListener("keydown",this._onKeyDown)}render(){return this._syncRoles(),f`<span class="os-holo-glint" aria-hidden="true"></span
		...
		`};let Xe=oe;E("os-tabpanel",Xe);function xs(o,e,t){const s=o.querySelectorAll(`:scope > ${e}`);for(const n of Array.from(s))n.remove();for(const n of t){const i=document.createElement(e);i.setAttribute("value",n.value),i.textContent=n.label,o.appendChild(i)}}function ws(o){const e=o.parentElement;if(!e)return null;const t=e.querySelector(":scope > os-tabs");return t||o.closest("os-tabs")}function Kt(o,e){const t=new Set,s=o.parentElement;if(s)for(const n of Array.from(s.querySelectorAll(":scope > os-tabpanel")))t.add(n);for(const n of Array.from(o.querySelectorAll(":scope > os-tabpanel")))t.add(n);for(const n of t){const i=n.getAttribute("for"),a=i!==null&&i===e;a?n.removeAttribute("hidden"):n.setAttribute("hidden",""),n.setAttribute("aria-hidden",a?"false":"true")}}const Cs=k`:host{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );color:inherit;line-height:1}:host( [ hidden ] ){display:none}.os-icon__glyph{font-size:var( --os-ui-icon-size,16px );width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );line-height:1;color:inherit;display:inline-flex;align-items:center;justify-content:center}.os-icon__glyph--char{font-family:dashicons;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;speak:none}.os-icon__glyph.dashicons{font-family:dashicons}`;let Se=null;function As(o){let e=o.trim();if(e==="")return null;(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))&&(e=e.slice(1,-1));const t=e.match(/^\\([0-9a-f]{1,6})\s?$/i);return t?String.fromCodePoint(parseInt(t[1],16)):e||null}function Zt(){const o=new Map;if(typeof document>"u")return o;const e=Array.from(document.styleSheets??[]);for(const t of e){let s=null;try{s=t.cssRules}catch{continue}if(s)for(const n of Array.from(s)){const i=n;if(!i||!i.selectorText)continue;const a=i.selectorText.match(/\.dashicons-([a-z0-9-]+)::?before/i);if(!a)continue;const r=i.style?.content;if(!r)continue;const l=As(r);l&&o.set(a[1],l)}}return o}function Es(o){Se||(Se=Zt());const e=o.startsWith("dashicons-")?o.slice(10):o;return Se.get(e)??null}function Ss(){Se=Zt()}let Gt=!1;function $s(){if(Gt||typeof window>"u")return;Gt=!0;const o=()=>{Ss()};document.readyState==="loading"&&document.addEventListener("DOMContentLoaded",o,{once:!0}),window.addEventListener("load",o,{once:!0})}$s();const se=class se extends C{render(){const e=this.name||"",t=e.startsWith("dashicons-")?e.slice(10):e,s=this.size;s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-icon-size",`${s}px`);const n=Es(t);return n?f`<span
				class="os-icon__glyph os-icon__glyph--char dashicons dashicons-${t}"
				aria-hidden="true"
			>${n}</span>`:f`<span
			class="os-icon__glyph dashicons dashicons-${t}"
			aria-hidden="true"
		></span>`}};se.props=["name","size"],se.styles=[Cs],se.help=void 0;let Qe=se;E("os-icon",Qe);const zs=k`:host{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;padding:32px 24px;text-align:center;color:var( --os-ui-empty-state-fg,var( --os-ui-fg-muted,#646970 ) )}:host( [ hidden ] ){display:none}.os-empty-state__icon{margin-bottom:4px;color:var( --os-ui-empty-state-icon-color,currentColor );opacity:0.75}.os-empty-state__heading{margin:0;font-size:14px;font-weight:600;color:var( --os-ui-fg,#1d2327 )}.os-empty-state__description{margin:0;font-size:12px;line-height:1.4;max-width:48ch}.os-empty-state__description:empty{display:none}.os-empty-state__cta{margin-top:8px}.os-empty-state__cta:empty{display:none}`,ne=class ne extends C{render(){const e=this.icon||"",t=this.heading||"",s=this.description||"";return f`
			${e?f`<os-icon
		...
		`}};ie.props=["rating","total"],ie.styles=[Ns],ie.help=void 0;let et=ie;function Yt(o,e){const t=o.getAttribute(e);if(t===null||t==="")return 0;const s=Number(t);return Number.isFinite(s)?s:0}function Ls(o){return o<0?0:o>100?100:o}function Ts(o,e){return e===0?"No ratings yet":`Average rating ${(o/100*5).toFixed(1)} out of 5, from ${e} ratings`}function Rs(o){const e=Math.floor(o),t=o-e>=.5?1:0,s=5-e-t,n=[];for(let i=0;i<e;i++)n.push(Xt());for(let i=0;i<t;i++)n.push(Ps());for(let i=0;i<s;i++)n.push(qs());return n}function Xt(){return f`
		<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
			<path
				d="M8 1.5l2.06 4.17 4.6.67-3.33 3.25.79 4.58L8 12L3.88 14.17l.79-4.58L1.34 6.34l4.6-.67L8 1.5z"
			/>
		</svg>
	`}function Ps(){return f`
	...
	`}E("os-rating-summary",et);const Qt=`
...
`;function Ds(o){const e=document.createElement("os-rating-summary");typeof o.rating=="number"&&e.setAttribute("rating",String(o.rating)),o.num_ratings&&e.setAttribute("total",String(o.num_ratings));const t={},s=o.ratings??{};for(const n of["1","2","3","4","5"]){const i=s[n];typeof i=="number"&&(t[n]=i)}return e.ratings=t,e}function Z(o){const e=document.createElement("div");e.className="os-plugins__reviews-loading";const t=document.createElement("os-spinner");t.setAttribute("preset","classic"),t.setAttribute("size","20");const s=document.createElement("span");return s.textContent=o,e.append(t,s),e}function G(o,e,t){const s=document.createElement("os-empty-state");return s.setAttribute("icon",`dashicons-${o}`),s.setAttribute("heading",e),s.setAttribute("description",t),s}function Jt(o,e,t){const s=document.createElement("div");if(s.className="os-plugins__reviews",!t)return s.appendChild(Z(d("Loading from WordPress.org…","desktop-mode"))),s;s.appendChild(Ds(t));const n=document.createElement("div");s.appendChild(n);const i=o.caches.reviews.get(e);return i?(eo(n,i,e),s):(n.appendChild(Z(d("Loading recent reviews…","desktop-mode"))),(async()=>{try{const a=await o.rest.fetchPluginReviews(e);o.caches.reviews.set(e,a),n.isConnected&&eo(n,a,e)}catch{n.isConnected&&n.replaceChildren(G("warning",d("Couldn’t load reviews","desktop-mode"),d("WordPress.org didn’t respond. Try again in a moment.","desktop-mode")))}})(),s)}function eo(o,e,t){o.replaceChildren();const s=Ce(t,"#reviews");if(!e.parsed){const a=G("external",d("Reviews live on WordPress.org","desktop-mode"),d("We couldn’t pull the review feed here. Open the full thread on WordPress.org to read every review.","desktop-mode")),r=H("primary",d("Open reviews on WordPress.org ↗","desktop-mode"),s,"small");r.setAttribute("slot","cta"),a.appendChild(r),o.appendChild(a);return}if(e.items.length===0){const a=document.createElement("div");a.className="os-plugins__reviews-cta",a.appendChild(H("primary",d("Write a review on WordPress.org ↗","desktop-mode"),`https://wordpress.org/support/plugin/${encodeURIComponent(t)}/reviews/#new-post`,"small")),o.appendChild(a);return}const n=document.createElement("div");n.className="os-plugins__reviews-grid";for(const a of e.items)n.appendChild(Ms(a));o.appendChild(n);const i=document.createElement("div");i.className="os-plugins__reviews-more",i.appendChild(H("ghost",d("Read all reviews on WordPress.org ↗","desktop-mode"),s,"small")),o.appendChild(i)}function Ms(o){const e=document.createElement("os-card");e.setAttribute("compact",""),e.className="os-plugins__review";const t=document.createElement("div");t.setAttribute("slot","header"),t.className="os-plugins__review-head";const s=document.createElement("strong");if(s.textContent=o.author||d("Anonymous","desktop-mode"),t.append(s,Ae(o.stars/5*100,0)),o.date){const n=document.createElement("span");n.className="os-plugins__review-date",n.textContent=o.date,t.appendChild(n)}if(e.appendChild(t),o.excerpt){const n=document.createElement("p");n.className="os-plugins__review-body",n.textContent=o.excerpt,e.appendChild(n)}if(o.url){const n=document.createElement("div");n.setAttribute("slot","footer"),n.appendChild(B(o.url,d("Read full review ↗","desktop-mode"),"os-plugins__review-link")),e.appendChild(n)}return e}let to=0;function Is(o,e,t,s){const n=++to,i=()=>n===to&&o.isConnected;o.replaceChildren();const a=document.createElement("div");a.className="os-plugins__flyout";const r=document.createElement("style");r.textContent=Qt;const l=Hs(t),c=Us(),p=document.createElement("div");p.className="os-plugins__flyout-body";const u=document.createElement("footer");u.className="os-plugins__flyout-footer",a.append(r,l.root,c.root,p,u),o.appendChild(a),o.setAttribute("open","");let g=s.caches.info.get(e)??null;const b=()=>{js(u,e,g,s,()=>o.removeAttribute("open"),b)};b();const h=_=>Fs(p,_,g,e,s);c.onChange(h),g&&so(l,g),h("overview"),!g&&(async()=>{try{const _=await s.rest.fetchPluginInfo(e);if(s.caches.info.set(e,_),!i())return;g=_,so(l,g),b(),h(c.current())}catch(_){if(!i())return;const m=document.createElement("p");m.className="os-plugins__flyout-error",m.textContent=_ instanceof Error?_.message:d("Could not load plugin details.","desktop-mode"),p.replaceChildren(m)}})()}function Hs(o){const e=document.createElement("header");e.className="os-plugins__flyout-hero";const t=document.createElement("div");t.className="os-plugins__flyout-banner",e.appendChild(t);const s=document.createElement("div");s.className="os-plugins__flyout-hero-inner";const n=document.createElement("div");n.className="os-plugins__flyout-hero-icon";const i=document.createElement("div");i.className="os-plugins__flyout-hero-text";const a=document.createElement("h2");a.className="os-plugins__flyout-hero-title";const r=document.createElement("p");r.className="os-plugins__flyout-hero-byline";const l=document.createElement("div"),c=document.createElement("div");l.appendChild(c),i.append(a,r,l),s.append(n,i),e.appendChild(s);const p=document.createElement("button");p.type="button",p.className="os-plugins__flyout-close",p.setAttribute("data-flyout-close",""),p.setAttribute("aria-label",d("Close plugin details","desktop-mode")),p.innerHTML=Ze("close",{size:20}),e.appendChild(p);const u={root:e,icon:n,title:a,byline:r,stars:c,meta:l,banner:t};return o&&oo(u,o),u}function oo(o,e){o.title.textContent=$(e.name),o.byline.textContent=y(d("by %s","desktop-mode"),$(e.author??"")),o.icon.replaceChildren();const t=Ee(e.icons);if(t){const s=document.createElement("img");s.src=t,s.alt="",o.icon.appendChild(s)}o.stars.replaceChildren(Ae(e.rating??0,e.num_ratings??0))}function so(o,e){oo(o,e);const t=e.banners?.high??e.banners?.low;t&&(o.banner.style.backgroundImage=`url("${t}")`,o.banner.classList.add("has-banner")),o.meta.querySelectorAll(":scope > .os-plugins__flyout-meta-row").forEach(a=>a.remove());const s=document.createElement("div");s.className="os-plugins__flyout-meta-row";const n=document.createElement("span");n.textContent=y(d("%s+ active","desktop-mode"),new Intl.NumberFormat().format(e.active_installs??0));const i=document.createElement("span");if(i.textContent=y(d("Updated %s","desktop-mode"),e.last_updated?xt(e.last_updated.slice(0,10),"long"):"—"),s.append(n,i),e.tested){const a=document.createElement("span");a.textContent=y(d("Tested up to WordPress %s","desktop-mode"),e.tested),s.appendChild(a)}o.meta.appendChild(s)}function Us(){const o=document.createElement("os-tabs");o.className="os-plugins__flyout-tabs",o.setAttribute("value","overview");const e=[{value:"overview",label:d("Overview","desktop-mode")},{value:"screenshots",label:d("Screenshots","desktop-mode")},{value:"reviews",label:d("Reviews","desktop-mode")},{value:"changelog",label:d("Changelog","desktop-mode")},{value:"faq",label:d("FAQ","desktop-mode")}];for(const n of e){const i=document.createElement("os-tab");i.setAttribute("value",n.value),i.textContent=n.label,o.appendChild(i)}let t="overview";const s=new Set;return o.addEventListener("os-tab-change",n=>{t=n.detail?.value??"overview";for(const a of s)a(t)}),{root:o,current:()=>t,onChange:n=>s.add(n)}}function Fs(o,e,t,s,n){if(o.replaceChildren(),!t){o.appendChild(Ws(4));return}e==="overview"?o.appendChild(tt(t.sections?.description??t.short_description??"")):e==="screenshots"?o.appendChild(Vs(t.screenshots)):e==="changelog"?o.appendChild(tt(t.sections?.changelog??"")):e==="faq"?o.appendChild(tt(t.sections?.faq??"")):o.appendChild(Jt(n,s,t))}function tt(o){if(!o){const e=document.createElement("div");return e.className="os-plugins__html",e.appendChild(no(d("No content available.","desktop-mode"))),e}return Oe(o,"os-plugins__html")}function no(o){const e=document.createElement("p");return e.className="os-plugins__empty-line",e.textContent=o,e}function Vs(o){const e=document.createElement("div");e.className="os-plugins__screenshots";const t=o?Object.values(o):[];if(t.length===0)return e.appendChild(no(d("This plugin doesn’t ship screenshots.","desktop-mode"))),e;for(const s of t){const n=document.createElement("figure");n.className="os-plugins__screenshot";const i=document.createElement("img");if(i.src=s.src,i.loading="lazy",i.alt=$(s.caption??""),n.appendChild(i),s.caption){const a=document.createElement("figcaption");a.innerHTML=Ut(s.caption),Vt(a),n.appendChild(a)}e.appendChild(n)}return e}function Ws(o){const e=document.createElement("div");e.className="os-plugins__skeleton";for(let t=0;t<o;t++){const s=document.createElement("span");s.className="os-plugins__skeleton-line",s.style.width=`${60+t*10%40}%`,e.appendChild(s)}return e}function js(o,e,t,s,n,i){o.replaceChildren();const a=s.extra.caps,r=s.installedFor(e),l=document.createElement("div");l.appendChild(B(Ce(e),d("View on WordPress.org ↗","desktop-mode"),"os-plugins__flyout-wporg"));const c=document.createElement("div");if(c.className="os-plugins__flyout-footer-right",r)c.append(...Nt(s,r,{size:"",onDone:(p,u)=>{p&&u==="delete"?n():i()}}));else if(a.install){const p=document.createElement("os-button");p.setAttribute("variant","primary"),p.textContent=d("Install","desktop-mode"),p.addEventListener("click",()=>{O(p,d("Installing…","desktop-mode")),St(s,e,t?.name??e).catch(u=>s.toast(I(u),6e3)).finally(i)}),c.appendChild(p)}o.append(l,c)}const io=24;function ao(o){const{host:e}=o,t=new Map,s=()=>new Map(e.installed.map(r=>[Pe(r),r])),n=r=>r.querySelector("[data-plugin-card-cta]"),i={onOpen:(r,l)=>{const c=o.flyout();c&&Is(c,r,l,e)},onInstall:async(r,l)=>{const c=O(n(l),d("Installing…","desktop-mode"));await St(e,r.slug,r.name)||c(),a()},onActivate:async(r,l)=>{const c=O(n(l),d("Activating…","desktop-mode"));await Ie(e,r)||c(),a()}},a=()=>{const r=s();for(const{plugin:l,card:c}of t.values())ds(c,l,r,i)};return{plugins:t,callbacks:i,installedIndex:s,repaintCtas:a,addCard:(r,l,c,p)=>{const u=ls(l,s(),i);if(p){u.classList.add("os-plugins__card--featured");const g=document.createElement("os-ribbon");g.textContent=d("Featured","desktop-mode"),u.prepend(g)}ps(u,l),r.insertBefore(u,c),t.set(l.slug,{plugin:l,card:u})},clear:()=>t.clear(),showStatus:(r,l)=>{r.hidden=!1,r.textContent=l},hideStatus:r=>{r.hidden=!0,r.textContent=""}}}function Os(o){const e=ao(o),t=document.createElement("div");t.className="os-plugins__gallery-sentinel",t.setAttribute("aria-hidden","true");let s=null,n=null,i=null,a="",r="featured",l="",c=1,p=0,u=!1,g=!1;const b=[],h=async()=>{if(s){c=1,p=0,g=!1,e.clear(),s.replaceChildren();for(let m=0;m<6;m++)s.appendChild(Be());s.appendChild(t),await _()}},_=async()=>{if(!(!s||!n||u||g)){if(u=!0,c>1&&b.length===0)for(let m=0;m<4;m++){const w=Be();s.insertBefore(w,t),b.push(w)}try{const m=await o.host.rest.browsePlugins({browse:l===""?r:void 0,search:l===""?void 0:l,page:c,perPage:io});c===1&&(s.replaceChildren(),s.appendChild(t));const w=m.info??{};typeof w.pages=="number"&&w.pages>0&&(p=w.pages);const x=m.plugins??[];if(x.length===0){g=!0,c===1&&e.showStatus(n,d("No plugins matched.","desktop-mode"));return}for(const S of x)S?.slug&&!e.plugins.has(S.slug)&&e.addCard(s,S,t,!1);c++,(p>0?c>p:x.length<io)&&(g=!0),e.hideStatus(n)}catch(m){e.showStatus(n,y(d("Could not load plugins: %s","desktop-mode"),I(m)))}finally{for(const m of b)m.remove();b.length=0,u=!1}}};return{sync:m=>{n=m.status,m.gallery!==s&&(s=m.gallery,i?.disconnect(),i=null,a="",s&&(i=new IntersectionObserver(x=>{x.some(S=>S.isIntersecting)&&_()},{root:s,rootMargin:"240px",threshold:0}),i.observe(t)));const w=`${m.filter}|${m.query}`;s&&m.active&&w!==a&&(a=w,r=m.filter,l=m.query,h())},reset:()=>void h(),repaintCtas:e.repaintCtas,dispose:()=>{i?.disconnect(),i=null}}}function Bs(o){const e=ao(o);let t=null,s=!1;const n=async i=>{if(t){s=!0,t.replaceChildren(),e.clear();for(let a=0;a<3;a++)t.appendChild(Be());try{const a=await o.host.rest.fetchFeaturedPlugins();t.replaceChildren();for(const r of a.plugins??[])r?.slug&&e.addCard(t,r,null,!!r.featured);i&&(e.plugins.size===0?e.showStatus(i,d("No featured plugins yet.","desktop-mode")):e.hideStatus(i))}catch(a){t.replaceChildren(),s=!1,i&&e.showStatus(i,y(d("Could not load featured plugins: %s","desktop-mode"),I(a)))}}};return{sync:i=>{i.gallery&&i.gallery!==t&&(t=i.gallery,s=!1),t&&i.active&&!s&&n(i.status)},repaintCtas:e.repaintCtas}}const Ks=k` ${T} ${Pt} ${qt} ${Fe} ${Dt} ${It}:host{display:inline-flex}:host( [ fill-cell ] ){display:flex;width:100%}button{appearance:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:var( --os-ui-button-padding,6px 12px );border-radius:var( --os-ui-button-border-radius,6px );font:inherit;font-weight:500;cursor:pointer;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,transform 80ms ease;background:var( --os-ui-button-bg,transparent );background-image:var( --os-ui-button-bg-image,none );background-repeat:var( --os-ui-button-bg-image-repeat,repeat );background-size:var( --os-ui-button-bg-image-size,auto );background-position:var( --os-ui-button-bg-image-position,center );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ fill-cell ] ) button{width:100%;min-height:var( --os-ui-button-min-height,44px )}button:disabled{opacity:0.5;cursor:not-allowed}button:active:not(:disabled ){transform:translateY( 1px )}button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before,button:disabled::after,button:disabled .os-holo-glint{opacity:0 !important}:host( [ variant='primary' ] ) button{background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-button-fg,var( --os-ui-accent-ink,var( --os-ui-fg-on-accent,#fff ) ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 );background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --_holo-glow )}:host( [ variant='holo' ] ) button{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --os-ui-button-fg,var( --_holo-ink ) );border:var( --os-ui-button-border,1px solid transparent );box-shadow:var( --_holo-glow );font-weight:600;transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease,transform 80ms ease}:host( [ variant='holo' ] ) button:hover:not(:disabled ){background-color:transparent;background-position:74% 66%;box-shadow:var( --_holo-glow-strong )}:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:88% 82%;filter:brightness( 0.94 )}:host( [ variant='holo' ] ) button::before{display:none}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ] ) button:hover:not(:disabled ),:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:22% 28%}}:host( [ variant='secondary' ] ) button{background-color:var( --os-ui-button-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='secondary' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}:host( [ variant='danger' ] ) button{background-color:var( --os-ui-button-bg,transparent );color:var( --os-ui-button-fg,var( --os-ui-danger,#d63638 ) );border:var( --os-ui-button-border,1px solid currentColor )}:host( [ variant='danger' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-danger,#d63638 );color:var( --os-ui-fg-on-accent,#fff )}:host( [ variant='danger' ] ) button::after{display:none}:host( [ variant='link' ] ) button{background-color:transparent;background-image:none;color:var( --os-ui-button-fg,var( --wp-admin-theme-color,#2271b1 ) );border:0;padding:0;text-decoration:underline}:host( [ variant='link' ] ) button::before,:host( [ variant='link' ] ) button::after,:host( [ variant='link' ] ) .os-holo-glint,:host( [ variant='link' ] ) .os-holo-ring{display:none}:host( [ variant='link' ] ) button:active:not(:disabled ){transform:none}:host( [ busy ] ) button{pointer-events:none;opacity:0.75}:host( [ variant='holo' ][ busy ] ) button{animation:os-holo-drift 12s ease-in-out infinite}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ][ busy ] ) button{animation:none}}.os-button__spinner{box-sizing:border-box;display:inline-block;width:12px;height:12px;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:os-button-spin 0.6s linear infinite;flex-shrink:0}@keyframes os-button-spin{to{transform:rotate( 360deg )}}`,ae=class ae extends C{render(){const e=this.disabled!==null,t=this.busy!==null,s=this.type||"button";return f`
		...
		`}};ae.props=["variant","disabled","type","busy","fill-cell"],ae.styles=[Ks],ae.help=void 0;let ot=ae;E("os-button",ot);const Zs=k` ${T} ${Ve}:host{display:inline-flex;align-items:center;gap:6px;font-size:13px;color:var( --os-ui-fg,#1d2327 );cursor:pointer}:host( [ disabled ] ){cursor:not-allowed;opacity:0.55}:host( [ block ] ){display:flex;cursor:default}:host( [ block ] ) label{cursor:pointer}:host( [ block ][ disabled ] ) label{cursor:not-allowed}label{display:inline-flex;align-items:center;gap:6px;cursor:inherit}.os-checkbox__label{line-height:1.3}.os-checkbox__label:empty{display:none}`,re=class re extends C{render(){const e=this.checked!==null,t=this.disabled!==null,s=this.label||"",n=this.value;return f`
			<label>
				<input
					type="checkbox"
					.checked=${e}
...
`+Qt,lo=new WeakMap;function co(o,e,t){let s=lo.get(o);if(s||(s=new Set,lo.set(o,s)),s.has(e))return;if(s.add(e),"adoptedStyleSheets"in o&&typeof CSSStyleSheet<"u"&&"replaceSync"in CSSStyleSheet.prototype){const i=new CSSStyleSheet;i.replaceSync(t),o.adoptedStyleSheets=[...o.adoptedStyleSheets,i];return}const n=document.createElement("style");n.setAttribute("data-os-plugins-styles",e),n.textContent=t,o.appendChild(n)}function Y(o,e=""){return f`<span class="os-plugins__table-line ${e}" title=${o}>${o}</span>`}function rn(o){return[{key:"name",label:d("Plugin","desktop-mode"),render:(e,t)=>{const s=$(t.name)||t.plugin;return f`<div class="os-plugins__table-identity">${o.icon(t)}<div class="os-plugins__table-copy">
		...
		`}_onDismiss(e){if(e.stopPropagation(),this.disabled!==null)return;const s=this.label??"";this.emit("os-chip-dismiss",{label:s})}};ge.props=["label","tone","size","dismissible","disabled","pending","selected"],ge.styles=[hn],ge.help=void 0;let ct=ge;E("os-chip",ct);const gn=k`:host{display:flex;flex-direction:row;flex-wrap:wrap;gap:var( --os-ui-cluster-gap,8px );justify-content:var( --os-ui-cluster-justify,flex-start );align-items:var( --os-ui-cluster-align,center )}:host( [ hidden ] ){display:none}`,fe=class fe extends C{render(){const e=this.gap,t=this.justify,s=this.align,n=e&&/^\d+$/.test(e)?`${e}px`:"";return n&&this.style.setProperty("--os-ui-cluster-gap",n),t&&this.style.setProperty("--os-ui-cluster-justify",t),s&&this.style.setProperty("--os-ui-cluster-align",s),f`<slot></slot>`}};fe.props=["gap","justify","align"],fe.styles=[gn],fe.help=void 0;let ut=fe;E("os-cluster",ut);const fn=k`:host{display:flex;flex-direction:column;gap:var( --os-ui-stack-gap,12px );align-items:var( --os-ui-stack-align,stretch );padding:var( --os-ui-stack-padding,0 )}:host( [ hidden ] ){display:none}`,be=class be extends C{render(){const e=this.gap,t=this.align,s=this.padding,n=e&&/^\d+$/.test(e)?`${e}px`:"";return n&&this.style.setProperty("--os-ui-stack-gap",n),t&&this.style.setProperty("--os-ui-stack-align",t),s!==null&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-stack-padding",`${s}px`),f`<slot></slot>`}};be.props=["gap","align","padding"],be.styles=[fn],be.help=void 0;let pt=be;E("os-stack",pt);const $e=o=>Oe(o,"os-plugins__detail-html");function bn(o){const e=we(o),t=[];let s=null;const n=/([0-9]+\.[0-9]+(?:\.[0-9]+)?(?:[\w.+-]*)?)/,i=()=>{s&&(t.push({version:s.version,body:s.html.trim()}),s=null)};for(const a of Array.from(e.childNodes)){if(a.nodeType===Node.ELEMENT_NODE){const r=a,l=/^H[1-6]$/.test(r.tagName),c=(r.textContent??"").trim().replace(/^=+\s*|\s*=+$/g,"").trim();if(l&&n.test(c)){i(),s={version:c,html:""};continue}s&&(s.html+=r.outerHTML);continue}a.nodeType===Node.TEXT_NODE&&s&&po(s,a.textContent??"")}return i(),t}function po(o,e){if(e.trim()===""){o.html!==""&&(o.html+=e);return}o.html+=`<p>${Ft(e)}</p>`}function mn(o){const e=we(o),t=Array.from(e.querySelectorAll(":scope > dt"));if(t.length>0)return t.map(vn).filter(r=>r.question!=="");const s=e.querySelector(":scope > dl");if(s){const r=[];let l=null;for(const c of Array.from(s.children))c.tagName==="DT"?(l&&r.push({question:l.q,answer:l.html.trim()}),l={q:(c.textContent??"").trim(),html:""}):l&&(l.html+=c.tagName==="DD"?c.innerHTML:c.outerHTML);return l&&r.push({question:l.q,answer:l.html.trim()}),r.filter(c=>c.question!=="")}const n=[];let i=null;const a=()=>{i&&(n.push({question:i.q,answer:i.html.trim()}),i=null)};for(const r of Array.from(e.childNodes)){if(r.nodeType===Node.ELEMENT_NODE){const l=r,c=(l.textContent??"").trim();if(/^H[1-6]$/.test(l.tagName)&&c){a(),i={q:c,html:""};continue}i&&(i.html+=l.outerHTML);continue}r.nodeType===Node.TEXT_NODE&&i&&po(i,r.textContent??"")}return a(),n.filter(r=>r.question!=="")}function vn(o){let e="",t="",s=!1;for(const n of Array.from(o.childNodes)){if(n.nodeType===Node.TEXT_NODE){const a=n.textContent??"";s?a.trim()!==""&&(t+=`<p>${Ft(a)}</p>`):e+=a;continue}if(n.nodeType!==Node.ELEMENT_NODE)continue;const i=n;i.tagName==="P"&&(i.textContent??"").trim()===""||(s=!0,t+=i.outerHTML)}return{question:e.replace(/\s+/g," ").trim(),answer:t.trim()}}function _n(o){if(!o)return Z(d("Loading from WordPress.org…","desktop-mode"));const e=o.sections?.changelog;if(!e)return G("list-view",d("No changelog","desktop-mode"),d("This plugin doesn’t ship a changelog.","desktop-mode"));const t=bn(e);if(t.length===0)return $e(e);const s=document.createElement("os-stack");return s.setAttribute("gap","12"),s.className="os-plugins__detail-changelog",t.forEach((n,i)=>{const a=document.createElement("os-card");a.className="os-plugins__detail-changelog-entry";const r=document.createElement("div");r.setAttribute("slot","header"),r.className="os-plugins__detail-changelog-head";const l=document.createElement("os-badge");if(l.setAttribute("tone",i===0?"success":"neutral"),l.textContent=n.version,r.appendChild(l),i===0){const c=document.createElement("span");c.className="os-plugins__detail-changelog-latest",c.textContent=d("Latest","desktop-mode"),r.appendChild(c)}a.appendChild(r),a.appendChild($e(n.body)),s.appendChild(a)}),s}function yn(o){if(!o)return Z(d("Loading from WordPress.org…","desktop-mode"));const e=o.sections?.faq;if(!e)return G("editor-help",d("No FAQ","desktop-mode"),d("This plugin doesn’t ship an FAQ.","desktop-mode"));const t=mn(e);if(t.length===0)return $e(e);const s=document.createElement("os-stack");return s.setAttribute("gap","8"),s.className="os-plugins__detail-faq",t.forEach((n,i)=>{const a=document.createElement("details");a.className="os-plugins__detail-faq-item",i===0&&a.setAttribute("open","");const r=document.createElement("summary");r.className="os-plugins__detail-faq-q";const l=document.createElement("span");l.className="os-plugins__detail-faq-q-text",l.textContent=n.question;const c=document.createElement("span");c.className="os-plugins__detail-faq-chevron",c.setAttribute("aria-hidden","true"),c.innerHTML=Ze("chevron-right",{size:16,rotate:90}),r.append(l,c);const p=$e(n.answer);p.classList.add("os-plugins__detail-faq-a"),a.append(r,p),s.appendChild(a)}),s}function kn(o,e){const t=document.createElement("div");t.className="os-plugins__detail",t.setAttribute("data-noclick","");const s=$n(o);t.appendChild(xn(o));const n=document.createElement("div");n.className="os-plugins__detail-tabs-wrap",t.appendChild(n);const i=document.createElement("div");i.className="os-plugins__detail-body",t.appendChild(i);const a=document.createElement("os-tabs");a.className="os-plugins__detail-tabs",a.setAttribute("value","overview");const r=[{value:"overview",label:d("Overview","desktop-mode"),show:!0},{value:"details",label:d("Details","desktop-mode"),show:!0},{value:"changelog",label:d("Changelog","desktop-mode"),show:!!s},{value:"faq",label:d("FAQ","desktop-mode"),show:!!s},{value:"reviews",label:d("Reviews","desktop-mode"),show:!!s}];for(const b of r){if(!b.show)continue;const h=document.createElement("os-tab");h.setAttribute("value",b.value),h.textContent=b.label,a.appendChild(h)}n.appendChild(a);let l=s?e.caches.info.get(s)??null:null,c=!1,p="overview";const u=()=>{i.replaceChildren(Cn(p,o,s,l,e))},g=()=>{!s||l||c||(c=!0,(async()=>{try{l=await e.rest.fetchPluginInfo(s),e.caches.info.set(s,l)}catch{}finally{c=!1,t.isConnected&&u()}})())};return a.addEventListener("os-tab-change",b=>{p=b.detail?.value??"overview",s&&p!=="overview"&&p!=="details"&&g(),u()}),u(),t}function xn(o){const e=document.createElement("div");e.className="os-plugins__detail-hero";const t=document.createElement("div");t.className="os-plugins__detail-hero-inner";const s=document.createElement("div");s.className="os-plugins__detail-hero-icon";const n=o.openstation_icon_url;if(n){const u=document.createElement("img");u.alt="",u.loading="lazy",u.decoding="async",u.src=uo(u,n,()=>{s.replaceChildren(K())}),s.appendChild(u)}else s.appendChild(K());const i=document.createElement("os-stack");i.setAttribute("gap","6"),i.className="os-plugins__detail-hero-text";const a=document.createElement("os-cluster");a.setAttribute("gap","10"),a.setAttribute("align","center");const r=document.createElement("h3");if(r.className="os-plugins__detail-title",r.textContent=$(o.name)||o.plugin,a.appendChild(r),o.version){const u=document.createElement("os-badge");u.setAttribute("tone","neutral"),u.setAttribute("no-dot",""),u.textContent=y(d("v%s","desktop-mode"),o.version),a.appendChild(u)}a.appendChild(wn(o));const l=o.openstation_update_available;if(l?.available&&l.new_version){const u=document.createElement("os-badge");u.setAttribute("tone","warning"),u.textContent=y(d("Update to %s","desktop-mode"),l.new_version),a.appendChild(u)}i.appendChild(a);const c=document.createElement("p");c.className="os-plugins__detail-byline";const p=$(o.author??"")||d("Unknown author","desktop-mode");return o.author_uri?c.append(d("by","desktop-mode")+" ",B(o.author_uri,p)):c.textContent=y(d("by %s","desktop-mode"),p),i.appendChild(c),t.append(s,i),e.appendChild(t),e}function wn(o){const e=N(o.status),t=document.createElement("os-badge");return t.setAttribute("tone",e?"success":"neutral"),t.textContent=d(e?"Active":"Inactive","desktop-mode"),t}function Cn(o,e,t,s,n){return o==="overview"?An(e,t,s):o==="details"?Sn(e):o==="changelog"?_n(s):o==="faq"?yn(s):Jt(n,t,s)}function An(o,e,t){const s=document.createElement("os-stack");s.setAttribute("gap","20");const n=En(o,t);n.children.length>0&&s.appendChild(n);const i=t?.sections?.description??t?.short_description??zn(o);i?s.appendChild(Oe(i,"os-plugins__detail-html")):e&&!t?s.appendChild(Z(d("Loading description…","desktop-mode"))):s.appendChild(G("admin-plugins",d("No description","desktop-mode"),d("This plugin doesn’t ship a description in its header.","desktop-mode")));const a=document.createElement("os-cluster");return a.setAttribute("gap","8"),a.className="os-plugins__detail-actions",e&&a.appendChild(H("primary",d("View on WordPress.org","desktop-mode"),Ce(e),"small")),o.plugin_uri&&a.appendChild(H("secondary",d("Plugin website","desktop-mode"),o.plugin_uri,"small")),o.author_uri&&a.appendChild(H("ghost",d("Author website","desktop-mode"),o.author_uri,"small")),a.children.length>0&&s.appendChild(a),s}function En(o,e){const t=document.createElement("os-cluster");if(t.setAttribute("gap","8"),t.className="os-plugins__detail-chip-strip",e){if(typeof e.rating=="number"&&e.rating>0){const s=document.createElement("span");s.className="os-plugins__detail-stars-pill",s.appendChild(Ae(e.rating,e.num_ratings??0)),t.appendChild(s)}e.active_installs&&t.appendChild(V("admin-users",y(d("%s+ active installs","desktop-mode"),new Intl.NumberFormat().format(e.active_installs)))),e.last_updated&&t.appendChild(V("update",y(d("Updated %s","desktop-mode"),xt(e.last_updated.slice(0,10),"long")))),e.tested&&t.appendChild(V("wordpress-alt",y(d("Tested up to WP %s","desktop-mode"),e.tested)))}return o.requires_wp&&t.appendChild(V("wordpress",y(d("Requires WP %s+","desktop-mode"),o.requires_wp))),o.requires_php&&t.appendChild(V("editor-code",y(d("Requires PHP %s+","desktop-mode"),o.requires_php))),o.network_only&&t.appendChild(V("networking",d("Network only","desktop-mode"))),t}function Sn(o){const e=document.createElement("os-grid");e.setAttribute("columns","2"),e.setAttribute("gap","12"),e.className="os-plugins__detail-grid";const t=N(o.status);return L(e,"media-document",d("Plugin file","desktop-mode"),ho(o.plugin)),o.version&&L(e,"tag",d("Version","desktop-mode"),o.version),o.openstation_size_kb!==null&&o.openstation_size_kb!==void 0&&L(e,"database",d("Size on disk","desktop-mode"),ye(o.openstation_size_kb*1024)),o.requires_wp&&L(e,"wordpress-alt",d("Requires WordPress","desktop-mode"),y(d("%s+","desktop-mode"),o.requires_wp)),o.requires_php&&L(e,"editor-code",d("Requires PHP","desktop-mode"),y(d("%s+","desktop-mode"),o.requires_php)),o.textdomain&&L(e,"translation",d("Text domain","desktop-mode"),ho(String(o.textdomain))),o.plugin_uri&&L(e,"admin-links",d("Plugin URL","desktop-mode"),B(o.plugin_uri,o.plugin_uri)),o.author_uri&&L(e,"admin-users",d("Author URL","desktop-mode"),B(o.author_uri,o.author_uri)),o.network_only&&L(e,"networking",d("Scope","desktop-mode"),d("Network only","desktop-mode")),L(e,t?"yes-alt":"marker",d("Status","desktop-mode"),d(t?"Active":"Inactive","desktop-mode")),e}function L(o,e,t,s){const n=document.createElement("os-card");n.setAttribute("compact",""),n.className="os-plugins__detail-fact";const i=document.createElement("div");i.setAttribute("slot","header"),i.className="os-plugins__detail-fact-head";const a=document.createElement("span");a.className=`dashicons dashicons-${e}`,a.setAttribute("aria-hidden","true");const r=document.createElement("span");r.textContent=t,i.append(a,r),n.appendChild(i);const l=document.createElement("div");l.className="os-plugins__detail-fact-value",typeof s=="string"?l.textContent=s:l.appendChild(s),n.appendChild(l),o.appendChild(n)}function V(o,e){const t=document.createElement("os-chip");t.setAttribute("label",e),t.setAttribute("tone","neutral");const s=document.createElement("span");return s.setAttribute("slot","icon"),s.className=`dashicons dashicons-${o}`,s.setAttribute("aria-hidden","true"),t.appendChild(s),t}function ho(o){const e=document.createElement("code");return e.textContent=o,e}function $n(o){const e=o.openstation_wporg_slug;return typeof e=="string"?e:""}function zn(o){const e=o.description;return e?typeof e=="string"?e:e.rendered||e.raw||"":""}const Nn=()=>({selected:[],savingView:!1,table:{element:null,key:""},rows:[],focused:"",sort:"attention",layoutKey:"",haystacks:{source:null,byPlugin:new Map},controls:new Map,detail:null,icons:new Map,autoUpdate:null});function Ln(o,e){return e.source!==o&&(e.source=o,e.byPlugin=new Map(o.map(t=>[t.plugin,`${t.name??""} ${t.plugin} ${$(t.author??"")}`.toLowerCase()]))),e.byPlugin}function Tn(o,e,t,s){const n=t.trim().toLowerCase();return o.filter(i=>!(e==="active"&&!N(i.status)||e==="inactive"&&i.status!=="inactive"||e==="update"&&!i.openstation_update_available?.available||n!==""&&!(s?.get(i.plugin)??`${i.name??""} ${i.plugin} ${$(i.author??"")}`.toLowerCase()).includes(n)))}function Rn(o){return o.filter(e=>!!e.openstation_update_available?.available).length}function X(o){return o.openstation_update_available?.available?"update":N(o.status)?"active":"inactive"}function ht(o,e,t,s="card"){const n=JSON.stringify([t,o.extra.caps,o.busy.updating.has(t.plugin),o.busy.optimistic.has(t.plugin)]);let i=e.controls.get(`${s}:${t.plugin}`);if(!i||i.key!==n){const a=Nt(o,t);if(o.busy.optimistic.has(t.plugin)||o.busy.updating.has(t.plugin))for(const r of a)r.setAttribute("disabled",""),r.setAttribute("aria-busy","true");i={key:n,actions:a},e.controls.set(`${s}:${t.plugin}`,i)}return i.actions}function go(o,e){const t=e.focused;e.focused="",o.repaint();const s=Array.from(o.root.querySelectorAll("[data-plugin-card]")).find(i=>i.dataset.pluginCard===t),n=Array.from(e.table.element?.shadowRoot?.querySelectorAll("[data-plugin-actions]")??[]).find(i=>i.getAttribute("data-plugin-actions")===t);queueMicrotask(()=>{(n?.shadowRoot?.querySelector("os-button")??s?.querySelector("[data-plugin-details]"))?.shadowRoot?.querySelector("button")?.focus()})}function Pn(o,e,t,s){const n=$(s.name)||s.plugin,i=N(s.status),a=e.busy.updating.has(s.plugin),r=e.busy.optimistic.has(s.plugin),l=s.openstation_update_available;let c=d(i?"Active":"Inactive","desktop-mode");s.status==="network-active"&&(c=d("Network active","desktop-mode")),r&&(c=d("Changing status…","desktop-mode"));const p=typeof s.description=="string"?s.description:s.description?.rendered||s.description?.raw||"",u=()=>{t.focused=s.plugin,o.repaint(),queueMicrotask(()=>o.root.querySelector("[data-plugin-back]")?.shadowRoot?.querySelector("button")?.focus())},g=b=>{const h=b.detail.checked;t.selected=h?[...new Set([...t.selected,s.plugin])]:t.selected.filter(_=>_!==s.plugin),o.repaint()};return f`<os-card
	...
	</os-card>`}function qn(o,e,t){const s=e.installed.find(a=>a.plugin===t.focused);if(!s)return"";const n=JSON.stringify(s),i=JSON.stringify([s,e.busy.autoUpdating.has(s.plugin)]);if(t.autoUpdate?.key!==i&&(t.autoUpdate={key:i,node:In(e,s)}),t.detail?.key!==n){const a=document.createElement("div");a.className="os-plugins__inspector-content";const r=a.attachShadow({mode:"open"});co(r,"plugins",an),r.appendChild(kn(s,e)),t.detail={key:n,node:a}}return f`<aside
		class="os-plugins__inspector"
		aria-label=${$(s.name)||s.plugin}
		@keydown=${a=>{a.key==="Escape"&&(a.stopPropagation(),go(o,t))}}
	>
		<header class="os-plugins__inspector-bar">
			<os-button variant="ghost" size="small" data-plugin-back @click=${()=>go(o,t)}>
	...
	</aside>`}function Dn(o,e,t,s){const n=()=>{t.selected=[],o.repaint()},i=Xo(e,t.selected,n),a=e.busy.updating.size>0||e.busy.optimistic.size>0;return f`<div class="os-plugins__selection" ?hidden=${t.selected.length===0}>
		<os-checkbox
		...
		>
	</div>`}function Mn(o,e,t){const{state:s,data:n}=o,i=Tn(n.installed,s.status,s.search,Ln(n.installed,t.haystacks)),a=new Set(i.map(h=>h.plugin));t.selected=t.selected.filter(h=>a.has(h)),a.has(t.focused)||(t.focused="",t.detail=null,t.autoUpdate=null);const r=new Set(n.installed.map(h=>h.plugin));for(const h of t.icons.keys())r.has(h)||t.icons.delete(h);for(const h of t.controls.keys())r.has(h.slice(h.indexOf(":")+1))||t.controls.delete(h);i.sort((h,_)=>t.sort==="size"&&(_.openstation_size_kb??0)-(h.openstation_size_kb??0)||h.name.localeCompare(_.name));const l=JSON.stringify([s.installedView,s.status,s.search,t.sort,i.map(h=>[h.plugin,X(h)])]);if(t.layoutKey!==l&&(t.layoutKey=l,t.controls.clear(),t.icons.clear()),t.sort==="attention"){const h=["update","active","inactive"];i.sort((_,m)=>h.indexOf(X(_))-h.indexOf(X(m)))}t.rows=i;const c=Rn(n.installed),p=n.installed.filter(h=>N(h.status)).length,u=[{value:"",label:d("All plugins","desktop-mode"),count:n.installed.length,icon:"screenoptions"},{value:"update",label:d("Updates","desktop-mode"),count:c,icon:"update"},{value:"active",label:d("Active","desktop-mode"),count:p,icon:"yes-alt"},{value:"inactive",label:d("Inactive","desktop-mode"),count:n.installed.length-p,icon:"marker"}],g=t.sort==="attention"&&!s.status?[{id:"update",title:d("Ready for an update","desktop-mode"),hint:d("The next versions of your tools are here.","desktop-mode")},{id:"active",title:d("Powering your site","desktop-mode"),hint:d("Your everyday tools, switched on.","desktop-mode")},{id:"inactive",title:d("On standby","desktop-mode"),hint:d("Ready when you need them.","desktop-mode")}]:[{id:"",title:u.find(h=>h.value===s.status)?.label||d("All plugins","desktop-mode"),hint:""}],b=()=>{s.status="",s.search="",o.repaint()};return f`<div class="os-plugins__workspace" data-view=${s.installedView} data-detail-open=${t.focused?"true":"false"}><style>${dn.cssText}</style>
	...
	>${s} ↗</os-tab>`}function Zn(o,e){e.detail?.value===ko&&(e.stopPropagation(),e.currentTarget.value=o.state.tab)}const Gn=[{value:"featured",label:()=>d("Featured","desktop-mode")},{value:"popular",label:()=>d("Popular","desktop-mode")},{value:"recommended",label:()=>d("Recommended","desktop-mode")},{value:"favorites",label:()=>d("Favorites","desktop-mode")},{value:"new",label:()=>d("New","desktop-mode")},{value:"beta",label:()=>d("Beta","desktop-mode")}];function Yn(o,e,t){const{state:s}=o;return f`
		<header class="os-app-list__toolbar">
			...
			<div class="os-app-list__toolbar-trailing">
				${e.host.extra.caps.upload?f`<os-button variant="secondary" @click=${()=>void _o(e.host,null)}>
...
`,Qn=Io(Vn,{local:{set:()=>{}},placeholder:()=>({installed:[],error:""}),view:o=>{const e=ft(o),{caps:t}=e.host.extra,s=wt(),n=o.state.tab;return f`
		...
		`},mounted:o=>{const e=ft(o),{host:t}=e,s=o.root,n=o.host.onBroadcast?.(Ct,(g,b)=>{const h=b;!h||h.source===At||h.source===Wn&&Bn(e.ownChanges,h.ids)||t.refresh()});n&&e.teardown.push(n),t.extra.caps.install&&e.teardown.push(hs());const i=g=>!!g.dataTransfer?.types.includes("Files"),a=()=>!!t.extra.caps.upload,r=g=>{a()&&i(g)&&(e.dragDepth++,s.classList.add("has-zip-dragover"))},l=g=>{a()&&i(g)&&(e.dragDepth=Math.max(0,e.dragDepth-1),e.dragDepth===0&&s.classList.remove("has-zip-dragover"))},c=g=>{a()&&i(g)&&g.preventDefault()},p=g=>{if(!a())return;e.dragDepth=0,s.classList.remove("has-zip-dragover");const b=g.dataTransfer?.files?.[0];b&&(g.preventDefault(),_o(t,b))};s.addEventListener("dragenter",r),s.addEventListener("dragleave",l),s.addEventListener("dragover",c),s.addEventListener("drop",p),e.teardown.push(()=>{s.removeEventListener("dragenter",r),s.removeEventListener("dragleave",l),s.removeEventListener("dragover",c),s.removeEventListener("drop",p)});const u=()=>o.repaint();return document.addEventListener("os-mode-changed",u),e.teardown.push(()=>document.removeEventListener("os-mode-changed",u)),()=>{for(const g of e.teardown)g();e.teardown.length=0,e.browse?.dispose()}},updated:o=>{Hn(o.root);const e=ft(o),{host:t}=e;if(Un(o,t,e.installed),t.extra.caps.install){const s=a=>o.root.querySelector(`[data-os-plugins-gallery="${a}"]`),n=a=>o.root.querySelector(`[data-os-plugins-gallery-status="${a}"]`);e.browse??(e.browse=Os({host:t,flyout:()=>yo(o)})),e.browse.sync({gallery:s("browse"),status:n("browse"),filter:o.state.browse,query:o.state.query,active:o.state.tab==="browse"}),e.featured??(e.featured=Bs({host:t,flyout:()=>yo(o)})),e.featured.sync({gallery:s("featured"),status:n("featured"),active:o.state.tab==="featured"});const i=t.installed.map(a=>`${Pe(a)}:${a.status}`).join("|");i!==e.ctaKey&&(e.ctaKey=i,e.browse.repaintCtas(),e.featured.repaintCtas())}}});return Te.default=Qn,Object.defineProperties(Te,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}}),Te}({});
