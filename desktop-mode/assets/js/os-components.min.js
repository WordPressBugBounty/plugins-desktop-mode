(function(){"use strict";function c(r,...e){return{__wpdHtml:!0,strings:r,values:e}}function Yi(r){return!!r&&r.__wpdHtml===!0}const Qi="$$wpd$$",L=/\$\$wpd\$\$(\d+)\$\$/g,Oi="$$wpd-node$$",Ji=/^\$\$wpd-node\$\$(\d+)\$\$$/,er=new Set(["style","script","textarea","title"]);function tr(r){let e="",t=!1,s=null,o=!1,i=null,n="",a=!1;for(let l=0;l<r.length;l++){const d=r[l];e+=d;for(let u=0;u<d.length;u++){const h=d[u];if(o){d.startsWith("-->",u)&&(o=!1,u+=2);continue}if(i!==null){h==="<"&&d[u+1]==="/"&&d.slice(u+2,u+2+i.length).toLowerCase()===i&&(u+=1+i.length,i=null,t=!0,a=!1,n="");continue}if(s!==null){h===s&&(s=null);continue}if(t){h==='"'||h==="'"?(s=h,a=!1):h===">"?(t=!1,a=!1,er.has(n)&&(i=n),n=""):a&&(/[a-zA-Z0-9-]/.test(h)?n+=h.toLowerCase():a=!1);continue}if(d.startsWith("<!--",u)){o=!0,u+=3;continue}const p=d[u+1]??"";h==="<"&&/[a-zA-Z/!]/.test(p)&&(t=!0,n="",a=/[a-zA-Z]/.test(p))}l<r.length-1&&(e+=t||o||i!==null?`${Qi}${l}$$`:`<!--${Oi}${l}$$-->`)}return e}const ko=new WeakMap;function $o(r){const e=ko.get(r);if(e)return e;const t=document.createElement("template");t.innerHTML=tr(r);const s=[],o=(a,l)=>{if(a.nodeType===Node.ELEMENT_NODE){const h=a;for(const p of Array.from(h.attributes)){const m=p.name,g=p.value,x=m[0];if(L.test(g))if(L.lastIndex=0,x==="@"){const _=L.exec(g);L.lastIndex=0,s.push({path:l,kind:"event",name:m.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(m)}else if(x==="."){const _=L.exec(g);L.lastIndex=0,s.push({path:l,kind:"prop",name:m.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(m)}else if(x==="?"){const _=L.exec(g);L.lastIndex=0,s.push({path:l,kind:"bool",name:m.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(m)}else{const _=[],y=[];let C=0,z;for(L.lastIndex=0;(z=L.exec(g))!==null;)_.push(g.slice(C,z.index)),y.push(Number(z[1])),C=z.index+z[0].length;_.push(g.slice(C)),s.push({path:l,kind:"attr",name:m,template:_,valueIndices:y}),h.setAttribute(m,"")}}}const d=Array.from(a.childNodes);let u=0;for(let h=0;h<d.length;h++){const p=d[h],m=h+u;if(p.nodeType===Node.COMMENT_NODE){const g=Ji.exec(p.data);if(g){const x=document.createTextNode("");p.parentNode.replaceChild(x,p),s.push({path:[...l,m],kind:"node",valueIndex:Number(g[1])})}continue}if(p.nodeType===Node.TEXT_NODE){const g=p.textContent||"";if(!L.test(g)){L.lastIndex=0;continue}L.lastIndex=0;const x=p.parentNode;let _=0,y;const C=[],z=[];for(L.lastIndex=0;(y=L.exec(g))!==null;){y.index>_&&C.push(document.createTextNode(g.slice(_,y.index)));const E=document.createTextNode("");C.push(E),z.push({path:[...l,m+C.length-1],kind:"node",valueIndex:Number(y[1])}),_=y.index+y[0].length}_<g.length&&C.push(document.createTextNode(g.slice(_)));for(const E of C)x.insertBefore(E,p);x.removeChild(p),u+=C.length-1,s.push(...z)}else o(p,[...l,m])}};o(t.content,[]);const n={template:t,buildParts:a=>{const l=[];for(const d of s){let u=a;for(const h of d.path)u=u.childNodes[h];d.kind==="node"?l.push({kind:"node",valueIndex:d.valueIndex,child:{anchor:u,state:null}}):d.kind==="attr"?l.push({kind:"attr",element:u,name:d.name,template:d.template,valueIndices:d.valueIndices}):d.kind==="event"?l.push({kind:"event",valueIndex:d.valueIndex,element:u,name:d.name}):d.kind==="prop"?l.push({kind:"prop",valueIndex:d.valueIndex,element:u,name:d.name}):d.kind==="bool"&&l.push({kind:"bool",valueIndex:d.valueIndex,element:u,name:d.name})}return l}};return ko.set(r,n),n}const Co=new WeakMap;function sr(r,e){for(const t of r.nodes)if(t.parentNode!==e)return!1;return!0}function wt(r,e){const t=Co.get(e);if(t&&t.strings===r.strings&&sr(t,e)){kt(t.parts,r.values);return}const s=$o(r.strings),o=s.template.content.cloneNode(!0),i=s.buildParts(o),n=Array.from(o.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(o),kt(i,r.values),Co.set(e,{strings:r.strings,parts:i,nodes:n})}function kt(r,e){for(const t of r)if(t.kind==="node")$t(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let s=t.template[0];for(let o=0;o<t.valueIndices.length;o++)s+=Ao(e[t.valueIndices[o]]),s+=t.template[o+1];s!==t.last&&(t.last=s,s===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,s))}else if(t.kind==="event"){const s=e[t.valueIndex];s!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),s&&t.element.addEventListener(t.name,s),t.current=s)}else if(t.kind==="prop"){const s=e[t.valueIndex];s!==t.last&&(t.last=s,t.element[t.name]=s)}else if(t.kind==="bool"){const s=!!e[t.valueIndex];s!==t.last&&(t.last=s,s?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function $t(r,e){if(e==null||e===!1){r.state&&(U(r.state),r.state=null);return}if(Array.isArray(e)){nr(r,e);return}if(Yi(e)){rr(r,e);return}if(e instanceof Node){or(r,e);return}ir(r,Ao(e))}function or(r,e){const t=r.state;t?.shape==="node"&&t.node===e||(t&&U(t),ee(r,[e]),r.state={shape:"node",node:e})}function ir(r,e){const t=r.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&U(t);const s=document.createTextNode(e);ee(r,[s]),r.state={shape:"text",node:s,text:e}}function rr(r,e){const t=r.state;if(t?.shape==="template"&&t.strings===e.strings){kt(t.parts,e.values);return}t&&U(t);const s=$o(e.strings),o=s.template.content.cloneNode(!0),i=s.buildParts(o),n=Array.from(o.childNodes);ee(r,[o]),kt(i,e.values),r.state={shape:"template",strings:e.strings,parts:i,nodes:n}}function nr(r,e){const t=r.state;if(t?.shape==="array"){const o=Math.min(t.entries.length,e.length);for(let i=0;i<o;i++)$t(t.entries[i],e[i]);if(e.length<t.entries.length){for(let i=e.length;i<t.entries.length;i++){const n=t.entries[i];n.state&&U(n.state),n.anchor.remove()}t.entries.length=e.length}else for(let i=t.entries.length;i<e.length;i++){const n=document.createTextNode("");ee(r,[n]);const a={anchor:n,state:null};$t(a,e[i]),t.entries.push(a)}return}t&&U(t);const s=[];for(const o of e){const i=document.createTextNode("");ee(r,[i]);const n={anchor:i,state:null};$t(n,o),s.push(n)}r.state={shape:"array",entries:s}}function ee(r,e){const t=r.anchor.parentNode;if(t)for(const s of e)t.insertBefore(s,r.anchor)}function U(r){if(r.shape==="text"){r.node.remove();return}if(r.shape==="template"){for(const e of r.parts)e.kind==="node"&&e.child.state&&(U(e.child.state),e.child.state=null);for(const e of r.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(r.shape==="node"){r.node.parentNode&&r.node.parentNode.removeChild(r.node);return}for(const e of r.entries)e.state&&U(e.state),e.anchor.remove()}function Ao(r){return r==null||r===!1?"":String(r)}const W=class W extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(So)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,s){if(t===s)return;const o=ar(e);this._propValues[o]=s,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const s=(Array.isArray(e)?e:String(e).split(/\s+/)).map(o=>String(o).trim()).filter(o=>o!=="");this.className=s.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const s=So(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(s),set:o=>{let i;o==null||o===!1?i=null:o===!0?i="":i=String(o),this._propValues[t]=i,i===null?this.removeAttribute(s):this.setAttribute(s,i),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&wt(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(s=>s.sheet).filter(s=>s!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const s of e.styles)if(!s.sheet){const o=document.createElement("style");o.textContent=s.cssText,this.shadowRoot.appendChild(o)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!W._lightStylesAdopted.has(e)){W._lightStylesAdopted.add(e);for(const t of e.styles){const s=document.createElement("style");s.dataset.osUi=this.tagName.toLowerCase(),s.textContent=t.cssText,document.head.appendChild(s)}}}};W.props=[],W.styles=[],W.shadow=!0,W._lightStylesAdopted=new WeakSet;let f=W;function v(r,e){customElements.get(r)||customElements.define(r,e)}function So(r){return r.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function ar(r){return r.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const lr=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function b(r,...e){let t=r[0];for(let s=1;s<r.length;s++){const o=e[s-1];if(typeof o=="string"||typeof o=="number")t+=String(o);else if(o&&o.__wpdCss)t+=o.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof o);t+=r[s]}if(lr){const s=new CSSStyleSheet;return s.replaceSync(t),{__wpdCss:!0,sheet:s,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function cr(r){const e=[],t=[];let s=null,o=r.parentElement;for(;o&&!(o===document.body||o===document.documentElement);){const n=o.id||"";if(n.startsWith("wp-window-")){s=n.slice(10);break}if(o.tagName.toLowerCase()==="os-tabpanel"){const a=o.getAttribute("for");a&&t.unshift(a)}o=o.parentElement}s&&e.push(Ut(s));for(const n of t)e.push("tab-"+Ut(n));const i=r.getAttribute("label");return i&&e.push(Ut(i)),e.length===0?"os-unnamed":"os-"+e.filter(n=>n!=="").join("-")}function Ut(r){return r.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function te(r){if(r.id)return r.id;const e=cr(r);return r.id=e,e}const dr=b`:host{display:block;margin-block-end:36px}:host( [ hidden ] ){display:none}.os-section__heading{margin:0 0 5px;font-size:20px;font-weight:500;letter-spacing:-0.01em;color:var( --os-ui-fg,#1d2327 )}.os-section__description{margin:0 0 14px;max-width:78ch;font-size:14px;color:var( --os-ui-fg-muted,#646970 );line-height:1.55}.os-section__description:empty{display:none}:host( [ stack ] ) .os-section__body{display:flex;flex-direction:column;gap:var( --os-ui-section-gap,12px )}`,ne=class ne extends f{render(){const e=this.heading||"",t=this.description||"";return c`
		...
		`};let Ot=pe;v("os-select",Ot);const yr=b`
	:host {
		display: flex;
...
`,document.head.appendChild(e)}typeof document<"u"&&wr();const ge=class ge extends f{constructor(){super(...arguments),this._optionObserver=null,this._popover=null,this._teardownOpen=null,this._hasMore=!1,this._loadingMore=!1}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const i of Array.from(t))i.remove();for(const i of e){const n=document.createElement("os-option");n.setAttribute("value",i.value),n.textContent=i.label,this.appendChild(n)}this._loadingMore=!1;const s=new Set(e.map(i=>i.value)),o=this._readValues().filter(i=>s.has(i));this._writeValueAttribute(o),this.requestUpdate(),this._refreshPopover()}get values(){return this._readValues()}set values(e){const t=Array.isArray(e)?e.map(s=>String(s)).filter(s=>s!==""):[];this._writeValueAttribute(t),this.requestUpdate(),this._refreshPopover()}get hasMore(){return this._hasMore}set hasMore(e){this._hasMore=!!e,this._refreshPopover()}get loadingMore(){return this._loadingMore}set loadingMore(e){this._loadingMore=!!e,this._refreshPopover()}appendItems(e){if(this._loadingMore=!1,!e||e.length===0){this._refreshPopover();return}const t=new Set(Array.from(this.querySelectorAll(":scope > os-option")).map(s=>s.getAttribute("value")));for(const s of e){if(t.has(s.value))continue;const o=document.createElement("os-option");o.setAttribute("value",s.value),o.textContent=s.label,this.appendChild(o)}this.requestUpdate(),this._refreshPopover()}connectedCallback(){super.connectedCallback(),te(this),this._optionObserver=new MutationObserver(()=>{this.requestUpdate(),this._refreshPopover()}),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._closePopover()}render(){const e=this.label||"",t=this.placeholder||"All",s=this.disabled!==null;e?this.setAttribute("aria-label",e):this.removeAttribute("aria-label");const o=e||t,i=this._summarize(t),n=this._readValues().length>0,l=`${this.id||"os-unnamed"}__trigger`;return c`
	...
	`}const ve=class ve extends f{connectedCallback(){super.connectedCallback(),te(this)}render(){const e=this.label||"",t=this.value??"",s=this.placeholder||"",o=this.disabled!==null,i=this.readonly!==null,n=this.name||"",a=this.suffix||"",l=this.min,d=this.max,u=this.step||"any",h=this.invalid!==null,m=`${this.id||"os-unnamed"}__input`;return c`
		...
		`}_onChange(e){const s=e.target.checked;s?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("os-checkbox-change",{checked:s,value:this.value})}};_e.props=["checked","value","label","disabled"],_e.styles=[Rr],_e.help=void 0;let is=_e;v("os-checkbox",is);const Mr=b` ${w} ${St}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg,#1d2327 );cursor:pointer;-webkit-user-select:none;user-select:none}label{display:inline-flex;align-items:center;gap:8px;cursor:pointer}:host( [ disabled ] ){opacity:0.5;cursor:not-allowed}:host( [ disabled ] ) label,:host( [ disabled ] ) input[ type='checkbox' ]{cursor:not-allowed}`,xe=class xe extends f{render(){const e=this.label||"",t=this.checked!==null,s=this.disabled!==null;return c`
			<label>
				<input
					type="checkbox"
					?checked=${t}
