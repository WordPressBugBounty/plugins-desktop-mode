(function(){"use strict";function c(r,...e){return{__wpdHtml:!0,strings:r,values:e}}function Xi(r){return!!r&&r.__wpdHtml===!0}const Gi="$$wpd$$",z=/\$\$wpd\$\$(\d+)\$\$/g,Zi="$$wpd-node$$",Yi=/^\$\$wpd-node\$\$(\d+)\$\$$/,Oi=new Set(["style","script","textarea","title"]);function Qi(r){let e="",t=!1,s=null,o=!1,i=null,n="",a=!1;for(let l=0;l<r.length;l++){const d=r[l];e+=d;for(let u=0;u<d.length;u++){const h=d[u];if(o){d.startsWith("-->",u)&&(o=!1,u+=2);continue}if(i!==null){h==="<"&&d[u+1]==="/"&&d.slice(u+2,u+2+i.length).toLowerCase()===i&&(u+=1+i.length,i=null,t=!0,a=!1,n="");continue}if(s!==null){h===s&&(s=null);continue}if(t){h==='"'||h==="'"?(s=h,a=!1):h===">"?(t=!1,a=!1,Oi.has(n)&&(i=n),n=""):a&&(/[a-zA-Z0-9-]/.test(h)?n+=h.toLowerCase():a=!1);continue}if(d.startsWith("<!--",u)){o=!0,u+=3;continue}const p=d[u+1]??"";h==="<"&&/[a-zA-Z/!]/.test(p)&&(t=!0,n="",a=/[a-zA-Z]/.test(p))}l<r.length-1&&(e+=t||o||i!==null?`${Gi}${l}$$`:`<!--${Zi}${l}$$-->`)}return e}const yo=new WeakMap;function wo(r){const e=yo.get(r);if(e)return e;const t=document.createElement("template");t.innerHTML=Qi(r);const s=[],o=(a,l)=>{if(a.nodeType===Node.ELEMENT_NODE){const h=a;for(const p of Array.from(h.attributes)){const f=p.name,g=p.value,x=f[0];if(z.test(g))if(z.lastIndex=0,x==="@"){const _=z.exec(g);z.lastIndex=0,s.push({path:l,kind:"event",name:f.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(f)}else if(x==="."){const _=z.exec(g);z.lastIndex=0,s.push({path:l,kind:"prop",name:f.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(f)}else if(x==="?"){const _=z.exec(g);z.lastIndex=0,s.push({path:l,kind:"bool",name:f.slice(1),valueIndex:_?Number(_[1]):0}),h.removeAttribute(f)}else{const _=[],y=[];let C=0,L;for(z.lastIndex=0;(L=z.exec(g))!==null;)_.push(g.slice(C,L.index)),y.push(Number(L[1])),C=L.index+L[0].length;_.push(g.slice(C)),s.push({path:l,kind:"attr",name:f,template:_,valueIndices:y}),h.setAttribute(f,"")}}}const d=Array.from(a.childNodes);let u=0;for(let h=0;h<d.length;h++){const p=d[h],f=h+u;if(p.nodeType===Node.COMMENT_NODE){const g=Yi.exec(p.data);if(g){const x=document.createTextNode("");p.parentNode.replaceChild(x,p),s.push({path:[...l,f],kind:"node",valueIndex:Number(g[1])})}continue}if(p.nodeType===Node.TEXT_NODE){const g=p.textContent||"";if(!z.test(g)){z.lastIndex=0;continue}z.lastIndex=0;const x=p.parentNode;let _=0,y;const C=[],L=[];for(z.lastIndex=0;(y=z.exec(g))!==null;){y.index>_&&C.push(document.createTextNode(g.slice(_,y.index)));const A=document.createTextNode("");C.push(A),L.push({path:[...l,f+C.length-1],kind:"node",valueIndex:Number(y[1])}),_=y.index+y[0].length}_<g.length&&C.push(document.createTextNode(g.slice(_)));for(const A of C)x.insertBefore(A,p);x.removeChild(p),u+=C.length-1,s.push(...L)}else o(p,[...l,f])}};o(t.content,[]);const n={template:t,buildParts:a=>{const l=[];for(const d of s){let u=a;for(const h of d.path)u=u.childNodes[h];d.kind==="node"?l.push({kind:"node",valueIndex:d.valueIndex,child:{anchor:u,state:null}}):d.kind==="attr"?l.push({kind:"attr",element:u,name:d.name,template:d.template,valueIndices:d.valueIndices}):d.kind==="event"?l.push({kind:"event",valueIndex:d.valueIndex,element:u,name:d.name}):d.kind==="prop"?l.push({kind:"prop",valueIndex:d.valueIndex,element:u,name:d.name}):d.kind==="bool"&&l.push({kind:"bool",valueIndex:d.valueIndex,element:u,name:d.name})}return l}};return yo.set(r,n),n}const ko=new WeakMap;function Ji(r,e){for(const t of r.nodes)if(t.parentNode!==e)return!1;return!0}function xt(r,e){const t=ko.get(e);if(t&&t.strings===r.strings&&Ji(t,e)){yt(t.parts,r.values);return}const s=wo(r.strings),o=s.template.content.cloneNode(!0),i=s.buildParts(o),n=Array.from(o.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(o),yt(i,r.values),ko.set(e,{strings:r.strings,parts:i,nodes:n})}function yt(r,e){for(const t of r)if(t.kind==="node")wt(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let s=t.template[0];for(let o=0;o<t.valueIndices.length;o++)s+=$o(e[t.valueIndices[o]]),s+=t.template[o+1];s!==t.last&&(t.last=s,s===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,s))}else if(t.kind==="event"){const s=e[t.valueIndex];s!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),s&&t.element.addEventListener(t.name,s),t.current=s)}else if(t.kind==="prop"){const s=e[t.valueIndex];s!==t.last&&(t.last=s,t.element[t.name]=s)}else if(t.kind==="bool"){const s=!!e[t.valueIndex];s!==t.last&&(t.last=s,s?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function wt(r,e){if(e==null||e===!1){r.state&&(U(r.state),r.state=null);return}if(Array.isArray(e)){or(r,e);return}if(Xi(e)){sr(r,e);return}if(e instanceof Node){er(r,e);return}tr(r,$o(e))}function er(r,e){const t=r.state;t?.shape==="node"&&t.node===e||(t&&U(t),ee(r,[e]),r.state={shape:"node",node:e})}function tr(r,e){const t=r.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&U(t);const s=document.createTextNode(e);ee(r,[s]),r.state={shape:"text",node:s,text:e}}function sr(r,e){const t=r.state;if(t?.shape==="template"&&t.strings===e.strings){yt(t.parts,e.values);return}t&&U(t);const s=wo(e.strings),o=s.template.content.cloneNode(!0),i=s.buildParts(o),n=Array.from(o.childNodes);ee(r,[o]),yt(i,e.values),r.state={shape:"template",strings:e.strings,parts:i,nodes:n}}function or(r,e){const t=r.state;if(t?.shape==="array"){const o=Math.min(t.entries.length,e.length);for(let i=0;i<o;i++)wt(t.entries[i],e[i]);if(e.length<t.entries.length){for(let i=e.length;i<t.entries.length;i++){const n=t.entries[i];n.state&&U(n.state),n.anchor.remove()}t.entries.length=e.length}else for(let i=t.entries.length;i<e.length;i++){const n=document.createTextNode("");ee(r,[n]);const a={anchor:n,state:null};wt(a,e[i]),t.entries.push(a)}return}t&&U(t);const s=[];for(const o of e){const i=document.createTextNode("");ee(r,[i]);const n={anchor:i,state:null};wt(n,o),s.push(n)}r.state={shape:"array",entries:s}}function ee(r,e){const t=r.anchor.parentNode;if(t)for(const s of e)t.insertBefore(s,r.anchor)}function U(r){if(r.shape==="text"){r.node.remove();return}if(r.shape==="template"){for(const e of r.parts)e.kind==="node"&&e.child.state&&(U(e.child.state),e.child.state=null);for(const e of r.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(r.shape==="node"){r.node.parentNode&&r.node.parentNode.removeChild(r.node);return}for(const e of r.entries)e.state&&U(e.state),e.anchor.remove()}function $o(r){return r==null||r===!1?"":String(r)}const W=class W extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(Co)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,s){if(t===s)return;const o=ir(e);this._propValues[o]=s,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const s=(Array.isArray(e)?e:String(e).split(/\s+/)).map(o=>String(o).trim()).filter(o=>o!=="");this.className=s.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const s=Co(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(s),set:o=>{let i;o==null||o===!1?i=null:o===!0?i="":i=String(o),this._propValues[t]=i,i===null?this.removeAttribute(s):this.setAttribute(s,i),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&xt(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(s=>s.sheet).filter(s=>s!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const s of e.styles)if(!s.sheet){const o=document.createElement("style");o.textContent=s.cssText,this.shadowRoot.appendChild(o)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!W._lightStylesAdopted.has(e)){W._lightStylesAdopted.add(e);for(const t of e.styles){const s=document.createElement("style");s.dataset.osUi=this.tagName.toLowerCase(),s.textContent=t.cssText,document.head.appendChild(s)}}}};W.props=[],W.styles=[],W.shadow=!0,W._lightStylesAdopted=new WeakSet;let m=W;function v(r,e){customElements.get(r)||customElements.define(r,e)}function Co(r){return r.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function ir(r){return r.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const rr=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function b(r,...e){let t=r[0];for(let s=1;s<r.length;s++){const o=e[s-1];if(typeof o=="string"||typeof o=="number")t+=String(o);else if(o&&o.__wpdCss)t+=o.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof o);t+=r[s]}if(rr){const s=new CSSStyleSheet;return s.replaceSync(t),{__wpdCss:!0,sheet:s,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function nr(r){const e=[],t=[];let s=null,o=r.parentElement;for(;o&&!(o===document.body||o===document.documentElement);){const n=o.id||"";if(n.startsWith("wp-window-")){s=n.slice(10);break}if(o.tagName.toLowerCase()==="os-tabpanel"){const a=o.getAttribute("for");a&&t.unshift(a)}o=o.parentElement}s&&e.push(Ht(s));for(const n of t)e.push("tab-"+Ht(n));const i=r.getAttribute("label");return i&&e.push(Ht(i)),e.length===0?"os-unnamed":"os-"+e.filter(n=>n!=="").join("-")}function Ht(r){return r.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function te(r){if(r.id)return r.id;const e=nr(r);return r.id=e,e}const ar=b`:host{display:block;margin-block-end:36px}:host( [ hidden ] ){display:none}.os-section__heading{margin:0 0 5px;font-size:20px;font-weight:500;letter-spacing:-0.01em;color:var( --os-ui-fg,#1d2327 )}.os-section__description{margin:0 0 14px;max-width:78ch;font-size:14px;color:var( --os-ui-fg-muted,#646970 );line-height:1.55}.os-section__description:empty{display:none}:host( [ stack ] ) .os-section__body{display:flex;flex-direction:column;gap:var( --os-ui-section-gap,12px )}`,ne=class ne extends m{render(){const e=this.heading||"",t=this.description||"";return c`
		...
		`}_onPick(){this.emit("os-pick",{value:this.value})}};le.props=["value","label","selected","preview","size","variant"],le.styles=[dr],le.help=void 0;let Bt=le;v("os-swatch",Bt);const ur=b`:host{display:grid;grid-template-columns:repeat( var( --os-ui-swatch-grid-cols,4 ),1fr );gap:12px}:host( [ mode='row' ] ){display:flex;flex-wrap:wrap;align-items:center;gap:10px}`,ce=class ce extends m{render(){const e=this.label||"",t=this.columns||"";return t&&this.style.setProperty("--os-ui-swatch-grid-cols",t),this.setAttribute("role","radiogroup"),e&&this.setAttribute("aria-label",e),c`<slot></slot>`}};ce.props=["label","columns","mode"],ce.styles=[ur],ce.help=void 0;let Wt=ce;v("os-swatch-grid",Wt);const hr=b` ${w}:host{display:inline-flex;position:relative;padding:3px;background:var( --os-ui-segmented-bg,var( --os-ui-hover,rgba( 0,0,0,0.05 ) ) );border-radius:8px;gap:2px}.os-segmented__thumb{position:absolute;top:3px;bottom:3px;left:0;width:var( --_thumb-w,0px );border-radius:6px;background-color:var( --os-ui-segmented-selected-bg,var( --os-ui-accent,#2271b1 ) );background-image:var( --os-ui-segmented-selected-image,none );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;transform:translateX( var( --_thumb-x,0px ) );pointer-events:none;opacity:0}:host( [ data-thumb ] ) .os-segmented__thumb{opacity:1}:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition:transform var( --_holo-t-slow ) var( --_holo-spring ),width var( --_holo-t-slow ) var( --_holo-ease ),opacity var( --_holo-t-fast ) linear}@media ( prefers-reduced-motion:reduce ){:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition-duration:1ms}}`,pr=b` ${w} ${kt}:host{flex:1 1 auto;min-width:0}button{appearance:none;display:block;width:100%;padding:6px 13px;background:transparent;border:0;font:inherit;font-size:13px;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:6px;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,background-position var( --_holo-t ) ease;white-space:nowrap}button:hover{color:var( --os-ui-fg,#1d2327 )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}:host( [ aria-checked='true' ] ) button{color:var( --os-ui-segmented-selected-fg,var( --os-ui-fg-on-accent,#fff ) );transition-duration:var( --_holo-t-fast )}:host( [ aria-checked='true' ] ) button::before{display:none}`,de=class de extends m{render(){return this.setAttribute("role","radio"),c`
			<button
				type="button"
				class="os-holo-sheen"
				@click=${()=>this._onPick()}
		...
		`};let Yt=pe;v("os-select",Yt);const vr=b`
	:host {
		display: flex;
...
`;function _r(){const r="os-multiselect-popover-styles";if(document.getElementById(r))return;const e=document.createElement("style");e.id=r,e.textContent=`
...
`,document.head.appendChild(e)}typeof document<"u"&&_r();const ge=class ge extends m{constructor(){super(...arguments),this._optionObserver=null,this._popover=null,this._teardownOpen=null,this._hasMore=!1,this._loadingMore=!1}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const i of Array.from(t))i.remove();for(const i of e){const n=document.createElement("os-option");n.setAttribute("value",i.value),n.textContent=i.label,this.appendChild(n)}this._loadingMore=!1;const s=new Set(e.map(i=>i.value)),o=this._readValues().filter(i=>s.has(i));this._writeValueAttribute(o),this.requestUpdate(),this._refreshPopover()}get values(){return this._readValues()}set values(e){const t=Array.isArray(e)?e.map(s=>String(s)).filter(s=>s!==""):[];this._writeValueAttribute(t),this.requestUpdate(),this._refreshPopover()}get hasMore(){return this._hasMore}set hasMore(e){this._hasMore=!!e,this._refreshPopover()}get loadingMore(){return this._loadingMore}set loadingMore(e){this._loadingMore=!!e,this._refreshPopover()}appendItems(e){if(this._loadingMore=!1,!e||e.length===0){this._refreshPopover();return}const t=new Set(Array.from(this.querySelectorAll(":scope > os-option")).map(s=>s.getAttribute("value")));for(const s of e){if(t.has(s.value))continue;const o=document.createElement("os-option");o.setAttribute("value",s.value),o.textContent=s.label,this.appendChild(o)}this.requestUpdate(),this._refreshPopover()}connectedCallback(){super.connectedCallback(),te(this),this._optionObserver=new MutationObserver(()=>{this.requestUpdate(),this._refreshPopover()}),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._closePopover()}render(){const e=this.label||"",t=this.placeholder||"All",s=this.disabled!==null;e?this.setAttribute("aria-label",e):this.removeAttribute("aria-label");const o=e||t,i=this._summarize(t),n=this._readValues().length>0,l=`${this.id||"os-unnamed"}__trigger`;return c`
		...
		`}connectedCallback(){super.connectedCallback(),getComputedStyle(this).direction==="rtl"&&this.style.setProperty("--_range-angle","270deg")}_onInput(e){const t=e.target,s=parseFloat(t.value);Number.isFinite(s)&&(this.value=String(s),this.emit("os-range-change",{value:s}))}};fe.props=["label","value","min","max","step","suffix","decimals"],fe.styles=[yr],fe.help=void 0;let Jt=fe;v("os-range-field",Jt);const Ro=b` ${w} ${Kt}:host{--_field-size:var( --os-ui-field-font-size,13px );--_field-radius:var( --os-ui-field-radius,6px );display:flex;flex-direction:column;gap:4px;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-text-field__label{font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row{position:relative;display:flex;align-items:center;width:100%}input{appearance:none;-webkit-appearance:none;display:block;width:100%;min-width:0;box-sizing:border-box;padding:7px 10px;background:var( --os-window-bg,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:var( --_field-radius );font:inherit;font-size:var( --_field-size );color:var( --os-ui-fg,#1d2327 )}.os-text-field__suffix{position:absolute;inset-inline-end:10px;top:50%;transform:translateY( -50% );pointer-events:none;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row--has-reveal input{padding-inline-end:36px}.os-text-field__row--has-clear input{padding-inline-end:36px}.os-text-field__row--has-reveal.os-text-field__row--has-clear input{padding-inline-end:68px}.os-text-field__clear{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0}.os-text-field__row--has-reveal .os-text-field__clear{inset-inline-end:34px;border-radius:0}.os-text-field__clear:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__clear:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 )}.os-text-field__clear:disabled{opacity:0.45;cursor:default}.os-text-field__reveal{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0;transition:color 0.12s ease}.os-text-field__reveal:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__reveal:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 );border-radius:0 6px 6px 0}.os-text-field__reveal:disabled{opacity:0.45;cursor:not-allowed}.os-text-field__input--masked{-webkit-text-security:disc;text-security:disc}@supports not ( ( -webkit-text-security:disc ) or ( text-security:disc ) ){.os-text-field__input--masked{font-family:text-security-disc,"password",monospace;letter-spacing:0.2em}}input:disabled{opacity:0.55;cursor:not-allowed;background:var( --os-ui-hover,rgba( 0,0,0,0.03 ) )}input[ aria-invalid='true' ],input[ aria-invalid='true' ]:hover:not(:disabled ){border-color:var( --os-ui-danger,#d63638 )}input[ aria-invalid='true' ]:focus,input[ aria-invalid='true' ]:focus-visible{border-color:var( --os-ui-danger,#d63638 );box-shadow:0 0 0 1px var( --os-ui-danger,#d63638 ),0 0 0 4px rgba( 214,54,56,0.18 )}input[ type='number' ]::-webkit-inner-spin-button,input[ type='number' ]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[ type='number' ]{-moz-appearance:textfield}`,me=class me extends m{constructor(){super(...arguments),this._revealed=!1}connectedCallback(){super.connectedCallback(),te(this)}render(){const e=this.label||"",t=this.value??"",s=this.placeholder||"",o=this.disabled!==null,i=this.readonly!==null,n=this.autocomplete,a=this.type||"text",l=a==="password";let d=n||"off";l&&(!n||d==="off")&&(d="new-password");const u=this.maxlength,h=this.minlength,p=this.pattern||"",f=this.name||"",g=this.suffix||"",x=this.invalid!==null,_=this.reveal!==null,y=this.clearable!==null,C=a==="password",L=C&&!(_&&this._revealed);let A;C||_&&this._revealed?A="text":A=a;const D=["os-text-field__row",_?"os-text-field__row--has-reveal":"",y?"os-text-field__row--has-clear":""].filter(Boolean).join(" "),J=L?"os-text-field__input os-text-field__input--masked":"os-text-field__input",Tt=`${this.id||"os-unnamed"}__input`;return c`
			...
			<span class=${D}>
				...
				/>
				${g?c`<span class="os-text-field__suffix">${g}</span>`:c``}
				${y&&t!==""?this._renderClearButton(o):c``}
				${_?this._renderRevealButton(o):c``}
			</span>
		...
		`}_onClear(){this.value="",this.emit("os-input-change",{value:""}),this.emit("os-input-commit",{value:""}),this.shadowRoot?.querySelector("input")?.focus()}_renderRevealButton(e){const t=this._revealed?"Hide":"Show";return c`
			...
			>
				${this._revealed?Sr():Ar()}
			</button>
		`}_onToggleReveal(){this._revealed=!this._revealed,this.requestUpdate()}_onInput(e){const t=e.target;this.value=t.value,this.emit("os-input-change",{value:t.value})}_onChange(e){const t=e.target;this.emit("os-input-commit",{value:t.value})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target;this.emit("os-submit",{value:t.value})}}};me.props=["label","value","placeholder","disabled","readonly","autocomplete","type","maxlength","minlength","pattern","name","suffix","invalid","reveal","clearable"],me.styles=[Ro],me.help=void 0;let es=me;v("os-text-field",es);function Cr(){return c`
		<svg
			viewBox="0 0 16 16"
			width="14"
			height="14"
	...
	`}const ve=class ve extends m{connectedCallback(){super.connectedCallback(),te(this)}render(){const e=this.label||"",t=this.value??"",s=this.placeholder||"",o=this.disabled!==null,i=this.readonly!==null,n=this.name||"",a=this.suffix||"",l=this.min,d=this.max,u=this.step||"any",h=this.invalid!==null,f=`${this.id||"os-unnamed"}__input`;return c`
			${e?c`<label
						class="os-text-field__label"
						for=${f}
					>${e}</label>`:c``}
		...
		`}_onChange(e){const s=e.target.checked;s?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("os-checkbox-change",{checked:s,value:this.value})}};_e.props=["checked","value","label","disabled"],_e.styles=[Er],_e.help=void 0;let ss=_e;v("os-checkbox",ss);const zr=b` ${w} ${Ct}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg,#1d2327 );cursor:pointer;-webkit-user-select:none;user-select:none}label{display:inline-flex;align-items:center;gap:8px;cursor:pointer}:host( [ disabled ] ){opacity:0.5;cursor:not-allowed}:host( [ disabled ] ) label,:host( [ disabled ] ) input[ type='checkbox' ]{cursor:not-allowed}`,xe=class xe extends m{render(){const e=this.label||"",t=this.checked!==null,s=this.disabled!==null;return c`
			<label>
				<input
					type="checkbox"
					?checked=${t}
		...
		`};let ls=$e;v("os-tabs",ls);const Ce=class Ce extends m{connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0");const e=Fr(this);e&&Mo(e,e.getAttribute("value"))}render(){return c`<slot></slot>`}};Ce.props=["for"],Ce.styles=[qr],Ce.help={title:"Tab panel",summary:'Auto-managed panel paired with a sibling <os-tabs>. Declares which tab it belongs to via `for="<tab-value>"`; the parent strip toggles `hidden` whenever the active tab changes. role="tabpanel" and tabindex="0" are set automatically.',status:"stable",props:[{name:"for",type:"string",description:"Matches the `value` of the owning <os-tab>. Panel is shown when its parent tabs strip is on that value."}],slots:[{name:"(default)",description:"Panel body content."}],example:c`
		...
		`}};Re.props=["open","title","size","mandatory"],Re.styles=[Yr],Re.help=void 0;let fs=Re;v("os-modal",fs);const qo="X-WP-Nonce";function Or(r,e){const t=Qr();if(!t)return e;const s=Jr(r);if(!s||!en(s))return e;const o=e?.headers??(typeof Request<"u"&&r instanceof Request?r.headers:void 0),i=new Headers(o??{});return i.has(qo)?e:(i.set(qo,t),{...e??{},headers:i})}function Qr(){if(typeof window>"u")return;const e=window.openStationConfig?.restNonce;return typeof e=="string"&&e.length>0?e:void 0}function Jr(r){try{const e=typeof window<"u"&&window.location?window.location.href:void 0;return typeof r=="string"?new URL(r,e):r instanceof URL?r:typeof Request<"u"&&r instanceof Request?new URL(r.url,e):null}catch{return null}}function en(r){return typeof window>"u"||!window.location||r.origin!==window.location.origin?!1:!!(r.pathname.includes("/wp-json/")||r.searchParams.has("rest_route"))}function tn(r,e,t={}){const s=window.wp?.os?.fetch;if(typeof s=="function")return s(r,e,t);const o=Or(r,e);return fetch(r,o)}const sn=b`:host{display:block;position:relative;font-size:13px}.input{width:100%;padding:8px 10px;background:var( --os-ui-input-bg,var( --os-ui-hover,rgba( 255,255,255,0.06 ) ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );border-radius:6px;font:inherit;box-sizing:border-box}.input:focus{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --os-ui-focus-ring-field,0 0 0 1px #2271b1,0 0 0 4px rgba( 34,113,177,0.18 ) )}.dropdown{background:var( --os-bg,#1d2327 );color:var( --os-fg,#fff );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.18 ) );border-radius:6px;overflow:auto;z-index:11000;box-shadow:0 12px 32px rgba( 0,0,0,0.5 )}.empty.error{color:var( --os-ui-danger-hover,#ff8080 )}.item{display:flex;align-items:center;gap:10px;padding:8px 10px;cursor:pointer;border:0;background:transparent;color:inherit;width:100%;text-align:start;font:inherit}.item:hover,.item:focus{background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );outline:none}.avatar{width:24px;height:24px;border-radius:50%;flex:0 0 auto;background:var( --os-ui-hover,rgba( 255,255,255,0.1 ) )}.name{font-weight:500}.slug{opacity:0.6;font-size:12px}.empty{padding:12px;color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,Me=class Me extends m{constructor(){super(...arguments),this._timer=null,this._abort=null,this._results=[],this._query="",this._open=!1,this._phase="idle",this._error="",this._dropdownStyle="",this._onScrollOrResize=()=>{},this._onInput=e=>{const t=e.target.value;this._query=t,this._scheduleSearch(t)},this._onFocus=()=>{if(this._results.length===0&&this._phase==="idle"){this._scheduleSearch(this._query);return}this._open=!0,this._positionDropdown(),this.requestUpdate()},this._onBlur=()=>{setTimeout(()=>{this._open=!1,this.requestUpdate()},150)},this._pick=e=>{this.emit("os-user-pick",{user:e}),this._results=[],this._open=!1,this._phase="idle",this._query="";const t=this.shadowRoot?.querySelector(".input");t&&(t.value=""),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this._onScrollOrResize=()=>{this._open&&(this._positionDropdown(),this.requestUpdate())},window.addEventListener("resize",this._onScrollOrResize),window.addEventListener("scroll",this._onScrollOrResize,!0)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),this._abort&&this._abort.abort(),window.removeEventListener("resize",this._onScrollOrResize),window.removeEventListener("scroll",this._onScrollOrResize,!0)}_endpoint(){const e=this.getAttribute("endpoint");return e||window.openStationConfig?.filesUsersSearchUrl||""}_scheduleSearch(e){this._timer&&clearTimeout(this._timer),this._phase="loading",this._open=!0,this._positionDropdown(),this.requestUpdate(),this._timer=setTimeout(()=>this._runSearch(e),200)}async _runSearch(e){const t=this._endpoint();if(!t){this._phase="error",this._error="Search endpoint is not configured.",this._results=[],this._open=!0,this.requestUpdate();return}this._abort&&this._abort.abort();const s=new AbortController;this._abort=s;const o=this.getAttribute("exclude")||"",i=t+"?q="+encodeURIComponent(e)+"&exclude="+encodeURIComponent(o);try{const n={signal:s.signal,credentials:"same-origin"},a=await tn(i,n,{source:"desktop-mode/files-user-search",silent:!0});if(!a.ok)throw new Error(`HTTP ${a.status}`);const l=await a.json();this._results=l&&Array.isArray(l.users)?l.users:[],this._phase="ready",this._error="",this._open=!0}catch(n){if(n.name==="AbortError")return;this._results=[],this._phase="error",this._error=n.message||"Search failed.",this._open=!0}this._positionDropdown(),this.requestUpdate()}_positionDropdown(){const e=this.shadowRoot?.querySelector(".input");if(!e)return;const t=e.getBoundingClientRect(),s=t.bottom+4,o=t.left,i=t.width,a=window.innerHeight-t.bottom,l=t.top,d=Math.max(120,Math.min(280,Math.max(a,l)-16));a<200&&l>a?this._dropdownStyle=["position:fixed",`left:${o}px`,`top:${t.top-4-d}px`,`width:${i}px`,`max-height:${d}px`].join(";"):this._dropdownStyle=["position:fixed",`left:${o}px`,`top:${s}px`,`width:${i}px`,`max-height:${d}px`].join(";")}_dropdownContent(){if(this._phase==="loading")return c`<div class="empty">Searching…</div>`;if(this._phase==="error")return c`<div class="empty error">${this._error}</div>`;if(this._results.length===0){const e=this._query?"No matches.":"No users available.";return c`<div class="empty">${e}</div>`}return this._results.map(e=>c`
			...
			${this._open?c`
				...
				`:c``}
		`}};Me.props=["placeholder","exclude","endpoint"],Me.styles=[sn],Me.help=void 0;let ms=Me;v("os-user-search",ms);const on=b`:host{display:flex;flex-wrap:wrap;gap:6px;font-size:13px}.chip{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:999px;background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );cursor:pointer;font:inherit}.chip:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.12 ) )}.chip[ aria-pressed='true' ]{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.empty{color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,Ie=class Ie extends m{constructor(){super(...arguments),this._onToggle=e=>{const t=!this._selectedSet().has(e);this.emit("os-role-toggle",{slug:e,selected:t})}}_selectedSet(){const e=this.getAttribute("selected")||"";return new Set(e.split(",").map(t=>t.trim()).filter(t=>t!==""))}_roles(){const e=this.getAttribute("roles");if(e)try{const t=JSON.parse(e);if(Array.isArray(t))return t}catch{}return window.openStationConfig?.shareEligibleRoles||[]}render(){const e=this._roles();if(e.length===0)return c`<span class="empty">No eligible roles.</span>`;const t=this._selectedSet();return c`
		...
		`}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._paintSvg())}attributeChangedCallback(e,t,s){super.attributeChangedCallback(e,t,s),queueMicrotask(()=>this._paintSvg())}_paintSvg(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector("svg"),s=e.querySelector("[data-svg-buffer]");if(t&&s){const o=s.textContent||"";t.innerHTML!==o&&(t.innerHTML=o)}}};De.props=["variant"],De.styles=[an],De.help=void 0;let xs=De;v("os-tab-chip",xs);const cn=b`:host{display:flex;flex-direction:column;gap:var( --os-ui-stack-gap,12px );align-items:var( --os-ui-stack-align,stretch );padding:var( --os-ui-stack-padding,0 )}:host( [ hidden ] ){display:none}`,Te=class Te extends m{render(){const e=this.gap,t=this.align,s=this.padding,o=e&&/^\d+$/.test(e)?`${e}px`:"";return o&&this.style.setProperty("--os-ui-stack-gap",o),t&&this.style.setProperty("--os-ui-stack-align",t),s!==null&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-stack-padding",`${s}px`),c`<slot></slot>`}};Te.props=["gap","align","padding"],Te.styles=[cn],Te.help=void 0;let ys=Te;v("os-stack",ys);const dn=b`:host{display:flex;flex-direction:row;flex-wrap:wrap;gap:var( --os-ui-cluster-gap,8px );justify-content:var( --os-ui-cluster-justify,flex-start );align-items:var( --os-ui-cluster-align,center )}:host( [ hidden ] ){display:none}`,qe=class qe extends m{render(){const e=this.gap,t=this.justify,s=this.align,o=e&&/^\d+$/.test(e)?`${e}px`:"";return o&&this.style.setProperty("--os-ui-cluster-gap",o),t&&this.style.setProperty("--os-ui-cluster-justify",t),s&&this.style.setProperty("--os-ui-cluster-align",s),c`<slot></slot>`}};qe.props=["gap","justify","align"],qe.styles=[dn],qe.help=void 0;let ws=qe;v("os-cluster",ws);const un=b`:host{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );color:inherit;line-height:1}:host( [ hidden ] ){display:none}.os-icon__glyph{font-size:var( --os-ui-icon-size,16px );width:var( --os-ui-icon-size,16px );height:var( --os-ui-icon-size,16px );line-height:1;color:inherit;display:inline-flex;align-items:center;justify-content:center}.os-icon__glyph--char{font-family:dashicons;font-style:normal;font-weight:normal;font-variant:normal;text-transform:none;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;speak:none}.os-icon__glyph.dashicons{font-family:dashicons}`;let At=null;function hn(r){let e=r.trim();if(e==="")return null;(e.startsWith('"')&&e.endsWith('"')||e.startsWith("'")&&e.endsWith("'"))&&(e=e.slice(1,-1));const t=e.match(/^\\([0-9a-f]{1,6})\s?$/i);return t?String.fromCodePoint(parseInt(t[1],16)):e||null}function Ho(){const r=new Map;if(typeof document>"u")return r;const e=Array.from(document.styleSheets??[]);for(const t of e){let s=null;try{s=t.cssRules}catch{continue}if(s)for(const o of Array.from(s)){const i=o;if(!i||!i.selectorText)continue;const n=i.selectorText.match(/\.dashicons-([a-z0-9-]+)::?before/i);if(!n)continue;const a=i.style?.content;if(!a)continue;const l=hn(a);l&&r.set(n[1],l)}}return r}function pn(r){At||(At=Ho());const e=r.startsWith("dashicons-")?r.slice(10):r;return At.get(e)??null}function gn(){At=Ho()}let Fo=!1;function bn(){if(Fo||typeof window>"u")return;Fo=!0;const r=()=>{gn()};document.readyState==="loading"&&document.addEventListener("DOMContentLoaded",r,{once:!0}),window.addEventListener("load",r,{once:!0})}bn();const Ne=class Ne extends m{render(){const e=this.name||"",t=e.startsWith("dashicons-")?e.slice(10):e,s=this.size;s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-icon-size",`${s}px`);const o=pn(t);return o?c`<span
				class="os-icon__glyph os-icon__glyph--char dashicons dashicons-${t}"
				aria-hidden="true"
			>${o}</span>`:c`<span
			class="os-icon__glyph dashicons dashicons-${t}"
			aria-hidden="true"
		></span>`}};Ne.props=["name","size"],Ne.styles=[un],Ne.help=void 0;let ks=Ne;v("os-icon",ks);const fn=b`:host{display:flex;flex-direction:column;gap:var( --os-ui-body-gap,12px );padding:var( --os-ui-body-padding,16px );box-sizing:border-box;width:100%;height:100%;min-width:0;min-height:0}:host( [ scroll ] ){overflow:auto}:host( [ hidden ] ){display:none}::slotted( * ){min-width:0}`,He=class He extends m{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-body-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-body-padding",`${t}px`),c`<slot></slot>`}};He.props=["gap","padding","scroll"],He.styles=[fn],He.help=void 0;let $s=He;v("os-body",$s);const mn=b`:host{display:flex;flex-direction:column;gap:var( --os-ui-panel-gap,12px );padding:var( --os-ui-panel-padding,16px );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );box-sizing:border-box}:host( [ hidden ] ){display:none}`,Fe=class Fe extends m{render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-panel-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-panel-padding",`${t}px`),c`<slot></slot>`}};Fe.props=["gap","padding"],Fe.styles=[mn],Fe.help=void 0;let Cs=Fe;v("os-panel",Cs);const vn=b`:host{display:grid;grid-template-columns:repeat( 12,minmax( 0,1fr ) );gap:var( --os-ui-row-gap,12px );row-gap:var( --os-ui-row-row-gap,var( --os-ui-row-gap,12px ) );column-gap:var( --os-ui-row-column-gap,var( --os-ui-row-gap,12px ) );width:100%;min-width:0}:host( [ hidden ] ){display:none}::slotted( [ col='1' ] ){grid-column:span 1}::slotted( [ col='2' ] ){grid-column:span 2}::slotted( [ col='3' ] ){grid-column:span 3}::slotted( [ col='4' ] ){grid-column:span 4}::slotted( [ col='5' ] ){grid-column:span 5}::slotted( [ col='6' ] ){grid-column:span 6}::slotted( [ col='7' ] ){grid-column:span 7}::slotted( [ col='8' ] ){grid-column:span 8}::slotted( [ col='9' ] ){grid-column:span 9}::slotted( [ col='10' ] ){grid-column:span 10}::slotted( [ col='11' ] ){grid-column:span 11}::slotted( [ col='12' ] ){grid-column:span 12}::slotted(:not( [ col ] ) ){grid-column:1 / -1}::slotted( * ){min-width:0}`,Ue=class Ue extends m{render(){const e=this.gap,t=this["column-gap"],s=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-row-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-row-column-gap",`${t}px`),s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-row-row-gap",`${s}px`),c`<slot></slot>`}};Ue.props=["gap","column-gap","row-gap"],Ue.styles=[vn],Ue.help=void 0;let As=Ue;v("os-row",As);const _n=b`:host{display:grid;grid-template-columns:var( --os-ui-grid-columns,1fr );grid-template-rows:var( --os-ui-grid-rows,auto );gap:var( --os-ui-grid-gap,8px );column-gap:var( --os-ui-grid-column-gap,var( --os-ui-grid-gap,8px ) );row-gap:var( --os-ui-grid-row-gap,var( --os-ui-grid-gap,8px ) )}:host( [ hidden ] ){display:none}`,je=class je extends m{render(){const e=this.columns,t=this.rows,s=this.gap,o=this["column-gap"],i=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-grid-columns",`repeat(${e}, minmax(0, 1fr))`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-grid-rows",`repeat(${t}, minmax(0, 1fr))`),s&&/^\d+$/.test(s)&&this.style.setProperty("--os-ui-grid-gap",`${s}px`),o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-grid-column-gap",`${o}px`),i&&/^\d+$/.test(i)&&this.style.setProperty("--os-ui-grid-row-gap",`${i}px`),c`<slot></slot>`}};je.props=["columns","rows","gap","column-gap","row-gap"],je.styles=[_n],je.help=void 0;let Ss=je;v("os-grid",Ss);const xn=b`:host{display:flex;align-items:center;justify-content:var( --os-ui-display-align,flex-end );width:100%;min-height:calc( var( --os-ui-display-size,28px ) * 1.4 );padding:8px 14px;box-sizing:border-box;font-size:var( --os-ui-display-size,28px );font-variant-numeric:tabular-nums;font-weight:500;letter-spacing:0.01em;color:var( --os-ui-display-fg,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-display-bg,transparent );border-radius:var( --os-ui-display-border-radius,0 );line-height:1.1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}:host( [ hidden ] ){display:none}.os-display__output{display:block;font:inherit;color:inherit;text-align:var( --os-ui-display-align,end );overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0}`,Uo={sm:"16px",md:"20px",lg:"28px",xl:"40px"},Ke=class Ke extends m{connectedCallback(){super.connectedCallback?.(),this.hasAttribute("aria-live")||this.setAttribute("aria-live","polite"),this.hasAttribute("role")||this.setAttribute("role","status")}render(){const e=this.value,t=this.size||"lg",s=this.align||"end";return this.style.setProperty("--os-ui-display-size",Uo[t]||Uo.lg),this.style.setProperty("--os-ui-display-align",s),c`
			<output part="output" class="os-display__output">
				${e??c`<slot></slot>`}
			</output>
		`}};Ke.props=["value","size","align"],Ke.styles=[xn],Ke.help=void 0;let Es=Ke;v("os-display",Es);const yn=b`:host{display:block}:host( [ hidden ] ){display:none}.os-disclosure__summary{display:flex;align-items:center;gap:8px;width:100%;padding:0;background:none;border:0;font:inherit;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer}.os-disclosure__summary:focus-visible{outline:2px solid var( --os-ui-accent,#f252fc );outline-offset:2px;border-radius:4px}.os-disclosure__heading{flex:1 1 auto;min-width:0;margin:0;font-size:20px;font-weight:500;letter-spacing:-0.01em}.os-disclosure__hint{flex:0 0 auto;font-size:13px;font-weight:400;color:var( --os-ui-fg-muted,#646970 )}.os-disclosure__marker{flex:0 0 auto;width:8px;height:8px;margin-inline-end:2px;border-inline-end:2px solid currentColor;border-block-end:2px solid currentColor;transform:rotate( -45deg );transition:transform 160ms ease;opacity:0.7}:host( [ open ] ) .os-disclosure__marker{transform:rotate( 45deg )}@media ( prefers-reduced-motion:reduce ){.os-disclosure__marker{transition:none}}.os-disclosure__body{margin-block-start:14px}.os-disclosure__body[ hidden ]{display:none}`;let wn=0;const Ve=class Ve extends m{constructor(){super(...arguments),this.bodyId=`os-disclosure-body-${++wn}`,this.onToggle=()=>{const e=!this.isOpen();e?this.setAttribute("open",""):this.removeAttribute("open"),this.emit("os-disclosure-toggle",{open:e})}}isOpen(){return this.hasAttribute("open")}render(){const e=this.heading||"",t=this.hint||"",s=this.isOpen();return c`
			<button
				type="button"
		...
		`}};Ve.props=["heading","hint","open"],Ve.styles=[yn],Ve.help=void 0;let zs=Ve;v("os-disclosure",zs);const kn=b`:host{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;padding:32px 24px;text-align:center;color:var( --os-ui-empty-state-fg,var( --os-ui-fg-muted,#646970 ) )}:host( [ hidden ] ){display:none}.os-empty-state__icon{margin-bottom:4px;color:var( --os-ui-empty-state-icon-color,currentColor );opacity:0.75}.os-empty-state__heading{margin:0;font-size:14px;font-weight:600;color:var( --os-ui-fg,#1d2327 )}.os-empty-state__description{margin:0;font-size:12px;line-height:1.4;max-width:48ch}.os-empty-state__description:empty{display:none}.os-empty-state__cta{margin-top:8px}.os-empty-state__cta:empty{display:none}`,Be=class Be extends m{render(){const e=this.icon||"",t=this.heading||"",s=this.description||"";return c`
			${e?c`<os-icon
			...
			<slot></slot>
		`}};Be.props=["icon","heading","description"],Be.styles=[kn],Be.help=void 0;let Ls=Be;v("os-empty-state",Ls);const $n=b` ${w} ${kt} ${$t} ${Ut}:host{display:inline-flex;user-select:none}:host( [ fill-cell ] ),:host{display:flex;width:100%}:host( [ hidden ] ){display:none}button{width:100%;min-height:var( --os-ui-key-min-height,48px );appearance:none;display:inline-flex;align-items:center;justify-content:center;padding:var( --os-ui-key-padding,8px 12px );font:inherit;font-size:var( --os-ui-key-font-size,16px );font-weight:500;cursor:pointer;border-radius:var( --os-ui-key-border-radius,8px );background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-key-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-key-border,1px solid transparent );transition:transform 0.08s ease,background-color 0.12s ease,box-shadow 0.12s ease}button:hover:not(:disabled ){background:var( --os-ui-key-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before{opacity:0 !important}:host( [ variant='primary' ] ) button{background:var( --os-ui-key-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-key-fg,var( --os-ui-fg-on-accent,#fff ) )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 )}:host( [ variant='secondary' ] ) button{background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}:host( [ variant='ghost' ] ) button{background:transparent;border:var( --os-ui-key-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ variant='danger' ] ) button{background:transparent;color:var( --os-ui-danger,#d63638 );border:1px solid currentColor}:host( .os-key--pressed ) button,button:active:not(:disabled ){transform:scale( 0.96 );box-shadow:inset 0 1px 2px rgba( 0,0,0,0.22 );background:var( --os-ui-key-bg-pressed,var( --os-ui-hover,rgba( 0,0,0,0.14 ) ) )}button:disabled{opacity:0.5;cursor:not-allowed}`,St="os-key--pressed",We=class We extends m{constructor(){super(...arguments),this._onKeyDown=null,this._onKeyUp=null,this._keyHeldByKeyboard=!1}connectedCallback(){super.connectedCallback?.(),this._onKeyDown=e=>this.handleKeyboardDown(e),this._onKeyUp=e=>this.handleKeyboardUp(e),document.addEventListener("keydown",this._onKeyDown),document.addEventListener("keyup",this._onKeyUp)}disconnectedCallback(){this._onKeyDown&&document.removeEventListener("keydown",this._onKeyDown),this._onKeyUp&&document.removeEventListener("keyup",this._onKeyUp)}render(){const e=this.label,t=this.disabled!==null;return c`
			<button
				part="button"
				class="os-holo-sheen"
				type="button"
		...
		`}paint(){const e=this.shadowRoot,t=e?.querySelector(".chart"),s=e?.querySelector(".tooltip");if(!t||!s)return;this._tooltip=s,s.hidden=!0,t.textContent="";const o=this.columnList,i=o.some($=>$.some(E=>E>0));if(o.length===0||!i){const $=document.createElement("div");$.className="empty",$.textContent=this.getAttribute("empty")??"",t.appendChild($);return}const n=this.seriesList,a=this.hiddenSet,l=n.map(($,E)=>a.has($.key)?-1:E).filter($=>$>=0),d=parseInt(this.getAttribute("height")??"",10),u=Number.isFinite(d)&&d>40?d:Ba,h=Math.max(280,this.clientWidth||640),p=h-T-Ka,f=u-ie-ja,g=o.length,x=p/g,_=Math.max(2,Math.min(Va,x-Os)),y=o.reduce(($,E)=>{const H=l.reduce((F,Nt)=>F+(E[Nt]??0),0);return Math.max($,H)},0),C=Xa(y),L=f/C,A=B("svg",{width:String(h),height:String(u),viewBox:`0 0 ${h} ${u}`,role:"img"});for(const $ of[0,.5,1]){const E=C*$,H=ie+f-E*L;A.appendChild(B("line",{class:"grid",x1:String(T),y1:String(H),x2:String(T+p),y2:String(H)}));const F=B("text",{class:"tick",x:String(T+p+6),y:String(H+3.5)});F.textContent=Number.isInteger(E)?E.toLocaleString():String(E),A.appendChild(F)}const D=Number(this.getAttribute("start"))||0,J=Number(this.getAttribute("end"))||D+g,mo=Math.max(1,(J-D)/g),Tt=J-D>36*3600,X=$=>new Date($*1e3).toLocaleString([],Tt?{month:"short",day:"numeric"}:{hour:"2-digit",minute:"2-digit"}),Tl=$=>new Date($*1e3).toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),ql=[[D,T,"start"],[D+(J-D)/2,T+p/2,"middle"],[J,T+p,"end"]];for(const[$,E,H]of ql){const F=B("text",{class:"tick",x:String(E),y:String(u-5),"text-anchor":H});F.textContent=X($),A.appendChild(F)}const qt=B("rect",{class:"hover",y:String(ie),width:String(x),height:String(f),visibility:"hidden"});A.appendChild(qt),o.forEach(($,E)=>{const H=T+E*x+(x-_)/2;let F=ie+f;const Nt=l.filter(_t=>($[_t]??0)>0),Nl=Nt[Nt.length-1];for(const _t of l){const Bi=$[_t]??0;if(Bi===0)continue;const Wi=n[_t].tone??"neutral",_o=Bi*L,xo=F-_o;_t===Nl?A.appendChild(B("path",{class:"seg","data-tone":Wi,d:Ga(H,xo,_,Math.max(1.5,_o))})):A.appendChild(B("rect",{class:"seg","data-tone":Wi,x:String(H),y:String(xo+Os),width:String(_),height:String(Math.max(1.5,_o-Os))})),F=xo}const vo=B("rect",{class:"hit",x:String(T+E*x),y:String(ie),width:String(x),height:String(f)});vo.addEventListener("pointerenter",()=>{qt.setAttribute("x",String(T+E*x)),qt.setAttribute("visibility","visible"),this.showTooltip(E,$,x,h,{head:`${Tl(D+E*mo)} – ${X(D+(E+1)*mo)}`,series:n,visibleIndexes:l})}),vo.addEventListener("pointerleave",()=>{qt.setAttribute("visibility","hidden"),s.hidden=!0}),A.appendChild(vo)}),t.appendChild(A)}showTooltip(e,t,s,o,i){const n=this._tooltip;if(!n)return;n.textContent="";const a=document.createElement("div");a.className="tooltip-head",a.textContent=i.head,n.appendChild(a);let l=0;for(const u of[...i.visibleIndexes].reverse()){const h=t[u]??0;if(h===0)continue;l++;const p=document.createElement("div");p.className="tooltip-row";const f=document.createElement("span");f.className="swatch",f.dataset.tone=i.series[u].tone??"neutral";const g=document.createElement("span");g.className="tooltip-label",g.textContent=i.series[u].label;const x=document.createElement("span");x.className="tooltip-value",x.textContent=h.toLocaleString(),p.append(f,g,x),n.appendChild(p)}if(l===0){const u=document.createElement("div");u.className="tooltip-row",u.textContent="—",n.appendChild(u)}n.hidden=!1;const d=T+e*s+s/2;n.style.left=`${Math.max(60,Math.min(d,o-60))}px`}};st.props=["heading","series","columns","start","end","hidden-series","legend","empty","height"],st.styles=[Fa],st.help=void 0;let Qs=st;v("os-histogram",Qs);const Za=b`:host{--_border:var( --os-ui-stat-border,var( --os-ui-border,#dcdcde ) );--_bg:var( --os-ui-stat-bg,transparent );--_value-color:var( --os-ui-stat-value-color,var( --wp-admin-theme-color,#2271b1 ) );--_value-size:var( --os-ui-stat-value-size,20px );--_label-color:var( --os-ui-stat-label-color,var( --os-ui-fg-muted,#646970 ) );display:flex;flex-direction:column;gap:2px;padding:var( --os-ui-stat-padding,10px 12px );border:1px solid var( --_border );border-radius:var( --os-ui-stat-radius,8px );background:var( --_bg );min-inline-size:0}:host( [ hidden ] ){display:none}.value{font-size:var( --_value-size );font-weight:700;line-height:1.1;color:var( --_value-color );font-variant-numeric:tabular-nums}.label{display:inline-flex;align-items:center;gap:6px;font-size:11px;letter-spacing:0.05em;text-transform:uppercase;color:var( --_label-color )}.caption{font-size:11px;color:var( --_label-color )}.swatch{display:inline-block;inline-size:10px;block-size:10px;border-radius:3px;flex:none;background:var( --os-app-tone,var( --os-ui-fg-muted,#646970 ) )}`,ot=class ot extends m{render(){const e=this,t=e.caption||"";return c`
		...
		`}_renderGlyph(e){return e==="saved"?rl():e==="failed"?nl():""}_labelForPhase(e){switch(e){case"pending":case"saving":return this["saving-label"]??"Saving…";case"saved":return this["saved-label"]??"Saved";case"failed":return(this.error??"")||"Couldn’t save";default:return this["idle-label"]??""}}_installAutoListener(){const e=this.event||Ii;this._docListener=t=>{const s=t.detail;!s||typeof s.phase!="string"||(this.phase=s.phase,s.error?this.error=s.error:s.phase!=="failed"&&this.error&&this.removeAttribute("error"))},document.addEventListener(e,this._docListener)}_removeAutoListener(){if(!this._docListener)return;const e=this.event||Ii;document.removeEventListener(e,this._docListener),this._docListener=null}_scheduleAutoClear(){this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null);const e=this.phase??"idle",t=this._autoClearMsFor(e);t<=0||(this._autoTimer=window.setTimeout(()=>{this._autoTimer=null,this.phase="idle"},t))}_autoClearMsFor(e){if(e==="saved"){const t=this["auto-clear-saved-ms"];return parseInt(t||"",10)||ol}if(e==="failed"){const t=this["auto-clear-failed-ms"];return parseInt(t||"",10)||il}return 0}};ct.props=["phase","mode","variant","animation","auto","event","error","saving-label","saved-label","idle-label","auto-clear-saved-ms","auto-clear-failed-ms"],ct.styles=[sl],ct.help=void 0;let ro=ct;v("os-save-status",ro);function rl(){return c`
		<svg
			viewBox="0 0 12 12"
			aria-hidden="true"
			focusable="false"
	...
	`}const al=b`:host{display:flex;width:100%;min-width:0;max-width:100%;align-items:stretch}.os-cat{display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:var( --os-ui-cat-padding,2px );min-height:24px;max-width:100%;width:100%}.os-cat__chips{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-cat-gap,4px );min-width:0}.os-cat__chains{display:flex;flex-wrap:wrap;gap:4px;min-width:0}.os-cat__viz-host{display:flex;align-items:center;gap:4px;min-width:0;flex:1 1 auto;max-width:100%;min-height:28px;cursor:pointer;position:relative}.os-cat__viz-svg{display:block;width:100%;max-width:100%;min-width:0;overflow:visible;flex:1 1 auto}.os-cat__viz-svg .os-cat-edge{fill:none;stroke:var( --os-ui-cat-edge-color,currentColor );stroke-width:1.25;stroke-linecap:round;opacity:0.55;transition:stroke-width 0.18s ease,opacity 0.18s ease}.os-cat__viz-svg .os-cat-edge[ data-active='true' ]{stroke-width:2;opacity:1}.os-cat__viz-svg .os-cat-node{cursor:pointer;transition:r 0.2s cubic-bezier( 0.34,1.56,0.64,1 ),fill 0.18s ease,stroke-width 0.18s ease,filter 0.18s ease}.os-cat__viz-svg .os-cat-node[ data-selected='true' ]{filter:drop-shadow( 0 0 6px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.18 ) ) )}.os-cat__viz-svg .os-cat-node:hover,.os-cat__viz-svg .os-cat-node:focus-visible{filter:drop-shadow( 0 0 8px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.3 ) ) );outline:none}.os-cat__viz-svg .os-cat-label{font-family:var( --os-ui-font,system-ui,sans-serif );font-size:10.5px;fill:var( --os-ui-cat-label-fg,var( --os-ui-fg,#1d2327 ) );font-weight:500;pointer-events:none;user-select:none}.os-cat__viz-svg .os-cat-label[ data-selected='false' ]{fill:var( --os-ui-cat-label-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-weight:400;font-style:italic}.os-cat__trigger{appearance:none;display:inline-flex;align-items:center;gap:4px;padding:1px 8px;min-height:22px;font:inherit;font-size:11px;font-weight:500;line-height:1;color:var( --os-ui-cat-trigger-fg,var( --os-ui-fg-muted,#50575e ) );background:transparent;border:1px dashed var( --os-ui-cat-trigger-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease,border-color 0.12s ease}.os-cat__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) );color:var( --os-ui-cat-trigger-fg-hover,var( --os-ui-fg,#1d2327 ) );border-color:var( --os-ui-cat-trigger-border-hover,var( --os-ui-border-strong,#8c8f94 ) )}.os-cat__trigger:focus-visible{outline:none;border-style:solid;box-shadow:0 0 0 2px var( --wp-admin-theme-color,#2271b1 )}.os-cat__trigger svg{display:block}.os-cat__uncategorized{display:inline-flex;align-items:center;gap:4px;padding:1px 10px;min-height:22px;font-size:11px;font-weight:500;line-height:1.6;color:var( --os-ui-cat-uncat-fg,var( --os-ui-fg-muted,#8c8f94 ) );background:transparent;border:1px dashed var( --os-ui-cat-uncat-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;font-style:italic}.os-cat__popover{position:fixed;top:0;left:0;min-width:280px;max-width:360px;max-height:360px;display:flex;flex-direction:column;background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-cat-pop-fg,var( --os-ui-fg,#1d2327 ) );border:1px solid var( --os-ui-cat-pop-border,var( --os-ui-border,#c3c4c7 ) );border-radius:8px;box-shadow:0 6px 16px rgba( 0,0,0,0.08 ),0 1px 2px rgba( 0,0,0,0.06 );z-index:1000}.os-cat__editor{position:relative;display:inline-flex;align-items:center}.os-cat__search{appearance:none;font:inherit;font-size:13px;padding:8px 12px;border:0;border-bottom:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );background:transparent;color:inherit;outline:none}.os-cat__search:focus{border-bottom-color:var( --wp-admin-theme-color,#2271b1 )}.os-cat__tree{flex:1 1 auto;min-height:0;overflow-y:auto;padding:4px 0}.os-cat__row-block{display:contents}.os-cat__row{display:flex;align-items:center;gap:6px;padding:4px 8px 4px var( --os-ui-cat-row-indent,12px );cursor:pointer;user-select:none;font-size:13px;line-height:1.4;position:relative}.os-cat__row:hover,.os-cat__row[ data-focused='true' ]{background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) )}.os-cat__row[ data-selected='true' ]{color:var( --wp-admin-theme-color,#2271b1 );font-weight:600}.os-cat__row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__expander{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;border:0;background:transparent;color:inherit;cursor:pointer;flex-shrink:0;opacity:0.65}.os-cat__expander:hover{opacity:1}.os-cat__expander svg{display:block;transition:transform 0.12s ease}.os-cat__row[ data-expanded='true' ] .os-cat__expander svg{transform:rotate( 90deg )}.os-cat__expander--placeholder{visibility:hidden}.os-cat__create-row{display:flex;align-items:center;padding:2px 8px 2px var( --os-ui-cat-row-indent,28px );position:relative}.os-cat__create-row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__create-wrap{display:inline-flex;align-items:center;flex:1 1 auto;min-width:0;gap:4px;padding:1px 1px 1px 0;border:1px solid transparent;border-radius:6px;background:transparent;transition:border-color 0.12s ease,background-color 0.12s ease,box-shadow 0.12s ease}.os-cat__create-wrap:hover{border-color:var( --os-ui-border,rgba( 0,0,0,0.12 ) );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) )}.os-cat__create-wrap:focus-within{border-color:var( --wp-admin-theme-color,#2271b1 );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );box-shadow:0 0 0 2px color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 15%,transparent )}.os-cat__create-input{flex:1 1 auto;min-width:0;appearance:none;font:inherit;font-size:var( --os-ui-field-font-size-compact,12px );padding:3px 6px;border:0;background:transparent;color:inherit;outline:none}.os-cat__create-input::placeholder{color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-style:italic;opacity:1}.os-cat__create-submit{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;flex-shrink:0;padding:0;border:0;border-radius:4px;background:transparent;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease}.os-cat__create-wrap:focus-within .os-cat__create-submit:not( [ disabled ] ){background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__create-submit:hover:not( [ disabled ] ){filter:brightness( 1.05 )}.os-cat__create-submit[ disabled ]{cursor:default;opacity:0.5}.os-cat__create-submit svg{display:block}.os-cat__create-spinner{display:inline-block;width:12px;height:12px;margin:0 4px;border-radius:50%;border:2px solid var( --wp-admin-theme-color,#2271b1 );border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;flex-shrink:0}.os-cat__check{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;border:1.5px solid var( --os-ui-cat-check-border,var( --os-ui-border,#8c8f94 ) );border-radius:3px;color:transparent;transition:background-color 0.12s ease,border-color 0.12s ease,color 0.12s ease}.os-cat__row[ data-selected='true' ] .os-cat__check{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__check svg{display:block;width:14px;height:14px}.os-cat__label{min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-cat__delete{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:18px;height:18px;border:0;border-radius:50%;padding:0;background:transparent;color:var( --os-ui-cat-delete-color,var( --os-ui-danger,#d63638 ) );cursor:pointer;opacity:0;transition:opacity 0.12s ease,background-color 0.12s ease}.os-cat__row:hover .os-cat__delete,.os-cat__row[ data-focused='true' ] .os-cat__delete,.os-cat__delete:focus-visible{opacity:1}.os-cat__delete:hover,.os-cat__delete:focus-visible{background:var( --os-ui-badge-danger-bg,rgba( 214,54,56,0.12 ) )}.os-cat__delete svg{display:block;width:14px;height:14px}.os-cat__match{background:var( --os-ui-search-highlight-bg,rgba( 252,211,77,0.45 ) );border-radius:2px;padding:0 1px}.os-cat__empty,.os-cat__loading{padding:12px;font-size:12px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );text-align:center}.os-cat__loading-spinner{display:inline-block;width:12px;height:12px;border-radius:50%;border:2px solid currentColor;border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;margin-inline-end:8px;vertical-align:middle}@keyframes os-cat-spin{to{transform:rotate( 360deg )}}.os-cat__footer{padding:8px 12px;font-size:11px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );border-top:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );border-radius:10px;background:var( --os-ui-cat-pop-footer-bg,var( --os-ui-surface,#fafafb ) );display:flex;align-items:center;gap:6px;line-height:1.4}.os-cat__footer .dashicons{font-size:14px;width:14px;height:14px;flex-shrink:0}:host( [ disabled ] ) .os-cat{opacity:0.6;pointer-events:none}`,N="10px",ll=b`:host{display:inline-flex;max-width:100%;align-items:center;min-width:0;font-family:var( --os-ui-font,system-ui,sans-serif );font-size:12px;line-height:1;font-weight:500}.os-crumb-chain{display:inline-flex;flex-wrap:nowrap;align-items:stretch;max-width:100%;min-width:0;min-height:22px;border-radius:999px;overflow:hidden;filter:drop-shadow( 0 1px 1px rgba( 0,0,0,0.06 ) )}.os-crumb{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:22px;padding:2px 12px;background:var( --os-ui-crumb-bg,var( --os-ui-surface,#c3c4c7 ) );color:var( --os-ui-crumb-fg,var( --os-ui-fg,#1d2327 ) );text-align:center;min-width:0;max-width:100%;flex-shrink:1;font-size:12px;font-weight:500;letter-spacing:0.01em;white-space:nowrap;cursor:grab;transition:filter 0.15s ease,transform 0.15s ease,background-color 0.12s ease}.os-crumb:active{cursor:grabbing}.os-crumb:hover{filter:brightness( 1.06 )}.os-crumb__remove{cursor:pointer}.os-crumb--first{padding-inline-end:22px;clip-path:polygon( 0 0,calc( 100% - ${N} ) 0,100% 50%,calc( 100% - ${N} ) 100%,0 100% )}.os-crumb--middle{padding-inline:22px;margin-inline-start:calc( -1 * ${N} );clip-path:polygon( ${N} 0,calc( 100% - ${N} ) 0,100% 50%,calc( 100% - ${N} ) 100%,${N} 100%,0 50% )}.os-crumb--last{padding-inline-start:22px;padding-inline-end:14px;margin-inline-start:calc( -1 * ${N} );clip-path:polygon( ${N} 0,100% 0,100% 100%,${N} 100%,0 50% )}.os-crumb--solo{padding:2px 12px;border-radius:999px}.os-crumb__label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;line-height:1.4}.os-crumb__remove{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;padding:0;border:0;border-radius:50%;background:transparent;color:inherit;cursor:pointer;opacity:0.65;transition:opacity 0.12s ease,background-color 0.12s ease,transform 0.12s ease}.os-crumb__remove:hover,.os-crumb__remove:focus-visible{opacity:1;background:var( --os-ui-scrim,rgba( 0,0,0,0.22 ) );outline:none;transform:scale( 1.1 )}.os-crumb__remove svg{display:block;width:100%;height:100%}.os-crumb-chain:hover{filter:drop-shadow( 0 2px 3px rgba( 0,0,0,0.12 ) )}:host( [ disabled ] ) .os-crumb-chain{opacity:0.55;pointer-events:none}`,dt=class dt extends m{constructor(){super(...arguments),this._segments=[]}get segments(){return this._segments}set segments(e){this._segments=Array.isArray(e)?e.slice():[],this.requestUpdate()}render(){const e=this.removable!==null,t=this._segments;return t.length===0?c``:c`
			...
			<div class="os-cat__row-block">
				...
				>
					${i?c`<button
							...
							>${Hi()}</button>`:c`<span class="os-cat__expander os-cat__expander--placeholder" aria-hidden="true">${Hi()}</span>`}
					<span class="os-cat__check" aria-hidden="true">${bl()}</span>
					<span class="os-cat__label">${this._highlight(o.item.name,this._query)}</span>
					${It(o.item)?c``:c`<button
								type="button"
				...
				${a&&!It(o.item)?this._renderCreateRow(o.item.id,12+(o.depth+1)*16,(o.depth+1)*16,o.item.name):c``}
			</div>
		...
		`}};pt.props=["rating","total"],pt.styles=[vl],pt.help=void 0;let co=pt;function Ui(r,e){const t=r.getAttribute(e);if(t===null||t==="")return 0;const s=Number(t);return Number.isFinite(s)?s:0}function _l(r){return r<0?0:r>100?100:r}function xl(r,e){return e===0?"No ratings yet":`Average rating ${(r/100*5).toFixed(1)} out of 5, from ${e} ratings`}function yl(r){const e=Math.floor(r),t=r-e>=.5?1:0,s=5-e-t,o=[];for(let i=0;i<e;i++)o.push(ji());for(let i=0;i<t;i++)o.push(wl());for(let i=0;i<s;i++)o.push(kl());return o}function ji(){return c`
		<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
			<path
				d="M8 1.5l2.06 4.17 4.6.67-3.33 3.25.79 4.58L8 12L3.88 14.17l.79-4.58L1.34 6.34l4.6-.67L8 1.5z"
			/>
		</svg>
	`}function wl(){return c`
	...
	`}v("os-rating-summary",co);const $l=b`:host{display:flex;align-items:flex-start;gap:10px;width:100%;box-sizing:border-box;padding:10px 14px;font:var( --os-ui-notice-font,13px/1.5 var( --os-font,system-ui ) );color:var( --os-ui-notice-color,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-notice-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );border-block-end:1px solid var( --os-ui-notice-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-inline-start:4px solid var( --os-ui-notice-accent,var( --os-ui-border,#646970 ) )}:host( [ hidden ] ){display:none}.os-notice__icon{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;color:var( --os-ui-notice-accent,var( --os-ui-accent,#646970 ) )}.os-notice__icon[ hidden ]{display:none}.os-notice__label{flex:1;min-width:0;word-wrap:break-word}::slotted( a ){color:var( --os-ui-notice-link,var( --wp-admin-theme-color,#2271b1 ) );border-radius:2px}::slotted( a:hover ),::slotted( a:focus-visible ){color:var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) )}::slotted( a:focus-visible ){outline:2px solid var( --os-ui-notice-link-hover,var( --os-ui-accent-strong,#135e96 ) );outline-offset:2px}::slotted( p:first-child ){margin-block-start:0}::slotted( p:last-child ){margin-block-end:0}.os-notice__close{flex:0 0 auto;display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px;padding:0;border:none;background:transparent;color:inherit;opacity:0.6;cursor:pointer;border-radius:4px;transition:opacity 0.12s ease,background-color 0.12s ease}.os-notice__close:hover{opacity:1;background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) )}.os-notice__close:focus-visible{opacity:1;outline:2px solid var( --wp-admin-theme-color,#2271b1 );outline-offset:1px}.os-notice__close[ hidden ]{display:none}.os-notice__close svg{width:14px;height:14px}:host( [ tone='info' ] ){--os-ui-notice-accent:var( --os-ui-notice-info,var( --os-ui-info-fg,#0969da ) );--os-ui-notice-bg:var( --os-ui-notice-info-bg,rgba( 9,105,218,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-info-border,rgba( 9,105,218,0.16 ) )}:host( [ tone='success' ] ){--os-ui-notice-accent:var( --os-ui-notice-success,var( --os-ui-success-fg,#1a7f37 ) );--os-ui-notice-bg:var( --os-ui-notice-success-bg,rgba( 26,127,55,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-success-border,rgba( 26,127,55,0.16 ) )}:host( [ tone='warning' ] ){--os-ui-notice-accent:var( --os-ui-notice-warning,var( --os-ui-warning-fg,#9a6700 ) );--os-ui-notice-bg:var( --os-ui-notice-warning-bg,rgba( 154,103,0,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-warning-border,rgba( 154,103,0,0.16 ) )}:host( [ tone='error' ] ),:host( [ tone='danger' ] ){--os-ui-notice-accent:var( --os-ui-notice-error,var( --os-ui-danger,#cf222e ) );--os-ui-notice-bg:var( --os-ui-notice-error-bg,rgba( 207,34,46,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-error-border,rgba( 207,34,46,0.16 ) )}:host( [ tone='neutral' ] ){--os-ui-notice-accent:var( --os-ui-notice-neutral,var( --os-ui-fg-muted,#57606a ) );--os-ui-notice-bg:var( --os-ui-notice-neutral-bg,rgba( 87,96,106,0.08 ) );--os-ui-notice-border:var( --os-ui-notice-neutral-border,rgba( 87,96,106,0.16 ) )}`,Cl="desktop-mode-notice-dismissed";function Al(){const e=window.wp?.os?.config?.currentUserId;return typeof e=="number"&&e>0?String(e):"anon"}function Ki(){return`${Cl}:${Al()}`}function uo(){try{const r=window.localStorage.getItem(Ki());if(!r)return{};const e=JSON.parse(r);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{}}function Vi(r){try{window.localStorage.setItem(Ki(),JSON.stringify(r))}catch{}}function Sl(r){return r?uo()[r]===!0:!1}function El(r){if(!r)return;const e=uo();e[r]=!0,Vi(e)}function zl(r){if(!r)return;const e=uo();e[r]&&(delete e[r],Vi(e))}const gt=class gt extends m{connectedCallback(){super.connectedCallback(),this.hasAttribute("role")||this.setAttribute("role","status"),this.hasAttribute("tone")||this.setAttribute("tone","info");const e=this.getAttribute("notice-id");e&&Sl(e)&&(this.hidden=!0)}dismiss(){this.hidden=!0;const e=this.getAttribute("notice-id");e&&El(e),this.emit("os-notice-dismiss",{noticeId:e??void 0})}undismiss(){const e=this.getAttribute("notice-id");e&&zl(e),this.hidden=!1}render(){const e=this.getAttribute("icon"),t=!this.hasAttribute("not-dismissible");return c`
		...
		`}};vt.props=["label","placeholder","hint","multiline","rows","disabled","readonly","insert-label","preview-label","open"],vt.styles=[Dl],vt.help=void 0;let fo=vt;v("os-token-field",fo),window.openStationComponents=!0})();
