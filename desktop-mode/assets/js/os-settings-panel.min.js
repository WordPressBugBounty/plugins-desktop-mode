(function(){"use strict";const Kr="desktop-mode";function di(){return window.wp?.i18n}function d(s,e=Kr){return di()?.__(s,e)??s}function F(s,...e){const t=di()?.sprintf;if(t)return t(s,...e);let o=0;return s.replace(/%(?:(\d+)\$)?[sd]/g,(i,n)=>{const r=n?Number.parseInt(n,10)-1:o++;return String(e[r]??"")})}function l(s,...e){return{__wpdHtml:!0,strings:s,values:e}}function Br(s){return!!s&&s.__wpdHtml===!0}const Gr="$$wpd$$",z=/\$\$wpd\$\$(\d+)\$\$/g;function Xr(s){let e=s[0];for(let t=1;t<s.length;t++)e+=`${Gr}${t-1}$$`+s[t];return e}const ui=new WeakMap;function hi(s){const e=ui.get(s);if(e)return e;const t=document.createElement("template");t.innerHTML=Xr(s);const o=[],i=(a,c)=>{if(a.nodeType===Node.ELEMENT_NODE){const p=a;for(const v of Array.from(p.attributes)){const y=v.name,g=v.value,_=y[0];if(z.test(g))if(z.lastIndex=0,_==="@"){const m=z.exec(g);z.lastIndex=0,o.push({path:c,kind:"event",name:y.slice(1),valueIndex:m?Number(m[1]):0}),p.removeAttribute(y)}else if(_==="."){const m=z.exec(g);z.lastIndex=0,o.push({path:c,kind:"prop",name:y.slice(1),valueIndex:m?Number(m[1]):0}),p.removeAttribute(y)}else if(_==="?"){const m=z.exec(g);z.lastIndex=0,o.push({path:c,kind:"bool",name:y.slice(1),valueIndex:m?Number(m[1]):0}),p.removeAttribute(y)}else{const m=[],f=[];let b=0,x;for(z.lastIndex=0;(x=z.exec(g))!==null;)m.push(g.slice(b,x.index)),f.push(Number(x[1])),b=x.index+x[0].length;m.push(g.slice(b)),o.push({path:c,kind:"attr",name:y,template:m,valueIndices:f}),p.setAttribute(y,"")}}}const u=Array.from(a.childNodes);let h=0;for(let p=0;p<u.length;p++){const v=u[p],y=p+h;if(v.nodeType===Node.TEXT_NODE){const g=v.textContent||"";if(!z.test(g)){z.lastIndex=0;continue}z.lastIndex=0;const _=v.parentNode;let m=0,f;const b=[],x=[];for(z.lastIndex=0;(f=z.exec(g))!==null;){f.index>m&&b.push(document.createTextNode(g.slice(m,f.index)));const w=document.createTextNode("");b.push(w),x.push({path:[...c,y+b.length-1],kind:"node",valueIndex:Number(f[1])}),m=f.index+f[0].length}m<g.length&&b.push(document.createTextNode(g.slice(m)));for(const w of b)_.insertBefore(w,v);_.removeChild(v),h+=b.length-1,o.push(...x)}else i(v,[...c,y])}};i(t.content,[]);const r={template:t,buildParts:a=>{const c=[];for(const u of o){let h=a;for(const p of u.path)h=h.childNodes[p];u.kind==="node"?c.push({kind:"node",valueIndex:u.valueIndex,child:{anchor:h,state:null}}):u.kind==="attr"?c.push({kind:"attr",element:h,name:u.name,template:u.template,valueIndices:u.valueIndices}):u.kind==="event"?c.push({kind:"event",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="prop"?c.push({kind:"prop",valueIndex:u.valueIndex,element:h,name:u.name}):u.kind==="bool"&&c.push({kind:"bool",valueIndex:u.valueIndex,element:h,name:u.name})}return c}};return ui.set(s,r),r}const pi=new WeakMap;function Zr(s,e){for(const t of s.nodes)if(t.parentNode!==e)return!1;return!0}function L(s,e){const t=pi.get(e);if(t&&t.strings===s.strings&&Zr(t,e)){Wt(t.parts,s.values);return}const o=hi(s.strings),i=o.template.content.cloneNode(!0),n=o.buildParts(i),r=Array.from(i.childNodes);for(;e.firstChild;)e.removeChild(e.firstChild);e.appendChild(i),Wt(n,s.values),pi.set(e,{strings:s.strings,parts:n,nodes:r})}function Wt(s,e){for(const t of s)if(t.kind==="node")us(t.child,e[t.valueIndex]);else if(t.kind==="attr"){let o=t.template[0];for(let i=0;i<t.valueIndices.length;i++)o+=fi(e[t.valueIndices[i]]),o+=t.template[i+1];o!==t.last&&(t.last=o,o===""?t.element.removeAttribute(t.name):t.element.setAttribute(t.name,o))}else if(t.kind==="event"){const o=e[t.valueIndex];o!==t.current&&(t.current&&t.element.removeEventListener(t.name,t.current),o&&t.element.addEventListener(t.name,o),t.current=o)}else if(t.kind==="prop"){const o=e[t.valueIndex];o!==t.last&&(t.last=o,t.element[t.name]=o)}else if(t.kind==="bool"){const o=!!e[t.valueIndex];o!==t.last&&(t.last=o,o?t.element.setAttribute(t.name,""):t.element.removeAttribute(t.name))}}function us(s,e){if(e==null||e===!1){s.state&&(re(s.state),s.state=null);return}if(Array.isArray(e)){ea(s,e);return}if(Br(e)){Qr(s,e);return}if(e instanceof Node){Yr(s,e);return}Jr(s,fi(e))}function Yr(s,e){const t=s.state;t?.shape==="node"&&t.node===e||(t&&re(t),Ht(s,[e]),s.state={shape:"node",node:e})}function Jr(s,e){const t=s.state;if(t?.shape==="text"){t.text!==e&&(t.node.textContent=e,t.text=e);return}t&&re(t);const o=document.createTextNode(e);Ht(s,[o]),s.state={shape:"text",node:o,text:e}}function Qr(s,e){const t=s.state;if(t?.shape==="template"&&t.strings===e.strings){Wt(t.parts,e.values);return}t&&re(t);const o=hi(e.strings),i=o.template.content.cloneNode(!0),n=o.buildParts(i),r=Array.from(i.childNodes);Ht(s,[i]),Wt(n,e.values),s.state={shape:"template",strings:e.strings,parts:n,nodes:r}}function ea(s,e){const t=s.state;if(t?.shape==="array"&&t.entries.length===e.length){for(let i=0;i<e.length;i++)us(t.entries[i],e[i]);return}t&&re(t);const o=[];for(const i of e){const n=document.createTextNode("");Ht(s,[n]);const r={anchor:n,state:null};us(r,i),o.push(r)}s.state={shape:"array",entries:o}}function Ht(s,e){const t=s.anchor.parentNode;if(t)for(const o of e)t.insertBefore(o,s.anchor)}function re(s){if(s.shape==="text"){s.node.remove();return}if(s.shape==="template"){for(const e of s.parts)e.kind==="node"&&e.child.state&&(re(e.child.state),e.child.state=null);for(const e of s.nodes)e.parentNode&&e.parentNode.removeChild(e);return}if(s.shape==="node"){s.node.parentNode&&s.node.parentNode.removeChild(s.node);return}for(const e of s.entries)e.state&&re(e.state),e.anchor.remove()}function fi(s){return s==null||s===!1?"":String(s)}const oe=class oe extends HTMLElement{constructor(){super(),this._renderScheduled=!1,this._propValues={},this.constructor.shadow?(this.attachShadow({mode:"open"}),this._renderRoot=this.shadowRoot):this._renderRoot=this,this._installPropAccessors()}static get observedAttributes(){return this.props.map(gi)}connectedCallback(){this._adoptStyles(),this.requestUpdate()}attributeChangedCallback(e,t,o){if(t===o)return;const i=ta(e);this._propValues[i]=o,this.requestUpdate()}get classNames(){return Array.from(this.classList)}set classNames(e){if(e==null){this.removeAttribute("class");return}const o=(Array.isArray(e)?e:String(e).split(/\s+/)).map(i=>String(i).trim()).filter(i=>i!=="");this.className=o.join(" ")}requestUpdate(){this._scheduleRender()}emit(e,t){return this.dispatchEvent(new CustomEvent(e,{detail:t,bubbles:!0,composed:!0}))}_installPropAccessors(){const e=this.constructor;for(const t of e.props){if(Object.getOwnPropertyDescriptor(this,t))continue;const o=gi(t);Object.defineProperty(this,t,{get:()=>t in this._propValues?this._propValues[t]:this.getAttribute(o),set:i=>{let n;i==null||i===!1?n=null:i===!0?n="":n=String(i),this._propValues[t]=n,n===null?this.removeAttribute(o):this.setAttribute(o,n),this.requestUpdate()},enumerable:!0,configurable:!0})}}_scheduleRender(){this._renderScheduled||!this.isConnected||(this._renderScheduled=!0,queueMicrotask(()=>{this._renderScheduled=!1,this.isConnected&&L(this.render(),this._renderRoot)}))}_adoptStyles(){const e=this.constructor;if(e.styles.length!==0)if(e.shadow&&this.shadowRoot){const t=e.styles.map(o=>o.sheet).filter(o=>o!==null);if(this.shadowRoot.adoptedStyleSheets=t,t.length!==e.styles.length){for(const o of e.styles)if(!o.sheet){const i=document.createElement("style");i.textContent=o.cssText,this.shadowRoot.appendChild(i)}}}else this._adoptLightStyles(e)}_adoptLightStyles(e){if(!oe._lightStylesAdopted.has(e)){oe._lightStylesAdopted.add(e);for(const t of e.styles){const o=document.createElement("style");o.dataset.osUi=this.tagName.toLowerCase(),o.textContent=t.cssText,document.head.appendChild(o)}}}};oe.props=[],oe.styles=[],oe.shadow=!0,oe._lightStylesAdopted=new WeakSet;let $=oe;function E(s,e){customElements.get(s)||customElements.define(s,e)}function gi(s){return s.replace(/[A-Z]/g,e=>"-"+e.toLowerCase())}function ta(s){return s.replace(/-([a-z])/g,(e,t)=>t.toUpperCase())}const sa=(()=>{try{return typeof new CSSStyleSheet().replaceSync=="function"}catch{return!1}})();function k(s,...e){let t=s[0];for(let o=1;o<s.length;o++){const i=e[o-1];if(typeof i=="string"||typeof i=="number")t+=String(i);else if(i&&i.__wpdCss)t+=i.cssText;else throw new TypeError("[os-ui] css`` interpolations must be strings, numbers, or other css`` results. Got: "+typeof i);t+=s[o]}if(sa){const o=new CSSStyleSheet;return o.replaceSync(t),{__wpdCss:!0,sheet:o,cssText:t}}return{__wpdCss:!0,sheet:null,cssText:t}}function oa(s){const e=[],t=[];let o=null,i=s.parentElement;for(;i&&!(i===document.body||i===document.documentElement);){const r=i.id||"";if(r.startsWith("wp-window-")){o=r.slice(10);break}if(i.tagName.toLowerCase()==="os-tabpanel"){const a=i.getAttribute("for");a&&t.unshift(a)}i=i.parentElement}o&&e.push(hs(o));for(const r of t)e.push("tab-"+hs(r));const n=s.getAttribute("label");return n&&e.push(hs(n)),e.length===0?"os-unnamed":"os-"+e.filter(r=>r!=="").join("-")}function hs(s){return s.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function be(s){if(s.id)return s.id;const e=oa(s);return s.id=e,e}const bi={close:{a:'fill="currentColor"',b:'<path d="m13.06 12 6.47-6.47-1.06-1.06L12 10.94 5.53 4.47 4.47 5.53 10.94 12l-6.47 6.47 1.06 1.06L12 13.06l6.47 6.47 1.06-1.06L13.06 12Z" />'},check:{a:'fill="currentColor"',b:'<path d="M16.5 7.5 10 13.9l-2.5-2.4-1 1 3.5 3.6 7.5-7.6z" />'},"chevron-right":{a:'fill="currentColor"',b:'<path d="M10.6 6L9.4 7l4.6 5-4.6 5 1.2 1 5.4-6z" />'},"arrow-up-right":{a:'fill="currentColor"',b:'<path d="M10 6H18V14H16.5V8.5L7 18L6 17L15.5 7.5H10V6Z" />'},plus:{a:'fill="currentColor"',b:'<path d="M11 12.5V17.5H12.5V12.5H17.5V11H12.5V6H11V11H6V12.5H11Z" />'},search:{a:'fill="currentColor"',b:'<path d="M13 5c-3.3 0-6 2.7-6 6 0 1.4.5 2.7 1.3 3.7l-3.8 3.8 1.1 1.1 3.8-3.8c1 .8 2.3 1.3 3.7 1.3 3.3 0 6-2.7 6-6S16.3 5 13 5zm0 10.5c-2.5 0-4.5-2-4.5-4.5s2-4.5 4.5-4.5 4.5 2 4.5 4.5-2 4.5-4.5 4.5z" />'},pin:{a:'fill="currentColor"',b:'<path d="m21.5 9.1-6.6-6.6-4.2 5.6c-1.2-.1-2.4.1-3.6.7-.1 0-.1.1-.2.1-.5.3-.9.6-1.2.9l3.7 3.7-5.7 5.7v1.1h1.1l5.7-5.7 3.7 3.7c.4-.4.7-.8.9-1.2.1-.1.1-.2.2-.3.6-1.1.8-2.4.6-3.6l5.6-4.1zm-7.3 3.5.1.9c.1.9 0 1.8-.4 2.6l-6-6c.8-.4 1.7-.5 2.6-.4l.9.1L15 4.9 19.1 9l-4.9 3.6z" />'},trash:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.5A2.25 2.25 0 0 0 9.878 7h4.244A2.251 2.251 0 0 0 12 5.5ZM12 4a3.751 3.751 0 0 0-3.675 3H5v1.5h1.27l.818 8.997a2.75 2.75 0 0 0 2.739 2.501h4.347a2.75 2.75 0 0 0 2.738-2.5L17.73 8.5H19V7h-3.325A3.751 3.751 0 0 0 12 4Zm4.224 4.5H7.776l.806 8.861a1.25 1.25 0 0 0 1.245 1.137h4.347a1.25 1.25 0 0 0 1.245-1.137l.805-8.861Z" />'},download:{a:'fill="currentColor"',b:'<path d="M18 11.3l-1-1.1-4 4V3h-1.5v11.3L7 10.2l-1 1.1 6.2 5.8 5.8-5.8zm.5 3.7v3.5h-13V15H4v5h16v-5h-1.5z" />'},settings:{a:'fill="currentColor"',b:'<path d="m19 7.5h-7.628c-.3089-.87389-1.1423-1.5-2.122-1.5-.97966 0-1.81309.62611-2.12197 1.5h-2.12803v1.5h2.12803c.30888.87389 1.14231 1.5 2.12197 1.5.9797 0 1.8131-.62611 2.122-1.5h7.628z" /><path d="m19 15h-2.128c-.3089-.8739-1.1423-1.5-2.122-1.5s-1.8131.6261-2.122 1.5h-7.628v1.5h7.628c.3089.8739 1.1423 1.5 2.122 1.5s1.8131-.6261 2.122-1.5h2.128z" />'},info:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm.75 4v1.5h-1.5V8h1.5Zm0 8v-5h-1.5v5h1.5Z" />'},bell:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M17 11.5c0 1.353.17 2.368.976 3 .266.209.602.376 1.024.5v1H5v-1c.422-.124.757-.291 1.024-.5.806-.632.976-1.647.976-3V9c0-2.8 2.2-5 5-5s5 2.2 5 5v2.5ZM15.5 9v2.5c0 .93.066 1.98.515 2.897l.053.103H7.932a4.018 4.018 0 0 0 .053-.103c.449-.917.515-1.967.515-2.897V9c0-1.972 1.528-3.5 3.5-3.5s3.5 1.528 3.5 3.5Zm-5.492 9.008c0-.176.023-.346.065-.508h3.854A1.996 1.996 0 0 1 12 20c-1.1 0-1.992-.892-1.992-1.992Z" />'},more:{a:'fill="currentColor"',b:'<path d="M11 13h2v-2h-2v2zm-6 0h2v-2H5v2zm12-2v2h2v-2h-2z" />'},maximize:{a:'fill="currentColor"',b:'<path d="M6 4a2 2 0 0 0-2 2v3h1.5V6a.5.5 0 0 1 .5-.5h3V4H6Zm3 14.5H6a.5.5 0 0 1-.5-.5v-3H4v3a2 2 0 0 0 2 2h3v-1.5Zm6 1.5v-1.5h3a.5.5 0 0 0 .5-.5v-3H20v3a2 2 0 0 1-2 2h-3Zm3-16a2 2 0 0 1 2 2v3h-1.5V6a.5.5 0 0 0-.5-.5h-3V4h3Z" />'},edit:{a:'fill="currentColor"',b:'<path d="m19 7-3-3-8.5 8.5-1 4 4-1L19 7Zm-7 11.5H5V20h7v-1.5Z" />'},color:{a:'fill="currentColor"',b:'<path d="M17.2 10.9c-.5-1-1.2-2.1-2.1-3.2-.6-.9-1.3-1.7-2.1-2.6L12 4l-1 1.1c-.6.9-1.3 1.7-2 2.6-.8 1.2-1.5 2.3-2 3.2-.6 1.2-1 2.2-1 3 0 3.4 2.7 6.1 6.1 6.1s6.1-2.7 6.1-6.1c0-.8-.3-1.8-1-3zm-5.1 7.6c-2.5 0-4.6-2.1-4.6-4.6 0-.3.1-1 .8-2.3.5-.9 1.1-1.9 2-3.1.7-.9 1.3-1.7 1.8-2.3.7.8 1.3 1.6 1.8 2.3.8 1.1 1.5 2.2 2 3.1.7 1.3.8 2 .8 2.3 0 2.5-2.1 4.6-4.6 4.6z" />'},wallpaper:{a:'fill="currentColor"',b:'<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM5 4.5h14c.3 0 .5.2.5.5v8.4l-3-2.9c-.3-.3-.8-.3-1 0L11.9 14 9 12c-.3-.2-.6-.2-.8 0l-3.6 2.6V5c-.1-.3.1-.5.4-.5zm14 15H5c-.3 0-.5-.2-.5-.5v-2.4l4.1-3 3 1.9c.3.2.7.2.9-.1L16 12l3.5 3.4V19c0 .3-.2.5-.5.5z" />'},warning:{a:'fill="currentColor"',b:'<path fill-rule="evenodd" clip-rule="evenodd" d="M5.5 12a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0ZM12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm-.75 12v-1.5h1.5V16h-1.5Zm0-8v5h1.5V8h-1.5Z" />'},minimize:{a:'fill="currentColor"',b:'<path d="M5 11.25h14v1.5H5z" />'},window:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="5.4375" width="15.75" height="13.125" rx="1.75"/><path d="M4.125 9.8125h15.75"/><circle cx="7.275" cy="7.625" r="0.7438" fill="currentColor" stroke="none"/>'},windows:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="8.5" width="11.375" height="10.0625" rx="1.75"/><path d="M3.6875 12h11.375"/><path d="M8.5 8.5V7.1875a1.75 1.75 0 0 1 1.75-1.75h7.875A1.75 1.75 0 0 1 19.875 7.1875v7a1.75 1.75 0 0 1-1.75 1.75h-3.0625"/>'},dock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.25" y="8.5" width="17.5" height="7" rx="3.5"/><circle cx="7.625" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="1.0062" fill="currentColor" stroke="none"/><circle cx="16.375" cy="12" r="1.0062" fill="currentColor" stroke="none"/>'},spaces:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><rect x="12.875" y="5.4375" width="7.4375" height="7.875" rx="1.75"/><circle cx="9.375" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="12" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/><circle cx="14.625" cy="17.6875" r="0.7875" fill="currentColor" stroke="none"/>'},copilot:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M10 2.5Q10.9 8.5 17.5 10Q10.9 11.5 10 17.5Q9.1 11.5 2.5 10Q9.1 8.5 10 2.5Z" fill="currentColor" stroke="none"/><path d="M17.9 14Q18.35 17.1 21.5 17.6Q18.35 18.1 17.9 21.2Q17.45 18.1 14.3 17.6Q17.45 17.1 17.9 14Z" fill="currentColor" stroke="none"/>'},snap:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="5.4375" width="16.625" height="13.125" rx="1.75"/><path d="M12 5.4375v13.125"/><path d="M12 12h8.3125"/>'},command:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<path d="M14.625 6.75v10.5a2.625 2.625 0 1 0 2.625-2.625H6.75a2.625 2.625 0 1 0 2.625 2.625V6.75a2.625 2.625 0 1 0-2.625 2.625h10.5a2.625 2.625 0 1 0-2.625-2.625"/>'},apps:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="4.125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="4.125" width="6.5625" height="6.5625" rx="1.75"/><rect x="4.125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/><rect x="13.3125" y="13.3125" width="6.5625" height="6.5625" rx="1.75"/>'},widgets:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="3.6875" y="3.6875" width="9.625" height="9.625" rx="1.75"/><rect x="15.0625" y="3.6875" width="5.25" height="5.25" rx="1.75"/><rect x="15.0625" y="10.6875" width="5.25" height="9.625" rx="1.75"/><rect x="3.6875" y="15.0625" width="9.625" height="5.25" rx="1.75"/>'},user:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<circle cx="12" cy="8.9375" r="3.5"/><path d="M5.4375 19.4375a6.5625 6.5625 0 0 1 13.125 0"/>'},lock:{a:'fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"',b:'<rect x="5.4375" y="10.6875" width="13.125" height="8.75" rx="1.75"/><path d="M8.5 10.6875V8.0625a3.5 3.5 0 0 1 7 0v2.625"/>'}};function mi(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ia(s){return Object.prototype.hasOwnProperty.call(bi,s)?bi[s]:null}function na(s,e={}){const t=ia(s);if(!t)return"";const{size:o=24,className:i,title:n,rotate:r}=e,a=['xmlns="http://www.w3.org/2000/svg"','viewBox="0 0 24 24"'];o!=null&&a.push(`width="${o}"`,`height="${o}"`),a.push(t.a),i&&a.push(`class="${mi(i)}"`),n?a.push('role="img"',`aria-label="${mi(n)}"`):a.push('aria-hidden="true"','focusable="false"');const c=r?`<g transform="rotate(${r} 12 12)">${t.b}</g>`:t.b;return`<svg ${a.join(" ")}>${c}</svg>`}function P(s,e={}){const t=na(s,e),o=document.createElement("div");o.innerHTML=t;const i=o.firstElementChild;return i instanceof SVGSVGElement?i:document.createElementNS("http://www.w3.org/2000/svg","svg")}const I=k`:host{--_holo-fill:var( --os-ui-holo-fill,${"linear-gradient( 124deg, #afa2e8 0%, #f5a8ea 46%, #8ee9f7 100% )"} );--_holo-ink:var( --os-ui-holo-ink,#0c0b0f );--_holo-sheen:var( --os-ui-holo-sheen,linear-gradient( 124deg,rgba( 159,214,255,0.1 ) 0%,rgba( 236,155,255,0.12 ) 34%,rgba( 242,82,252,0.1 ) 58%,rgba( 147,240,198,0.09 ) 100% ) );--_holo-edge:var( --os-ui-holo-edge,linear-gradient( 124deg,rgba( 154,242,255,0.7 ) 0%,rgba( 236,155,255,0.85 ) 38%,rgba( 242,82,252,0.7 ) 62%,rgba( 159,152,255,0.6 ) 100% ) );--_holo-edge-quiet:var( --os-ui-holo-edge-quiet,linear-gradient( 124deg,rgba( 154,242,255,0.22 ) 0%,rgba( 236,155,255,0.28 ) 38%,rgba( 242,82,252,0.22 ) 62%,rgba( 159,152,255,0.2 ) 100% ) );--_holo-glow:var( --os-ui-holo-glow,0 0 0 1px rgba( 242,82,252,0.28 ),0 2px 10px rgba( 242,82,252,0.22 ) );--_holo-glow-strong:var( --os-ui-holo-glow-strong,0 0 0 1px rgba( 242,82,252,0.42 ),0 4px 18px rgba( 242,82,252,0.38 ),0 1px 3px rgba( 12,11,15,0.6 ) );--_holo-track:var( --os-ui-holo-track,rgba( 255,251,255,0.16 ) );--_holo-track-edge:var( --os-ui-holo-track-edge,#8c8f94 );--_holo-ring-color:var( --os-ui-accent-dim,#2271b1 );--_holo-focus:var( --os-ui-focus-ring,0 0 0 2px rgba( 12,11,15,0.9 ),0 0 0 4px #f252fc,0 0 12px 2px rgba( 242,82,252,0.45 ) );--_holo-focus-field:var( --os-ui-focus-ring-field,0 0 0 1px #f252fc,0 0 0 4px rgba( 242,82,252,0.18 ) );--_holo-t:var( --os-ui-holo-transition,220ms );--_holo-t-fast:var( --os-ui-motion-fast,140ms );--_holo-t-slow:var( --os-ui-motion-slow,340ms );--_holo-t-ambient:var( --os-ui-motion-ambient,12s );--_holo-spring:var( --os-ui-ease-spring,cubic-bezier( 0.32,1.5,0.55,1 ) );--_holo-ease:var( --os-ui-ease-out,cubic-bezier( 0.22,0.9,0.28,1 ) );--_holo-loop:var( --os-ui-ease-loop,cubic-bezier( 0.45,0,0.55,1 ) )}`,ra=k` .os-holo-fill{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --_holo-ink );transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease}.os-holo-fill:hover{background-position:74% 66%}.os-holo-fill:active{background-position:88% 82%;filter:brightness( 0.94 )}@media ( prefers-reduced-motion:reduce ){.os-holo-fill{transition-duration:1ms}.os-holo-fill:hover,.os-holo-fill:active{background-position:22% 28%}}`,Ut=k` .os-holo-sheen{position:relative;isolation:isolate}.os-holo-sheen::before{content:'';position:absolute;inset:0;z-index:-1;border-radius:inherit;background-image:var( --_holo-sheen );background-size:200% 200%;background-position:20% 30%;opacity:0;pointer-events:none;transition:opacity var( --_holo-t ) ease,background-position var( --_holo-t ) ease}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{opacity:1;background-position:76% 68%}@media ( prefers-reduced-motion:reduce ){.os-holo-sheen::before{transition-duration:1ms}.os-holo-sheen:hover::before,.os-holo-sheen:focus-visible::before{background-position:20% 30%}}`,vi=k` .os-holo-edge{position:relative}.os-holo-edge::after{content:'';position:absolute;inset:0;border-radius:inherit;padding:1px;background-image:var( --_holo-edge-quiet );opacity:0;pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude;transition:opacity var( --_holo-t ) ease}.os-holo-edge:hover::after,.os-holo-edge:focus-visible::after{background-image:var( --_holo-edge );opacity:1}.os-holo-edge.is-lit::after{background-image:var( --_holo-edge );opacity:1}@media ( prefers-reduced-motion:reduce ){.os-holo-edge::after{transition-duration:1ms}}`,qt=k` .os-holo-glint{position:absolute;inset:0;border-radius:inherit;overflow:hidden;pointer-events:none}.os-holo-glint::before{content:'';position:absolute;top:-60%;bottom:-60%;width:45%;inset-inline-start:-60%;background:linear-gradient( 90deg,transparent 0%,rgba( 255,251,255,0.14 ) 45%,rgba( 255,251,255,0.22 ) 50%,rgba( 255,251,255,0.14 ) 55%,transparent 100% );transform:rotate( 18deg ) translateX( 0 );opacity:0}:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:os-holo-glint var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-glint{0%{opacity:0;transform:rotate( 18deg ) translateX( 0 )}15%{opacity:1}85%{opacity:1}100%{opacity:0;transform:rotate( 18deg ) translateX( 240vw )}}@media ( prefers-reduced-motion:reduce ){:hover>.os-holo-glint::before,:focus-visible>.os-holo-glint::before,:host(:hover )>.os-holo-glint::before,:host(:focus-visible )>.os-holo-glint::before{animation:none}}`,ps=k` .os-holo-ring{position:absolute;inset:0;border-radius:inherit;box-shadow:0 0 0 0 var( --_holo-ring-color );opacity:0;pointer-events:none}:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:os-holo-ring var( --_holo-t-slow ) var( --_holo-ease )}@keyframes os-holo-ring{0%{opacity:0.45;box-shadow:0 0 0 0 var( --_holo-ring-color )}100%{opacity:0;box-shadow:0 0 0 10px transparent}}@media ( prefers-reduced-motion:reduce ){:active:not(:disabled )>.os-holo-ring,:host(:active:not( [ disabled ] ) )>.os-holo-ring{animation:none}}`,_i=k` .os-holo-shimmer{background-image:var( --_holo-fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}@keyframes os-holo-shimmer{0%{background-position:0% 50%}100%{background-position:100% 50%}}@media ( prefers-reduced-motion:reduce ){.os-holo-shimmer{animation:none;background-position:30% 50%}}`,fs=k` .os-holo-enter{animation:os-holo-enter var( --_holo-t ) var( --_holo-spring )}@keyframes os-holo-enter{from{opacity:0;transform:scale( 0.96 )}}@media ( prefers-reduced-motion:reduce ){.os-holo-enter{animation:none}}`,gs=k` input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):hover:not(:disabled ),select:hover:not(:disabled ),textarea:hover:not(:disabled ){border-color:var( --os-ui-border-strong,#8c8f94 )}input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus,input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ):focus-visible,select:focus,select:focus-visible,textarea:focus,textarea:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}input::placeholder,textarea::placeholder{color:var( --os-ui-fg-faint,#8c8f94 );opacity:1}input::selection,textarea::selection{background:var( --os-ui-selection-bg,rgba( 159,152,255,0.6 ) );color:var( --os-ui-selection-fg,#fffbff )}@media ( prefers-reduced-motion:reduce ){input:where(:not( [ type='checkbox' ] ):not( [ type='radio' ] ) ),select,textarea{transition-duration:1ms}}`,Ft=k` input[ type='checkbox' ],input[ type='radio' ]{appearance:none;-webkit-appearance:none;position:relative;flex:0 0 auto;box-sizing:border-box;width:16px;height:16px;margin:0;padding:0;border:1px solid var( --_holo-track-edge );border-radius:4px;background-color:var( --_holo-track );background-image:none;background-repeat:no-repeat;cursor:inherit;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='radio' ]{border-radius:50%}input[ type='checkbox' ]:hover:not(:disabled ),input[ type='radio' ]:hover:not(:disabled ){border-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:focus-visible,input[ type='radio' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked,input[ type='checkbox' ]:indeterminate,input[ type='radio' ]:checked{border-color:transparent;background-color:var( --os-ui-accent,#2271b1 )}input[ type='checkbox' ]:checked:focus-visible,input[ type='radio' ]:checked:focus-visible{box-shadow:var( --_holo-focus )}input[ type='checkbox' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:46%;width:3.5px;height:7.5px;border:solid var( --os-ui-fg-on-accent,#fff );border-width:0 2px 2px 0;transform:translate( -50%,-50% ) rotate( 45deg );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:indeterminate::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:8px;height:2px;border:0;border-radius:1px;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% )}input[ type='radio' ]:checked::after{content:'';position:absolute;inset-inline-start:50%;top:50%;width:6px;height:6px;border-radius:50%;background:var( --os-ui-fg-on-accent,#fff );transform:translate( -50%,-50% );animation:os-holo-tick 180ms cubic-bezier( 0.3,1.4,0.6,1 )}input[ type='checkbox' ]:disabled,input[ type='radio' ]:disabled{cursor:not-allowed}@keyframes os-holo-tick{from{opacity:0;transform:translate( -50%,-50% ) rotate( 45deg ) scale( 0.4 )}}@media ( prefers-reduced-motion:reduce ){input[ type='checkbox' ]:checked::after,input[ type='radio' ]:checked::after{animation:none}}`,yi=k` @keyframes os-holo-drift{0%{background-position:16% 26%}50%{background-position:84% 74%}100%{background-position:16% 26%}}.os-holo-alive{animation:os-holo-drift var( --_holo-t-ambient ) var( --_holo-loop ) infinite}@media ( prefers-reduced-motion:reduce ){.os-holo-alive{animation:none}}`;k` ${I} ${ra} ${Ut} ${vi} ${qt} ${ps} ${_i} ${fs} ${gs} ${Ft} ${yi} `;const aa=k` ${I} ${Ut} ${vi} ${qt} ${ps} ${yi}:host{display:inline-flex}:host( [ fill-cell ] ){display:flex;width:100%}button{appearance:none;display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:var( --os-ui-button-padding,6px 12px );border-radius:var( --os-ui-button-border-radius,6px );font:inherit;font-weight:500;cursor:pointer;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,transform 80ms ease;background:var( --os-ui-button-bg,transparent );background-image:var( --os-ui-button-bg-image,none );background-repeat:var( --os-ui-button-bg-image-repeat,repeat );background-size:var( --os-ui-button-bg-image-size,auto );background-position:var( --os-ui-button-bg-image-position,center );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ fill-cell ] ) button{width:100%;min-height:var( --os-ui-button-min-height,44px )}button:disabled{opacity:0.5;cursor:not-allowed}button:active:not(:disabled ){transform:translateY( 1px )}button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before,button:disabled::after,button:disabled .os-holo-glint{opacity:0 !important}:host( [ variant='primary' ] ) button{background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-button-fg,var( --os-ui-fg-on-accent,#fff ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 );background-color:var( --os-ui-button-bg,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --_holo-glow )}:host( [ variant='holo' ] ) button{background-color:transparent;background-image:var( --_holo-fill );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;color:var( --os-ui-button-fg,var( --_holo-ink ) );border:var( --os-ui-button-border,1px solid transparent );box-shadow:var( --_holo-glow );font-weight:600;transition:background-position var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,filter var( --_holo-t ) ease,transform 80ms ease}:host( [ variant='holo' ] ) button:hover:not(:disabled ){background-color:transparent;background-position:74% 66%;box-shadow:var( --_holo-glow-strong )}:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:88% 82%;filter:brightness( 0.94 )}:host( [ variant='holo' ] ) button::before{display:none}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ] ) button:hover:not(:disabled ),:host( [ variant='holo' ] ) button:active:not(:disabled ){background-position:22% 28%}}:host( [ variant='secondary' ] ) button{background-color:var( --os-ui-button-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-button-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-button-border,1px solid transparent )}:host( [ variant='secondary' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-button-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}:host( [ variant='danger' ] ) button{background-color:var( --os-ui-button-bg,transparent );color:var( --os-ui-button-fg,var( --os-ui-danger,#d63638 ) );border:var( --os-ui-button-border,1px solid currentColor )}:host( [ variant='danger' ] ) button:hover:not(:disabled ){background-color:var( --os-ui-danger,#d63638 );color:var( --os-ui-fg-on-accent,#fff )}:host( [ variant='danger' ] ) button::after{display:none}:host( [ variant='link' ] ) button{background-color:transparent;background-image:none;color:var( --os-ui-button-fg,var( --wp-admin-theme-color,#2271b1 ) );border:0;padding:0;text-decoration:underline}:host( [ variant='link' ] ) button::before,:host( [ variant='link' ] ) button::after,:host( [ variant='link' ] ) .os-holo-glint,:host( [ variant='link' ] ) .os-holo-ring{display:none}:host( [ variant='link' ] ) button:active:not(:disabled ){transform:none}:host( [ busy ] ) button{pointer-events:none;opacity:0.75}:host( [ variant='holo' ][ busy ] ) button{animation:os-holo-drift 12s ease-in-out infinite}@media ( prefers-reduced-motion:reduce ){:host( [ variant='holo' ][ busy ] ) button{animation:none}}.os-button__spinner{box-sizing:border-box;display:inline-block;width:12px;height:12px;border:2px solid currentColor;border-right-color:transparent;border-radius:50%;animation:os-button-spin 0.6s linear infinite;flex-shrink:0}@keyframes os-button-spin{to{transform:rotate( 360deg )}}`,Ce=class Ce extends ${render(){const e=this.disabled!==null,t=this.busy!==null,o=this.type||"button";return l`
			...
			>
				${t?l`<span class="os-button__spinner" aria-hidden="true"></span>`:""}
				<slot></slot>
				<!--
		...
		`}};Ce.props=["variant","disabled","type","busy","fill-cell"],Ce.styles=[aa],Ce.help=void 0;let bs=Ce;E("os-button",bs);const la=k` ${I} ${Ft}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg,#1d2327 );cursor:pointer;-webkit-user-select:none;user-select:none}label{display:inline-flex;align-items:center;gap:8px;cursor:pointer}:host( [ disabled ] ){opacity:0.5;cursor:not-allowed}:host( [ disabled ] ) label,:host( [ disabled ] ) input[ type='checkbox' ]{cursor:not-allowed}`,Se=class Se extends ${render(){const e=this.label||"",t=this.checked!==null,o=this.disabled!==null;return l`
			<label>
				<input
					type="checkbox"
					?checked=${t}
		...
		`}_onChange(e){if(this.disabled!==null)return;const t=e.target.checked;t?this.setAttribute("checked",""):this.removeAttribute("checked"),this.emit("os-checkbox-change",{checked:t})}};Se.props=["label","checked","disabled"],Se.styles=[la],Se.help=void 0;let ms=Se;E("os-checkbox-label",ms);const ca=k` ${I}:host{display:inline-flex;align-items:center;gap:8px;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}label{display:inline-flex;align-items:center;gap:8px}input[ type='color' ]{width:28px;height:28px;padding:0;border:1px solid var( --os-ui-border,#c3c4c7 );border-radius:6px;background:transparent;cursor:pointer;transition:border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='color' ]:hover{border-color:var( --os-ui-border-strong,#8c8f94 )}input[ type='color' ]:focus-visible{outline:none;box-shadow:var( --_holo-focus )}:host( [ variant='block' ] ){display:flex;width:100%}:host( [ variant='block' ] ) label{display:flex;flex:1;align-items:center}:host( [ variant='block' ] ) input[ type='color' ]{flex:1;width:auto;height:32px}input[ type='color' ]::-webkit-color-swatch-wrapper{padding:2px}input[ type='color' ]::-webkit-color-swatch{border:none;border-radius:2px}`,Le=class Le extends ${open(){const e=()=>{const t=this.shadowRoot?.querySelector("input");if(!t)return!1;try{t.showPicker()}catch{t.click()}return!0};e()||queueMicrotask(()=>void e())}render(){const e=this.label||"",t=this.value||"#000000";return l`
			<label>
				<span class="os-color-field__label">${e}</span>
				<input
					type="color"
					.value=${t}
		...
		`}_onDismiss(e){e.preventDefault(),e.stopPropagation(),this.dismiss()}};Te.props=["tone","notDismissible","icon","noticeId"],Te.styles=[ba],Te.help=void 0;let ks=Te;E("os-notice",ks);const ka=k`:host{display:flex;flex-direction:column;gap:var( --os-ui-panel-gap,12px );padding:var( --os-ui-panel-padding,16px );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );box-sizing:border-box}:host( [ hidden ] ){display:none}`,De=class De extends ${render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-panel-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-panel-padding",`${t}px`),l`<slot></slot>`}};De.props=["gap","padding"],De.styles=[ka],De.help=void 0;let xs=De;E("os-panel",xs);const xa=k` ${I}:host{display:flex;align-items:center;gap:10px;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}input[ type='range' ]{appearance:none;-webkit-appearance:none;flex:1;min-width:0;height:18px;margin:0;padding:0;background:transparent;cursor:pointer}input[ type='range' ]:disabled{cursor:not-allowed;opacity:0.5}input[ type='range' ]::-webkit-slider-runnable-track{height:6px;border-radius:999px;background-image:linear-gradient( var( --_range-angle,90deg ),transparent var( --_fill,0% ),var( --_holo-track ) var( --_fill,0% ) ),linear-gradient( var( --os-ui-accent,#2271b1 ),var( --os-ui-accent,#2271b1 ) );background-size:auto,auto;background-position:center,center;background-repeat:no-repeat;box-shadow:inset 0 0 0 1px var( --_holo-track-edge )}input[ type='range' ]::-moz-range-track{height:6px;border-radius:999px;background-image:linear-gradient( var( --_range-angle,90deg ),transparent var( --_fill,0% ),var( --_holo-track ) var( --_fill,0% ) ),linear-gradient( var( --os-ui-accent,#2271b1 ),var( --os-ui-accent,#2271b1 ) );background-size:auto,auto;background-position:center,center;background-repeat:no-repeat;box-shadow:inset 0 0 0 1px var( --_holo-track-edge )}input[ type='range' ]::-webkit-slider-thumb{appearance:none;-webkit-appearance:none;width:16px;height:16px;margin-top:-5px;border:0;border-radius:50%;background:var( --os-ui-switch-knob,#fffbff );box-shadow:0 1px 3px rgba( 12,11,15,0.5 ),0 0 0 1px rgba( 12,11,15,0.14 );cursor:inherit;transition:transform var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='range' ]::-moz-range-thumb{width:16px;height:16px;border:0;border-radius:50%;background:var( --os-ui-switch-knob,#fffbff );box-shadow:0 1px 3px rgba( 12,11,15,0.5 ),0 0 0 1px rgba( 12,11,15,0.14 );cursor:inherit;transition:transform var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}input[ type='range' ]:active::-webkit-slider-thumb{transform:scale( 1.15 );box-shadow:var( --_holo-glow-strong )}input[ type='range' ]:active::-moz-range-thumb{transform:scale( 1.15 );box-shadow:var( --_holo-glow-strong )}input[ type='range' ]:focus-visible{outline:none}input[ type='range' ]:focus-visible::-webkit-slider-thumb{box-shadow:var( --_holo-focus )}input[ type='range' ]:focus-visible::-moz-range-thumb{box-shadow:var( --_holo-focus )}.os-range-field__value{width:var( --os-ui-range-readout-width,3ch );flex:none;text-align:end;font-variant-numeric:tabular-nums;color:var( --os-ui-fg,#1d2327 )}@media ( prefers-reduced-motion:reduce ){input[ type='range' ]::-webkit-slider-thumb{transition-duration:1ms}input[ type='range' ]::-moz-range-thumb{transition-duration:1ms}}`;function $a(s,e,t){const o=Number.parseFloat(s),i=Number.parseFloat(e),n=Number.parseFloat(t);if(!Number.isFinite(o)||!Number.isFinite(i)||!Number.isFinite(n)||n===i)return"0%";const r=(o-i)/(n-i);return`${Math.min(100,Math.max(0,r*100)).toFixed(2)}%`}function Ea(s){const e=s.indexOf(".");return e<0?0:Math.min(3,s.length-e-1)}function Aa(s,e,t,o){const i=r=>{const a=Number.parseFloat(r);return Number.isFinite(a)?String(Math.trunc(Math.abs(a))).length+(a<0?1:0):3};return Math.max(i(s),i(e))+(t>0?t+1:0)+o.length}const Pe=class Pe extends ${render(){const e=this.label||"",t=this.value||"0",o=this.min||"0",i=this.max||"100",n=this.step||"1",r=this.suffix||"",a=this.decimals,c=a?Math.min(6,Math.max(0,Number.parseInt(a,10)||0)):Ea(n),u=Number.parseFloat(t),h=Number.isFinite(u)?u.toFixed(c):t,p=Aa(o,i,c,r);return l`
			...
			<span
				...
				style="--os-ui-range-readout-width: ${p}ch"
				>${h}${r}</span
			>
		`}connectedCallback(){super.connectedCallback(),getComputedStyle(this).direction==="rtl"&&this.style.setProperty("--_range-angle","270deg")}_onInput(e){const t=e.target,o=parseFloat(t.value);Number.isFinite(o)&&(this.value=String(o),this.emit("os-range-change",{value:o}))}};Pe.props=["label","value","min","max","step","suffix","decimals"],Pe.styles=[xa],Pe.help=void 0;let $s=Pe;E("os-range-field",$s);const Ca=k`:host{display:block;margin-block-end:36px}:host( [ hidden ] ){display:none}.os-section__heading{margin:0 0 5px;font-size:20px;font-weight:500;letter-spacing:-0.01em;color:var( --os-ui-fg,#1d2327 )}.os-section__description{margin:0 0 14px;max-width:78ch;font-size:14px;color:var( --os-ui-fg-muted,#646970 );line-height:1.55}.os-section__description:empty{display:none}:host( [ stack ] ) .os-section__body{display:flex;flex-direction:column;gap:var( --os-ui-section-gap,12px )}`,Ne=class Ne extends ${render(){const e=this.heading||"",t=this.description||"";return l`
			${e?l`<h3 class="os-section__heading">${e}</h3>`:""}
			${t?l`<p class="os-section__description">${t}</p>`:""}
			<div class="os-section__body" part="body"><slot></slot></div>
		`}};Ne.props=["heading","description","stack"],Ne.styles=[Ca],Ne.help=void 0;let Es=Ne;E("os-section",Es);const Sa=k` ${I}:host{display:inline-flex;position:relative;padding:3px;background:var( --os-ui-segmented-bg,var( --os-ui-hover,rgba( 0,0,0,0.05 ) ) );border-radius:8px;gap:2px}.os-segmented__thumb{position:absolute;top:3px;bottom:3px;left:0;width:var( --_thumb-w,0px );border-radius:6px;background-color:var( --os-ui-segmented-selected-bg,var( --os-ui-accent,#2271b1 ) );background-image:var( --os-ui-segmented-selected-image,none );background-size:220% 220%;background-position:22% 28%;background-repeat:no-repeat;transform:translateX( var( --_thumb-x,0px ) );pointer-events:none;opacity:0}:host( [ data-thumb ] ) .os-segmented__thumb{opacity:1}:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition:transform var( --_holo-t-slow ) var( --_holo-spring ),width var( --_holo-t-slow ) var( --_holo-ease ),opacity var( --_holo-t-fast ) linear}@media ( prefers-reduced-motion:reduce ){:host( [ data-thumb-ready ] ) .os-segmented__thumb{transition-duration:1ms}}`,La=k` ${I} ${Ut}:host{flex:1 1 auto;min-width:0}button{appearance:none;display:block;width:100%;padding:6px 13px;background:transparent;border:0;font:inherit;font-size:13px;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:6px;transition:background-color var( --_holo-t ) ease,color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease,background-position var( --_holo-t ) ease;white-space:nowrap}button:hover{color:var( --os-ui-fg,#1d2327 )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}:host( [ aria-checked='true' ] ) button{color:var( --os-ui-segmented-selected-fg,var( --os-ui-fg-on-accent,#fff ) );transition-duration:var( --_holo-t-fast )}:host( [ aria-checked='true' ] ) button::before{display:none}`,ze=class ze extends ${render(){return this.setAttribute("role","radio"),l`
			<button
				type="button"
				class="os-holo-sheen"
				@click=${()=>this._onPick()}
		...
		`};let Cs=Me;E("os-segmented",Cs);const Ra=k` ${I}:host{display:flex;flex-direction:column;gap:8px;font-size:13px;color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-select__label{font-size:13px;line-height:1.5;color:var( --os-ui-fg-muted,#646970 )}.os-select__trigger{appearance:none;display:flex;align-items:center;gap:8px;width:100%;min-width:0;padding:8px 12px;background:var( --os-ui-hover,rgba( 0,0,0,0.05 ) );border:1px solid transparent;border-radius:8px;font:inherit;font-size:13px;line-height:1.5;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer;transition:background-color var( --_holo-t ) ease,border-color var( --_holo-t ) ease,box-shadow var( --_holo-t ) ease}.os-select__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.08 ) );border-color:var( --os-ui-border-strong,#8c8f94 )}.os-select__trigger:focus,.os-select__trigger:focus-visible{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --_holo-focus-field )}.os-select__trigger:disabled{opacity:0.5;cursor:not-allowed}:host( [ plain ] ){display:inline-flex;flex-direction:row;align-items:center}:host( [ plain ] ) .os-select__label{display:none}:host( [ plain ] ) .os-select__trigger{width:auto;padding:4px 6px;background:transparent;border-color:transparent;border-radius:6px}:host( [ plain ] ) .os-select__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.05 ) );border-color:transparent}:host( [ plain ] ) .os-select__trigger:focus,:host( [ plain ] ) .os-select__trigger:focus-visible{border-color:var( --os-ui-accent,#2271b1 )}:host( [ plain ] ) .os-select__value{flex:0 1 auto}.os-select__value{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-select__value--placeholder{color:var( --os-ui-fg-muted,#646970 )}.os-select__chevron{flex:0 0 auto;pointer-events:none;color:var( --os-ui-fg-muted,#646970 )}.os-select__trigger:hover .os-select__chevron{color:var( --os-ui-fg,#1d2327 )}.os-select__trigger:focus .os-select__chevron,.os-select__trigger:focus-visible .os-select__chevron{color:var( --os-ui-accent,#2271b1 )}.os-select__popup{position:fixed;inset:auto;margin:0;max-height:min( 320px,60vh );overflow-y:auto;padding:4px;background:var( --os-ui-surface,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:8px;box-shadow:0 12px 32px rgba( 0,0,0,0.45 );color:var( --os-ui-fg,#1d2327 )}.os-select__popup:not( [ data-open ] ){display:none}.os-select__popup:popover-open{display:block}.os-select__popup[ data-open ]{position:absolute;top:calc( 100% + 4px );left:0;min-width:100%;z-index:1000}:host{position:relative}.os-select__option{display:flex;align-items:center;gap:8px;padding:7px 10px;border-radius:6px;font-size:13px;line-height:1.5;cursor:pointer;white-space:nowrap}.os-select__check{flex:0 0 auto;visibility:hidden}.os-select__option[ aria-selected='true' ] .os-select__check{visibility:visible}.os-select__option[ data-active ],.os-select__option:hover{background:var( --os-ui-accent,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-select__option[ aria-disabled='true' ]{opacity:0.5;cursor:not-allowed}.os-select__option[ aria-disabled='true' ]:hover{background:transparent;color:inherit}@media ( prefers-reduced-motion:reduce ){.os-select__trigger{transition-duration:1ms}}`,Ia=k`:host{display:none}`,Oe=class Oe extends ${render(){return l``}};Oe.props=["value","disabled"],Oe.styles=[Ia],Oe.help=void 0;let Ss=Oe;E("os-option",Ss);const We=class We extends ${constructor(){super(...arguments),this._optionObserver=null,this._open=!1,this._activeIndex=-1,this._typed="",this._dismissedAt=0,this._typedTimer=null,this._onWindowScroll=e=>{const t=e.target,o=this._popup();o&&t instanceof Node&&(t===o||o.contains(t))||this._hide()},this._onWindowResize=()=>this._hide()}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const n of Array.from(t))n.remove();for(const n of e){const r=document.createElement("os-option");r.setAttribute("value",n.value),r.textContent=n.label,this.appendChild(r)}const o=this.value;!(o!==null&&e.some(n=>n.value===o))&&e.length>0&&(this.value=e[0].value),this.requestUpdate()}connectedCallback(){super.connectedCallback(),be(this),this._optionObserver=new MutationObserver(()=>this.requestUpdate()),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._teardownDismiss(),this._open=!1,this._typedTimer&&(clearTimeout(this._typedTimer),this._typedTimer=null)}render(){const e=this.label||"",t=this.value,o=this.placeholder||"",i=this.disabled!==null;e&&this.setAttribute("aria-label",e);const n=this.getAttribute("aria-label")||"",r=e||n||o,a=this._readOptions(),c=a.find(g=>g.value===t),u=c?c.label:o,h=this.id||"os-unnamed",p=`${h}__listbox`,v=`${h}__trigger`,y=this._open&&this._activeIndex>=0?`${h}__opt-${this._activeIndex}`:"";return l`
			...
			<button
				...
				?disabled=${i}
				@click=${()=>this._toggle()}
				@keydown=${g=>this._onTriggerKeydown(g)}
			>
				<span
					class="os-select__value${c?"":" os-select__value--placeholder"}"
					>${u}</span
				>
				${P("chevron-right",{size:16,rotate:90,className:"os-select__chevron"})}
			</button>
			<div
				...
				popover="auto"
				aria-label=${r}
				@toggle=${g=>this._onPopoverToggle(g)}
			>
				${a.map((g,_)=>l`
						<div
		...
		`};let Ds=Fe;E("os-tabs",Ds);const Ve=class Ve extends ${connectedCallback(){super.connectedCallback(),this.setAttribute("role","tabpanel"),this.hasAttribute("tabindex")||this.setAttribute("tabindex","0");const e=Oa(this);e&&Ei(e,e.getAttribute("value"))}render(){return l`<slot></slot>`}};Ve.props=["for"],Ve.styles=[Na],Ve.help={title:"Tab panel",summary:'Auto-managed panel paired with a sibling <os-tabs>. Declares which tab it belongs to via `for="<tab-value>"`; the parent strip toggles `hidden` whenever the active tab changes. role="tabpanel" and tabindex="0" are set automatically.',status:"stable",props:[{name:"for",type:"string",description:"Matches the `value` of the owning <os-tab>. Panel is shown when its parent tabs strip is on that value."}],slots:[{name:"(default)",description:"Panel body content."}],example:l`
		...
		`};let Ps=Ve;E("os-tabpanel",Ps);function Ma(s,e,t){const o=s.querySelectorAll(`:scope > ${e}`);for(const i of Array.from(o))i.remove();for(const i of t){const n=document.createElement(e);n.setAttribute("value",i.value),n.textContent=i.label,s.appendChild(n)}}function Oa(s){const e=s.parentElement;if(!e)return null;const t=e.querySelector(":scope > os-tabs");return t||s.closest("os-tabs")}function Ei(s,e){const t=new Set,o=s.parentElement;if(o)for(const i of Array.from(o.querySelectorAll(":scope > os-tabpanel")))t.add(i);for(const i of Array.from(s.querySelectorAll(":scope > os-tabpanel")))t.add(i);for(const i of t){const n=i.getAttribute("for"),r=n!==null&&n===e;r?i.removeAttribute("hidden"):i.setAttribute("hidden",""),i.setAttribute("aria-hidden",r?"false":"true")}}const Ai=k` ${I} ${gs}:host{display:flex;flex-direction:column;gap:4px;font-size:13px;color:var( --os-ui-fg,#1d2327 );min-width:0}:host( [ hidden ] ){display:none}.os-text-field__label{font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row{position:relative;display:flex;align-items:center;width:100%}input{appearance:none;-webkit-appearance:none;display:block;width:100%;min-width:0;box-sizing:border-box;padding:7px 10px;background:var( --os-window-bg,#fff );border:1px solid var( --os-ui-border,#dcdcde );border-radius:6px;font:inherit;font-size:13px;color:var( --os-ui-fg,#1d2327 )}.os-text-field__suffix{position:absolute;inset-inline-end:10px;top:50%;transform:translateY( -50% );pointer-events:none;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-text-field__row--has-reveal input{padding-inline-end:36px}.os-text-field__reveal{position:absolute;inset-inline-end:0;top:0;bottom:0;width:34px;display:flex;align-items:center;justify-content:center;padding:0;border:none;background:transparent;color:var( --os-ui-fg-muted,#646970 );cursor:pointer;border-radius:0 6px 6px 0;transition:color 0.12s ease}.os-text-field__reveal:hover{color:var( --os-ui-accent,#2271b1 )}.os-text-field__reveal:focus-visible{outline:none;color:var( --os-ui-accent,#2271b1 );box-shadow:inset 0 0 0 2px var( --os-ui-accent,#2271b1 );border-radius:0 6px 6px 0}.os-text-field__reveal:disabled{opacity:0.45;cursor:not-allowed}.os-text-field__input--masked{-webkit-text-security:disc;text-security:disc}@supports not ( ( -webkit-text-security:disc ) or ( text-security:disc ) ){.os-text-field__input--masked{font-family:text-security-disc,"password",monospace;letter-spacing:0.2em}}input:disabled{opacity:0.55;cursor:not-allowed;background:var( --os-ui-hover,rgba( 0,0,0,0.03 ) )}input[ aria-invalid='true' ],input[ aria-invalid='true' ]:hover:not(:disabled ){border-color:var( --os-ui-danger,#d63638 )}input[ aria-invalid='true' ]:focus,input[ aria-invalid='true' ]:focus-visible{border-color:var( --os-ui-danger,#d63638 );box-shadow:0 0 0 1px var( --os-ui-danger,#d63638 ),0 0 0 4px rgba( 214,54,56,0.18 )}input[ type='number' ]::-webkit-inner-spin-button,input[ type='number' ]::-webkit-outer-spin-button{-webkit-appearance:none;margin:0}input[ type='number' ]{-moz-appearance:textfield}`,je=class je extends ${constructor(){super(...arguments),this._revealed=!1}connectedCallback(){super.connectedCallback(),be(this)}render(){const e=this.label||"",t=this.value??"",o=this.placeholder||"",i=this.disabled!==null,n=this.readonly!==null,r=this.autocomplete,a=this.type||"text",c=a==="password";let u=r||"off";c&&(!r||u==="off")&&(u="new-password");const h=this.maxlength,p=this.minlength,v=this.pattern||"",y=this.name||"",g=this.suffix||"",_=this.invalid!==null,m=this.reveal!==null,f=a==="password",b=f&&!(m&&this._revealed);let x;f||m&&this._revealed?x="text":x=a;const w=m?"os-text-field__row os-text-field__row--has-reveal":"os-text-field__row",R=b?"os-text-field__input os-text-field__input--masked":"os-text-field__input",U=`${this.id||"os-unnamed"}__input`;return l`
			${e?l`<label
			...
			<span class=${w}>
				...
				/>
				${g?l`<span class="os-text-field__suffix">${g}</span>`:l``}
				${m?this._renderRevealButton(i):l``}
			</span>
		`}_renderRevealButton(e){const t=this._revealed?"Hide":"Show";return l`
			<button
				type="button"
	...
	`}const Ua="os-window-tab-change";function Ci(s){return Array.from(s.querySelectorAll(".os-window__tab"))}function Si(s){return s.replace(/[^a-zA-Z0-9_-]/g,"-")}function Li(s,e){return`${s.id||"os-window"}-tab-${Si(e)}`}function Ri(s,e){return`${s.id||"os-window"}-panel-${Si(e)}`}function qa(s){const e=s.querySelector(".os-window__tab-plate");if(!e)return;const t=s.querySelector(".os-window__tab--active");if(!t){e.dataset.empty="",s.dataset.tabPlateEmpty="";return}delete e.dataset.empty,delete s.dataset.tabPlateEmpty,s.style.setProperty("--_tab-plate-x",`${t.offsetLeft}px`),s.style.setProperty("--_tab-plate-w",`${t.offsetWidth}px`),s.style.setProperty("--_tab-strip-w",`${s.clientWidth}px`),t.offsetWidth>0&&(e.dataset.placed="")}function Fa(s){if(s){if(s.querySelector(":scope > .os-window__tab")){s.setAttribute("role","tablist");const e=s.dataset.tablistLabel;e&&s.setAttribute("aria-label",e);return}s.setAttribute("role","presentation"),s.removeAttribute("aria-label")}}function Va(s){const e=Ci(s);if(e.length===0)return;const t=e.find(o=>o.classList.contains("os-window__tab--active"))??e[0];for(const o of e){const i=o===t?0:-1;o.tabIndex!==i&&(o.tabIndex=i)}}function Ii(s){const e=new Map;for(const t of Ci(s))t.dataset.kind==="panel"&&t.dataset.panel&&e.set(t.dataset.panel,t);return e}function Ti(s){const e=s.querySelector(".os-window__body");return e?Array.from(e.querySelectorAll("os-tabpanel[ for ]")).filter(t=>!t.parentElement?.closest("os-tabpanel, os-tabs")):[]}function ja(s,e){const t=s.querySelector(".os-window__tabs");if(!t)return;let o=!1;for(const[i,n]of Ii(t)){const r=i===e;o=o||r,n.classList.toggle("os-window__tab--active",r),n.setAttribute("aria-selected",r?"true":"false")}if(o){for(const i of Ti(s)){const n=i.getAttribute("for")===e;i.toggleAttribute("hidden",!n),i.setAttribute("aria-hidden",n?"false":"true")}Va(t),qa(t),s.dispatchEvent(new CustomEvent(Ua,{bubbles:!0,detail:{value:e}}))}}function Ka(s,e,t){const o=s.querySelector(".os-window__tabs");if(!o)return;const i=Ii(o),n=Array.from(i.entries()).find(([,h])=>h.classList.contains("os-window__tab--active"))?.[0];let r=o.querySelector(".os-window__tab-plate");for(const h of e){let p=i.get(h.value);if(p)i.delete(h.value);else{const v=document.createElement("button");v.type="button",p=v,p.className="os-window__tab",p.dataset.kind="panel",p.dataset.panel=h.value,p.setAttribute("role","tab"),p.setAttribute("aria-selected","false"),p.tabIndex=-1}p.textContent!==h.label&&(p.textContent=h.label),p.id=Li(s,h.value),p.setAttribute("aria-controls",Ri(s,h.value)),p.previousElementSibling!==r&&o.insertBefore(p,r?r.nextSibling:o.firstChild),r=p}for(const h of i.values())h.remove();Fa(o);const a=o.querySelector(":scope > .os-window__tab")!==null;for(const h of Ti(s)){const p=h.getAttribute("for");p&&(h.id=Ri(s,p),a?h.setAttribute("aria-labelledby",Li(s,p)):h.removeAttribute("aria-labelledby"))}const c=h=>h!==void 0&&e.some(p=>p.value===h),u=[t,n,e[0]?.value].find(c);u!==void 0&&ja(s,u)}const me={size:null},Di={appearance:()=>P("color",me),themes:()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path fill-rule="evenodd" clip-rule="evenodd" d="M20 12a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-1.5 0a6.5 6.5 0 0 1-6.5 6.5v-13a6.5 6.5 0 0 1 6.5 6.5Z" />',s},windows:()=>P("windows",me),navigation:()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path d="M12 4c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14.5c-3.6 0-6.5-2.9-6.5-6.5S8.4 5.5 12 5.5s6.5 2.9 6.5 6.5-2.9 6.5-6.5 6.5zM9 16l4.5-3L15 8.4l-4.5 3L9 16z" />',s},features:()=>P("settings",me),help:()=>P("widgets",me),"os-file-associations":()=>{const s=document.createElementNS("http://www.w3.org/2000/svg","svg");return s.setAttribute("viewBox","0 0 24 24"),s.setAttribute("fill","currentColor"),s.setAttribute("aria-hidden","true"),s.innerHTML='<path d="M15.5 7.5h-7V9h7V7.5Zm-7 3.5h7v1.5h-7V11Zm7 3.5h-7V16h7v-1.5Z" /><path d="M17 4H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2ZM7 5.5h10a.5.5 0 0 1 .5.5v12a.5.5 0 0 1-.5.5H7a.5.5 0 0 1-.5-.5V6a.5.5 0 0 1 .5-.5Z" />',s},about:()=>P("info",me)},zs=1920,Ms=1080,Ba=40,Ga=300,jt="custom-gradient",V="custom-image",Pi="galaxy",ve="custom",Ni=[{id:"pulse",label:"Pulse",value:"#f252fc"},{id:"nebula",label:"Nebula",value:"#ec9bff"},{id:"sirius",label:"Sirius",value:"#9af2ff"},{id:"lagoon",label:"Lagoon",value:"#9f98ff"},{id:"wp-blue",label:"WordPress Blue",value:"#2271b1"},{id:"indigo",label:"Indigo",value:"#3858e9"},{id:"teal",label:"Teal",value:"#04a4cc"},{id:"emerald",label:"Emerald",value:"#059669"},{id:"amber",label:"Amber",value:"#d97706"},{id:"rose",label:"Rose",value:"#e11d48"}];function Os(){const e=window.wp?.os?.config?.accentColors;if(!Array.isArray(e)||e.length===0)return Ni;const t=[];for(const o of e)o&&typeof o=="object"&&typeof o.id=="string"&&typeof o.label=="string"&&typeof o.value=="string"&&o.id!==""&&o.label!==""&&/^#[0-9a-f]{3,8}$/i.test(o.value)&&t.push({id:o.id,label:o.label,value:o.value});return t.length>0?t:Ni}const zi=[{id:"compact",label:"Compact",width:48,icon:18},{id:"default",label:"Default",width:56,icon:20},{id:"large",label:"Large",width:72,icon:26}],Mi=[{id:"sharp",label:"Sharp",value:0},{id:"default",label:"Default",value:8},{id:"round",label:"Round",value:16}],Oi=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"},{id:"hidden",label:"Hidden"}],Wi=[{id:"static",label:"Static"},{id:"dynamic",label:"Dynamic"}],Hi=[{id:"bottom",label:"Bottom"},{id:"left",label:"Left"},{id:"right",label:"Right"}],Ui=[{id:"unified",label:"Unified"},{id:"classic",label:"Split"}],Y={wallpaper:Pi,accent:"pulse",customAccent:"#f252fc",dockSize:"default",windowRadius:"round",adminBarMode:"hidden",desktopLayout:"unified",dockPlacement:"bottom",dockBehavior:"static",sideDockBehavior:"static",dockRailRenderer:"default",desktopTheme:"",appliedThemeRecommendations:[],unfocusEffect:"darken",windowReveal:"none",windowRevealDuration:0,windowLinkRenderer:"svg-splines",windowLinkVisibility:"always",windowLinksEnabled:!0,windowLinkRaiseOnFocus:!0,windowLinkHighlight:!0,customGradient:{from:"#2271b1",to:"#7c3aed",angle:135},customImage:null,wallpaperSettings:{},libraryHdOnly:!0,ai:{enabled:!1},heartbeatRate:60,nativePostsEnabled:!1,nativePostsHiddenColumns:[],nativePagesEnabled:!1,nativeUsersEnabled:!1,nativePluginsEnabled:!1,nativeCommentsEnabled:!1,stationHomeEnabled:!1,adminAssetCacheEnabled:!1,windowPrewarmEnabled:!1,showDesktopOnWallpaperClick:!1,mioEnabled:!1,mioStyle:{appearance:{},physics:{}},showPostStatusRibbons:!0,developerModeEnabled:!1,foldersSharingEnabled:!0,navPlacement:{},navOrder:[],dockPromotedPositions:{}};function Ws(s){return!!s&&typeof s=="object"&&typeof s.then=="function"}function Xa(s){return s.replace(/[^a-zA-Z0-9._-]+/g,"-").replace(/^-+|-+$/g,"")||"wallpaper"}function Za(s){if(!s||typeof s.id!="number"||!s.source_url)return!1;const e=s.media_details;return!!e&&typeof e.width=="number"&&typeof e.height=="number"&&e.width>0&&e.height>0}function Ya(s){if(!s)return"";const e=document.createElement("div");return e.innerHTML=s,e.textContent?.trim()||""}const qi="X-WP-Nonce";function Ja(s,e){const t=Qa();if(!t)return e;const o=el(s);if(!o||!tl(o))return e;const i=e?.headers??(typeof Request<"u"&&s instanceof Request?s.headers:void 0),n=new Headers(i??{});return n.has(qi)?e:(n.set(qi,t),{...e??{},headers:n})}function Qa(){if(typeof window>"u")return;const e=window.openStationConfig?.restNonce;return typeof e=="string"&&e.length>0?e:void 0}function el(s){try{const e=typeof window<"u"&&window.location?window.location.href:void 0;return typeof s=="string"?new URL(s,e):s instanceof URL?s:typeof Request<"u"&&s instanceof Request?new URL(s.url,e):null}catch{return null}}function tl(s){return typeof window>"u"||!window.location||s.origin!==window.location.origin?!1:!!(s.pathname.includes("/wp-json/")||s.searchParams.has("rest_route"))}function j(s,e,t={}){const o=window.wp?.os?.fetch;if(typeof o=="function")return o(s,e,t);const i=Ja(s,e);return fetch(s,i)}function sl(){return{...Y,customGradient:{...Y.customGradient},customImage:null,wallpaperSettings:{...Y.wallpaperSettings},ai:{...Y.ai},appliedThemeRecommendations:[...Y.appliedThemeRecommendations],navPlacement:{...Y.navPlacement},navOrder:[...Y.navOrder],dockPromotedPositions:{...Y.dockPromotedPositions}}}const Fi="__openStationSharedStores";function ol(){const s=window;let e=s[Fi];return e||(e=new Map,s[Fi]=e),e}function K(s,e){const t=ol();let o=t.get(s);o||(o={state:e(),listeners:new Set,rebuild:e},t.set(s,o));const i={get state(){return o.state},set state(n){o.state=n},getState(){return o.state},notify(){for(const n of Array.from(o.listeners))try{n(o.state)}catch(r){console.error(`[desktop-mode/shared-store:${s}] subscriber threw:`,r)}},subscribe(n){return o.listeners.add(n),()=>{o.listeners.delete(n)}},setState(n){const r=o.state;if(typeof r!="object"||r===null){console.warn(`[desktop-mode/shared-store:${s}] setState called on a primitive store; use the state setter instead.`);return}Object.assign(r,n),i.notify()},reset(){const n=o.rebuild(),r=o.state;if(typeof r=="object"&&r!==null&&typeof n=="object"&&n!==null){const a=r;for(const c of Object.keys(a))delete a[c];Object.assign(a,n)}else o.state=n;o.listeners.clear()}};return i}const Vi=K("desktop-mode/settings-tab-registry",()=>({registry:new Map,listeners:new Set})),il=Vi.state.registry,ji=Vi.state.listeners;function nl(){return Array.from(il.values()).sort((s,e)=>(s.order??100)-(e.order??100))}function rl(s){return ji.add(s),()=>{ji.delete(s)}}const Ki="https://openstation.blog/",Bi="https://openstation.blog/feed/",al="https://github.com/WordPress/openstation/";function ll(s,e){return s.clientWidth>0&&s.clientHeight>0?Promise.resolve():new Promise(t=>{const o=()=>{i.disconnect(),e.removeEventListener("abort",o),t()},i=new ResizeObserver(()=>{s.clientWidth>0&&s.clientHeight>0&&o()});e.addEventListener("abort",o,{once:!0}),i.observe(s)})}function Hs(s){if(typeof s!="string"||s==="")return"";try{const e=new URL(s,window.location.href);return e.protocol==="http:"||e.protocol==="https:"?e.href:""}catch{return""}}function le(s){return typeof s=="string"?s.trim():""}function cl(s){if(!s||typeof s!="object")return null;const e=s,o=(Array.isArray(e.items)?e.items:[]).map(i=>{if(!i||typeof i!="object")return null;const n=i,r=le(n.title),a=Hs(n.url);return r===""||a===""?null:{title:r,url:a,author:le(n.author),publishedAt:le(n.publishedAt),excerpt:le(n.excerpt)}}).filter(i=>i!==null).slice(0,5);return{title:le(e.title)||d("OpenStation"),description:le(e.description)||d("A public dev diary — building a desktop OS for wp-admin."),homeUrl:Hs(e.homeUrl)||Ki,feedUrl:Hs(e.feedUrl)||Bi,items:o,stale:e.stale===!0}}function dl(s){if(s==="")return"";const e=new Date(s);return Number.isNaN(e.getTime())?"":e.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function Gi(s){const e=dl(s.publishedAt);return e&&s.author?F("%1$s · %2$s",e,s.author):e||s.author}function ul(s){return l`
			...
			<a href=${s.url} target="_blank" rel="noopener noreferrer">
				<div class="os-settings__about-featured-copy">
					<span class="os-settings__about-kicker"
						>${d("Latest dispatch")}</span
					>
					<h3>${s.title}</h3>
					${s.excerpt?l`<p>${s.excerpt}</p>`:l``}
				</div>
				<footer>
					<span>${Gi(s)}</span>
					<strong
	...
	`}function pl(s){if(s.kind==="loading")return l`
			<div
			...
			>
				...
				></span>
				<div>
					<strong>${d("Opening the journal…")}</strong>
					<span
						>${d("The latest posts are arriving over RSS.")}</span
					>
				</div>
			</div>
		`;if(s.kind==="error")return l`
			<div
			...
			>
				...
				<div>
					<strong>${d("The journal could not be reached.")}</strong>
					<span
						>${d("You can still read every post on openstation.blog.")}</span
					>
				</div>
			</div>
		`;if(s.feed.items.length===0)return l`
			<div class="os-settings__about-status" role="status">
				<span class="dashicons dashicons-rss" aria-hidden="true"></span>
				<div>
					<strong>${d("No dispatches yet.")}</strong>
					<span
						>${d("The journal is open and waiting for its next post.")}</span
					>
				</div>
			</div>
		`;const[e,...t]=s.feed.items;return l`
		${s.feed.stale?l`<p class="os-settings__about-stale" role="status">
					${d("Showing the last saved copy while the journal reconnects.")}
				</p>`:l``}
		<section
			class="os-settings__about-feed"
			aria-label=${d("Latest journal posts")}
		>
			${ul(e)}
			${t.length>0?l`<div class="os-settings__about-grid" role="list">
						${t.map(hl)}
					</div>`:l``}
		</section>
	`}function Kt(s,e,t){const o=t.kind==="ready"?t.feed:null,i=o?.homeUrl||Ki,n=o?.feedUrl||Bi,r=o?.description||d("A public dev diary — building a desktop OS for wp-admin."),a=`${e.pluginUrl??""}/assets/images/openstation-mark.svg`,c=e.pluginVersion??"";L(l`
			<div class="os-settings__about-inner">
				<header class="os-settings__about-overview">
					<div class="os-settings__about-identity">
						<img src=${a} alt="" width="64" height="64" />
						<div>
							<span class="os-settings__about-eyebrow"
								>${d("About OpenStation")}</span
							>
							<h2>${d("A desktop for WordPress.")}</h2>
							<p>
								${d("OpenStation reshapes wp-admin into a personal workspace, with movable windows, a dock, themes, and focused tools that keep your site close at hand.")}
							</p>
						</div>
					</div>
					<div class="os-settings__about-story">
						<p>
							${d("It is a playful, open-source experiment by Automattic exploring what WordPress can feel like when the dashboard becomes a place of its own.")}
						</p>
						<div class="os-settings__about-meta">
							<span>
								<strong
									>OpenStation${c?` ${c}`:""}</strong
								>
								<small
									>${d("An experiment by Automattic")}</small
								>
							</span>
							<a
								href=${al}
				...
				<div class="os-settings__about-journal-head">
					<div>
						<span class="os-settings__about-eyebrow"
							>${d("OpenStation Journal")}</span
						>
						<h2>${d("Latest from the station")}</h2>
						<p>${r}</p>
					</div>
					<a
				...
				<footer class="os-settings__about-footer">
					<p>
						<strong>${d("OpenStation Journal")}</strong>
						<span
							>${d("News and field notes, delivered over RSS.")}</span
						>
					</p>
					<a
						href=${n}
		...
		`,s)}function fl(){const s=document.createElement("div");s.classList.add("os-settings__about");const e=window.openStationConfig??{};Kt(s,e,{kind:"loading"});const t=new AbortController;let o=!1;const i=async()=>{if(await ll(s,t.signal),!(o||!s.isConnected)){if(!e.aboutFeedUrl){Kt(s,e,{kind:"error"});return}try{const r=await j(e.aboutFeedUrl,{credentials:"same-origin",signal:t.signal},{windowId:"desktop-mode-os-settings",source:"openstation/about-feed"});if(!r.ok)throw new Error(`about feed returned ${r.status}`);const a=await r.json(),c=a.success?cl(a.data):null;if(!c)throw new Error("about feed returned an invalid payload");!o&&s.isConnected&&Kt(s,e,{kind:"ready",feed:c})}catch(r){if(t.signal.aborted||o)return;typeof console<"u"&&console.error("[openstation/about] journal feed failed:",r),Kt(s,e,{kind:"error"})}}};requestAnimationFrame(()=>{i()});const n=new MutationObserver(()=>{s.isConnected||(o=!0,t.abort(),n.disconnect())});return n.observe(document.body,{childList:!0,subtree:!0}),s}function gl(s,e){switch(s){case"wp-blue":return d("WordPress Blue");case"indigo":return d("Indigo");case"teal":return d("Teal");case"emerald":return d("Emerald");case"amber":return d("Amber");case"rose":return d("Rose");default:return e}}function bl(s,e){switch(s){case"compact":return d("Compact");case"default":return d("Default");case"large":return d("Large");default:return e}}function ml(s,e){switch(s){case"sharp":return d("Sharp");case"default":return d("Default");case"round":return d("Round");default:return e}}function vl(s,e){switch(s){case"static":return d("Static");case"dynamic":return d("Dynamic");case"hidden":return d("Hidden");default:return e}}function _l(s,e){switch(s){case"static":return d("Static");case"dynamic":return d("Dynamic");default:return e}}function yl(s,e){switch(s){case"bottom":return d("Bottom");case"left":return d("Left");case"right":return d("Right");default:return e}}function wl(s,e){switch(s){case"classic":return d("Split");case"unified":return d("Unified");default:return e}}function kl(s){switch(s){case"classic":return d("Core admin menus are placed in a sidebar; plugins, apps, and OpenStation controls in a dock along the bottom edge.");case"unified":return d("Every menu in a single dock.");default:return""}}const xl="conic-gradient( #f252fc, #9af2ff, #93f0c6, #f8f2b6, #ff5a5a, #f252fc )";function $l(s){const e=()=>{const r=i.querySelector(".os-settings__accent-picker");if(r)try{r.showPicker()}catch{r.click()}},t=r=>{const a=r.detail?.value??"";a!==ve&&!Os().some(c=>c.id===a)||(s.state.accent=a,s.save(),s.apply(),n(),a===ve&&e())},o=r=>{const a=r.target.value;/^#[0-9a-fA-F]{6}$/.test(a)&&(s.state.customAccent=a,s.state.accent=ve,s.save(),s.apply(),n())},i=document.createElement("div"),n=()=>{const r=s.state.accent===ve;L(l`
				<os-section
					heading=${d("Accent color")}
					description=${d("Used in focused window title bars, buttons, and focus rings.")}
				>
					<os-swatch-grid
						label=${d("Accent color")}
						mode="row"
						@os-pick=${t}
					>
						${Os().map(a=>l`<os-swatch
								value=${a.id}
								label=${gl(a.id,a.label)}
								preview=${a.value}
								size="small"
								variant="accent"
								?selected=${s.state.accent===a.id}
							></os-swatch>`)}
						<span class="os-settings__accent-custom">
							<os-swatch
								value=${ve}
								label=${d("Custom")}
								preview=${r?s.state.customAccent:xl}
								size="small"
								variant="accent"
								?selected=${r}
							></os-swatch>
			...
			<div class="dialog" tabindex="-1">
				${a?l`<button
						...
						@click=${()=>this._cancel()}
					>&times;</button>`:l``}
				${e?l`<h2 class="title">${e}</h2>`:l``}
				${t?l`<p class="message">${t}</p>`:l``}
				<div class="actions">
					${r?l``:l`<button
							type="button"
					...
					<button
						type="button"
						class="btn ${n?"btn--danger":"btn--primary"}"
						@click=${()=>this._confirm()}
					>
						${o}
					</button>
		...
		`}};Ke.props=["open","title","message","confirm-label","cancel-label","danger","hide-cancel","dismissable"],Ke.styles=[Cl],Ke.help=void 0;let Us=Ke;E("os-confirm-dialog",Us);function Ji(s){return new Promise(e=>{const t=document.createElement("os-confirm-dialog");t.setAttribute("open",""),s.title&&t.setAttribute("title",s.title),t.setAttribute("message",s.message),s.confirmLabel&&t.setAttribute("confirm-label",s.confirmLabel),s.cancelLabel&&t.setAttribute("cancel-label",s.cancelLabel),s.danger&&t.setAttribute("danger",""),s.hideCancel&&t.setAttribute("hide-cancel",""),s.dismissable&&t.setAttribute("dismissable","");const o=i=>{t.remove(),e(i)};t.addEventListener("os-confirm",()=>o(!0)),t.addEventListener("os-cancel",()=>o(!1)),document.body.appendChild(t)})}const Qi=K("desktop-mode/dock-rail-registry",()=>({registry:new Map,listeners:new Set,activeId:"default"})),en=Qi.state.registry,tn=Qi.state.listeners;function Ll(s){return en.get(s)}function sn(){return Array.from(en.values())}function Rl(s){return tn.add(s),()=>{tn.delete(s)}}function Bt(){const s=window.wp?.hooks;if(!s)throw new Error("[openstation] `window.wp.hooks` is not available. The plugin declares `wp-hooks` as a script dependency; if you are seeing this error, verify the enqueue order.");return s}function Il(s,e,t,o){Bt().addAction(s,e,t,o)}function Tl(s,e){return Bt().removeAction(s,e)}function J(s,e,...t){return Bt().applyFilters(s,e,...t)}function Q(s,...e){Bt().doAction(s,...e)}const O={INIT:"os.init",WALLPAPERS:"os.wallpapers",GAMES:"os.games",UNFOCUS_EFFECTS:"os.unfocus-effects",WINDOW_REVEALS:"os.window-reveals",WALLPAPER_MOUNTING:"os.wallpaper.mounting",WALLPAPER_MOUNTED:"os.wallpaper.mounted",WALLPAPER_UNMOUNTING:"os.wallpaper.unmounting",WALLPAPER_MOUNT_FAILED:"os.wallpaper.mount-failed",WALLPAPER_VISIBILITY:"os.wallpaper.visibility",WALLPAPER_SUSPEND:"os.wallpaper.suspend",WALLPAPER_PREVIEW_PARAMS:"os.wallpaper.preview-params",WALLPAPER_SETTINGS_CHANGED:"os.wallpaper.settings-changed",IFRAME_READY:"os.iframe.ready",IFRAME_ERROR:"os.iframe.error",IFRAME_NETWORK_COMPLETED:"os.iframe.network-completed",SHELL_ERROR:"os.shell.error",BROADCAST:"os.broadcast",MONITOR_ENTRY:"os.monitor.entry",WALLPAPER_SURFACES:"os.wallpaper.surfaces",DESKTOP_THEME_CHANGED:"os.os-theme.changed",DESKTOP_THEME_ICON:"os.os-theme.icon",DESKTOP_THEME_ICON_COLOR:"os.os-theme.icon-color",WALLPAPERS_SERVER_CHANGED:"os.wallpapers.server-changed",EXTENDED_OPTIONS_CHANGED:"os.extended-options.changed",WINDOW_GEOMETRY:"os.window.geometry",WINDOW_OPENED:"os.window.opened",WINDOW_CONTENT_LOADING:"os.window.content-loading",WINDOW_CONTENT_LOADED:"os.window.content-loaded",WINDOW_LOADING_OVERLAY:"os.window.loading-overlay",WINDOW_REOPENED:"os.window.reopened",WINDOW_MENU_OPENED:"os.window.menu-opened",WINDOW_CLOSING:"os.window.closing",WINDOW_CLOSED:"os.window.closed",WINDOW_FOCUSED:"os.window.focused",WINDOW_BLURRED:"os.window.blurred",WINDOW_MINIMIZED:"os.window.minimized",WINDOW_RESTORED:"os.window.restored",WINDOW_CHILD_BLOCKED:"os.window.child-blocked",WINDOW_MAXIMIZED:"os.window.maximized",WINDOW_UNMAXIMIZED:"os.window.unmaximized",WINDOW_FULLSCREEN_ENTERED:"os.window.fullscreen-entered",WINDOW_FULLSCREEN_EXITED:"os.window.fullscreen-exited",WINDOW_AUTO_EXIT_FULLSCREEN:"os.window.auto-exit-fullscreen",WINDOW_FOCUS_ON_DRAG_HOVER:"os.window.focus-on-drag-hover",WINDOW_BOUNDS_CHANGED:"os.window.bounds-changed",WINDOW_MOVED:"os.window.moved",WINDOW_RESIZED:"os.window.resized",WINDOW_DRAG_START:"os.window.drag-start",WINDOW_DRAG_END:"os.window.drag-end",WINDOW_RESIZE_START:"os.window.resize-start",WINDOW_RESIZE_END:"os.window.resize-end",WINDOW_DETACHED:"os.window.detached",WINDOW_RELOADED:"os.window.reloaded",WINDOW_TITLE_CHANGED:"os.window.title-changed",WINDOW_HIGHLIGHT_CHANGED:"os.window.highlight-changed",WINDOW_BODY_RESIZED:"os.window.body-resized",NATIVE_WINDOW_BEFORE_RENDER:"os.native-window.before-render",NATIVE_WINDOW_AFTER_RENDER:"os.native-window.after-render",NATIVE_WINDOW_BEFORE_CLOSE:"os.native-window.before-close",WINDOW_CHROME_THEME:"os.window.chrome.theme",WINDOW_CHROME_CONTROLS:"os.window.chrome.controls",WINDOW_CHROME_SLOT:"os.window.chrome.slot",WINDOW_CHROME_RENDER:"os.window.chrome.render",WINDOW_CHROME_APPLIED:"os.window.chrome.applied",WINDOW_CHROME_THEME_CHANGED:"os.window.chrome.theme-changed",DESKTOP_ICON_CLICKED:"os.os-icon.clicked",DESKTOP_ICONS_RENDERED:"os.os-icons.rendered",ICON_BADGE_CHANGED:"os.icon.badge-changed",COMPONENTS_REGISTERED:"os.components.registered",DOCK_ITEM_APPENDED:"os.dock.item-appended",DOCK_ITEM_REMOVED:"os.dock.item-removed",DOCK_BEFORE_RENDER:"os.dock.before-render",DOCK_AFTER_RENDER:"os.dock.after-render",DOCK_REFRESH_ACTIVE:"os.dock.refresh-active",DOCK_TILE_CLASS:"os.dock.tile-class",DOCK_TILE_ELEMENT:"os.dock.tile-element",DOCK_TILE_RENDERED:"os.dock.tile-rendered",DOCK_TILE_TOOLTIP:"os.dock.tile-tooltip",DOCK_PEEK_CARD_CONTENT:"os.dock.peek-card-content",DOCK_PEEK_CARD_ELEMENT:"os.dock.peek-card-element",CONSTELLATION_PANEL:"os.constellation.panel",CONSTELLATION_OPENED:"os.constellation.opened",CONSTELLATION_CLOSED:"os.constellation.closed",OVERVIEW_ENTERING:"os.overview.entering",OVERVIEW_ENTERED:"os.overview.entered",OVERVIEW_EXITING:"os.overview.exiting",OVERVIEW_EXITED:"os.overview.exited",OVERVIEW_WINDOW_HOVER:"os.overview.window-hover",OVERVIEW_WINDOW_UNHOVER:"os.overview.window-unhover",OVERVIEW_WINDOW_CLICK:"os.overview.window-click",WORK_AREA_CHANGED:"os.work-area.changed",ARRANGE_CASCADE_STARTING:"os.arrange.cascade.starting",ARRANGE_CASCADE_APPLIED:"os.arrange.cascade.applied",ARRANGE_TILE_STARTING:"os.arrange.tile.starting",ARRANGE_TILE_APPLIED:"os.arrange.tile.applied",ARRANGE_TILE_DIMENSIONS:"os.arrange.tile.dimensions",ARRANGE_SNAP_CHANGED:"os.arrange.snap.changed",ARRANGE_SNAP_CELL_SIZE:"os.arrange.snap.cell-size",ARRANGE_CUSTOM_ACTION:"os.arrange.custom-action",SNAP_ZONE_PENDING:"os.snap.zone-pending",SNAP_ZONE_CANCELED:"os.snap.zone-canceled",SNAP_ZONE_COMMITTED:"os.snap.zone-committed",SNAP_SPLIT_FILLED:"os.snap.split-filled",WIDGETS:"os.widgets",WIDGET_MOUNTING:"os.widget.mounting",WIDGET_MOUNTED:"os.widget.mounted",WIDGET_UNMOUNTING:"os.widget.unmounting",WIDGET_MOUNT_FAILED:"os.widget.mount-failed",WIDGET_ADDED:"os.widget.added",WIDGET_REMOVED:"os.widget.removed",DESKTOP_CREATED:"os.os.created",DESKTOP_CLOSED:"os.os.closed",DESKTOP_SWITCHED:"os.os.switched",DESKTOP_RENAMED:"os.os.renamed",PRIMARY_DESKTOP_ID:"os.primary-desktop-id",WINDOWS_BEFORE_CLOSE_ALL:"os.windows.before-close-all",WINDOWS_CLOSE_ALL:"os.windows.close-all",WINDOWS_AFTER_CLOSE_ALL:"os.windows.after-close-all",COMMAND_BEFORE_RUN:"os.command.before-run",COMMAND_AFTER_RUN:"os.command.after-run",COMMAND_ERROR:"os.command.error",SHELL_RESIZED:"os.shell.resized",SHELL_VISIBILITY:"os.shell.visibility",CONNECTION_OPENED:"os.connection.opened",CONNECTION_CLOSED:"os.connection.closed",CONNECTION_MESSAGE:"os.connection.message",IFRAME_CONNECTION_REQUEST:"os.iframe.connection-request",WINDOW_CONTENT_CHANGED:"os.window-links.content-changed",WINDOW_LINK_GROUPS_CHANGED:"os.window-links.groups-changed",WINDOW_LINKS_CONTENT:"os.window-links.content",WINDOW_LINK_GROUPS:"os.window-links.groups",WINDOW_LINK_EDGES:"os.window-links.edges",RELATED_ENTITIES_ITEMS:"os.related-entities.items",WINDOW_LINK_RENDERERS:"os.window-links.renderers",WINDOW_LINK_RENDERER:"os.window-links.renderer",EDITOR_PREVIEW_WINDOW_CONFIG:"os.editor-preview.window-config",EDITOR_PREVIEW_LIVE:"os.editor-preview.live",EDITOR_PREVIEW_OPENED:"os.editor-preview.opened",EDITOR_PREVIEW_CLOSED:"os.editor-preview.closed",REVISIONS_WINDOW_CONFIG:"os.revisions.window-config",REVISIONS_OPENED:"os.revisions.opened",FILE_DROP_FILES_DETECTED:"os.drop.files-detected",FILE_DROP_FILES_REJECTED:"os.drop.files-rejected",FILE_DROP_DIALOG_FIELDS:"os.drop.dialog-fields",FILE_DROP_BEFORE_UPLOAD:"os.drop.before-upload",FILE_DROP_UPLOAD_STARTED:"os.drop.upload-started",FILE_DROP_UPLOAD_PROGRESS:"os.drop.upload-progress",FILE_DROP_AFTER_UPLOAD:"os.drop.after-upload",FILE_DROP_UPLOAD_FAILED:"os.drop.upload-failed",AUTH_LOST:"os.auth.lost",AUTH_RESTORED:"os.auth.restored"};function on(s,e){if(!s||typeof s!="object")return["def (not an object)"];const t=s,o=[];for(const i of e)i.valid(t)||o.push(`${i.field} (${i.message})`);return o}class Dl extends Error{constructor(e,t,o){super(`[openstation] ${e} registration rejected — fields: `+t.join(", ")+"."),this.name="RegistrationError",this.kind=e,this.errors=t,this.def=o}}function qs(s,e,t){if(e.length!==0)throw new Dl(s,e,t)}const ee=[[0,0],[100,0],[100,100],[0,100]],Pl=48,Nl=80,Fs=6,Vs=8,nn=4,rn=3,an=64,js=105,te=2;function ln(s){return`${Math.round(s*1e3)/1e3}%`}function se(s){return s.slice().reverse()}function _e(s,e,t,o){return[[s,e],[t,e],[t,o],[s,o]]}function zl(s,e,t,o){const i=[];for(let n=0;n<o;n++){const r=n/o*Math.PI*2;i.push([s+Math.cos(r)*t,e+Math.sin(r)*t])}return i}function B(s,e=[]){const t=[],o=i=>{t.push(`${ln(i[0])} ${ln(i[1])}`)};for(const i of s)o(i);if(e.length>0){o(s[0]);for(const i of e){for(const n of i)o(n);o(i[0]),o(s[0])}}return`polygon( ${t.join(", ")} )`}function cn(s){return B(ee,[se(zl(50,50,s,Pl))])}function dn(s){return B(ee,[se(_e(50-s,-te,50+s,100+te))])}function un(s){const e=100/Fs,t=[];for(let o=0;o<Fs;o++){const i=o*e;t.push(se(_e(-te,i,100+te,i+s)))}return B(ee,t)}function hn(s){return B(ee,[se(_e(-te,50-s,100+te,50+s))])}function pn(s){const e=100/Vs,t=[];for(let o=0;o<Vs;o++){const i=o*e;t.push(se(_e(i,-te,i+s,100+te)))}return B(ee,t)}function fn(s){return B(ee,[se([[50,50-s],[50+s,50],[50,50+s],[50-s,50]])])}function gn(s){const e=100/nn,t=100/rn,o=[];for(let i=0;i<rn;i++)for(let n=0;n<nn;n++){const r=n*e+e/2,a=i*t+t/2,c=e/2*s,u=t/2*s;o.push(se(_e(r-c,a-u,r+c,a+u)))}return B(ee,o)}function bn(s){const e=-Math.PI/2,t=s/180*Math.PI,o=[[50,50]];for(let i=0;i<an;i++){const n=e+i/(an-1)*t;o.push([50+Math.cos(n)*js,50+Math.sin(n)*js])}return B(ee,[se(o)])}function Ml(){return{from:cn(0),to:cn(Nl)}}function Ol(){return{from:dn(0),to:dn(52)}}function Wl(){return{from:un(0),to:un(100/Fs+.5)}}function Hl(){return{from:hn(0),to:hn(52)}}function Ul(){return{from:pn(0),to:pn(100/Vs+.5)}}function ql(){return{from:fn(0),to:fn(js)}}function Fl(){return{from:gn(0),to:gn(1.04)}}function Vl(){return{from:bn(0),to:bn(360)}}function jl(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 100% 0% )"}}function Kl(){return{from:"inset( 0% 0% 0% 0% )",to:"inset( 0% 0% 0% 100% )"}}function Bl(){return{from:B([[-60,0],[100,0],[100,100],[0,100]]),to:B([[100,0],[260,0],[260,100],[160,100]])}}const Ks=6,Bs=100,ce=Bs/2,Gt=200,mn=90,vn=["#5c5c6d","#525261","#484855","#3e3e49","#34343d","#2a2a31"],Gl="#101014",Xl=1.25,de="http://www.w3.org/2000/svg";let Zl=0;function Xt(s){return Math.round(s*1e3)/1e3}function Gs(s){return s/Ks*Math.PI*2-Math.PI/2}function Yl(s){const t=Gs(s)+Math.PI/Ks+Math.PI/2;return{x:Math.cos(t),y:Math.sin(t)}}function Jl(s){const e=Gs(s),t=Gs(s+1);return[[ce,ce],[ce+Math.cos(e)*Gt,ce+Math.sin(e)*Gt],[ce+Math.cos(t)*Gt,ce+Math.sin(t)*Gt]]}function _n(s,e){const t=Jl(s),o=document.createElementNS(de,"path");return o.setAttribute("d",`M ${t.map(([i,n])=>`${Xt(i)} ${Xt(n)}`).join(" L ")} Z`),e?o.setAttribute("fill","#fff"):(o.setAttribute("fill",vn[s%vn.length]),o.setAttribute("stroke",Gl),o.setAttribute("stroke-width",String(Xl)),o.setAttribute("vector-effect","non-scaling-stroke"),o.setAttribute("stroke-linejoin","round")),o}function Ql(){const s=`os-iris-${++Zl}`,e=document.createElementNS(de,"svg");e.setAttribute("viewBox",`0 0 ${Bs} ${Bs}`),e.setAttribute("preserveAspectRatio","none"),e.setAttribute("aria-hidden","true"),e.style.width="100%",e.style.height="100%",e.style.display="block";const t=document.createElementNS(de,"defs"),o=document.createElementNS(de,"mask");o.setAttribute("id",s);const i=document.createElementNS(de,"g"),n=document.createElementNS(de,"g");n.setAttribute("mask",`url(#${s})`);const r=[];for(let c=0;c<Ks;c++){const u=_n(c,!0),h=_n(c,!1);i.appendChild(u),n.appendChild(h),r.push({el:u,index:c},{el:h,index:c})}o.appendChild(i),t.appendChild(o),e.appendChild(t),e.appendChild(n);const a=document.createElement("div");return a.appendChild(e),{element:a,play:c=>r.map(({el:u,index:h})=>{const p=Yl(h),v=Xt(p.x*mn),y=Xt(p.y*mn);return u.animate([{transform:"translate( 0px, 0px )"},{transform:`translate( ${v}px, ${y}px )`}],{duration:c.duration,easing:c.easing,delay:c.delay,fill:"both"})})}}const ye="none",yn=K("desktop-mode/window-reveal-registry",()=>({registry:new Map,listeners:new Set})),Xs=yn.state.registry,Zs=yn.state.listeners,wn=/^[a-z0-9_/-]+$/;function kn(s){const e=/^\s*([a-zA-Z-]+)\s*\(/.exec(s);return e?e[1].toLowerCase():""}const ec=0;function xn(s,e){const t=[],o=typeof s.from=="string"&&s.from.trim()!=="",i=typeof s.to=="string"&&s.to.trim()!=="";if(o||t.push(`${e}.from (missing — the clip-path covering the window)`),i||t.push(`${e}.to (missing — the clip-path uncovering the window)`),o&&i){const n=kn(s.from),r=kn(s.to);n===""||r===""?t.push(`${e}.from|to (must be shape functions, e.g. \`inset( … )\` or \`polygon( … )\` — bare keywords like \`none\` cannot be animated)`):n!==r&&t.push(`${e}.from|to (must use the same shape function to interpolate — got \`${n}()\` and \`${r}()\`)`)}return t}function tc(s){if(typeof KeyframeEffect!="function")return!0;try{return new KeyframeEffect(null,null,{easing:s}),!0}catch{return!1}}function q(s){const e=[];if(!s||typeof s!="object")e.push("def (not an object)");else{typeof s.id!="string"||s.id.trim()===""?e.push("id (missing)"):wn.test(s.id.trim().toLowerCase())?s.id.trim().toLowerCase()===ye&&e.push('id ("none" is reserved)'):e.push(`id (must match ${wn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof s.label!="string"||s.label.trim()==="")&&e.push("label (missing)");const o=s.render!==void 0,i=Array.isArray(s.layers),n=s.from!==void 0||s.to!==void 0;o&&typeof s.render!="function"?e.push("render (not a function)"):o&&(i||n)?e.push("render|layers|from|to (supply exactly one of: a from/to pair, a layers array, or a render function)"):o||(i&&n?e.push("layers|from|to (supply EITHER a single from/to pair OR a layers array, not both)"):i?(s.layers.length===0&&e.push("layers (empty — supply at least one matched pair)"),s.layers.forEach((r,a)=>{if(!r||typeof r!="object"){e.push(`layers[ ${a} ] (not an object)`);return}e.push(...xn(r,`layers[ ${a} ]`))})):e.push(...xn(s,"").map(r=>r.replace(/^\./,"")))),s.easing!==void 0&&(typeof s.easing!="string"||s.easing.trim()===""?e.push("easing (not a non-empty string)"):tc(s.easing)||e.push("easing (not an easing the browser can parse — `Element.animate()` would throw at play time, with the covering surface already over the window)"))}qs("WindowReveal",e,s);const t=s.id.trim().toLowerCase();Xs.set(t,{...s,id:t}),ic()}function $n(){const s=Array.from(Xs.values()),e=J(O.WINDOW_REVEALS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-reveals` filter returned a non-array; falling back to registry list."),s)}function sc(s){return Xs.has(s)}function oc(s){return Zs.add(s),()=>{Zs.delete(s)}}function ic(){const s=Array.from(Zs);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] window-reveal registry listener threw:",t)}}q({id:"sweep",label:d("Sweep"),description:d("A straight edge travels across the window, uncovering the page behind it."),...Kl(),duration:420}),q({id:"iris",label:d("Iris"),description:d("The page opens out from the centre of the window, like a camera shutter."),...Ml(),duration:520}),q({id:"curtain",label:d("Curtain"),description:d("Two panels part from the middle of the window and slide off the sides."),...Ol(),duration:480}),q({id:"blinds",label:d("Blinds"),description:d("Six horizontal slats retract at once, letting the page through between them."),...Wl(),duration:560}),q({id:"diagonal",label:d("Diagonal"),description:d("A slanted edge sweeps off the trailing corner of the window."),...Bl(),duration:460}),q({id:"rise",label:d("Rise"),description:d("The page rises into the window from the bottom edge upward."),...jl(),duration:440}),q({id:"shutter",label:d("Shutter"),description:d("Two panels part from the middle of the window and slide off the top and bottom."),...Hl(),duration:480}),q({id:"slats",label:d("Slats"),description:d("Eight vertical slats retract at once, letting the page through between them."),...Ul(),duration:560}),q({id:"diamond",label:d("Diamond"),description:d("The page opens out from the centre of the window through a growing rhombus."),...ql(),duration:520}),q({id:"mosaic",label:d("Mosaic"),description:d("The page arrives as a grid of tiles, each opening out from its own centre."),...Fl(),duration:600}),q({id:"obturator",label:d("Camera shutter"),description:d("Six wedges slide aside in unison, opening a hexagonal aperture from the centre like the iris of a camera lens."),render:Ql,duration:720,edgeLag:0}),q({id:"radar",label:d("Radar"),description:d("A spoke sweeps a full turn around the centre of the window, uncovering the page behind it."),...Vl(),duration:760});const En={dockSize:["compact","default","large"],desktopLayout:["classic","unified"],dockPlacement:["bottom","left","right"],windowRadius:["sharp","default","round"],adminBarMode:["static","dynamic","hidden"]},An=["dockRailRenderer","windowReveal","accent"],Cn={windowRevealDuration:{min:80,max:4e3}},nc=/^[a-z0-9_-]+$/;[...Object.keys(En),...An,...Object.keys(Cn)];function Sn(s){if(!s||typeof s!="object"||Array.isArray(s))return{};const e=s,t={},o={};for(const[i,n]of Object.entries(En)){const r=e[i];typeof r=="string"&&n.includes(r)&&(t[i]=r)}for(const i of An){const n=e[i];typeof n=="string"&&nc.test(n)&&(t[i]=n)}for(const[i,n]of Object.entries(Cn)){const r=e[i];typeof r=="number"&&Number.isFinite(r)&&(o[i]=Math.min(n.max,Math.max(n.min,Math.round(r))))}return{...t,...o}}function Ys(s){const e=Sn(s);return typeof e.dockRailRenderer=="string"&&Ll(e.dockRailRenderer)===void 0&&delete e.dockRailRenderer,typeof e.windowReveal=="string"&&e.windowReveal!==ye&&!sc(e.windowReveal)&&delete e.windowReveal,typeof e.accent=="string"&&!Os().some(t=>t.id===e.accent)&&delete e.accent,e}const rc=/^[a-z0-9_-]+$/,Ln=128;function ac(s){return typeof s!="string"||s===""||s.length>2048?!1:s.startsWith("dashicons-")||s.startsWith("https://")||s.startsWith("http://")||s.startsWith("data:image/")}function Rn(s){if(!s||typeof s!="object")return null;const e=s,t=typeof e.slug=="string"?e.slug:"";if(!rc.test(t))return null;const o={};if(e.icons&&typeof e.icons=="object"){let c=0;for(const[u,h]of Object.entries(e.icons)){if(c>=Ln)break;u===""||!ac(h)||(o[u]=h,c+=1)}}const i={};if(e.tokens&&typeof e.tokens=="object")for(const[c,u]of Object.entries(e.tokens))typeof u=="string"&&(i[c]=u);const n=[];if(Array.isArray(e.fonts))for(const c of e.fonts)typeof c=="string"&&c!==""&&n.push(c);const r={};if(e.iconColors&&typeof e.iconColors=="object"){let c=0;for(const[u,h]of Object.entries(e.iconColors)){if(c>=Ln)break;u===""||typeof h!="string"||h===""||(r[u]=h,c+=1)}}const a=c=>typeof e[c]=="string"?e[c]:"";return{id:a("id")||t,slug:t,name:a("name")||t,version:a("version"),author:a("author"),description:a("description"),previewUrl:a("previewUrl"),cssUrl:a("cssUrl"),cssText:a("cssText"),tokens:i,fonts:n,icons:o,iconColors:r,recommendedOsSettings:Sn(e.recommendedOsSettings),installedAt:typeof e.installedAt=="number"?e.installedAt:0,source:e.source==="code"?"code":"upload",cssDeferred:e.cssDeferred===!0}}function lc(){const e=window.openStationConfig?.serverDesktopThemes,t=[];if(Array.isArray(e))for(const o of e){const i=Rn(o);i&&t.push(i)}return{themes:t,activeId:null,activeIcons:null,activeIconColors:null}}const Z=K("desktop-mode/desktop-themes",lc);function In(){return Z}function cc(){return Z.getState().themes.slice()}function Tn(s){if(typeof s!="string"||s==="")return null;const e=s.replace(/\//g,"-");return Z.getState().themes.find(t=>t.slug===e||t.id===s)??null}function dc(s){const e=Rn(s);if(!e)return null;const t=Z.state.themes.slice(),o=t.findIndex(i=>i.slug===e.slug);return o>=0?t[o]=e:t.push(e),t.sort((i,n)=>i.name.localeCompare(n.name)),Z.setState({themes:t}),e}function uc(s){const e=Z.state.themes.filter(t=>t.slug!==s);e.length!==Z.state.themes.length&&Z.setState({themes:e})}function hc(s){return Z.subscribe(s)}async function Dn(s,e){try{const t=await s.json();if(t&&typeof t.message=="string"&&t.message!=="")return t.message}catch{}return`${e} (HTTP ${s.status}).`}function Pn(s){const e=s?.serverWallpapers;Array.isArray(e)&&Q(O.WALLPAPERS_SERVER_CHANGED,{wallpapers:e})}async function pc(s,e){const t=s.desktopThemesUrl??"";if(t==="")throw new Error("[openstation] No desktopThemesUrl in the shell config — the desktop-themes REST route is unavailable.");const o=new FormData;o.append("file",e,e.name);const i=await j(t,{method:"POST",credentials:"same-origin",headers:{"X-WP-Nonce":s.restNonce},body:o},{source:"desktop-mode/desktop-themes/upload"});if(!i.ok)throw new Error(await Dn(i,"Theme upload failed"));const n=await i.json();return Pn(n),n}async function fc(s,e){const t=s.desktopThemesUrl??"";if(t==="")throw new Error("[openstation] No desktopThemesUrl in the shell config — the desktop-themes REST route is unavailable.");const o=await j(`${t}/${encodeURIComponent(e)}`,{method:"DELETE",credentials:"same-origin",headers:{"X-WP-Nonce":s.restNonce}},{source:"desktop-mode/desktop-themes/delete"});if(!o.ok)throw new Error(await Dn(o,"Theme delete failed"));try{Pn(await o.json())}catch{}}const gc="os.activity.";function Js(s){return gc+String(s).replace(/[^a-zA-Z0-9_.-]/g,".")}let bc=0;const Nn={publish(s,e){Q(Js(s),e)},subscribe(s,e){const t=`os/activity-sub/${++bc}`,o=Js(s);Il(o,t,n=>e(n));let i=!1;return()=>{i||(i=!0,Tl(o,t))}},filter(s,e,...t){return J(Js(s),e,...t)}};let Qs=null;function Zt(){return!!window.openStationShellOverlays}function mc(s){return new Promise((e,t)=>{const o=document.querySelector('script[data-os-shell-overlays="1"]'),i=()=>{if(Zt()){e();return}t(new Error("[openstation] shell-overlays bundle loaded but did not set `window.openStationShellOverlays`."))};if(o){Zt()?i():(o.addEventListener("load",i),o.addEventListener("error",()=>t(new Error("failed to load shell-overlays bundle"))));return}const n=document.createElement("script");n.src=s,n.async=!0,n.dataset.osShellOverlays="1",n.addEventListener("load",i),n.addEventListener("error",()=>t(new Error("failed to load shell-overlays bundle"))),document.head.appendChild(n)})}function vc(s){return Zt()||!s?Promise.resolve():(Qs||(Qs=mc(s)),Qs)}function _c(){return window.openStationConfig?.shellOverlaysBundleUrl??""}function yc(s,e){const t=_c();if(Zt()||!t){e();return}vc(t).then(()=>{s()&&e()}).catch(o=>{typeof console<"u"&&console.warn("[openstation] shell-overlays failed to load; menu/dialog suppressed:",o)})}const wc=4e3,kc=200,xc=1200;function eo(s){const e=Nn.filter("os/toast-requested",{...s});if(!e||e.cancel===!0)return()=>{};let t=!1,o=null;return yc(()=>!t,()=>{o=$c(e)}),()=>{t=!0,o&&o()}}function $c(s){const e=Sc(),t=document.createElement("os-toast");t.textContent=s.message,s.action&&(t.setAttribute("action",s.action.label),t.addEventListener("os-toast-action",()=>{s.action?.onClick(),c()})),s.dismissible&&(t.setAttribute("dismissible",""),t.addEventListener("os-toast-dismiss",()=>{s.onDismiss?.(),c()})),e.appendChild(t);let o=!1,i=null,n=s.duration??wc,r=0;const a=()=>{i!==null&&(window.clearTimeout(i),i=null)},c=()=>{o||(o=!0,a(),Cc(t),t.setAttribute("state","out"),window.setTimeout(()=>{t.remove(),Ac()},kc))},u=()=>{o||s.persistent||i!==null||(r=Date.now(),i=window.setTimeout(c,n))},h=()=>{i!==null&&(n=Math.max(0,n-(Date.now()-r)),a())};return requestAnimationFrame(()=>{t.setAttribute("state","in")}),t.addEventListener("os-toast-hold",p=>{if(p.detail?.held){h();return}n=Math.max(n,xc),u()}),Ec(t),u(),Nn.publish("os/toast-shown",{...s}),c}let Yt=null,we=0;function zn(s){const e=s.target;e instanceof HTMLElement&&(e.closest("os-toast-container")||(Yt=e))}function Ec(s){we===0&&document.addEventListener("focusin",zn,!0),we+=1;const e=s.ownerDocument,t=e.activeElement;t instanceof HTMLElement&&t!==e.body&&!t.closest("os-toast-container")&&(Yt=t)}function Ac(){we=Math.max(0,we-1),we===0&&document.removeEventListener("focusin",zn,!0)}function Cc(s){const e=s.ownerDocument.activeElement;e!==s&&!s.contains(e)||Yt?.isConnected===!0&&Yt.focus()}function Sc(){const s=document.querySelector("os-toast-container");if(s)return s;const e=document.createElement("os-toast-container");return document.body.appendChild(e),e}function Lc(s){const e=In().state;if(e.activeIcons===null||!s)return null;const t=e.activeIcons[s];if(typeof t!="string"||t==="")return null;const o=J(O.DESKTOP_THEME_ICON,t,{slot:s,themeId:e.activeId??""});return typeof o=="string"&&o!==""?o:null}function Rc(s){const e=In().state;if(e.activeIconColors===null||!s)return null;const t=e.activeIconColors[s];if(typeof t!="string"||t==="")return null;const o=J(O.DESKTOP_THEME_ICON_COLOR,t,{slot:s,themeId:e.activeId??""});return typeof o=="string"&&o!==""?Ic(o):null}function Ic(s){const e=s.trim();if(e===""||e.length>64||/[;{}<>"'\\]/.test(e))return null;let t=0;for(const o of e)if(o==="(")t+=1;else if(o===")"&&(t-=1,t<0))return null;return t===0?e:null}const ke={OS_SETTINGS:"OS_SETTINGS",RECYCLE_BIN:"RECYCLE_BIN",BUG_REPORT:"BUG_REPORT",EXIT_OPENSTATION:"EXIT_OPENSTATION",PWA_INSTALL:"PWA_INSTALL"},Tc={"desktop-mode-os-settings":ke.OS_SETTINGS,"desktop-mode-recycle-bin":ke.RECYCLE_BIN,"desktop-mode-bug-report":ke.BUG_REPORT,"os-exit":ke.EXIT_OPENSTATION,"os-pwa-install":ke.PWA_INSTALL};function Dc(s){if(typeof s!="string"||s==="")return"";const e=Tc[s];if(e)return e;const t=s.toLowerCase().replace(/[^a-z0-9_-]/g,"");return t===""?"":`APP:${t}`}const Mn="",Pc="system-default",On={accent:"pulse",desktopLayout:"unified",dockPlacement:"bottom"};function Wn(s,e,t={}){const o=e===Mn,i=o?null:Tn(e);if(!o&&!i)return{};const n=o?Pc:i.slug,r=s.appliedThemeRecommendations.includes(n);if(r&&!t.force)return{};const a=Ys(o?On:i.recommendedOsSettings),c=Object.keys(a);if(c.length===0)return{};const u=s,h={};for(const p of c){const v=a[p];typeof v!="string"&&typeof v!="number"||!(p in s)||typeof u[p]!=typeof v||(u[p]=v,h[p]=v)}return Object.keys(h).length===0?{}:(r||(s.appliedThemeRecommendations=[...s.appliedThemeRecommendations,n].slice(-64)),h)}function Nc(s){if(s===Mn)return Object.keys(Ys(On)).length>0;const e=Tn(s);return e?Object.keys(Ys(e.recommendedOsSettings)).length>0:!1}const Jt="",Hn="OpenStation";function zc(s){const e=s.trim().split(/\s+/).filter(Boolean);return e.length===0?"?":e.length>=2?(e[0][0]+e[1][0]).toUpperCase():e[0].slice(0,2).toUpperCase()}function Mc(s){const e=document.createElement("div");e.className="os-settings__themes";let t="",o=!1;const i=!!s.config.canManageDesktopThemes,n=f=>{s.state.desktopTheme!==f&&(s.state.desktopTheme=f,Wn(s.state,f),s.save(),s.apply(),_())},r=f=>{const b=Wn(s.state,f,{force:!0});Object.keys(b).length!==0&&(s.save(),s.apply(),_())},a=async f=>{if(!o){o=!0,t="",_();try{const b=await pc(s.config,f);dc(b)}catch(b){t=b instanceof Error?b.message:d("That theme could not be installed.")}finally{o=!1,_()}}},c=async f=>{if(await Ji({title:d("Delete this theme?"),message:F(d("“%s” will be removed from this site for everyone. This cannot be undone."),f.name),confirmLabel:d("Delete"),danger:!0})){t="";try{await fc(s.config,f.slug),uc(f.slug),s.state.desktopTheme===f.slug&&(s.state.desktopTheme=Jt,s.save(),s.apply())}catch(x){t=x instanceof Error?x.message:d("That theme could not be deleted.")}_()}},u=f=>{const b=f.currentTarget,x=b.files?.[0];x&&a(x),b.value=""},h=f=>{f.preventDefault(),f.currentTarget.classList.remove("os-settings__theme-upload--dragover");const b=f.dataTransfer?.files?.[0];b&&a(b)},p=f=>{const b=s.state.desktopTheme===f.slug;return l`<div class="os-settings__theme-card-wrap">
			<button
				type="button"
				class="os-settings__theme-card"
				aria-pressed=${b?"true":"false"}
				data-theme-slug=${f.slug}
				@click=${()=>n(f.slug)}
			>
				...
				<span class="os-settings__theme-meta">
					${f.version!==""?F(d("Version %s"),f.version):""}
				</span>
			</button>
			${i&&f.source!=="code"?l`<button
						type="button"
						class="os-settings__theme-delete"
						aria-label=${F(d("Delete %s"),f.name)}
						@click=${()=>void c(f)}
					>
						×
					</button>`:""}
		</div>`},v=()=>{const f=s.state.desktopTheme===Jt;return l`<div class="os-settings__theme-card-wrap">
			<button
				type="button"
			...
			>
				...
				>
				<span class="os-settings__theme-meta"
					>${d("The look OpenStation ships with")}</span
				>
			</button>
		</div>`},y=()=>l`<div
		class=${o?"os-settings__theme-upload os-settings__theme-upload--busy":"os-settings__theme-upload"}
		@dragover=${f=>{f.preventDefault(),f.currentTarget.classList.add("os-settings__theme-upload--dragover")}}
		@dragleave=${f=>{f.currentTarget.classList.remove("os-settings__theme-upload--dragover")}}
		@drop=${h}
	>
		<label class="os-settings__theme-upload-label">
			...
			<span class="os-settings__theme-upload-prompt"
				>${d(o?"Installing…":"Drop a theme .zip here, or click to upload")}</span
			>
		</label>
	</div>`,g=f=>{const b=s.state.desktopTheme;if(!Nc(b))return"";const x=b===Jt?Hn:f.find(w=>w.slug===b)?.name;return x===void 0?"":l`<div class="os-settings__theme-recommendation">
			<os-button
				variant="secondary"
				@click=${()=>r(b)}
				>${F(d("Apply %s’s recommended layout and effects"),x)}</os-button
			>
		</div>`};function _(){const f=cc();L(l`
				${t!==""?l`<os-notice tone="error">${t}</os-notice>`:""}
				<os-section heading=${d("Installed")}>
					<!--
			...
			`,e)}_();const m=hc(()=>{if(!e.isConnected){m();return}_()});return e}function Un(s){if(!s)return 214;let e=5381;for(let t=0;t<s.length;t++)e=Math.imul(e,33)+s.charCodeAt(t);return(e%360+360)%360}function Oc(s){return typeof s!="string"||s===""||s.length>4096||!/^(https?:\/\/|data:image\/)/i.test(s)?!1:!/['"()\\<>\s]/.test(s)}function qn(s,e,t){if(!Oc(e))return!1;const o=`url("${e}") center / contain no-repeat`;return s.style.backgroundImage="none",s.style.backgroundColor=t,s.style.setProperty("-webkit-mask",o),s.style.setProperty("mask",o),!0}const Fn="data:image/svg+xml;base64,",Qt=new Map;function Wc(s){const e=Qt.get(s);if(e!==void 0)return e;let t=!1;try{t=atob(s.slice(Fn.length)).includes("currentColor")}catch{}return Qt.size>=256&&Qt.clear(),Qt.set(s,t),t}function Vn(s,e){const t=e.className??"",o=e.title??"";let i=null;if(e.slot){const c=Lc(e.slot);c!==null&&(s=c),i=Rc(e.slot)}if(typeof s=="string"&&s.startsWith("dashicons-")){const c=document.createElement("span");return c.className=`dashicons ${s} ${t}`.trim(),c.setAttribute("aria-hidden","true"),i!==null&&(c.style.color=i),c}if(i!==null&&typeof s=="string"){const c=document.createElement("span");if(c.className=t,c.setAttribute("aria-hidden","true"),c.style.display="inline-block",qn(c,s,i))return c}if(typeof s=="string"&&s.startsWith("data:image/svg+xml;base64,")){const c=s.slice(Fn.length);if(/^[A-Za-z0-9+/=]+$/.test(c)){const u=document.createElement("span");return u.className=t,u.setAttribute("aria-hidden","true"),u.style.display="inline-block",Wc(s)&&qn(u,s,"currentColor")||(u.style.backgroundImage=`url("${s}")`,u.style.backgroundRepeat="no-repeat",u.style.backgroundPosition="center",u.style.backgroundSize="contain"),u}}if(typeof s=="string"&&/^data:image\/(png|jpeg|jpg|gif|webp|x-icon|vnd\.microsoft\.icon);base64,/i.test(s)){const c=s.indexOf(","),u=c>=0?s.slice(c+1):"";if(/^[A-Za-z0-9+/=]+$/.test(u))return jn(s,t)}if(typeof s=="string"&&(s.startsWith("http://")||s.startsWith("https://")))return jn(s,t);const n=document.createElement("span");n.className=`${t} os-icon-letter`.trim(),n.setAttribute("aria-hidden","true");const r=Hc(o);n.textContent=r;const a=Un(o);return n.style.backgroundColor=`hsl( ${a}, 60%, 45% )`,n.style.color="#fff",n.style.display="inline-flex",n.style.alignItems="center",n.style.justifyContent="center",n.style.fontWeight="600",n.style.borderRadius="4px",n}function jn(s,e){const t=document.createElement("img");return t.className=e,t.src=s,t.alt="",t.setAttribute("aria-hidden","true"),t.draggable=!1,t}function Hc(s){const e=(s??"").trim();if(e==="")return"?";const t=e.split(/\s+/);if(t.length>=2)return(t[0][0]+t[1][0]).toUpperCase();const o=t[0];return o.length>=2?o.slice(0,2).toUpperCase():o.toUpperCase()}const Uc={core:"rail",plugin:"rail",app:"desktop",control:"rail"};function qc(s,e){return s==="core"&&e==="classic"?"sidebar":"dock"}function Fc(s,e){return s.locked?"rail":e[s.id]??s.defaultPlacement??Uc[s.kind]}function Vc(s){return s.map((e,t)=>({item:e,index:t})).sort((e,t)=>(e.item.order??0)-(t.item.order??0)||e.index-t.index).map(e=>e.item)}const jc=[{kinds:["core"],heading:d("WordPress Core"),description:d("The admin menus WordPress itself registers.")},{kinds:["plugin","app"],heading:d("Plugins & Apps"),description:d("Menus from installed plugins and apps.")},{kinds:["control"],heading:d("OpenStation"),description:d("The OpenStation’s own controls.")}];function Kc(){const s=window.wp?.os;return typeof s?.getNavItems=="function"?s.getNavItems():[]}function Bc(s){return s.locked||s.transient?!1:s.menu||s.entry?!0:s.tile?.placeable===!0}function Gc(s){const e=document.createElement("div"),t=(u,h)=>{s.state.navPlacement={...s.state.navPlacement,[u]:h},s.save(),r()},o=u=>h=>{const v=h.detail?.value;(v==="both"||v==="rail"||v==="desktop"||v==="hidden")&&t(u,v)},i=u=>d(u==="classic"?"Choose where each menu shows up: on the dock/sidebar, on the desktop wallpaper, both, or hidden entirely. Changes apply instantly.":"Choose where each menu shows up: on the dock, on the desktop wallpaper, both, or hidden entirely. Changes apply instantly."),n=(u,h)=>[{id:"rail",label:qc(u,h)==="sidebar"?d("In the sidebar"):d("On the dock")},{id:"desktop",label:d("On the desktop")},{id:"both",label:d("On both")},{id:"hidden",label:d("Hidden")}],r=(u=s.state.navPlacement,h=s.state.desktopLayout)=>{const p=Kc().filter(Bc),v=jc.map(y=>({...y,rows:Vc(p.filter(g=>y.kinds.includes(g.kind)))})).filter(y=>y.rows.length>0);L(l`
				<p class="os-settings__page-description os-nav-settings__lead">
					${i(h)}
				</p>
				${v.length===0?l`<os-empty-state
							heading=${d("Nothing registered yet")}
							description=${d("Plugins and the admin menu will appear here once they’re registered.")}
						></os-empty-state>`:v.map(y=>l`
								<os-section
									class="os-nav-settings"
									heading=${y.heading}
									description=${y.description}
								>
									${y.rows.map(g=>a(g,u,h))}
								</os-section>
							`)}
			`,e)},a=(u,h,p)=>l`<div class="os-nav-settings__row" data-item-id=${u.id}>
		<div class="os-nav-settings__identity">
			${Vn(u.icon,{title:u.title,className:"os-nav-settings__icon",slot:Dc(u.id)})}
			<div class="os-nav-settings__title">${u.title}</div>
		</div>
		<os-select
			plain
			label=${u.title}
			...
			@os-pick=${o(u.id)}
		>
			${n(u.kind,p).map(v=>l`<os-option value=${v.id}>${v.label}</os-option>`)}
		</os-select>
	</div>`;r();const c=window.wp?.os;if(c?.subscribeOsSettings){const u=c.subscribeOsSettings(h=>{if(!e.isConnected){u();return}r(h.navPlacement,h.desktopLayout)})}return e}const Xc={unified:[{kind:"win",style:"left:12%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:30%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:24%;bottom:10%;width:52%;height:9%"}],classic:[{kind:"bar",rail:"sidebar",style:"left:0;top:0;bottom:0;width:5%"},{kind:"win",style:"left:14%;top:14%;width:44%;height:42%"},{kind:"win",style:"left:32%;top:30%;width:44%;height:42%"},{kind:"bar",rail:"dock",style:"left:33%;bottom:10%;width:38%;height:9%"}]};function Zc(s){const e=_=>{Ui.some(m=>m.id===_)&&(s.state.desktopLayout=_,s.save(),s.apply(),g())},t=_=>{const m=_.detail?.value??"";Hi.some(f=>f.id===m)&&(s.state.dockPlacement=m,s.save(),s.apply(),g())},o=_=>{const m=_.detail?.value??"";zi.some(f=>f.id===m)&&(s.state.dockSize=m,s.save(),s.apply(),g())},i=_=>{const m=_.detail?.value??"";return Wi.some(f=>f.id===m)?m:null},n=_=>{const m=i(_);m&&(s.state.dockBehavior=m,s.save(),s.apply(),g())},r=_=>{const m=i(_);m&&(s.state.sideDockBehavior=m,s.save(),s.apply(),g())},a=_=>d(_==="dynamic"?"The dock folds into a thin line at its edge of the screen and comes back when you move the pointer there. Windows can use the whole desktop.":"The dock is always visible, and windows open above it."),c=()=>Wi.map(_=>l`<os-segment value=${_.id}
					>${_l(_.id,_.label)}</os-segment
				>`),u=()=>l`<div class="os-settings__dock-options">
					<div class="os-settings__dock-option">
						...
						>
						<os-segmented
							value=${s.state.dockPlacement}
							label=${d("Dock position")}
							@os-pick=${t}
						>
							${Hi.map(_=>l`<os-segment value=${_.id}
										>${yl(_.id,_.label)}</os-segment
									>`)}
						</os-segmented>
					</div>
			  </div>`,h=()=>l`<div class="os-settings__dock-options">
					<div class="os-settings__dock-option">
						<span
							class="os-settings__dock-option-label"
							id="os-settings-side-dock-behavior-label"
							>${d("Sidebar behavior")}</span
						>
						<os-segmented
							value=${s.state.sideDockBehavior}
							label=${d("Sidebar behavior")}
							@os-pick=${r}
						>
							${c()}
						</os-segmented>
				...
				>
					<div class="os-settings__dock-option">
						...
						<os-segmented
							...
							@os-pick=${o}
						>
							${zi.map(_=>l`<os-segment value=${_.id}
										>${bl(_.id,_.label)}</os-segment
									>`)}
						</os-segmented>
					</div>
					<div class="os-settings__dock-option">
						<span
							...
							>${d("Dock behavior")}</span
						>
						<os-segmented
							value=${s.state.dockBehavior}
							label=${d("Dock behavior")}
							@os-pick=${n}
						>
							${c()}
						</os-segmented>
						<span class="os-settings__dock-option-hint"
							>${a(s.state.dockBehavior)}</span
						>
					</div>
			  </div>`,v=_=>{const m=["os-settings__layout-card"];return s.state.dockBehavior==="dynamic"&&m.push("is-dock-dynamic"),_==="classic"&&s.state.sideDockBehavior==="dynamic"&&m.push("is-sidebar-dynamic"),m.join(" ")},y=document.createElement("div"),g=()=>L(l`
				<os-section
					heading=${d("Desktop layout")}
					description=${d("Where the menus live.")}
				>
					<div
						class="os-settings__layout-grid"
						role="radiogroup"
						aria-label=${d("Desktop layout")}
					>
						${Ui.map(_=>{const m=s.state.desktopLayout===_.id;return l`<div class=${v(_.id)}>
								<button
									type="button"
								...
								>
									<span
										...
										aria-hidden="true"
									>
										${(Xc[_.id]??[]).map(f=>l`<span
												class="os-settings__layout-${f.kind}${f.rail?` is-accent is-${f.rail}`:""}"
												style=${f.style}
											></span>`)}
									</span>
									<span class="os-settings__layout-name"
										>${wl(_.id,_.label)}</span
									>
			...
			`,y);return g(),y}function Yc(s){const e=i=>{const n=i.detail?.value??"";Mi.some(r=>r.id===n)&&(s.state.windowRadius=n,s.save(),s.apply(),o())},t=document.createElement("div"),o=()=>L(l`
				<os-section
					heading=${d("Window corners")}
					description=${d("How rounded the corners of windows are.")}
				>
					<os-segmented
						value=${s.state.windowRadius}
						label=${d("Window corners")}
						@os-pick=${e}
					>
						${Mi.map(i=>l`<os-segment value=${i.id}
								>${ml(i.id,i.label)}</os-segment
							>`)}
					</os-segmented>
				</os-section>
			`,t);return o(),t}function Jc(s){s.style.setProperty("--os-file-tile-enter-delay",`${(Math.random()*.25).toFixed(3)}s`),s.style.setProperty("--os-file-tile-enter-duration",`${(.3+Math.random()*.25).toFixed(3)}s`)}const es=new Map;function Kn(s){let e,t;try{const i=new URL(s,document.baseURI);e=i.origin,t=i.pathname}catch{return null}if(!t)return null;const o=document.querySelectorAll("script[src]");for(const i of Array.from(o))try{const n=new URL(i.src,document.baseURI);if(n.origin===e&&n.pathname===t)return i}catch{}return null}function to(s,e){const t=es.get(s);if(t)return t;const o=e?.deps;if(o&&o.length>0){const n=a=>!a.url||Kn(a.url)?Promise.resolve():to(a.url,{...a,deps:void 0}),r=o.reduce((a,c)=>a.then(()=>n(c)),Promise.resolve(void 0)).then(()=>Bn(s,e));return es.set(s,r),r}const i=Bn(s,e);return es.set(s,i),i}function Bn(s,e){return new Promise((t,o)=>{const i=`script[data-os-vendor="${Qc(s)}"]`,n=document.querySelector(i);if(n){if(n.dataset.loaded==="1"){t();return}n.addEventListener("load",()=>t(),{once:!0}),n.addEventListener("error",()=>o(new Error(`Failed to load ${s}`)),{once:!0});return}const r=Kn(s);if(r){r.dataset.osVendor=s,r.dataset.loaded="1",t();return}e?.translations&&ts(e.translations);for(const c of e?.l10n??[])ts(c);for(const c of e?.before??[])ts(c);const a=document.createElement("script");a.src=s,a.async=!0,a.dataset.osVendor=s,a.addEventListener("load",()=>{a.dataset.loaded="1";for(const c of e?.after??[])ts(c);t()},{once:!0}),a.addEventListener("error",()=>{es.delete(s),a.remove(),o(new Error(`Failed to load ${s}`))},{once:!0}),document.head.appendChild(a)})}function ts(s){if(!s)return;const e=document.createElement("script");e.textContent=s,e.dataset.osVendorInline="1",document.head.appendChild(e)}function Qc(s){return typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(s):s.replace(/["\\]/g,"\\$&")}K("desktop-mode/native-url-remap",()=>({remaps:[],deps:null}));function ed(s){const e=document.createElement("div"),t=a=>{const c=a.detail?.value??"";c!==""&&(s.state.dockRailRenderer=c,s.save(),s.apply(),i())};let o=sn();const i=()=>{if(o.length<=1){L(l``,e);return}L(l`
				<os-section
					heading=${d("Dock style")}
					description=${d("How the rail itself paints — the shipped icon strip, or anything a plugin replaces it with. Switching is instant; the dock rebuilds with the new renderer.")}
				>
					<os-segmented
						value=${s.state.dockRailRenderer}
						label=${d("Dock style")}
						@os-pick=${t}
					>
						${o.map(a=>l`<os-segment value=${a.id}
									>${a.label}</os-segment
								>`)}
					</os-segmented>
				</os-section>
			`,e)},n=Rl(()=>{o=sn(),i()}),r=new MutationObserver(()=>{e.isConnected||(n(),r.disconnect())});return queueMicrotask(()=>{e.parentNode&&r.observe(e.parentNode,{childList:!0,subtree:!1})}),i(),e}const ss="none",Gn=K("desktop-mode/unfocus-effect-registry",()=>({registry:new Map,listeners:new Set})),Xn=Gn.state.registry,so=Gn.state.listeners,Zn=/^[a-z0-9_/-]+$/;function oo(s){const e=[];!s||typeof s!="object"?e.push("def (not an object)"):(typeof s.id!="string"||s.id.trim()===""?e.push("id (missing)"):Zn.test(s.id.trim().toLowerCase())?s.id.trim().toLowerCase()===ss&&e.push('id ("none" is reserved)'):e.push(`id (must match ${Zn} — lowercase alphanum, hyphens, underscores, slashes for vendor/sub-id)`),(typeof s.label!="string"||s.label.trim()==="")&&e.push("label (missing)"),typeof s.className!="string"&&typeof s.apply!="function"&&e.push("className|apply (at least one must be provided — a CSS class to toggle or an apply callback)")),qs("UnfocusEffect",e,s);const t=s.id.trim().toLowerCase();Xn.set(t,{...s,id:t}),sd()}function Yn(){const s=Array.from(Xn.values()),e=J(O.UNFOCUS_EFFECTS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.unfocus-effects` filter returned a non-array; falling back to registry list."),s)}function td(s){return so.add(s),()=>{so.delete(s)}}function sd(){const s=Array.from(so);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] unfocus-effect registry listener threw:",t)}}oo({id:"darken",label:d("Darken"),description:d("Dim unfocused windows so the focused one stands out."),className:"os-window--fx-darken"}),oo({id:"frost",label:d("Frost"),description:d("Throw unfocused windows out of focus — a soft, frosted-glass blur, as if you were looking at them through an iced-over pane."),className:"os-window--fx-frost"}),oo({id:"grayscale",label:d("Grayscale"),description:d("Drain the colour from unfocused windows so the focused one is the only thing still in colour — your eye snaps right to it."),className:"os-window--fx-grayscale"});const io="none",Jn=K("desktop-mode/window-link-renderer-registry",()=>({registry:new Map,listeners:new Set})),od=Jn.state.registry,Qn=Jn.state.listeners;function er(){const s=Array.from(od.values()),e=J(O.WINDOW_LINK_RENDERERS,s);return Array.isArray(e)?e:(typeof console<"u"&&console.warn("[openstation] `os.window-links.renderers` filter returned a non-array; falling back to registry list."),s)}function id(s){return Qn.add(s),()=>{Qn.delete(s)}}let ae=null;function nd(){if(ae)return ae;if(window.openStationWindowLinkVisuals)return ae=Promise.resolve(!0),ae;const e=window.openStationConfig?.windowLinkVisualsBundleUrl;return e?(ae=to(e).then(()=>!0).catch(t=>{throw ae=null,t}),ae):Promise.resolve(!1)}const tr=[{value:ec,label:()=>d("Default (per reveal)")},{value:200,label:()=>d("Very fast — 200 ms")},{value:320,label:()=>d("Fast — 320 ms")},{value:460,label:()=>d("Normal — 460 ms")},{value:700,label:()=>d("Slow — 700 ms")},{value:1100,label:()=>d("Very slow — 1100 ms")}],rd=[{id:"focus",label:()=>d("When a related window is focused")},{id:"always",label:()=>d("Always")},{id:"off",label:()=>d("Off")}];function ad(s){const e=document.createElement("div"),t=_=>{const m=_.detail?.value??"";m!==""&&(m!==ss&&!a.some(f=>f.id===m)||(s.state.unfocusEffect=m,s.save(),s.apply(),h()))},o=_=>{const m=_.detail?.value??"";m!==""&&(m!==ye&&!c.some(f=>f.id===m)||(s.state.windowReveal=m,s.save(),h()))},i=_=>{const m=_.detail?.value??"";if(m==="")return;const f=Number(m);tr.some(b=>b.value===f)&&(s.state.windowRevealDuration=f,s.save(),h())},n=_=>{const m=_.detail?.value??"";m!==""&&(m!==io&&!u.some(f=>f.id===m)||(s.state.windowLinkRenderer=m,s.save(),s.apply(),h()))},r=_=>{const m=_.detail?.value??"";m!=="focus"&&m!=="always"&&m!=="off"||(s.state.windowLinkVisibility=m,s.save(),s.apply(),h())};let a=Yn(),c=$n(),u=er();const h=()=>{const _=a.find(S=>S.id===s.state.unfocusEffect),m=d("Apply a visual treatment to every window except the one you are working in."),f=s.state.unfocusEffect!==ss&&_?.description?_.description:m,b=c.find(S=>S.id===s.state.windowReveal),x=d("Uncover a window’s content when it finishes loading, instead of fading it in."),w=s.state.windowReveal!==ye&&b?.description?b.description:x,R=u.find(S=>S.id===s.state.windowLinkRenderer),ie=d("Draw a visual tie between windows showing related content — a post and its comments or media."),U=s.state.windowLinkRenderer!==io&&R?.description?R.description:ie;L(l`
				<os-section
					heading=${d("Unfocused windows")}
					description=${f}
				>
					<os-select
						value=${s.state.unfocusEffect}
						label=${d("Unfocused window effect")}
						@os-pick=${t}
					>
						<os-option value=${ss}>
							${d("None")}
						</os-option>
						${a.map(S=>l`<os-option value=${S.id}
									>${S.label}</os-option
								>`)}
					</os-select>
				</os-section>
				<os-section
					heading=${d("Window reveal")}
					description=${w}
				>
					<os-select
						value=${s.state.windowReveal}
						label=${d("Reveal style")}
						@os-pick=${o}
					>
						<os-option value=${ye}>
							${d("None")}
						</os-option>
						${c.map(S=>l`<os-option value=${S.id}
									>${S.label}</os-option
								>`)}
					</os-select>
					<os-select
						value=${String(s.state.windowRevealDuration)}
						label=${d("Reveal speed")}
						@os-pick=${i}
					>
						${tr.map(S=>l`<os-option value=${String(S.value)}
									>${S.label()}</os-option
								>`)}
					</os-select>
				</os-section>
				<os-section
					heading=${d("Window links")}
					description=${U}
				>
					<os-select
						value=${s.state.windowLinkRenderer}
						label=${d("Link style")}
						@os-pick=${n}
					>
						<os-option value=${io}>
						...
						${u.map(S=>l`<os-option value=${S.id}
									>${S.label}</os-option
								>`)}
					</os-select>
					<os-select
						value=${s.state.windowLinkVisibility}
						label=${d("Show links")}
						@os-pick=${r}
					>
						${rd.map(S=>l`<os-option value=${S.id}
									>${S.label()}</os-option
								>`)}
					</os-select>
				</os-section>
			`,e)},p=td(()=>{a=Yn(),h()}),v=oc(()=>{c=$n(),h()}),y=id(()=>{u=er(),h()});nd().catch(()=>{});const g=new MutationObserver(()=>{e.isConnected||(p(),v(),y(),g.disconnect())});return queueMicrotask(()=>{e.parentNode&&g.observe(e.parentNode,{childList:!0,subtree:!1})}),h(),e}function sr(){const s=window.wp?.os?.refreshMenu;if(typeof s=="function")try{s()}catch{}}function ld(s){const{extendedOptions:e,extendedOptionsUrl:t,restNonce:o}=s.config,i={media_library_enhanced:e?.media_library_enhanced===!0,games:e?.games===!0,agents:e?.agents===!0,saving:!1,error:""},n=document.createElement("div");let r=!1;const a=async()=>{if(!t||!o)return;if(i.saving){r=!0;return}i.saving=!0,i.error="",p();let v=null;try{const y=await j(t,{method:"POST",headers:{"Content-Type":"application/json","X-WP-Nonce":o},body:JSON.stringify({options:{media_library_enhanced:i.media_library_enhanced,games:i.games,agents:i.agents}})},{source:"desktop-mode/settings/extended"});if(y.ok){const g=await y.json().catch(()=>null);g&&typeof g=="object"&&(s.config.extendedOptions=g,v=g)}else{const g=await y.json().catch(()=>({}));i.error=g.message??`Error ${y.status}`}}catch{i.error=d("Network error — check your connection.")}finally{if(i.saving=!1,v)try{Q(O.EXTENDED_OPTIONS_CHANGED,{options:v})}catch{}r?(r=!1,await a()):(v&&sr(),p())}},c=v=>{i.media_library_enhanced=v.detail?.checked===!0,a()},u=v=>{i.games=v.detail?.checked===!0,a()},h=v=>{i.agents=v.detail?.checked===!0,a()},p=()=>L(l`
				<os-section
					heading=${d("Extended options")}
					description=${d("Site-wide enhancements that apply to every user. Toggling requires the affected page to be reloaded for the change to take effect.")}
				>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Enable drag-and-drop in the Media Library")}
							?checked=${i.media_library_enhanced}
							@os-checkbox-change=${c}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Makes every item in the WordPress Media Library draggable. Drop a media item into text fields, rich-text editors, Gutenberg blocks, or any target that accepts images or files. No replacement of the library — just a drag-and-drop layer on top of the one you already know.")}
						</p>
					</div>

					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Enable games")}
							?checked=${i.games}
							@os-checkbox-change=${u}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Adds a Games app for every user: built-in games, scoreboards, and player-to-player challenges. Off by default — while off, nothing game-related runs anywhere, on the server or in the browser. Saved scores are kept across a disable and reappear when re-enabled.")}
						</p>
					</div>

					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Enable AI agents")}
							?checked=${i.agents}
							@os-checkbox-change=${h}
						></os-checkbox-label>
						<p class="os-features__hint">
					...
					${i.error?l`<p class="os-ext__error">${i.error}</p>`:l``}
					${i.saving?l`<p class="os-ext__saving">${d("Saving…")}</p>`:l``}
				</os-section>
			`,n);return p(),n}function cd(s){try{navigator.serviceWorker?.controller?.postMessage({type:"os-sw-set-prewarm",enabled:s})}catch{}}let no=!1;function dd(){no=!0}document.addEventListener("os-settings-save-lifecycle",s=>{if(!no)return;const e=s.detail?.phase;e!=="saved"&&e!=="failed"||(no=!1,e==="saved"&&sr())});const ud=typeof navigator<"u"&&/Mac|iPhone|iPad|iPod/i.test(navigator.platform||navigator.userAgent||"")?"⌘K":"Ctrl+K";function hd(s){const e=document.createElement("div"),t=A=>{const C=A.detail?.checked===!0;s.state.nativePostsEnabled=C,s.save(),T()},o=A=>{const C=A.detail?.value,N=Number(C);if([15,30,45,60].includes(N)){s.state.heartbeatRate=N,s.save();try{const M=window.wp,ne=N>=60?"slow":"standard";M?.heartbeat?.interval?.(ne)}catch{}T()}},i=A=>{const C=A.detail?.checked===!0;s.state.nativePagesEnabled=C,s.save(),T()},n=A=>{const C=A.detail?.checked===!0;s.state.nativeUsersEnabled=C,s.save(),T()},r=A=>{const C=A.detail?.checked===!0;s.state.nativePluginsEnabled=C,s.save(),T()},a=A=>{const C=A.detail?.checked===!0;s.state.nativeCommentsEnabled=C,s.save(),T()},c=A=>{const C=A.detail?.checked===!0;s.state.stationHomeEnabled=C,s.save(),T()},u=A=>{const C=A.detail?.checked===!0;s.state.windowPrewarmEnabled=C,s.save(),cd(C),T()},h=A=>{const C=A.detail?.checked===!0;s.state.adminAssetCacheEnabled=C,s.save(),T()},p=A=>{const C=A.detail?.checked===!0;s.state.showDesktopOnWallpaperClick=C,s.save(),T()},v=A=>{const C=A.detail?.checked===!0;s.state.windowLinksEnabled=C,s.save(),s.apply(),T()},y=A=>{const C=A.detail?.checked===!0;s.state.windowLinkRaiseOnFocus=C,s.save(),s.apply(),T()},g=A=>{const C=A.detail?.checked===!0;s.state.windowLinkHighlight=C,s.save(),s.apply(),T()},_=A=>{const C=A.detail?.checked===!0;s.state.showPostStatusRibbons=C,s.save(),T()},m=A=>{const C=A.detail?.checked===!0;s.state.developerModeEnabled=C,s.save(),T(),dd()},f=A=>{const C=A.detail?.checked===!0;s.state.foldersSharingEnabled=C,s.save(),T()};let b=!1;const x=async()=>{if(b||!await Ji({title:d("Delete folder sharing data?"),message:d("This drops every shares table on the site (current + legacy). All invites, accept/deny decisions, and share rows are permanently removed. Recipients lose their access until someone shares with them again. The empty tables are recreated on the next admin load so the feature keeps working — but every existing share is gone."),confirmLabel:d("Delete data"),danger:!0}))return;const C=w?.filesUrl,N=w?.restNonce;if(!C||!N){eo({message:d("Files REST endpoint is not available.")});return}b=!0,T();try{const M=C.replace(/\/+$/,"")+"/folder-sharing-tables/purge",ne=await j(M,{method:"POST",headers:{"X-WP-Nonce":N},credentials:"same-origin"},{source:"os-settings/folder-sharing-purge"});if(!ne.ok){const Fh=await ne.text();throw new Error(`${ne.status}: ${Fh.slice(0,200)}`)}const qh=await ne.json();eo({message:d("Folder sharing data deleted.")+" ("+qh.dropped.length+" tables)"})}catch(M){const ne=M instanceof Error?M.message:String(M);eo({message:d("Could not delete sharing data.")+" "+ne})}finally{b=!1,T()}},w=window.openStationConfig,R={enabled:w?.commentsAi?.enabled??!1,providerConfigured:w?.commentsAi?.providerConfigured??!1,saving:!1},ie=async A=>{const C=A.detail?.checked===!0;if(!(!w?.commentsAiUrl||R.saving)){R.saving=!0,R.enabled=C,T();try{const N=await j(w.commentsAiUrl,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json","X-WP-Nonce":w.restNonce??""},body:JSON.stringify({enabled:C})},{source:"os-settings/comments-ai"});if(N.ok){const M=await N.json();R.enabled=M.enabled,R.providerConfigured=M.providerConfigured,w.commentsAi&&(w.commentsAi.enabled=M.enabled,w.commentsAi.providerConfigured=M.providerConfigured)}else R.enabled=!C}catch{R.enabled=!C}R.saving=!1,T()}},U=A=>{const C=A.detail?.checked===!0;s.state.ai={...s.state.ai,enabled:C},s.save(),T()},S=async()=>{const A=w?.aiAssistant;if(!(!A||!w?.aiStatusUrl))try{const C=await j(w.aiStatusUrl,{credentials:"same-origin",headers:{"X-WP-Nonce":w.restNonce??""}},{source:"os-settings/ai-status",silent:!0});if(!C.ok)return;const N=await C.json(),M=A.available!==(N.available===!0)||A.assistantProviderConfigured!==(N.assistantProviderConfigured===!0);A.available=N.available===!0,A.providerConfigured=N.providerConfigured===!0,A.assistantProviderConfigured=N.assistantProviderConfigured===!0,R.providerConfigured=A.providerConfigured,T(),M&&document.dispatchEvent(new CustomEvent("os-ai-status-changed"))}catch{}};let X=!1;const Fr=A=>{A.detail?.windowId==="desktop-mode-os-settings"&&(X||(X=!0,S().finally(()=>{X=!1})))};document.addEventListener("os-window-focused",Fr);const Vr=new MutationObserver(()=>{e.isConnected||(document.removeEventListener("os-window-focused",Fr),Vr.disconnect())});Vr.observe(document.body,{childList:!0,subtree:!0});const jr=()=>{const A=w?.aiAssistant?.connectorsUrl??"";if(!A)return;const C=window.wp?.os;if(C?.windowManager?.open){const N=C.deriveWindowId?C.deriveWindowId(A):A;C.windowManager.open({id:N,url:A,title:d("Connectors"),icon:"dashicons-admin-settings"})}else window.open(A,"_blank","noopener")};let Ot=!1;const Uh=async()=>{if(Ot)return;const A=window.openStationConfig;if(A?.seenIntrosUrl){Ot=!0,T();try{await j(A.seenIntrosUrl,{method:"DELETE",credentials:"same-origin",headers:{"X-WP-Nonce":A.restNonce??""}},{source:"os-settings/reset-intros"}),document.dispatchEvent(new CustomEvent("os-intros-reset"))}catch{}Ot=!1,T()}},T=()=>L(l`
				<!--
				...
				<os-section
					heading=""
					description=${d("Watch the dot in the OpenStation Preferences title bar to see when a change has been saved.")}
				>
					${w?.aiAssistant?.available?l`
								<div class="os-features__item">
									<os-checkbox-label
										label=${d("AI assistant")}
										?checked=${s.state.ai.enabled}
										?disabled=${!w.aiAssistant.assistantProviderConfigured}
										@os-checkbox-change=${U}
									></os-checkbox-label>
									<p class="os-features__hint">
										${F(d("Adds an AI mode to the %s command palette: find content and ask about your site."),ud)}
									</p>
									${w.aiAssistant.assistantProviderConfigured?"":l`
												<os-notice tone="warning" not-dismissible>
													${d("This feature requires an AI provider configured in")}
													<a
														href=${w.aiAssistant.connectorsUrl}
														@click=${A=>{A.preventDefault(),jr()}}
														>${d("Settings → Connectors")}</a
													>.
												</os-notice>
											`}
								</div>
					...
					${w?.commentsAi?l`
							<div class="os-features__item">
								<os-checkbox-label
									label=${d("Score new comments with AI")}
									?checked=${R.enabled}
									?disabled=${R.saving||!R.providerConfigured}
									@os-checkbox-change=${ie}
								></os-checkbox-label>
								<p class="os-features__hint">
									${d("Rates incoming comments so you can triage the queue faster.")}
								</p>
								${R.providerConfigured?"":l`
											<os-notice tone="warning" not-dismissible>
												${d("This feature requires an AI provider configured in")}
												<a
													href=${w?.aiAssistant?.connectorsUrl??""}
					...
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Window links")}
							?checked=${s.state.windowLinksEnabled}
							@os-checkbox-change=${v}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Draws connector lines between related windows. Line style and visibility live in Windows → Window links.")}
						</p>
						<div class="os-features__item">
							<os-checkbox-label
								label=${d("Bring related windows to front")}
								?checked=${s.state.windowLinkRaiseOnFocus}
								?disabled=${!s.state.windowLinksEnabled}
								@os-checkbox-change=${y}
							></os-checkbox-label>
							<p class="os-features__hint">
								${d("Clicking a window also surfaces its parent and children.")}
							</p>
						</div>
						<div class="os-features__item">
							<os-checkbox-label
								label=${d("Highlight related windows")}
								?checked=${s.state.windowLinkHighlight}
								?disabled=${!s.state.windowLinksEnabled}
								@os-checkbox-change=${g}
							></os-checkbox-label>
							<p class="os-features__hint">
								${d("Related windows get an accent outline while one of them is focused.")}
							</p>
						</div>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Show desktop when clicking the wallpaper")}
							?checked=${s.state.showDesktopOnWallpaperClick}
							@os-checkbox-change=${p}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("A click on the empty desktop minimizes every window; a second click restores them.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Show post/page status ribbon")}
							?checked=${s.state.showPostStatusRibbons}
							@os-checkbox-change=${_}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Marks unpublished posts and pages with a corner ribbon on their tiles.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Enable developer mode")}
							?checked=${s.state.developerModeEnabled}
							@os-checkbox-change=${m}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Unlocks developer surfaces meant for plugin authors.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Folder sharing")}
							?checked=${s.state.foldersSharingEnabled}
							@os-checkbox-change=${f}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Share desktop folders with other users or roles, with read or write access.")}
						</p>
						${w?.currentUserIsAdmin?l`
								<div class="os-features__danger-row">
									<p class="os-features__hint">
										${d("Removes every share and its access list. Cannot be undone.")}
									</p>
									<os-button
										variant="danger"
										?disabled=${b}
										@click=${x}
									>
										${d(b?"Deleting…":"Delete folder sharing data")}
									</os-button>
								</div>
							`:""}
					</div>
					<div class="os-features__item">
						<label class="os-features__select-label">
							<span class="os-features__select-title">${d("WordPress Heartbeat rate")}</span>
							<os-select
								value=${String(s.state.heartbeatRate)}
								@os-pick=${o}
							>
								<os-option value="15">${d("Fast (15s, not recommended)")}</os-option>
								<os-option value="30">${d("Medium (30s)")}</os-option>
								<os-option value="45">${d("Slow (45s)")}</os-option>
								<os-option value="60">${d("Very slow (60s, default)")}</os-option>
							</os-select>
						</label>
						<p class="os-features__hint">
							${d("How often the Heartbeat API runs. Faster means quicker live updates and more server traffic. The 30s and 45s rates apply exactly from the next page load.")}
						</p>
					</div>
					<div class="os-features__row">
						<p class="os-features__hint">
							${d("Brings back the one-time announcements you have dismissed, such as the welcome dialog.")}
						</p>
						<os-button
							variant="secondary"
							?disabled=${Ot}
							@click=${Uh}
						>
							${d(Ot?"Resetting…":"Reset what’s-new dialogs")}
						</os-button>
					</div>
				</os-section>
				<os-section
					heading=${d("Beta features")}
					description=${d("Experimental redesigns of core admin screens, off by default. Each toggle affects only your account and takes effect immediately.")}
				>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use Station Home as your Dashboard")}
							?checked=${s.state.stationHomeEnabled}
							@os-checkbox-change=${c}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Opens Station Home instead of the classic WordPress Dashboard: recent work, site pulse, and quick actions in one native window. Leave off to keep the classic Dashboard, including any customizations plugins have made to it.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use the native Posts window")}
							?checked=${s.state.nativePostsEnabled}
							@os-checkbox-change=${t}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Replaces the classic Posts list with a native table window: sticky header, paginated rows, bulk actions, and a row preview.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use the native Pages window")}
							?checked=${s.state.nativePagesEnabled}
							@os-checkbox-change=${i}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("The Posts table experience for Pages, with a Parent column, hierarchical sort, and edit-lock indicators.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use the native Users window")}
							?checked=${s.state.nativeUsersEnabled}
							@os-checkbox-change=${n}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("A native Users list with bulk role changes, online indicators, and one-click password resets.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use the native Plugins window")}
							?checked=${s.state.nativePluginsEnabled}
							@os-checkbox-change=${r}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("A native Plugins window with an Installed list, bulk actions, and a Browse gallery from the WordPress.org directory.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Use the native Comments window")}
							?checked=${s.state.nativeCommentsEnabled}
							@os-checkbox-change=${a}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("A native two-pane Comments window: a list of conversations beside the full reply thread.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Prewarm windows on hover (experimental)")}
							?checked=${s.state.windowPrewarmEnabled}
							@os-checkbox-change=${u}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Starts loading a page in a hidden window while you hover its dock icon, so the window appears already rendered when you click. Uses extra memory for one speculative window at a time.")}
						</p>
					</div>
					<div class="os-features__item">
						<os-checkbox-label
							label=${d("Shared asset cache (experimental)")}
							?checked=${s.state.adminAssetCacheEnabled}
							@os-checkbox-change=${h}
						></os-checkbox-label>
						<p class="os-features__hint">
							${d("Serves the admin’s stylesheets and scripts from one cache shared by every window, so opening a window skips the network for files any window has already loaded. Unlike the other toggles here, this one takes effect after your next reload.")}
						</p>
					</div>
				</os-section>
			`,e);return T(),e}const pd=k`
	:host {
		display: flex;
...
`;function fd(){const s="os-multiselect-popover-styles";if(document.getElementById(s))return;const e=document.createElement("style");e.id=s,e.textContent=`
...
`,document.head.appendChild(e)}typeof document<"u"&&fd();const Be=class Be extends ${constructor(){super(...arguments),this._optionObserver=null,this._popover=null,this._teardownOpen=null,this._hasMore=!1,this._loadingMore=!1}set items(e){const t=this.querySelectorAll(":scope > os-option");for(const n of Array.from(t))n.remove();for(const n of e){const r=document.createElement("os-option");r.setAttribute("value",n.value),r.textContent=n.label,this.appendChild(r)}this._loadingMore=!1;const o=new Set(e.map(n=>n.value)),i=this._readValues().filter(n=>o.has(n));this._writeValueAttribute(i),this.requestUpdate(),this._refreshPopover()}get values(){return this._readValues()}set values(e){const t=Array.isArray(e)?e.map(o=>String(o)).filter(o=>o!==""):[];this._writeValueAttribute(t),this.requestUpdate(),this._refreshPopover()}get hasMore(){return this._hasMore}set hasMore(e){this._hasMore=!!e,this._refreshPopover()}get loadingMore(){return this._loadingMore}set loadingMore(e){this._loadingMore=!!e,this._refreshPopover()}appendItems(e){if(this._loadingMore=!1,!e||e.length===0){this._refreshPopover();return}const t=new Set(Array.from(this.querySelectorAll(":scope > os-option")).map(o=>o.getAttribute("value")));for(const o of e){if(t.has(o.value))continue;const i=document.createElement("os-option");i.setAttribute("value",o.value),i.textContent=o.label,this.appendChild(i)}this.requestUpdate(),this._refreshPopover()}connectedCallback(){super.connectedCallback(),be(this),this._optionObserver=new MutationObserver(()=>{this.requestUpdate(),this._refreshPopover()}),this._optionObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["value","disabled"],characterData:!0})}disconnectedCallback(){this._optionObserver?.disconnect(),this._optionObserver=null,this._closePopover()}render(){const e=this.label||"",t=this.placeholder||"All",o=this.disabled!==null;e?this.setAttribute("aria-label",e):this.removeAttribute("aria-label");const i=e||t,n=this._summarize(t),r=this._readValues().length>0,c=`${this.id||"os-unnamed"}__trigger`;return l`
		...
		`}_readOptions(){const e=[],t=this.querySelectorAll(":scope > os-option");for(const o of Array.from(t)){const i=o.getAttribute("value");i!==null&&e.push({value:i,label:(o.textContent||i).trim(),disabled:o.hasAttribute("disabled")})}return e}_readValues(){return(this.value??"").split(",").map(t=>t.trim()).filter(t=>t!=="")}_writeValueAttribute(e){const t=e.join(",");this.value=t}_summarize(e){const t=this._readValues();if(t.length===0)return e;const o=this._readOptions(),i=new Map(o.map(n=>[n.value,n.label]));return t.length===1?i.get(t[0])??t[0]:`${t.length} selected`}_isOpen(){return this.open!==null}_onTriggerClick(e){e.stopPropagation(),e.preventDefault(),this.disabled===null&&(this._popover?this._closePopover():this._openPopover())}_openPopover(){if(this._popover)return;const e=document.createElement("div");e.className="os-multiselect__popover",e.setAttribute("role","listbox"),e.setAttribute("aria-multiselectable","true"),e.style.setProperty("--wp-admin-theme-color",getComputedStyle(this).getPropertyValue("--wp-admin-theme-color")||"#2271b1"),document.body.appendChild(e),this._popover=e,this._refreshPopover(),this._placePopover();const t=r=>{const a=r.target;if(!a)return;const c=this.shadowRoot?.querySelector(".os-multiselect__trigger");e.contains(a)||c&&c.contains(a)||this._closePopover()},o=r=>{r.key==="Escape"&&(r.stopPropagation(),this._closePopover(),this.shadowRoot?.querySelector(".os-multiselect__trigger")?.focus())},i=()=>this._placePopover(),n=()=>{if(!this._hasMore||this._loadingMore)return;const r=e.scrollHeight,a=e.clientHeight,c=e.scrollTop;r-(c+a)<64&&this.emit("os-multiselect-load-more",{})};setTimeout(()=>{document.addEventListener("pointerdown",t,!0)},0),document.addEventListener("keydown",o,!0),window.addEventListener("resize",i),window.addEventListener("scroll",i,!0),e.addEventListener("scroll",n),this._teardownOpen=()=>{document.removeEventListener("pointerdown",t,!0),document.removeEventListener("keydown",o,!0),window.removeEventListener("resize",i),window.removeEventListener("scroll",i,!0),e.removeEventListener("scroll",n)},this.setAttribute("open",""),this.requestUpdate(),this.emit("os-multiselect-open",{})}_closePopover(){this._teardownOpen&&(this._teardownOpen(),this._teardownOpen=null),this._popover&&(this._popover.remove(),this._popover=null,this.removeAttribute("open"),this.requestUpdate(),this.emit("os-multiselect-close",{}))}_refreshPopover(){const e=this._popover;if(!e)return;const t=this._readOptions(),o=new Set(this._readValues());if(e.replaceChildren(),t.length===0){const i=document.createElement("div");i.className="os-multiselect__empty",i.textContent="No options",e.appendChild(i);return}if(o.size>0){const i=document.createElement("button");i.type="button",i.className="os-multiselect__clear",i.textContent="Clear",i.addEventListener("click",n=>{n.preventDefault(),n.stopPropagation(),this._writeValueAttribute([]),this.requestUpdate(),this._refreshPopover(),this._emitPick()}),e.appendChild(i)}for(const i of t){const n=document.createElement("label");n.className="os-multiselect__option",n.setAttribute("role","option"),n.setAttribute("aria-selected",o.has(i.value)?"true":"false"),i.disabled&&(n.setAttribute("aria-disabled","true"),n.dataset.disabled="true");const r=document.createElement("input");r.type="checkbox",r.checked=o.has(i.value),r.disabled=i.disabled,r.addEventListener("change",()=>{const c=new Set(this._readValues());r.checked?c.add(i.value):c.delete(i.value);const u=t.map(h=>h.value).filter(h=>c.has(h));this._writeValueAttribute(u),n.setAttribute("aria-selected",r.checked?"true":"false"),this.requestUpdate(),this._refreshPopover(),this._emitPick()});const a=document.createElement("span");a.textContent=i.label,n.appendChild(r),n.appendChild(a),e.appendChild(n)}if(this._loadingMore){const i=document.createElement("div");i.className="os-multiselect__loading";const n=document.createElement("span");n.className="os-multiselect__spinner",n.setAttribute("aria-hidden","true");const r=document.createElement("span");r.textContent="Loading…",i.appendChild(n),i.appendChild(r),e.appendChild(i)}}_placePopover(){const e=this._popover,t=this.shadowRoot?.querySelector(".os-multiselect__trigger");if(!e||!t)return;const o=t.getBoundingClientRect(),i=window.innerWidth,n=window.innerHeight,r=Math.max(o.width,200);e.style.minWidth=`${r}px`;let a=o.left;a+r>i-8&&(a=Math.max(8,i-r-8)),e.style.left=`${a}px`,e.style.top=`${o.bottom+4}px`;const c=e.offsetHeight||200;o.bottom+4+c>n-8&&(e.style.top=`${Math.max(8,o.top-c-4)}px`)}_emitPick(){const e=this._readValues();this.emit("os-pick",{value:e.join(","),values:e})}};Be.props=["value","label","placeholder","disabled","name","open"],Be.styles=[pd],Be.help=void 0;let ro=Be;E("os-multiselect",ro);const Ge=class Ge extends ${connectedCallback(){super.connectedCallback(),be(this)}render(){const e=this.label||"",t=this.value??"",o=this.placeholder||"",i=this.disabled!==null,n=this.readonly!==null,r=this.name||"",a=this.suffix||"",c=this.min,u=this.max,h=this.step||"any",p=this.invalid!==null,y=`${this.id||"os-unnamed"}__input`;return l`
			...
			<span class="os-text-field__row">
				...
				/>
				${a?l`<span class="os-text-field__suffix">${a}</span>`:l``}
			</span>
		`}_readRange(){const e=this.min,t=this.max,o=e!==null?parseFloat(e):-1/0,i=t!==null?parseFloat(t):1/0;return{min:Number.isFinite(o)?o:-1/0,max:Number.isFinite(i)?i:1/0}}_clamp(e){const{min:t,max:o}=this._readRange();return e<t?t:e>o?o:e}_onInput(e){const t=e.target,o=parseFloat(t.value);Number.isFinite(o)&&(this.value=String(o),this.emit("os-input-change",{value:o}))}_onCommit(e){const t=e.target,o=parseFloat(t.value);if(!Number.isFinite(o))return;const i=this._clamp(o);i!==o&&(t.value=String(i),this.value=String(i)),this.emit("os-input-commit",{value:i})}_onKeyDown(e){if(e.key==="Enter"&&!e.shiftKey&&!e.altKey&&!e.metaKey){const t=e.target,o=parseFloat(t.value);if(!Number.isFinite(o))return;const i=this._clamp(o);i!==o&&(t.value=String(i),this.value=String(i)),this.emit("os-submit",{value:i})}}};Ge.props=["label","value","placeholder","disabled","readonly","name","suffix","min","max","step","invalid"],Ge.styles=[Ai],Ge.help=void 0;let ao=Ge;E("os-number-field",ao);const gd=k` ${I} ${Ft}:host{display:inline-flex;align-items:center;gap:6px;font-size:13px;color:var( --os-ui-fg,#1d2327 );cursor:pointer}:host( [ disabled ] ){cursor:not-allowed;opacity:0.55}:host( [ block ] ){display:flex;cursor:default}:host( [ block ] ) label{cursor:pointer}:host( [ block ][ disabled ] ) label{cursor:not-allowed}label{display:inline-flex;align-items:center;gap:6px;cursor:inherit}.os-checkbox__label{line-height:1.3}.os-checkbox__label:empty{display:none}`,Xe=class Xe extends ${render(){const e=this.checked!==null,t=this.disabled!==null,o=this.label||"",i=this.value;return l`
			<label>
				<input
					type="checkbox"
					?checked=${e}
		...
		`}};st.props=["open","title","size","mandatory"],st.styles=[Cd],st.help=void 0;let vo=st;E("os-modal",vo);const Sd=k`:host{display:block;position:relative;font-size:13px}.input{width:100%;padding:8px 10px;background:var( --os-ui-input-bg,var( --os-ui-hover,rgba( 255,255,255,0.06 ) ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );border-radius:6px;font:inherit;box-sizing:border-box}.input:focus{outline:none;border-color:var( --os-ui-accent,#2271b1 );box-shadow:var( --os-ui-focus-ring-field,0 0 0 1px #2271b1,0 0 0 4px rgba( 34,113,177,0.18 ) )}.dropdown{background:var( --os-bg,#1d2327 );color:var( --os-fg,#fff );border:1px solid var( --os-ui-border,rgba( 255,255,255,0.18 ) );border-radius:6px;overflow:auto;z-index:11000;box-shadow:0 12px 32px rgba( 0,0,0,0.5 )}.empty.error{color:var( --os-ui-danger-hover,#ff8080 )}.item{display:flex;align-items:center;gap:10px;padding:8px 10px;cursor:pointer;border:0;background:transparent;color:inherit;width:100%;text-align:start;font:inherit}.item:hover,.item:focus{background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );outline:none}.avatar{width:24px;height:24px;border-radius:50%;flex:0 0 auto;background:var( --os-ui-hover,rgba( 255,255,255,0.1 ) )}.name{font-weight:500}.slug{opacity:0.6;font-size:12px}.empty{padding:12px;color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,ot=class ot extends ${constructor(){super(...arguments),this._timer=null,this._abort=null,this._results=[],this._query="",this._open=!1,this._phase="idle",this._error="",this._dropdownStyle="",this._onScrollOrResize=()=>{},this._onInput=e=>{const t=e.target.value;this._query=t,this._scheduleSearch(t)},this._onFocus=()=>{if(this._results.length===0&&this._phase==="idle"){this._scheduleSearch(this._query);return}this._open=!0,this._positionDropdown(),this.requestUpdate()},this._onBlur=()=>{setTimeout(()=>{this._open=!1,this.requestUpdate()},150)},this._pick=e=>{this.emit("os-user-pick",{user:e}),this._results=[],this._open=!1,this._phase="idle",this._query="";const t=this.shadowRoot?.querySelector(".input");t&&(t.value=""),this.requestUpdate()}}connectedCallback(){super.connectedCallback(),this._onScrollOrResize=()=>{this._open&&(this._positionDropdown(),this.requestUpdate())},window.addEventListener("resize",this._onScrollOrResize),window.addEventListener("scroll",this._onScrollOrResize,!0)}disconnectedCallback(){this._timer&&clearTimeout(this._timer),this._abort&&this._abort.abort(),window.removeEventListener("resize",this._onScrollOrResize),window.removeEventListener("scroll",this._onScrollOrResize,!0)}_endpoint(){const e=this.getAttribute("endpoint");return e||window.openStationConfig?.filesUsersSearchUrl||""}_scheduleSearch(e){this._timer&&clearTimeout(this._timer),this._phase="loading",this._open=!0,this._positionDropdown(),this.requestUpdate(),this._timer=setTimeout(()=>this._runSearch(e),200)}async _runSearch(e){const t=this._endpoint();if(!t){this._phase="error",this._error="Search endpoint is not configured.",this._results=[],this._open=!0,this.requestUpdate();return}this._abort&&this._abort.abort();const o=new AbortController;this._abort=o;const i=this.getAttribute("exclude")||"",n=t+"?q="+encodeURIComponent(e)+"&exclude="+encodeURIComponent(i);try{const r={signal:o.signal,credentials:"same-origin"},a=await j(n,r,{source:"desktop-mode/files-user-search",silent:!0});if(!a.ok)throw new Error(`HTTP ${a.status}`);const c=await a.json();this._results=c&&Array.isArray(c.users)?c.users:[],this._phase="ready",this._error="",this._open=!0}catch(r){if(r.name==="AbortError")return;this._results=[],this._phase="error",this._error=r.message||"Search failed.",this._open=!0}this._positionDropdown(),this.requestUpdate()}_positionDropdown(){const e=this.shadowRoot?.querySelector(".input");if(!e)return;const t=e.getBoundingClientRect(),o=t.bottom+4,i=t.left,n=t.width,a=window.innerHeight-t.bottom,c=t.top,u=Math.max(120,Math.min(280,Math.max(a,c)-16));a<200&&c>a?this._dropdownStyle=["position:fixed",`left:${i}px`,`top:${t.top-4-u}px`,`width:${n}px`,`max-height:${u}px`].join(";"):this._dropdownStyle=["position:fixed",`left:${i}px`,`top:${o}px`,`width:${n}px`,`max-height:${u}px`].join(";")}_dropdownContent(){if(this._phase==="loading")return l`<div class="empty">Searching…</div>`;if(this._phase==="error")return l`<div class="empty error">${this._error}</div>`;if(this._results.length===0){const e=this._query?"No matches.":"No users available.";return l`<div class="empty">${e}</div>`}return this._results.map(e=>l`
			...
			`)}render(){const e=this.getAttribute("placeholder")||"Search users…";return l`
			<input
				class="input"
				type="search"
				placeholder=${e}
			...
			${this._open?l`
				...
				`:l``}
		`}};ot.props=["placeholder","exclude","endpoint"],ot.styles=[Sd],ot.help=void 0;let _o=ot;E("os-user-search",_o);const Ld=k`:host{display:flex;flex-wrap:wrap;gap:6px;font-size:13px}.chip{display:inline-flex;align-items:center;gap:6px;padding:4px 10px;border-radius:999px;background:var( --os-ui-hover,rgba( 255,255,255,0.06 ) );color:inherit;border:1px solid var( --os-ui-border,rgba( 255,255,255,0.12 ) );cursor:pointer;font:inherit}.chip:hover{background:var( --os-ui-hover,rgba( 255,255,255,0.12 ) )}.chip[ aria-pressed='true' ]{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.empty{color:var( --os-ui-fg-muted,rgba( 255,255,255,0.5 ) );font-size:12px}`,it=class it extends ${constructor(){super(...arguments),this._onToggle=e=>{const t=!this._selectedSet().has(e);this.emit("os-role-toggle",{slug:e,selected:t})}}_selectedSet(){const e=this.getAttribute("selected")||"";return new Set(e.split(",").map(t=>t.trim()).filter(t=>t!==""))}_roles(){const e=this.getAttribute("roles");if(e)try{const t=JSON.parse(e);if(Array.isArray(t))return t}catch{}return window.openStationConfig?.shareEligibleRoles||[]}render(){const e=this._roles();if(e.length===0)return l`<span class="empty">No eligible roles.</span>`;const t=this._selectedSet();return l`
			${e.map(o=>{const i=t.has(o.slug);return l`
					<button
						type="button"
						class="chip"
		...
		`}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._paintSvg())}attributeChangedCallback(e,t,o){super.attributeChangedCallback(e,t,o),queueMicrotask(()=>this._paintSvg())}_paintSvg(){const e=this.shadowRoot;if(!e)return;const t=e.querySelector("svg"),o=e.querySelector("[data-svg-buffer]");if(t&&o){const i=o.textContent||"";t.innerHTML!==i&&(t.innerHTML=i)}}};rt.props=["variant"],rt.styles=[Td],rt.help=void 0;let ko=rt;E("os-tab-chip",ko);const Pd=k`:host{display:flex;flex-direction:column;gap:var( --os-ui-stack-gap,12px );align-items:var( --os-ui-stack-align,stretch );padding:var( --os-ui-stack-padding,0 )}:host( [ hidden ] ){display:none}`,at=class at extends ${render(){const e=this.gap,t=this.align,o=this.padding,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-stack-gap",i),t&&this.style.setProperty("--os-ui-stack-align",t),o!==null&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-stack-padding",`${o}px`),l`<slot></slot>`}};at.props=["gap","align","padding"],at.styles=[Pd],at.help=void 0;let xo=at;E("os-stack",xo);const Nd=k`:host{display:flex;flex-direction:row;flex-wrap:wrap;gap:var( --os-ui-cluster-gap,8px );justify-content:var( --os-ui-cluster-justify,flex-start );align-items:var( --os-ui-cluster-align,center )}:host( [ hidden ] ){display:none}`,lt=class lt extends ${render(){const e=this.gap,t=this.justify,o=this.align,i=e&&/^\d+$/.test(e)?`${e}px`:"";return i&&this.style.setProperty("--os-ui-cluster-gap",i),t&&this.style.setProperty("--os-ui-cluster-justify",t),o&&this.style.setProperty("--os-ui-cluster-align",o),l`<slot></slot>`}};lt.props=["gap","justify","align"],lt.styles=[Nd],lt.help=void 0;let $o=lt;E("os-cluster",$o);const zd=k`:host{display:flex;flex-direction:column;gap:var( --os-ui-body-gap,12px );padding:var( --os-ui-body-padding,16px );box-sizing:border-box;width:100%;height:100%;min-width:0;min-height:0}:host( [ scroll ] ){overflow:auto}:host( [ hidden ] ){display:none}::slotted( * ){min-width:0}`,ct=class ct extends ${render(){const e=this.gap,t=this.padding;return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-body-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-body-padding",`${t}px`),l`<slot></slot>`}};ct.props=["gap","padding","scroll"],ct.styles=[zd],ct.help=void 0;let Eo=ct;E("os-body",Eo);const Md=k`:host{display:grid;grid-template-columns:repeat( 12,minmax( 0,1fr ) );gap:var( --os-ui-row-gap,12px );row-gap:var( --os-ui-row-row-gap,var( --os-ui-row-gap,12px ) );column-gap:var( --os-ui-row-column-gap,var( --os-ui-row-gap,12px ) );width:100%;min-width:0}:host( [ hidden ] ){display:none}::slotted( [ col='1' ] ){grid-column:span 1}::slotted( [ col='2' ] ){grid-column:span 2}::slotted( [ col='3' ] ){grid-column:span 3}::slotted( [ col='4' ] ){grid-column:span 4}::slotted( [ col='5' ] ){grid-column:span 5}::slotted( [ col='6' ] ){grid-column:span 6}::slotted( [ col='7' ] ){grid-column:span 7}::slotted( [ col='8' ] ){grid-column:span 8}::slotted( [ col='9' ] ){grid-column:span 9}::slotted( [ col='10' ] ){grid-column:span 10}::slotted( [ col='11' ] ){grid-column:span 11}::slotted( [ col='12' ] ){grid-column:span 12}::slotted(:not( [ col ] ) ){grid-column:1 / -1}::slotted( * ){min-width:0}`,dt=class dt extends ${render(){const e=this.gap,t=this["column-gap"],o=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-row-gap",`${e}px`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-row-column-gap",`${t}px`),o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-row-row-gap",`${o}px`),l`<slot></slot>`}};dt.props=["gap","column-gap","row-gap"],dt.styles=[Md],dt.help=void 0;let Ao=dt;E("os-row",Ao);const Od=k`:host{display:grid;grid-template-columns:var( --os-ui-grid-columns,1fr );grid-template-rows:var( --os-ui-grid-rows,auto );gap:var( --os-ui-grid-gap,8px );column-gap:var( --os-ui-grid-column-gap,var( --os-ui-grid-gap,8px ) );row-gap:var( --os-ui-grid-row-gap,var( --os-ui-grid-gap,8px ) )}:host( [ hidden ] ){display:none}`,ut=class ut extends ${render(){const e=this.columns,t=this.rows,o=this.gap,i=this["column-gap"],n=this["row-gap"];return e&&/^\d+$/.test(e)&&this.style.setProperty("--os-ui-grid-columns",`repeat(${e}, minmax(0, 1fr))`),t&&/^\d+$/.test(t)&&this.style.setProperty("--os-ui-grid-rows",`repeat(${t}, minmax(0, 1fr))`),o&&/^\d+$/.test(o)&&this.style.setProperty("--os-ui-grid-gap",`${o}px`),i&&/^\d+$/.test(i)&&this.style.setProperty("--os-ui-grid-column-gap",`${i}px`),n&&/^\d+$/.test(n)&&this.style.setProperty("--os-ui-grid-row-gap",`${n}px`),l`<slot></slot>`}};ut.props=["columns","rows","gap","column-gap","row-gap"],ut.styles=[Od],ut.help=void 0;let Co=ut;E("os-grid",Co);const Wd=k`:host{display:flex;align-items:center;justify-content:var( --os-ui-display-align,flex-end );width:100%;min-height:calc( var( --os-ui-display-size,28px ) * 1.4 );padding:8px 14px;box-sizing:border-box;font-size:var( --os-ui-display-size,28px );font-variant-numeric:tabular-nums;font-weight:500;letter-spacing:0.01em;color:var( --os-ui-display-fg,var( --os-ui-fg,#1d2327 ) );background:var( --os-ui-display-bg,transparent );border-radius:var( --os-ui-display-border-radius,0 );line-height:1.1;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}:host( [ hidden ] ){display:none}.os-display__output{display:block;font:inherit;color:inherit;text-align:var( --os-ui-display-align,end );overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0}`,nr={sm:"16px",md:"20px",lg:"28px",xl:"40px"},ht=class ht extends ${connectedCallback(){super.connectedCallback?.(),this.hasAttribute("aria-live")||this.setAttribute("aria-live","polite"),this.hasAttribute("role")||this.setAttribute("role","status")}render(){const e=this.value,t=this.size||"lg",o=this.align||"end";return this.style.setProperty("--os-ui-display-size",nr[t]||nr.lg),this.style.setProperty("--os-ui-display-align",o),l`
			<output part="output" class="os-display__output">
				${e??l`<slot></slot>`}
			</output>
		`}};ht.props=["value","size","align"],ht.styles=[Wd],ht.help=void 0;let So=ht;E("os-display",So);const Hd=k`:host{display:block}:host( [ hidden ] ){display:none}.os-disclosure__summary{display:flex;align-items:center;gap:8px;width:100%;padding:0;background:none;border:0;font:inherit;color:var( --os-ui-fg,#1d2327 );text-align:start;cursor:pointer}.os-disclosure__summary:focus-visible{outline:2px solid var( --os-ui-accent,#f252fc );outline-offset:2px;border-radius:4px}.os-disclosure__heading{flex:1 1 auto;min-width:0;margin:0;font-size:20px;font-weight:500;letter-spacing:-0.01em}.os-disclosure__hint{flex:0 0 auto;font-size:13px;font-weight:400;color:var( --os-ui-fg-muted,#646970 )}.os-disclosure__marker{flex:0 0 auto;width:8px;height:8px;margin-inline-end:2px;border-inline-end:2px solid currentColor;border-block-end:2px solid currentColor;transform:rotate( -45deg );transition:transform 160ms ease;opacity:0.7}:host( [ open ] ) .os-disclosure__marker{transform:rotate( 45deg )}@media ( prefers-reduced-motion:reduce ){.os-disclosure__marker{transition:none}}.os-disclosure__body{margin-block-start:14px}.os-disclosure__body[ hidden ]{display:none}`;let Ud=0;const pt=class pt extends ${constructor(){super(...arguments),this.bodyId=`os-disclosure-body-${++Ud}`,this.onToggle=()=>{const e=!this.isOpen();e?this.setAttribute("open",""):this.removeAttribute("open"),this.emit("os-disclosure-toggle",{open:e})}}isOpen(){return this.hasAttribute("open")}render(){const e=this.heading||"",t=this.hint||"",o=this.isOpen();return l`
			<button
				type="button"
			...
			>
				...
				<h3 class="os-disclosure__heading">${e}</h3>
				${t?l`<span class="os-disclosure__hint">${t}</span>`:""}
			</button>
			<div
				id=${this.bodyId}
		...
		`}};pt.props=["heading","hint","open"],pt.styles=[Hd],pt.help=void 0;let Lo=pt;E("os-disclosure",Lo);const qd=k` ${I} ${Ut} ${qt} ${ps}:host{display:inline-flex;user-select:none}:host( [ fill-cell ] ),:host{display:flex;width:100%}:host( [ hidden ] ){display:none}button{width:100%;min-height:var( --os-ui-key-min-height,48px );appearance:none;display:inline-flex;align-items:center;justify-content:center;padding:var( --os-ui-key-padding,8px 12px );font:inherit;font-size:var( --os-ui-key-font-size,16px );font-weight:500;cursor:pointer;border-radius:var( --os-ui-key-border-radius,8px );background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.06 ) ) );color:var( --os-ui-key-fg,var( --os-ui-fg,#1d2327 ) );border:var( --os-ui-key-border,1px solid transparent );transition:transform 0.08s ease,background-color 0.12s ease,box-shadow 0.12s ease}button:hover:not(:disabled ){background:var( --os-ui-key-bg-hover,var( --os-ui-hover,rgba( 0,0,0,0.1 ) ) )}button:focus-visible{outline:none;box-shadow:var( --_holo-focus )}button:disabled::before{opacity:0 !important}:host( [ variant='primary' ] ) button{background:var( --os-ui-key-bg,var( --wp-admin-theme-color,#2271b1 ) );color:var( --os-ui-key-fg,var( --os-ui-fg-on-accent,#fff ) )}:host( [ variant='primary' ] ) button:hover:not(:disabled ){filter:brightness( 1.06 )}:host( [ variant='secondary' ] ) button{background:var( --os-ui-key-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) )}:host( [ variant='ghost' ] ) button{background:transparent;border:var( --os-ui-key-border,1px solid var( --os-ui-border,#c3c4c7 ) )}:host( [ variant='danger' ] ) button{background:transparent;color:var( --os-ui-danger,#d63638 );border:1px solid currentColor}:host( .os-key--pressed ) button,button:active:not(:disabled ){transform:scale( 0.96 );box-shadow:inset 0 1px 2px rgba( 0,0,0,0.22 );background:var( --os-ui-key-bg-pressed,var( --os-ui-hover,rgba( 0,0,0,0.14 ) ) )}button:disabled{opacity:0.5;cursor:not-allowed}`,os="os-key--pressed",ft=class ft extends ${constructor(){super(...arguments),this._onKeyDown=null,this._onKeyUp=null,this._keyHeldByKeyboard=!1}connectedCallback(){super.connectedCallback?.(),this._onKeyDown=e=>this.handleKeyboardDown(e),this._onKeyUp=e=>this.handleKeyboardUp(e),document.addEventListener("keydown",this._onKeyDown),document.addEventListener("keyup",this._onKeyUp)}disconnectedCallback(){this._onKeyDown&&document.removeEventListener("keydown",this._onKeyDown),this._onKeyUp&&document.removeEventListener("keyup",this._onKeyUp)}render(){const e=this.label,t=this.disabled!==null;return l`
			<button
				part="button"
				class="os-holo-sheen"
				type="button"
			...
			<span class="os-tag-input__chips" role="list">
				${o.map((i,n)=>{const r=i.tone??"neutral";return l`
						<os-chip
							...
							?disabled=${t}
							?pending=${!!i.pending}
							tabindex=${n===this._focusedChip?"0":"-1"}
							data-idx=${String(n)}
							@os-chip-dismiss=${a=>this._onChipDismiss(a,i)}
							@focus=${()=>this._focusedChip=n}
						></os-chip>
					`})}
			</span>
		`}_renderTrigger(e){const t=this.disabled!==null;return l`
			<button
				type="button"
		...
		`}_renderEditor(e,t){const o=this._suggestions.length>0||this._suggestionsLoading||t&&this._query.trim().length>0;return l`
			<span class="os-tag-input__editor">
				<input
					...
					@input=${i=>this._onInput(i)}
					@keydown=${i=>this._onInputKeyDown(i)}
					@blur=${i=>this._onInputBlur(i)}
				/>
				${o?this._renderSuggestions(t):l``}
			</span>
		`}_renderSuggestions(e){const t=this._query.trim(),o=this._suggestions,i=e&&t.length>0&&!o.some(n=>n.label.toLowerCase()===t.toLowerCase())&&!this._value.some(n=>n.label.toLowerCase()===t.toLowerCase());return l`
			<div
				class="os-tag-input__suggestions"
				role="listbox"
			>
				${this._suggestionsLoading?l`
							<div class="os-tag-input__suggestion-loading">
								<span class="os-tag-input__suggestion-spinner" aria-hidden="true"></span>
								<span>Searching…</span>
							</div>
					  `:l``}
				${o.length===0&&!this._suggestionsLoading&&!i?l`
							<div class="os-tag-input__suggestion-empty">
								${t.length>0?"No matches.":"Type to search."}
							</div>
					  `:l``}
				${o.map((n,r)=>{const a=r===this._highlight;return l`
						<div
							id=${`os-tag-suggestion-${r}`}
							role="option"
							aria-selected=${a?"true":"false"}
							class="os-tag-input__suggestion-item"
							@mousedown=${c=>{c.preventDefault(),this._addSuggestion(n,!1)}}
				...
				${i?l`
							<div
								...
								@mousedown=${n=>{n.preventDefault(),this._addSuggestion({label:t},!0)}}
		...
		`}_onChipDismiss(e,t){e.stopPropagation(),this.emit("os-tag-remove",{tag:t})}_onInput(e){const t=e.target.value;this._query=t,this._emitSuggest(t)}_emitSuggest(e){const t=parseInt(this["min-query"]||"0",10)||0;if(e.length<t){this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate();return}this._suggestionsLoading=!0,this.requestUpdate(),this.emit("os-tag-suggest",{query:e})}_onInputKeyDown(e){const t=this.creatable!==null,o=this._suggestions,i=this._query.trim(),n=t&&i.length>0&&!o.some(a=>a.label.toLowerCase()===i.toLowerCase())&&!this._value.some(a=>a.label.toLowerCase()===i.toLowerCase()),r=o.length+(n?1:0);switch(e.key){case"ArrowDown":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight+1>=r?0:this._highlight+1,this.requestUpdate();return}case"ArrowUp":{if(r===0)return;e.preventDefault(),this._highlight=this._highlight<=0?r-1:this._highlight-1,this.requestUpdate();return}case"Enter":{if(e.preventDefault(),this._highlight>=0&&this._highlight<o.length){this._addSuggestion(o[this._highlight],!1);return}if(this._highlight===o.length&&n){this._addSuggestion({label:i},!0);return}if(n&&i.length>0){this._addSuggestion({label:i},!0);return}return}case"Escape":{e.preventDefault(),this.closeInput();return}case"Backspace":{if(this._query===""&&this._value.length>0){e.preventDefault();const a=this._value.length-1;this._focusedChip===a?(this.emit("os-tag-remove",{tag:this._value[a]}),this._focusedChip=-1):(this._focusedChip=a,this.requestUpdate())}return}default:this._focusedChip!==-1&&(this._focusedChip=-1)}}_onInputBlur(e){queueMicrotask(()=>{this.shadowRoot?.activeElement||this.closeInput()})}_addSuggestion(e,t){if(this._value.some(i=>i.label.toLowerCase()===e.label.toLowerCase())){this._query="",this._highlight=-1,this._suggestions=[],this.requestUpdate(),this._input?.focus();return}this.emit("os-tag-add",{tag:e,isNew:t}),this._query="",this._highlight=-1,this._suggestions=[],this._suggestionsLoading=!1,this.requestUpdate(),queueMicrotask(()=>{this._input?.focus()})}};Ct.props=["label","placeholder","add-label","creatable","removable","disabled","readonly","size","min-query","open"],Ct.styles=[bu],Ct.help=void 0;let Ko=Ct;E("os-tag-input",Ko);function mu(){return P("plus",{size:14})}const vu=k`:host{display:block;container-type:inline-size;container-name:os-form;font-size:13px;color:var( --os-ui-fg,#1d2327 )}:host( [ hidden ] ){display:none}.header{margin:0 0 18px}.header:empty{display:none}.fields{display:grid;grid-template-columns:1fr;gap:14px 16px;margin:0 0 18px}@container os-form ( min-width:480px ){.fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}}@container os-form ( min-width:760px ){:host( [ columns="3" ] ) .fields{grid-template-columns:repeat( 3,minmax( 0,1fr ) )}}:host( [ columns="1" ] ) .fields{grid-template-columns:1fr}:host( [ columns="2" ] ) .fields{grid-template-columns:repeat( 2,minmax( 0,1fr ) )}::slotted( [ full-width ] ){grid-column:1 / -1}::slotted( [ slot ] ){display:contents}.error{margin:0 0 14px;padding:10px 12px;border-radius:6px;background:var( --os-ui-notice-error-bg,rgba( 179,45,46,0.10 ) );color:var( --os-ui-danger-hover,#b32d2e );font-size:13px;line-height:1.4}.error[ hidden ]{display:none}.footer{display:flex;flex-wrap:wrap;gap:8px;align-items:center;justify-content:flex-end;border-top:1px solid var( --os-ui-border,#dcdcde );padding-top:14px}:host( [ align="start" ] ) .footer{justify-content:flex-start}:host( [ align="stretch" ] ) .footer{justify-content:stretch}:host( [ align="stretch" ] ) .footer .footer-actions{flex:1 1 auto}.footer-leading,.footer-trailing{display:contents}.footer-actions{display:inline-flex;gap:8px;align-items:center;margin-inline-start:auto}:host( [ align="start" ] ) .footer-actions{margin-inline-start:0}:host( [ busy ] ){pointer-events:none}:host( [ busy ] ) .fields{opacity:0.6}:host( [ busy ] ) .footer{pointer-events:auto}.busy-spinner{display:inline-flex;width:14px;height:14px;border-radius:50%;border:2px solid currentColor;border-right-color:transparent;animation:os-form-spin 0.7s linear infinite;vertical-align:-2px;margin-inline-end:6px}@keyframes os-form-spin{to{transform:rotate( 360deg )}}@media ( prefers-reduced-motion:reduce ){.busy-spinner{animation-duration:2s}}`,St=class St extends ${constructor(){super(...arguments),this._initial=new Map,this._captured=!1,this._fieldChangeListener=null,this._enterSubmitListener=null}connectedCallback(){super.connectedCallback(),queueMicrotask(()=>this._captureInitialValues()),this._fieldChangeListener=e=>this._onAnyFieldInput(e),this.addEventListener("os-input-change",this._fieldChangeListener),this.addEventListener("os-input-commit",this._fieldChangeListener),this.addEventListener("os-checkbox-change",this._fieldChangeListener),this.addEventListener("os-select-change",this._fieldChangeListener),this.addEventListener("change",this._fieldChangeListener),this._enterSubmitListener=()=>this.submit(),this.addEventListener("os-submit",this._enterSubmitListener)}disconnectedCallback(){this._fieldChangeListener&&(this.removeEventListener("os-input-change",this._fieldChangeListener),this.removeEventListener("os-input-commit",this._fieldChangeListener),this.removeEventListener("os-checkbox-change",this._fieldChangeListener),this.removeEventListener("os-select-change",this._fieldChangeListener),this.removeEventListener("change",this._fieldChangeListener),this._fieldChangeListener=null),this._enterSubmitListener&&(this.removeEventListener("os-submit",this._enterSubmitListener),this._enterSubmitListener=null)}render(){const e=this["submit-label"]||"Submit",t=this["reset-label"]||"Reset",o=this.error||"",i=this.busy!==null,r=this["show-reset"]!=="false";return l`
			...
			<slot name="error">
				${o?l`<p class="error" role="alert" part="error">${o}</p>`:l`<p class="error" role="alert" part="error" hidden></p>`}
			</slot>
			<footer class="footer" part="footer">
				...
				<span class="footer-actions">
					...
					<os-button
						...
						@click=${()=>this.submit()}
					>
						${i?l`<span class="busy-spinner" aria-hidden="true"></span>`:l``}
						${e}
					</os-button>
				</span>
		...
		`}getValues(){const e={};for(const t of this._namedFields()){const o=t.getAttribute("name");o&&(e[o]=this._readField(t))}return e}setValues(e){for(const[t,o]of Object.entries(e)){const i=this._fieldByName(t);i&&this._writeField(i,o)}}setBusy(e){e?this.setAttribute("busy",""):this.removeAttribute("busy")}setError(e){e?this.setAttribute("error",e):this.removeAttribute("error")}setFieldInvalid(e,t=!0,o=null){const i=this._fieldByName(e);i&&(t?(i.setAttribute("invalid",""),o!==null&&i.setAttribute("error",o)):(i.removeAttribute("invalid"),i.removeAttribute("error")))}clearErrors(){this.setError(null);for(const e of this._namedFields())e.removeAttribute("invalid"),e.removeAttribute("error")}reset(){this.clearErrors();for(const[e,t]of this._initial.entries()){const o=this._fieldByName(e);if(o){if(t.checked!==null){o.checked=t.checked,t.checked?o.setAttribute("checked",""):o.removeAttribute("checked");continue}this._writeField(o,t.value)}}this.dispatchEvent(new CustomEvent("os-form-reset",{bubbles:!0,composed:!0,detail:{form:this}}))}submit(){const e=[];for(const i of this._namedFields()){const n=i.getAttribute("name");if(!n||!i.hasAttribute("required"))continue;const a=this._readField(i);if(a==null||a===""||Array.isArray(a)&&a.length===0){i.setAttribute("invalid","");const u=i.getAttribute("label");e.push(u||n)}}if(e.length>0){const i=e.join(", ");this.setError(`Required: ${i}`);return}const t=this.getValues(),o=new CustomEvent("os-form-submit",{bubbles:!0,composed:!0,cancelable:!0,detail:{values:t,form:this}});this.dispatchEvent(o)}_captureInitialValues(){if(this._captured)return;const e=this._namedFields();if(e.length!==0){for(const t of e){const o=t.getAttribute("name");if(!o)continue;const i=t.tagName==="OS-CHECKBOX"||t.tagName==="OS-CHECKBOX-LABEL"||t.tagName==="INPUT"&&t.type==="checkbox";this._initial.set(o,{value:this._readField(t),checked:i?!!t.checked:null})}this._captured=!0}}_namedFields(){return Array.from(this.querySelectorAll("[name]"))}_fieldByName(e){const t=typeof CSS<"u"&&typeof CSS.escape=="function"?CSS.escape(e):e.replace(/["\\]/g,"\\$&");return this.querySelector(`[name="${t}"]`)}_readField(e){const t=e.tagName.toUpperCase();return t==="OS-CHECKBOX"||t==="OS-CHECKBOX-LABEL"||t==="INPUT"&&e.type==="checkbox"?typeof e.checked=="boolean"?e.checked:e.hasAttribute("checked"):e.value!==void 0&&e.value!==null?e.value:e.getAttribute("value")??""}_writeField(e,t){const o=e.tagName.toUpperCase();if(o==="OS-CHECKBOX"||o==="OS-CHECKBOX-LABEL"||o==="INPUT"&&e.type==="checkbox"){const r=!!t;e.checked=r,r?e.setAttribute("checked",""):e.removeAttribute("checked");return}const n=t==null?"":String(t);e.value=n,e.setAttribute("value",n)}_onAnyFieldInput(e){const t=e.target;if(!t)return;const o=t.getAttribute?.("name");o&&(this.dispatchEvent(new CustomEvent("os-form-input",{bubbles:!0,composed:!0,detail:{name:o,value:this._readField(t),form:this}})),t.hasAttribute("invalid")&&t.removeAttribute("invalid"))}};St.props=["submit-label","reset-label","error","busy","columns","min-column","show-reset","align"],St.styles=[vu],St.help=void 0;let Bo=St;E("os-form",Bo);const _u=k`:host{display:inline-flex;align-items:center;gap:6px;font-size:var( --os-ui-save-status-font-size,11px );line-height:1;color:var( --os-ui-save-status-fg,currentColor );vertical-align:middle;min-width:0;opacity:1;pointer-events:auto}.os-save-status__indicator{display:inline-flex;align-items:center;justify-content:center;width:var( --os-ui-save-status-size,12px );height:var( --os-ui-save-status-size,12px );border-radius:50%;flex-shrink:0;box-sizing:border-box;background:var( --os-ui-save-status-bg,transparent );border:2px solid var( --os-ui-save-status-idle-color,color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 55%,transparent ) );color:var( --wp-admin-theme-color,#2271b1 );transition:background-color 0.2s ease,border-color 0.2s ease,box-shadow 0.2s ease}:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-pulse 1.2s ease-in-out infinite}:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;color:var( --wp-admin-theme-color,#2271b1 );animation:os-save-status-modem-stutter 1.8s ease-in-out infinite,os-save-status-modem-glow 2.4s ease-in-out infinite}@keyframes os-save-status-modem-stutter{0%,4%{opacity:1}5%,30%{opacity:0.22}31%,36%{opacity:1}37%,39%{opacity:0.22}40%,44%{opacity:1}45%,67%{opacity:0.22}68%,76%{opacity:1}77%,100%{opacity:0.22}}@keyframes os-save-status-modem-glow{0%,12%{box-shadow:0 0 0 0 transparent}13%,22%{box-shadow:0 0 4px 0 currentColor}23%,50%{box-shadow:0 0 0 0 transparent}51%,58%{box-shadow:0 0 4px 0 currentColor}59%,84%{box-shadow:0 0 0 0 transparent}85%,94%{box-shadow:0 0 5px 0 currentColor}95%,100%{box-shadow:0 0 0 0 transparent}}@media ( prefers-reduced-motion:reduce ){:host( [ phase='pending' ] ) .os-save-status__indicator,:host( [ phase='saving' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ animation='modem' ][ phase='saving' ] ) .os-save-status__indicator{animation:none;opacity:0.85}}:host( [ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) );border-color:transparent;color:var( --os-ui-save-status-saved-bg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ phase='failed' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );border-color:transparent;color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-pulse 0.8s ease-in-out 2}:host( [ variant='ring' ] ) .os-save-status__indicator{background:transparent}:host( [ variant='ring' ][ phase='pending' ] ) .os-save-status__indicator,:host( [ variant='ring' ][ phase='saving' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-ring-color,var( --os-ui-save-status-bg,var( --wp-admin-theme-color,#2271b1 ) ) );animation:os-save-status-ring-pulse 1.6s var( --os-ui-ease-loop,ease-in-out ) infinite}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__indicator{background:transparent;border-color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) );animation:os-save-status-ring-alert 0.62s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{color:var( --os-ui-save-status-failed-bg,var( --os-ui-danger,#d63638 ) )}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__indicator{background:var( --os-ui-save-status-saved-bg,var( --wp-admin-theme-color,#2271b1 ) );border-color:transparent;animation:os-save-status-ring-land 0.42s var( --os-ui-ease-out,ease-out ) 1}:host( [ variant='ring' ][ phase='saved' ] ) .os-save-status__glyph,:host( [ variant='ring' ][ phase='failed' ] ) .os-save-status__glyph{animation:os-save-status-glyph-in 0.24s var( --os-ui-ease-out,ease-out ) 0.08s 1 backwards}@keyframes os-save-status-ring-pulse{0%,100%{opacity:0.45;scale:0.9}50%{opacity:1;scale:1}}@keyframes os-save-status-ring-land{0%{scale:0.82}55%{scale:1.06}100%{scale:1}}@keyframes os-save-status-ring-alert{0%{scale:0.9}25%{scale:1.08}50%{scale:0.98}75%{scale:1.04}100%{scale:1}}@keyframes os-save-status-glyph-in{0%{opacity:0;scale:0.4}100%{opacity:1;scale:1}}@media ( prefers-reduced-motion:reduce ){:host( [ variant='ring' ] ) .os-save-status__indicator,:host( [ variant='ring' ] ) .os-save-status__glyph{animation:none;opacity:1;scale:1}}@keyframes os-save-status-pulse{0%,100%{opacity:0.55;transform:scale( 0.9 )}50%{opacity:1;transform:scale( 1 )}}:host( [ mode='pill' ] ) .os-save-status{display:inline-flex;align-items:center;gap:6px;padding:2px 10px;border-radius:999px;background:var( --os-ui-save-status-pill-bg,transparent );font-weight:500;white-space:nowrap}:host( [ mode='pill' ][ phase='saving' ] ) .os-save-status,:host( [ mode='pill' ][ phase='pending' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,var( --os-ui-hover,rgba( 0,0,0,0.04 ) ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-fg-muted,#50575e ) )}:host( [ mode='pill' ][ phase='saved' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 30,132,73,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-success-fg,#1d6f42 ) )}:host( [ mode='pill' ][ phase='failed' ] ) .os-save-status{background:var( --os-ui-save-status-pill-bg,rgba( 214,54,56,0.12 ) );color:var( --os-ui-save-status-pill-fg,var( --os-ui-danger-hover,#a02622 ) )}.os-save-status__label{min-width:0;max-width:200px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}:host( [ phase='saved' ] ) .os-save-status__glyph,:host( [ phase='failed' ] ) .os-save-status__glyph{display:inline-block;color:var( --os-ui-fg-on-accent,#fff );width:calc( var( --os-ui-save-status-size,12px ) * 0.66 );height:calc( var( --os-ui-save-status-size,12px ) * 0.66 )}.os-save-status__glyph{display:none}.os-save-status__glyph svg{display:block;width:100%;height:100%}`,mr="os-settings-save-lifecycle",yu=2200,wu=6e3,Lt=class Lt extends ${constructor(){super(...arguments),this._autoTimer=null,this._docListener=null}connectedCallback(){super.connectedCallback(),this.auto!==null&&this._installAutoListener()}disconnectedCallback(){this._removeAutoListener(),this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null)}attributeChangedCallback(e,t,o){if(super.attributeChangedCallback(e,t,o),(e==="auto"||e==="event")&&(this._removeAutoListener(),this.auto!==null&&this._installAutoListener()),e==="phase"){this._scheduleAutoClear();const i={phase:this.phase??"idle",error:this.error??void 0};this.emit("os-save-status-change",i)}}render(){const e=this.phase??"idle",t=this.mode??"dot",i=(this.error??"")||this._labelForPhase(e);return i?this.setAttribute("title",i):this.removeAttribute("title"),this.setAttribute("aria-live",e==="failed"?"assertive":"polite"),this.setAttribute("role",e==="failed"?"alert":"status"),l`
			<span class="os-save-status">
				...
				${t==="pill"?l`<span class="os-save-status__label"
							>${this._labelForPhase(e)}</span
					  >`:l``}
			</span>
		`}_renderGlyph(e){return e==="saved"?ku():e==="failed"?xu():""}_labelForPhase(e){switch(e){case"pending":case"saving":return this["saving-label"]??"Saving…";case"saved":return this["saved-label"]??"Saved";case"failed":return(this.error??"")||"Couldn’t save";default:return this["idle-label"]??""}}_installAutoListener(){const e=this.event||mr;this._docListener=t=>{const o=t.detail;!o||typeof o.phase!="string"||(this.phase=o.phase,o.error?this.error=o.error:o.phase!=="failed"&&this.error&&this.removeAttribute("error"))},document.addEventListener(e,this._docListener)}_removeAutoListener(){if(!this._docListener)return;const e=this.event||mr;document.removeEventListener(e,this._docListener),this._docListener=null}_scheduleAutoClear(){this._autoTimer!==null&&(window.clearTimeout(this._autoTimer),this._autoTimer=null);const e=this.phase??"idle",t=this._autoClearMsFor(e);t<=0||(this._autoTimer=window.setTimeout(()=>{this._autoTimer=null,this.phase="idle"},t))}_autoClearMsFor(e){if(e==="saved"){const t=this["auto-clear-saved-ms"];return parseInt(t||"",10)||yu}if(e==="failed"){const t=this["auto-clear-failed-ms"];return parseInt(t||"",10)||wu}return 0}};Lt.props=["phase","mode","variant","animation","auto","event","error","saving-label","saved-label","idle-label","auto-clear-saved-ms","auto-clear-failed-ms"],Lt.styles=[_u],Lt.help=void 0;let Go=Lt;E("os-save-status",Go);function ku(){return l`
		<svg
			viewBox="0 0 12 12"
			aria-hidden="true"
			focusable="false"
	...
	`}const $u=k`:host{display:flex;width:100%;min-width:0;max-width:100%;align-items:stretch}.os-cat{display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:var( --os-ui-cat-padding,2px );min-height:24px;max-width:100%;width:100%}.os-cat__chips{display:inline-flex;flex-wrap:wrap;align-items:center;gap:var( --os-ui-cat-gap,4px );min-width:0}.os-cat__chains{display:flex;flex-wrap:wrap;gap:4px;min-width:0}.os-cat__viz-host{display:flex;align-items:center;gap:4px;min-width:0;flex:1 1 auto;max-width:100%;min-height:28px;cursor:pointer;position:relative}.os-cat__viz-svg{display:block;width:100%;max-width:100%;min-width:0;overflow:visible;flex:1 1 auto}.os-cat__viz-svg .os-cat-edge{fill:none;stroke:var( --os-ui-cat-edge-color,currentColor );stroke-width:1.25;stroke-linecap:round;opacity:0.55;transition:stroke-width 0.18s ease,opacity 0.18s ease}.os-cat__viz-svg .os-cat-edge[ data-active='true' ]{stroke-width:2;opacity:1}.os-cat__viz-svg .os-cat-node{cursor:pointer;transition:r 0.2s cubic-bezier( 0.34,1.56,0.64,1 ),fill 0.18s ease,stroke-width 0.18s ease,filter 0.18s ease}.os-cat__viz-svg .os-cat-node[ data-selected='true' ]{filter:drop-shadow( 0 0 6px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.18 ) ) )}.os-cat__viz-svg .os-cat-node:hover,.os-cat__viz-svg .os-cat-node:focus-visible{filter:drop-shadow( 0 0 8px var( --os-ui-cat-node-glow,rgba( 0,0,0,0.3 ) ) );outline:none}.os-cat__viz-svg .os-cat-label{font-family:var( --os-ui-font,system-ui,sans-serif );font-size:10.5px;fill:var( --os-ui-cat-label-fg,var( --os-ui-fg,#1d2327 ) );font-weight:500;pointer-events:none;user-select:none}.os-cat__viz-svg .os-cat-label[ data-selected='false' ]{fill:var( --os-ui-cat-label-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-weight:400;font-style:italic}.os-cat__trigger{appearance:none;display:inline-flex;align-items:center;gap:4px;padding:1px 8px;min-height:22px;font:inherit;font-size:11px;font-weight:500;line-height:1;color:var( --os-ui-cat-trigger-fg,var( --os-ui-fg-muted,#50575e ) );background:transparent;border:1px dashed var( --os-ui-cat-trigger-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease,border-color 0.12s ease}.os-cat__trigger:hover:not(:disabled ){background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) );color:var( --os-ui-cat-trigger-fg-hover,var( --os-ui-fg,#1d2327 ) );border-color:var( --os-ui-cat-trigger-border-hover,var( --os-ui-border-strong,#8c8f94 ) )}.os-cat__trigger:focus-visible{outline:none;border-style:solid;box-shadow:0 0 0 2px var( --wp-admin-theme-color,#2271b1 )}.os-cat__trigger svg{display:block}.os-cat__uncategorized{display:inline-flex;align-items:center;gap:4px;padding:1px 10px;min-height:22px;font-size:11px;font-weight:500;line-height:1.6;color:var( --os-ui-cat-uncat-fg,var( --os-ui-fg-muted,#8c8f94 ) );background:transparent;border:1px dashed var( --os-ui-cat-uncat-border,var( --os-ui-border,#c3c4c7 ) );border-radius:999px;font-style:italic}.os-cat__popover{position:fixed;top:0;left:0;min-width:280px;max-width:360px;max-height:360px;display:flex;flex-direction:column;background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );color:var( --os-ui-cat-pop-fg,var( --os-ui-fg,#1d2327 ) );border:1px solid var( --os-ui-cat-pop-border,var( --os-ui-border,#c3c4c7 ) );border-radius:8px;box-shadow:0 6px 16px rgba( 0,0,0,0.08 ),0 1px 2px rgba( 0,0,0,0.06 );z-index:1000}.os-cat__editor{position:relative;display:inline-flex;align-items:center}.os-cat__search{appearance:none;font:inherit;font-size:13px;padding:8px 12px;border:0;border-bottom:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );background:transparent;color:inherit;outline:none}.os-cat__search:focus{border-bottom-color:var( --wp-admin-theme-color,#2271b1 )}.os-cat__tree{flex:1 1 auto;min-height:0;overflow-y:auto;padding:4px 0}.os-cat__row-block{display:contents}.os-cat__row{display:flex;align-items:center;gap:6px;padding:4px 8px 4px var( --os-ui-cat-row-indent,12px );cursor:pointer;user-select:none;font-size:13px;line-height:1.4;position:relative}.os-cat__row:hover,.os-cat__row[ data-focused='true' ]{background:var( --os-ui-hover,rgba( 0,0,0,0.04 ) )}.os-cat__row[ data-selected='true' ]{color:var( --wp-admin-theme-color,#2271b1 );font-weight:600}.os-cat__row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__expander{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;border:0;background:transparent;color:inherit;cursor:pointer;flex-shrink:0;opacity:0.65}.os-cat__expander:hover{opacity:1}.os-cat__expander svg{display:block;transition:transform 0.12s ease}.os-cat__row[ data-expanded='true' ] .os-cat__expander svg{transform:rotate( 90deg )}.os-cat__expander--placeholder{visibility:hidden}.os-cat__create-row{display:flex;align-items:center;padding:2px 8px 2px var( --os-ui-cat-row-indent,28px );position:relative}.os-cat__create-row::before{content:'';position:absolute;left:0;top:0;bottom:0;width:var( --os-ui-cat-guide-width,0px );border-left:1px dotted var( --os-ui-cat-guide-color,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) )}.os-cat__create-wrap{display:inline-flex;align-items:center;flex:1 1 auto;min-width:0;gap:4px;padding:1px 1px 1px 0;border:1px solid transparent;border-radius:6px;background:transparent;transition:border-color 0.12s ease,background-color 0.12s ease,box-shadow 0.12s ease}.os-cat__create-wrap:hover{border-color:var( --os-ui-border,rgba( 0,0,0,0.12 ) );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) )}.os-cat__create-wrap:focus-within{border-color:var( --wp-admin-theme-color,#2271b1 );background:var( --os-ui-cat-pop-bg,var( --os-ui-surface,#fff ) );box-shadow:0 0 0 2px color-mix( in srgb,var( --wp-admin-theme-color,#2271b1 ) 15%,transparent )}.os-cat__create-input{flex:1 1 auto;min-width:0;appearance:none;font:inherit;font-size:12px;padding:3px 6px;border:0;background:transparent;color:inherit;outline:none}.os-cat__create-input::placeholder{color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );font-style:italic;opacity:1}.os-cat__create-submit{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;flex-shrink:0;padding:0;border:0;border-radius:4px;background:transparent;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#8c8f94 ) );cursor:pointer;transition:background-color 0.12s ease,color 0.12s ease}.os-cat__create-wrap:focus-within .os-cat__create-submit:not( [ disabled ] ){background:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__create-submit:hover:not( [ disabled ] ){filter:brightness( 1.05 )}.os-cat__create-submit[ disabled ]{cursor:default;opacity:0.5}.os-cat__create-submit svg{display:block}.os-cat__create-spinner{display:inline-block;width:12px;height:12px;margin:0 4px;border-radius:50%;border:2px solid var( --wp-admin-theme-color,#2271b1 );border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;flex-shrink:0}.os-cat__check{display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;border:1.5px solid var( --os-ui-cat-check-border,var( --os-ui-border,#8c8f94 ) );border-radius:3px;color:transparent;transition:background-color 0.12s ease,border-color 0.12s ease,color 0.12s ease}.os-cat__row[ data-selected='true' ] .os-cat__check{background:var( --wp-admin-theme-color,#2271b1 );border-color:var( --wp-admin-theme-color,#2271b1 );color:var( --os-ui-fg-on-accent,#fff )}.os-cat__check svg{display:block;width:14px;height:14px}.os-cat__label{min-width:0;flex:1 1 auto;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.os-cat__delete{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;width:18px;height:18px;border:0;border-radius:50%;padding:0;background:transparent;color:var( --os-ui-cat-delete-color,var( --os-ui-danger,#d63638 ) );cursor:pointer;opacity:0;transition:opacity 0.12s ease,background-color 0.12s ease}.os-cat__row:hover .os-cat__delete,.os-cat__row[ data-focused='true' ] .os-cat__delete,.os-cat__delete:focus-visible{opacity:1}.os-cat__delete:hover,.os-cat__delete:focus-visible{background:var( --os-ui-badge-danger-bg,rgba( 214,54,56,0.12 ) )}.os-cat__delete svg{display:block;width:14px;height:14px}.os-cat__match{background:var( --os-ui-search-highlight-bg,rgba( 252,211,77,0.45 ) );border-radius:2px;padding:0 1px}.os-cat__empty,.os-cat__loading{padding:12px;font-size:12px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );text-align:center}.os-cat__loading-spinner{display:inline-block;width:12px;height:12px;border-radius:50%;border:2px solid currentColor;border-top-color:transparent;animation:os-cat-spin 0.8s linear infinite;margin-inline-end:8px;vertical-align:middle}@keyframes os-cat-spin{to{transform:rotate( 360deg )}}.os-cat__footer{padding:8px 12px;font-size:11px;color:var( --os-ui-cat-pop-muted,var( --os-ui-fg-muted,#646970 ) );border-top:1px solid var( --os-ui-cat-pop-divider,var( --os-ui-border,#f0f0f1 ) );border-radius:10px;background:var( --os-ui-cat-pop-footer-bg,var( --os-ui-surface,#fafafb ) );display:flex;align-items:center;gap:6px;line-height:1.4}.os-cat__footer .dashicons{font-size:14px;width:14px;height:14px;flex-shrink:0}:host( [ disabled ] ) .os-cat{opacity:0.6;pointer-events:none}`,G="10px",Eu=k`:host{display:inline-flex;max-width:100%;align-items:center;min-width:0;font-family:var( --os-ui-font,system-ui,sans-serif );font-size:12px;line-height:1;font-weight:500}.os-crumb-chain{display:inline-flex;flex-wrap:nowrap;align-items:stretch;max-width:100%;min-width:0;min-height:22px;border-radius:999px;overflow:hidden;filter:drop-shadow( 0 1px 1px rgba( 0,0,0,0.06 ) )}.os-crumb{display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:22px;padding:2px 12px;background:var( --os-ui-crumb-bg,var( --os-ui-surface,#c3c4c7 ) );color:var( --os-ui-crumb-fg,var( --os-ui-fg,#1d2327 ) );text-align:center;min-width:0;max-width:100%;flex-shrink:1;font-size:12px;font-weight:500;letter-spacing:0.01em;white-space:nowrap;cursor:grab;transition:filter 0.15s ease,transform 0.15s ease,background-color 0.12s ease}.os-crumb:active{cursor:grabbing}.os-crumb:hover{filter:brightness( 1.06 )}.os-crumb__remove{cursor:pointer}.os-crumb--first{padding-inline-end:22px;clip-path:polygon( 0 0,calc( 100% - ${G} ) 0,100% 50%,calc( 100% - ${G} ) 100%,0 100% )}.os-crumb--middle{padding-inline:22px;margin-inline-start:calc( -1 * ${G} );clip-path:polygon( ${G} 0,calc( 100% - ${G} ) 0,100% 50%,calc( 100% - ${G} ) 100%,${G} 100%,0 50% )}.os-crumb--last{padding-inline-start:22px;padding-inline-end:14px;margin-inline-start:calc( -1 * ${G} );clip-path:polygon( ${G} 0,100% 0,100% 100%,${G} 100%,0 50% )}.os-crumb--solo{padding:2px 12px;border-radius:999px}.os-crumb__label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;line-height:1.4}.os-crumb__remove{appearance:none;display:inline-flex;align-items:center;justify-content:center;width:14px;height:14px;flex-shrink:0;padding:0;border:0;border-radius:50%;background:transparent;color:inherit;cursor:pointer;opacity:0.65;transition:opacity 0.12s ease,background-color 0.12s ease,transform 0.12s ease}.os-crumb__remove:hover,.os-crumb__remove:focus-visible{opacity:1;background:var( --os-ui-scrim,rgba( 0,0,0,0.22 ) );outline:none;transform:scale( 1.1 )}.os-crumb__remove svg{display:block;width:100%;height:100%}.os-crumb-chain:hover{filter:drop-shadow( 0 2px 3px rgba( 0,0,0,0.12 ) )}:host( [ disabled ] ) .os-crumb-chain{opacity:0.55;pointer-events:none}`,Rt=class Rt extends ${constructor(){super(...arguments),this._segments=[]}get segments(){return this._segments}set segments(e){this._segments=Array.isArray(e)?e.slice():[],this.requestUpdate()}render(){const e=this.removable!==null,t=this._segments;return t.length===0?l``:l`
		...
		`}_renderChipRow(e,t,o,i){const n=this._selectedItemsInOrder();if(n.length===0)return l`
			...
			`;const r=this._buildChains(n);return l`
			<div
				class="os-cat__chains"
				role="list"
				@click=${this._onCellClick}
			>
				${r.map(a=>this._renderChain(a,t,o))}
			</div>
		`}_buildChains(e){const t=new Map;for(const a of this._items)t.set(a.id,a);const o=new Set(e.map(a=>a.id)),i=a=>{for(const c of o){if(c===a)continue;let u=t.get(c),h=16;for(;u&&h-- >0;){if(u.parent===a)return!0;if(!u.parent)break;u=t.get(u.parent)}}return!1},n=e.filter(a=>!i(a.id)),r=[];for(const a of n){const c=[];let u=a,h=16;for(;u&&h-- >0&&((u===a||o.has(u.id))&&c.unshift(u),!!u.parent);)u=t.get(u.parent);const p=c.map(v=>({id:v.id,name:v.name}));r.push({id:a.id,segments:p})}return r}_renderChain(e,t,o){const i=!t&&!o,n=a=>{a.stopPropagation();const c=a.detail,u=typeof c?.index=="number"?c.index:e.segments.length-1,h=new Set;for(const v of e.segments.slice(u))typeof v.id=="number"&&h.add(v.id);const p=this._value.filter(v=>!h.has(v));p.length!==this._value.length&&this.emit("os-categories-change",{value:p})},r=document.createElement("os-crumb-chain");return r.segments=e.segments,i&&r.setAttribute("removable",""),r.addEventListener("os-chain-remove",n),l`<div role="listitem">${r}</div>`}_renderPopover(e,t){const o=this._buildTree(),i=this._filterTree(o,this._query),n=this._flattenForDisplay(i);return this._focusedRow>=n.length&&(this._focusedRow=n.length>0?n.length-1:-1),l`
		...
		`}_renderTreeBody(e,t){return e?l`
			...
			`:t.map((o,i)=>this._renderRow(o,i,t.length))}_renderRow(e,t,o){const{node:i,hasChildren:n}=e,r=this._value.includes(i.item.id),a=!this._collapsed.has(i.item.id),c=12+i.depth*16,u=i.depth>0?i.depth*16:0,h=t===this._focusedRow;return l`
			<div class="os-cat__row-block">
				<div
					...
					data-focused=${h?"true":"false"}
					data-row-id=${String(i.item.id)}
					style=${`--os-ui-cat-row-indent: ${c}px; --os-ui-cat-guide-width: ${u}px;`}
					@mouseenter=${()=>{this._focusedRow=t,this.requestUpdate()}}
					@click=${p=>{p.preventDefault(),this._toggleSelection(i.item.id)}}
				>
					${n?l`<button
								type="button"
								class="os-cat__expander"
								aria-label=${a?"Collapse":"Expand"}
								@click=${p=>{p.stopPropagation(),this._toggleExpand(i.item.id)}}
							>${xr()}</button>`:l`<span class="os-cat__expander os-cat__expander--placeholder" aria-hidden="true">${xr()}</span>`}
					<span class="os-cat__check" aria-hidden="true">${Tu()}</span>
					<span class="os-cat__label">${this._highlight(i.item.name,this._query)}</span>
					${rs(i.item)?l``:l`<button
								type="button"
								class="os-cat__delete"
								aria-label=${`Delete ${i.item.name}`}
								title=${`Delete ${i.item.name}`}
								@click=${p=>this._onDeleteClick(p,i.item)}
							>${Du()}</button>`}
				</div>
				${a&&!rs(i.item)?this._renderCreateRow(i.item.id,12+(i.depth+1)*16,(i.depth+1)*16,i.item.name):l``}
			</div>
		`}_renderCreateRow(e,t,o,i){const n=this._creatingValues.get(e)??"",r=this._creatingPending.has(e),a=e===0?"Add new category…":`Add child of "${i}"…`;return l`
			<div
		...
		>${e.slice(r+o.length)}`}_toggleSelection(e){const t=this._value.includes(e)?this._value.filter(o=>o!==e):[...this._value,e];this.emit("os-categories-change",{value:t})}_onDeleteClick(e,t){e.stopPropagation(),e.preventDefault(),this.emit("os-categories-delete",{id:t.id,name:t.name})}_toggleExpand(e){this._collapsed.has(e)?this._collapsed.delete(e):this._collapsed.add(e),this.requestUpdate()}_onSearchInput(e){this._query=e.target.value,this._focusedRow=0,this.requestUpdate()}_onSearchKeydown(e,t){switch(e.key){case"ArrowDown":{if(t.length===0)return;e.preventDefault(),this._focusedRow=this._focusedRow+1>=t.length?0:this._focusedRow+1,this.requestUpdate(),this._scrollFocusedIntoView();return}case"ArrowUp":{if(t.length===0)return;e.preventDefault(),this._focusedRow=this._focusedRow<=0?t.length-1:this._focusedRow-1,this.requestUpdate(),this._scrollFocusedIntoView();return}case"ArrowRight":{if(this._focusedRow<0||this._focusedRow>=t.length)return;const o=t[this._focusedRow];o.hasChildren&&this._collapsed.has(o.node.item.id)&&(e.preventDefault(),this._toggleExpand(o.node.item.id));return}case"ArrowLeft":{if(this._focusedRow<0||this._focusedRow>=t.length)return;const o=t[this._focusedRow];o.hasChildren&&!this._collapsed.has(o.node.item.id)&&(e.preventDefault(),this._toggleExpand(o.node.item.id));return}case"Enter":case" ":{if(this._focusedRow<0||this._focusedRow>=t.length)return;e.preventDefault();const o=t[this._focusedRow];this._toggleSelection(o.node.item.id);return}case"Escape":e.preventDefault(),this.closePicker()}}_scrollFocusedIntoView(){queueMicrotask(()=>{const e=this.shadowRoot?.querySelector(".os-cat__tree");if(!e)return;const t=e.querySelector('.os-cat__row[data-focused="true"]');if(!t)return;const o=t.getBoundingClientRect(),i=e.getBoundingClientRect();o.top<i.top?t.scrollIntoView({block:"nearest"}):o.bottom>i.bottom&&t.scrollIntoView({block:"nearest"})})}_positionPopover(){const e=this.shadowRoot?.querySelector(".os-cat__popover");if(!e)return;const t=this.getBoundingClientRect(),o=e.getBoundingClientRect(),i=window.innerWidth,n=window.innerHeight,r=8;let a=t.bottom+4;const c=a+o.height+r>n,u=t.top-4-o.height>=r;c&&u?a=t.top-4-o.height:c&&(a=Math.max(r,n-o.height-r));let h=t.left;h+o.width+r>i&&(h=t.right-o.width),h=Math.max(r,Math.min(h,i-o.width-r)),e.style.top=`${a}px`,e.style.left=`${h}px`}};It.props=["placeholder","add-label","disabled","readonly","open","loading","max-visible"],It.styles=[$u],It.help=void 0;let Zo=It;E("os-category-picker",Zo);function xr(){return P("chevron-right",{size:14})}function Iu(){return P("plus",{size:16})}function Tu(){return P("check",{size:null})}function Du(){return P("close",{size:null})}const Pu=k` ${I} ${qt}:host(:not( [ interactive ] ) ) .os-holo-glint,:host( [ disabled ] ) .os-holo-glint{display:none}:host{display:flex;flex-direction:column;position:relative;gap:var( --os-ui-card-gap,12px );padding:var( --os-ui-card-padding,16px );border:1px solid var( --os-ui-card-border,var( --os-ui-border,rgba( 0,0,0,0.08 ) ) );border-radius:var( --os-ui-card-radius,12px );background:var( --os-ui-card-bg,var( --os-ui-surface,#fff ) );background-image:var( --os-ui-panel-bg-image,none );background-repeat:var( --os-ui-panel-bg-image-repeat,repeat );background-size:var( --os-ui-panel-bg-image-size,auto );background-position:var( --os-ui-panel-bg-image-position,center );color:var( --os-ui-card-fg,inherit );box-sizing:border-box;min-width:0;transition:transform 180ms ease,box-shadow 180ms ease,border-color 180ms ease}:host( [ hidden ] ){display:none}:host( [ compact ] ){padding:var( --os-ui-card-padding-compact,10px );gap:var( --os-ui-card-gap-compact,6px );border-radius:var( --os-ui-card-radius-compact,8px )}:host( [ interactive ] ){cursor:pointer;outline-offset:2px}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:translateY( -2px );box-shadow:var( --os-ui-card-shadow-hover,0 4px 16px rgba( 0,0,0,0.08 ) );border-color:var( --os-ui-card-border-hover,var( --os-ui-border-strong,rgba( 0,0,0,0.16 ) ) )}:host( [ interactive ]:focus-visible ){outline:none;box-shadow:var( --_holo-focus )}:host( [ selected ] ){border-color:var( --os-ui-card-border-selected,var( --wp-admin-theme-color,#2271b1 ) );box-shadow:var( --os-ui-card-shadow-selected,0 0 0 1px var( --wp-admin-theme-color,#2271b1 ) inset )}:host( [ selected ] )::after{content:'';position:absolute;inset:-1px;border-radius:inherit;padding:1px;background-image:var( --_holo-edge );pointer-events:none;-webkit-mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );-webkit-mask-composite:xor;mask:linear-gradient( #000 0 0 ) content-box,linear-gradient( #000 0 0 );mask-composite:exclude}:host( [ disabled ] ){opacity:0.55;pointer-events:none;cursor:not-allowed}@media ( prefers-reduced-motion:reduce ){:host{transition:none}:host( [ interactive ]:hover ),:host( [ interactive ]:focus-visible ){transform:none}}::slotted( header ){display:flex;align-items:center;gap:12px;min-width:0}::slotted( footer ){display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:auto}`,$r="[data-noclick]",Tt=class Tt extends ${constructor(){super(...arguments),this._onClick=e=>{!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.target?.closest($r)||this._emitCardClick(e)},this._onKeyDown=e=>{if(!this.hasAttribute("interactive")||this.hasAttribute("disabled")||e.key!=="Enter"&&e.key!==" "&&e.key!=="Spacebar")return;const t=e.target;t&&t!==this&&t.closest($r)||t instanceof HTMLElement&&t!==this&&(t.tagName==="BUTTON"||t.tagName==="A"||t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="SELECT")||(e.preventDefault(),this._emitCardClick(e))}}connectedCallback(){super.connectedCallback(),this._syncRoles(),this.addEventListener("click",this._onClick),this.addEventListener("keydown",this._onKeyDown)}disconnectedCallback(){this.removeEventListener("click",this._onClick),this.removeEventListener("keydown",this._onKeyDown)}render(){return this._syncRoles(),l`<span class="os-holo-glint" aria-hidden="true"></span
			...
			<div class="summary-card" role="img" aria-label=${Mu(e,i)}>
				<div class="summary">
					...
					<div class="total">
						${i===1?"1 rating":`${n.format(i)} ratings`}
					</div>
				</div>
				<div class="bars">
					${[5,4,3,2,1].map(a=>{const c=this._ratings[String(a)]??0,u=i===0?0:c/i;return l`
							<div
								class="row"
								role="presentation"
								aria-label=${`${a} stars: ${n.format(c)}`}
							>
								...
								<span class="row__track">
									<span
										class="row__fill"
										style=${`--ratio: ${u.toFixed(4)}`}
									></span>
								</span>
								<span class="row__count">${n.format(c)}</span>
							</div>
						`})}
				</div>
			</div>
		`}};Dt.props=["rating","total"],Dt.styles=[Nu],Dt.help=void 0;let Jo=Dt;function Er(s,e){const t=s.getAttribute(e);if(t===null||t==="")return 0;const o=Number(t);return Number.isFinite(o)?o:0}function zu(s){return s<0?0:s>100?100:s}function Mu(s,e){return e===0?"No ratings yet":`Average rating ${(s/100*5).toFixed(1)} out of 5, from ${e} ratings`}function Ou(s){const e=Math.floor(s),t=s-e>=.5?1:0,o=5-e-t,i=[];for(let n=0;n<e;n++)i.push(Ar());for(let n=0;n<t;n++)i.push(Wu());for(let n=0;n<o;n++)i.push(Hu());return i}function Ar(){return l`
		<svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
			<path
				d="M8 1.5l2.06 4.17 4.6.67-3.33 3.25.79 4.58L8 12L3.88 14.17l.79-4.58L1.34 6.34l4.6-.67L8 1.5z"
			/>
		</svg>
	`}function Wu(){return l`
	...
	`}E("os-rating-summary",Jo);const Uu=k` ${I} ${_i}:host{display:block;--_track-bg:var( --os-ui-progress-track-bg,var( --os-ui-surface-sunken,rgba( 0,0,0,0.08 ) ) );--_fill:var( --os-ui-progress-fill,var( --wp-admin-theme-color,#2271b1 ) );--_height:var( --os-ui-progress-height,6px );--_radius:var( --os-ui-progress-radius,999px );--_label-color:var( --os-ui-progress-label-color,inherit );--_label-size:var( --os-ui-progress-label-size,12px );--_label-gap:var( --os-ui-progress-label-gap,4px );width:100%;font:inherit;color:var( --_label-color )}:host( [ hidden ] ){display:none}.header{display:flex;align-items:baseline;justify-content:space-between;gap:8px;margin-bottom:var( --_label-gap );font-size:var( --_label-size );line-height:1.3}.label{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.percent{font-variant-numeric:tabular-nums;opacity:0.75;flex-shrink:0}.track{position:relative;width:100%;height:var( --_height );background:var( --_track-bg );border-radius:var( --_radius );overflow:hidden}.fill{position:absolute;inset-block:0;inset-inline-start:0;width:0;background:var( --_fill );border-radius:inherit;transition:width 0.18s ease-out}:host( [ tone='success' ] ){--os-ui-progress-fill:var( --os-ui-success-fg,#3a8a3a )}:host( [ tone='warning' ] ){--os-ui-progress-fill:var( --os-ui-warning-fg,#dba617 )}:host( [ tone='danger' ] ){--os-ui-progress-fill:var( --os-ui-danger,#d63638 )}:host( [ indeterminate ] ) .fill{width:100%;transition:none;background-image:var( --_fill );background-size:300% 300%;background-repeat:no-repeat;animation:os-holo-shimmer 2.4s var( --_holo-loop ) infinite}:host( [ indeterminate ][ tone ] ) .fill{width:33%;background-image:none;animation:os-progress-sweep 1.1s linear infinite}@keyframes os-progress-sweep{0%{transform:translateX( -120% )}100%{transform:translateX( 320% )}}@media ( prefers-reduced-motion:reduce ){.fill{transition:none}:host( [ indeterminate ] ) .fill,:host( [ indeterminate ][ tone ] ) .fill{animation:none;width:100%;opacity:0.6}}`,Pt=class Pt extends ${constructor(){super(...arguments),this._ownedAriaLabel=null}render(){return l`<div class="root" part="root">
		...
		`}};zt.props=["add-label","empty-text","disabled","reorderable","min","max","row-label"],zt.styles=[ju],zt.help=void 0;let ti=zt;E("os-repeater",ti);const Ku=k`:host{--_bg:var( --os-ui-token-field-bg,var( --os-ui-field-bg,#fff ) );--_border:var( --os-ui-token-field-border,var( --os-ui-field-border,#8c8f94 ) );--_fg:var( --os-ui-token-field-fg,var( --os-ui-field-fg,#2c3338 ) );--_chip-bg:var( --os-ui-token-field-chip-bg,var( --os-ui-surface-raised,rgba( 0,0,0,0.06 ) ) );display:block;position:relative}:host( [ hidden ] ){display:none}.os-token-field{display:flex;flex-direction:column;gap:6px}.os-token-field__label{font-size:13px;font-weight:500;color:var( --os-ui-fg,#1d2327 )}.os-token-field__input{box-sizing:border-box;width:100%;padding:6px 8px;border-radius:4px;background:var( --_bg );border:1px solid var( --_border );color:var( --_fg );font:inherit;resize:vertical}.os-token-field__input:focus-visible{outline:2px solid var( --os-ui-accent,#2271b1 );outline-offset:1px}.os-token-field__input:disabled{opacity:0.6}.os-token-field__toolbar{display:flex;align-items:center;gap:6px}.os-token-field__catalogue{position:absolute;inset-inline-start:0;inset-block-start:100%;z-index:20;max-height:18rem;overflow-y:auto;width:100%;padding:4px;box-sizing:border-box;border:1px solid var( --os-ui-border,#dcdcde );border-radius:6px;background:var( --os-ui-surface-elevated,#fff );box-shadow:0 8px 24px rgba( 0,0,0,0.18 )}.os-token-field__group{margin:6px 6px 2px;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:0.04em;color:var( --os-ui-fg-faint,#8c8f94 )}.os-token-field__option{display:grid;grid-template-columns:minmax( 0,1fr ) auto;gap:2px 8px;width:100%;padding:6px 8px;border:0;border-radius:4px;background:transparent;color:var( --os-ui-fg,#1d2327 );font:inherit;text-align:start;cursor:pointer}.os-token-field__option:hover,.os-token-field__option:focus-visible{background:var( --os-ui-hover,rgba( 0,0,0,0.06 ) );outline:none}.os-token-field__option-label{font-size:13px;min-width:0}.os-token-field__option-token{grid-column:2;grid-row:1;padding:1px 5px;border-radius:3px;background:var( --_chip-bg );font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample,.os-token-field__option-description{grid-column:1 / -1;font-size:11px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__option-sample{font-style:italic}.os-token-field__hint{margin:0;font-size:12px;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview{display:flex;gap:6px;margin:0;font-size:12px;line-height:1.4;color:var( --os-ui-fg-muted,#646970 )}.os-token-field__preview-label{flex:0 0 auto;font-weight:600}.os-token-field__preview-body{min-width:0;overflow-wrap:anywhere;white-space:pre-wrap}`,Mt=class Mt extends ${constructor(){super(...arguments),this._tokens=[],this._value="",this.caret=null,this.onInput=e=>{const t=e.target;this._value=t.value,this.emit("os-token-field-input",{value:this._value}),this.requestUpdate()},this.rememberCaret=()=>{const e=this.field;e&&(this.caret={start:e.selectionStart??e.value.length,end:e.selectionEnd??e.value.length})},this.toggleCatalogue=()=>{if(!(this.hasAttribute("disabled")||this.hasAttribute("readonly"))){if(this.isOpen){this.removeAttribute("open");return}this.rememberCaret(),this.setAttribute("open","")}},this.onKeydown=e=>{e.key==="Escape"&&this.isOpen&&(e.stopPropagation(),this.removeAttribute("open"),this.field?.focus())}}get tokens(){return this._tokens}set tokens(e){this._tokens=Array.isArray(e)?[...e]:[],this.requestUpdate()}get value(){return this._value}set value(e){this._value=typeof e=="string"?e:"";const t=this.field;t&&t.value!==this._value&&(t.value=this._value),this.requestUpdate()}get field(){return this.shadowRoot?.querySelector(".os-token-field__input")??null}get isOpen(){return this.hasAttribute("open")}grouped(){const e=new Map;for(const t of this._tokens){const o=t.group??"",i=e.get(o);i?i.push(t):e.set(o,[t])}return[...e.entries()].sort((t,o)=>t[0]===""?1:o[0]===""?-1:0)}preview(){let e=this._value,t=!1;for(const o of this._tokens)!o.sample||!e.includes(o.token)||(e=e.split(o.token).join(o.sample),t=!0);return t?e:null}insert(e){const t=this.field,o=this.caret??{start:this._value.length,end:this._value.length},i=this._value.slice(0,o.start),n=this._value.slice(o.end);this._value=`${i}${e.token}${n}`,this.removeAttribute("open"),t&&(t.value=this._value),this.emit("os-token-insert",{token:e.token,value:this._value}),this.emit("os-token-field-input",{value:this._value}),this.requestUpdate();const r=i.length+e.token.length;this.caret={start:r,end:r},queueMicrotask(()=>{const a=this.field;a?.focus(),a?.setSelectionRange?.(r,r)})}render(){const e=this.label||"",t=this.hint||"",o=this.placeholder||"",i=this,n=i["insert-label"]||"Insert a value",r=i["preview-label"]||"Reads as",a=this.hasAttribute("multiline"),c=this.hasAttribute("disabled"),u=this.hasAttribute("readonly"),h=Number(this.getAttribute("rows"))||4,p=this.preview(),v=this.grouped(),y=a?l`<textarea
			...
			<div class="os-token-field" @keydown=${this.onKeydown}>
				${e?l`<span class="os-token-field__label">${e}</span>`:null}
				${y}
				<div class="os-token-field__toolbar">
					<os-button
						variant="ghost"
						size="small"
						?disabled=${c||u||v.length===0}
				...
				${this.isOpen?l`<div
					  ...
					  >
							${v.map(([g,_])=>l`
									${g?l`<p class="os-token-field__group">${g}</p>`:null}
									${_.map(m=>l`
											<button
												type="button"
												role="option"
											...
											>
												...
												<code class="os-token-field__option-token"
													>${m.token}</code
												>
												${m.sample?l`<span class="os-token-field__option-sample"
															>${m.sample}</span
													  >`:null}
												${m.description?l`<span
				...
				${t?l`<p class="os-token-field__hint">${t}</p>`:null}
				${p!==null?l`<p class="os-token-field__preview">
							<span class="os-token-field__preview-label"
								>${r}</span
							>
							<span class="os-token-field__preview-body">${p}</span>
					  </p>`:null}
			</div>
		`}};Mt.props=["label","placeholder","hint","multiline","rows","disabled","readonly","insert-label","preview-label","open"],Mt.styles=[Ku],Mt.help=void 0;let si=Mt;E("os-token-field",si);const Bu=["os-section","os-button","os-swatch","os-swatch-grid","os-segmented","os-segment","os-select","os-option","os-multiselect","os-color-field","os-range-field","os-text-field","os-number-field","os-checkbox","os-checkbox-label","os-switch","os-toast","os-toast-container","os-tabs","os-tab","os-tabpanel","os-window-button","os-menu","os-menu-item","os-context-menu","os-context-menu-option","os-confirm-dialog","os-modal","os-user-search","os-role-picker","os-flyout","os-tab-chip","os-stack","os-cluster","os-icon","os-body","os-panel","os-row","os-grid","os-display","os-disclosure","os-empty-state","os-key","os-code","os-badge","os-ribbon","os-tile","os-log","os-steps","os-step","os-table","os-spinner","os-relative-time","os-avatar","os-textarea","os-chip","os-tag-input","os-form","os-save-status","os-category-picker","os-crumb-chain","os-card","os-rating-summary","os-notice","os-progress-bar","os-field-row","os-repeater","os-token-field"];function Gu(s,e,t,o){const i=[s,e,...o];if(t){i.push(t.summary??"",t.status??"");const n=[t.props,t.slots,t.events,t.parts,t.cssProps];for(const r of n)for(const a of r??[]){const c=a;i.push(c.name??"",c.description??"")}}return i.join(" ").toLowerCase()}function Xu(s,e){const t=e.toLowerCase().split(/\s+/).filter(Boolean);return t.length?t.every(o=>s.haystack.includes(o)):!0}function Zu(s,e){const t=e?.help?.exampleInit,o=s.querySelector(".os-settings__help-example");if(!(!t||!o)){customElements.upgrade(o);try{t(o)}catch(i){console.error(`[openstation] <${e?.tag}> exampleInit threw:`,i)}}}const Yu=["<!-- 1 — invented name, nothing close in the registry. -->","<os-example-console-fail-due-to-unregistered-component>","</os-example-console-fail-due-to-unregistered-component>","","<!-- 2 — typo within edit distance of a real tag. -->","<os-buton></os-buton>"].join(`
`);let Cr=!1;function Ju(){if(Cr)return;Cr=!0;const s=["background: #ffb400","color: #1a1a1a","font-weight: 700","font-size: 12px","padding: 4px 8px","border-radius: 3px"].join(";"),e=["color: #b25c00","font-weight: 500"].join(";");console.log(`%c⚠ wp.os — INTENTIONAL DEMO%c
...
if you want a quieter Components tab.`,s,e)}function Qu(s){const e=ah(),t=document.createElement("div");t.classList.add("os-settings__help");let o=e[0]?.tag??"",i="",n="";const r=()=>{s.state.developerModeEnabled&&Ju();const c=e.filter(p=>Xu(p,i)),u=c.find(p=>p.tag===o)??c[0];L(l`
				<!--
					...
					list.
				-->
				${s.state.developerModeEnabled?l`
						<!--
						...
						<os-disclosure
							...
							heading=${d("Missing-import warner — live demo")}
							hint=${d("Developer mode")}
						>
							<div class="os-settings__help-warner">
								<p class="os-settings__help-warner-text">
									${d('Both <os-*> tags in the next piece of code are intentionally bogus, one per answer the warner has. Open the browser console: within ~2 seconds you should see two console.error entries from the framework, each pointing the developer at the fix — a name nothing in the registry comes close to, and a typo the warner can suggest a fix for ("did you mean"). Live copies of the same two tags are rendered off-screen, so the demo fires without affecting layout — including while this section is folded away. Remove this section in your fork if you want a quieter Components tab.')}
								</p>
								<pre
				...
				<div class="os-settings__help-layout">
					<div class="os-settings__help-sidebar">
						<os-text-field
							...
							type="search"
							label=${d("Search components")}
							placeholder=${d("Name, tag, prop, event…")}
							autocomplete="off"
							value=${i}
							@os-input-change=${p=>{i=(p.detail?.value??"").trim(),r()}}
						></os-text-field>
					<nav
						class="os-settings__help-nav"
						aria-label=${d("Components")}
					>
						${c.length?"":l`<p
									class="os-settings__help-nav-empty"
								>
									${d("No components match.")}
								</p>`}
						${c.map(p=>l`
								<button
									type="button"
									class=${Sr("os-settings__help-nav-item",p.tag===(u?.tag??"")?"is-active":"")}
									aria-pressed=${p.tag===(u?.tag??"")?"true":"false"}
									@click=${()=>{o=p.tag,r()}}
								>
			...
			`,t);const h=t.querySelector(".os-settings__help-detail");h&&(u?.tag??"")!==n&&(h.scrollTop=0),n=u?.tag??"",Zu(t,u)};r();const a=window.wp?.os;if(a?.subscribeOsSettings){const c=a.subscribeOsSettings(()=>{if(!t.isConnected){c();return}r()})}return t}function eh(s){const e=s.help,t=e?.status??"stable";return l`
		<header class="os-settings__help-head">
			<h3 class="os-settings__help-title">${s.title}</h3>
			<code class="os-settings__help-code"
				>&lt;${s.tag}&gt;</code
			>
			<span
				class=${Sr("os-settings__help-badge",`is-${t}`)}
				>${ch(t)}</span
			>
		</header>

		${e?.summary?l`<p class="os-settings__help-summary">
					${e.summary}
				</p>`:l``}
		...
		${oh(e)} ${ih(e)}
		${nh(e)}
		${e?l``:l`<p class="os-settings__help-note">
					${d("This component has no help descriptor yet. Add `static help` to its class for a fuller reference.")}
				</p>`}
	`}function th(s,e){const t=e?.props??[],o=new Set(t.map(n=>n.name)),i=s.props.filter(n=>!o.has(n));return t.length===0&&i.length===0?l``:l`
		<section class="os-settings__help-group">
			<h4>${d("Props")}</h4>
				...
				<tbody>
					...
					${i.map(n=>l`
							<tr>
								...
								<td>
									<em
										>${d("Undocumented — declared via static props.")}</em
									>
								</td>
							</tr>
						`)}
	...
	`}function sh(s){return s?.slots?.length?l`
		<section class="os-settings__help-group">
			<h4>${d("Slots")}</h4>
			<ul class="os-settings__help-list">
				${s.slots.map(e=>l`
						<li>
							<code>${e.name}</code>
							${e.description?l` — ${e.description}`:l``}
						</li>
					`)}
			</ul>
		</section>
	`:l``}function oh(s){return s?.events?.length?l`
		<section class="os-settings__help-group">
			<h4>${d("Events")}</h4>
			<ul class="os-settings__help-list">
				${s.events.map(e=>l`
						<li>
							<code>${e.name}</code>
							${e.detail?l` — <code>${e.detail}</code>`:l``}
							${e.description?l` — ${e.description}`:l``}
						</li>
					`)}
			</ul>
		</section>
	`:l``}function ih(s){return s?.parts?.length?l`
		<section class="os-settings__help-group">
			<h4>${d("Shadow parts")}</h4>
			<ul class="os-settings__help-list">
				${s.parts.map(e=>l`
						<li>
	...
	`:l``}function nh(s){return s?.cssProps?.length?l`
		<section class="os-settings__help-group">
			<h4>${d("CSS custom properties")}</h4>
			<ul class="os-settings__help-list">
				${s.cssProps.map(e=>l`
						<li>
							<code>${e.name}</code>
	...
	`:l``}function rh(){return l`<p>${d("No components registered.")}</p>`}function ah(){const s=[];for(const e of Bu){const t=customElements.get(e);if(!t)continue;const o=t.help??null,i=o?.title??lh(e),n=t.props??[];s.push({tag:e,title:i,help:o,props:n,haystack:Gu(e,i,o,n)})}return s.sort((e,t)=>e.title.localeCompare(t.title)),s}function lh(s){const e=s.replace(/^os-/,"").replace(/-/g," ");return e.charAt(0).toUpperCase()+e.slice(1)}function ch(s){switch(s){case"experimental":return d("Experimental");case"planned":return d("Planned");case"stable":default:return d("Stable")}}function Sr(...s){return s.filter(Boolean).join(" ")}const Lr=K("desktop-mode/wallpaper-registry",()=>({seed:[],listeners:new Set})),ue=Lr.state.seed,oi=Lr.state.listeners;function ii(s){qs("Wallpaper",on(s,Tr),s);const e=ue.findIndex(t=>t.id===s.id);e>=0?ue[e]=s:ue.push(s),Rr()}function dh(s){const e=ue.findIndex(t=>t.id===s);e>=0&&(ue.splice(e,1),Rr())}function uh(s){return oi.add(s),()=>{oi.delete(s)}}function Rr(){const s=Array.from(oi);for(const e of s)try{e()}catch(t){typeof console<"u"&&console.error("[openstation] wallpaper registry listener threw:",t)}}function Ir(){const s=ue.slice(),e=J(O.WALLPAPERS,s);return Array.isArray(e)?e.filter(hh):(typeof console<"u"&&console.warn("[openstation] `os.wallpapers` filter returned a non-array; falling back to seed list."),s)}function he(s){return Ir().find(e=>e.id===s)}const Tr=[{field:"id",message:"missing or not a non-empty string",valid:s=>typeof s.id=="string"&&s.id!==""},{field:"label",message:"missing or not a non-empty string",valid:s=>typeof s.label=="string"&&s.label!==""},{field:"preview",message:"missing or not a non-empty string",valid:s=>typeof s.preview=="string"&&s.preview!==""},{field:"type",message:'must be "css" or "canvas"',valid:s=>s.type==="css"||s.type==="canvas"},{field:"value/resolveValue/mount",message:"css types need `value` or `resolveValue`; canvas types need `mount`",valid:s=>s.type==="css"?typeof s.value=="string"||typeof s.resolveValue=="function":s.type==="canvas"?typeof s.mount=="function":!0}];function hh(s){return on(s,Tr).length===0}const pe=K("desktop-mode/wallpaper-lazy",()=>({pending:new Map,inflight:new Map}));function ph(s){pe.state.pending.delete(s)}function fh(s){return(window.openStationWallpapers||{})[s]??null}function gh(s){const e=pe.state.inflight.get(s);if(e)return e;const t=pe.state.pending.get(s);if(!t)return Promise.resolve(null);const o=(async()=>{try{await to(t.scriptUrl,{translations:t.scriptTranslations,l10n:t.scriptL10n,before:t.scriptBefore,after:t.scriptAfter})}catch(n){return Q(O.SHELL_ERROR,{scope:"wallpaper-script-load",id:t.id,error:n}),null}let i=fh(t.id);if(i&&!i.description&&t.description&&(i={...i,description:t.description}),!i)return Q(O.SHELL_ERROR,{scope:"wallpaper-missing-def",id:t.id,error:new Error(`[openstation] No wallpaper def on window.openStationWallpapers["${t.id}"]. Script loaded but didn't publish a def — check the plugin's enqueue + global assignment.`)}),null;try{ii(i)}catch(n){return Q(O.SHELL_ERROR,{scope:"wallpaper-register",id:t.id,error:n}),null}return ph(t.id),i})().finally(()=>{pe.state.inflight.delete(s)});return pe.state.inflight.set(s,o),o}async function bh(){const s=Array.from(pe.state.pending.keys());s.length!==0&&await Promise.all(s.map(e=>gh(e)))}const Dr=K("desktop-mode/wallpaper-settings",()=>({values:{}}));function ni(s){return{...Dr.state.values[s]??{}}}function mh(s,e){Dr.state.values[s]={...e},Q(O.WALLPAPER_SETTINGS_CHANGED,{id:s,settings:{...e}})}async function vh(s,e,t,o){const i=new URL(s.mediaUrl);i.searchParams.set("media_type","image"),i.searchParams.set("per_page",String(Ba)),i.searchParams.set("page",String(e)),i.searchParams.set("orderby","date"),i.searchParams.set("order","desc"),i.searchParams.set("_fields","id,source_url,alt_text,title,media_details"),t&&i.searchParams.set("search",t),o&&(i.searchParams.set("openstation_min_width",String(zs)),i.searchParams.set("openstation_min_height",String(Ms)));const n=await j(i.toString(),{credentials:"same-origin",headers:{"X-WP-Nonce":s.restNonce}},{source:"desktop-mode/settings/media"});if(!n.ok){let u=`HTTP ${n.status}`;try{const h=await n.json();h&&typeof h.message=="string"&&(u=h.message)}catch{}throw new Error(u)}const r=n.headers.get("X-WP-TotalPages"),a=r?parseInt(r,10):1;return{items:(await n.json()).filter(Za),totalPages:a||1}}async function _h(s,e){const t=await j(s.mediaUrl,{method:"POST",credentials:"same-origin",headers:{"X-WP-Nonce":s.restNonce,"Content-Type":e.type,"Content-Disposition":`attachment; filename="${Xa(e.name)}"`},body:e},{source:"desktop-mode/settings/media-upload"});if(!t.ok){let i=`Upload failed (HTTP ${t.status}).`;try{const n=await t.json();n&&typeof n.message=="string"&&(i=n.message)}catch{}throw new Error(i)}const o=await t.json();return{id:o.id,url:o.source_url}}function yh(s,e){const t=[],o=document.createElement("div");o.className="os-settings__tab-pane",s.config.canUpload&&t.push({key:"upload",label:d("Upload new"),render:()=>wh(s,o,e)}),t.push({key:"library",label:d("Media Library"),render:()=>kh(s,o,e)});const i=t[0].key,n=a=>{const c=a.detail.value;t.find(u=>u.key===c)?.render()},r=document.createElement("div");return L(l`
				...
				`:l`
					<div class="os-settings__upload-inner">
						...
						<span class="os-settings__upload-prompt"
							>${d("Drop an image here, or click to upload")}</span
						>
						<span class="os-settings__upload-hint"
							>${d("JPEG, PNG, or WebP · goes straight to your Media Library")}</span
						>
					</div>
				`,e),e.onclick=()=>{if(!e.classList.contains("os-settings__upload-tile--busy")){if(s.state.customImage){Wr(s,V,o);return}t.click()}},e.ondragover=r=>{r.preventDefault(),e.classList.add("os-settings__upload-tile--dragover")},e.ondragleave=()=>{e.classList.remove("os-settings__upload-tile--dragover")},e.ondrop=r=>{r.preventDefault(),e.classList.remove("os-settings__upload-tile--dragover");const a=r.dataTransfer?.files?.[0];a&&Pr(s,a,e,o)}}async function Pr(s,e,t,o){if(!e.type.startsWith("image/")){Nr(t,d("That file isn’t an image."));return}t.classList.add("os-settings__upload-tile--busy"),L(l`<span class="os-settings__upload-status"
			>${d("Uploading…")}</span
		>`,t);const i=t.parentElement?.querySelector(".os-settings__file-input");try{const n=await _h(s.config,e);s.state.customImage={id:n.id,url:n.url},s.state.wallpaper=V,ai(s.state),s.save(),s.apply(),i&&as(s,t,i,o),ls(s,o)}catch(n){t.classList.remove("os-settings__upload-tile--busy"),i&&as(s,t,i,o);const r=n instanceof Error?n.message:d("Upload failed.");Nr(t,r)}}function Nr(s,e){let t=s.querySelector(".os-settings__upload-error");t||(t=document.createElement("span"),t.className="os-settings__upload-error",t.setAttribute("role","status"),s.appendChild(t)),t.textContent=e,window.setTimeout(()=>{t?.remove()},4e3)}function kh(s,e,t){const o=document.createElement("input");o.type="search",o.placeholder=d("Search your media"),o.className="os-settings__library-search",o.setAttribute("aria-label",d("Search media"));const i=document.createElement("div");i.className="os-settings__library-grid";const n=document.createElement("span");n.className="os-settings__library-meta";const r=document.createElement("os-button");r.setAttribute("variant","ghost"),r.textContent=d("Load more");let a="",c=0,u=0,h=[],p=0,v=!1;const y=x=>{s.state.libraryHdOnly=x.detail.checked,s.save(),f()};L(l`
			<div class="os-settings__library">
				<div class="os-settings__library-toolbar">
					${o}
					<os-checkbox-label
						label=${F(d("Only HD (≥%1$d×%2$d)"),zs,Ms)}
		...
		`,e);const g=()=>{const x=zr(s.state,h).length,w=[F(d("Showing %d"),x)];s.state.libraryHdOnly&&p>0&&w.push(F(d("%d hidden by HD filter"),p)),n.textContent=w.join(" · "),r.hidden=c>=u,v?r.setAttribute("disabled",""):r.removeAttribute("disabled")},_=()=>{const x=zr(s.state,h);if(p=h.length-x.length,x.length===0&&!v)L(l`<p class="os-settings__library-empty">
					${s.state.libraryHdOnly?d("No HD images found. Try unchecking the filter, or upload a larger image."):d("No images in your Media Library yet.")}
				</p>`,i);else{i.innerHTML="";for(const w of x)i.appendChild(xh(s,w,t))}g()},m=async()=>{if(!(v||u>0&&c>=u)){v=!0,g(),c===0&&L(l`${Array.from({length:8},()=>l`<div
						class="os-settings__library-tile os-settings__library-tile--skeleton"
					></div>`)}`,i);try{const x=await vh(s.config,c+1,a,s.state.libraryHdOnly);c=c+1,u=x.totalPages,h=h.concat(x.items),_()}catch(x){L(l`<p class="os-settings__library-error">
					${x instanceof Error?F(d("Couldn’t load your media: %s"),x.message):d("Couldn’t load your media.")}
				</p>`,i)}finally{v=!1,g()}}},f=()=>{c=0,u=0,h=[],p=0,m()};let b=null;o.addEventListener("input",()=>{b!==null&&window.clearTimeout(b),b=window.setTimeout(()=>{b=null,a=o.value.trim(),f()},Ga)}),r.addEventListener("click",()=>{m()}),m()}function zr(s,e){return s.libraryHdOnly?e.filter(t=>t.media_details.width>=zs&&t.media_details.height>=Ms):e}function xh(s,e,t){const o=s.state.wallpaper===V&&s.state.customImage?.id===e.id,i=e.media_details.sizes||{},n=i.medium?.source_url||i.thumbnail?.source_url||i.large?.source_url||e.source_url,r=e.alt_text||Ya(e.title?.rendered||"")||`Image #${e.id}`,a=()=>{s.state.customImage={id:e.id,url:e.source_url},s.state.wallpaper=V,ai(s.state),s.save(),s.apply(),ls(s,t);const u=c.firstElementChild?.parentElement;u&&u.querySelectorAll("[data-media-id]").forEach(h=>{const p=h.dataset.mediaId===String(e.id);h.setAttribute("aria-pressed",p?"true":"false"),h.classList.toggle("os-settings__library-tile--selected",p)})},c=document.createElement("div");return L(l`
			<button
				type="button"
				class=${o?"os-settings__library-tile os-settings__library-tile--selected":"os-settings__library-tile"}
				data-media-id=${String(e.id)}
				aria-pressed=${o?"true":"false"}
				aria-label=${r}
				title=${r}
				style=${`background-image: url("${encodeURI(n)}")`}
				@click=${a}
			>
		...
		`,c),c.firstElementChild}const $h=4,Mr=24,Or=4,Eh=250,Ah="os-settings__wallpaper-live-preview";function Ch(s){const e=s.type==="canvas"?s.needs:void 0;if(!e||e.length===0)return Promise.resolve();const t=window.wp?.os;return t?.loadModules?t.loadModules(e):Promise.reject(new Error(`[openstation] Wallpaper "${s.id}" declares needs but wp.os.loadModules is unavailable.`))}function Sh(){return window.openStationConfig?.pluginUrl??""}function Lh(){return typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches}function Rh(s){const e={...s.previewParams??{}},t=J(O.WALLPAPER_PREVIEW_PARAMS,e,s.id);return!t||typeof t!="object"?e:t}function Ih(s){const e=new Map;let t=!1;const o=()=>{let b=0;return e.forEach(x=>{(x.teardown||x.mounting)&&b++}),b},i=b=>{b.remountTimer!==null&&(clearTimeout(b.remountTimer),b.remountTimer=null)},n=b=>{if(b.generation++,b.mounting=!1,i(b),b.teardown){const x=b.teardown;b.teardown=null;try{x()}catch(w){typeof console<"u"&&console.error(`[openstation] Wallpaper "${b.defId}" preview teardown threw:`,w)}}b.overlay.innerHTML=""},r=b=>{t||!b.visible||b.teardown||b.mounting||y&&(b.tile.clientWidth<Mr||b.tile.clientHeight<Mr)||a(b)},a=b=>{const x=he(b.defId);if(!x?.renderPreview||o()>=$h)return;const w=++b.generation;b.mounting=!0,b.mountWidth=b.tile.clientWidth,b.mountHeight=b.tile.clientHeight;const R={id:x.id,pluginUrl:Sh(),prefersReducedMotion:Lh(),visible:!document.hidden,settings:ni(x.id),params:Rh(x),width:b.mountWidth,height:b.mountHeight},ie=S=>{if(w!==b.generation||t){try{S()}catch{}return}b.mounting=!1,b.teardown=S,c(b)&&u(b)},U=S=>{w===b.generation&&(b.mounting=!1,b.overlay.innerHTML="",typeof console<"u"&&console.error(`[openstation] Wallpaper "${x.id}" renderPreview failed:`,S))};Ch(x).then(()=>{if(w!==b.generation||t)return;let S;try{S=x.renderPreview(b.overlay,R)}catch(X){U(X);return}if(Ws(S)){S.then(ie,U);return}ie(S)},U)},c=b=>Math.abs(b.tile.clientWidth-b.mountWidth)>Or||Math.abs(b.tile.clientHeight-b.mountHeight)>Or,u=b=>{i(b),b.remountTimer=setTimeout(()=>{b.remountTimer=null,!(t||!b.teardown||!c(b))&&(n(b),r(b))},Eh)},h=b=>{for(const x of b){const w=e.get(x.target);w&&(w.visible=x.isIntersecting,x.isIntersecting?r(w):n(w))}},p=typeof IntersectionObserver=="function"?new IntersectionObserver(h,{threshold:.1}):null,v=b=>{for(const x of b){const w=e.get(x.target);!w||t||(!w.teardown&&!w.mounting?r(w):w.teardown&&c(w)&&u(w))}},y=typeof ResizeObserver=="function"?new ResizeObserver(v):null,g=b=>{n(b),p?.unobserve(b.tile),y?.unobserve(b.tile),b.overlay.remove(),e.delete(b.tile)},_=()=>{if(t)return;const b=s.querySelectorAll("os-swatch[data-wallpaper-id]"),x=new Set;b.forEach(w=>{x.add(w);const R=w.dataset.wallpaperId??"",U=!!he(R)?.renderPreview&&!!p,S=e.get(w);if(S&&(S.defId!==R||!U)&&g(S),!U||e.has(w))return;const X=document.createElement("div");X.className=Ah,X.setAttribute("aria-hidden","true"),w.appendChild(X),e.set(w,{tile:w,overlay:X,defId:R,generation:0,teardown:null,mounting:!1,visible:!1,mountWidth:0,mountHeight:0,remountTimer:null}),p.observe(w),y?.observe(w)}),e.forEach((w,R)=>{x.has(R)||g(w)})},m=()=>{t||(t=!0,e.forEach(b=>n(b)),e.clear(),p?.disconnect(),y?.disconnect(),document.removeEventListener("os-window-closed",f))},f=()=>{s.isConnected||m()};return document.addEventListener("os-window-closed",f),{sync:_,dispose:m}}function ri(s){const{from:e,to:t,angle:o}=s.customGradient;return`linear-gradient(${o}deg, ${e}, ${t})`}const Th=()=>d("Mix your own two-colour gradient and set the angle — your desk, your palette.");function Dh(s){ii({id:jt,label:d("Custom gradient"),type:"css",preview:ri(s.state),description:Th(),resolveValue:()=>ri(s.state),renderEditor:e=>Nh(s,e)})}function ai(s){if(!s.customImage){dh(V);return}const t=`url("${encodeURI(s.customImage.url)}") center/cover no-repeat, #1d2327`;ii({id:V,label:d("Custom image"),type:"css",value:t,preview:t,description:d("Any image from your media library or an upload, sized to cover the whole desk.")})}function Wr(s,e,t){s.state.wallpaper=e,s.save(),s.apply(),ls(s,t);const o=t.querySelector(".os-settings__wallpaper-config-slot");o&&li(s,o)}function li(s,e){const t=e.firstElementChild;if(!t)return;const o=he(s.state.wallpaper);if(!o||typeof o.renderConfig!="function"){e.dataset.expanded="false",e.style.marginTop="";return}e.style.marginTop="12px",L(l`
			<div class="os-settings__wallpaper-config">
				...
				>
					...
					${d("Wallpaper settings")}
				</os-button>
			</div>
		`,t),e.dataset.expanded="true"}function Ph(s,e){if(typeof e.renderConfig!="function")return;const t=document.createElement("os-modal");t.setAttribute("size","sm"),t.setAttribute("title",F(d("%s settings"),e.label));const o=document.createElement("div");o.className="os-settings__wallpaper-config-form",o.style.display="flex",o.style.flexDirection="column",o.style.gap="14px",t.appendChild(o);const i=document.createElement("os-button");i.setAttribute("slot","footer"),i.setAttribute("variant","primary"),i.textContent=d("Done"),t.appendChild(i);let n=null,r=!1;const a=()=>{if(!r){if(r=!0,n){try{n()}catch(u){typeof console<"u"&&console.error(`[openstation] Wallpaper "${e.id}" config teardown threw:`,u)}n=null}t.remove()}};i.addEventListener("click",a),t.addEventListener("os-modal-cancel",a);const c={id:e.id,pluginUrl:"",prefersReducedMotion:typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches,visible:!document.hidden,settings:ni(e.id),setSettings:u=>{const h={...s.state.wallpaperSettings[e.id]??{},...u};s.state.wallpaperSettings[e.id]=h,s.save(),mh(e.id,h)}};document.body.appendChild(t),t.setAttribute("open","");try{const u=e.renderConfig(o,c);Ws(u)?u.then(h=>{if(r){try{h()}catch{}return}n=h}):n=u}catch(u){typeof console<"u"&&console.error(`[openstation] Wallpaper "${e.id}" renderConfig threw:`,u),a()}}function ls(s,e){e.querySelectorAll("[data-wallpaper-id]").forEach(t=>{const o=t.dataset.wallpaperId===s.state.wallpaper;o?t.setAttribute("selected",""):t.removeAttribute("selected"),t.setAttribute("aria-pressed",o?"true":"false")})}function ci(s,e,t){Hr(s);const o=document.createElement("div");if(o.className="os-settings__editor-slot-inner",e.textContent="",e.appendChild(o),!t.renderEditor){e.dataset.expanded="false";return}const i={id:t.id,pluginUrl:"",prefersReducedMotion:typeof window.matchMedia=="function"&&window.matchMedia("( prefers-reduced-motion: reduce )").matches,visible:!document.hidden,settings:ni(t.id)};try{const n=t.renderEditor(o,i);Ws(n)?n.then(r=>{s.activeEditorTeardown=r}):s.activeEditorTeardown=n}catch(n){typeof console<"u"&&console.error(`[openstation] Wallpaper "${t.id}" renderEditor threw:`,n)}e.dataset.expanded="true"}function Hr(s){if(s.activeEditorTeardown){try{s.activeEditorTeardown()}catch(e){typeof console<"u"&&console.error("[openstation] Wallpaper editor teardown threw:",e)}s.activeEditorTeardown=null}}function Nh(s,e){e.classList.add("os-settings__gradient-editor-inner");const t=a=>{s.state.customGradient.from=a.detail.value,n()},o=a=>{s.state.customGradient.to=a.detail.value,n()},i=a=>{s.state.customGradient.angle=a.detail.value,n()},n=()=>{s.save(),s.apply(),zh(s,e),r()},r=()=>L(l`
				...
				<os-range-field
					...
					@os-range-change=${i}
				></os-range-field>
			`,e);return r(),()=>{}}function zh(s,e){const o=e.closest("os-section")?.querySelector(`[data-wallpaper-id="${jt}"]`);o&&(o.style.background=ri(s.state))}let Ur=null;function Mh(s,e){const t=document.createElement("div");t.className="os-settings__editor-slot",t.dataset.expanded="false";const o=document.createElement("div");o.className="os-settings__editor-slot-inner",t.appendChild(o);const i=document.createElement("div");i.className="os-settings__wallpaper-config-slot",i.dataset.expanded="false";const n=document.createElement("div");n.className="os-settings__wallpaper-config-slot-inner",i.appendChild(n);const r=f=>{const b=f.detail?.value??"",x=he(b);!x||x.id===V||(Wr(s,x.id,e),ci(s,t,x),g())},a=yh(s,e);let c=!!s.state.customImage;const u=document.createElement("div");u.className="os-settings__image-picker-slot",u.dataset.expanded=String(c);const h=document.createElement("div");h.className="os-settings__image-picker-slot-inner",h.appendChild(a),u.appendChild(h);const p=()=>{c=!c,u.dataset.expanded=String(c),g()},v=document.createElement("div");Ur?.dispose();const y=Ih(v);Ur=y;const g=()=>L(l`
				<os-section
					heading=${d("Wallpaper")}
					description=${d("The backdrop behind your windows. Pick a preset, mix your own gradient, or drop in an image.")}
				>
					<div
						class="os-settings__grid os-settings__grid--wallpapers"
						@os-pick=${r}
					>
						${Ir().filter(f=>f.id!==V).sort((f,b)=>+(f.id===jt)-+(b.id===jt)).map(f=>l`<os-swatch
									value=${f.id}
									label=${f.label}
									preview=${f.preview}
									variant="wallpaper"
									data-wallpaper-id=${f.id}
									?selected=${s.state.wallpaper===f.id}
								>
						...
						>
							<span
								...
								>+</span
							>
							<span>${d("Use your own image")}</span>
						</button>
					</div>
					${i} ${t}
					${u}
				</os-section>
			`,v);g(),y.sync();const _=he(s.state.wallpaper);_&&ci(s,t,_),li(s,i);const m=uh(()=>{if(!v.isConnected){m(),y.dispose();return}g(),y.sync();const f=he(s.state.wallpaper);f&&ci(s,t,f),li(s,i)});return bh(),v}function Oh(s,e){return s.capability&&s.capability==="manage_options"?e:!0}function qr(s){return s<20?1:s<40?2:3}const Wh=["heading","description","label","placeholder"];function fe(s,e=""){return l`
		<header class="os-settings__page-header">
			<h2 class="os-settings__page-title">${s}</h2>
			${e?l`<p class="os-settings__page-description">
						${e}
					</p>`:l``}
		</header>
	`}function Hh(s,e){Dh(s),Hr(s),s.tabRegistryUnsubscribe&&(s.tabRegistryUnsubscribe(),s.tabRegistryUnsubscribe=null),e.classList.add("os-settings");const t=()=>{const g=s.state.customImage;s.state={...sl(),customImage:g},s.save(),s.apply(),s.renderPanel(e)},o=s.config.isAdmin,i=nl().filter(g=>Oh(g,o)),n=[{id:"appearance",order:10,label:d("Appearance"),panel:l`<os-tabpanel for="appearance">
				<os-panel>
					${fe(d("Appearance"),d("Personalize your desktop. Changes apply instantly and are saved to this browser."))}
					<!--
			...
			</os-tabpanel>`},{id:"windows",order:18,label:d("Windows"),panel:l`<os-tabpanel for="windows">
				<os-panel>
					${fe(d("Windows"),d("How windows look, how they arrive, and how they behave when they are not the one you are using."))}
					${Yc(s)}
					${ad(s)}
				</os-panel>
			</os-tabpanel>`},{id:"features",order:30,label:d("Features"),panel:l`<os-tabpanel for="features">
				<os-panel>
					${fe(d("Features"),d("The assistant, the developer tools, and the betas. Every switch here affects only your account and takes effect immediately."))}
					${hd(s)}
					${o?ld(s):""}
				</os-panel>
			</os-tabpanel>`},{id:"themes",order:12,label:d("Themes"),panel:l`<os-tabpanel for="themes">
				<os-panel>
					${fe(d("Themes"),d("A desktop theme repaints every token at once. A coarser version of what Appearance does one control at a time."))}
					${Mc(s)}
				</os-panel>
			</os-tabpanel>`},{id:"navigation",order:22,label:d("Navigation"),panel:l`<os-tabpanel for="navigation">
				<os-panel>
					<!--
			...
			</os-tabpanel>`}];o&&n.push({id:"help",order:40,label:d("Components"),panel:l`<os-tabpanel for="help">
				<os-panel>
					${fe(d("Components"),d("Every <os-*> web component shipped by this plugin, with its props, slots, and a live example."))}
					${Qu(s)}
				</os-panel>
			</os-tabpanel>`}),n.push({id:"about",order:Number.MAX_SAFE_INTEGER,label:d("About"),panel:l`<os-tabpanel for="about">
			<os-panel padding="0">${fl()}</os-panel>
		</os-tabpanel>`});for(const g of i){const _=`ext-${g.id}`,m=`os-settings-tab-host-${g.id}`,f=g;n.push({id:_,order:g.order??100,label:g.label,icon:Di[g.id]?.(),panel:l`<os-tabpanel for=${_}>
				<os-panel><div data-host=${m}></div></os-panel>
			</os-tabpanel>`,mount:b=>{const x=b.querySelector(`[data-host="${m}"]`);if(x)try{f.render(x,{isAdmin:o,getOsSettings:()=>s.getOsSettingsSnapshot(),subscribeOsSettings:w=>s.subscribeOsSettings(w)})}catch(w){typeof console<"u"&&console.error("[openstation] settings tab render threw:",f.id,w)}}})}n.sort((g,_)=>g.order-_.order);const r=s.activeTabId??"appearance",c=n.some(g=>g.id===r)?r:"appearance",u=()=>{const g=new Map;for(const _ of n){const m=e.querySelector(`os-tabpanel[for="${_.id}"]`),f=[_.label,m?.textContent??""];if(m){const b=m.querySelectorAll("[heading],[description],[label],[placeholder]");for(const x of Array.from(b))for(const w of Wh)f.push(x.getAttribute(w)??"")}g.set(_.id,f.join(" ").replace(/\s+/g," ").toLowerCase())}return g};let h=null;const p=g=>{const _=g.target.value.trim().toLowerCase();h=h??u();let m=0;for(const b of Array.from(e.querySelectorAll(":scope > os-tabs > os-tab"))){const x=b.getAttribute("value")??"",w=_===""||(h.get(x)??"").includes(_);b.toggleAttribute("data-search-hidden",!w),w&&m++}const f=e.querySelector(".os-settings__search-empty");f&&(f.hidden=m>0)};L(l`
			<div class="os-settings__search">
				<label class="os-settings__search-field">
					...
					<input
						...
						placeholder=${d("Search settings")}
						aria-label=${d("Search settings")}
			...
			<os-tabs
				...
				value=${c}
				label=${d("Settings sections")}
			>
				${n.map((g,_)=>{const m=_>0&&qr(g.order)!==qr(n[_-1].order);return l`<os-tab
						value=${g.id}
						data-group-start=${m?"true":null}
						>${Di[g.id]?.()??g.icon??l`<span
			...
			<p class="os-settings__search-empty" hidden>
				${d("No settings match that.")}
			</p>
			<os-panel class="os-settings__footer">
				<os-button variant="ghost" @click=${t}
					>${d("Reset to defaults")}</os-button
				>
			</os-panel>
			${n.map(g=>g.panel)}
		`,e);for(const g of n)g.mount&&g.mount(e);const v=e.querySelector("os-tabs");if(v){s.tabChangeAbort?.abort();const g=new AbortController;s.tabChangeAbort=g,v.addEventListener("os-tab-change",_=>{const m=_.detail;m?.value&&(s.activeTabId=m.value)},{signal:g.signal})}const y=e.closest(".os-window");y&&Ka(y,[]),s.activeTabId=c,s.tabRegistryUnsubscribe=rl(()=>{if(!e.isConnected){s.tabRegistryUnsubscribe&&(s.tabRegistryUnsubscribe(),s.tabRegistryUnsubscribe=null);return}s.renderPanel(e)})}window.openStationRenderOsSettingsPanel=Hh})();
